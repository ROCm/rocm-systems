...
from perfxpert.analysis.core import detect_warmup_issues
...
class TestI3WarmupDetection:
    def test_no_outliers_when_consistent(self):
        ...
        with patch("perfxpert.analysis.core.execute_statement", return_value=mock_cursor):
    ...
    def test_skips_single_dispatch_kernels(self):
        ...
        mock_conn = MagicMock()
        with patch("perfxpert.analysis.core.execute_statement") as mock_exec:
            result = detect_warmup_issues(
                mock_conn,
