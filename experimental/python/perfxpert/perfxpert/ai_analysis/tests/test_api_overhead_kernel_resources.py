...
from perfxpert.analysis.core import (
...
class TestC2ApiOverhead:
    def test_returns_empty_when_no_regions(self):
        ...
        with patch("perfxpert.analysis.core.execute_statement", side_effect=Exception("no such table")):
...
class TestI1KernelResources:
    ...
    def test_returns_empty_when_no_hotspots(self):
        ...
        mock_conn = MagicMock()
        with patch("perfxpert.analysis.core.execute_statement"):
    ...
    def test_occupancy_calculation(self):
        ...
        with patch("perfxpert.analysis.core.execute_statement", side_effect=mock_exec):
