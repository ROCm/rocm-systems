...
class TestUTF8GuideLoading:
    ...
    def test_load_reference_guide_public(self, tmp_path):
        ...
        with patch("perfxpert.ai_analysis.llm_analyzer.get_reference_guide_path", return_value=guide_path):
            from perfxpert.ai_analysis.llm_analyzer import load_reference_guide
