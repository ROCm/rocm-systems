...
class TestInteractiveIntegration(unittest.TestCase):
    ...
    def test_post_rewrite_summary_appended_to_conv(self):
        ...
        import perfxpert.ai_analysis.interactive as imod

        with patch(
            "perfxpert.ai_analysis.llm_analyzer.LLMAnalyzer", return_value=mock_analyzer
        ):
    ...
    def test_session_context_is_importable(self):
        ...
        from perfxpert.ai_analysis.interactive import SessionContext
    ...
    def test_workflow_session_conv_is_none_without_llm(self):
        ...
        from perfxpert.ai_analysis.interactive import WorkflowSession
