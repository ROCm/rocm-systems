...
Regression guard: the `perfxpert.ai_analysis.analyze_database`
library API was removed in Phase 7.1. Programmatic callers must
use the agentic runtime (`perfxpert.agents`).
"""
...
def test_legacy_ai_analysis_module_is_removed():
    """Regression guard: importing the module removed in Phase 7.1 must fail cleanly."""
