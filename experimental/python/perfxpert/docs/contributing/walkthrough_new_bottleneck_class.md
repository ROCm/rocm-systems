...
Create `perfxpert/agents/fence/io_specialist.md` (≤ 400 lines). The shared
`always.md` is composed in automatically, and the 400-line cap applies to the
composed result, so budget for it:
