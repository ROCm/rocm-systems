...
///
/// @details This uses instruction metadata only. Branch and program-exit
/// classification belongs in generated ISA subclasses, not in generic code
/// matching display mnemonics.
