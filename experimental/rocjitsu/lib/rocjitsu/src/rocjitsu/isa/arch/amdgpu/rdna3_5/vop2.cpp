...
void VAddF32Vop2::execute_impl(amdgpu::Wavefront &wf) { amdgpu::execute_v_add_f32_vop2(*this, wf); }
...
void VSubF32Vop2::execute_impl(amdgpu::Wavefront &wf) { amdgpu::execute_v_sub_f32_vop2(*this, wf); }
...
void VMulF32Vop2::execute_impl(amdgpu::Wavefront &wf) { amdgpu::execute_v_mul_f32_vop2(*this, wf); }
...
void VMinF32Vop2::execute_impl(amdgpu::Wavefront &wf) { amdgpu::execute_v_min_f32_vop2(*this, wf); }
...
void VMaxF32Vop2::execute_impl(amdgpu::Wavefront &wf) { amdgpu::execute_v_max_f32_vop2(*this, wf); }
...
void VMinI32Vop2::execute_impl(amdgpu::Wavefront &wf) { amdgpu::execute_v_min_i32_vop2(*this, wf); }
...
void VMaxI32Vop2::execute_impl(amdgpu::Wavefront &wf) { amdgpu::execute_v_max_i32_vop2(*this, wf); }
...
void VMinU32Vop2::execute_impl(amdgpu::Wavefront &wf) { amdgpu::execute_v_min_u32_vop2(*this, wf); }
...
void VMaxU32Vop2::execute_impl(amdgpu::Wavefront &wf) { amdgpu::execute_v_max_u32_vop2(*this, wf); }
...
void VAndB32Vop2::execute_impl(amdgpu::Wavefront &wf) { amdgpu::execute_v_and_b32_vop2(*this, wf); }
...
void VOrB32Vop2::execute_impl(amdgpu::Wavefront &wf) { amdgpu::execute_v_or_b32_vop2(*this, wf); }
...
void VXorB32Vop2::execute_impl(amdgpu::Wavefront &wf) { amdgpu::execute_v_xor_b32_vop2(*this, wf); }
...
void VAddF16Vop2::execute_impl(amdgpu::Wavefront &wf) { amdgpu::execute_v_add_f16_vop2(*this, wf); }
...
void VSubF16Vop2::execute_impl(amdgpu::Wavefront &wf) { amdgpu::execute_v_sub_f16_vop2(*this, wf); }
...
void VMulF16Vop2::execute_impl(amdgpu::Wavefront &wf) { amdgpu::execute_v_mul_f16_vop2(*this, wf); }
...
void VMaxF16Vop2::execute_impl(amdgpu::Wavefront &wf) { amdgpu::execute_v_max_f16_vop2(*this, wf); }
...
void VMinF16Vop2::execute_impl(amdgpu::Wavefront &wf) { amdgpu::execute_v_min_f16_vop2(*this, wf); }
