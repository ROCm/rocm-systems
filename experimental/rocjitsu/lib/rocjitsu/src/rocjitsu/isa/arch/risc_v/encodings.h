...
public:
  RType(std::string_view mnemonic, uint32_t raw);
...
public:
  IType(std::string_view mnemonic, uint32_t raw);
  int32_t imm() const;
...
public:
  SType(std::string_view mnemonic, uint32_t raw);
  int32_t imm() const;
...
public:
  BType(std::string_view mnemonic, uint32_t raw);
  int32_t imm() const;
...
public:
  UType(std::string_view mnemonic, uint32_t raw);
  int32_t imm() const;
...
public:
  JType(std::string_view mnemonic, uint32_t raw);
  int32_t imm() const;
...
public:
  R4Type(std::string_view mnemonic, uint32_t raw);
