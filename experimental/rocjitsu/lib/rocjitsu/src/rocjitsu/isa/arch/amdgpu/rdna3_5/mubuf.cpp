...
void BufferLoadLdsU8Mubuf::execute(amdgpu::Wavefront &wf) { (void)wf; }
...
void BufferLoadLdsI8Mubuf::execute(amdgpu::Wavefront &wf) { (void)wf; }
...
void BufferLoadLdsU16Mubuf::execute(amdgpu::Wavefront &wf) { (void)wf; }
...
void BufferLoadLdsI16Mubuf::execute(amdgpu::Wavefront &wf) { (void)wf; }
...
void BufferLoadLdsB32Mubuf::execute(amdgpu::Wavefront &wf) { (void)wf; }
...
void BufferLoadLdsFormatXMubuf::execute(amdgpu::Wavefront &wf) { (void)wf; }
