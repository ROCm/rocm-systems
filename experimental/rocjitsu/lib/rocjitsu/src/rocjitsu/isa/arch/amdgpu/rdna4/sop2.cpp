...
void SAddF32Sop2::execute(amdgpu::Wavefront &wf) {
  uint32_t s0 = ssrc0.read_scalar(wf);
  uint32_t s1 = ssrc1.read_scalar(wf);
  (void)s1;
...
void SSubF32Sop2::execute(amdgpu::Wavefront &wf) {
  uint32_t s0 = ssrc0.read_scalar(wf);
  uint32_t s1 = ssrc1.read_scalar(wf);
  (void)s1;
...
void SMulF32Sop2::execute(amdgpu::Wavefront &wf) {
  uint32_t s0 = ssrc0.read_scalar(wf);
  uint32_t s1 = ssrc1.read_scalar(wf);
  (void)s1;
...
void SAddF16Sop2::execute(amdgpu::Wavefront &wf) {
  uint32_t s0 = ssrc0.read_scalar(wf);
  uint32_t s1 = ssrc1.read_scalar(wf);
  (void)s1;
  uint32_t result = s0; // TODO: op=add
...
void SSubF16Sop2::execute(amdgpu::Wavefront &wf) {
  uint32_t s0 = ssrc0.read_scalar(wf);
  uint32_t s1 = ssrc1.read_scalar(wf);
  (void)s1;
  uint32_t result = s0; // TODO: op=sub
...
void SMulF16Sop2::execute(amdgpu::Wavefront &wf) {
  uint32_t s0 = ssrc0.read_scalar(wf);
  uint32_t s1 = ssrc1.read_scalar(wf);
  (void)s1;
  uint32_t result = s0; // TODO: op=mul
