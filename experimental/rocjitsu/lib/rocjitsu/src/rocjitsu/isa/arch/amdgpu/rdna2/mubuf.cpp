...
void BufferAtomicCsubMubuf::execute(amdgpu::Wavefront &wf) {
  (void)wf;
...
void BufferAtomicFcmpswapMubuf::execute(amdgpu::Wavefront &wf) {
  (void)wf;
  throw util::UnimplementedInst(
...
void BufferAtomicFminMubuf::execute(amdgpu::Wavefront &wf) {
  auto d = std::make_unique<amdgpu::VectorMemState>(amdgpu::GLOBAL_MEM);
  d->dst_reg_base = wf.vgpr_alloc().base + inst_.vdata;
  d->elem_size = 4;
  d->num_elems = 1;
...
void BufferAtomicFmaxMubuf::execute(amdgpu::Wavefront &wf) {
  auto d = std::make_unique<amdgpu::VectorMemState>(amdgpu::GLOBAL_MEM);
  d->dst_reg_base = wf.vgpr_alloc().base + inst_.vdata;
  d->elem_size = 4;
  d->num_elems = 1;
...
void BufferAtomicFcmpswapX2Mubuf::execute(amdgpu::Wavefront &wf) {
  (void)wf;
  throw util::UnimplementedInst(
...
void BufferAtomicFminX2Mubuf::execute(amdgpu::Wavefront &wf) {
  auto d = std::make_unique<amdgpu::VectorMemState>(amdgpu::GLOBAL_MEM);
  d->dst_reg_base = wf.vgpr_alloc().base + inst_.vdata;
  d->elem_size = 8;
  d->num_elems = 1;
...
void BufferAtomicFmaxX2Mubuf::execute(amdgpu::Wavefront &wf) {
  auto d = std::make_unique<amdgpu::VectorMemState>(amdgpu::GLOBAL_MEM);
  d->dst_reg_base = wf.vgpr_alloc().base + inst_.vdata;
  d->elem_size = 8;
  d->num_elems = 1;
