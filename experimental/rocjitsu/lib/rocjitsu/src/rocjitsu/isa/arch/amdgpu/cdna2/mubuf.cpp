...
void BufferWbl2Mubuf::execute_impl(amdgpu::Wavefront &wf) { (void)wf; }
...
void BufferInvl2Mubuf::execute_impl(amdgpu::Wavefront &wf) { (void)wf; }
...
void BufferStoreLdsDwordMubuf::execute_impl(amdgpu::Wavefront &wf) { (void)wf; }
