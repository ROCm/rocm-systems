...
void VMovB64Vop3::execute(amdgpu::Wavefront &wf) { amdgpu::execute_v_mov_b64_vop3(*this, wf); }
...
void VFmacF64Vop3::execute(amdgpu::Wavefront &wf) { amdgpu::execute_v_fmac_f64_vop3(*this, wf); }
