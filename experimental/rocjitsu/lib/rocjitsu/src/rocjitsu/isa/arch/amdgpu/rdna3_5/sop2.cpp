...
void SMinF32Sop2::implicit_defs(uint8_t wf_size, std::vector<RegisterRef> &defs) const {
  (void)wf_size;
  defs.push_back(RegisterRef{RegClass::SCC, 0, 1});
}
...
void SMaxF32Sop2::implicit_defs(uint8_t wf_size, std::vector<RegisterRef> &defs) const {
  (void)wf_size;
  defs.push_back(RegisterRef{RegClass::SCC, 0, 1});
}
...
void SMinF16Sop2::implicit_defs(uint8_t wf_size, std::vector<RegisterRef> &defs) const {
  (void)wf_size;
  defs.push_back(RegisterRef{RegClass::SCC, 0, 1});
}
...
void SMaxF16Sop2::implicit_defs(uint8_t wf_size, std::vector<RegisterRef> &defs) const {
  (void)wf_size;
  defs.push_back(RegisterRef{RegClass::SCC, 0, 1});
}
