...
#ifndef ROCJITSU_ISA_ARCH_AMDGPU_CDNA1_MUBUF_H_
#define ROCJITSU_ISA_ARCH_AMDGPU_CDNA1_MUBUF_H_
...
class BufferStoreLdsDwordMubuf : public Mubuf {
public:
  BufferStoreLdsDwordMubuf(const MachineInst *inst);
  void execute_impl(amdgpu::Wavefront &wf);
  Operand srsrc;
  Operand soffset;
};

class BufferWbinvl1Mubuf : public Mubuf {
public:
  BufferWbinvl1Mubuf(const MachineInst *inst);
  void execute_impl(amdgpu::Wavefront &wf);
};

class BufferWbinvl1VolMubuf : public Mubuf {
public:
  BufferWbinvl1VolMubuf(const MachineInst *inst);
  void execute_impl(amdgpu::Wavefront &wf);
};
...
#endif // ROCJITSU_ISA_ARCH_AMDGPU_CDNA1_MUBUF_H_
