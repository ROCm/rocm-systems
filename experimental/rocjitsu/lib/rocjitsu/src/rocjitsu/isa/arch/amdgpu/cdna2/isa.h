...
/// @brief CDNA2 STATUS register layout (GFX90A, one 32-bit scalar register per wavefront).
...
struct Isa {
  ...
  static constexpr uint32_t MAX_ACC_VGPRS_PER_WF = 256; ///< Max AccVGPRs (encoding base 512).
  ...
  using StatusReg = cdna2::StatusReg;
};
