...
uint64_t smem_calculate_address(const SmemMachineInst &inst, amdgpu::Wavefront &wf) {
  (void)inst;
  (void)wf;
  throw util::UnimplementedInst("rdna1 smem_calculate_address not yet implemented");
  return 0;
}
...
void flat_calculate_addresses(const FlatMachineInst &inst, amdgpu::Wavefront &wf,
  ...
  (void)addrs;
  (void)lane_mask;
  throw util::UnimplementedInst("rdna1 flat_calculate_addresses not yet implemented");
}
...
void mubuf_calculate_addresses(const MubufMachineInst &inst, amdgpu::Wavefront &wf,
  ...
  (void)addrs;
  (void)lane_mask;
  throw util::UnimplementedInst("rdna1 mubuf_calculate_addresses not yet implemented");
}
...
void ds_calculate_addresses(const DsMachineInst &inst, amdgpu::Wavefront &wf,
  ...
  (void)addrs;
  (void)lane_mask;
  throw util::UnimplementedInst("rdna1 ds_calculate_addresses not yet implemented");
}
