...
void mubuf_calculate_addresses(const MubufMachineInst &inst, amdgpu::Wavefront &wf,
  ...
  (void)addrs;
  (void)lane_mask;
  throw util::UnimplementedInst("rdna3 mubuf_calculate_addresses not yet implemented");
}
...
void ds_calculate_addresses(const DsMachineInst &inst, amdgpu::Wavefront &wf,
  ...
  (void)addrs;
  (void)lane_mask;
  throw util::UnimplementedInst("rdna3 ds_calculate_addresses not yet implemented");
}
