...
SEndpgmSopp::SEndpgmSopp(const MachineInst *inst) : Sopp("s_endpgm", reinterpret_cast<const OpEncoding*>(inst), make_exec_fn<SEndpgmSopp>()) {num_src_ = 0;num_dst_ = 0;}

void SEndpgmSopp::execute_impl(amdgpu::Wavefront &wf) {
  wf.end();
}

SBranchSopp::SBranchSopp(const MachineInst *inst) : Sopp("s_branch", reinterpret_cast<const OpEncoding*>(inst), make_exec_fn<SBranchSopp>()), simm16(32, OperandType::OPR_LABEL, reinterpret_cast<const OpEncoding*>(inst)->simm16) {src_operands_[0] = &simm16;num_src_ = 1;num_dst_ = 0;}
...
SCbranchScc0Sopp::SCbranchScc0Sopp(const MachineInst *inst) : Sopp("s_cbranch_scc0", reinterpret_cast<const OpEncoding*>(inst), make_exec_fn<SCbranchScc0Sopp>()), simm16(32, OperandType::OPR_LABEL, reinterpret_cast<const OpEncoding*>(inst)->simm16) {src_operands_[0] = &simm16;num_src_ = 1;num_dst_ = 0;}
...
SCbranchScc1Sopp::SCbranchScc1Sopp(const MachineInst *inst) : Sopp("s_cbranch_scc1", reinterpret_cast<const OpEncoding*>(inst), make_exec_fn<SCbranchScc1Sopp>()), simm16(32, OperandType::OPR_LABEL, reinterpret_cast<const OpEncoding*>(inst)->simm16) {src_operands_[0] = &simm16;num_src_ = 1;num_dst_ = 0;}
...
SCbranchVcczSopp::SCbranchVcczSopp(const MachineInst *inst) : Sopp("s_cbranch_vccz", reinterpret_cast<const OpEncoding*>(inst), make_exec_fn<SCbranchVcczSopp>()), simm16(32, OperandType::OPR_LABEL, reinterpret_cast<const OpEncoding*>(inst)->simm16) {src_operands_[0] = &simm16;num_src_ = 1;num_dst_ = 0;}
...
SCbranchVccnzSopp::SCbranchVccnzSopp(const MachineInst *inst) : Sopp("s_cbranch_vccnz", reinterpret_cast<const OpEncoding*>(inst), make_exec_fn<SCbranchVccnzSopp>()), simm16(32, OperandType::OPR_LABEL, reinterpret_cast<const OpEncoding*>(inst)->simm16) {src_operands_[0] = &simm16;num_src_ = 1;num_dst_ = 0;}
...
SCbranchExeczSopp::SCbranchExeczSopp(const MachineInst *inst) : Sopp("s_cbranch_execz", reinterpret_cast<const OpEncoding*>(inst), make_exec_fn<SCbranchExeczSopp>()), simm16(32, OperandType::OPR_LABEL, reinterpret_cast<const OpEncoding*>(inst)->simm16) {src_operands_[0] = &simm16;num_src_ = 1;num_dst_ = 0;}
...
SCbranchExecnzSopp::SCbranchExecnzSopp(const MachineInst *inst) : Sopp("s_cbranch_execnz", reinterpret_cast<const OpEncoding*>(inst), make_exec_fn<SCbranchExecnzSopp>()), simm16(32, OperandType::OPR_LABEL, reinterpret_cast<const OpEncoding*>(inst)->simm16) {src_operands_[0] = &simm16;num_src_ = 1;num_dst_ = 0;}
...
SBarrierSopp::SBarrierSopp(const MachineInst *inst) : Sopp("s_barrier", reinterpret_cast<const OpEncoding*>(inst), make_exec_fn<SBarrierSopp>()) {num_src_ = 0;num_dst_ = 0;}
...
SWaitcntSopp::SWaitcntSopp(const MachineInst *inst) : Sopp("s_waitcnt", reinterpret_cast<const OpEncoding*>(inst), make_exec_fn<SWaitcntSopp>()), simm16(32, OperandType::OPR_WAITCNT, reinterpret_cast<const OpEncoding*>(inst)->simm16) {src_operands_[0] = &simm16;num_src_ = 1;num_dst_ = 0;}
...
SSendmsgSopp::SSendmsgSopp(const MachineInst *inst) : Sopp("s_sendmsg", reinterpret_cast<const OpEncoding*>(inst), make_exec_fn<SSendmsgSopp>()), simm16(32, OperandType::OPR_SENDMSG, reinterpret_cast<const OpEncoding*>(inst)->simm16) {src_operands_[0] = &simm16;num_src_ = 1;num_dst_ = 0;}

void SSendmsgSopp::execute_impl(amdgpu::Wavefront &wf) {
  (void)wf;
}

SSendmsghaltSopp::SSendmsghaltSopp(const MachineInst *inst) : Sopp("s_sendmsghalt", reinterpret_cast<const OpEncoding*>(inst), make_exec_fn<SSendmsghaltSopp>()), simm16(32, OperandType::OPR_SENDMSG, reinterpret_cast<const OpEncoding*>(inst)->simm16) {src_operands_[0] = &simm16;num_src_ = 1;num_dst_ = 0;}
...
STtracedataSopp::STtracedataSopp(const MachineInst *inst) : Sopp("s_ttracedata", reinterpret_cast<const OpEncoding*>(inst), make_exec_fn<STtracedataSopp>()) {num_src_ = 0;num_dst_ = 0;}
...
SEndpgmSavedSopp::SEndpgmSavedSopp(const MachineInst *inst) : Sopp("s_endpgm_saved", reinterpret_cast<const OpEncoding*>(inst), make_exec_fn<SEndpgmSavedSopp>()) {num_src_ = 0;num_dst_ = 0;}
...
SSetGprIdxModeSopp::SSetGprIdxModeSopp(const MachineInst *inst) : Sopp("s_set_gpr_idx_mode", reinterpret_cast<const OpEncoding*>(inst), make_exec_fn<SSetGprIdxModeSopp>()), simm16(32, OperandType::OPR_SIMM16, reinterpret_cast<const OpEncoding*>(inst)->simm16) {src_operands_[0] = &simm16;num_src_ = 1;num_dst_ = 0;}

void SSetGprIdxModeSopp::execute_impl(amdgpu::Wavefront &wf) {
  (void)wf;
}

SEndpgmOrderedPsDoneSopp::SEndpgmOrderedPsDoneSopp(const MachineInst *inst) : Sopp("s_endpgm_ordered_ps_done", reinterpret_cast<const OpEncoding*>(inst), make_exec_fn<SEndpgmOrderedPsDoneSopp>()) {num_src_ = 0;num_dst_ = 0;}
