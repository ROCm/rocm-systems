...
#ifndef ROCJITSU_ISA_ARCH_AMDGPU_CDNA2_VOP3_H_
#define ROCJITSU_ISA_ARCH_AMDGPU_CDNA2_VOP3_H_
...
class VMacF32Vop3 : public Vop3 {
public:
  VMacF32Vop3(const MachineInst *inst);
  void execute(amdgpu::Wavefront &wf) override;
  Operand vdst;
  Operand src0;
  Operand src1;
...
class VMadLegacyF32Vop3 : public Vop3 {
public:
  VMadLegacyF32Vop3(const MachineInst *inst);
  void execute(amdgpu::Wavefront &wf) override;
  Operand vdst;
  Operand src0;
  Operand src1;
...
class VMadF32Vop3 : public Vop3 {
public:
  VMadF32Vop3(const MachineInst *inst);
  void execute(amdgpu::Wavefront &wf) override;
  Operand vdst;
  Operand src0;
  Operand src1;
...
#endif // ROCJITSU_ISA_ARCH_AMDGPU_CDNA2_VOP3_H_
