...
void SWaitcntVscntSopk::execute(amdgpu::Wavefront &wf) { (void)wf; }
...
void SWaitcntVmcntSopk::execute(amdgpu::Wavefront &wf) { (void)wf; }
...
void SWaitcntExpcntSopk::execute(amdgpu::Wavefront &wf) { (void)wf; }
...
void SWaitcntLgkmcntSopk::execute(amdgpu::Wavefront &wf) { (void)wf; }
...
void SSubvectorLoopBeginSopk::execute(amdgpu::Wavefront &wf) { (void)wf; }
...
void SSubvectorLoopEndSopk::execute(amdgpu::Wavefront &wf) { (void)wf; }
