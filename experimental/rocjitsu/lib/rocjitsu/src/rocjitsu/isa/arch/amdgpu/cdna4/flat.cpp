...
void FlatStoreDwordFlat::execute_impl(amdgpu::Wavefront &wf) {
  ...
  for (uint32_t lane = 0; lane < wf.wf_size(); ++lane) {
    if (!(exec & (1ULL << lane)))
      continue;
    uint32_t val0 =
        cu.read_vgpr(wf.vgpr_alloc().base + (inst_.acc ? 256u : 0u) + inst_.data + 0, lane);
...
void FlatStoreDwordx2Flat::execute_impl(amdgpu::Wavefront &wf) {
  ...
  for (uint32_t lane = 0; lane < wf.wf_size(); ++lane) {
    ...
    uint32_t val1 =
        cu.read_vgpr(wf.vgpr_alloc().base + (inst_.acc ? 256u : 0u) + inst_.data + 1, lane);
...
void FlatStoreDwordx3Flat::execute_impl(amdgpu::Wavefront &wf) {
  ...
  for (uint32_t lane = 0; lane < wf.wf_size(); ++lane) {
    ...
    uint32_t val2 =
        cu.read_vgpr(wf.vgpr_alloc().base + (inst_.acc ? 256u : 0u) + inst_.data + 2, lane);
...
void FlatStoreDwordx4Flat::execute_impl(amdgpu::Wavefront &wf) {
  ...
  for (uint32_t lane = 0; lane < wf.wf_size(); ++lane) {
    ...
    uint32_t val3 =
        cu.read_vgpr(wf.vgpr_alloc().base + (inst_.acc ? 256u : 0u) + inst_.data + 3, lane);
...
GlobalLoadLdsDwordx4FlatGlbl::GlobalLoadLdsDwordx4FlatGlbl(const MachineInst *inst)
    : FlatGlbl("global_load_lds_dwordx4", reinterpret_cast<const OpEncoding *>(inst),
               make_exec_fn<GlobalLoadLdsDwordx4FlatGlbl>()),
      vdst(128, OperandType::OPR_VGPR_OR_ACCVGPR, reinterpret_cast<const OpEncoding *>(inst)->vdst),
      addr(64, OperandType::OPR_VGPR, reinterpret_cast<const OpEncoding *>(inst)->addr),
      saddr(64, OperandType::OPR_SREG, reinterpret_cast<const OpEncoding *>(inst)->saddr) {
  dst_operands_[0] = &vdst;
...
void GlobalLoadLdsDwordx4FlatGlbl::execute_impl(amdgpu::Wavefront &wf) {
  (void)wf;
  throw util::UnimplementedInst(mnemonic());
}

GlobalLoadLdsDwordx3FlatGlbl::GlobalLoadLdsDwordx3FlatGlbl(const MachineInst *inst)
    : FlatGlbl("global_load_lds_dwordx3", reinterpret_cast<const OpEncoding *>(inst),
               make_exec_fn<GlobalLoadLdsDwordx3FlatGlbl>()),
      vdst(96, OperandType::OPR_VGPR_OR_ACCVGPR, reinterpret_cast<const OpEncoding *>(inst)->vdst),
      addr(64, OperandType::OPR_VGPR, reinterpret_cast<const OpEncoding *>(inst)->addr),
      saddr(64, OperandType::OPR_SREG, reinterpret_cast<const OpEncoding *>(inst)->saddr) {
  dst_operands_[0] = &vdst;
...
void GlobalLoadLdsDwordx3FlatGlbl::execute_impl(amdgpu::Wavefront &wf) {
  (void)wf;
  throw util::UnimplementedInst(mnemonic());
}
