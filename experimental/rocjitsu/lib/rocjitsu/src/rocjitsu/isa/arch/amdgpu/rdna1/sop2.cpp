...
void SAddU32Sop2::execute(amdgpu::Wavefront &wf) { amdgpu::execute_s_add_u32_sop2(*this, wf); }
...
void SSubU32Sop2::execute(amdgpu::Wavefront &wf) { amdgpu::execute_s_sub_u32_sop2(*this, wf); }
...
void SAddI32Sop2::execute(amdgpu::Wavefront &wf) { amdgpu::execute_s_add_i32_sop2(*this, wf); }
...
void SSubI32Sop2::execute(amdgpu::Wavefront &wf) { amdgpu::execute_s_sub_i32_sop2(*this, wf); }
...
void SAddcU32Sop2::execute(amdgpu::Wavefront &wf) { amdgpu::execute_s_addc_u32_sop2(*this, wf); }
...
void SSubbU32Sop2::execute(amdgpu::Wavefront &wf) { amdgpu::execute_s_subb_u32_sop2(*this, wf); }
...
void SAndn2B32Sop2::execute(amdgpu::Wavefront &wf) { amdgpu::execute_s_andn2_b32_sop2(*this, wf); }
...
void SAndn2B64Sop2::execute(amdgpu::Wavefront &wf) { amdgpu::execute_s_andn2_b64_sop2(*this, wf); }
...
void SOrn2B32Sop2::execute(amdgpu::Wavefront &wf) { amdgpu::execute_s_orn2_b32_sop2(*this, wf); }
...
void SOrn2B64Sop2::execute(amdgpu::Wavefront &wf) { amdgpu::execute_s_orn2_b64_sop2(*this, wf); }
...
SPackLlB32B16Sop2::SPackLlB32B16Sop2(const MachineInst *inst)
    : Sop2("s_pack_ll_b32_b16", reinterpret_cast<const OpEncoding *>(inst)),
      ...
      ssrc1(16, OperandType::OPR_SSRC_NOLDS, reinterpret_cast<const OpEncoding *>(inst)->ssrc1) {
  dst_operands_.emplace_back(&sdst);
  src_operands_.emplace_back(&ssrc0);
  src_operands_.emplace_back(&ssrc1);
  if (reinterpret_cast<const OpEncoding *>(inst)->ssrc0 == 255)
