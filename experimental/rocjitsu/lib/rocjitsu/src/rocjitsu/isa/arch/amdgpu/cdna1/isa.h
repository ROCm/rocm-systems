...
/// @brief CDNA1 STATUS register layout (GFX908, one 32-bit scalar register per wavefront).
...
struct Isa {
  ...
  static constexpr uint32_t MAX_ACC_VGPRS_PER_WF = 0; ///< No AccVGPRs in CDNA1.
  ...
  using StatusReg = cdna1::StatusReg;
};
