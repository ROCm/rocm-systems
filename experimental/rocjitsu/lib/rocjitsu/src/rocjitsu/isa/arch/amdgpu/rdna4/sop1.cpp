...
void SCmovB32Sop1::implicit_uses(uint8_t wf_size, std::vector<RegisterRef> &uses) const {
  (void)wf_size;
...
void SCmovB64Sop1::implicit_uses(uint8_t wf_size, std::vector<RegisterRef> &uses) const {
  (void)wf_size;
  uses.push_back(RegisterRef{RegClass::SCC, 0, 1});
}
...
void SCtzI32B32Sop1::implicit_defs(uint8_t wf_size, std::vector<RegisterRef> &defs) const {
  (void)wf_size;
  defs.push_back(RegisterRef{RegClass::SCC, 0, 1});
}
...
void SCtzI32B64Sop1::implicit_defs(uint8_t wf_size, std::vector<RegisterRef> &defs) const {
  (void)wf_size;
  defs.push_back(RegisterRef{RegClass::SCC, 0, 1});
}
...
void SClzI32U32Sop1::implicit_defs(uint8_t wf_size, std::vector<RegisterRef> &defs) const {
  (void)wf_size;
  defs.push_back(RegisterRef{RegClass::SCC, 0, 1});
}
...
void SClzI32U64Sop1::implicit_defs(uint8_t wf_size, std::vector<RegisterRef> &defs) const {
  (void)wf_size;
  defs.push_back(RegisterRef{RegClass::SCC, 0, 1});
}
...
void SClsI32Sop1::implicit_defs(uint8_t wf_size, std::vector<RegisterRef> &defs) const {
  (void)wf_size;
  defs.push_back(RegisterRef{RegClass::SCC, 0, 1});
}
...
void SClsI32I64Sop1::implicit_defs(uint8_t wf_size, std::vector<RegisterRef> &defs) const {
  (void)wf_size;
  defs.push_back(RegisterRef{RegClass::SCC, 0, 1});
}
...
void SAndSaveexecB32Sop1::implicit_defs(uint8_t wf_size, std::vector<RegisterRef> &defs) const {
  defs.push_back(RegisterRef{RegClass::SCC, 0, 1});
  defs.push_back(RegisterRef{RegClass::EXEC, 0, static_cast<uint8_t>(wf_size > 32 ? 2 : 1)});
}

void SAndSaveexecB32Sop1::implicit_uses(uint8_t wf_size, std::vector<RegisterRef> &uses) const {
...
void SAndSaveexecB64Sop1::implicit_defs(uint8_t wf_size, std::vector<RegisterRef> &defs) const {
  defs.push_back(RegisterRef{RegClass::SCC, 0, 1});
  defs.push_back(RegisterRef{RegClass::EXEC, 0, static_cast<uint8_t>(wf_size > 32 ? 2 : 1)});
}

void SAndSaveexecB64Sop1::implicit_uses(uint8_t wf_size, std::vector<RegisterRef> &uses) const {
  uses.push_back(RegisterRef{RegClass::EXEC, 0, static_cast<uint8_t>(wf_size > 32 ? 2 : 1)});
}
...
void SOrSaveexecB32Sop1::implicit_defs(uint8_t wf_size, std::vector<RegisterRef> &defs) const {
  defs.push_back(RegisterRef{RegClass::SCC, 0, 1});
  defs.push_back(RegisterRef{RegClass::EXEC, 0, static_cast<uint8_t>(wf_size > 32 ? 2 : 1)});
}

void SOrSaveexecB32Sop1::implicit_uses(uint8_t wf_size, std::vector<RegisterRef> &uses) const {
  uses.push_back(RegisterRef{RegClass::EXEC, 0, static_cast<uint8_t>(wf_size > 32 ? 2 : 1)});
}
...
void SOrSaveexecB64Sop1::implicit_defs(uint8_t wf_size, std::vector<RegisterRef> &defs) const {
  defs.push_back(RegisterRef{RegClass::SCC, 0, 1});
  defs.push_back(RegisterRef{RegClass::EXEC, 0, static_cast<uint8_t>(wf_size > 32 ? 2 : 1)});
}

void SOrSaveexecB64Sop1::implicit_uses(uint8_t wf_size, std::vector<RegisterRef> &uses) const {
  uses.push_back(RegisterRef{RegClass::EXEC, 0, static_cast<uint8_t>(wf_size > 32 ? 2 : 1)});
}
...
void SXorSaveexecB32Sop1::implicit_defs(uint8_t wf_size, std::vector<RegisterRef> &defs) const {
  defs.push_back(RegisterRef{RegClass::SCC, 0, 1});
  defs.push_back(RegisterRef{RegClass::EXEC, 0, static_cast<uint8_t>(wf_size > 32 ? 2 : 1)});
}

void SXorSaveexecB32Sop1::implicit_uses(uint8_t wf_size, std::vector<RegisterRef> &uses) const {
  uses.push_back(RegisterRef{RegClass::EXEC, 0, static_cast<uint8_t>(wf_size > 32 ? 2 : 1)});
}
...
void SXorSaveexecB64Sop1::implicit_defs(uint8_t wf_size, std::vector<RegisterRef> &defs) const {
  defs.push_back(RegisterRef{RegClass::SCC, 0, 1});
  defs.push_back(RegisterRef{RegClass::EXEC, 0, static_cast<uint8_t>(wf_size > 32 ? 2 : 1)});
}

void SXorSaveexecB64Sop1::implicit_uses(uint8_t wf_size, std::vector<RegisterRef> &uses) const {
  uses.push_back(RegisterRef{RegClass::EXEC, 0, static_cast<uint8_t>(wf_size > 32 ? 2 : 1)});
}
...
void SNandSaveexecB32Sop1::implicit_defs(uint8_t wf_size, std::vector<RegisterRef> &defs) const {
  defs.push_back(RegisterRef{RegClass::SCC, 0, 1});
  defs.push_back(RegisterRef{RegClass::EXEC, 0, static_cast<uint8_t>(wf_size > 32 ? 2 : 1)});
}

void SNandSaveexecB32Sop1::implicit_uses(uint8_t wf_size, std::vector<RegisterRef> &uses) const {
  uses.push_back(RegisterRef{RegClass::EXEC, 0, static_cast<uint8_t>(wf_size > 32 ? 2 : 1)});
}
...
void SNandSaveexecB64Sop1::implicit_defs(uint8_t wf_size, std::vector<RegisterRef> &defs) const {
  defs.push_back(RegisterRef{RegClass::SCC, 0, 1});
  defs.push_back(RegisterRef{RegClass::EXEC, 0, static_cast<uint8_t>(wf_size > 32 ? 2 : 1)});
}

void SNandSaveexecB64Sop1::implicit_uses(uint8_t wf_size, std::vector<RegisterRef> &uses) const {
  uses.push_back(RegisterRef{RegClass::EXEC, 0, static_cast<uint8_t>(wf_size > 32 ? 2 : 1)});
}
...
void SNorSaveexecB32Sop1::implicit_defs(uint8_t wf_size, std::vector<RegisterRef> &defs) const {
  defs.push_back(RegisterRef{RegClass::SCC, 0, 1});
  defs.push_back(RegisterRef{RegClass::EXEC, 0, static_cast<uint8_t>(wf_size > 32 ? 2 : 1)});
}

void SNorSaveexecB32Sop1::implicit_uses(uint8_t wf_size, std::vector<RegisterRef> &uses) const {
  uses.push_back(RegisterRef{RegClass::EXEC, 0, static_cast<uint8_t>(wf_size > 32 ? 2 : 1)});
}
...
void SNorSaveexecB64Sop1::implicit_defs(uint8_t wf_size, std::vector<RegisterRef> &defs) const {
  defs.push_back(RegisterRef{RegClass::SCC, 0, 1});
  defs.push_back(RegisterRef{RegClass::EXEC, 0, static_cast<uint8_t>(wf_size > 32 ? 2 : 1)});
}

void SNorSaveexecB64Sop1::implicit_uses(uint8_t wf_size, std::vector<RegisterRef> &uses) const {
  uses.push_back(RegisterRef{RegClass::EXEC, 0, static_cast<uint8_t>(wf_size > 32 ? 2 : 1)});
}
...
void SXnorSaveexecB32Sop1::implicit_defs(uint8_t wf_size, std::vector<RegisterRef> &defs) const {
  defs.push_back(RegisterRef{RegClass::SCC, 0, 1});
  defs.push_back(RegisterRef{RegClass::EXEC, 0, static_cast<uint8_t>(wf_size > 32 ? 2 : 1)});
}

void SXnorSaveexecB32Sop1::implicit_uses(uint8_t wf_size, std::vector<RegisterRef> &uses) const {
  uses.push_back(RegisterRef{RegClass::EXEC, 0, static_cast<uint8_t>(wf_size > 32 ? 2 : 1)});
}
...
void SXnorSaveexecB64Sop1::implicit_defs(uint8_t wf_size, std::vector<RegisterRef> &defs) const {
  defs.push_back(RegisterRef{RegClass::SCC, 0, 1});
  defs.push_back(RegisterRef{RegClass::EXEC, 0, static_cast<uint8_t>(wf_size > 32 ? 2 : 1)});
}

void SXnorSaveexecB64Sop1::implicit_uses(uint8_t wf_size, std::vector<RegisterRef> &uses) const {
  uses.push_back(RegisterRef{RegClass::EXEC, 0, static_cast<uint8_t>(wf_size > 32 ? 2 : 1)});
}
...
void SAndNot0SaveexecB32Sop1::implicit_defs(uint8_t wf_size, std::vector<RegisterRef> &defs) const {
  defs.push_back(RegisterRef{RegClass::SCC, 0, 1});
  defs.push_back(RegisterRef{RegClass::EXEC, 0, static_cast<uint8_t>(wf_size > 32 ? 2 : 1)});
}

void SAndNot0SaveexecB32Sop1::implicit_uses(uint8_t wf_size, std::vector<RegisterRef> &uses) const {
  uses.push_back(RegisterRef{RegClass::EXEC, 0, static_cast<uint8_t>(wf_size > 32 ? 2 : 1)});
}
...
void SAndNot0SaveexecB64Sop1::implicit_defs(uint8_t wf_size, std::vector<RegisterRef> &defs) const {
  defs.push_back(RegisterRef{RegClass::SCC, 0, 1});
  defs.push_back(RegisterRef{RegClass::EXEC, 0, static_cast<uint8_t>(wf_size > 32 ? 2 : 1)});
}

void SAndNot0SaveexecB64Sop1::implicit_uses(uint8_t wf_size, std::vector<RegisterRef> &uses) const {
  uses.push_back(RegisterRef{RegClass::EXEC, 0, static_cast<uint8_t>(wf_size > 32 ? 2 : 1)});
}
...
void SOrNot0SaveexecB32Sop1::implicit_defs(uint8_t wf_size, std::vector<RegisterRef> &defs) const {
  defs.push_back(RegisterRef{RegClass::SCC, 0, 1});
  defs.push_back(RegisterRef{RegClass::EXEC, 0, static_cast<uint8_t>(wf_size > 32 ? 2 : 1)});
}

void SOrNot0SaveexecB32Sop1::implicit_uses(uint8_t wf_size, std::vector<RegisterRef> &uses) const {
  uses.push_back(RegisterRef{RegClass::EXEC, 0, static_cast<uint8_t>(wf_size > 32 ? 2 : 1)});
}
...
void SOrNot0SaveexecB64Sop1::implicit_defs(uint8_t wf_size, std::vector<RegisterRef> &defs) const {
  defs.push_back(RegisterRef{RegClass::SCC, 0, 1});
  defs.push_back(RegisterRef{RegClass::EXEC, 0, static_cast<uint8_t>(wf_size > 32 ? 2 : 1)});
}

void SOrNot0SaveexecB64Sop1::implicit_uses(uint8_t wf_size, std::vector<RegisterRef> &uses) const {
  uses.push_back(RegisterRef{RegClass::EXEC, 0, static_cast<uint8_t>(wf_size > 32 ? 2 : 1)});
}
...
void SAndNot1SaveexecB32Sop1::implicit_defs(uint8_t wf_size, std::vector<RegisterRef> &defs) const {
  defs.push_back(RegisterRef{RegClass::SCC, 0, 1});
  defs.push_back(RegisterRef{RegClass::EXEC, 0, static_cast<uint8_t>(wf_size > 32 ? 2 : 1)});
}

void SAndNot1SaveexecB32Sop1::implicit_uses(uint8_t wf_size, std::vector<RegisterRef> &uses) const {
  uses.push_back(RegisterRef{RegClass::EXEC, 0, static_cast<uint8_t>(wf_size > 32 ? 2 : 1)});
}
...
void SAndNot1SaveexecB64Sop1::implicit_defs(uint8_t wf_size, std::vector<RegisterRef> &defs) const {
  defs.push_back(RegisterRef{RegClass::SCC, 0, 1});
  defs.push_back(RegisterRef{RegClass::EXEC, 0, static_cast<uint8_t>(wf_size > 32 ? 2 : 1)});
}

void SAndNot1SaveexecB64Sop1::implicit_uses(uint8_t wf_size, std::vector<RegisterRef> &uses) const {
  uses.push_back(RegisterRef{RegClass::EXEC, 0, static_cast<uint8_t>(wf_size > 32 ? 2 : 1)});
}
...
void SOrNot1SaveexecB32Sop1::implicit_defs(uint8_t wf_size, std::vector<RegisterRef> &defs) const {
  defs.push_back(RegisterRef{RegClass::SCC, 0, 1});
  defs.push_back(RegisterRef{RegClass::EXEC, 0, static_cast<uint8_t>(wf_size > 32 ? 2 : 1)});
}

void SOrNot1SaveexecB32Sop1::implicit_uses(uint8_t wf_size, std::vector<RegisterRef> &uses) const {
  uses.push_back(RegisterRef{RegClass::EXEC, 0, static_cast<uint8_t>(wf_size > 32 ? 2 : 1)});
}
...
void SOrNot1SaveexecB64Sop1::implicit_defs(uint8_t wf_size, std::vector<RegisterRef> &defs) const {
  defs.push_back(RegisterRef{RegClass::SCC, 0, 1});
  defs.push_back(RegisterRef{RegClass::EXEC, 0, static_cast<uint8_t>(wf_size > 32 ? 2 : 1)});
}

void SOrNot1SaveexecB64Sop1::implicit_uses(uint8_t wf_size, std::vector<RegisterRef> &uses) const {
  uses.push_back(RegisterRef{RegClass::EXEC, 0, static_cast<uint8_t>(wf_size > 32 ? 2 : 1)});
}
...
void SAndNot0WrexecB32Sop1::implicit_defs(uint8_t wf_size, std::vector<RegisterRef> &defs) const {
  defs.push_back(RegisterRef{RegClass::EXEC, 0, static_cast<uint8_t>(wf_size > 32 ? 2 : 1)});
}

void SAndNot0WrexecB32Sop1::implicit_uses(uint8_t wf_size, std::vector<RegisterRef> &uses) const {
  uses.push_back(RegisterRef{RegClass::EXEC, 0, static_cast<uint8_t>(wf_size > 32 ? 2 : 1)});
}
...
void SAndNot0WrexecB64Sop1::implicit_defs(uint8_t wf_size, std::vector<RegisterRef> &defs) const {
  defs.push_back(RegisterRef{RegClass::EXEC, 0, static_cast<uint8_t>(wf_size > 32 ? 2 : 1)});
}

void SAndNot0WrexecB64Sop1::implicit_uses(uint8_t wf_size, std::vector<RegisterRef> &uses) const {
  uses.push_back(RegisterRef{RegClass::EXEC, 0, static_cast<uint8_t>(wf_size > 32 ? 2 : 1)});
}
...
void SAndNot1WrexecB32Sop1::implicit_defs(uint8_t wf_size, std::vector<RegisterRef> &defs) const {
  defs.push_back(RegisterRef{RegClass::EXEC, 0, static_cast<uint8_t>(wf_size > 32 ? 2 : 1)});
}

void SAndNot1WrexecB32Sop1::implicit_uses(uint8_t wf_size, std::vector<RegisterRef> &uses) const {
  uses.push_back(RegisterRef{RegClass::EXEC, 0, static_cast<uint8_t>(wf_size > 32 ? 2 : 1)});
}
...
void SAndNot1WrexecB64Sop1::implicit_defs(uint8_t wf_size, std::vector<RegisterRef> &defs) const {
  defs.push_back(RegisterRef{RegClass::EXEC, 0, static_cast<uint8_t>(wf_size > 32 ? 2 : 1)});
}

void SAndNot1WrexecB64Sop1::implicit_uses(uint8_t wf_size, std::vector<RegisterRef> &uses) const {
  uses.push_back(RegisterRef{RegClass::EXEC, 0, static_cast<uint8_t>(wf_size > 32 ? 2 : 1)});
}
...
void SCeilF32Sop1::implicit_defs(uint8_t wf_size, std::vector<RegisterRef> &defs) const {
  (void)wf_size;
  defs.push_back(RegisterRef{RegClass::SCC, 0, 1});
}
...
void SFloorF32Sop1::implicit_defs(uint8_t wf_size, std::vector<RegisterRef> &defs) const {
  (void)wf_size;
  defs.push_back(RegisterRef{RegClass::SCC, 0, 1});
}
...
void STruncF32Sop1::implicit_defs(uint8_t wf_size, std::vector<RegisterRef> &defs) const {
  (void)wf_size;
  defs.push_back(RegisterRef{RegClass::SCC, 0, 1});
}
...
void SRndneF32Sop1::implicit_defs(uint8_t wf_size, std::vector<RegisterRef> &defs) const {
  (void)wf_size;
  defs.push_back(RegisterRef{RegClass::SCC, 0, 1});
}
...
void SCvtF32I32Sop1::implicit_defs(uint8_t wf_size, std::vector<RegisterRef> &defs) const {
  (void)wf_size;
  defs.push_back(RegisterRef{RegClass::SCC, 0, 1});
}
...
void SCvtF32U32Sop1::implicit_defs(uint8_t wf_size, std::vector<RegisterRef> &defs) const {
  (void)wf_size;
  defs.push_back(RegisterRef{RegClass::SCC, 0, 1});
}
...
void SCvtI32F32Sop1::implicit_defs(uint8_t wf_size, std::vector<RegisterRef> &defs) const {
  (void)wf_size;
  defs.push_back(RegisterRef{RegClass::SCC, 0, 1});
}
...
void SCvtU32F32Sop1::implicit_defs(uint8_t wf_size, std::vector<RegisterRef> &defs) const {
  (void)wf_size;
  defs.push_back(RegisterRef{RegClass::SCC, 0, 1});
}
...
void SCvtF16F32Sop1::implicit_defs(uint8_t wf_size, std::vector<RegisterRef> &defs) const {
  (void)wf_size;
  defs.push_back(RegisterRef{RegClass::SCC, 0, 1});
}
...
void SCvtF32F16Sop1::implicit_defs(uint8_t wf_size, std::vector<RegisterRef> &defs) const {
  (void)wf_size;
  defs.push_back(RegisterRef{RegClass::SCC, 0, 1});
}
...
void SCvtHiF32F16Sop1::implicit_defs(uint8_t wf_size, std::vector<RegisterRef> &defs) const {
  (void)wf_size;
  defs.push_back(RegisterRef{RegClass::SCC, 0, 1});
}
...
void SCeilF16Sop1::implicit_defs(uint8_t wf_size, std::vector<RegisterRef> &defs) const {
  (void)wf_size;
  defs.push_back(RegisterRef{RegClass::SCC, 0, 1});
}
...
void SFloorF16Sop1::implicit_defs(uint8_t wf_size, std::vector<RegisterRef> &defs) const {
  (void)wf_size;
  defs.push_back(RegisterRef{RegClass::SCC, 0, 1});
}
...
void STruncF16Sop1::implicit_defs(uint8_t wf_size, std::vector<RegisterRef> &defs) const {
  (void)wf_size;
  defs.push_back(RegisterRef{RegClass::SCC, 0, 1});
}
...
void SRndneF16Sop1::implicit_defs(uint8_t wf_size, std::vector<RegisterRef> &defs) const {
  (void)wf_size;
  defs.push_back(RegisterRef{RegClass::SCC, 0, 1});
}
