...
class GlobalLoadLdsDwordx4FlatGlbl : public FlatGlbl {
public:
  GlobalLoadLdsDwordx4FlatGlbl(const MachineInst *inst);
  void execute_impl(amdgpu::Wavefront &wf);
  Operand vdst;
  Operand addr;
  Operand saddr;
...
class GlobalLoadLdsDwordx3FlatGlbl : public FlatGlbl {
public:
  GlobalLoadLdsDwordx3FlatGlbl(const MachineInst *inst);
  void execute_impl(amdgpu::Wavefront &wf);
  Operand vdst;
  Operand addr;
  Operand saddr;
