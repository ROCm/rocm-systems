...
#ifndef ROCJITSU_ISA_ARCH_AMDGPU_RDNA2_ADDR_CALC_H_
#define ROCJITSU_ISA_ARCH_AMDGPU_RDNA2_ADDR_CALC_H_

/// @file Address calculation stubs for RDNA2 memory instructions.
///
/// Phase A stubs — implementations are placeholders. Phase B will provide
/// correct address calculation logic for the GFX10.3 memory model.
...
#endif // ROCJITSU_ISA_ARCH_AMDGPU_RDNA2_ADDR_CALC_H_
