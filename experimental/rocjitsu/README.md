...
are autogenerated from the MR ISA XML specification. Download `amdgpu_isa_cdna4.xml`
from the [GPUOpen Machine-Readable ISA download page](https://gpuopen.com/download/machine-readable-isa/latest/).
To fetch and unpack the latest archive directly into the repo, run:
...
python -m amdisa --gen-all \
  ...
  third_party/machine-readable-isa/amdgpu_isa_cdna4.xml
