...
def main():
    og_dir = '/home/ben/rocm-systems/perf-pmu-stub/src/aql_c/tools/og_pm4'
    new_dir = '/home/ben/rocm-systems/perf-pmu-stub/src/aql_c/tools/new_pm4'
    ...
    # Write report
    with open('/home/ben/rocm-systems/perf-pmu-stub/src/aql_c/tools/report.txt', 'w') as f:
        f.write('\n'.join(report_lines))
