/*
 * kfd_test.c - KFD ioctl test implementation for perf-pmu-stub
 *
...
/* KFD ioctl test result structure */
...
/* Export symbols for use by other parts of the module */
EXPORT_SYMBOL_GPL(kfd_test_get_version);
EXPORT_SYMBOL_GPL(kfd_test_get_result);
EXPORT_SYMBOL_GPL(kfd_test_print_result);