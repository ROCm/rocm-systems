...
TEST(RaceDetector, LdsSameWave_AllLanesWriteSameAddr) {
  ...
  // TODO: WAW detection is not implemented — this documents current behavior.
  RaceTestBuilder b(/*numWaves=*/1, /*vgprs=*/8, /*sgprs=*/8);
  b.ldsWrite(/*wave=*/0, /*lane=*/0, /*addr=*/0, /*bytes=*/4);
...
static void crossWaveExecTest(int lgkmcnt1, int lgkmcnt2, bool barrier1,
                              bool barrier2, bool expectFirstReadRace,
                              bool expectSecondReadRace) {
  RaceTestBuilder b(/*numWaves=*/2, /*vgprs=*/8, /*sgprs=*/8);
