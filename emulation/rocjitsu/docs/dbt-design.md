...
The initial target pairs are CDNA4 (GFX950) → RDNA4 (GFX1200/1201) and
CDNA4 (GFX950) → CDNA3 (GFX942), but the architecture is designed to support
any directional ISA pair.
