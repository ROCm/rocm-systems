...
- Coherency bit remapping (for example GFX940 sc0/sc1/nt -> target cache flags)
...
### CDNA4-to-RDNA3 notes

The CDNA4-to-RDNA3 implementation has pair-specific design notes that record
current coverage, residual unsupported buckets, and matrix/AccVGPR disposition:

- [CDNA4-to-RDNA3 taxonomy](cdna4-to-rdna3-taxonomy.md)
- [CDNA4-to-RDNA3 residual coverage](cdna4-to-rdna3-residual-coverage.md)
- [CDNA4-to-RDNA3 MFMA and AccVGPR strategy](cdna4-to-rdna3-mfma-accvgpr-strategy.md)
