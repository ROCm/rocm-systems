...
| `RJ_CONSAN_MAX_PATCHED_IMAGE_GROWTH_BYTES=N` | `469762048` (448 MiB) | Bound total additional ELF bytes, including alignment padding, across one code-object transformation. `N` is unsigned decimal; zero permits only no-growth rewrites. |
