...
| P1 | `016_spmm_tdm_all` | 🟩 1610/1610 accesses; current paired 1.15x | 🟩 1610/1610 accesses; 512/512 barriers; current paired 1.24x | 🟩 1610/1610 accesses; 494/494 barriers; current paired 1.19x | 🟥 Current rerun contradicts prior acceptance | Multi-type exact numeric matrix covers both supported transpose widths.  Current one-repetition paired artifact `consan-revalidation-gfx1250-20260720-tensile-spmm-all-all-nullfix-014` accepts the first three profiles and exposes the Inline Shadow regression.  Prior artifact: `consan-validation-gfx1250-tensile-spmm-tdm-all-028`. |
