...
| PyTorch | P2 | Inductor compiled softmax (`pytorch-rdna4-compiled-softmax`) | 🟨 high: clean pass; fault running; same-value writes allowed | 🟨 delay-matrix: clean pass; fault 1/8 (bar 6/8) |
