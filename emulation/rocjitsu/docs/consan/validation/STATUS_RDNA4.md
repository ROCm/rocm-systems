...
| Production HIP | P0 | FP8 matmul (`rdna4-matmul-fp8-production`) | 🟨 Sep 23: clean pass; publication fault 0/8 detections; fault qualification failed; dense clean pass; dense fault missing summary; inspect runner log | 🟩 Sep 23: clean pass; reviewed publication fault 1/8; dense clean failed |
...
| Main E2E | P4 | hip-moi WMMA attention (`wmma-attention`) | 🟨 Sep 23: standard fault 0/8; qualified preset=max alternative: clean pass, fault 8/8 | 🟨 Sep 23: clean pass; grouped publication fault 0/8 detections; fault qualification failed; dense clean failed |
...
- `rdna4-matmul-fp16-production` / default: initial-tile publication fault detects 0/8; admitted 0, reached 0; aggregate accepted=False. Evidence: `/home/benoit/workspace/consan-validation/rdna4-20260923/fault-round6-rdna4-matmul-fp16-production-default`. Final qualification requires comparator/provenance audit.
- `rdna4-matmul-fp16-production` / supercollider: initial-tile publication fault detects 0/8; admitted 0, reached 0; aggregate accepted=False. Evidence: `/home/benoit/workspace/consan-validation/rdna4-20260923/fault-round6-rdna4-matmul-fp16-production-supercollider`. Final qualification requires comparator/provenance audit.
- `rdna4-matmul-fp8-production` / default: initial-tile publication fault detects 0/8; admitted 0, reached 0; aggregate accepted=False. Evidence: `/home/benoit/workspace/consan-validation/rdna4-20260923/fault-round6-rdna4-matmul-fp8-production-default`. Final qualification requires comparator/provenance audit.
- Matmul fault execution correction: completed round-6 FP16 modes and
  FP8 Default had **zero admitted trials**, with host transformation exceeding
  300 seconds before mutation installation. These are transformation timeouts,
...
- FP16 Default round 7: {"accepted": false, "admitted_trials": 8, "attempted_trials": 8, "detection_rate": 0.0, "detection_wilson_95": {"confidence": 0.95, "lower": 0.0, "upper": 0.32440756488388023}, "detections": 0, "detector_policy": "statistical", "oracle_manifestation_rate": 0.0, "oracle_manifestation_wilson_95": {"confidence": 0.95, "lower": 0.0, "upper": 0.32440756488388023}, "oracle_manifestations": 0, "planned_trials": 8, "profile": "default", "reach_outcomes": {"reviewed-unconditional-final-isa": 8}, "reached_trials": 8, "reasons": ["detections=0/8, minimum=1"], "trials": 8}. Evidence: `/home/benoit/workspace/consan-validation/rdna4-20260923/fault-round7-fp16-default/rdna4-matmul-fp16-production/faults/barrier-drop-initial-tile-publication/summary.json`.
- WMMA Default dense clean comparator passes (`preset=max`); evidence `/home/benoit/workspace/consan-validation/rdna4-20260923/clean-round12/wmma-dense-comparator`. Dense fault matrix follows.
- WMMA dense Default fault: {"accepted": true, "admitted_trials": 8, "attempted_trials": 8, "detection_rate": 1.0, "detection_wilson_95": {"confidence": 0.95, "lower": 0.6755924351161198, "upper": 1.0}, "detections": 8, "detector_policy": "statistical", "oracle_manifestation_rate": 0.125, "oracle_manifestation_wilson_95": {"confidence": 0.95, "lower": 0.02241749145005667, "upper": 0.4708881822128535}, "oracle_manifestations": 1, "planned_trials": 8, "profile": "default", "reach_outcomes": {"detector-owned-runtime-diagnostic": 8}, "reached_trials": 8, "reasons": [], "trials": 8}. Evidence: `/home/benoit/workspace/consan-validation/rdna4-20260923/fault-round8-wmma-dense/wmma-attention/faults/barrier-drop-kv-publication-group-dense-diagnostic/summary.json`. Separate sampling configuration; original standard-profile misses retained.
- WMMA dense Default qualification audit passes: clean 82/82 access and
  36/36 barrier coverage, eight admitted/reached/detected grouped-fault trials,
  all health checks pass and no report overflow. One faulty trial has a numeric
  manifestation. Hook, executable, allowlist and tool hashes match between
...
- FP16 SuperCollider round 7: {"accepted": false, "admitted_trials": 8, "attempted_trials": 8, "detection_rate": 0.0, "detection_wilson_95": {"confidence": 0.95, "lower": 0.0, "upper": 0.32440756488388023}, "detections": 0, "detector_policy": "statistical", "oracle_manifestation_rate": 0.0, "oracle_manifestation_wilson_95": {"confidence": 0.95, "lower": 0.0, "upper": 0.32440756488388023}, "oracle_manifestations": 0, "planned_trials": 8, "profile": "supercollider", "reach_outcomes": {"reviewed-unconditional-final-isa": 8}, "reached_trials": 8, "reasons": ["detections=0/8, minimum=1"], "trials": 8}. Evidence: `/home/benoit/workspace/consan-validation/rdna4-20260923/fault-round7-fp16-supercollider/rdna4-matmul-fp16-production/faults/barrier-drop-initial-tile-publication/summary.json`.
- FP16 Default dense clean comparator passes (`preset=max`); evidence `/home/benoit/workspace/consan-validation/rdna4-20260923/clean-round13/fp16-dense-comparator`. Dense fault matrix follows.
- RMS norm fault review: pristine library code object `fnv1a64:57d125f3f8a0c446` confirms the eight-wave sum publication pair at `.text+0x1824/0x1830`, between the lane-zero LDS stores and peer-wave loads. Precommitted `barrier-drop-wave-sum-publication` requires at least one detection per eight standard-profile trials. Live qualification remains pending; review artifacts: `/home/benoit/workspace/consan-validation/rdna4-20260923/llama-rms-debug/`.
- Execution queue: FP8 standard clean comparators and fault matrices follow the running FP16 dense matrix, using the fixed hook; RMS norm follows FP8 with fresh clean comparators and its precommitted publication fault (`d328a5713b3`). Each completed clean or fault cell updates this ledger and commits locally.
- D128 block fault review: release code object `fnv1a64:51455fdce9fbef23` contains two physical publication pairs for one logical K-fragment barrier (`.text+0x554f0/0x55508` and `0x5551c/0x55520`), between subgroup-zero stores and all-wave loads. Precommitted grouped fault removes both pairs and retains the reuse barrier; standard qualification remains pending. Review artifacts: `/home/benoit/workspace/consan-validation/rdna4-20260923/d128-debug/`.
- FP16 dense Default fault: {"accepted": true, "admitted_trials": 8, "attempted_trials": 8, "detection_rate": 1.0, "detection_wilson_95": {"confidence": 0.95, "lower": 0.6755924351161198, "upper": 1.0}, "detections": 8, "detector_policy": "statistical", "oracle_manifestation_rate": 0.0, "oracle_manifestation_wilson_95": {"confidence": 0.95, "lower": 0.0, "upper": 0.32440756488388023}, "oracle_manifestations": 0, "planned_trials": 8, "profile": "default", "reach_outcomes": {"detector-owned-runtime-diagnostic": 8}, "reached_trials": 8, "reasons": [], "trials": 8}. Evidence: `/home/benoit/workspace/consan-validation/rdna4-20260923/fault-round9-fp16-dense/rdna4-matmul-fp16-production/faults/barrier-drop-initial-tile-publication-dense-diagnostic/summary.json`. Separate sampling configuration; original standard-profile misses retained.
- FP16 dense Default qualification audit passed: matching clean/fault executable, hook, allowlist and source hashes; all trials admitted/reached, complete without overflow, and healthy before/after. Detects 8/8; standard sampling remains unqualified. Audit: `/home/benoit/workspace/consan-validation/rdna4-20260923/fault-round9-fp16-dense/rdna4-matmul-fp16-production/faults/barrier-drop-initial-tile-publication-dense-diagnostic/qualification-audit.json`.
- `rdna4-matmul-fp8-production` / default: fresh clean pass; fault qualification pending. Evidence: `/home/benoit/workspace/consan-validation/rdna4-20260923/clean-round14/rdna4-matmul-fp8-production-default`.
- `rdna4-matmul-fp8-production` / supercollider: fresh clean pass; fault qualification pending. Evidence: `/home/benoit/workspace/consan-validation/rdna4-20260923/clean-round14/rdna4-matmul-fp8-production-supercollider`.
- FP8 Default current fault progress: 5/8 trials complete, 0 detections; mutation now installs after the host transformation fix. Full result pending. Evidence: `/home/benoit/workspace/consan-validation/rdna4-20260923/fault-round10-rdna4-matmul-fp8-production-default`.
- Sampling follow-ups precommitted in `b37cfd1041b`: explicit SuperCollider workgroup/cell stride 1 for WMMA and both matmuls, plus FP8 Default `preset=max`, each with a matching clean comparator. All 197 validation-runner tests passed. Runs are serialized after RMS norm and D128 standard cells; standard misses remain separate. Runner test log: `/home/benoit/workspace/consan-validation/rdna4-20260923/sc-sampling-runner-tests.log`.
- Compiled-softmax fault review: native-selected Triton ELF `fnv1a64:dc46cdfe6cf1810e` matches the clean log. Its two-wave maximum publication barrier at `.text+0x168/0x16c` separates LDS stores from peer-wave reads. Precommitted `barrier-drop-wave-max-publication` requires detection in each standard-profile matrix. Live fault qualification remains pending; artifacts: `/home/benoit/workspace/consan-validation/rdna4-20260923/softmax-debug/`.
- `rdna4-matmul-fp8-production` / default: initial-tile publication fault detects 0/8; admitted 8, reached 8; aggregate accepted=False. Evidence: `/home/benoit/workspace/consan-validation/rdna4-20260923/fault-round10-rdna4-matmul-fp8-production-default`. Final qualification requires comparator/provenance audit.
- Split-softmax fault review: native-selected ELF `fnv1a64:045c766e416734e6` matches the clean log. Its eight-wave maximum publication pair at `.text+0xde4/0xe28` separates LDS stores from peer-wave reads after the reduction loop. Precommitted standard-profile fault matrices; live qualification remains pending. Review artifacts: `/home/benoit/workspace/consan-validation/rdna4-20260923/softmax-debug/split.*` and `split-inventory.txt`.
...
- `llama-rdna4-rms-norm` / default: fresh clean pass; fault qualification pending. Evidence: `/home/benoit/workspace/consan-validation/rdna4-20260923/clean-round15/llama-rdna4-rms-norm-default`.
- `llama-rdna4-rms-norm` / supercollider: fresh clean pass; fault qualification pending. Evidence: `/home/benoit/workspace/consan-validation/rdna4-20260923/clean-round15/llama-rdna4-rms-norm-supercollider`.
- `llama-rdna4-rms-norm` / default: wave-sum publication fault detects 0/8; admitted 8, reached 8; aggregate accepted=False. Evidence: `/home/benoit/workspace/consan-validation/rdna4-20260923/fault-round11-llama-rdna4-rms-norm-default`. Final qualification requires comparator/provenance audit.
- `llama-rdna4-rms-norm` / supercollider: wave-sum publication fault detects 0/8; admitted 8, reached 8; aggregate accepted=False. Evidence: `/home/benoit/workspace/consan-validation/rdna4-20260923/fault-round11-llama-rdna4-rms-norm-supercollider`. Final qualification requires comparator/provenance audit.
- `d128-block` / default: fresh clean pass; fault qualification pending. Evidence: `/home/benoit/workspace/consan-validation/rdna4-20260923/clean-round16/d128-block-default`.
- `d128-block` / supercollider: fresh clean pass; fault qualification pending. Evidence: `/home/benoit/workspace/consan-validation/rdna4-20260923/clean-round16/d128-block-supercollider`.
- RMS norm sampling diagnosis: all eight fault trials in each standard mode recorded zero sampled access/sync events. Precommitted dense Default and SuperCollider comparisons preserve the original mutation and eight-trial thresholds, with fresh clean comparators. These address sampling coverage; standard-profile misses remain recorded.
...
- D128 pressure fault review: native-selected ELF `fnv1a64:dae0bb24d0c25859` matches clean evidence. FullKvDoubleBuffered16Key/FastContextPolicy publishes cooperatively staged K/V fragments through two physical pairs (`.text+0x41768/0x4178c`, `0x417a0/0x417a4`) before peer-wave reads. Precommitted grouped fault; live qualification pending. Artifacts: `/home/benoit/workspace/consan-validation/rdna4-20260923/pressure-debug/`.
...
- `pytorch-rdna4-compiled-softmax` / supercollider: fresh clean pass; fault qualification pending. Evidence: `/home/benoit/workspace/consan-validation/rdna4-20260923/clean-round18/pytorch-rdna4-compiled-softmax-supercollider`.
