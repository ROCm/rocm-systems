...
- Fresh clean assessments: **37/42**; no cell has completed fresh fault qualification.
...
| Main E2E | P4 | hip-moi Stream-K arrival (`streamk-arrival`) | 🟥 Sep 23: no applicable code object; analysis incomplete | 🟩 exact; 4/4 accesses; fault bundle |
