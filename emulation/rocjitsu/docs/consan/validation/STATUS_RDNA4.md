...
| PyTorch | P2 | Qwen-vocabulary top-k (`pytorch-rdna4-llm-topk`) | 🟨 max: clean pass; fault 0/1 (bar 6/8) | 🟨 Clean pass; reviewed fault ready; delay-matrix qualification queued |
...
| Main E2E | P4 | hip-moi Jakub attention (`jakub-attention`) | 🟨 default: clean pass; fault running | 🟨 Clean pass; reviewed fault ready; delay-matrix qualification queued |
