...
| PyTorch | P2 | split online softmax (`pytorch-rdna4-split-softmax`) | 🟨 high: clean pass; fault running; same-value writes allowed | 🟩 delay matrix: fault 8/8; matching clean controls pass |
