...
| Main E2E | P4 | hip-moi tree atomic-OR (`tree-atomic-or`) | 🟨 high: clean pass; fault running | 🟨 Clean pass; atomic-scope fault applies offline; GPU qualification queued |
