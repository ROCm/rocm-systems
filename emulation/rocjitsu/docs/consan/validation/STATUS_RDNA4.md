...
| Main E2E | P4 | hip-moi Stream-K arrival (`streamk-arrival`) | 🟨 high: clean pass; fault 0/8 (bar 6/8) | 🟨 Clean pass; atomic-scope fault applies offline; GPU qualification queued |
