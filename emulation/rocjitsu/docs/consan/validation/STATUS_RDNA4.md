...
| PyTorch | P2 | Qwen-vocabulary top-k (`pytorch-rdna4-llm-topk`) | 🟨 max: clean pass; fault running | 🟨 Clean pass; reviewed fault ready; delay-matrix qualification queued |
