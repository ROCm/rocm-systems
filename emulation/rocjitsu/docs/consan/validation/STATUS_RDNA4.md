...
| PyTorch | P2 | Qwen-vocabulary top-k (`pytorch-rdna4-llm-topk`) | 🟨 Clean pass; fault not admitted; canonical-owner selector retry pending | 🟨 Clean pass; reviewed fault ready; delay-matrix qualification queued |
...
| Main E2E | P3 | Sharktank CLIP BF16 (`clip-bf16`) | 🟨 default: clean pass; fault 0/8 (bar 6/8) | 🟨 Clean pass; reviewed fault ready; delay=0 qualification queued |
