...
| PyTorch | P2 | Inductor compiled softmax (`pytorch-rdna4-compiled-softmax`) | 🟩 higher (lowest passing): clean pass; fault 8/8 (bar 6/8); same-value writes allowed | 🟨 sleep=1: clean pass; fault 4/8 (bar 6/8); same-value writes allowed; [delay experiments](SC_SENSITIVITY_RDNA4_20260924.md) below bar |
