...
- Fresh clean assessments: **23/42**; no cell has completed fresh fault qualification.
...
| Main E2E | P1 | Sharktank TP1 decode/combined (`tp1-decode-combined`) | 🟥 Sep 23: native rocprofv3 discovery failed; inspect discovery log | 🟩 exact; 704/704 accesses; fault bundle |
