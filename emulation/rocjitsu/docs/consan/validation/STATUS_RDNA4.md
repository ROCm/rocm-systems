...
| PyTorch | P2 | Qwen-vocabulary top-k (`pytorch-rdna4-llm-topk`) | 🟥 Sep 23: no applicable code object; analysis incomplete | 🟥 Sep 23: native rocprofv3 discovery failed; inspect discovery log |
