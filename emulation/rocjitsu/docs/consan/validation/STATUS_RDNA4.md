...
| Main E2E | P1 | Sharktank TP1 decode/combined (`tp1-decode-combined`) | 🟥 Sep 23: missing ConSan analysis verdict; exit 124 (timeout override 300s) | 🟨 Sep 23: fresh clean pass; reviewed fault qualification pending |
