...
| Main E2E | P4 | hip-moi WMMA attention (`wmma-attention`) | 🟨 Sep 23: clean pass; grouped publication fault 0/8 detections; fault qualification failed | 🟨 Sep 23: fresh clean pass; reviewed fault qualification pending |
