...
| Main E2E | P4 | hip-moi Jakub attention (`jakub-attention`) | 🟨 high: clean pass; fault 0/8 (bar 6/8) | 🟨 Clean pass; reviewed fault ready; delay-matrix qualification queued |
