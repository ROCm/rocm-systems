...
| PyTorch | P2 | split online softmax (`pytorch-rdna4-split-softmax`) | 🟨 higher: numeric pass; same-wave write conflicts; explicit same-value policy trials queued | 🟨 Fault 8/8; clean nop=64: pass; comparator audit running |
