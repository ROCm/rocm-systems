...
| Main E2E | P4 | hip-moi tree atomic-OR (`tree-atomic-or`) | 🟨 default: clean pass; fault running | 🟨 Clean pass; atomic-scope fault applies offline; GPU qualification queued |
