...
- Fresh clean assessments: **27/42**; no cell has completed fresh fault qualification.
...
| Main E2E | P3 | Sharktank CLIP BF16 (`clip-bf16`) | 🟥 Sep 23: native rocprofv3 discovery failed; inspect discovery log | 🟩 exact; 85/85 accesses; fault bundle |
