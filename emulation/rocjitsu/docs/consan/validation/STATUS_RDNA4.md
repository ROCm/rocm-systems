...
| Main E2E | P0 | Qwen3-0.6B prefill (`qwen-prefill`) | 🟩 higher: clean pass; fault 8/8 (bar 6/8); lower search: 🟨 low: clean failed | 🟨 NOP delays: fault 0/8; matching sleep-delay calibration queued |
