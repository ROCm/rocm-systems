...
| PyTorch | P0 | `torch.mode` (`pytorch-torch-mode`) | 🟨 higher: clean pass; fault trials running | 🟨 Sep 23: fresh clean pass; reviewed fault qualification pending; prior fault assessment: clean pass; reviewed cross-wave publication fault missed in 8/8 trials |
