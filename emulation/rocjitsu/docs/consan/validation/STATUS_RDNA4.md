...
| PyTorch | P2 | Qwen-vocabulary top-k (`pytorch-rdna4-llm-topk`) | 🟨 higher: clean pass; fault 0/1 (bar 6/8) | 🟨 Clean pass; reviewed fault ready; delay-matrix qualification queued |
