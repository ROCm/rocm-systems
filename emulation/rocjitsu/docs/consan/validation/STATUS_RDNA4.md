...
| Main E2E | P4 | hip-moi D128 block (`d128-block`) | 🟨 higher: clean pass; fault trials running | 🟨 Sep 23: clean pass; publication fault 0/8 detections; fault qualification failed |
