...
| PyTorch | P2 | split online softmax (`pytorch-rdna4-split-softmax`) | 🟨 higher: numeric pass; same-wave write conflicts; explicit same-value policy trials queued | 🟨 Delay matrix: fault 8/8; matching clean delays queued next |
