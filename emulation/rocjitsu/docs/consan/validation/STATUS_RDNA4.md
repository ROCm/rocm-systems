...
| Main E2E | P1 | Sharktank TP1 prefill (`tp1-prefill`) | 🟩 higher (lowest verified): clean pass; fault 8/8 (bar 6/8) | 🟨 delay-matrix: clean pass; fault trials running |
| Main E2E | P1 | Sharktank TP1 decode/combined (`tp1-decode-combined`) | 🟩 higher (lowest passing): clean pass; fault 8/8 (bar 6/8) | 🟨 Clean pass; reviewed fault ready; delay-matrix qualification queued |
...
| PyTorch | P2 | Qwen-vocabulary top-k (`pytorch-rdna4-llm-topk`) | 🟨 Clean pass; canonical-owner fault applies offline; GPU requalification queued | 🟨 Clean pass; reviewed fault ready; delay-matrix qualification queued |
...
| PyTorch | P3 | native histogram (`pytorch-torch-histc`) | 🟨 max: clean pass; fault 0/8 (bar 6/8) | 🟨 Clean pass; reviewed fault ready; delay=0 qualification queued |
