...
| PyTorch | P0 | `torch.mode` (`pytorch-torch-mode`) | 🟩 higher: clean pass; fault 8/8 (bar 6/8); lower search: 🟨 low: clean pass; fault 0/8 (bar 6/8) | 🟨 NOP delays: fault 0/8; matching sleep-delay calibration queued |
