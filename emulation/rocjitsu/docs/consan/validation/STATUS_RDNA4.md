...
| --- | ---: | --- | --- | --- |
| Production HIP | P0 | FP16 matmul (`rdna4-matmul-fp16-production`) | 🟨 Sep 23: clean pass; publication fault 0/8 detections; fault qualification failed | 🟨 Sep 23: fresh clean pass; reviewed fault qualification pending |
