...
- Fresh clean assessments: **19/42**; no cell has completed fresh fault qualification.
...
| Main E2E | P0 | Qwen3-0.6B prefill (`qwen-prefill`) | 🟥 Sep 23: exit 1 | 🟩 exact; 20/20 accesses; fault bundle |
