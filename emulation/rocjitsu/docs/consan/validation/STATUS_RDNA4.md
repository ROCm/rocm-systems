...
- Fresh clean assessments: **33/42**; no cell has completed fresh fault qualification.
...
| Main E2E | P4 | hip-moi D128 pressure (`d128-pressure`) | 🟥 Sep 23: ConSan rejected a code object before execution; exit 92 | 🟩 exact; 12/12 accesses; fault bundle |
