...
| Main E2E | P4 | hip-moi Stream-K arrival (`streamk-arrival`) | 🟨 default: clean pass; fault running | 🟨 Clean pass; atomic-scope fault applies offline; GPU qualification queued |
