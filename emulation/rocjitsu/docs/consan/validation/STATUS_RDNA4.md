...
| Production HIP | P0 | FP8 matmul (`rdna4-matmul-fp8-production`) | 🟨 Sep 23: fresh clean pass; transform fixed, fault matrix running (5/8 complete, 0 detections) | 🟨 Sep 23: fresh clean pass; reviewed fault qualification pending |
