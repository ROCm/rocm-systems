...
| PyTorch | P0 | `torch.mode` (`pytorch-torch-mode`) | 🟩 higher: clean pass; fault 8/8 (bar 6/8); lower search: 🟨 default: clean pass; fault running | 🟨 NOP delays: fault 0/8; matching sleep-delay calibration queued |
