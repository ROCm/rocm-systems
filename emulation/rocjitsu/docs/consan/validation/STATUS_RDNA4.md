...
| PyTorch | P2 | split online softmax (`pytorch-rdna4-split-softmax`) | 🟨 default: clean pass; fault 0/8 (bar 6/8); same-value writes allowed | 🟩 delay matrix: fault 8/8; matching clean controls pass |
