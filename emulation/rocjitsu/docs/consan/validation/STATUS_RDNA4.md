...
| Main E2E | P1 | Sharktank TP1 decode/combined (`tp1-decode-combined`) | 🟨 high: clean pass; fault running | 🟨 Clean pass; reviewed fault ready; delay-matrix qualification queued |
