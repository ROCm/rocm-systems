...
| Main E2E | P4 | hip-moi D128 block (`d128-block`) | 🟨 Sep 23: clean pass; publication fault 0/8 detections; fault qualification failed | 🟨 Sep 23: fresh clean pass; reviewed fault qualification pending |
...
| Main E2E | P4 | hip-moi WMMA attention (`wmma-attention`) | 🟨 Sep 23: standard fault 0/8; qualified preset=max alternative: clean pass, fault 8/8 | 🟨 Sep 23: clean pass; grouped publication fault 0/8 detections; fault qualification failed |
