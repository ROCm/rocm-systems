...
| Main E2E | P0 | Qwen3-0.6B prefill (`qwen-prefill`) | 🟩 higher: clean pass; fault 8/8 (bar 6/8) | 🟨 NOP delays: fault 0/8; matching sleep-delay calibration queued |
...
| Main E2E | P1 | Sharktank TP1 prefill (`tp1-prefill`) | 🟨 higher: clean pass; fault trials running | 🟨 Clean pass; reviewed fault ready; delay-matrix qualification queued |
...
| Main E2E | P4 | hip-moi D128 pressure (`d128-pressure`) | 🟩 higher: clean pass; fault 8/8 (bar 6/8) | 🟨 delay-matrix: clean pass; fault 0/8 (bar 6/8) |
