...
| Production HIP | P0 | FP8 matmul (`rdna4-matmul-fp8-production`) | 🟨 Sep 23: clean pass; publication fault 0/8 detections; fault qualification failed; dense clean pass; dense fault missing summary; inspect runner log | 🟩 Sep 23: clean pass; reviewed publication fault 1/8 |
