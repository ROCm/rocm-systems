...
| llama.cpp | P2 | quantized matvec (`llama-rdna4-mul-mat-vec-q`) | 🟨 higher: clean pass; fault trials running | 🟨 Sep 23: fresh clean pass; reviewed fault qualification pending |
