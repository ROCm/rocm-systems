...
| Main E2E | P4 | hip-moi Stream-K arrival (`streamk-arrival`) | 🟨 high: clean pass; fault running | 🟨 Clean pass; atomic-scope fault applies offline; GPU qualification queued |
