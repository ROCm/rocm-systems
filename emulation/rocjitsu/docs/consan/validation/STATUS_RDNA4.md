...
- Fresh clean assessments: **15/42**; no cell has completed fresh fault qualification.
...
| --- | ---: | --- | --- | --- |
| Production HIP | P0 | FP16 matmul (`rdna4-matmul-fp16-production`) | 🟥 Sep 23: missing ConSan coverage record; exit 124 | 🩶 unassessed |
