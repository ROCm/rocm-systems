...
| PyTorch | P3 | native histogram (`pytorch-torch-histc`) | 🟨 max: clean pass; fault 0/8 (bar 6/8); bank-capacity trial queued | 🟨 delay-zero: clean pass; fault trials running |
