...
| Tensile | P1 | `016_spmm_tdm_all` (`tensile-spmm-tdm-all`) | 🟨 default: all 9 clean objects pass with tensor-DMA coverage; fault trials pending | 🟨 delay-zero: filtered clean pass; fault trials pending |
...
| Tensile | P1 | `007_sk_mxf4gemm_tdm` (`tensile-sk-mxf4gemm-tdm`) | 🟧 tensor loads modeled; all 6 clean shards rejected before execution, allocation triage pending | 🟨 delay-zero: all 6 clean shards pass after address-bank fixes; fault trials pending |
