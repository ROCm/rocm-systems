...
| --- | ---: | --- | --- | --- |
| Main E2E | P0 | Qwen3-0.6B prefill (`qwen-prefill`) | 🟨 default: filtered clean pass; fault trials pending | 🟧 sleep=15: clean run hits 360 s deadline; delay-zero clean previously passed |
