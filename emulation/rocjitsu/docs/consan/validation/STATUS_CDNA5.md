...
| Tensile | P2 | `000_sk_sgemm_quick` (`tensile-sk-sgemm-quick`) | 🟧 high + 1 GiB cap: bank fix: 2/6 full-clean shards pass, 4 pending; untimed matching clean passes; fault trials running | 🟧 sleep_wave=15, untimed: matching clean passes; detector 0/8, oracle failures 8/8; full clean 3/6, 3 large shapes pending |
