...
| Tensile | P0 | `002_sk_mxf8gemm_explicit` (`tensile-sk-mxf8gemm-explicit`) | 🟨 default: clean pass with tensor-DMA coverage (78/78 accesses); fault trials pending | 🟨 delay-zero: filtered clean pass; fault trials pending |
