...
| Tensile | P3 | `015_spmm_f8_ml` (`tensile-spmm-f8-ml`) | 🟨 high: all 3 clean shards pass; tail fault qualification running | 🟧 delay-zero: no mismatches in 6 completed clients per shard; 900 s deadline before all 8 finish |
