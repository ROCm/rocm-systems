...
| Tensile | P1 | `001_sk_mxf8f4gemm_tdm` (`tensile-sk-mxf8f4gemm-tdm`) | 🟨 default: all 3 clean shards pass at 1200 s with complete tensor-DMA coverage; fault trials pending | 🟧 delay-zero: 2/3 clean shards pass; third hits the 300 s client deadline |
...
| Tensile | P1 | `007_sk_mxf4gemm_tdm` (`tensile-sk-mxf4gemm-tdm`) | 🟨 default + 192 MiB report cap: all 6 clean shards pass with complete tensor-DMA coverage; fault trials pending | 🟨 delay-zero: all 6 clean shards pass after address-bank fixes; fault trials pending |
...
| Tensile | P2 | `000_sk_sgemm_quick` (`tensile-sk-sgemm-quick`) | 🟧 profiler discovery: 3/6 shards completed; checkpointed 3600 s retries running | 🟧 profiler discovery: 3/6 shards completed; checkpointed 3600 s retries running |
