...
| Tensile | P2 | `000_sk_sgemm_quick` (`tensile-sk-sgemm-quick`) | 🟧 high + 1 GiB cap: bank fix: 2/6 full-clean shards pass, 4 pending; short matching clean timed out at 577/650 cases; longer untimed qualification running | 🟧 sleep_wave=15: prior fault 0/8 and large-shape timeouts; untimed clean 3/6, 3 large shapes pending; matching untimed fault qualification running |
