...
| Tensile | P2 | `006_sk_hgemm_quick` (`tensile-sk-hgemm-quick`) | 🟨 default: filtered clean pass; exact-artifact fault 0/8; high qualification running | 🟨 delay-zero: filtered clean pass; fault trials pending |
