...
| Tensile | P2 | `005_sk_f8gemm_quick` (`tensile-sk-f8gemm-quick`) | 🟨 default: all 9 clean shards pass at 1800 s; exact fault installation blocked | 🟨 delay-zero: filtered clean pass; fault trials pending |
| Tensile | P2 | `006_sk_hgemm_quick` (`tensile-sk-hgemm-quick`) | 🟨 default: filtered clean pass; exact-artifact replay verified; fault review pending | 🟨 delay-zero: filtered clean pass; fault trials pending |
