...
| Tensile | P2 | `000_sk_sgemm_quick` (`tensile-sk-sgemm-quick`) | 🟧 high + 1 GiB cap: targeted clean pass and fault 8/8; 3 of 6 full-clean shards pass; all 3 larger shards timed out at 14400 s; instrumented metadata-load retry under investigation | 🟧 sleep_wave=15: targeted clean pass and fault 0/8; 3 of 6 full-clean shards pass; all 3 larger shards timed out at 3600 s |
