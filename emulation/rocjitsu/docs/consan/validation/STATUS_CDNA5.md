...
| Main E2E | P4 | hip-moi WMMA attention (`wmma-attention`) | 🟨 default: filtered clean pass; fault 2/8; high calibration next | 🟨 delay-zero: filtered clean pass; fault trials pending |
