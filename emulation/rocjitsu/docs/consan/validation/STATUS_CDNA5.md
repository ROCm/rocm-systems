...
| Tensile | P2 | `000_sk_sgemm_quick` (`tensile-sk-sgemm-quick`) | 🟥 high + 1 GiB cap: targeted fault 8/8; 3 of 6 full-clean shards pass; large shards expose gfx1250 VGPR-bank mismatch in instrumented metadata addressing | 🟧 sleep_wave=15: targeted clean pass and fault 0/8; 3 of 6 full-clean shards pass; all 3 larger shards timed out at 3600 s |
