...
| Tensile | P2 | `000_sk_sgemm_quick` (`tensile-sk-sgemm-quick`) | 🟧 high + 1 GiB cap: bank fix: 3/6 full-clean shards pass, 3 large shapes pending; untimed matching clean passes; 5 fault trials detected, 3 pending | 🟧 sleep_wave=15, untimed: matching clean passes; detector 0/8, oracle failures 8/8; full clean 3/6, 3 large shapes pending |
