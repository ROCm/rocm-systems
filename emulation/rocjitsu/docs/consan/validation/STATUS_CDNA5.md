...
| Tensile | P2 | `000_sk_sgemm_quick` (`tensile-sk-sgemm-quick`) | 🟧 high + 1 GiB cap: bank fix: 2/6 full-clean shards pass, 4 pending; short matching clean timed out at 577/650 cases; longer untimed qualification running | 🟧 sleep_wave=15: targeted clean pass and fault 0/8; 3 of 6 full-clean shards pass; all 3 larger shards timed out at 3600 s; untimed rerun: 3/6 complete clean passes, 3 large shapes pending |
