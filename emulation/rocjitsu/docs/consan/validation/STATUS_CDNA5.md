...
| Tensile | P2 | `000_sk_sgemm_quick` (`tensile-sk-sgemm-quick`) | 🟧 high + 1 GiB cap: targeted clean pass and fault 8/8; 3 of 6 full-clean shards numerically pass; remainder running | 🟧 sleep_wave=15: targeted clean pass and fault 0/8; 3 of 6 full-clean shards pass; all 3 larger shards timed out at 3600 s |
| Tensile | P2 | `005_sk_f8gemm_quick` (`tensile-sk-f8gemm-quick`) | 🟩 high: all 9 clean shards pass; exact-artifact fault 8/8 | 🟨 sleep=15: all 9 clean shards pass with complete coverage; fault 0/8 |
