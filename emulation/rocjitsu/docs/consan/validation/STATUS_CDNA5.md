...
| Tensile | P2 | `006_sk_hgemm_quick` (`tensile-sk-hgemm-quick`) | 🟩 high: all 6 clean shards pass; exact-artifact fault 6/8 | 🟧 sleep=15: matching fault-shard clean pass and fault 0/8; full delayed clean running |
