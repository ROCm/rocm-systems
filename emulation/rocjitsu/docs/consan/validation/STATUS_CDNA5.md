...
| Tensile | P1 | `016_spmm_tdm_all` (`tensile-spmm-tdm-all`) | 🟩 higher + 256 banks: all 4 clean shards pass with complete tensor-DMA coverage; fault 8/8 | 🟨 delay-zero: filtered clean pass; fault trials pending |
