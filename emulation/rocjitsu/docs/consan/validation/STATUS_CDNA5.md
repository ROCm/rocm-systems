...
| --- | ---: | --- | --- | --- |
| Main E2E | P0 | Qwen3-0.6B prefill (`qwen-prefill`) | 🟨 high: clean pass at 1200 s; 4/4 completed fault trials detected; remaining trials resumed | 🟧 sleep=15: clean run hits 360 s deadline; delay-zero clean previously passed |
...
| Tensile | P2 | `005_sk_f8gemm_quick` (`tensile-sk-f8gemm-quick`) | 🟨 high: exact fault shard clean pass and 8/8; full 9-shard high clean pending | 🟨 delay-zero: filtered clean pass; fault trials pending |
