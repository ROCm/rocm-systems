...
| Tensile | P2 | `000_sk_sgemm_quick` (`tensile-sk-sgemm-quick`) | 🟧 1 GiB cap resolves report rejection; 1800 s clean timeout; full sweep and targeted fault trials running | 🟧 profiler discovery complete for all 6 shards; clean qualification pending |
