...
| --- | ---: | --- | --- | --- |
| Main E2E | P0 | Qwen3-0.6B prefill (`qwen-prefill`) | 🟨 default: filtered clean pass; fault 0/8; high rerun in progress | 🟧 sleep=15: clean run hits 360 s deadline; delay-zero clean previously passed |
...
| PyTorch | P0 | `torch.mode` (`pytorch-torch-mode`) | 🟨 default: filtered clean pass; fault 0/8; high next | 🟨 delay-zero: filtered clean pass; fault trials pending |
...
| PyTorch | P2 | norm/softmax (`pytorch-norm-softmax`) | 🟨 default: filtered clean pass; fault 0/8; high next | 🟨 delay-zero: filtered clean pass; fault trials pending |
