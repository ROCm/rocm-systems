...
| Tensile | P1 | `004_sk_mxf8gemm_tdm` (`tensile-sk-mxf8gemm-tdm`) | 🟨 default: all 6 clean shards pass with complete tensor-DMA coverage; fault trials pending | 🟨 delay-zero: filtered clean pass; fault trials pending |
