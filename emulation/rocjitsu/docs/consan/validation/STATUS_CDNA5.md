...
| Tensile | P1 | `007_sk_mxf4gemm_tdm` (`tensile-sk-mxf4gemm-tdm`) | 🟧 tensor coverage needs 146 MiB report storage; 128 MiB cap blocks all 6 shards | 🟨 delay-zero: all 6 clean shards pass after address-bank fixes; fault trials pending |
