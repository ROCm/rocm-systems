...
| Tensile | P2 | `000_sk_sgemm_quick` (`tensile-sk-sgemm-quick`) | 🟧 high + 1 GiB cap: targeted clean pass and fault 8/8; 3 of 6 full-clean shards numerically pass; remainder running | 🟧 sleep_wave=15: targeted clean pass and fault 0/8; full clean hit a 3600 s timeout; remaining shards running |
