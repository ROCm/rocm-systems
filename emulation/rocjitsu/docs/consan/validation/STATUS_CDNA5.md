...
| Tensile | P2 | `000_sk_sgemm_quick` (`tensile-sk-sgemm-quick`) | 🟧 high + 1 GiB cap: targeted clean passes; full clean and fault qualification running | 🟧 profiler discovery complete for all 6 shards; clean qualification pending |
