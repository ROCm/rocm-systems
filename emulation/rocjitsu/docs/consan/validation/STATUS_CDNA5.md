...
| Tensile | P1 | `016_spmm_tdm_all` (`tensile-spmm-tdm-all`) | 🟨 higher: all 4 clean shards pass with complete tensor-DMA coverage; fault 4/8 | 🟨 delay-zero: filtered clean pass; fault trials pending |
...
| Tensile | P2 | `000_sk_sgemm_quick` (`tensile-sk-sgemm-quick`) | 🟧 all 6 shards: first client passes; second code object rejected as unsupported | 🟧 profiler discovery complete for all 6 shards; clean qualification pending |
