...
| Main E2E | P4 | hip-moi WMMA attention (`wmma-attention`) | 🟨 default: filtered clean pass; fault 2/8; high calibration next | 🟨 sleep=15: filtered clean pass; detector 0/8 despite oracle failures 8/8 |
