...
| Tensile | P2 | `000_sk_sgemm_quick` (`tensile-sk-sgemm-quick`) | 🟧 profiler discovery complete for all 6 shards; clean qualification pending | 🟧 profiler discovery complete for all 6 shards; clean qualification pending |
...
| Tensile | P3 | `015_spmm_f8_ml` (`tensile-spmm-f8-ml`) | 🟨 default: all 3 clean shards pass at 1800 s; reviewed tail fault pending replay | 🟥 delay-zero: subword transform fixed; clean mismatches persist and all 3 shards time out |
