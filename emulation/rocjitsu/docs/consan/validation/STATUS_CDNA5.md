...
| Tensile | P1 | `016_spmm_tdm_all` (`tensile-spmm-tdm-all`) | 🟨 higher: all 4 clean shards pass with complete tensor-DMA coverage; fault qualification running | 🟨 delay-zero: filtered clean pass; fault trials pending |
