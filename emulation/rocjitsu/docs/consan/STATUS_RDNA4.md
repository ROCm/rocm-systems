...
certificate has advanced through validation checkpoint `42271fd5fc`, using
rebuilt hook SHA-256
`bb08fa7cfef409a2505493cc7a0c092f0b6bd3e83c5210ba528f02710e130e1f`.
...
| **P3 CLIP BF16** | 🟩 Exact oracle; clean 85/85; exact drop and move are precommitted qualified misses; overhead 0.98x | 🟨 Exact oracle; current clean is statically and dynamically complete at 85/85 accesses + 36/36 barriers and finishes in 1.38 seconds versus a 1.31-second baseline; current-tip reviewed fault and paired-overhead evidence pending | 🟩 Exact oracle; clean 85/85 + 72/72; exact drop and move are precommitted qualified misses; overhead 0.97x | 🟩 Exact oracle; clean 85/85 + 36/36; exact move emits an attributed diagnostic while exact drop is a qualified miss; overhead 1.51x | Record/Replay checkpoint `42271fd5fc`, hook `bb08fa7c…`, artifact `rdna4-clip-rr-scalar-007`: gfx1201 now keeps owner/epoch in persistent SGPRs instead of loading a private-memory epoch at every hot access. Other profiles and historical fault expectations remain at checkpoint `3033f30f2a` in `...-057` through `...-070` |
