...
| **P4 hip-moi WMMA attention** | 🟩 Exact oracle; clean 12/12; exact barrier drop is a precommitted qualified miss and breaks the oracle; overhead 158.07x | 🟩 Exact oracle; clean 12/12 + 4/4; exact barrier drop emits an attributed diagnostic and breaks the oracle; overhead 11.99x | 🟨 Exact oracle and clean-complete 12/12 accesses + 8/8 barrier members; overhead and reviewed fault pending | 🟨 Exact oracle and clean-complete 12/12 accesses + 4/4 barriers in five consecutive current-tip processes; overhead and reviewed fault pending | Current Inline artifacts `rdna4-generation-wmma-repeat-{1..5}`, checkpoint `23ccbda318`, confirm that generation-qualified local shadows remove the former intermittent clean diagnostic. Sampled checkpoint `e96efba818`: clean `...-142`. SuperCollider checkpoint `ca1eb5456e`: `...-128` through `...-131`. Record/Replay checkpoint `baed32a85e`: `...-114`, `...-115`, `...-116`, `...-120`, and `...-125` |
