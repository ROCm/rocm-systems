...
| **P1 Sharktank TP1 decode/combined** | 🟨 current clean and paired: both exact oracles, 240/240 accesses, complete analysis, 1.33x maximum; reviewed exact-one fault was schedule-masked and contradicted its frozen detection policy | 🟨 current clean and paired: both exact oracles, complete 240/240 accesses plus 62/62 barriers, and 1.41x maximum paired slowdown; the first prospectively reviewed exact-one barrier drop preserved the oracle without a Record/Replay diagnostic, so the fault gate remains open | 🟥 current planner rejects persistent state at the ordinary-VGPR/AccVGPR boundary before installing the instrumented object | 🟩 current VCC-safe spill-backed bundle: both exact clean and paired oracles, complete 240/240 accesses plus 62/62 barriers, 31.2x maximum slowdown, reviewed exact-one pass/no-diagnosis fault, containment, health, and clean provenance |
