...
The source tree was dirty during the confirming timeout and fault runs, so a
clean-provenance rerun at the timeout-policy revision remains before this cell
turns green.
