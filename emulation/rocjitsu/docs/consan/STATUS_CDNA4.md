...
| P1 | `torch.histc` with a shared-memory-sized bin count | 🩶 Baseline exact; profile unassessed | 🟨 Exact oracle passes in 9.04 s with zero diagnostics; the histogram object now has complete 152/152 access and 84/84 barrier coverage after dense routing, subword-alias admission, and access-record coverage for all 42 co-resident CDNA4 LDS atomics.  A separately loaded boolean-fill helper still patches 12/27 accesses, leaving one resource failure and 14 placement/lowering failures | 🩶 Baseline exact; profile unassessed | 🩶 Baseline exact; profile unassessed | One-repetition artifact `consan-gfx950-pytorch-histc-rr-atomic-access-20260722`; aggregate coverage is 164/179 accesses and 84/84 barriers with dynamic completeness.  The remaining fill-helper spill/placement gap alone keeps this cell yellow. |
