...
| **P4 hip-moi D128 pressure attention** | 🟨 Current physical strict run passes all four exact clean oracles in 1.40 seconds with complete 252/252 access coverage and complete static, analysis, and dynamic verdicts; paired-overhead, reviewed-fault, and clean-provenance acceptance remain | 🟨 Current extended physical clean run passes all four exact oracles in 42.27 seconds with zero diagnostics, complete 252/252 access and 28/28 nonredundant-barrier coverage, and complete static, analysis, and dynamic verdicts; the ordinary 30-second latency contract, paired overhead, and reviewed-fault acceptance remain | 🟧 Current unrestricted physical run passes all four exact clean oracles with zero diagnostics and dynamic completion, but only 73/252 accesses plus all 4/4 applicable barriers patch; 179 access sites still fail resource planning | 🟨 Current physical strict run passes all four exact clean oracles in 22.32 seconds with zero diagnostics, complete 252/252 access and 28/28 nonredundant-barrier coverage, and complete static, analysis, and dynamic verdicts; paired-overhead and reviewed-fault acceptance remain |
| **P4 hip-moi MFMA attention** | 🟩 Current candidate-tree physical run passes both exact oracles in 0.23 seconds with complete 58/58 access coverage; CDNA4 B16 store readback is now covered by a focused host regression; prior paired and reviewed-fault evidence retained | 🟨 Current candidate-tree physical row passes both exact oracles in 150.78 seconds with complete 58/58 access and 14/14 barrier coverage, zero diagnostics, and complete static, analysis, and dynamic verdicts; paired overhead and reviewed-fault acceptance remain | 🟧 Current physical run passes both exact oracles. The FastContext component supplies all 33 patched accesses plus all 4/4 applicable barriers; the full-pressure ExactContext component accounts for all 25 access resource failures | 🟨 Current candidate-tree physical row passes both exact oracles in 9.38 seconds with complete 58/58 access and 14/14 barrier coverage, 8,704 visible exact-shadow cells, zero diagnostics or incomplete state, and complete static, analysis, and dynamic verdicts; paired overhead and reviewed-fault acceptance remain |
