...
| **P3 CLIP BF16** | 🟩 Current cosine oracle with complete 45/45 access coverage | 🟩 Current cosine oracle with complete 45/45 access plus 24/24 barrier coverage and a complete dynamic verdict | 🟩 Current cosine oracle with complete 45/45 access plus 24/24 applicable-barrier coverage | 🟩 Current cosine oracle with complete 45/45 access plus 24/24 barrier coverage |
| **P4 hip-moi D128 block attention** | 🟩 Current exact host-reference oracles with complete 128/128 access coverage; prior paired/fault evidence retained | 🟩 Current exact oracles with complete 128/128 access plus 119/119 barrier coverage and zero diagnostics | 🟩 Current exact oracles with complete 128/128 access plus 117/117 applicable-barrier coverage | 🟩 Current exact oracles with complete 128/128 access plus 119/119 barrier coverage |
| **P4 hip-moi D128 pressure attention** | 🟩 Current physical paired row passes the exact full-KV oracle with complete 252/252 access coverage and complete static, analysis, and dynamic verdicts; the bracketing baselines take 79 and 77 ms versus 1,331 ms for SuperCollider (17.06x). A prospectively reviewed exact-one drop of the first of two consecutive FastContext barriers is reached and accepted as a `not_detected/pass` qualified miss with all four exact oracles passing, zero diagnostics, complete 252/252 access coverage, zero report-memory leakage, cleanup, containment, health, hook hashing, and exact provenance. The earlier prospectively frozen K/V-publication `not_detected/fail` hypothesis remains rejected without relabeling | 🟩 Current clean-source physical bundle passes all four exact oracles with complete 252/252 access and 28/28 barrier coverage, zero diagnostics, and complete static, analysis, and dynamic verdicts. The paired bracketing baselines take 66 and 85 ms versus 1,463 ms for Record/Replay (19.38x), well inside the ordinary 30-second bound. A distinct prospectively reviewed exact-one drop of the first of two consecutive FastContext barriers is reached and accepted as a qualified miss with a passing oracle, bounded memory, cleanup, and healthy pre/post probes | 🟩 Current exact oracle, complete 252/252 access plus 24/24 applicable-barrier coverage, zero diagnostics, and 17.32x paired slowdown; a prospectively reviewed exact-one first FastContext barrier drop leaves its adjacent barrier intact and is reached and accepted as a qualified miss with complete coverage, bounded memory, cleanup, containment, health, hook hashing, and exact provenance | 🟩 Current physical paired row passes the exact full-KV oracle with complete 252/252 access and 28/28 barrier coverage, zero forbidden diagnostics, and complete static, analysis, and dynamic verdicts; both bracketing baselines take 64 ms versus 1,483 ms for Inline Shadow (23.17x). A prospectively reviewed exact-one drop of the first consecutive FastContext barrier is reached and accepted as `not_detected/pass`, with the adjacent barrier intact, complete surviving coverage, bounded report memory, zero live bytes after cleanup, exact hook/executable provenance, and healthy pre/post probes |
| **P4 hip-moi MFMA attention** | 🟩 Current candidate-tree physical run passes both exact oracles in 0.23 seconds with complete 58/58 access coverage; CDNA4 B16 store readback is now covered by a focused host regression; prior paired and reviewed-fault evidence retained | 🟩 Current clean-source physical bundle passes the exact paired oracles with complete 58/58 access and 14/14 barrier coverage, zero diagnostics, and complete static, analysis, and dynamic verdicts; the paired slowdown is 4.22x. A prospectively reviewed exact-one score-publication barrier drop is reached and accepted as a qualified miss with a passing oracle, complete surviving coverage, cleanup, and healthy pre/post probes | 🟩 Current exact oracle, complete 58/58 access plus 12/12 applicable-barrier coverage, zero diagnostics, and 2.57x paired slowdown; a prospectively reviewed exact-one first score-publication barrier drop leaves its adjacent publication barrier intact and is reached and accepted as a qualified miss with complete surviving coverage, bounded memory, cleanup, containment, health, hook hashing, and exact provenance | 🟩 Current physical paired row passes the exact oracle with complete 58/58 access and 14/14 barrier coverage, 8,704 visible exact-shadow cells, zero forbidden diagnostics or incomplete state, and complete static, analysis, and dynamic verdicts; the bracketing baselines take 80 and 68 ms versus 246 ms for Inline Shadow (3.32x). A prospectively reviewed exact-one first score-publication drop is reached and accepted as `not_detected/pass`, with the following source-level publication edge intact, 58/58 access plus 13/13 surviving-barrier coverage, bounded report memory, zero live bytes after cleanup, exact provenance, and healthy pre/post probes |
| **P4 hip-moi Stream-K arrival** | 🟩 Current exact clean row with complete 32/32 access coverage; prior paired/fault evidence retained | 🟥 Current strict load rejects the applicable object as `non-installable-transform-outcome` before workload execution | 🟩 Current exact clean row with complete 32/32 access, 4/4 applicable-barrier, and 1/1 atomic coverage | 🟧 Current exact workload execution reaches complete 32/32 access, 6/6 barrier, and 1/1 atomic coverage, but produces 256 forbidden clean diagnostics and exits 89 |
| **P4 hip-moi tree atomic-OR** | 🟩 Current exact clean row with complete 48/48 access coverage; prior paired/fault evidence retained | 🟥 Current strict load rejects the applicable object as `non-installable-transform-outcome` before workload execution | 🟧 The exact workload runs with 48/48 access and 4/4 barrier coverage, but only 2/3 atomics are patched and the strict analysis verdict is incomplete | 🟧 Current exact workload execution reaches complete 48/48 access, 6/6 barrier, and 3/3 atomic coverage, but produces 768 forbidden clean diagnostics and exits 89 |
| **P4 hip-moi Jakub attention** | 🟩 Current four-oracle row with complete 338/338 access coverage | 🟩 Current four-oracle row with complete 338/338 access plus 35/35 barrier coverage and zero diagnostics | 🟩 Current four-oracle row with complete 338/338 access plus 35/35 applicable-barrier coverage | 🟩 Current four-oracle row with complete 338/338 access plus 35/35 barrier coverage |

### 2026-08-23 final current-tip correctness refresh

The publication-window refresh intentionally reran clean correctness and strict
coverage only; it did not repeat retained timing or fault campaigns. Physical
...
Fresh target-native inventory at
`/home/ossci/xx/consan-validation/prep-20260823-gfx950-jakub-inline-inventory-v1`
records fingerprint `fnv1a64:120a833f9c345de1` and distinguishes all 35
barriers in the four executed FP16 MFMA variants. Three prospectively frozen
trials were rejected without relabeling: the initial ordinary publication edge
at PC `0x8e4` and delayed-producer edge at `0x1808` both preserved every
oracle but did not diagnose under positive policies, while the distinct later
publication edge at `0xca0` produced a diagnosis under a negative policy.
These immutable trials localize the observed behavior instead of being reused
as retrospective acceptance evidence.

Final-ISA review then selected the distinct PipelinedProd16x8
reader-retirement barrier at PC `0xddc`, occurrence 2. Peer LDS reads and their
`lgkm` wait precede it and stores for the replacement stage immediately follow
it. The checked-in policy froze `detected/pass` before execution. Final
artifact
`/home/ossci/xx/consan-validation/prep-20260823-gfx950-jakub-inline-retirement-fault-v2`
accepts one requested/planned/reserved/applied mutation. All four exact oracles
pass and Inline Shadow emits one required diagnostic, providing
detector-owned reach. Static, analysis, and dynamic verdicts are complete at
338/338 accesses plus 34/34 surviving barriers. The 134,280,216 report bytes
are bounded, cleanup leaves zero live bytes, and pre/post physical discovery
and dispatch probes remain healthy. Provenance pins checked-in fault-spec
SHA-256
`09e141da50f5989515e08a66e4f2455774918b3487ce09fa9a0e256ffe60f3dd`,
executable SHA-256
`a04e46abf1e344fc9da7794e423a2848f14f825a8cf549b68a3f92b3ef8684b7`,
and hook SHA-256
`3dc44a0d6efaec4b0a67b92fa9e55804e0162273e3607b29f2f2379769836226`.

The selector and positive policy have focused host coverage. The durable
observable contract is not gfx950-specific: `ReusedLdsGemmPipeline` pairs the
same reader-retirement-before-overwrite edge on all five RocJitsu targets and
physical gfx950, while `CdnaMfmaPipeline` retains native MFMA/AccVGPR pressure
on CDNA3/CDNA4 and physical gfx950. Their combined 90 baseline/all-engine rows
are the quick correct/no-diagnostic and incorrect/required-diagnostic gate.

### 2026-08-23 tree atomic-OR Inline Shadow qualification

Fresh target-native inventory at
`/home/ossci/xx/consan-validation/prep-20260823-gfx950-tree-inline-inventory-v1`
records fingerprint `fnv1a64:59f4280a6d20c4de`. It distinguishes the executed
release-only producer `global_atomic_or` at code-object PC `0x185c8`,
occurrence 208, from the later acquire-release compare/exchange operations.
Before execution, the checked-in policy froze exactly that producer release as
`detected/pass` and required Inline Shadow diagnostics.

Artifact
`/home/ossci/xx/consan-validation/prep-20260823-gfx950-tree-inline-fault-v1`
accepts one requested/planned/reserved/applied atomic-order mutation. The exact
MFMA-partials oracle passes and Inline Shadow produces 768 diagnostics, which
also supplies detector-owned runtime reach evidence. Static, analysis, and
dynamic verdicts remain complete at 48/48 accesses, 6/6 barriers, and 2/2
surviving ordered atomics; the report contains one release record and 2,048
visible exact-shadow cells. The 119,663,056 report bytes are bounded, cleanup
leaves zero live bytes, and pre/post physical discovery and dispatch probes are
healthy. Provenance pins executable SHA-256
`dea93630d4a28b050a44b8ca32122e1d365c88521db058454e92f3ef01ef541c`
and hook SHA-256
`3dc44a0d6efaec4b0a67b92fa9e55804e0162273e3607b29f2f2379769836226`.

The target-specific selector and positive policy are host-tested, while the
observable behavior is implementation-independent and already generalized:
the adjacent `TreeAtomicOr` pair weakens only the same producer release, and
`FlatAtomicPublication` executes native target-specific release/acquire forms.
Their 120 baseline/all-engine rows pass across all five RocJitsu targets and
physical gfx950, preserving exact/no-diagnostic correct members and required
diagnostic incorrect members.

### 2026-08-23 MFMA-attention Inline Shadow qualification

Fresh inventory at
`/home/ossci/xx/consan-validation/prep-20260823-gfx950-mfma-inline-inventory-v1`
retains object fingerprint `fnv1a64:4329a1f90ba40311`. Source and final-ISA
review selected ExactContext occurrence 3 at code-object PC `0x1f88`, the first
score-publication barrier in the executed unconditional attention loop. The
following source-level publication edge remains, so the prospective Inline
Shadow policy was frozen as the semantically redundant qualified miss
`not_detected/pass` before execution.

Artifact
`/home/ossci/xx/consan-validation/prep-20260823-gfx950-mfma-inline-fault-v1`
accepts one requested/planned/reserved/applied mutation with reviewed
unconditional-final-ISA reach. The exact attention oracle passes, Inline Shadow
emits zero diagnostics, and static, analysis, and dynamic verdicts remain
complete at 58/58 accesses plus 13/13 surviving barriers, with all 8,704 exact
shadow cells visible. The 110,488,176 report bytes are bounded, cleanup leaves
zero live bytes, and pre/post physical discovery and dispatch probes are
healthy. Provenance pins executable SHA-256
`ee7e677a3ff14105ac22ffb5960c56c2799ac11117990eaae70269b7a2b6ac6a`
and hook SHA-256
`3dc44a0d6efaec4b0a67b92fa9e55804e0162273e3607b29f2f2379769836226`.

The reviewed target-specific selector and policy are checked in and
host-tested. `CdnaMfmaPipeline` owns the native MFMA/AccVGPR correct/incorrect
behavior on RocJitsu gfx942/gfx950 and physical gfx950; all 30 of its
baseline/all-engine rows pass. `DoubleBufferedPipeline` separately transports
the stronger publication-edge contract to all five supported architectures.
Encoding this retained-edge qualified miss as an incorrect device member would
make that member behaviorally correct, so no duplicate pair is added.

### 2026-08-23 D128-pressure Inline Shadow qualification

Fresh inventory at
`/home/ossci/xx/consan-validation/prep-20260823-gfx950-d128-pressure-inline-inventory-v1`
retains object fingerprint `fnv1a64:1cc23eaceeb81f21`. Final-ISA review selected
occurrence 1 at code-object PC `0x1c394` in the executed
`FullKvDoubleBuffered16Key` FastContext kernel. It is the first of two
consecutive unconditional `s_barrier` instructions; occurrence 2 at `0x1c398`
remains, so the prospective Inline Shadow policy was frozen as the semantically
redundant qualified miss `not_detected/pass` before execution.

Artifact
`/home/ossci/xx/consan-validation/prep-20260823-gfx950-d128-pressure-inline-fault-v1`
accepts the exact-one requested/planned/reserved/applied mutation with reviewed
unconditional-final-ISA reach. All four exact host-reference oracles pass,
Inline Shadow emits zero diagnostics, and static, analysis, and dynamic
verdicts remain complete at 252/252 accesses plus 28/28 surviving barriers.
The 134,280,136 report bytes are bounded, cleanup leaves zero live bytes, and
pre/post physical discovery and dispatch probes are healthy. Provenance pins
executable SHA-256
`744f8762f629cd63322b41f4ee225494f10c25b2bd6b15b03367a876f7139bf3`
and hook SHA-256
`3dc44a0d6efaec4b0a67b92fa9e55804e0162273e3607b29f2f2379769836226`.

The reviewed gfx950 fault contract is checked in and host-tested. The stronger
observable behavior remains owned by the adjacent `DoubleBufferedPipeline`
device pair: its correct member preserves the redundant barriers, while its
incorrect member removes the complete publication edge and requires the
diagnostic. All 60 baseline/all-engine rows pass on the five RocJitsu targets
and physical gfx950. A duplicate incorrect member that removes only the
redundant first barrier would be behaviorally correct and is therefore not
added.
...
and physical gfx950. The adjacent `FlatAtomicPublication` pair preserves the
target-native CDNA `flat_atomic_add` release and returning/acquire forms while
changing only the acquired synchronization object; all 60 of its cross-target
rows pass as well. The Sampled cell is green.
...
ConSan or HSA-tool settings. The target-resolved manifest now also pins the
reviewed stride-one Record/Replay validation cadence.  This prevents its six
compact dispatches from all missing the production stride and turning a
statically complete 739-access/109-barrier run into a zero-evidence rejection;
focused host coverage verifies both the manifest and effective environment.
The full 353-test ConSan Python suite produced
...
| Priority | Tracking unit | SuperCollider | Record/Replay | Sampled | Inline Shadow | Why it matters and next proof |
|---|---|---|---|---|---|---|
| P0 | `torch.mode`, large rows | 🟧 Exact oracle and dynamic execution pass, but static analysis is incomplete at 199/23,298 supported accesses | 🟩 The current physical-gfx950 run passes the exact value/index oracle and ordinary 30-second contract in 27.61 seconds with complete static, analysis, and dynamic verdicts, all 25,523 accesses and 3,920 barriers patched, lossless replay of 13,017 accesses plus 49 barriers, and zero diagnostics. Record/Replay now prefers coarse-grained auto-report storage when available, eliminating the fine-grained sparse-copy teardown floor without changing Sampled or Inline Shadow allocation policy | 🟩 The current-tip paired run passes the exact value/index oracle with complete 25,523-access/3,920-barrier coverage and zero diagnostics. Sampled device time is 19.13 seconds versus a 295.45-ms bracketing baseline, or 64.74×. A prospectively frozen exact-one drop of occurrence 2 at PC `0x6a904` in the dispatched int32 `compute_mode` specialization is reached and accepted as `not_detected/pass`: the 64-thread workgroup is exactly one gfx950 wave, so the removed barrier cannot remove an inter-wave publication edge. The 60-second fault envelope passes the exact oracle with one requested/planned/applied mutation, 25,523/25,523 accesses, 3,919/3,919 surviving barriers, zero diagnostics or overflow, clean containment, and healthy pre/post probes | 🟨 The repaired 60-second diagnostic run is fully accepted in 49.62 seconds with the exact value/index oracle, zero forbidden diagnostics, complete static/analysis/dynamic evidence, and all 25,523 accesses plus 3,920 barriers patched. The ordinary 30-second latency contract, paired overhead, and reviewed-fault acceptance remain | Exact values/indices. Current Inline artifact `rebase-20260821-gfx950-pytorch-mode-inline-coplan-final-v3` closes the entry-prologue composition and private-dispatch validation regressions. Current Sampled artifacts `prep-20260823-postmerge-gfx950-pytorch-mode-sampled-overhead-v1`, `prep-20260823-postmerge-gfx950-pytorch-mode-sampled-fault-v4`, and the retained final-ISA object in `prep-20260823-postmerge-gfx950-pytorch-mode-sampled-isa-v1` close the paired-overhead, reviewed-fault, mutation, containment, and health gates and promote Sampled from yellow to green. The adjacent `SortNetworkExchange` device pair transports the compare/exchange publication idea into a genuine two-wave contract on all five RocJitsu targets plus physical gfx950. Current Record/Replay artifact `rebase-20260822-gfx950-pytorch-mode-rr-coarse-v1` closes its remaining latency gate; the other named artifacts retain the per-profile frontiers. |
| P0 | `torch.topk`, FP64 spill and BF16 coverage cases | 🟧 Exact oracle and dynamic execution pass, but static analysis is incomplete at 3,056/230,438 supported accesses | 🟧 The current 180-second diagnostic exits cleanly in 138.46 seconds and passes both exact BF16 and FP64 value/index oracles with zero diagnostics and complete dynamic replay. Reachable medium-scale full-pressure sites use bounded-density shared branch-only relay routing, while oversized periodic banks fall back without dominating transformed-image growth; the large object nevertheless has no safe owner-local donor corridor from the affected sites to appended text. Static analysis remains incomplete at 232,814/239,722 accesses and 6,743/11,423 barriers: 6,908 accesses still have no legal first SOPP hop and consequently 4,680 barriers remain omitted | 🟧 The current 180-second diagnostic exits cleanly in 92.06 seconds and passes both exact BF16 and FP64 value/index oracles with zero diagnostics and complete dynamic evidence. Branch-only scalar-spill routing and the empty-EXEC guard patch 232,814/239,722 accesses and all 6,743/6,743 applicable barriers. The remaining 6,908 access sites have no legal first SOPP hop; ordinary 30-second latency and static completeness remain | 🟧 The current physical-gfx950 clean run clears the former growth-cap rejection, passes the exact oracle in 171.37 seconds with zero diagnostics and complete dynamic evidence, and patches all 11,423 barriers. Static coverage remains incomplete at 122,420/239,722 supported accesses: the 20,792,320-byte large object now produces a valid 363,435,008-byte replacement, but patches 65,536/182,838 supported accesses while the smaller object patches all 56,884 | Exact values/indices across FP64 register pressure and BF16 coverage. Current Record/Replay artifact `prep-20260823-gfx950-topk-rr-dense-branch-spine-v3` proves the bounded periodic-bank policy and retains the residual donor-free no-first-hop limitation; the earlier growth artifact records the independent envelope repair. Current Inline Shadow artifact `rebase-20260821-gfx950-pytorch-topk-inline-diagaddr-drRcFh` records the first valid large-object replacement. Current Sampled artifact `rebase-20260822-gfx950-pytorch-topk-sampled-empty-exec-fix-v2` closes the physical fault and converges on the same bounded no-first-hop frontier as Record/Replay. |
...
### 2026-08-23 PyTorch mode Sampled qualification and portable sort exchange

Current paired artifact
`/home/ossci/xx/consan-validation/prep-20260823-postmerge-gfx950-pytorch-mode-sampled-overhead-v1`
passes the exact value/index oracle with complete 25,523/25,523 access and
3,920/3,920 barrier coverage, zero forbidden diagnostics, and complete
static, analysis, and dynamic verdicts. The Sampled device median is
19,127.73 ms versus the 295.45-ms mean of the bracketing device baselines, a
64.74x slowdown. The complete instrumented process remains inside the
ordinary 30-second envelope at 25.30 seconds. The hook before and after the
run has SHA-256
`0f1e554192be7f324cd54e201fff207aad9367f1534ec02adfd075b201bdbbb5`.

Final-ISA review of the dispatched int32, 128-column `compute_mode`
specialization selected occurrence 2 of `s_barrier` at section PC `0x6a904`.
The barrier follows conditional LDS compare/exchange writes and precedes the
next LDS reads, but the specialization launches one 64-thread workgroup:
exactly one wave on gfx950. The prospective fault policy therefore required
the exact oracle to pass and Sampled not to diagnose. Artifact
`/home/ossci/xx/consan-validation/prep-20260823-postmerge-gfx950-pytorch-mode-sampled-fault-v4`
accepts that qualified miss under its explicit 60-second process envelope.
Exactly one mutation is requested, planned, reserved, and applied; the exact
oracle passes, all 25,523 accesses and 3,919 surviving barriers patch, there
are zero diagnostics and overflows, report memory returns to zero, and both
physical-GPU health probes pass. The workload device median is 30,962.68 ms
and the complete fault row takes 52.47 seconds. An earlier 30-second attempt
timed out while loading and transforming the exact object and remains
inconclusive; extending the bounded process envelope did not revise the
prospective detector or oracle policy.

The checked-in `SortNetworkExchange` pair preserves the workload's in-place
value/index compare/exchange idiom while deliberately using two waves, so its
stage-publication barrier is behaviorally necessary on every target. Its
correct and incorrect members differ only at that barrier. Baseline plus all
four engines pass all 50 RocJitsu rows across gfx942, gfx950, gfx1100,
gfx1201, and gfx1250 in 1.99 seconds; all ten serialized physical-gfx950 rows
pass in 2.40 seconds. This converts a single-wave E2E qualified miss into a
portable positive behavioral contract without freezing the prototype's
patching or report layout. The final combined `consan-device` qualification
passes all 2,287 rows in 143.03 seconds, including all 431 serialized physical
gfx950 rows.
...
correct member requires exact collision-heavy integer/FP32/FP64 LDS-atomic results
...
and FP64 LDS atomic-add payloads alongside the original integer histogram and
global scatter idioms. CDNA3/4/5 retain native `ds_add_f64`, while RDNA3/4
transport the same collision contract through their 64-bit LDS
compare/exchange loops; the pair owns the architecture-general collision and
...
The later all-target `RecordReplayDenseBranchOnlyPressure` device pair combines
TopK's complete ordinary-SGPR and alternating-VGPR pressure with Qwen's repeated
LDS-access and stride-two selection shapes. Its adjacent correct/incorrect
members retain exact warmup, tile, and control oracles while changing only the
cross-wave publication edge, and all 24 baseline/Record-Replay rows pass on the
five RocJitsu targets plus physical gfx950. The fixture exposed a distinct
medium-scale corridor defect: periodic entry/return banks were needed through
ordinary appended bodies, and bank spacing had to be measured after the entire
...
spent 131.99 seconds planning a 960,421,888-byte growth before correctly
rejecting it. Periodic banks now require their payload to occupy at most one
eighth of the body interval they serve; larger demands retain the existing
bounded partial-coverage path. The current physical artifact
`/home/ossci/xx/consan-validation/prep-20260823-gfx950-topk-rr-dense-branch-spine-v3`
uses hook SHA-256
`1cf51903ccddbc1c9e0d944d192229538fc74f856db07ff14056b95abd9dfa89`,
produces a valid 434,021,376-byte replacement after an 81.95-second transform,
and exits in 138.46 seconds with both exact TopK oracles, zero diagnostics, and
complete replay. It retains the established 232,814/239,722-access and
6,743/11,423-barrier frontier, so the cell remains orange rather than confusing
bounded routing infrastructure with the still-missing shared-dispatch design.
