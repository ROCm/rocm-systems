...
| PyTorch synthetic dense decode (one continuous-batch tick) | 3.73 s | 0.00361 s (1×) | 190 s | 0.00346 s (0.958×) | running | running | pending | pending | pending | pending | [record-replay--audit-on: running](</home/benjacob/consan-gfx950-benchmark-full/pytorch-synthetic-decode--record-replay--audit-on.log>) |
