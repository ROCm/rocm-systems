...
| PyTorch synthetic four-expert top-1 MoE prefill (16-token prompt) | running | running | pending | pending | pending | pending | pending | pending | pending | pending | [native-reference-1: running](</home/benjacob/consan-gfx950-benchmark-full/pytorch-top1-moe-prefill--native-reference-1.log>) |
