...
| PyTorch synthetic dense decode (one continuous-batch tick) | 54.4 s | 0.00336 s (1×) | running | running | pending | pending | pending | pending | [default--audit-on: running](</home/benjacob/work/consan-benchmark-gfx950-20260918/pytorch-synthetic-decode/pytorch-synthetic-decode--default--audit-on.log>) |
