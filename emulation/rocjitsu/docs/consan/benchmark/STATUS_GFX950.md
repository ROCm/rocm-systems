...
| PyTorch synthetic dense decode (one continuous-batch tick) | 3.73 s | 0.00361 s (1×) | 190 s | 0.00346 s (0.958×) | 269 s | 5.1 s (1,410×) | running | running | pending | pending | [sampled--audit-on: running](</home/benjacob/consan-gfx950-benchmark-full/pytorch-synthetic-decode--sampled--audit-on.log>) |
