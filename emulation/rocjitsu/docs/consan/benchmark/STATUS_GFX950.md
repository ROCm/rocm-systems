...
| PyTorch synthetic four-expert top-1 MoE prefill (16-token prompt) | 4.64 s | 0.0112 s (1×) | 326 s | 0.0137 s (1.22×) | running | running | pending | pending | pending | pending | [record-replay--audit-on: running](</home/benjacob/consan-gfx950-benchmark-full/pytorch-top1-moe-prefill--record-replay--audit-on.log>) |
