...
| TokenSpeed Gluon BF16 GEMM large-M (4096×4096×4096) | 0.121 s | 0.000649 s (1×) | 1.32 s | 0.00177 s (2.73×) | 8.58 s | 1.72 s (2,660×) | 5.39 s | 0.0213 s (32.8×) | timeout (600 s) | timeout (600 s) | [inline-shadow--audit-on: timeout (600 s)](</home/benjacob/consan-gfx950-benchmark-full/tokenspeed-bf16-gemm-largem--inline-shadow--audit-on.log>) |
| TokenSpeed Gluon attention prefill | 0.126 s | 0.000624 s (1×) | failed | failed | pending | pending | pending | pending | pending | pending | [supercollider--audit-on: failed](</home/benjacob/consan-gfx950-benchmark-full/tokenspeed-attention-prefill--supercollider--audit-on.log>) |
