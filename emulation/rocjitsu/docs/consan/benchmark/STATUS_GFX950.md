...
| TokenSpeed Gluon attention prefill | pending | pending | pending | pending | pending | pending | pending | pending | pending | pending | [barrier fix check: passed; benchmark pending](</tmp/consan-attention-barrier-after.log>) |
| TokenSpeed Gluon attention decode | pending | pending | pending | pending | pending | pending | pending | pending | fix-check passed; benchmark pending | fix-check passed; benchmark pending | [barrier fix check: passed; benchmark pending](</tmp/consan-attention-barrier-after.log>) |
