...
| PyTorch synthetic four-expert top-1 MoE prefill (16-token prompt) | 92.7 s | 3.25 s (1×) | 566 s | 3.57 s (1.1×) | pending | pending | pending | pending | [default--audit-on: accepted](</home/benjacob/work/consan-benchmark-gfx950-20260918/pytorch-top1-moe-prefill/pytorch-top1-moe-prefill--default--audit-on.log>) |
