...
| TokenSpeed Qwen3-0.6B prefill | 3.77 s | 0.0255 s (1×) | failed | failed | pending | pending | pending | pending | pending | pending | [supercollider--audit-on: failed](</home/benjacob/consan-gfx950-benchmark-full/tokenspeed-qwen-prefill--supercollider--audit-on.log>) |
