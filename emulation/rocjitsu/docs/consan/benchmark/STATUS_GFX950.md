...
| TokenSpeed Gluon BF16 MoE | 3.3 s | 3.22 s (1×) | N/A (no applicable sites) | N/A (no applicable sites) | pending | pending | pending | pending | [default--audit-on: not-applicable](</home/benjacob/work/consan-benchmark-gfx950-20260918/tokenspeed-bf16-moe/tokenspeed-bf16-moe--default--audit-on.log>) |
