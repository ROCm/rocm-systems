...
| PyTorch synthetic dense decode (one continuous-batch tick) | 2.77 s | 0.00295 s (1×) | 249 s | 0.00796 s (2.7×) | not run | not run | 188 s | 0.00289 s (0.981×) | [native-validation: accepted; high not run](</home/benjacob/work/consan-benchmark-gfx950-20260917/pytorch-synthetic-decode--native-validation.log>) |
...
| TokenSpeed Gluon BF16 MoE | pending | pending | pending | pending | pending | pending | pending | pending | [native-reference-2: accepted](</home/benjacob/work/consan-benchmark-gfx950-20260918/tokenspeed-bf16-moe/tokenspeed-bf16-moe--native-reference-2.log>) |
