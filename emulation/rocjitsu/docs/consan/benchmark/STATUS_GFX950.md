...
| PyTorch synthetic dense decode (one continuous-batch tick) | 3.73 s | 0.00361 s (1×) | 190 s | 0.00346 s (0.958×) | 269 s | 5.1 s (1,410×) | 252 s | 0.0077 s (2.13×) | 250 s | 28.2 s (7,800×) | [native-validation: accepted](</home/benjacob/consan-gfx950-benchmark-full/pytorch-synthetic-decode--native-validation.log>) |
| PyTorch synthetic four-expert top-1 MoE prefill (16-token prompt) | 4.64 s | 0.0112 s (1×) | 326 s | 0.0137 s (1.22×) | 603 s | 21 s (1,870×) | 451 s | 0.021 s (1.87×) | 524 s | 72.1 s (6,410×) | [native-validation: accepted](</home/benjacob/consan-gfx950-benchmark-full/pytorch-top1-moe-prefill--native-validation.log>) |
...
| TokenSpeed Gluon BF16 GEMM medium-M (128×4096×4096) | 0.124 s | 0.000628 s (1×) | failed | failed | pending | pending | pending | pending | pending | pending | [supercollider--audit-on: failed](</home/benjacob/consan-gfx950-benchmark-full/tokenspeed-bf16-gemm-mediumm--supercollider--audit-on.log>) |
