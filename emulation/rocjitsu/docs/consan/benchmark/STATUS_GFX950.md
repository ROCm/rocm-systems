...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| PyTorch synthetic dense prefill (32-token prompt) | 4.3 s | 0.00351 s (1×) | 185 s | 0.00401 s (1.14×) | 278 s | 5.37 s (1,530×) | 226 s | 0.00774 s (2.2×) | running | running | [inline-shadow--audit-on: running](</home/benjacob/consan-gfx950-benchmark-full/pytorch-dense-prefill--inline-shadow--audit-on.log>) |
