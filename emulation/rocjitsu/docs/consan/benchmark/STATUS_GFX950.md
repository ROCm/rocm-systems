...
| TokenSpeed Qwen3-0.6B prefill | 3.77 s | 0.0255 s (1×) | running | running | pending | pending | pending | pending | pending | pending | [supercollider--audit-on: running](</home/benjacob/consan-gfx950-benchmark-full/tokenspeed-qwen-prefill--supercollider--audit-on.log>) |
