...
| TokenSpeed Qwen3-0.6B prefill | 3.77 s | 0.0255 s (1×) | 173 s | 0.0275 s (1.08×) | running | running | pending | pending | pending | pending | [record-replay--audit-on: running](</home/benjacob/consan-gfx950-benchmark-full/tokenspeed-qwen-prefill--record-replay--audit-on.log>) |
