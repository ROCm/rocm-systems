...
| PyTorch synthetic dense decode (one continuous-batch tick) | 3.73 s | 0.00361 s (1×) | 190 s | 0.00346 s (0.958×) | 269 s | 5.1 s (1,410×) | 252 s | 0.0077 s (2.13×) | running | running | [inline-shadow--audit-on: running](</home/benjacob/consan-gfx950-benchmark-full/pytorch-synthetic-decode--inline-shadow--audit-on.log>) |
