...
async opt-in: large gfx1250 WMMA, plus K32 with cached admission. Exclude memory
offload. This accelerates functional simulation; it does not model GPU timing.
