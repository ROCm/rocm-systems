...
const bool ScratchLoadB128Vscratch::execute_registered_ = register_exec_fn<ScratchLoadB128Vscratch>();
...
void ScratchStoreB8Vscratch::execute_impl(amdgpu::Wavefront &wf) {
  ...
  uint32_t data_base = wf.vgpr_alloc().base + *Isa::resolved_vgpr_offset(wf, vsrc.opr_type_, vsrc.encoding_value_, vsrc.vgpr_msb_role());
...
const bool ScratchStoreB16Vscratch::execute_registered_ = register_exec_fn<ScratchStoreB16Vscratch>();
...
const bool ScratchStoreB32Vscratch::execute_registered_ = register_exec_fn<ScratchStoreB32Vscratch>();
...
const bool ScratchStoreB64Vscratch::execute_registered_ = register_exec_fn<ScratchStoreB64Vscratch>();
...
const bool ScratchStoreB96Vscratch::execute_registered_ = register_exec_fn<ScratchStoreB96Vscratch>();
...
const bool ScratchStoreB128Vscratch::execute_registered_ = register_exec_fn<ScratchStoreB128Vscratch>();
...
const bool ScratchLoadD16U8Vscratch::execute_registered_ = register_exec_fn<ScratchLoadD16U8Vscratch>();
...
const bool ScratchLoadD16I8Vscratch::execute_registered_ = register_exec_fn<ScratchLoadD16I8Vscratch>();
...
const bool ScratchLoadD16B16Vscratch::execute_registered_ = register_exec_fn<ScratchLoadD16B16Vscratch>();
...
const bool ScratchLoadD16HiU8Vscratch::execute_registered_ = register_exec_fn<ScratchLoadD16HiU8Vscratch>();
...
const bool ScratchLoadD16HiI8Vscratch::execute_registered_ = register_exec_fn<ScratchLoadD16HiI8Vscratch>();
...
const bool ScratchLoadD16HiB16Vscratch::execute_registered_ = register_exec_fn<ScratchLoadD16HiB16Vscratch>();
...
const bool ScratchStoreD16HiB8Vscratch::execute_registered_ = register_exec_fn<ScratchStoreD16HiB8Vscratch>();
...
const bool ScratchStoreD16HiB16Vscratch::execute_registered_ = register_exec_fn<ScratchStoreD16HiB16Vscratch>();
...
const bool ScratchLoadBlockVscratch::execute_registered_ = register_exec_fn<ScratchLoadBlockVscratch>();
...
const bool ScratchStoreBlockVscratch::execute_registered_ = register_exec_fn<ScratchStoreBlockVscratch>();
