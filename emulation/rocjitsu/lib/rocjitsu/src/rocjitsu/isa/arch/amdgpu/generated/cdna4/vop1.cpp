...
VMovB32Vop1::VMovB32Vop1(const MachineInst *inst)
  ...
  if (reinterpret_cast<const OpEncoding *>(inst)->src0 == amdgpu::SRC_DPP) {
    ...
    if (!amdgpu::dpp::dpp_ctrl_is_valid(dp->dpp_ctrl, true, true, false))
...
DecodeResult decodeVReadfirstlaneB32Vop1(const MachineInst *opcode,
  ...
  if (validation.failed()) [[unlikely]]
    return Result::failure();
  if (reinterpret_cast<const Vop1::OpEncoding *>(inst)->src0 == amdgpu::SRC_DPP) [[unlikely]]
...
VCvtRpiI32F32Vop1::VCvtRpiI32F32Vop1(const MachineInst *inst)
  ...
  if (reinterpret_cast<const OpEncoding *>(inst)->src0 == amdgpu::SRC_DPP) {
    auto *dp = reinterpret_cast<const Vop1VopDppMachineInst *>(inst);
    if (!amdgpu::dpp::dpp_ctrl_is_valid(dp->dpp_ctrl, true, true, false))
      throw util::InvalidInst("v_cvt_rpi_i32_f32: reserved DPP control", "");
    src0 = Operand(32, OperandType::OPR_VGPR, dp->vsrc0);
    dpp_ctrl_ = dp->dpp_ctrl;
    dpp_row_mask_ = dp->row_mask;
    dpp_bank_mask_ = dp->bank_mask;
...
VCvtFlrI32F32Vop1::VCvtFlrI32F32Vop1(const MachineInst *inst)
  ...
  if (reinterpret_cast<const OpEncoding *>(inst)->src0 == amdgpu::SRC_DPP) {
    auto *dp = reinterpret_cast<const Vop1VopDppMachineInst *>(inst);
    if (!amdgpu::dpp::dpp_ctrl_is_valid(dp->dpp_ctrl, true, true, false))
      throw util::InvalidInst("v_cvt_flr_i32_f32: reserved DPP control", "");
    src0 = Operand(32, OperandType::OPR_VGPR, dp->vsrc0);
    dpp_ctrl_ = dp->dpp_ctrl;
    dpp_row_mask_ = dp->row_mask;
    dpp_bank_mask_ = dp->bank_mask;
...
VFfbhU32Vop1::VFfbhU32Vop1(const MachineInst *inst)
  ...
  if (reinterpret_cast<const OpEncoding *>(inst)->src0 == amdgpu::SRC_DPP) {
    auto *dp = reinterpret_cast<const Vop1VopDppMachineInst *>(inst);
    if (!amdgpu::dpp::dpp_ctrl_is_valid(dp->dpp_ctrl, true, true, false))
      throw util::InvalidInst("v_ffbh_u32: reserved DPP control", "");
    src0 = Operand(32, OperandType::OPR_VGPR, dp->vsrc0);
    dpp_ctrl_ = dp->dpp_ctrl;
    dpp_row_mask_ = dp->row_mask;
    dpp_bank_mask_ = dp->bank_mask;
...
VFfblB32Vop1::VFfblB32Vop1(const MachineInst *inst)
  ...
  if (reinterpret_cast<const OpEncoding *>(inst)->src0 == amdgpu::SRC_DPP) {
    auto *dp = reinterpret_cast<const Vop1VopDppMachineInst *>(inst);
    if (!amdgpu::dpp::dpp_ctrl_is_valid(dp->dpp_ctrl, true, true, false))
      throw util::InvalidInst("v_ffbl_b32: reserved DPP control", "");
    src0 = Operand(32, OperandType::OPR_VGPR, dp->vsrc0);
    dpp_ctrl_ = dp->dpp_ctrl;
    dpp_row_mask_ = dp->row_mask;
    dpp_bank_mask_ = dp->bank_mask;
...
VFfbhI32Vop1::VFfbhI32Vop1(const MachineInst *inst)
  ...
  if (reinterpret_cast<const OpEncoding *>(inst)->src0 == amdgpu::SRC_DPP) {
    auto *dp = reinterpret_cast<const Vop1VopDppMachineInst *>(inst);
    if (!amdgpu::dpp::dpp_ctrl_is_valid(dp->dpp_ctrl, true, true, false))
      throw util::InvalidInst("v_ffbh_i32: reserved DPP control", "");
    src0 = Operand(32, OperandType::OPR_VGPR, dp->vsrc0);
    dpp_ctrl_ = dp->dpp_ctrl;
    dpp_row_mask_ = dp->row_mask;
    dpp_bank_mask_ = dp->bank_mask;
...
VClrexcpVop1::VClrexcpVop1(const MachineInst *inst)
  ...
  if (reinterpret_cast<const OpEncoding *>(inst)->src0 == amdgpu::SRC_DPP ||
      amdgpu::dpp::is_src_dpp8(reinterpret_cast<const OpEncoding *>(inst)->src0))
    throw util::InvalidInst("V_CLREXCP does not support DPP", "");
}
...
VScreenPartition4seB32Vop1::VScreenPartition4seB32Vop1(const MachineInst *inst)
  ...
  if (reinterpret_cast<const OpEncoding *>(inst)->src0 == amdgpu::SRC_DPP) {
    auto *dp = reinterpret_cast<const Vop1VopDppMachineInst *>(inst);
    if (!amdgpu::dpp::dpp_ctrl_is_valid(dp->dpp_ctrl, true, true, false))
      throw util::InvalidInst("v_screen_partition_4se_b32: reserved DPP control", "");
    src0 = Operand(32, OperandType::OPR_VGPR, dp->vsrc0);
    dpp_ctrl_ = dp->dpp_ctrl;
    dpp_row_mask_ = dp->row_mask;
    dpp_bank_mask_ = dp->bank_mask;
...
VExpLegacyF32Vop1::VExpLegacyF32Vop1(const MachineInst *inst)
  ...
  if (reinterpret_cast<const OpEncoding *>(inst)->src0 == amdgpu::SRC_DPP) {
    auto *dp = reinterpret_cast<const Vop1VopDppMachineInst *>(inst);
    if (!amdgpu::dpp::dpp_ctrl_is_valid(dp->dpp_ctrl, true, true, false))
      throw util::InvalidInst("v_exp_legacy_f32: reserved DPP control", "");
    src0 = Operand(32, OperandType::OPR_VGPR, dp->vsrc0);
    dpp_ctrl_ = dp->dpp_ctrl;
    dpp_row_mask_ = dp->row_mask;
    dpp_bank_mask_ = dp->bank_mask;
...
VLogLegacyF32Vop1::VLogLegacyF32Vop1(const MachineInst *inst)
  ...
  if (reinterpret_cast<const OpEncoding *>(inst)->src0 == amdgpu::SRC_DPP) {
    auto *dp = reinterpret_cast<const Vop1VopDppMachineInst *>(inst);
    if (!amdgpu::dpp::dpp_ctrl_is_valid(dp->dpp_ctrl, true, true, false))
      throw util::InvalidInst("v_log_legacy_f32: reserved DPP control", "");
    src0 = Operand(32, OperandType::OPR_VGPR, dp->vsrc0);
    dpp_ctrl_ = dp->dpp_ctrl;
    dpp_row_mask_ = dp->row_mask;
    dpp_bank_mask_ = dp->bank_mask;
...
VAccvgprMovB32Vop1::VAccvgprMovB32Vop1(const MachineInst *inst)
  ...
  if (reinterpret_cast<const OpEncoding *>(inst)->src0 == amdgpu::SRC_DPP) {
    auto *dp = reinterpret_cast<const Vop1VopDppMachineInst *>(inst);
    if (!amdgpu::dpp::dpp_ctrl_is_valid(dp->dpp_ctrl, true, true, false))
      throw util::InvalidInst("v_accvgpr_mov_b32: reserved DPP control", "");
    src0 = Operand(32, OperandType::OPR_VGPR, dp->vsrc0);
    dpp_ctrl_ = dp->dpp_ctrl;
    dpp_row_mask_ = dp->row_mask;
    dpp_bank_mask_ = dp->bank_mask;
...
VCvtPkF32Fp8Vop1::VCvtPkF32Fp8Vop1(const MachineInst *inst)
  ...
  if (reinterpret_cast<const OpEncoding *>(inst)->src0 == amdgpu::SRC_DPP) {
    auto *dp = reinterpret_cast<const Vop1VopDppMachineInst *>(inst);
    if (!amdgpu::dpp::dpp_ctrl_is_valid(dp->dpp_ctrl, true, true, false))
      throw util::InvalidInst("v_cvt_pk_f32_fp8: reserved DPP control", "");
    src0 = Operand(16, OperandType::OPR_VGPR, dp->vsrc0);
    dpp_ctrl_ = dp->dpp_ctrl;
    dpp_row_mask_ = dp->row_mask;
    dpp_bank_mask_ = dp->bank_mask;
...
VCvtPkF32Bf8Vop1::VCvtPkF32Bf8Vop1(const MachineInst *inst)
  ...
  if (reinterpret_cast<const OpEncoding *>(inst)->src0 == amdgpu::SRC_DPP) {
    auto *dp = reinterpret_cast<const Vop1VopDppMachineInst *>(inst);
    if (!amdgpu::dpp::dpp_ctrl_is_valid(dp->dpp_ctrl, true, true, false))
      throw util::InvalidInst("v_cvt_pk_f32_bf8: reserved DPP control", "");
    src0 = Operand(16, OperandType::OPR_VGPR, dp->vsrc0);
    dpp_ctrl_ = dp->dpp_ctrl;
    dpp_row_mask_ = dp->row_mask;
    dpp_bank_mask_ = dp->bank_mask;
...
DecodeResult decodeVPermlane16SwapB32Vop1(const MachineInst *opcode,
  ...
  if (reinterpret_cast<const Vop1::OpEncoding *>(inst)->src0 == amdgpu::SRC_SDWA) [[unlikely]]
    return emit_error.emit() << "V_PERMLANE16_SWAP_B32 does not support SDWA";
...
VPermlane32SwapB32Vop1::VPermlane32SwapB32Vop1(const MachineInst *inst)
  ...
  num_dst_ = 2;
  if (reinterpret_cast<const OpEncoding *>(inst)->src0 == amdgpu::SRC_DPP)
    throw util::InvalidInst("V_PERMLANE32_SWAP_B32 does not support DPP", "");
  vdst.set_vgpr_msb_role(amdgpu::VgprMsbRole::Dst);
  src0.set_vgpr_msb_role(amdgpu::VgprMsbRole::Src0);
}
...
DecodeResult decodeVPermlane32SwapB32Vop1(const MachineInst *opcode,
  ...
  if (validation.failed()) [[unlikely]]
    return Result::failure();
  if (reinterpret_cast<const Vop1::OpEncoding *>(inst)->src0 == amdgpu::SRC_DPP) [[unlikely]]
    return emit_error.emit() << "V_PERMLANE32_SWAP_B32 does not support DPP";
  if (reinterpret_cast<const Vop1::OpEncoding *>(inst)->src0 == amdgpu::SRC_SDWA) [[unlikely]]
    return emit_error.emit() << "V_PERMLANE32_SWAP_B32 does not support SDWA";
