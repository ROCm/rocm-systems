...
#include "rocjitsu/isa/arch/amdgpu/generated/cdna2/decoder.h"
...
std::unique_ptr<Instruction> decodeVMfmaF3216x16x16bf161kVop3pMfma(const MachineInst *opcode);
std::unique_ptr<Instruction> decodeVMfmaF3216x16x16f16Vop3pMfma(const MachineInst *opcode);
std::unique_ptr<Instruction> decodeVMfmaF3216x16x1f32Vop3pMfma(const MachineInst *opcode);
std::unique_ptr<Instruction> decodeVMfmaF3216x16x2bf16Vop3pMfma(const MachineInst *opcode);
std::unique_ptr<Instruction> decodeVMfmaF3216x16x4bf161kVop3pMfma(const MachineInst *opcode);
std::unique_ptr<Instruction> decodeVMfmaF3216x16x4f16Vop3pMfma(const MachineInst *opcode);
std::unique_ptr<Instruction> decodeVMfmaF3216x16x4f32Vop3pMfma(const MachineInst *opcode);
std::unique_ptr<Instruction> decodeVMfmaF3216x16x8bf16Vop3pMfma(const MachineInst *opcode);
std::unique_ptr<Instruction> decodeVMfmaF3232x32x1f32Vop3pMfma(const MachineInst *opcode);
std::unique_ptr<Instruction> decodeVMfmaF3232x32x2bf16Vop3pMfma(const MachineInst *opcode);
std::unique_ptr<Instruction> decodeVMfmaF3232x32x2f32Vop3pMfma(const MachineInst *opcode);
std::unique_ptr<Instruction> decodeVMfmaF3232x32x4bf161kVop3pMfma(const MachineInst *opcode);
std::unique_ptr<Instruction> decodeVMfmaF3232x32x4bf16Vop3pMfma(const MachineInst *opcode);
std::unique_ptr<Instruction> decodeVMfmaF3232x32x4f16Vop3pMfma(const MachineInst *opcode);
std::unique_ptr<Instruction> decodeVMfmaF3232x32x8bf161kVop3pMfma(const MachineInst *opcode);
std::unique_ptr<Instruction> decodeVMfmaF3232x32x8f16Vop3pMfma(const MachineInst *opcode);
std::unique_ptr<Instruction> decodeVMfmaF324x4x1f32Vop3pMfma(const MachineInst *opcode);
std::unique_ptr<Instruction> decodeVMfmaF324x4x2bf16Vop3pMfma(const MachineInst *opcode);
std::unique_ptr<Instruction> decodeVMfmaF324x4x4bf161kVop3pMfma(const MachineInst *opcode);
std::unique_ptr<Instruction> decodeVMfmaF324x4x4f16Vop3pMfma(const MachineInst *opcode);
std::unique_ptr<Instruction> decodeVMfmaF6416x16x4f64Vop3pMfma(const MachineInst *opcode);
std::unique_ptr<Instruction> decodeVMfmaF644x4x4f64Vop3pMfma(const MachineInst *opcode);
std::unique_ptr<Instruction> decodeVMfmaI3216x16x16i8Vop3pMfma(const MachineInst *opcode);
std::unique_ptr<Instruction> decodeVMfmaI3216x16x4i8Vop3pMfma(const MachineInst *opcode);
std::unique_ptr<Instruction> decodeVMfmaI3232x32x4i8Vop3pMfma(const MachineInst *opcode);
std::unique_ptr<Instruction> decodeVMfmaI3232x32x8i8Vop3pMfma(const MachineInst *opcode);
std::unique_ptr<Instruction> decodeVMfmaI324x4x4i8Vop3pMfma(const MachineInst *opcode);
...
const std::array<DecoderImpl::DecodeFunc, 512> DecoderImpl::primary_decode_table = {
    ...
    &detail::decodeVXorB32Vop2,         &detail::decodeVXorB32Vop2,
    &detail::decodeVMacF32Vop2,         &detail::decodeVMacF32Vop2,
    &detail::decodeVMacF32Vop2,         &detail::decodeVMacF32Vop2,
    &detail::decodeVMadmkF32Vop2,       &detail::decodeVMadmkF32Vop2,
    &detail::decodeVMadmkF32Vop2,       &detail::decodeVMadmkF32Vop2,
    &detail::decodeVMadakF32Vop2,       &detail::decodeVMadakF32Vop2,
    &detail::decodeVMadakF32Vop2,       &detail::decodeVMadakF32Vop2,
    ...
    &DecoderImpl::decodeInvalid,        &DecoderImpl::decodeInvalid,
    &DecoderImpl::decodeInvalid,        &DecoderImpl::decodeInvalid,
    &DecoderImpl::subDecodeMimg,        &DecoderImpl::subDecodeMimg,
    &DecoderImpl::subDecodeMimg,        &DecoderImpl::subDecodeMimg,
    &DecoderImpl::subDecodeMimg,        &DecoderImpl::subDecodeMimg,
    &DecoderImpl::subDecodeMimg,        &DecoderImpl::subDecodeMimg,
    &DecoderImpl::decodeInvalid,        &DecoderImpl::decodeInvalid,
...
const std::array<DecoderImpl::DecodeFunc, 128> DecoderImpl::sub_decode_vop3p = {
    ...
    &DecoderImpl::decodeInvalid,
    &DecoderImpl::decodeInvalid,
    &detail::decodeVMfmaF3232x32x4bf161kVop3pMfma,
    &detail::decodeVMfmaF3216x16x4bf161kVop3pMfma,
    &detail::decodeVMfmaF324x4x4bf161kVop3pMfma,
    &detail::decodeVMfmaF3232x32x8bf161kVop3pMfma,
    &detail::decodeVMfmaF3216x16x16bf161kVop3pMfma,
    ...
    &detail::decodeVMfmaF644x4x4f64Vop3pMfma,
    &DecoderImpl::decodeInvalid,
    &DecoderImpl::decodeInvalid,
    &DecoderImpl::decodeInvalid,
    &DecoderImpl::decodeInvalid,
...
const std::array<DecoderImpl::DecodeFunc, 128> DecoderImpl::sub_decode_flat = {
    ...
    &DecoderImpl::decodeInvalid,         &DecoderImpl::decodeInvalid,
    &DecoderImpl::decodeInvalid,         &DecoderImpl::decodeInvalid,
    &detail::decodeFlatLoadUbyteFlat,    &detail::decodeFlatLoadSbyteFlat,
    &detail::decodeFlatLoadUshortFlat,   &detail::decodeFlatLoadSshortFlat,
    &detail::decodeFlatLoadDwordFlat,    &detail::decodeFlatLoadDwordx2Flat,
    &detail::decodeFlatLoadDwordx3Flat,  &detail::decodeFlatLoadDwordx4Flat,
    &detail::decodeFlatStoreByteFlat,    &detail::decodeFlatStoreByteD16HiFlat,
    &detail::decodeFlatStoreShortFlat,   &detail::decodeFlatStoreShortD16HiFlat,
    &detail::decodeFlatStoreDwordFlat,   &detail::decodeFlatStoreDwordx2Flat,
    &detail::decodeFlatStoreDwordx3Flat, &detail::decodeFlatStoreDwordx4Flat,
    &detail::decodeFlatLoadUbyteD16Flat, &detail::decodeFlatLoadUbyteD16HiFlat,
    &detail::decodeFlatLoadSbyteD16Flat, &detail::decodeFlatLoadSbyteD16HiFlat,
    &detail::decodeFlatLoadShortD16Flat, &detail::decodeFlatLoadShortD16HiFlat,
    &DecoderImpl::decodeInvalid,         &DecoderImpl::decodeInvalid,
    &DecoderImpl::decodeInvalid,         &DecoderImpl::decodeInvalid,
    &DecoderImpl::decodeInvalid,         &DecoderImpl::decodeInvalid,
    &DecoderImpl::decodeInvalid,         &DecoderImpl::decodeInvalid,
    ...
    &DecoderImpl::decodeInvalid,         &DecoderImpl::decodeInvalid,
    &DecoderImpl::decodeInvalid,         &DecoderImpl::decodeInvalid,
    &detail::decodeFlatAtomicSwapFlat,   &detail::decodeFlatAtomicCmpswapFlat,
    &detail::decodeFlatAtomicAddFlat,    &detail::decodeFlatAtomicSubFlat,
    &detail::decodeFlatAtomicSminFlat,   &detail::decodeFlatAtomicUminFlat,
    &detail::decodeFlatAtomicSmaxFlat,   &detail::decodeFlatAtomicUmaxFlat,
    &detail::decodeFlatAtomicAndFlat,    &detail::decodeFlatAtomicOrFlat,
    &detail::decodeFlatAtomicXorFlat,    &detail::decodeFlatAtomicIncFlat,
    &detail::decodeFlatAtomicDecFlat,    &DecoderImpl::decodeInvalid,
    &DecoderImpl::decodeInvalid,         &detail::decodeFlatAtomicAddF64Flat,
    &detail::decodeFlatAtomicMinF64Flat, &detail::decodeFlatAtomicMaxF64Flat,
    &DecoderImpl::decodeInvalid,         &DecoderImpl::decodeInvalid,
    &DecoderImpl::decodeInvalid,         &DecoderImpl::decodeInvalid,
    &DecoderImpl::decodeInvalid,         &DecoderImpl::decodeInvalid,
    &DecoderImpl::decodeInvalid,         &DecoderImpl::decodeInvalid,
    ...
    &DecoderImpl::decodeInvalid,         &DecoderImpl::decodeInvalid,
    &DecoderImpl::decodeInvalid,         &DecoderImpl::decodeInvalid,
    &detail::decodeFlatAtomicSwapX2Flat, &detail::decodeFlatAtomicCmpswapX2Flat,
    &detail::decodeFlatAtomicAddX2Flat,  &detail::decodeFlatAtomicSubX2Flat,
    &detail::decodeFlatAtomicSminX2Flat, &detail::decodeFlatAtomicUminX2Flat,
    &detail::decodeFlatAtomicSmaxX2Flat, &detail::decodeFlatAtomicUmaxX2Flat,
    &detail::decodeFlatAtomicAndX2Flat,  &detail::decodeFlatAtomicOrX2Flat,
    &detail::decodeFlatAtomicXorX2Flat,  &detail::decodeFlatAtomicIncX2Flat,
    &detail::decodeFlatAtomicDecX2Flat,  &DecoderImpl::decodeInvalid,
    &DecoderImpl::decodeInvalid,         &DecoderImpl::decodeInvalid,
    &DecoderImpl::decodeInvalid,         &DecoderImpl::decodeInvalid,
    &DecoderImpl::decodeInvalid,         &DecoderImpl::decodeInvalid,
    &DecoderImpl::decodeInvalid,         &DecoderImpl::decodeInvalid,
...
const std::array<DecoderImpl::DecodeFunc, 256> DecoderImpl::sub_decode_mimg = {
    ...
    &DecoderImpl::decodeInvalid,        &DecoderImpl::decodeInvalid,
    &detail::decodeImageSampleMimg,     &DecoderImpl::decodeInvalid,
    &DecoderImpl::decodeInvalid,        &DecoderImpl::decodeInvalid,
    &DecoderImpl::decodeInvalid,        &DecoderImpl::decodeInvalid,
    &DecoderImpl::decodeInvalid,        &DecoderImpl::decodeInvalid,
    &DecoderImpl::decodeInvalid,        &DecoderImpl::decodeInvalid,
