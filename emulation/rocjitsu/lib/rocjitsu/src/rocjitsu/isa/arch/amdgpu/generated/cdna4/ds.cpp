...
#include "rocjitsu/isa/arch/amdgpu/generated/cdna4/ds.h"
...
DsReadB96TrB6Ds::DsReadB96TrB6Ds(const MachineInst *inst)
    : Ds("ds_read_b96_tr_b6", reinterpret_cast<const OpEncoding *>(inst),
         selected_exec_fn(InstructionExecutionId::DsReadB96TrB6Ds)),
...
DsReadB64TrB16Ds::DsReadB64TrB16Ds(const MachineInst *inst)
    : Ds("ds_read_b64_tr_b16", reinterpret_cast<const OpEncoding *>(inst),
         selected_exec_fn(InstructionExecutionId::DsReadB64TrB16Ds)),
      vdst(64, OperandType::OPR_VGPR_OR_ACCVGPR,
           (reinterpret_cast<const OpEncoding *>(inst)->vdst +
            (reinterpret_cast<const OpEncoding *>(inst)->acc
                 ? OpSelVgprOrAccvgpr::OPR_VGPR_OR_ACCVGPR_ACC_MIN
