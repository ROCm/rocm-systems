...
void VSwmmacF3216x16x32F16Vop3p::execute_impl(amdgpu::Wavefront &wf) {
  ...
  uint32_t vb = wf.vgpr_alloc().base;
  uint32_t dst = amdgpu::dst_base(vb, vdst.encoding_value_, 1);
  rdna4::exec_swmmac_f32(cu, 16, 16, 32, 2, 16, dst, amdgpu::src_base(vb, src0.encoding_value_),
                         amdgpu::src_base(vb, src1.encoding_value_), dst,
                         amdgpu::src_base(vb, src2.encoding_value_), 16, 0, amdgpu::extract_f16,
                         amdgpu::extract_f16);
}
...
void VSwmmacI3216x16x32Iu8Vop3p::execute_impl(amdgpu::Wavefront &wf) {
  ...
  rdna4::exec_swmmac_i32(cu, 16, 16, 32, 2, 8, dst, amdgpu::src_base(vb, src0.encoding_value_),
                         amdgpu::src_base(vb, src1.encoding_value_), dst,
                         amdgpu::src_base(vb, src2.encoding_value_), 16, 0, extract_a, extract_b,
                         inst_.clamp);
}
