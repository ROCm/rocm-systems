...
const std::array<DecoderImpl::DecodeFunc, 512> DecoderImpl::primary_decode_table = {
    ...
    &detail::decodeVSubrevF32Vop2,
    &detail::decodeVSubrevF32Vop2,
    &detail::decodeVMacLegacyF32Vop2,
    &detail::decodeVMacLegacyF32Vop2,
    &detail::decodeVMacLegacyF32Vop2,
    &detail::decodeVMacLegacyF32Vop2,
...
const std::array<DecoderImpl::DecodeFunc, 128> DecoderImpl::sub_decode_vop3p = {
    ...
    &detail::decodeVPkMaxF16Vop3p,     &DecoderImpl::decodeInvalid,
    &DecoderImpl::decodeInvalid,       &DecoderImpl::decodeInvalid,
    &DecoderImpl::decodeInvalid,       &DecoderImpl::decodeInvalid,
    &DecoderImpl::decodeInvalid,       &DecoderImpl::decodeInvalid,
    &DecoderImpl::decodeInvalid,       &DecoderImpl::decodeInvalid,
...
const std::array<DecoderImpl::DecodeFunc, 1024> DecoderImpl::sub_decode_vop3 = {
    ...
    &detail::decodeVMacLegacyF32Vop3,
...
const std::array<DecoderImpl::DecodeFunc, 256> DecoderImpl::sub_decode_mimg = {
    ...
    &DecoderImpl::decodeInvalid,           &DecoderImpl::decodeInvalid,
    &detail::decodeImageGetResinfoMimg,    &detail::decodeImageAtomicSwapMimg,
    &detail::decodeImageAtomicCmpswapMimg, &detail::decodeImageAtomicAddMimg,
    &detail::decodeImageAtomicSubMimg,     &DecoderImpl::decodeInvalid,
    ...
    &detail::decodeImageAtomicDecMimg,     &detail::decodeImageAtomicFcmpswapMimg,
    &detail::decodeImageAtomicFminMimg,    &detail::decodeImageAtomicFmaxMimg,
    ...
    &detail::decodeImageLoadBy2Mimg,       &detail::decodeImageLoadBy4Mimg,
    ...
    &detail::decodeImageLoadMipBy2Mimg,    &detail::decodeImageLoadMipBy4Mimg,
    ...
    &detail::decodeImageStoreBy2Mimg,      &detail::decodeImageStoreBy4Mimg,
    ...
    &detail::decodeImageStoreMipBy2Mimg,   &detail::decodeImageStoreMipBy4Mimg,
    ...
    &detail::decodeImageGetLodMimg,        &detail::decodeImageGather4hMimg,
    ...
    &detail::decodeImageLoadPck2Mimg,      &detail::decodeImageLoadPck4Mimg,
    &DecoderImpl::decodeInvalid,           &detail::decodeImageLoadMipPck2Mimg,
    &detail::decodeImageLoadMipPck4Mimg,   &DecoderImpl::decodeInvalid,
    &detail::decodeImageStorePck2Mimg,     &detail::decodeImageStorePck4Mimg,
    &DecoderImpl::decodeInvalid,           &detail::decodeImageStoreMipPck2Mimg,
    &detail::decodeImageStoreMipPck4Mimg,  &DecoderImpl::decodeInvalid,
    &DecoderImpl::decodeInvalid,           &DecoderImpl::decodeInvalid,
    &DecoderImpl::decodeInvalid,           &DecoderImpl::decodeInvalid,
    &detail::decodeImageMsaaLoadMimg,      &DecoderImpl::decodeInvalid,
    &DecoderImpl::decodeInvalid,           &DecoderImpl::decodeInvalid,
    &DecoderImpl::decodeInvalid,           &DecoderImpl::decodeInvalid,
    &DecoderImpl::decodeInvalid,           &DecoderImpl::decodeInvalid,
    &DecoderImpl::decodeInvalid,           &DecoderImpl::decodeInvalid,
    ...
    &DecoderImpl::decodeInvalid,           &DecoderImpl::decodeInvalid,
    &DecoderImpl::decodeInvalid,           &DecoderImpl::decodeInvalid,
    &detail::decodeImageSampleDG16Mimg,    &detail::decodeImageSampleDClG16Mimg,
    &DecoderImpl::decodeInvalid,           &DecoderImpl::decodeInvalid,
    &DecoderImpl::decodeInvalid,           &DecoderImpl::decodeInvalid,
    &DecoderImpl::decodeInvalid,           &DecoderImpl::decodeInvalid,
    &detail::decodeImageSampleCDG16Mimg,   &detail::decodeImageSampleCDClG16Mimg,
    &DecoderImpl::decodeInvalid,           &DecoderImpl::decodeInvalid,
    &DecoderImpl::decodeInvalid,           &DecoderImpl::decodeInvalid,
    &DecoderImpl::decodeInvalid,           &DecoderImpl::decodeInvalid,
    &detail::decodeImageSampleDOG16Mimg,   &detail::decodeImageSampleDClOG16Mimg,
    &DecoderImpl::decodeInvalid,           &DecoderImpl::decodeInvalid,
    &DecoderImpl::decodeInvalid,           &DecoderImpl::decodeInvalid,
    &DecoderImpl::decodeInvalid,           &DecoderImpl::decodeInvalid,
    &detail::decodeImageSampleCDOG16Mimg,  &detail::decodeImageSampleCDClOG16Mimg,
    &DecoderImpl::decodeInvalid,           &DecoderImpl::decodeInvalid,
    &DecoderImpl::decodeInvalid,           &DecoderImpl::decodeInvalid,
    &DecoderImpl::decodeInvalid,           &DecoderImpl::decodeInvalid,
    &DecoderImpl::decodeInvalid,           &DecoderImpl::decodeInvalid,
    ...
    &DecoderImpl::decodeInvalid,           &DecoderImpl::decodeInvalid,
    &detail::decodeImageSampleCdG16Mimg,   &detail::decodeImageSampleCdClG16Mimg,
    &detail::decodeImageSampleCCdG16Mimg,  &detail::decodeImageSampleCCdClG16Mimg,
    &detail::decodeImageSampleCdOG16Mimg,  &detail::decodeImageSampleCdClOG16Mimg,
    &detail::decodeImageSampleCCdOG16Mimg, &detail::decodeImageSampleCCdClOG16Mimg,
    &DecoderImpl::decodeInvalid,           &DecoderImpl::decodeInvalid,
    &DecoderImpl::decodeInvalid,           &DecoderImpl::decodeInvalid,
    &DecoderImpl::decodeInvalid,           &DecoderImpl::decodeInvalid,
    &DecoderImpl::decodeInvalid,           &DecoderImpl::decodeInvalid,
...
const std::array<DecoderImpl::DecodeFunc, 256> DecoderImpl::sub_decode_smem = {
    ...
    &DecoderImpl::decodeInvalid,
    &DecoderImpl::decodeInvalid,
    &detail::decodeSGetWaveidInWorkgroupSmem,
    &DecoderImpl::decodeInvalid,
    &DecoderImpl::decodeInvalid,
    &DecoderImpl::decodeInvalid,
    &DecoderImpl::decodeInvalid,
