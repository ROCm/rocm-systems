...
SSetValuCoexecModeSopp::SSetValuCoexecModeSopp(const MachineInst *inst) : Sopp("s_set_valu_coexec_mode", reinterpret_cast<const OpEncoding*>(inst), make_exec_fn<SSetValuCoexecModeSopp>()), simm16(32, OperandType::OPR_SIMM16, reinterpret_cast<const OpEncoding*>(inst)->simm16) {src_operands_[0] = &simm16;num_src_ = 1;num_dst_ = 0;}
