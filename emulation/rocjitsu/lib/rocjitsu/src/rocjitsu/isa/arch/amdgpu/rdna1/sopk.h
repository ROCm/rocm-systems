...
#ifndef ROCJITSU_ISA_ARCH_AMDGPU_RDNA1_SOPK_H_
#define ROCJITSU_ISA_ARCH_AMDGPU_RDNA1_SOPK_H_
...
class SSubvectorLoopBeginSopk : public Sopk
{
  public:
...
class SSubvectorLoopEndSopk : public Sopk
{
  public:
...
#endif // ROCJITSU_ISA_ARCH_AMDGPU_RDNA1_SOPK_H_
