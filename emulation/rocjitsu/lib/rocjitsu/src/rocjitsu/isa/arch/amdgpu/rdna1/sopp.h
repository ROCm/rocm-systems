...
#ifndef ROCJITSU_ISA_ARCH_AMDGPU_RDNA1_SOPP_H_
#define ROCJITSU_ISA_ARCH_AMDGPU_RDNA1_SOPP_H_
...
class SInstPrefetchSopp : public Sopp
{
  public:
   SInstPrefetchSopp(const MachineInst * inst);
  void execute_impl(amdgpu::Wavefront &wf);
  Operand simm16;
} ;
...
#endif // ROCJITSU_ISA_ARCH_AMDGPU_RDNA1_SOPP_H_
