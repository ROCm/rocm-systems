...
DecodeResult decodeBufferStoreShortMubuf(const MachineInst *opcode,
                                         const DecodeErrorEmitter &emit_error);
DecodeResult decodeBufferWbl2Mubuf(const MachineInst *opcode, const DecodeErrorEmitter &emit_error);
...
DecodeResult decodeDsPkAddRtnBf16Ds(const MachineInst *opcode,
                                    const DecodeErrorEmitter &emit_error);
DecodeResult decodeDsPkAddRtnF16Ds(const MachineInst *opcode, const DecodeErrorEmitter &emit_error);
...
DecodeResult decodeDsReadB64TrB16Ds(const MachineInst *opcode,
                                    const DecodeErrorEmitter &emit_error);
DecodeResult decodeDsReadB64TrB4Ds(const MachineInst *opcode, const DecodeErrorEmitter &emit_error);
DecodeResult decodeDsReadB64TrB8Ds(const MachineInst *opcode, const DecodeErrorEmitter &emit_error);
DecodeResult decodeDsReadB96Ds(const MachineInst *opcode, const DecodeErrorEmitter &emit_error);
DecodeResult decodeDsReadB96TrB6Ds(const MachineInst *opcode, const DecodeErrorEmitter &emit_error);
...
DecodeResult decodeSSetGprIdxOnSopc(const MachineInst *opcode,
                                    const DecodeErrorEmitter &emit_error);
DecodeResult decodeSSetValuCoexecModeSopp(const MachineInst *opcode,
                                          const DecodeErrorEmitter &emit_error);
...
DecodeResult decodeVDot2U32U16Vop3p(const MachineInst *opcode,
                                    const DecodeErrorEmitter &emit_error);
DecodeResult decodeVDot2cF32Bf16Vop2(const MachineInst *opcode,
                                     const DecodeErrorEmitter &emit_error);
