...
case OperandType::OPR_SRC_ACCVGPR_OR_CONST: { if (encoding_value_ >= OpSelSrcAccvgprOrConst::OPR_SRC_ACCVGPR_OR_CONST_ACC_MIN && encoding_value_ <= OpSelSrcAccvgprOrConst::OPR_SRC_ACCVGPR_OR_CONST_ACC_MAX) return reg_name("acc", encoding_value_ - OpSelSrcAccvgprOrConst::OPR_SRC_ACCVGPR_OR_CONST_ACC_MIN, size_bits_); if (encoding_value_ >= OpSelSrcAccvgprOrConst::OPR_SRC_ACCVGPR_OR_CONST_POS_INT_MIN && encoding_value_ <= OpSelSrcAccvgprOrConst::OPR_SRC_ACCVGPR_OR_CONST_POS_INT_MAX) return std::to_string(encoding_value_ - OpSelSrcAccvgprOrConst::OPR_SRC_ACCVGPR_OR_CONST_POS_INT_MIN); if (encoding_value_ >= OpSelSrcAccvgprOrConst::OPR_SRC_ACCVGPR_OR_CONST_NEG_INT_MIN && encoding_value_ <= OpSelSrcAccvgprOrConst::OPR_SRC_ACCVGPR_OR_CONST_NEG_INT_MAX) return std::to_string(-(encoding_value_ - OpSelSrcAccvgprOrConst::OPR_SRC_ACCVGPR_OR_CONST_NEG_INT_MIN + 1)); if (encoding_value_ == OpSelSrcAccvgprOrConst::OPR_SRC_ACCVGPR_OR_CONST_FLOAT_HALF) return "0.5"; if (encoding_value_ == OpSelSrcAccvgprOrConst::OPR_SRC_ACCVGPR_OR_CONST_FLOAT_NEG_HALF) return "-0.5"; if (encoding_value_ == OpSelSrcAccvgprOrConst::OPR_SRC_ACCVGPR_OR_CONST_FLOAT_ONE) return "1.0"; if (encoding_value_ == OpSelSrcAccvgprOrConst::OPR_SRC_ACCVGPR_OR_CONST_FLOAT_NEG_ONE) return "-1.0"; if (encoding_value_ == OpSelSrcAccvgprOrConst::OPR_SRC_ACCVGPR_OR_CONST_FLOAT_TWO) return "2.0"; if (encoding_value_ == OpSelSrcAccvgprOrConst::OPR_SRC_ACCVGPR_OR_CONST_FLOAT_NEG_TWO) return "-2.0"; if (encoding_value_ == OpSelSrcAccvgprOrConst::OPR_SRC_ACCVGPR_OR_CONST_FLOAT_FOUR) return "4.0"; if (encoding_value_ == OpSelSrcAccvgprOrConst::OPR_SRC_ACCVGPR_OR_CONST_FLOAT_NEG_FOUR) return "-4.0"; if (encoding_value_ == OpSelSrcAccvgprOrConst::OPR_SRC_ACCVGPR_OR_CONST_FLOAT_ONE_OVER_TWO_PI) return "0.15915494"; break; }
...
case OperandType::OPR_SRC_ACCVGPR_OR_CONST: { if (encoding_value_ >= OpSelSrcAccvgprOrConst::OPR_SRC_ACCVGPR_OR_CONST_ACC_MIN && encoding_value_ <= OpSelSrcAccvgprOrConst::OPR_SRC_ACCVGPR_OR_CONST_ACC_MAX) return RegisterRef{RegClass::ACC_VGPR, static_cast<uint16_t>(encoding_value_ - OpSelSrcAccvgprOrConst::OPR_SRC_ACCVGPR_OR_CONST_ACC_MIN), reg_width}; break; }
