...
/// architecture-specific prologue and DS lowering details live in
/// lds_virtualization.cpp so the main translation loop does not grow target-ISA
/// encoding knowledge.
...
/// target instruction encoders and resource limits remain in
/// lds_virtualization.cpp.
