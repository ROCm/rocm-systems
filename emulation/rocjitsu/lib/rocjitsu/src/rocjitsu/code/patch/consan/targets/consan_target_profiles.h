...
extern const std::array<TargetProfile, 5> kTargetProfiles;

[[nodiscard]] constexpr bool arch_is_cdna3_or_cdna4(rj_code_arch_t arch) {
  return arch == ROCJITSU_CODE_ARCH_CDNA3 || arch == ROCJITSU_CODE_ARCH_CDNA4;
}

[[nodiscard]] constexpr bool arch_is_rdna4_or_cdna5(rj_code_arch_t arch) {
  return arch == ROCJITSU_CODE_ARCH_RDNA4 || arch == ROCJITSU_CODE_ARCH_CDNA5;
}

[[nodiscard]] constexpr bool arch_is_cdna5(rj_code_arch_t arch) {
  return arch == ROCJITSU_CODE_ARCH_CDNA5;
}

[[nodiscard]] constexpr bool arch_is_rdna3(rj_code_arch_t arch) {
