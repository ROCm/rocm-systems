...
enum class FlatSubwordPlacement : uint8_t {
  Low16,
  High16,
};

struct FlatSubwordSemantics {
  uint32_t memory_width_bits = 0;
  FlatSubwordPlacement placement = FlatSubwordPlacement::Low16;
};
...
[[nodiscard]] inline constexpr std::optional<FlatSubwordSemantics>
flat_load_subword_semantics(std::string_view mnemonic) {
  if (mnemonic == "flat_load_d16_u8" || mnemonic == "flat_load_d16_i8" ||
      mnemonic == "flat_load_ubyte_d16" || mnemonic == "flat_load_sbyte_d16")
    return FlatSubwordSemantics{8u, FlatSubwordPlacement::Low16};

  if (mnemonic == "flat_load_d16_b16" || mnemonic == "flat_load_short_d16")
    return FlatSubwordSemantics{16u, FlatSubwordPlacement::Low16};
  ...
  if (mnemonic == "flat_load_d16_hi_u8" || mnemonic == "flat_load_d16_hi_i8" ||
    ...
    return FlatSubwordSemantics{8u, FlatSubwordPlacement::High16};

  if (mnemonic == "flat_load_d16_hi_b16" || mnemonic == "flat_load_short_d16_hi")
    return FlatSubwordSemantics{16u, FlatSubwordPlacement::High16};
...
[[nodiscard]] inline constexpr std::optional<FlatSubwordSemantics>
flat_store_subword_semantics(std::string_view mnemonic) {
