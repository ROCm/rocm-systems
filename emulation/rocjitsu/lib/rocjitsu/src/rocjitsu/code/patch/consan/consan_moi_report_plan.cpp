...
classify_evidence_intent(const ConSanEngineProbeVocabulary &vocabulary, Probe kind) {
...
[[nodiscard]] uint64_t evidence_element_count(const ConSanEngineProbeVocabulary &vocabulary,
                                              Evidence kind,
