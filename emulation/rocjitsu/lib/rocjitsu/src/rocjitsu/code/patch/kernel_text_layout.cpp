...
// SOPP reaches almost 128 KiB in either direction. Full-SGPR conditional
// branches can add one word after pools are placed, at most doubling a
// branch-dense interval, so keep the pre-growth pool grid within half of the
// original 64 KiB safety interval.
constexpr uint64_t kDirectBranchIslandSpacingBytes = 32 * 1024;
} // namespace
