...
/// Complete site-local facts selected before a ConSan access body is sized.
///
...
struct AccessEmissionPlan {
  ...
  size_t causal_windows_offset = 0;
  size_t watchpoints_offset = 0;
  size_t pending_acquires_offset = 0;
  ...
  std::optional<detail::WorkitemOwnerDerivationPlan> owner_derivation;
