...
selectable_vgpr_bank_mode_at(rj_code_arch_t arch, std::span<const uint8_t> bytes,
...
[[nodiscard]] bool selectable_vgpr_bank_transition_in_range(rj_code_arch_t arch,
