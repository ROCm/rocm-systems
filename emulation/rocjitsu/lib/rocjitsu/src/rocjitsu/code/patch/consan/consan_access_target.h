...
/// Materialize one CDNA5 tensor-transfer LDS address from a caller-selected linear
...
/// zero-filled elements and apply descriptor padding; stores ignore padding
/// and the caller must exclude masked elements which do not read LDS.
...
[[nodiscard]] bool
append_materialize_tensor_lds_address(std::vector<uint32_t> &words, const ProgramSite &site,
