...
/// parity, program-end waits or control flow. An empty diagnostics vector alone
...
/// end are outside the scope. Invalid options/architectures or malformed encodings
