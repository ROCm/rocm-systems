...
/// RegisterSet makes every invalidation scan SGPR, VGPR, and AccVGPR bitsets
/// even though vector classes are irrelevant here. Keep two words instead and
/// iterate only set SGPR bits.
