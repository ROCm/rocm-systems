...
/// computes. This module reproduces that layout for the gfx9 family
/// (CDNA1-4 / gfx942 / gfx950), cross-checked against
/// projects/rocdbgapi/src/architecture.cpp (gfx9/gfx90a/mi cwsr_record_t).
