...
struct GpuGenerationDescriptor {
...
public:
  ...
  explicit GpuGenerationRegistry(const GpuGenerationDescriptor (&descriptors)[N])
      : descriptors_(descriptors, N), initialization_error_(validate(descriptors_)) {}
