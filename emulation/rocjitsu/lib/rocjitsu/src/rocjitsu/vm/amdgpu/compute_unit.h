...
protected:
  ...
  util::inline_vector<std::unique_ptr<Wavefront>> wfs_; ///< Pre-allocated wavefront slots.
  ...
  util::inline_vector<Wavefront *> sgpr_to_wave_;
...
private:
  ...
  util::inline_vector<Wavefront *> vgpr_to_wave_; ///< Physical VGPR → owning wavefront.
