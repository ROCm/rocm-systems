...
public:
  ...
  /// @brief Return whether the submission was accepted by a live queue binding.
  explicit operator bool() const { return found && status == QueueSubmissionStatus::Accepted; }
};
