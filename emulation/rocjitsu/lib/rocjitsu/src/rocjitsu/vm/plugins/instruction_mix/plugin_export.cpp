...
/// @brief Loader exports for librocjitsu_plugin_instruction-mix.so.
///
...
ROCJITSU_DEFINE_PLUGIN(rocjitsu::plugins::instruction_mix::InstructionMixPlugin, "instruction-mix",
                       "{}")
