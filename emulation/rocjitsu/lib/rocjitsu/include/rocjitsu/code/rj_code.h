...
typedef enum rj_code_target_id_t {
  ...
  /// @note ABI review: rocjitsu-beta-v0.1.0 published INVALID as 6. Assigning 6
  /// to gfx1251 makes a new library interpret INVALID passed by an old binary
  /// as gfx1251. Should INVALID remain 6 and gfx1251 use 7 instead?
  ...
  ROCJITSU_CODE_TARGET_INVALID = 7
} rj_code_target_id_t;
