...
def gen_mfma(
    ...
    if inst.operands and inst.operands[0].field_less:
        raise ValueError(
            f'{name}: field-less operand at index 0 breaks the '
            f'accumulator-is-operand[0] assumption in gen_mfma. A field-less '
