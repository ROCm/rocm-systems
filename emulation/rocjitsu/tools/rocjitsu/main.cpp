...
int main(int argc, char *argv[]) {
  ...
  if (dbt_guest_mode) {
    ...
    const char *existing_tools = launch_environment.get("HSA_TOOLS_LIB");
    launch_environment.set("HSA_TOOLS_LIB", existing_tools && *existing_tools
                                                ? std::string(existing_tools) + " " + hooks_path
                                                : hooks_path);
  }
