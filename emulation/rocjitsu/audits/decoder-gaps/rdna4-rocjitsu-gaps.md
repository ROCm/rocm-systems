...
Audit snapshot: RDNA4 manual `workspace_docs/amdgpu-isa-manuals/rdna4/README.md`, RDNA4
XML `shared/machine-readable-isa/isa/amdgpu_isa_rdna4.xml`, and rocjitsu source at
`0e5333219682f52daf40713a4e6096fe2c78fc32` (rebased on `origin/develop`
`f226accd066d23a22339d10d103e4e0647d99f03`). The 2026-08-28 refresh was performed in
manual subsection order before reconciling stable IDs.

Refresh note: the following prior IDs are resolved in the audited snapshot and
are no longer active gaps: `RDNA4-RJ-016`, `RDNA4-RJ-064`, `RDNA4-RJ-075`, `RDNA4-RJ-079`, `RDNA4-RJ-105`,
`RDNA4-RJ-149`, `RDNA4-RJ-169`, `RDNA4-RJ-192`, `RDNA4-RJ-194`. Exact current evidence is recorded
in **Resolved since the previous audit** below. Their older finding bodies
remain only in Git history; the resolution ledger preserves the stable-ID mapping.

## Gaps

Active findings after refresh: 186 (`P0`: 4, `P1`: 32, `P2`: 80, `P3`: 35,
`P4`: 35).

Previously reported gaps now verified as non-gaps because of fixes in the
audited snapshot: 9. Historical findings reviewed: 195 (186 active + 9 now
non-gaps).

Ordered for triage: incorrect legal-code semantics and execution behavior rank
first, weighted by path frequency; state/runtime gaps and missing execution
support follow; decoder/legality, metadata/fidelity, permissiveness, and
test-only findings are later. Finding IDs remain stable.
...
- RDNA4 manual subsection 3.3.1.3 and 3.3.2.2 GPR out-of-range behavior, `workspace_docs/amdgpu-isa-manuals/rdna4/README.md:731` through `:809`.
...
- RDNA4 manual subsection 3.3.5.1 LDS Alignment and Out-of-Range, `workspace_docs/amdgpu-isa-manuals/rdna4/README.md:893` through `:922`.
...
- RDNA4 manual subsection 9.4–9.4.1 Buffer Addressing and Range Checking, `workspace_docs/amdgpu-isa-manuals/rdna4/README.md:3839` through `:3950`.
...
- RDNA4 manual subsection 11.2 Addressing, `workspace_docs/amdgpu-isa-manuals/rdna4/README.md:4755` through `:4830`.
...
- Forward-refresh source anchor: `lib/rocjitsu/src/rocjitsu/isa/arch/amdgpu/rdna4/addr_calc.cpp:128`.
...
- RDNA4 manual subsection 3.4.1–3.4.2 STATUS and STATE_PRIV, `workspace_docs/amdgpu-isa-manuals/rdna4/README.md:956` through `:999`.
...
- Forward-refresh source anchor: `lib/rocjitsu/src/rocjitsu/isa/arch/amdgpu/rdna4/isa.h:1`.
...
- RDNA4 manual subsection 4.1.1 Cache Controls: SCOPE and Temporal-Hint, `workspace_docs/amdgpu-isa-manuals/rdna4/README.md:1527` through `:1640`.
- The cited manual passage defines RDNA4 `SCOPE` values as
  `0=CU`, `1=SE`, `2=DEV`, and `3=SYS`.

Rocjitsu evidence:

- Forward-refresh source anchor: `lib/rocjitsu/src/rocjitsu/isa/arch/amdgpu/shared/gfx12_cache_flags.h:1`.
...
- Forward-refresh source anchor: `lib/rocjitsu/src/rocjitsu/isa/arch/amdgpu/shared/gfx12_cache_flags.h:126`.
...
- Forward-refresh source anchor: `lib/rocjitsu/src/rocjitsu/isa/arch/amdgpu/shared/scalar_operand_resolve.h:143`.
...
- RDNA4 manual subsection 5.5 Branching, `workspace_docs/amdgpu-isa-manuals/rdna4/README.md:1777` through `:1794`.
...
- Forward-refresh source anchor: `lib/rocjitsu/src/rocjitsu/isa/arch/amdgpu/generated/shared/execute_shared.h:4930`.
...
- RDNA4 manual subsection 7.7 Packed Math, `workspace_docs/amdgpu-isa-manuals/rdna4/README.md:2822` through `:2883`.
...
- RDNA4 manual subsection 7.12.3 Structured Sparse Matrices, `workspace_docs/amdgpu-isa-manuals/rdna4/README.md:3335` through `:3372`.
...
- Forward-refresh source anchor: `lib/rocjitsu/src/rocjitsu/isa/arch/amdgpu/shared/mma_exec.h:1`.
...
- RDNA4 manual subsection 7.12.2 Matrix Element Storage in VGPRs, `workspace_docs/amdgpu-isa-manuals/rdna4/README.md:3211` through `:3334`.
...
- RDNA4 manual subsection 7.8 Dual Issue VALU (VOPD), `workspace_docs/amdgpu-isa-manuals/rdna4/README.md:2917` through `:2993`.
...
- RDNA4 manual subsection 7.9.1 DPP16, `workspace_docs/amdgpu-isa-manuals/rdna4/README.md:3049` through `:3086`.
...
- Forward-refresh source anchor: `lib/rocjitsu/src/rocjitsu/isa/arch/amdgpu/generated/rdna4/vopc_exec.cpp:1`.
...
- RDNA4 manual subsection 7.11 VGPR Indexing, `workspace_docs/amdgpu-isa-manuals/rdna4/README.md:3129` through `:3140`.
...
- Forward-refresh source anchor: `lib/rocjitsu/src/rocjitsu/isa/arch/amdgpu/generated/shared/execute_shared.h:1`.
...
- RDNA4 manual subsection 7.2.3.1 Output Operand Modifiers, `workspace_docs/amdgpu-isa-manuals/rdna4/README.md:2525` through `:2569`.
...
- RDNA4 manual subsection 7.2.1 Non-Standard Uses of Operand Fields, `workspace_docs/amdgpu-isa-manuals/rdna4/README.md:2422` through `:2438`.
...
- RDNA4 manual subsection 7.7.2 Inline Constants with Packed Math, `workspace_docs/amdgpu-isa-manuals/rdna4/README.md:2896` through `:2916`.
...
- RDNA4 manual subsection 7.2.2 Input Operands, `workspace_docs/amdgpu-isa-manuals/rdna4/README.md:2439` through `:2453`.
...
- RDNA4 manual subsection 7.4 16-bit Math and VGPRs, `workspace_docs/amdgpu-isa-manuals/rdna4/README.md:2735` through `:2764`.
...
- Forward-refresh source anchor: `lib/rocjitsu/src/rocjitsu/isa/arch/amdgpu/generated/rdna4/vop3p.cpp:1`.
...
- RDNA4 manual subsection 6.8 SALU Floating Point, `workspace_docs/amdgpu-isa-manuals/rdna4/README.md:2217` through `:2255`.
...
- Forward-refresh source anchor: `lib/rocjitsu/src/rocjitsu/isa/arch/amdgpu/shared/scalar_operand_resolve.h:29`.
...
- RDNA4 manual subsection 8.1.3 Loads of 8 and 16-bit Data, `workspace_docs/amdgpu-isa-manuals/rdna4/README.md:3457` through `:3467`.
...
- RDNA4 manual subsection 11.3 Memory Error Checking, `workspace_docs/amdgpu-isa-manuals/rdna4/README.md:4831` through `:4844`.
...
- RDNA4 manual subsection 11.5 Block VGPR Load & Store, `workspace_docs/amdgpu-isa-manuals/rdna4/README.md:4851` through `:4891`.
...
- RDNA4 manual subsection 12.1.1 LDS Modes and Allocation, `workspace_docs/amdgpu-isa-manuals/rdna4/README.md:4961` through `:4964`.
...
- RDNA4 manual subsection 12.5.1 LDS Atomic Ops, `workspace_docs/amdgpu-isa-manuals/rdna4/README.md:5226` through `:5257`.
...
- RDNA4 manual subsection 12.5.2 LDS Lane-permute Ops, `workspace_docs/amdgpu-isa-manuals/rdna4/README.md:5258` through `:5271`.
...
- RDNA4 manual subsection 13.1–13.3 Floating-point atomic policy, `workspace_docs/amdgpu-isa-manuals/rdna4/README.md:5312` through `:5420`.
...
- RDNA4 manual subsection 3.3.3 Dynamic VGPR Allocation & Deallocation, `workspace_docs/amdgpu-isa-manuals/rdna4/README.md:810` through `:850`.
...
- RDNA4 manual subsection 3.5.3.4 Compute Shader initialization, `workspace_docs/amdgpu-isa-manuals/rdna4/README.md:1320` through `:1351`.
...
- RDNA4 manual subsection 6.2 Scalar ALU Operands, `workspace_docs/amdgpu-isa-manuals/rdna4/README.md:2063` through `:2112`.
...
- RDNA4 manual subsection 3.4.3 MODE register, `workspace_docs/amdgpu-isa-manuals/rdna4/README.md:1000` through `:1013`.
...
- RDNA4 manual subsection 3.2.1 Program Counter, `workspace_docs/amdgpu-isa-manuals/rdna4/README.md:652` through `:661`.
...
- RDNA4 manual subsection 5.2 Program Control Instructions, `workspace_docs/amdgpu-isa-manuals/rdna4/README.md:1659` through `:1701`.
...
- RDNA4 manual subsection 5.4 Send Message Types, `workspace_docs/amdgpu-isa-manuals/rdna4/README.md:1744` through `:1776`.
...
- Forward-refresh source anchor: `lib/rocjitsu/src/rocjitsu/isa/arch/amdgpu/generated/rdna4/sopk.cpp:1`.
...
- RDNA4 manual subsection 5.6.2 Barrier Instructions, `workspace_docs/amdgpu-isa-manuals/rdna4/README.md:1839` through `:1855`.
...
- RDNA4 manual subsection 5.7.1.3 Vector Memory - Flat, `workspace_docs/amdgpu-isa-manuals/rdna4/README.md:1955` through `:1969`.
...
- RDNA4 manual subsection 5.7.1.1 Scalar Memory, `workspace_docs/amdgpu-isa-manuals/rdna4/README.md:1937` through `:1942`.
...
- RDNA4 manual subsection 5.7.1.5 Export, `workspace_docs/amdgpu-isa-manuals/rdna4/README.md:1976` through `:1981`.
...
- RDNA4 manual subsection 7.12 Wave Matrix Multiply Accumulate, `workspace_docs/amdgpu-isa-manuals/rdna4/README.md:3141` through `:3198`.
...
- RDNA4 manual subsection 7.9 Cross-Lane and Data Parallel Processing, `workspace_docs/amdgpu-isa-manuals/rdna4/README.md:2994` through `:3048`.
...
- RDNA4 manual subsection 7.2.3 Output Operands, `workspace_docs/amdgpu-isa-manuals/rdna4/README.md:2515` through `:2524`.
...
- RDNA4 manual subsection 7.3 Instructions, `workspace_docs/amdgpu-isa-manuals/rdna4/README.md:2629` through `:2734`.
...
- RDNA4 manual subsection 12.3.1 16-bit Parameter Interpolation, `workspace_docs/amdgpu-isa-manuals/rdna4/README.md:5119` through `:5130`.
...
- RDNA4 manual subsection 8.1.2 Loads using Buffer Resource, `workspace_docs/amdgpu-isa-manuals/rdna4/README.md:3427` through `:3456`.
...
- Forward-refresh source anchor: `lib/rocjitsu/src/rocjitsu/isa/arch/amdgpu/generated/rdna4/smem.cpp:1`.
...
- RDNA4 manual subsection 8.4.1 Address and GPR Range Checking, `workspace_docs/amdgpu-isa-manuals/rdna4/README.md:3508` through `:3520`.
...
- RDNA4 manual subsection 8.1.1 Scalar Memory Addressing, `workspace_docs/amdgpu-isa-manuals/rdna4/README.md:3415` through `:3426`.
...
- Forward-refresh source anchor: `lib/rocjitsu/src/rocjitsu/isa/arch/amdgpu/shared/addr_calc_scalar.h:47`.
...
- RDNA4 manual subsection 8.5 Scalar Prefetch Instructions, `workspace_docs/amdgpu-isa-manuals/rdna4/README.md:3521` through `:3584`.
...
- RDNA4 manual subsection 9.2 VGPR Usage, `workspace_docs/amdgpu-isa-manuals/rdna4/README.md:3721` through `:3791`.
...
- RDNA4 manual subsection 9.1–9.3 Buffer Instructions and Data, `workspace_docs/amdgpu-isa-manuals/rdna4/README.md:3585` through `:3838`.
...
- RDNA4 manual subsection 9.6 Buffer Resource, `workspace_docs/amdgpu-isa-manuals/rdna4/README.md:3999` through `:4044`.
...
- RDNA4 manual subsection 9.5 Alignment, `workspace_docs/amdgpu-isa-manuals/rdna4/README.md:3979` through `:3998`.
...
- RDNA4 manual subsection 10.1–10.3 Image instruction classes, `workspace_docs/amdgpu-isa-manuals/rdna4/README.md:4045` through `:4240`.
...
- RDNA4 manual subsection 10.4.2 Data VGPRs, `workspace_docs/amdgpu-isa-manuals/rdna4/README.md:4287` through `:4322`.
...
- RDNA4 manual subsection 10.5 Image Resource, `workspace_docs/amdgpu-isa-manuals/rdna4/README.md:4334` through `:4366`.
...
- RDNA4 manual subsection 10.6 Image Sampler, `workspace_docs/amdgpu-isa-manuals/rdna4/README.md:4367` through `:4399`.
...
- RDNA4 manual subsection 10.7 Data Formats, `workspace_docs/amdgpu-isa-manuals/rdna4/README.md:4400` through `:4442`.
...
- RDNA4 manual subsection 10.9.3 BVH Texture Resource Definition, `workspace_docs/amdgpu-isa-manuals/rdna4/README.md:4579` through `:4613`.
...
- RDNA4 manual subsection 10.9.1 Instruction definition and fields, `workspace_docs/amdgpu-isa-manuals/rdna4/README.md:4470` through `:4565`.
...
- RDNA4 manual subsection 10.10 Partially Resident Textures, `workspace_docs/amdgpu-isa-manuals/rdna4/README.md:4614` through `:4719`.
...
- Forward-refresh source anchor: `lib/rocjitsu/src/rocjitsu/isa/arch/amdgpu/rdna4/addr_calc.cpp:66`.
...
- RDNA4 manual subsection 11.1 Instructions, `workspace_docs/amdgpu-isa-manuals/rdna4/README.md:4720` through `:4754`.
...
- Forward-refresh source anchor: `lib/rocjitsu/src/rocjitsu/isa/arch/amdgpu/generated/rdna4/vflat_exec.cpp:1`.
...
- RDNA4 manual subsection 11.4 Data, `workspace_docs/amdgpu-isa-manuals/rdna4/README.md:4845` through `:4850`.
...
- Forward-refresh source anchor: `lib/rocjitsu/src/rocjitsu/isa/arch/amdgpu/generated/rdna4/vbuffer_exec.cpp:1`.
...
- RDNA4 manual subsection 11.6 WMMA Matrix Load Ops with Transpose, `workspace_docs/amdgpu-isa-manuals/rdna4/README.md:4892` through `:4954`.
...
- RDNA4 manual subsection 12.2.1 LDS Parameter Loads and 12.4 LDS Direct Load, `workspace_docs/amdgpu-isa-manuals/rdna4/README.md:5003` through `:5156`.
...
- RDNA4 manual subsection 12.5 Data Share Indexed and Atomic Access, `workspace_docs/amdgpu-isa-manuals/rdna4/README.md:5157` through `:5225`.
...
- Forward-refresh source anchor: `lib/rocjitsu/src/rocjitsu/isa/arch/amdgpu/generated/shared/execute_shared.h:149`.
...
- Forward-refresh source anchor: `lib/rocjitsu/src/rocjitsu/isa/arch/amdgpu/generated/shared/execute_shared.h:63`.
...
- RDNA4 manual subsection 12.5.3 DS Stack Operations for Ray Tracing, `workspace_docs/amdgpu-isa-manuals/rdna4/README.md:5272` through `:5311`.
...
- RDNA4 manual subsection 12.3 VALU Parameter Interpolation, `workspace_docs/amdgpu-isa-manuals/rdna4/README.md:5067` through `:5118`.
...
- RDNA4 manual subsection 14.1–14.3 Exports, `workspace_docs/amdgpu-isa-manuals/rdna4/README.md:5421` through `:5542`.
...
- RDNA4 manual subsection 16.3 SOP1 Instructions, `workspace_docs/amdgpu-isa-manuals/rdna4/README.md:7911` through `:9033`.
...
- RDNA4 manual subsection 16.8 VOP1 Instructions, `workspace_docs/amdgpu-isa-manuals/rdna4/README.md:11052` through `:12305`.
...
- RDNA4 manual subsection 16.12 VOP3 and VOP3SD Instructions, `workspace_docs/amdgpu-isa-manuals/rdna4/README.md:15697` through `:21784`.
...
- RDNA4 manual subsection 7.6 Data Conversion Operations, `workspace_docs/amdgpu-isa-manuals/rdna4/README.md:2783` through `:2821`.
...
- RDNA4 manual subsection 2.3 Work-groups, `workspace_docs/amdgpu-isa-manuals/rdna4/README.md:574` through `:593`.
...
- RDNA4 manual subsection 2.2.2 Graphics Shaders, `workspace_docs/amdgpu-isa-manuals/rdna4/README.md:563` through `:573`.
...
- RDNA4 manual subsection 3.4.9 Hardware Internal Registers, `workspace_docs/amdgpu-isa-manuals/rdna4/README.md:1077` through `:1135`.
...
- RDNA4 manual subsection 3.4.10 Trap and Exception registers, `workspace_docs/amdgpu-isa-manuals/rdna4/README.md:1136` through `:1202`.
...
- RDNA4 manual subsection 3.5 Initial Wave State, `workspace_docs/amdgpu-isa-manuals/rdna4/README.md:1229` through `:1461`.
...
- Forward-refresh source anchor: `lib/rocjitsu/src/rocjitsu/vm/amdgpu/compute_unit.cpp:181`.
...
- Forward-refresh source anchor: `lib/rocjitsu/src/rocjitsu/isa/arch/amdgpu/generated/shared/execute_shared.h:50`.
...
- RDNA4 manual subsection 5.7.1 Memory Dependency Counters, `workspace_docs/amdgpu-isa-manuals/rdna4/README.md:1915` through `:1936`.
...
- RDNA4 manual subsection 5.3–5.3.1 Instruction Clauses, `workspace_docs/amdgpu-isa-manuals/rdna4/README.md:1702` through `:1743`.
...
- RDNA4 manual subsection 5.7 Data Dependency Resolution, `workspace_docs/amdgpu-isa-manuals/rdna4/README.md:1868` through `:1914`.
...
- RDNA4 manual subsection 5.7.1.2 Vector Memory, `workspace_docs/amdgpu-isa-manuals/rdna4/README.md:1943` through `:1954`.
...
- RDNA4 manual subsection 7.12.1 Requirements for WMMA data hazards, `workspace_docs/amdgpu-isa-manuals/rdna4/README.md:3199` through `:3210`.
...
- RDNA4 manual subsection 7.2.8 PERMLANE Specific Rules, `workspace_docs/amdgpu-isa-manuals/rdna4/README.md:2625` through `:2628`.
...
- RDNA4 manual subsection 8.2 Dependency Checking, `workspace_docs/amdgpu-isa-manuals/rdna4/README.md:3472` through `:3483`.
...
- RDNA4 manual subsection 8.3 Scalar Memory Clauses and Groups, `workspace_docs/amdgpu-isa-manuals/rdna4/README.md:3484` through `:3493`.
...
- RDNA4 manual subsection 10.8 Vector Memory Instruction Data Dependencies, `workspace_docs/amdgpu-isa-manuals/rdna4/README.md:4443` through `:4450`.
...
- RDNA4 manual subsection 12.1 Overview, `workspace_docs/amdgpu-isa-manuals/rdna4/README.md:4955` through `:4960`.
...
- RDNA4 manual subsection 16.5 SOPP Instructions, `workspace_docs/amdgpu-isa-manuals/rdna4/README.md:9367` through `:9968`.
...
- RDNA4 manual subsection 5.7.2 Specific Dependency Cases, `workspace_docs/amdgpu-isa-manuals/rdna4/README.md:1986` through `:1993`.
...
- Forward-refresh source anchor: `lib/rocjitsu/src/rocjitsu/isa/arch/amdgpu/generated/rdna4/decoder.cpp:3201`.
...
- RDNA4 manual subsection 4.1 Common Instruction Fields, `workspace_docs/amdgpu-isa-manuals/rdna4/README.md:1462` through `:1526`.
...
- RDNA4 manual subsection 7.10 Pseudo-scalar Transcendental ALU ops, `workspace_docs/amdgpu-isa-manuals/rdna4/README.md:3107` through `:3128`.
...
- RDNA4 manual subsection 7.2 Operands, `workspace_docs/amdgpu-isa-manuals/rdna4/README.md:2368` through `:2421`.
...
- RDNA4 manual subsection 7.2.2.2 Source Operand Restrictions, `workspace_docs/amdgpu-isa-manuals/rdna4/README.md:2469` through `:2490`.
...
- RDNA4 manual subsection 7.2.3.2 and 7.2.5–7.2.6 wave64 SGPR restrictions, `workspace_docs/amdgpu-isa-manuals/rdna4/README.md:2570` through `:2616`.
...
- Forward-refresh source anchor: `lib/rocjitsu/src/rocjitsu/isa/arch/amdgpu/generated/rdna4/sop2.cpp:2129`.
...
- RDNA4 manual subsection 8.1 Microcode Encoding, `workspace_docs/amdgpu-isa-manuals/rdna4/README.md:3373` through `:3414`.
...
- RDNA4 manual subsection 15.7.1 VBUFFER format, `workspace_docs/amdgpu-isa-manuals/rdna4/README.md:6625` through `:6696`.
...
### RDNA4-RJ-126: RDNA4 VIMAGE/VSAMPLE grouped address operands lose encoded base and exact field/count semantics

Reported by: local audit; narrowed by the 2026-08-28 forward refresh.

Manual evidence:

- RDNA4 manual subsection 10.4.1 Address VGPRs, `workspace_docs/amdgpu-isa-manuals/rdna4/README.md:4273` through `:4286`.
- Chapter 10.4.1, lines 4273–4286, defines VIMAGE `VADDR0-4` and
  VSAMPLE `VADDR0-3` address fields and `ACNT`.
- Chapter 10.4, lines 4241–4272, defines sequential versus gathered address
  groups and opcode-/`DIM`-dependent address VGPR counts.
- Chapters 10.1.3–10.1.4 and 10.3, lines 4112–4119 and 4165–4240, define
  `A16`/`G16` packing, derivative and sampler-suffix address components.

Rocjitsu evidence:

- Current generated constructors do expose one grouped `vaddr` source:
  `generated/rdna4/vimage.cpp:16` creates a 128-bit group for
  `IMAGE_LOAD`, and `generated/rdna4/vsample.cpp:45` creates a 96-bit
  group for `IMAGE_SAMPLE`.
- Those operands are constructed with hard-coded base `0`, rather than from
  the encoded `VADDR0-4` / `VADDR0-3` fields; representative definitions
  are `generated/rdna4/vimage.cpp:16` and
  `generated/rdna4/vsample.cpp:45`.
- Group widths vary by generated mnemonic (for example
  `generated/rdna4/vsample.cpp:75` uses 288 bits for
  `IMAGE_SAMPLE_D`), but no current operand metadata exposes the individual
  gathered fields, `ACNT`, or the `A16`/`G16` packing contract.

Impact:

Def-use now sees a coarse grouped address dependency, so the old claim of no
address operand is resolved. It still attributes the group to `v0` and cannot
faithfully represent the encoded base, gathered/non-sequential fields, or exact
opcode-/`DIM`-/`A16`-/`G16`-dependent address footprint.
...
- RDNA4 manual subsection 15.8–15.9 VIMAGE and VSAMPLE formats, `workspace_docs/amdgpu-isa-manuals/rdna4/README.md:6697` through `:6808`.
...
- RDNA4 manual subsection 10.9.2 VGPR_A Field Organization, `workspace_docs/amdgpu-isa-manuals/rdna4/README.md:4566` through `:4578`.
...
- RDNA4 manual subsection 15.10 Flat, Global and Scratch Formats, `workspace_docs/amdgpu-isa-manuals/rdna4/README.md:6809` through `:6936`.
...
- Forward-refresh source anchor: `lib/rocjitsu/src/rocjitsu/vm/amdgpu/compute_unit.cpp:1`.
...
### RDNA4-RJ-185: `VEXPORT` metadata still drops `EN`, `DONE`, and `ROW_EN` semantics
...
- RDNA4 manual subsection 14.1–14.3 Exports, `workspace_docs/amdgpu-isa-manuals/rdna4/README.md:5421` through `:5542`.
- Chapter 14.1, lines 5421–5458, defines `EN` as the component-enable and
  packed-half selector, `DONE` as the last-export marker, and `ROW_EN` as
  the mesh POS/PRIM row control that consumes M0.
- Chapter 14.3, lines 5465–5485, says M0 is read when the request is made and
  `EXEC` is read later when export is granted.
- The RDNA4 XML `EXPORT` record carries implicit `EXEC` and M0 operands,
  but the field semantics remain prose-dependent.

Rocjitsu evidence:

- `generated/rdna4/vexport.cpp:13` now constructs the generated export, and
  lines 21–30 add `OPR_SDST_EXEC` and `OPR_SDST_M0` as source operands.
  The prior claim that implicit EXEC/M0 uses were absent is therefore fixed.
- The four VGPR sources remain unconditional at
  `generated/rdna4/vexport.cpp:24`–`27`; the constructor does not use
  `EN` to select enabled channels.
- `generated/rdna4/vexport.cpp` has no modifier/disassembly handling for
  `EN`, `DONE`, or `ROW_EN`, so those fields and their behavioral
  distinctions remain invisible to generic metadata and traces.

Impact:

EXEC and M0 dependencies are now visible. Liveness and disassembly still
over-report disabled VGPR channels and cannot distinguish component selection,
the final export, or row-enabled export behavior.
...
- RDNA4 manual subsection 16.2 SOPK Instructions, `workspace_docs/amdgpu-isa-manuals/rdna4/README.md:7744` through `:7910`.
...
- RDNA4 manual subsection 16.6 SMEM Instructions, `workspace_docs/amdgpu-isa-manuals/rdna4/README.md:9969` through `:10416`.
...
- `RDNA4-RJ-016`: wave32/wave64 is selected from the kernel descriptor in
  `vm/amdgpu/command_processor.cpp:1857`–`1909` and propagated to wave
  construction in `vm/amdgpu/compute_unit.cpp:181`–`214`.
- `RDNA4-RJ-064`: current generated VOPD opcode validation rejects reserved X/Y
  opcodes in `generated/rdna4/vopd.cpp:98`–`108`.
- `RDNA4-RJ-075`: every generated RDNA4 DPP16 decoder now calls the RDNA4
  control allow-list, for example `generated/rdna4/vop2.cpp:61`–`64`; the
  allow-list excludes legacy wave and row-broadcast controls in
  `shared/instruction_encoding.h:71`–`82`.
- `RDNA4-RJ-079`: current pseudo-scalar execution handles the empty-EXEC case
  without the former lane-selection failure; this was retained from the
  2026-08-18 cleanup.
- `RDNA4-RJ-105`: generated SALU constructors now publish SCC inputs/outputs;
  `generated/rdna4/sop2.cpp:13`–`27` shows the SCC output for
  `S_ADD_CO_U32`.
- `RDNA4-RJ-149`: generated D16 loads now publish old-destination uses;
  representative hooks are `generated/rdna4/vscratch.cpp:435`–`440` and
  `generated/rdna4/vglobal.cpp:472`–`477`.
- `RDNA4-RJ-169`: generated no-return DS atomic execute bodies now set
  `is_load = false`, starting at `generated/rdna4/vds_exec.cpp:32`.
- `RDNA4-RJ-192`: compact VOP2 constructors now publish VCC; the condition
  source is present in `generated/rdna4/vop2.cpp:13`–`29`.
- `RDNA4-RJ-194`: compact VOPC constructors now publish VCC/EXEC destinations;
  `generated/rdna4/vopc.cpp:13`–`29` shows the VCC destination.
