...
TEST(HsaHooksUnitTest, ConSanEnableDefaultsToMoiRecordReplay) {
  ScopedEnvVar enable("RJ_CONSAN_ENABLE", "1");
...
TEST(HsaHooksUnitTest, ConSanLoadedWithoutActivationRemainsInert) {
...
TEST(HsaHooksUnitTest, ConSanExplicitFlavorWithoutEnableRemainsInert) {
  ScopedEnvVar enable("RJ_CONSAN_ENABLE", nullptr);
  ScopedEnvVar flavor("RJ_CONSAN_FLAVOR", "moi");
