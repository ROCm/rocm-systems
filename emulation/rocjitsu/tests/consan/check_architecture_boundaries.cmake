...
foreach(_plan IN ITEMS
    ...
    if(NOT _site_plan_contract MATCHES "ConSanSyncEventId event" OR
       ...
       (_plan STREQUAL "MoiAtomicEvidenceSitePlan" AND
        _site_plan_contract MATCHES "ConSanAtomicSite site") OR
...
_consan_assert_match_count_at_most(
    ...
    "ConSanTransformArtifacts"
    5
    "fault internals must use their private mutation transaction"
)
_consan_assert_match_count_at_most(
...
_consan_assert_match_count_at_most(
    "${_consan_dir}/consan.cpp"
    "ConSanTransformArtifacts"
    9
    "native lowering failures must share one terminal publication authority"
)
_consan_assert_no_match(
...
_consan_assert_no_match(
    ...
    "resource-plan lookup must not restore the dormant parallel site index"
)
_consan_assert_no_match(
...
if(NOT _runtime_analysis_build MATCHES "rj_hsa_dbi_moi_sampled_report_decoder[.]cpp")
    message(FATAL_ERROR
        "ConSan Sampled report decoder lost its physical build owner"
    )
endif()
...
_consan_assert_no_match(
    "${_hook_dir}/rj_hsa_dbi_moi_report_decoder.cpp"
    "classify_consan_moi_sampled|consan_moi_sampled_join|ConSanMoiSampledPendingAcquire|AutoMoiSampledEvidence"
    "common report decoding must not reimplement Sampled evidence decoding"
)
_consan_assert_no_match(
