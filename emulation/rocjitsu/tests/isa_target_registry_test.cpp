...
static_assert(static_cast<int>(ROCJITSU_CODE_TARGET_GFX1100) == 6);
static_assert(static_cast<int>(ROCJITSU_CODE_TARGET_GFX1150) == 7);
static_assert(static_cast<int>(ROCJITSU_CODE_TARGET_GFX1151) == 8);
static_assert(static_cast<int>(ROCJITSU_CODE_TARGET_GFX1251) == 9);
static_assert(static_cast<int>(ROCJITSU_CODE_TARGET_NUM_TARGETS) == 10);
