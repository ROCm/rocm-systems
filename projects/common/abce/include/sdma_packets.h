...
namespace abce {
 ...
 typedef struct SDMA_PKT_FENCE_64B_TAG_OSS70 {
   union {
     struct {
       unsigned int op             :  8;
       unsigned int sub_op         :  8;
 ...
 typedef struct SDMA_PKT_POLL_MEM_64B_TAG_OSS70 {
   union {
     struct {
       unsigned int op             :  8;
       unsigned int sub_op         :  8;
 ...
 typedef struct SDMA_PKT_GCR_TAG_OSS70 {
   union {
     struct {
       unsigned int op : 8;
       unsigned int sub_op : 8;
 ...
 typedef struct SDMA_PKT_COPY_LINEAR_SWAP_TAG_OSS70 {
   union {
     struct {
       unsigned int op          :  8;
       unsigned int sub_op      :  8;
 ...
 } SDMA_PKT_COPY_LINEAR_SWAP_OSS70;
 ...
 typedef struct SDMA_PKT_COPY_LINEAR_MULTICAST_TAG_OSS70 {
   union {
     struct {
       unsigned int op          :  8;
       unsigned int sub_op      :  8;
 ...
 } SDMA_PKT_COPY_LINEAR_MULTICAST_OSS70;
 ...
 typedef struct SDMA_PKT_COPY_LINEAR_WAITSIGNAL_TAG_OSS70 {
   union {
     struct {
       unsigned int op          :  8;
       unsigned int sub_op      :  8;
 ...
 } SDMA_PKT_COPY_LINEAR_WAITSIGNAL_OSS70;
 ...
 // DW layout below assumes both WAIT=1 and SIGNAL=1 (maximum packet size).
 typedef struct SDMA_PKT_COPY_LINEAR_WAITSIGNAL_INDIRECT_TAG_OSS70 {
   union {
     struct {
       unsigned int op           :  8;
       unsigned int sub_op       :  8;
 ...
 } SDMA_PKT_COPY_LINEAR_WAITSIGNAL_INDIRECT_OSS70;
 ...
 typedef struct SDMA_PKT_COPY_LINEAR_MULTICAST_WAITSIGNAL_TAG_OSS70 {
   union {
     struct {
       unsigned int op          :  8;
       unsigned int sub_op      :  8;
 ...
 } SDMA_PKT_COPY_LINEAR_MULTICAST_WAITSIGNAL_OSS70;
 ...
 typedef struct SDMA_PKT_COPY_LINEAR_SWAP_WAITSIGNAL_TAG_OSS70 {
   union {
     struct {
       unsigned int op          :  8;
       unsigned int sub_op      :  8;
   ...
   static const size_t kMaxSize_ = 0x3fffffe0;
   static const size_t kAlignment_ = 32;
 } SDMA_PKT_COPY_LINEAR_SWAP_WAITSIGNAL_OSS70;
...
static_assert(sizeof(SDMA_PKT_FENCE_64B_OSS70) == 20);
static_assert(sizeof(SDMA_PKT_POLL_REGMEM) == 24);
static_assert(sizeof(SDMA_PKT_POLL_MEM_64B_OSS70) == 32);
...
static_assert(sizeof(SDMA_PKT_GCR_OSS70) == 24);
static_assert(sizeof(SDMA_PKT_COPY_LINEAR_SWAP_OSS70) == 28);
static_assert(sizeof(SDMA_PKT_COPY_LINEAR_WAITSIGNAL_OSS70) == 76);
static_assert(sizeof(SDMA_PKT_COPY_LINEAR_WAITSIGNAL_INDIRECT_OSS70) == 76);
static_assert(sizeof(SDMA_PKT_COPY_LINEAR_MULTICAST_WAITSIGNAL_OSS70) == 76);
static_assert(sizeof(SDMA_PKT_COPY_LINEAR_SWAP_WAITSIGNAL_OSS70) == 76);
