...
function(set_variables)
    ...
    if(GIT)
        ...
        execute_process(
            COMMAND git merge-base HEAD origin/HEAD
        ...
        if(${RESULT} EQUAL 0)
            ...
            execute_process(
                COMMAND git rev-list --count ${GIT_MERGE_BASE}..HEAD
                WORKING_DIRECTORY ${CMAKE_CURRENT_SOURCE_DIR}
    ...
    if(NOT DEFINED ENV{ROCM_LIBPATCH_VERSION})
        ...
        if(LENSTR EQUAL 1) # length of version cannot be zero hence it would be 1 or greater
            set(ROCM_LIBPATCH_VERSION
                "${ROCM_LIBPATCH_VERSION}0${VERSION_MINOR}"
            )
        else() # length is greater than 1
            set(ROCM_LIBPATCH_VERSION
                "${ROCM_LIBPATCH_VERSION}${VERSION_MINOR}"
            )
        endif()
        ...
        if(LENSTR EQUAL 1) # length of version cannot be zero hence it would be 1 or greater
            ...
            set(ROCM_LIBPATCH_VERSION
                "${ROCM_LIBPATCH_VERSION}${VERSION_PATCH}"
            )
        endif()
    ...
    message(
        STATUS
        "CPACK_DEBIAN_PACKAGE_RELEASE : ${CPACK_DEBIAN_PACKAGE_RELEASE}"
    )
            ...
            if(NOT BUILD_SHARED_LIBS)
                ...
                if(OUT_VAR1 EQUAL -1)
                    set(DEB_OVERRIDES_INSTALL_FILENM
                        "${DEB_OVERRIDES_INSTALL_FILENM}-static"
                    )
                endif()
            else()
