...
.. note::
  ...
  The bitstream reader utility class can be used to extract and parse coded picture data from an elementary video stream. It can be used only with elementary video streams and IVF container files.
