...
std::pair<const Isa*, const Isa*> Isa::supportedIsas() {
  ...
  static constexpr Isa supportedIsas_[] = {
      ...
      {"gfx802", true, true, 8, 0, 2, NONE, NONE},
      {"gfx803", true, true, 8, 0, 3, NONE, NONE},
      {"gfx805", true, true, 8, 0, 5, NONE, NONE},
      {"gfx810", true, true, 8, 1, 0, NONE, ANY},
      {"gfx810:xnack-", true, false, 8, 1, 0, NONE, OFF},
      {"gfx810:xnack+", true, true, 8, 1, 0, NONE, ON},
      {"gfx900", true, true, 9, 0, 0, NONE, ANY},
      {"gfx900:xnack-", true, true, 9, 0, 0, NONE, OFF},
      {"gfx900:xnack+", true, true, 9, 0, 0, NONE, ON},
      {"gfx902", true, true, 9, 0, 2, NONE, ANY},
      {"gfx902:xnack-", true, true, 9, 0, 2, NONE, OFF},
      {"gfx902:xnack+", true, true, 9, 0, 2, NONE, ON},
      {"gfx904", true, true, 9, 0, 4, NONE, ANY},
      {"gfx904:xnack-", true, true, 9, 0, 4, NONE, OFF},
      {"gfx904:xnack+", true, true, 9, 0, 4, NONE, ON},
      {"gfx906", true, true, 9, 0, 6, ANY, ANY},
      {"gfx906:sramecc-", true, true, 9, 0, 6, OFF, ANY},
      {"gfx906:sramecc+", true, true, 9, 0, 6, ON, ANY},
      {"gfx906:xnack-", true, true, 9, 0, 6, ANY, OFF},
      {"gfx906:xnack+", true, true, 9, 0, 6, ANY, ON},
      {"gfx906:sramecc-:xnack-", true, true, 9, 0, 6, OFF, OFF},
      {"gfx906:sramecc-:xnack+", true, true, 9, 0, 6, OFF, ON},
      {"gfx906:sramecc+:xnack-", true, true, 9, 0, 6, ON, OFF},
      {"gfx906:sramecc+:xnack+", true, true, 9, 0, 6, ON, ON},
      {"gfx908", true, false, 9, 0, 8, ANY, ANY},
      {"gfx908:sramecc-", true, false, 9, 0, 8, OFF, ANY},
      {"gfx908:sramecc+", true, false, 9, 0, 8, ON, ANY},
      {"gfx908:xnack-", true, false, 9, 0, 8, ANY, OFF},
      {"gfx908:xnack+", true, false, 9, 0, 8, ANY, ON},
      {"gfx908:sramecc-:xnack-", true, false, 9, 0, 8, OFF, OFF},
      {"gfx908:sramecc-:xnack+", true, false, 9, 0, 8, OFF, ON},
      {"gfx908:sramecc+:xnack-", true, false, 9, 0, 8, ON, OFF},
      {"gfx908:sramecc+:xnack+", true, false, 9, 0, 8, ON, ON},
      {"gfx909", false, true, 9, 0, 2, NONE, ANY},
      {"gfx909:xnack-", false, true, 9, 0, 2, NONE, OFF},
      {"gfx909:xnack+", false, true, 9, 0, 2, NONE, ON},
      {"gfx90a", true, false, 9, 0, 10, ANY, ANY},
      {"gfx90a:sramecc-", true, false, 9, 0, 10, OFF, ANY},
      {"gfx90a:sramecc+", true, false, 9, 0, 10, ON, ANY},
      {"gfx90a:xnack-", true, false, 9, 0, 10, ANY, OFF},
      {"gfx90a:xnack+", true, false, 9, 0, 10, ANY, ON},
      {"gfx90a:sramecc-:xnack-", true, false, 9, 0, 10, OFF, OFF},
      {"gfx90a:sramecc-:xnack+", true, false, 9, 0, 10, OFF, ON},
      {"gfx90a:sramecc+:xnack-", true, false, 9, 0, 10, ON, OFF},
      {"gfx90a:sramecc+:xnack+", true, false, 9, 0, 10, ON, ON},
      {"gfx942", true, false, 9, 4, 2, ANY, ANY},
      {"gfx942:sramecc-", true, false, 9, 4, 2, OFF, ANY},
      {"gfx942:sramecc+", true, false, 9, 4, 2, ON, ANY},
      {"gfx942:xnack-", true, false, 9, 4, 2, ANY, OFF},
      {"gfx942:xnack+", true, false, 9, 4, 2, ANY, ON},
      {"gfx942:sramecc-:xnack-", true, false, 9, 4, 2, OFF, OFF},
      {"gfx942:sramecc-:xnack+", true, false, 9, 4, 2, OFF, ON},
      {"gfx942:sramecc+:xnack-", true, false, 9, 4, 2, ON, OFF},
      {"gfx942:sramecc+:xnack+", true, false, 9, 4, 2, ON, ON},
      {"gfx90c", true, true, 9, 0, 12, NONE, ANY},
      {"gfx90c:xnack-", true, true, 9, 0, 12, NONE, OFF},
      {"gfx90c:xnack+", true, true, 9, 0, 12, NONE, ON},
      {"gfx950", true, false, 9, 5, 0, ANY, ANY},
      {"gfx950:sramecc-", true, false, 9, 5, 0, OFF, ANY},
      {"gfx950:sramecc+", true, false, 9, 5, 0, ON, ANY},
      {"gfx950:xnack-", true, false, 9, 5, 0, ANY, OFF},
      {"gfx950:xnack+", true, false, 9, 5, 0, ANY, ON},
      {"gfx950:sramecc-:xnack-", true, false, 9, 5, 0, OFF, OFF},
      {"gfx950:sramecc-:xnack+", true, false, 9, 5, 0, OFF, ON},
      {"gfx950:sramecc+:xnack-", true, false, 9, 5, 0, ON, OFF},
      {"gfx950:sramecc+:xnack+", true, false, 9, 5, 0, ON, ON},
      {"gfx9-generic", true, true, 9, 0, 0, NONE, ANY},
      {"gfx9-generic:xnack-", true, true, 9, 0, 0, NONE, OFF},
      {"gfx9-generic:xnack+", true, true, 9, 0, 0, NONE, ON},
      {"gfx9-4-generic", true, true, 9, 4, 0, ANY, ANY},
      {"gfx9-4-generic:sramecc-", true, true, 9, 4, 0, OFF, ANY},
      {"gfx9-4-generic:sramecc+", true, true, 9, 4, 0, ON, ANY},
      {"gfx9-4-generic:xnack-", true, true, 9, 4, 0, ANY, OFF},
      {"gfx9-4-generic:xnack+", true, true, 9, 4, 0, ANY, ON},
      {"gfx9-4-generic:sramecc-:xnack-", true, true, 9, 4, 0, OFF, OFF},
      {"gfx9-4-generic:sramecc-:xnack+", true, true, 9, 4, 0, OFF, ON},
      {"gfx9-4-generic:sramecc+:xnack-", true, true, 9, 4, 0, ON, OFF},
      {"gfx9-4-generic:sramecc+:xnack+", true, true, 9, 4, 0, ON, ON},
      {"gfx1010", true, true, 10, 1, 0, NONE, ANY},
      {"gfx1010:xnack-", true, true, 10, 1, 0, NONE, OFF},
      {"gfx1010:xnack+", true, true, 10, 1, 0, NONE, ON},
      {"gfx1011", true, true, 10, 1, 1, NONE, ANY},
      {"gfx1011:xnack-", true, true, 10, 1, 1, NONE, OFF},
      {"gfx1011:xnack+", true, true, 10, 1, 1, NONE, ON},
      {"gfx1012", true, true, 10, 1, 2, NONE, ANY},
      {"gfx1012:xnack-", true, true, 10, 1, 2, NONE, OFF},
      {"gfx1012:xnack+", true, true, 10, 1, 2, NONE, ON},
      {"gfx1013", true, false, 10, 1, 3, NONE, ANY},
      {"gfx1013:xnack-", true, false, 10, 1, 3, NONE, OFF},
      {"gfx1013:xnack+", true, false, 10, 1, 3, NONE, ON},
      {"gfx10-1-generic", true, true, 10, 1, 0, NONE, ANY},
      {"gfx10-1-generic:xnack-", true, true, 10, 1, 0, NONE, OFF},
      {"gfx10-1-generic:xnack+", true, true, 10, 1, 0, NONE, ON},
      {"gfx1030", true, true, 10, 3, 0, NONE, NONE},
      {"gfx1031", true, true, 10, 3, 1, NONE, NONE},
      {"gfx1032", true, true, 10, 3, 2, NONE, NONE},
      {"gfx1033", true, false, 10, 3, 3, NONE, NONE},
      {"gfx1034", true, true, 10, 3, 4, NONE, NONE},
      {"gfx1035", true, true, 10, 3, 5, NONE, NONE},
      {"gfx1036", true, true, 10, 3, 6, NONE, NONE},
      {"gfx10-3-generic", true, true, 10, 3, 0, NONE, NONE},
      {"gfx1100", true, true, 11, 0, 0, NONE, NONE},
      {"gfx1101", true, true, 11, 0, 1, NONE, NONE},
      {"gfx1102", true, true, 11, 0, 2, NONE, NONE},
      {"gfx1103", true, true, 11, 0, 3, NONE, NONE},
      {"gfx1150", true, true, 11, 5, 0, NONE, NONE},
      {"gfx1151", true, true, 11, 5, 1, NONE, NONE},
      {"gfx1152", true, true, 11, 5, 2, NONE, NONE},
      {"gfx1153", true, true, 11, 5, 3, NONE, NONE},
      {"gfx11-generic", true, true, 11, 0, 0, NONE, NONE},
      {"gfx1200", true, true, 12, 0, 0, NONE, NONE},
      {"gfx1201", true, true, 12, 0, 1, NONE, NONE},
      {"gfx1250", true, true, 12, 5, 0, NONE, NONE},
      {"gfx12-generic", true, true, 12, 0, 0, NONE, NONE},
  };
