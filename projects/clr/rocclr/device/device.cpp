...
bool Device::init() {
  ...
  // Check if GPU_ENABLE_PAL env var was set to empty string
  // Empty string should be treated as "not set" to preserve default behavior
  ...
  // Handle empty string case: set platform-specific defaults
