...
class VirtualGPU : public device::VirtualDevice {
  ...
  class MetaDataPreloader : public amd::EmbeddedObject {
    ...
    private:
      ...
      void SetMetadataPacketMovdir64b(AqlBarrierPacket* aql, uint16_t header,
        ...
        *reinterpret_cast<uint32_t*>(seg0) = GetType(header);
 ...
 private:
  ...
  volatile uint64_t* doorbell_ptr_ = nullptr;  //!< Cached hardware doorbell (UC MMIO)
  ...
  volatile uint64_t* schedulerDoorbell_ = nullptr;  //!< Cached doorbell for scheduler queue
