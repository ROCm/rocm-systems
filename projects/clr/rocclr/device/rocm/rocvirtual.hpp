...
class VirtualGPU : public device::VirtualDevice {
 ...
 private:
  ...
  //! Ring the doorbell for a contiguous part of a reservation, in reservation order. Every
  //! reserved slot must be committed: an abandoned reservation stalls every stream sharing the
  //! HW queue.
  ...
  //! which outlives every VirtualGPU bound to the queue.
