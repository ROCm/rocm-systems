...
target_compile_definitions(
    rocclr
    PRIVATE ROCCLR_VERSION_GITHASH="${ROCCLR_VERSION_GITHASH}"
)

# Code-object translator selection (resolved in the CLR root CMakeLists; must
# match the ROCr build). Gates amd::hotswap so a NONE build compiles out
# source-bundle forwarding and foreign-ISA admission.
if(DEFINED ROCM_TRANSLATOR_COMPILE_DEF)
    target_compile_definitions(rocclr PUBLIC ${ROCM_TRANSLATOR_COMPILE_DEF})
endif()
...
target_compile_definitions(rocclr PUBLIC LITTLEENDIAN_CPU ${AMD_OPENCL_DEFS})
