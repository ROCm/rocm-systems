...
if (AMD_COMPUTE_WIN)
  ...
  if (ROCR_DLL_LOAD)
    ...
    if (STATIC_ROCR)
      ...
      get_target_property(_rocclr_hsa_inc_dir hsa-runtime64::hsa-runtime64 INTERFACE_INCLUDE_DIRECTORIES)
      if(_rocclr_hsa_inc_dir)
        target_include_directories(rocclr SYSTEM BEFORE PUBLIC "${_rocclr_hsa_inc_dir}")
      endif()
    endif()
  endif()
endif()
