...
* New HIP APIs
    ...
    - Peer-to-peer atomic capability query: support for API parity with corresponding CUDA API.
      * `hipDeviceGetP2PAtomicCapabilities` reports, per atomic operation, which native atomic capabilities are supported over the P2P link between two devices
