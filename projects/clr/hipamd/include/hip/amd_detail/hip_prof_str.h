...
enum hip_api_id_t {
  ...
  HIP_API_ID_hipDeviceGetP2PAtomicCapabilities = 451,
  HIP_API_ID_LAST = 451,
...
#define INIT_hipDeviceGetP2PAtomicCapabilities_CB_ARGS_DATA(cb_data) { \
  ...
  cb_data.args.hipDeviceGetP2PAtomicCapabilities.src_device = (int)src_device; \
  cb_data.args.hipDeviceGetP2PAtomicCapabilities.dst_device = (int)dst_device; \
};
...
static inline const char* hipApiString(hip_api_id_t id, const hip_api_data_t* data) {
  ...
  switch (id) {
    ...
    case HIP_API_ID_hipDeviceGetP2PAtomicCapabilities:
      ...
      oss << ", operations="; roctracer::hip_support::detail::operator<<(oss, data->args.hipDeviceGetP2PAtomicCapabilities.operations__val);
      oss << ", count="; roctracer::hip_support::detail::operator<<(oss, data->args.hipDeviceGetP2PAtomicCapabilities.count);
      oss << ", src_device="; roctracer::hip_support::detail::operator<<(oss, data->args.hipDeviceGetP2PAtomicCapabilities.src_device);
      oss << ", dst_device="; roctracer::hip_support::detail::operator<<(oss, data->args.hipDeviceGetP2PAtomicCapabilities.dst_device);
      oss << ")";
    case HIP_API_ID_hipDeviceGetP2PAttribute:
