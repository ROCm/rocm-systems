...
enum hip_api_id_t {
  ...
  HIP_API_ID_hipMipmappedArrayGetMemoryRequirements = 439,
  HIP_API_ID_LAST = 439,
...
static inline uint32_t hipApiIdByName(const char* name) {
  ...
  if (strcmp("hipMipmappedArrayGetMemoryRequirements", name) == 0)
    return HIP_API_ID_hipMipmappedArrayGetMemoryRequirements;
  ...
  if (strcmp("hipModuleOccupancyMaxActiveBlocksPerMultiprocessorWithFlags", name) == 0)
  ...
  if (strcmp("hipOccupancyMaxActiveBlocksPerMultiprocessorWithFlags", name) == 0)
...
// __hipPopCallConfiguration[('dim3*', 'gridDim'), ('dim3*', 'blockDim'), ('size_t*', 'sharedMem'),
// ('hipStream_t*', 'stream')]
...
// __hipPushCallConfiguration[('dim3', 'gridDim'), ('dim3', 'blockDim'), ('size_t', 'sharedMem'),
// ('hipStream_t', 'stream')]
...
// hipArrayGetInfo[('hipChannelFormatDesc*', 'desc'), ('hipExtent*', 'extent'), ('unsigned int*',
// 'flags'), ('hipArray_t', 'array')]
...
// hipConfigureCall[('dim3', 'gridDim'), ('dim3', 'blockDim'), ('size_t', 'sharedMem'),
// ('hipStream_t', 'stream')]
...
// hipCreateSurfaceObject[('hipSurfaceObject_t*', 'pSurfObject'), ('const hipResourceDesc*',
// 'pResDesc')]
...
// hipDeviceGetGraphMemAttribute[('int', 'device'), ('hipGraphMemAttributeType', 'attr'), ('void*',
// 'value')]
...
// hipDeviceGetP2PAttribute[('int*', 'value'), ('hipDeviceP2PAttr', 'attr'), ('int', 'srcDevice'),
// ('int', 'dstDevice')]
...
// hipDevicePrimaryCtxGetState[('hipDevice_t', 'dev'), ('unsigned int*', 'flags'), ('int*',
// 'active')]
...
// hipDeviceSetGraphMemAttribute[('int', 'device'), ('hipGraphMemAttributeType', 'attr'), ('void*',
// 'value')]
...
// hipDrvGraphAddMemFreeNode[('hipGraphNode_t*', 'phGraphNode'), ('hipGraph_t', 'hGraph'), ('const
// hipGraphNode_t*', 'dependencies'), ('size_t', 'numDependencies'), ('hipDeviceptr_t', 'dptr')]
...
// hipDrvGraphAddMemcpyNode[('hipGraphNode_t*', 'phGraphNode'), ('hipGraph_t', 'hGraph'), ('const
// hipGraphNode_t*', 'dependencies'), ('size_t', 'numDependencies'), ('const HIP_MEMCPY3D*',
// 'copyParams'), ('hipCtx_t', 'ctx')]
...
// hipDrvGraphAddMemsetNode[('hipGraphNode_t*', 'phGraphNode'), ('hipGraph_t', 'hGraph'), ('const
// hipGraphNode_t*', 'dependencies'), ('size_t', 'numDependencies'), ('const hipMemsetParams*',
...
// hipDrvGraphExecMemcpyNodeSetParams[('hipGraphExec_t', 'hGraphExec'), ('hipGraphNode_t', 'hNode'),
...
// hipDrvGraphExecMemsetNodeSetParams[('hipGraphExec_t', 'hGraphExec'), ('hipGraphNode_t', 'hNode'),
...
// hipDrvGraphMemcpyNodeSetParams[('hipGraphNode_t', 'hNode'), ('const HIP_MEMCPY3D*',
// 'nodeParams')]
...
// hipDrvLaunchKernelEx[('const HIP_LAUNCH_CONFIG*', 'config'), ('hipFunction_t', 'f'), ('void**',
// 'params'), ('void**', 'extra')]
...
// hipDrvPointerGetAttributes[('unsigned int', 'numAttributes'), ('hipPointer_attribute*',
// 'attributes'), ('void**', 'data'), ('hipDeviceptr_t', 'ptr')]
...
// hipEventRecordWithFlags[('hipEvent_t', 'event'), ('hipStream_t', 'stream'), ('unsigned int',
// 'flags')]
...
// hipExtGetLinkTypeAndHopCount[('int', 'device1'), ('int', 'device2'), ('unsigned int*',
// 'linktype'), ('unsigned int*', 'hopcount')]
...
// hipExtLaunchKernel[('const void*', 'function_address'), ('dim3', 'numBlocks'), ('dim3',
// 'dimBlocks'), ('void**', 'args'), ('size_t', 'sharedMemBytes'), ('hipStream_t', 'stream'),
...
// hipExtLaunchMultiKernelMultiDevice[('hipLaunchParams*', 'launchParamsList'), ('int',
...
// hipExtModuleLaunchKernel[('hipFunction_t', 'f'), ('unsigned int', 'globalWorkSizeX'), ('unsigned
// int', 'globalWorkSizeY'), ('unsigned int', 'globalWorkSizeZ'), ('unsigned int',
// 'localWorkSizeX'), ('unsigned int', 'localWorkSizeY'), ('unsigned int', 'localWorkSizeZ'),
// ('size_t', 'sharedMemBytes'), ('hipStream_t', 'hStream'), ('void**', 'kernelParams'), ('void**',
// 'extra'), ('hipEvent_t', 'startEvent'), ('hipEvent_t', 'stopEvent'), ('unsigned int', 'flags')]
...
// hipExtStreamCreateWithCUMask[('hipStream_t*', 'stream'), ('unsigned int', 'cuMaskSize'), ('const
// unsigned int*', 'cuMask')]
...
// hipExtStreamGetCUMask[('hipStream_t', 'stream'), ('unsigned int', 'cuMaskSize'), ('unsigned
// int*', 'cuMask')]
...
// hipExternalMemoryGetMappedBuffer[('void**', 'devPtr'), ('hipExternalMemory_t', 'extMem'), ('const
...
// hipFuncGetAttribute[('int*', 'value'), ('hipFunction_attribute', 'attrib'), ('hipFunction_t',
// 'hfunc')]
...
// hipGLGetDevices[('unsigned int*', 'pHipDeviceCount'), ('int*', 'pHipDevices'), ('unsigned int',
// 'hipDeviceCount'), ('hipGLDeviceList', 'deviceList')]
...
// hipGetDriverEntryPoint[('const char*', 'symbol'), ('void**', 'funcPtr'), ('unsigned long long',
...
// hipGetMipmappedArrayLevel[('hipArray_t*', 'levelArray'), ('hipMipmappedArray_const_t',
...
// hipGraphAddBatchMemOpNode[('hipGraphNode_t*', 'phGraphNode'), ('hipGraph_t', 'hGraph'), ('const
// hipGraphNode_t*', 'dependencies'), ('size_t', 'numDependencies'), ('const
// hipBatchMemOpNodeParams*', 'nodeParams')]
...
// hipGraphAddChildGraphNode[('hipGraphNode_t*', 'pGraphNode'), ('hipGraph_t', 'graph'), ('const
// hipGraphNode_t*', 'pDependencies'), ('size_t', 'numDependencies'), ('hipGraph_t', 'childGraph')]
...
// hipGraphAddDependencies[('hipGraph_t', 'graph'), ('const hipGraphNode_t*', 'from'), ('const
// hipGraphNode_t*', 'to'), ('size_t', 'numDependencies')]
...
// hipGraphAddEmptyNode[('hipGraphNode_t*', 'pGraphNode'), ('hipGraph_t', 'graph'), ('const
// hipGraphNode_t*', 'pDependencies'), ('size_t', 'numDependencies')]
...
// hipGraphAddEventRecordNode[('hipGraphNode_t*', 'pGraphNode'), ('hipGraph_t', 'graph'), ('const
// hipGraphNode_t*', 'pDependencies'), ('size_t', 'numDependencies'), ('hipEvent_t', 'event')]
...
// hipGraphAddEventWaitNode[('hipGraphNode_t*', 'pGraphNode'), ('hipGraph_t', 'graph'), ('const
// hipGraphNode_t*', 'pDependencies'), ('size_t', 'numDependencies'), ('hipEvent_t', 'event')]
...
// hipGraphAddExternalSemaphoresSignalNode[('hipGraphNode_t*', 'pGraphNode'), ('hipGraph_t',
// 'graph'), ('const hipGraphNode_t*', 'pDependencies'), ('size_t', 'numDependencies'), ('const
...
// hipGraphAddExternalSemaphoresWaitNode[('hipGraphNode_t*', 'pGraphNode'), ('hipGraph_t', 'graph'),
...
// hipGraphAddHostNode[('hipGraphNode_t*', 'pGraphNode'), ('hipGraph_t', 'graph'), ('const
// hipGraphNode_t*', 'pDependencies'), ('size_t', 'numDependencies'), ('const hipHostNodeParams*',
// 'pNodeParams')]
...
// hipGraphAddKernelNode[('hipGraphNode_t*', 'pGraphNode'), ('hipGraph_t', 'graph'), ('const
// hipGraphNode_t*', 'pDependencies'), ('size_t', 'numDependencies'), ('const hipKernelNodeParams*',
// 'pNodeParams')]
...
// hipGraphAddMemAllocNode[('hipGraphNode_t*', 'pGraphNode'), ('hipGraph_t', 'graph'), ('const
// hipGraphNode_t*', 'pDependencies'), ('size_t', 'numDependencies'), ('hipMemAllocNodeParams*',
// 'pNodeParams')]
...
// hipGraphAddMemFreeNode[('hipGraphNode_t*', 'pGraphNode'), ('hipGraph_t', 'graph'), ('const
...
// hipGraphAddMemcpyNode1D[('hipGraphNode_t*', 'pGraphNode'), ('hipGraph_t', 'graph'), ('const
// hipGraphNode_t*', 'pDependencies'), ('size_t', 'numDependencies'), ('void*', 'dst'), ('const
// void*', 'src'), ('size_t', 'count'), ('hipMemcpyKind', 'kind')]
...
// hipGraphAddMemcpyNodeFromSymbol[('hipGraphNode_t*', 'pGraphNode'), ('hipGraph_t', 'graph'),
...
// hipGraphAddMemcpyNodeToSymbol[('hipGraphNode_t*', 'pGraphNode'), ('hipGraph_t', 'graph'), ('const
// hipGraphNode_t*', 'pDependencies'), ('size_t', 'numDependencies'), ('const void*', 'symbol'),
...
// hipGraphAddMemsetNode[('hipGraphNode_t*', 'pGraphNode'), ('hipGraph_t', 'graph'), ('const
// hipGraphNode_t*', 'pDependencies'), ('size_t', 'numDependencies'), ('const hipMemsetParams*',
// 'pMemsetParams')]
...
// hipGraphAddNode[('hipGraphNode_t*', 'pGraphNode'), ('hipGraph_t', 'graph'), ('const
// hipGraphNode_t*', 'pDependencies'), ('size_t', 'numDependencies'), ('hipGraphNodeParams*',
// 'nodeParams')]
...
// hipGraphBatchMemOpNodeGetParams[('hipGraphNode_t', 'hNode'), ('hipBatchMemOpNodeParams*',
// 'nodeParams_out')]
...
// hipGraphBatchMemOpNodeSetParams[('hipGraphNode_t', 'hNode'), ('hipBatchMemOpNodeParams*',
// 'nodeParams')]
...
// hipGraphDebugDotPrint[('hipGraph_t', 'graph'), ('const char*', 'path'), ('unsigned int',
// 'flags')]
...
// hipGraphExecBatchMemOpNodeSetParams[('hipGraphExec_t', 'hGraphExec'), ('hipGraphNode_t',
// 'hNode'), ('const hipBatchMemOpNodeParams*', 'nodeParams')]
...
// hipGraphExecChildGraphNodeSetParams[('hipGraphExec_t', 'hGraphExec'), ('hipGraphNode_t', 'node'),
// ('hipGraph_t', 'childGraph')]
...
// hipGraphExecEventRecordNodeSetEvent[('hipGraphExec_t', 'hGraphExec'), ('hipGraphNode_t',
// 'hNode'), ('hipEvent_t', 'event')]
...
// hipGraphExecEventWaitNodeSetEvent[('hipGraphExec_t', 'hGraphExec'), ('hipGraphNode_t', 'hNode'),
// ('hipEvent_t', 'event')]
...
// hipGraphExecExternalSemaphoresSignalNodeSetParams[('hipGraphExec_t', 'hGraphExec'),
...
#define INIT_hipGraphExecExternalSemaphoresSignalNodeSetParams_CB_ARGS_DATA(cb_data)               \
  {                                                                                                \
    cb_data.args.hipGraphExecExternalSemaphoresSignalNodeSetParams.hGraphExec =                    \
        (hipGraphExec_t)hGraphExec;                                                                \
    cb_data.args.hipGraphExecExternalSemaphoresSignalNodeSetParams.hNode = (hipGraphNode_t)hNode;  \
    cb_data.args.hipGraphExecExternalSemaphoresSignalNodeSetParams.nodeParams =                    \
        (const hipExternalSemaphoreSignalNodeParams*)nodeParams;                                   \
  };
// hipGraphExecExternalSemaphoresWaitNodeSetParams[('hipGraphExec_t', 'hGraphExec'),
...
// hipGraphExecMemcpyNodeSetParams1D[('hipGraphExec_t', 'hGraphExec'), ('hipGraphNode_t', 'node'),
...
// hipGraphExecMemcpyNodeSetParamsFromSymbol[('hipGraphExec_t', 'hGraphExec'), ('hipGraphNode_t',
// 'node'), ('void*', 'dst'), ('const void*', 'symbol'), ('size_t', 'count'), ('size_t', 'offset'),
// ('hipMemcpyKind', 'kind')]
...
// hipGraphExecMemcpyNodeSetParamsToSymbol[('hipGraphExec_t', 'hGraphExec'), ('hipGraphNode_t',
// 'node'), ('const void*', 'symbol'), ('const void*', 'src'), ('size_t', 'count'), ('size_t',
...
// hipGraphGetRootNodes[('hipGraph_t', 'graph'), ('hipGraphNode_t*', 'pRootNodes'), ('size_t*',
// 'pNumRootNodes')]
...
// hipGraphHostNodeSetParams[('hipGraphNode_t', 'node'), ('const hipHostNodeParams*',
// 'pNodeParams')]
...
// hipGraphKernelNodeGetAttribute[('hipGraphNode_t', 'hNode'), ('hipLaunchAttributeID', 'attr'),
// ('hipLaunchAttributeValue*', 'value')]
...
// hipGraphKernelNodeSetAttribute[('hipGraphNode_t', 'hNode'), ('hipLaunchAttributeID', 'attr'),
// ('const hipLaunchAttributeValue*', 'value')]
#define INIT_hipGraphKernelNodeSetAttribute_CB_ARGS_DATA(cb_data) {};
// hipGraphKernelNodeSetParams[('hipGraphNode_t', 'node'), ('const hipKernelNodeParams*',
// 'pNodeParams')]
...
// hipGraphMemAllocNodeGetParams[('hipGraphNode_t', 'node'), ('hipMemAllocNodeParams*',
// 'pNodeParams')]
...
// hipGraphMemcpyNodeSetParams[('hipGraphNode_t', 'node'), ('const hipMemcpy3DParms*',
// 'pNodeParams')]
...
// hipGraphMemcpyNodeSetParams1D[('hipGraphNode_t', 'node'), ('void*', 'dst'), ('const void*',
...
// hipGraphMemcpyNodeSetParamsFromSymbol[('hipGraphNode_t', 'node'), ('void*', 'dst'), ('const
// void*', 'symbol'), ('size_t', 'count'), ('size_t', 'offset'), ('hipMemcpyKind', 'kind')]
...
// hipGraphMemsetNodeSetParams[('hipGraphNode_t', 'node'), ('const hipMemsetParams*',
// 'pNodeParams')]
...
// hipGraphNodeFindInClone[('hipGraphNode_t*', 'pNode'), ('hipGraphNode_t', 'originalNode'),
// ('hipGraph_t', 'clonedGraph')]
...
// hipGraphNodeGetDependentNodes[('hipGraphNode_t', 'node'), ('hipGraphNode_t*', 'pDependentNodes'),
// ('size_t*', 'pNumDependentNodes')]
...
// hipGraphNodeGetEnabled[('hipGraphExec_t', 'hGraphExec'), ('hipGraphNode_t', 'hNode'), ('unsigned
// int*', 'isEnabled')]
...
// hipGraphNodeSetEnabled[('hipGraphExec_t', 'hGraphExec'), ('hipGraphNode_t', 'hNode'), ('unsigned
// int', 'isEnabled')]
...
// hipGraphReleaseUserObject[('hipGraph_t', 'graph'), ('hipUserObject_t', 'object'), ('unsigned
// int', 'count')]
...
// hipGraphRemoveDependencies[('hipGraph_t', 'graph'), ('const hipGraphNode_t*', 'from'), ('const
// hipGraphNode_t*', 'to'), ('size_t', 'numDependencies')]
...
// hipGraphRetainUserObject[('hipGraph_t', 'graph'), ('hipUserObject_t', 'object'), ('unsigned int',
...
// hipGraphicsGLRegisterBuffer[('hipGraphicsResource**', 'resource'), ('GLuint', 'buffer'),
// ('unsigned int', 'flags')]
...
// hipGraphicsGLRegisterImage[('hipGraphicsResource**', 'resource'), ('GLuint', 'image'), ('GLenum',
...
// hipGraphicsSubResourceGetMappedArray[('hipArray_t*', 'array'), ('hipGraphicsResource_t',
...
// hipHccModuleLaunchKernel[('hipFunction_t', 'f'), ('unsigned int', 'globalWorkSizeX'), ('unsigned
// int', 'globalWorkSizeY'), ('unsigned int', 'globalWorkSizeZ'), ('unsigned int', 'blockDimX'),
// ('unsigned int', 'blockDimY'), ('unsigned int', 'blockDimZ'), ('size_t', 'sharedMemBytes'),
// ('hipStream_t', 'hStream'), ('void**', 'kernelParams'), ('void**', 'extra'), ('hipEvent_t',
// 'startEvent'), ('hipEvent_t', 'stopEvent')]
...
// hipLaunchCooperativeKernel[('const void*', 'f'), ('dim3', 'gridDim'), ('dim3', 'blockDimX'),
...
// hipLaunchCooperativeKernelMultiDevice[('hipLaunchParams*', 'launchParamsList'), ('int',
// 'numDevices'), ('unsigned int', 'flags')]
...
// hipLaunchKernel[('const void*', 'function_address'), ('dim3', 'numBlocks'), ('dim3',
// 'dimBlocks'), ('void**', 'args'), ('size_t', 'sharedMemBytes'), ('hipStream_t', 'stream')]
...
// hipLaunchKernelExC[('const hipLaunchConfig_t*', 'config'), ('const void*', 'fPtr'), ('void**',
// 'args')]
...
// ('size_t', 'size'), ('const char*', 'name'), ('unsigned int', 'numOptions'), ('hipJitOption*',
...
// hipLinkAddFile[('hipLinkState_t', 'state'), ('hipJitInputType', 'type'), ('const char*', 'path'),
...
// hipLinkCreate[('unsigned int', 'numOptions'), ('hipJitOption*', 'options'), ('void**',
// 'optionValues'), ('hipLinkState_t*', 'stateOut')]
...
// hipMalloc3DArray[('hipArray_t*', 'array'), ('const hipChannelFormatDesc*', 'desc'), ('hipExtent',
...
// hipMallocArray[('hipArray_t*', 'array'), ('const hipChannelFormatDesc*', 'desc'), ('size_t',
// 'width'), ('size_t', 'height'), ('unsigned int', 'flags')]
...
// hipChannelFormatDesc*', 'desc'), ('hipExtent', 'extent'), ('unsigned int', 'numLevels'),
// ('unsigned int', 'flags')]
...
// hipMallocPitch[('void**', 'ptr'), ('size_t*', 'pitch'), ('size_t', 'width'), ('size_t',
// 'height')]
...
// hipMemAddressReserve[('void**', 'ptr'), ('size_t', 'size'), ('size_t', 'alignment'), ('void*',
...
// hipMemAdvise[('const void*', 'dev_ptr'), ('size_t', 'count'), ('hipMemoryAdvise', 'advice'),
// ('int', 'device')]
...
// hipMemAdvise_v2[('const void*', 'dev_ptr'), ('size_t', 'count'), ('hipMemoryAdvise', 'advice'),
// ('hipMemLocation', 'location')]
...
// hipMemCreate[('hipMemGenericAllocationHandle_t*', 'handle'), ('size_t', 'size'), ('const
...
// hipMemExportToShareableHandle[('void*', 'shareableHandle'), ('hipMemGenericAllocationHandle_t',
...
// hipMemGetAccess[('unsigned long long*', 'flags'), ('const hipMemLocation*', 'location'),
// ('void*', 'ptr')]
...
// hipMemGetAddressRange[('hipDeviceptr_t*', 'pbase'), ('size_t*', 'psize'), ('hipDeviceptr_t',
// 'dptr')]
...
// hipMemGetAllocationGranularity[('size_t*', 'granularity'), ('const hipMemAllocationProp*',
// 'prop'), ('hipMemAllocationGranularity_flags', 'option')]
...
// hipMemImportFromShareableHandle[('hipMemGenericAllocationHandle_t*', 'handle'), ('void*',
...
// hipMemMapArrayAsync[('hipArrayMapInfo*', 'mapInfoList'), ('unsigned int', 'count'),
// ('hipStream_t', 'stream')]
...
// hipMemPoolGetAccess[('hipMemAccessFlags*', 'flags'), ('hipMemPool_t', 'mem_pool'),
// ('hipMemLocation*', 'location')]
...
// hipMemPoolGetAttribute[('hipMemPool_t', 'mem_pool'), ('hipMemPoolAttr', 'attr'), ('void*',
// 'value')]
...
// hipMemPoolSetAccess[('hipMemPool_t', 'mem_pool'), ('const hipMemAccessDesc*', 'desc_list'),
// ('size_t', 'count')]
...
// hipMemPoolSetAttribute[('hipMemPool_t', 'mem_pool'), ('hipMemPoolAttr', 'attr'), ('void*',
// 'value')]
...
// hipMemPrefetchAsync[('const void*', 'dev_ptr'), ('size_t', 'count'), ('int', 'device'),
// ('hipStream_t', 'stream')]
...
// hipMemPrefetchAsync_v2[('const void*', 'dev_ptr'), ('size_t', 'count'), ('hipMemLocation',
// 'location'), ('unsigned int', 'flags'), ('hipStream_t', 'stream')]
...
// hipMemRangeGetAttribute[('void*', 'data'), ('size_t', 'data_size'), ('hipMemRangeAttribute',
// 'attribute'), ('const void*', 'dev_ptr'), ('size_t', 'count')]
...
// hipMemRangeGetAttributes[('void**', 'data'), ('size_t*', 'data_sizes'), ('hipMemRangeAttribute*',
// 'attributes'), ('size_t', 'num_attributes'), ('const void*', 'dev_ptr'), ('size_t', 'count')]
...
// hipMemcpy[('void*', 'dst'), ('const void*', 'src'), ('size_t', 'sizeBytes'), ('hipMemcpyKind',
// 'kind')]
...
// hipMemcpy2DArrayToArray[('hipArray_t', 'dst'), ('size_t', 'wOffsetDst'), ('size_t',
// 'hOffsetDst'), ('hipArray_const_t', 'src'), ('size_t', 'wOffsetSrc'), ('size_t', 'hOffsetSrc'),
// ('size_t', 'width'), ('size_t', 'height'), ('hipMemcpyKind', 'kind')]
...
// hipMemcpy2DAsync[('void*', 'dst'), ('size_t', 'dpitch'), ('const void*', 'src'), ('size_t',
// 'spitch'), ('size_t', 'width'), ('size_t', 'height'), ('hipMemcpyKind', 'kind'), ('hipStream_t',
// 'stream')]
...
// hipMemcpy2DFromArray[('void*', 'dst'), ('size_t', 'dpitch'), ('hipArray_const_t', 'src'),
...
// hipMemcpy2DToArray[('hipArray_t', 'dst'), ('size_t', 'wOffset'), ('size_t', 'hOffset'), ('const
...
// hipMemcpy3DBatchAsync[('size_t', 'numOps'), ('hipMemcpy3DBatchOp*', 'opList'), ('size_t*',
// 'failIdx'), ('unsigned long long', 'flags'), ('hipStream_t', 'stream')]
...
// hipMemcpyAtoA[('hipArray_t', 'dstArray'), ('size_t', 'dstOffset'), ('hipArray_t', 'srcArray'),
...
// hipMemcpyAtoD[('hipDeviceptr_t', 'dstDevice'), ('hipArray_t', 'srcArray'), ('size_t',
...
// hipMemcpyAtoH[('void*', 'dst'), ('hipArray_t', 'srcArray'), ('size_t', 'srcOffset'), ('size_t',
// 'count')]
...
// hipMemcpyAtoHAsync[('void*', 'dstHost'), ('hipArray_t', 'srcArray'), ('size_t', 'srcOffset'),
...
// hipMemcpyBatchAsync[('void**', 'dsts'), ('void**', 'srcs'), ('size_t*', 'sizes'), ('size_t',
// 'count'), ('hipMemcpyAttributes*', 'attrs'), ('size_t*', 'attrsIdxs'), ('size_t', 'numAttrs'),
...
// hipMemcpyDtoA[('hipArray_t', 'dstArray'), ('size_t', 'dstOffset'), ('hipDeviceptr_t',
...
// hipMemcpyDtoDAsync[('hipDeviceptr_t', 'dst'), ('hipDeviceptr_t', 'src'), ('size_t', 'sizeBytes'),
// ('hipStream_t', 'stream')]
...
// hipMemcpyDtoHAsync[('void*', 'dst'), ('hipDeviceptr_t', 'src'), ('size_t', 'sizeBytes'),
// ('hipStream_t', 'stream')]
...
// hipMemcpyHtoA[('hipArray_t', 'dstArray'), ('size_t', 'dstOffset'), ('const void*', 'srcHost'),
// ('size_t', 'count')]
...
// hipMemcpyHtoAAsync[('hipArray_t', 'dstArray'), ('size_t', 'dstOffset'), ('const void*',
// 'srcHost'), ('size_t', 'ByteCount'), ('hipStream_t', 'stream')]
...
// hipMemcpyHtoDAsync[('hipDeviceptr_t', 'dst'), ('const void*', 'src'), ('size_t', 'sizeBytes'),
// ('hipStream_t', 'stream')]
...
// hipMemcpyPeer[('void*', 'dst'), ('int', 'dstDeviceId'), ('const void*', 'src'), ('int',
// 'srcDeviceId'), ('size_t', 'sizeBytes')]
...
// hipMemcpyPeerAsync[('void*', 'dst'), ('int', 'dstDeviceId'), ('const void*', 'src'), ('int',
...
// hipMemcpyToArray[('hipArray_t', 'dst'), ('size_t', 'wOffset'), ('size_t', 'hOffset'), ('const
// void*', 'src'), ('size_t', 'count'), ('hipMemcpyKind', 'kind')]
...
// hipMemcpyToSymbolAsync[('const void*', 'symbol'), ('const void*', 'src'), ('size_t',
// 'sizeBytes'), ('size_t', 'offset'), ('hipMemcpyKind', 'kind'), ('hipStream_t', 'stream')]
...
// hipMemset2D[('void*', 'dst'), ('size_t', 'pitch'), ('int', 'value'), ('size_t', 'width'),
// ('size_t', 'height')]
...
// hipMemset3DAsync[('hipPitchedPtr', 'pitchedDevPtr'), ('int', 'value'), ('hipExtent', 'extent'),
// ('hipStream_t', 'stream')]
...
// hipMemsetAsync[('void*', 'dst'), ('int', 'value'), ('size_t', 'sizeBytes'), ('hipStream_t',
// 'stream')]
...
// hipMemsetD16Async[('hipDeviceptr_t', 'dest'), ('unsigned short', 'value'), ('size_t', 'count'),
// ('hipStream_t', 'stream')]
...
// hipMemsetD2D16[('hipDeviceptr_t', 'dst'), ('size_t', 'dstPitch'), ('unsigned short', 'value'),
...
// hipMemsetD2D16Async[('hipDeviceptr_t', 'dst'), ('size_t', 'dstPitch'), ('unsigned short',
// 'value'), ('size_t', 'width'), ('size_t', 'height'), ('hipStream_t', 'stream')]
...
// hipMemsetD2D32[('hipDeviceptr_t', 'dst'), ('size_t', 'dstPitch'), ('unsigned int', 'value'),
// ('size_t', 'width'), ('size_t', 'height')]
...
// hipMemsetD2D32Async[('hipDeviceptr_t', 'dst'), ('size_t', 'dstPitch'), ('unsigned int', 'value'),
...
// hipMemsetD2D8[('hipDeviceptr_t', 'dst'), ('size_t', 'dstPitch'), ('unsigned char', 'value'),
// ('size_t', 'width'), ('size_t', 'height')]
...
// hipMemsetD2D8Async[('hipDeviceptr_t', 'dst'), ('size_t', 'dstPitch'), ('unsigned char', 'value'),
// ('size_t', 'width'), ('size_t', 'height'), ('hipStream_t', 'stream')]
...
// hipMemsetD8Async[('hipDeviceptr_t', 'dest'), ('unsigned char', 'value'), ('size_t', 'count'),
// ('hipStream_t', 'stream')]
...
// hipMipmappedArrayCreate[('hipMipmappedArray_t*', 'pHandle'), ('HIP_ARRAY3D_DESCRIPTOR*',
...
// hipMipmappedArrayGetLevel[('hipArray_t*', 'pLevelArray'), ('hipMipmappedArray_t',
...
// hipMipmappedArrayGetMemoryRequirements[('hipArrayMemoryRequirements*', 'memoryRequirements'),
// ('hipMipmappedArray_t', 'mipmap'), ('hipDevice_t', 'device')]
#define INIT_hipMipmappedArrayGetMemoryRequirements_CB_ARGS_DATA(cb_data)                          \
  {                                                                                                \
    cb_data.args.hipMipmappedArrayGetMemoryRequirements.memoryRequirements =                       \
        (hipArrayMemoryRequirements*)memoryRequirements;                                           \
...
// hipModuleGetFunction[('hipFunction_t*', 'function'), ('hipModule_t', 'module'), ('const char*',
// 'kname')]
...
// hipModuleGetGlobal[('hipDeviceptr_t*', 'dptr'), ('size_t*', 'bytes'), ('hipModule_t', 'hmod'),
// ('const char*', 'name')]
...
// hipModuleGetTexRef[('textureReference**', 'texRef'), ('hipModule_t', 'hmod'), ('const char*',
// 'name')]
...
// int', 'gridDimY'), ('unsigned int', 'gridDimZ'), ('unsigned int', 'blockDimX'), ('unsigned int',
...
// hipModuleLaunchCooperativeKernelMultiDevice[('hipFunctionLaunchParams*', 'launchParamsList'),
// ('unsigned int', 'numDevices'), ('unsigned int', 'flags')]
#define INIT_hipModuleLaunchCooperativeKernelMultiDevice_CB_ARGS_DATA(cb_data)                     \
  {                                                                                                \
    cb_data.args.hipModuleLaunchCooperativeKernelMultiDevice.launchParamsList =                    \
        (hipFunctionLaunchParams*)launchParamsList;                                                \
...
// hipModuleLoadDataEx[('hipModule_t*', 'module'), ('const void*', 'image'), ('unsigned int',
// 'numOptions'), ('hipJitOption*', 'options'), ('void**', 'optionsValues')]
...
#define INIT_hipModuleOccupancyMaxActiveBlocksPerMultiprocessor_CB_ARGS_DATA(cb_data)              \
  {                                                                                                \
    ...
    cb_data.args.hipModuleOccupancyMaxActiveBlocksPerMultiprocessor.dynSharedMemPerBlk =           \
        (size_t)dynSharedMemPerBlk;                                                                \
  };
// hipModuleOccupancyMaxActiveBlocksPerMultiprocessorWithFlags[('int*', 'numBlocks'),
// ('hipFunction_t', 'f'), ('int', 'blockSize'), ('size_t', 'dynSharedMemPerBlk'), ('unsigned int',
// 'flags')]
#define INIT_hipModuleOccupancyMaxActiveBlocksPerMultiprocessorWithFlags_CB_ARGS_DATA(cb_data)     \
  {                                                                                                \
    cb_data.args.hipModuleOccupancyMaxActiveBlocksPerMultiprocessorWithFlags.numBlocks =           \
        (int*)numBlocks;                                                                           \
    cb_data.args.hipModuleOccupancyMaxActiveBlocksPerMultiprocessorWithFlags.f = (hipFunction_t)f; \
    cb_data.args.hipModuleOccupancyMaxActiveBlocksPerMultiprocessorWithFlags.blockSize =           \
        (int)blockSize;                                                                            \
    cb_data.args.hipModuleOccupancyMaxActiveBlocksPerMultiprocessorWithFlags.dynSharedMemPerBlk =  \
        (size_t)dynSharedMemPerBlk;                                                                \
    cb_data.args.hipModuleOccupancyMaxActiveBlocksPerMultiprocessorWithFlags.flags =               \
        (unsigned int)flags;                                                                       \
  };
...
// ('hipFunction_t', 'f'), ('size_t', 'dynSharedMemPerBlk'), ('int', 'blockSizeLimit'), ('unsigned
// int', 'flags')]
#define INIT_hipModuleOccupancyMaxPotentialBlockSizeWithFlags_CB_ARGS_DATA(cb_data)                \
  {                                                                                                \
    ...
    cb_data.args.hipModuleOccupancyMaxPotentialBlockSizeWithFlags.dynSharedMemPerBlk =             \
        (size_t)dynSharedMemPerBlk;                                                                \
    cb_data.args.hipModuleOccupancyMaxPotentialBlockSizeWithFlags.blockSizeLimit =                 \
        (int)blockSizeLimit;                                                                       \
...
// hipOccupancyMaxActiveBlocksPerMultiprocessor[('int*', 'numBlocks'), ('const void*', 'f'), ('int',
...
#define INIT_hipOccupancyMaxActiveBlocksPerMultiprocessor_CB_ARGS_DATA(cb_data)                    \
  {                                                                                                \
    ...
    cb_data.args.hipOccupancyMaxActiveBlocksPerMultiprocessor.dynamicSMemSize =                    \
        (size_t)dynamicSMemSize;                                                                   \
  };
// hipOccupancyMaxActiveBlocksPerMultiprocessorWithFlags[('int*', 'numBlocks'), ('const void*',
// 'f'), ('int', 'blockSize'), ('size_t', 'dynamicSMemSize'), ('unsigned int', 'flags')]
#define INIT_hipOccupancyMaxActiveBlocksPerMultiprocessorWithFlags_CB_ARGS_DATA(cb_data)           \
  {                                                                                                \
    cb_data.args.hipOccupancyMaxActiveBlocksPerMultiprocessorWithFlags.numBlocks =                 \
        (int*)numBlocks;                                                                           \
    ...
    cb_data.args.hipOccupancyMaxActiveBlocksPerMultiprocessorWithFlags.dynamicSMemSize =           \
        (size_t)dynamicSMemSize;                                                                   \
    cb_data.args.hipOccupancyMaxActiveBlocksPerMultiprocessorWithFlags.flags =                     \
        (unsigned int)flags;                                                                       \
  };
// hipOccupancyMaxPotentialBlockSize[('int*', 'gridSize'), ('int*', 'blockSize'), ('const void*',
// 'f'), ('size_t', 'dynSharedMemPerBlk'), ('int', 'blockSizeLimit')]
...
// hipPointerSetAttribute[('const void*', 'value'), ('hipPointer_attribute', 'attribute'),
// ('hipDeviceptr_t', 'ptr')]
...
// hipSignalExternalSemaphoresAsync[('const hipExternalSemaphore_t*', 'extSemArray'), ('const
// hipExternalSemaphoreSignalParams*', 'paramsArray'), ('unsigned int', 'numExtSems'),
// ('hipStream_t', 'stream')]
...
// hipStreamAddCallback[('hipStream_t', 'stream'), ('hipStreamCallback_t', 'callback'), ('void*',
...
// hipStreamAttachMemAsync[('hipStream_t', 'stream'), ('void*', 'dev_ptr'), ('size_t', 'length'),
// ('unsigned int', 'flags')]
...
// hipStreamBeginCaptureToGraph[('hipStream_t', 'stream'), ('hipGraph_t', 'graph'), ('const
// hipGraphNode_t*', 'dependencies'), ('const hipGraphEdgeData*', 'dependencyData'), ('size_t',
// 'numDependencies'), ('hipStreamCaptureMode', 'mode')]
...
// hipStreamCreateWithPriority[('hipStream_t*', 'stream'), ('unsigned int', 'flags'), ('int',
// 'priority')]
...
// hipStreamGetAttribute[('hipStream_t', 'stream'), ('hipLaunchAttributeID', 'attr'), ('const
// hipLaunchAttributeValue*', 'value_out')]
#define INIT_hipStreamGetAttribute_CB_ARGS_DATA(cb_data) {};
// hipStreamGetCaptureInfo[('hipStream_t', 'stream'), ('hipStreamCaptureStatus*', 'pCaptureStatus'),
// ('unsigned long long*', 'pId')]
...
// 'captureStatus_out'), ('unsigned long long*', 'id_out'), ('hipGraph_t*', 'graph_out'), ('const
// hipGraphNode_t**', 'dependencies_out'), ('size_t*', 'numDependencies_out')]
...
// hipStreamSetAttribute[('hipStream_t', 'stream'), ('hipLaunchAttributeID', 'attr'), ('const
// hipLaunchAttributeValue*', 'value')]
...
// 'dependencies'), ('size_t', 'numDependencies'), ('unsigned int', 'flags')]
...
// hipStreamWaitValue32[('hipStream_t', 'stream'), ('void*', 'ptr'), ('unsigned int', 'value'),
...
// hipStreamWriteValue32[('hipStream_t', 'stream'), ('void*', 'ptr'), ('unsigned int', 'value'),
// ('unsigned int', 'flags')]
...
// hipStreamWriteValue64[('hipStream_t', 'stream'), ('void*', 'ptr'), ('uint64_t', 'value'),
// ('unsigned int', 'flags')]
...
// hipTexRefGetFormat[('hipArray_Format*', 'pFormat'), ('int*', 'pNumChannels'), ('const
// textureReference*', 'texRef')]
...
// hipTexRefGetMipMappedArray[('hipMipmappedArray_t*', 'pArray'), ('const textureReference*',
// 'texRef')]
...
// hipTexRefSetAddress[('size_t*', 'ByteOffset'), ('textureReference*', 'texRef'),
...
// hipTexRefSetAddress2D[('textureReference*', 'texRef'), ('const HIP_ARRAY_DESCRIPTOR*', 'desc'),
...
// hipTexRefSetArray[('textureReference*', 'tex'), ('hipArray_const_t', 'array'), ('unsigned int',
// 'flags')]
...
// hipTexRefSetFormat[('textureReference*', 'texRef'), ('hipArray_Format', 'fmt'), ('int',
// 'NumPackedComponents')]
...
// hipTexRefSetMipmapLevelClamp[('textureReference*', 'texRef'), ('float', 'minMipMapLevelClamp'),
// ('float', 'maxMipMapLevelClamp')]
...
// hipTexRefSetMipmappedArray[('textureReference*', 'texRef'), ('hipMipmappedArray*',
// 'mipmappedArray'), ('unsigned int', 'Flags')]
...
// hipUserObjectCreate[('hipUserObject_t*', 'object_out'), ('void*', 'ptr'), ('hipHostFn_t',
...
// hipWaitExternalSemaphoresAsync[('const hipExternalSemaphore_t*', 'extSemArray'), ('const
// hipExternalSemaphoreWaitParams*', 'paramsArray'), ('unsigned int', 'numExtSems'), ('hipStream_t',
// 'stream')]
...
static inline void hipApiArgsInit(hip_api_id_t id, hip_api_data_t* data) {
  switch (id) {
      // __hipPopCallConfiguration[('dim3*', 'gridDim'), ('dim3*', 'blockDim'), ('size_t*',
    ...
    case HIP_API_ID___hipPopCallConfiguration:
      ...
      break;
      // __hipPushCallConfiguration[('dim3', 'gridDim'), ('dim3', 'blockDim'), ('size_t',
      // 'sharedMem'), ('hipStream_t', 'stream')]
    case HIP_API_ID___hipPushCallConfiguration:
      break;
    ...
    case HIP_API_ID_hipArray3DCreate:
      if (data->args.hipArray3DCreate.array)
        data->args.hipArray3DCreate.array__val = *(data->args.hipArray3DCreate.array);
      ...
      break;
      // hipArray3DGetDescriptor[('HIP_ARRAY3D_DESCRIPTOR*', 'pArrayDescriptor'), ('hipArray_t',
      // 'array')]
    case HIP_API_ID_hipArray3DGetDescriptor:
    ...
    case HIP_API_ID_hipArrayCreate:
      if (data->args.hipArrayCreate.pHandle)
        data->args.hipArrayCreate.pHandle__val = *(data->args.hipArrayCreate.pHandle);
      if (data->args.hipArrayCreate.pAllocateArray)
        data->args.hipArrayCreate.pAllocateArray__val = *(data->args.hipArrayCreate.pAllocateArray);
      break;
      // hipArrayDestroy[('hipArray_t', 'array')]
    case HIP_API_ID_hipArrayDestroy:
      break;
      // hipArrayGetDescriptor[('HIP_ARRAY_DESCRIPTOR*', 'pArrayDescriptor'), ('hipArray_t',
      // 'array')]
    case HIP_API_ID_hipArrayGetDescriptor:
      ...
      break;
      // hipArrayGetInfo[('hipChannelFormatDesc*', 'desc'), ('hipExtent*', 'extent'), ('unsigned
      // int*', 'flags'), ('hipArray_t', 'array')]
    case HIP_API_ID_hipArrayGetInfo:
      ...
      if (data->args.hipArrayGetInfo.extent)
        data->args.hipArrayGetInfo.extent__val = *(data->args.hipArrayGetInfo.extent);
      if (data->args.hipArrayGetInfo.flags)
        data->args.hipArrayGetInfo.flags__val = *(data->args.hipArrayGetInfo.flags);
      break;
      // hipChooseDeviceR0000[('int*', 'device'), ('const hipDeviceProp_tR0000*', 'prop')]
    case HIP_API_ID_hipChooseDeviceR0000:
      if (data->args.hipChooseDeviceR0000.device)
        data->args.hipChooseDeviceR0000.device__val = *(data->args.hipChooseDeviceR0000.device);
      if (data->args.hipChooseDeviceR0000.prop)
        data->args.hipChooseDeviceR0000.prop__val = *(data->args.hipChooseDeviceR0000.prop);
      break;
      // hipChooseDeviceR0600[('int*', 'device'), ('const hipDeviceProp_tR0600*', 'prop')]
    case HIP_API_ID_hipChooseDeviceR0600:
      if (data->args.hipChooseDeviceR0600.device)
        data->args.hipChooseDeviceR0600.device__val = *(data->args.hipChooseDeviceR0600.device);
      if (data->args.hipChooseDeviceR0600.prop)
        data->args.hipChooseDeviceR0600.prop__val = *(data->args.hipChooseDeviceR0600.prop);
      break;
      // hipConfigureCall[('dim3', 'gridDim'), ('dim3', 'blockDim'), ('size_t', 'sharedMem'),
      // ('hipStream_t', 'stream')]
    case HIP_API_ID_hipConfigureCall:
    ...
    case HIP_API_ID_hipCtxGetDevice:
      if (data->args.hipCtxGetDevice.device)
        data->args.hipCtxGetDevice.device__val = *(data->args.hipCtxGetDevice.device);
      break;
      // hipCtxGetFlags[('unsigned int*', 'flags')]
    case HIP_API_ID_hipCtxGetFlags:
    ...
    case HIP_API_ID_hipDestroySurfaceObject:
      break;
      // hipDeviceCanAccessPeer[('int*', 'canAccessPeer'), ('int', 'deviceId'), ('int',
      // 'peerDeviceId')]
    case HIP_API_ID_hipDeviceCanAccessPeer:
    ...
    case HIP_API_ID_hipDeviceGet:
      ...
      break;
      // hipDeviceGetAttribute[('int*', 'pi'), ('hipDeviceAttribute_t', 'attr'), ('int',
      // 'deviceId')]
    case HIP_API_ID_hipDeviceGetAttribute:
      if (data->args.hipDeviceGetAttribute.pi)
        data->args.hipDeviceGetAttribute.pi__val = *(data->args.hipDeviceGetAttribute.pi);
      break;
      // hipDeviceGetByPCIBusId[('int*', 'device'), ('const char*', 'pciBusId')]
    case HIP_API_ID_hipDeviceGetByPCIBusId:
      if (data->args.hipDeviceGetByPCIBusId.device)
        data->args.hipDeviceGetByPCIBusId.device__val = *(data->args.hipDeviceGetByPCIBusId.device);
    ...
    case HIP_API_ID_hipDeviceGetLimit:
      if (data->args.hipDeviceGetLimit.pValue)
        data->args.hipDeviceGetLimit.pValue__val = *(data->args.hipDeviceGetLimit.pValue);
      break;
      // hipDeviceGetMemPool[('hipMemPool_t*', 'mem_pool'), ('int', 'device')]
    case HIP_API_ID_hipDeviceGetMemPool:
      if (data->args.hipDeviceGetMemPool.mem_pool)
        data->args.hipDeviceGetMemPool.mem_pool__val = *(data->args.hipDeviceGetMemPool.mem_pool);
      break;
      // hipDeviceGetName[('char*', 'name'), ('int', 'len'), ('hipDevice_t', 'device')]
    case HIP_API_ID_hipDeviceGetName:
      data->args.hipDeviceGetName.name =
          (data->args.hipDeviceGetName.name) ? strdup(data->args.hipDeviceGetName.name) : NULL;
      break;
      // hipDeviceGetP2PAttribute[('int*', 'value'), ('hipDeviceP2PAttr', 'attr'), ('int',
    ...
    case HIP_API_ID_hipDeviceGetUuid:
      if (data->args.hipDeviceGetUuid.uuid)
        data->args.hipDeviceGetUuid.uuid__val = *(data->args.hipDeviceGetUuid.uuid);
      break;
      // hipDeviceGraphMemTrim[('int', 'device')]
    case HIP_API_ID_hipDeviceGraphMemTrim:
      break;
    ...
    case HIP_API_ID_hipDeviceTotalMem:
      if (data->args.hipDeviceTotalMem.bytes)
        data->args.hipDeviceTotalMem.bytes__val = *(data->args.hipDeviceTotalMem.bytes);
      break;
      // hipDriverGetVersion[('int*', 'driverVersion')]
    case HIP_API_ID_hipDriverGetVersion:
    ...
    case HIP_API_ID_hipDrvGraphAddMemFreeNode:
      ...
      // ('const hipGraphNode_t*', 'dependencies'), ('size_t', 'numDependencies'), ('const
      // HIP_MEMCPY3D*', 'copyParams'), ('hipCtx_t', 'ctx')]
    case HIP_API_ID_hipDrvGraphAddMemcpyNode:
      ...
      // ('const hipGraphNode_t*', 'dependencies'), ('size_t', 'numDependencies'), ('const
      // hipMemsetParams*', 'memsetParams'), ('hipCtx_t', 'ctx')]
    case HIP_API_ID_hipDrvGraphAddMemsetNode:
      ...
      break;
      // hipDrvGraphExecMemcpyNodeSetParams[('hipGraphExec_t', 'hGraphExec'), ('hipGraphNode_t',
      // 'hNode'), ('const HIP_MEMCPY3D*', 'copyParams'), ('hipCtx_t', 'ctx')]
    case HIP_API_ID_hipDrvGraphExecMemcpyNodeSetParams:
      ...
      break;
      // hipDrvGraphExecMemsetNodeSetParams[('hipGraphExec_t', 'hGraphExec'), ('hipGraphNode_t',
      // 'hNode'), ('const hipMemsetParams*', 'memsetParams'), ('hipCtx_t', 'ctx')]
    case HIP_API_ID_hipDrvGraphExecMemsetNodeSetParams:
    ...
    case HIP_API_ID_hipDrvGraphMemcpyNodeSetParams:
      ...
      break;
      // hipDrvLaunchKernelEx[('const HIP_LAUNCH_CONFIG*', 'config'), ('hipFunction_t', 'f'),
      // ('void**', 'params'), ('void**', 'extra')]
    case HIP_API_ID_hipDrvLaunchKernelEx:
      if (data->args.hipDrvLaunchKernelEx.config)
        data->args.hipDrvLaunchKernelEx.config__val = *(data->args.hipDrvLaunchKernelEx.config);
      if (data->args.hipDrvLaunchKernelEx.params)
        data->args.hipDrvLaunchKernelEx.params__val = *(data->args.hipDrvLaunchKernelEx.params);
      if (data->args.hipDrvLaunchKernelEx.extra)
        data->args.hipDrvLaunchKernelEx.extra__val = *(data->args.hipDrvLaunchKernelEx.extra);
      break;
      // hipDrvMemcpy2DUnaligned[('const hip_Memcpy2D*', 'pCopy')]
    case HIP_API_ID_hipDrvMemcpy2DUnaligned:
      if (data->args.hipDrvMemcpy2DUnaligned.pCopy)
        data->args.hipDrvMemcpy2DUnaligned.pCopy__val = *(data->args.hipDrvMemcpy2DUnaligned.pCopy);
      break;
      // hipDrvMemcpy3D[('const HIP_MEMCPY3D*', 'pCopy')]
    case HIP_API_ID_hipDrvMemcpy3D:
    ...
    case HIP_API_ID_hipDrvMemcpy3DAsync:
      if (data->args.hipDrvMemcpy3DAsync.pCopy)
        data->args.hipDrvMemcpy3DAsync.pCopy__val = *(data->args.hipDrvMemcpy3DAsync.pCopy);
      break;
      // hipDrvPointerGetAttributes[('unsigned int', 'numAttributes'), ('hipPointer_attribute*',
      // 'attributes'), ('void**', 'data'), ('hipDeviceptr_t', 'ptr')]
    case HIP_API_ID_hipDrvPointerGetAttributes:
    ...
    case HIP_API_ID_hipEventCreateWithFlags:
      if (data->args.hipEventCreateWithFlags.event)
        data->args.hipEventCreateWithFlags.event__val = *(data->args.hipEventCreateWithFlags.event);
      break;
      // hipEventDestroy[('hipEvent_t', 'event')]
    case HIP_API_ID_hipEventDestroy:
      break;
    ...
    case HIP_API_ID_hipEventElapsedTime:
      if (data->args.hipEventElapsedTime.ms)
        data->args.hipEventElapsedTime.ms__val = *(data->args.hipEventElapsedTime.ms);
      break;
      // hipEventQuery[('hipEvent_t', 'event')]
    case HIP_API_ID_hipEventQuery:
      break;
    ...
    case HIP_API_ID_hipEventRecord:
      break;
      // hipEventRecordWithFlags[('hipEvent_t', 'event'), ('hipStream_t', 'stream'), ('unsigned
      // int', 'flags')]
    case HIP_API_ID_hipEventRecordWithFlags:
      break;
      // hipEventSynchronize[('hipEvent_t', 'event')]
    ...
    case HIP_API_ID_hipExtLaunchKernel:
      if (data->args.hipExtLaunchKernel.args)
        data->args.hipExtLaunchKernel.args__val = *(data->args.hipExtLaunchKernel.args);
      break;
      // hipExtLaunchMultiKernelMultiDevice[('hipLaunchParams*', 'launchParamsList'), ('int',
      // 'numDevices'), ('unsigned int', 'flags')]
    case HIP_API_ID_hipExtLaunchMultiKernelMultiDevice:
      ...
      break;
      // hipExtMallocWithFlags[('void**', 'ptr'), ('size_t', 'sizeBytes'), ('unsigned int',
      // 'flags')]
    case HIP_API_ID_hipExtMallocWithFlags:
      if (data->args.hipExtMallocWithFlags.ptr)
        data->args.hipExtMallocWithFlags.ptr__val = *(data->args.hipExtMallocWithFlags.ptr);
      break;
      // hipExtModuleLaunchKernel[('hipFunction_t', 'f'), ('unsigned int', 'globalWorkSizeX'),
      // ('unsigned int', 'globalWorkSizeY'), ('unsigned int', 'globalWorkSizeZ'), ('unsigned int',
      // 'localWorkSizeX'), ('unsigned int', 'localWorkSizeY'), ('unsigned int', 'localWorkSizeZ'),
      // ('size_t', 'sharedMemBytes'), ('hipStream_t', 'hStream'), ('void**', 'kernelParams'),
      // ('void**', 'extra'), ('hipEvent_t', 'startEvent'), ('hipEvent_t', 'stopEvent'), ('unsigned
      // int', 'flags')]
    case HIP_API_ID_hipExtModuleLaunchKernel:
      ...
      break;
      // hipExtStreamCreateWithCUMask[('hipStream_t*', 'stream'), ('unsigned int', 'cuMaskSize'),
      // ('const unsigned int*', 'cuMask')]
    case HIP_API_ID_hipExtStreamCreateWithCUMask:
    ...
    case HIP_API_ID_hipExtStreamGetCUMask:
      if (data->args.hipExtStreamGetCUMask.cuMask)
        data->args.hipExtStreamGetCUMask.cuMask__val = *(data->args.hipExtStreamGetCUMask.cuMask);
      break;
    ...
    case HIP_API_ID_hipExternalMemoryGetMappedBuffer:
      ...
      break;
      // hipExternalMemoryGetMappedMipmappedArray[('hipMipmappedArray_t*', 'mipmap'),
      // ('hipExternalMemory_t', 'extMem'), ('const hipExternalMemoryMipmappedArrayDesc*',
      // 'mipmapDesc')]
    case HIP_API_ID_hipExternalMemoryGetMappedMipmappedArray:
    ...
    case HIP_API_ID_hipFuncGetAttribute:
      if (data->args.hipFuncGetAttribute.value)
        data->args.hipFuncGetAttribute.value__val = *(data->args.hipFuncGetAttribute.value);
      break;
      // hipFuncGetAttributes[('hipFuncAttributes*', 'attr'), ('const void*', 'func')]
    case HIP_API_ID_hipFuncGetAttributes:
      if (data->args.hipFuncGetAttributes.attr)
        data->args.hipFuncGetAttributes.attr__val = *(data->args.hipFuncGetAttributes.attr);
      break;
      // hipFuncSetAttribute[('const void*', 'func'), ('hipFuncAttribute', 'attr'), ('int',
      // 'value')]
    case HIP_API_ID_hipFuncSetAttribute:
      break;
      // hipFuncSetCacheConfig[('const void*', 'func'), ('hipFuncCache_t', 'config')]
    ...
    case HIP_API_ID_hipFuncSetSharedMemConfig:
      break;
      // hipGLGetDevices[('unsigned int*', 'pHipDeviceCount'), ('int*', 'pHipDevices'), ('unsigned
      // int', 'hipDeviceCount'), ('hipGLDeviceList', 'deviceList')]
    case HIP_API_ID_hipGLGetDevices:
      ...
      if (data->args.hipGLGetDevices.pHipDevices)
        data->args.hipGLGetDevices.pHipDevices__val = *(data->args.hipGLGetDevices.pHipDevices);
      break;
      // hipGetChannelDesc[('hipChannelFormatDesc*', 'desc'), ('hipArray_const_t', 'array')]
    case HIP_API_ID_hipGetChannelDesc:
      if (data->args.hipGetChannelDesc.desc)
        data->args.hipGetChannelDesc.desc__val = *(data->args.hipGetChannelDesc.desc);
      break;
      // hipGetDevice[('int*', 'deviceId')]
    case HIP_API_ID_hipGetDevice:
      if (data->args.hipGetDevice.deviceId)
        data->args.hipGetDevice.deviceId__val = *(data->args.hipGetDevice.deviceId);
      break;
      // hipGetDeviceCount[('int*', 'count')]
    case HIP_API_ID_hipGetDeviceCount:
      if (data->args.hipGetDeviceCount.count)
        data->args.hipGetDeviceCount.count__val = *(data->args.hipGetDeviceCount.count);
      break;
      // hipGetDeviceFlags[('unsigned int*', 'flags')]
    case HIP_API_ID_hipGetDeviceFlags:
      if (data->args.hipGetDeviceFlags.flags)
        data->args.hipGetDeviceFlags.flags__val = *(data->args.hipGetDeviceFlags.flags);
      break;
      // hipGetDevicePropertiesR0000[('hipDeviceProp_tR0000*', 'prop'), ('int', 'device')]
    case HIP_API_ID_hipGetDevicePropertiesR0000:
    ...
    case HIP_API_ID_hipGetDevicePropertiesR0600:
      ...
      break;
      // hipGetDriverEntryPoint[('const char*', 'symbol'), ('void**', 'funcPtr'), ('unsigned long
      // long', 'flags'), ('hipDriverEntryPointQueryResult*', 'driverStatus')]
    case HIP_API_ID_hipGetDriverEntryPoint:
      if (data->args.hipGetDriverEntryPoint.symbol)
        data->args.hipGetDriverEntryPoint.symbol__val = *(data->args.hipGetDriverEntryPoint.symbol);
    ...
    case HIP_API_ID_hipGetProcAddress:
      if (data->args.hipGetProcAddress.symbol)
        data->args.hipGetProcAddress.symbol__val = *(data->args.hipGetProcAddress.symbol);
      if (data->args.hipGetProcAddress.pfn)
        data->args.hipGetProcAddress.pfn__val = *(data->args.hipGetProcAddress.pfn);
    ...
    case HIP_API_ID_hipGetSymbolAddress:
      if (data->args.hipGetSymbolAddress.devPtr)
        data->args.hipGetSymbolAddress.devPtr__val = *(data->args.hipGetSymbolAddress.devPtr);
      break;
      // hipGetSymbolSize[('size_t*', 'size'), ('const void*', 'symbol')]
    case HIP_API_ID_hipGetSymbolSize:
      if (data->args.hipGetSymbolSize.size)
        data->args.hipGetSymbolSize.size__val = *(data->args.hipGetSymbolSize.size);
      break;
    ...
    case HIP_API_ID_hipGraphAddBatchMemOpNode:
      ...
      // ('const hipGraphNode_t*', 'pDependencies'), ('size_t', 'numDependencies'), ('hipGraph_t',
      // 'childGraph')]
    case HIP_API_ID_hipGraphAddChildGraphNode:
    ...
    case HIP_API_ID_hipGraphAddDependencies:
      if (data->args.hipGraphAddDependencies.from)
        data->args.hipGraphAddDependencies.from__val = *(data->args.hipGraphAddDependencies.from);
      if (data->args.hipGraphAddDependencies.to)
        data->args.hipGraphAddDependencies.to__val = *(data->args.hipGraphAddDependencies.to);
      break;
      // hipGraphAddEmptyNode[('hipGraphNode_t*', 'pGraphNode'), ('hipGraph_t', 'graph'), ('const
      // hipGraphNode_t*', 'pDependencies'), ('size_t', 'numDependencies')]
    case HIP_API_ID_hipGraphAddEmptyNode:
      ...
      // ('const hipGraphNode_t*', 'pDependencies'), ('size_t', 'numDependencies'), ('hipEvent_t',
      // 'event')]
    case HIP_API_ID_hipGraphAddEventRecordNode:
    ...
    case HIP_API_ID_hipGraphAddEventWaitNode:
      ...
      break;
      // hipGraphAddExternalSemaphoresSignalNode[('hipGraphNode_t*', 'pGraphNode'), ('hipGraph_t',
      // 'graph'), ('const hipGraphNode_t*', 'pDependencies'), ('size_t', 'numDependencies'),
      // ('const hipExternalSemaphoreSignalNodeParams*', 'nodeParams')]
    case HIP_API_ID_hipGraphAddExternalSemaphoresSignalNode:
      ...
      break;
      // hipGraphAddExternalSemaphoresWaitNode[('hipGraphNode_t*', 'pGraphNode'), ('hipGraph_t',
      // 'graph'), ('const hipGraphNode_t*', 'pDependencies'), ('size_t', 'numDependencies'),
      // ('const hipExternalSemaphoreWaitNodeParams*', 'nodeParams')]
    case HIP_API_ID_hipGraphAddExternalSemaphoresWaitNode:
    ...
    case HIP_API_ID_hipGraphAddMemcpyNode:
      ...
      break;
      // hipGraphAddMemcpyNode1D[('hipGraphNode_t*', 'pGraphNode'), ('hipGraph_t', 'graph'), ('const
      // hipGraphNode_t*', 'pDependencies'), ('size_t', 'numDependencies'), ('void*', 'dst'),
    ...
    case HIP_API_ID_hipGraphAddMemcpyNode1D:
      ...
      break;
      // hipGraphAddMemcpyNodeFromSymbol[('hipGraphNode_t*', 'pGraphNode'), ('hipGraph_t', 'graph'),
      // ('const hipGraphNode_t*', 'pDependencies'), ('size_t', 'numDependencies'), ('void*',
    ...
    case HIP_API_ID_hipGraphAddMemcpyNodeFromSymbol:
      ...
      // ('const hipGraphNode_t*', 'pDependencies'), ('size_t', 'numDependencies'), ('const void*',
    ...
    case HIP_API_ID_hipGraphAddNode:
      if (data->args.hipGraphAddNode.pGraphNode)
        data->args.hipGraphAddNode.pGraphNode__val = *(data->args.hipGraphAddNode.pGraphNode);
      if (data->args.hipGraphAddNode.pDependencies)
        data->args.hipGraphAddNode.pDependencies__val = *(data->args.hipGraphAddNode.pDependencies);
      if (data->args.hipGraphAddNode.nodeParams)
        data->args.hipGraphAddNode.nodeParams__val = *(data->args.hipGraphAddNode.nodeParams);
      break;
      // hipGraphBatchMemOpNodeGetParams[('hipGraphNode_t', 'hNode'), ('hipBatchMemOpNodeParams*',
      // 'nodeParams_out')]
    case HIP_API_ID_hipGraphBatchMemOpNodeGetParams:
    ...
    case HIP_API_ID_hipGraphClone:
      if (data->args.hipGraphClone.pGraphClone)
        data->args.hipGraphClone.pGraphClone__val = *(data->args.hipGraphClone.pGraphClone);
      break;
      // hipGraphCreate[('hipGraph_t*', 'pGraph'), ('unsigned int', 'flags')]
    case HIP_API_ID_hipGraphCreate:
      if (data->args.hipGraphCreate.pGraph)
        data->args.hipGraphCreate.pGraph__val = *(data->args.hipGraphCreate.pGraph);
      break;
      // hipGraphDebugDotPrint[('hipGraph_t', 'graph'), ('const char*', 'path'), ('unsigned int',
      // 'flags')]
    case HIP_API_ID_hipGraphDebugDotPrint:
      if (data->args.hipGraphDebugDotPrint.path)
        data->args.hipGraphDebugDotPrint.path__val = *(data->args.hipGraphDebugDotPrint.path);
      break;
      // hipGraphDestroy[('hipGraph_t', 'graph')]
    case HIP_API_ID_hipGraphDestroy:
      break;
    ...
    case HIP_API_ID_hipGraphExecBatchMemOpNodeSetParams:
      ...
      break;
      // hipGraphExecChildGraphNodeSetParams[('hipGraphExec_t', 'hGraphExec'), ('hipGraphNode_t',
      // 'node'), ('hipGraph_t', 'childGraph')]
    case HIP_API_ID_hipGraphExecChildGraphNodeSetParams:
      break;
      // hipGraphExecDestroy[('hipGraphExec_t', 'graphExec')]
    case HIP_API_ID_hipGraphExecDestroy:
    ...
    case HIP_API_ID_hipGraphExecEventRecordNodeSetEvent:
      break;
      // hipGraphExecEventWaitNodeSetEvent[('hipGraphExec_t', 'hGraphExec'), ('hipGraphNode_t',
      // 'hNode'), ('hipEvent_t', 'event')]
    case HIP_API_ID_hipGraphExecEventWaitNodeSetEvent:
      break;
      // hipGraphExecExternalSemaphoresSignalNodeSetParams[('hipGraphExec_t', 'hGraphExec'),
    ...
    case HIP_API_ID_hipGraphExecExternalSemaphoresSignalNodeSetParams:
      if (data->args.hipGraphExecExternalSemaphoresSignalNodeSetParams.nodeParams)
        data->args.hipGraphExecExternalSemaphoresSignalNodeSetParams.nodeParams__val =
            *(data->args.hipGraphExecExternalSemaphoresSignalNodeSetParams.nodeParams);
      break;
      // hipGraphExecExternalSemaphoresWaitNodeSetParams[('hipGraphExec_t', 'hGraphExec'),
      // ('hipGraphNode_t', 'hNode'), ('const hipExternalSemaphoreWaitNodeParams*', 'nodeParams')]
    case HIP_API_ID_hipGraphExecExternalSemaphoresWaitNodeSetParams:
      if (data->args.hipGraphExecExternalSemaphoresWaitNodeSetParams.nodeParams)
        data->args.hipGraphExecExternalSemaphoresWaitNodeSetParams.nodeParams__val =
            *(data->args.hipGraphExecExternalSemaphoresWaitNodeSetParams.nodeParams);
      break;
      // hipGraphExecGetFlags[('hipGraphExec_t', 'graphExec'), ('unsigned long long*', 'flags')]
    case HIP_API_ID_hipGraphExecGetFlags:
    ...
    case HIP_API_ID_hipGraphExecHostNodeSetParams:
      ...
      break;
      // hipGraphExecKernelNodeSetParams[('hipGraphExec_t', 'hGraphExec'), ('hipGraphNode_t',
      // 'node'), ('const hipKernelNodeParams*', 'pNodeParams')]
    case HIP_API_ID_hipGraphExecKernelNodeSetParams:
      ...
      break;
      // hipGraphExecMemcpyNodeSetParams[('hipGraphExec_t', 'hGraphExec'), ('hipGraphNode_t',
      // 'node'), ('hipMemcpy3DParms*', 'pNodeParams')]
    case HIP_API_ID_hipGraphExecMemcpyNodeSetParams:
      ...
      break;
      // hipGraphExecMemcpyNodeSetParams1D[('hipGraphExec_t', 'hGraphExec'), ('hipGraphNode_t',
      // 'node'), ('void*', 'dst'), ('const void*', 'src'), ('size_t', 'count'), ('hipMemcpyKind',
      // 'kind')]
    case HIP_API_ID_hipGraphExecMemcpyNodeSetParams1D:
      break;
      // hipGraphExecMemcpyNodeSetParamsFromSymbol[('hipGraphExec_t', 'hGraphExec'),
      // ('hipGraphNode_t', 'node'), ('void*', 'dst'), ('const void*', 'symbol'), ('size_t',
      // 'count'), ('size_t', 'offset'), ('hipMemcpyKind', 'kind')]
    case HIP_API_ID_hipGraphExecMemcpyNodeSetParamsFromSymbol:
      break;
      // hipGraphExecMemcpyNodeSetParamsToSymbol[('hipGraphExec_t', 'hGraphExec'),
      // ('hipGraphNode_t', 'node'), ('const void*', 'symbol'), ('const void*', 'src'), ('size_t',
      // 'count'), ('size_t', 'offset'), ('hipMemcpyKind', 'kind')]
    case HIP_API_ID_hipGraphExecMemcpyNodeSetParamsToSymbol:
      break;
      // hipGraphExecMemsetNodeSetParams[('hipGraphExec_t', 'hGraphExec'), ('hipGraphNode_t',
      // 'node'), ('const hipMemsetParams*', 'pNodeParams')]
    case HIP_API_ID_hipGraphExecMemsetNodeSetParams:
    ...
    case HIP_API_ID_hipGraphExternalSemaphoresSignalNodeGetParams:
      if (data->args.hipGraphExternalSemaphoresSignalNodeGetParams.params_out)
        data->args.hipGraphExternalSemaphoresSignalNodeGetParams.params_out__val =
            *(data->args.hipGraphExternalSemaphoresSignalNodeGetParams.params_out);
      break;
      // hipGraphExternalSemaphoresSignalNodeSetParams[('hipGraphNode_t', 'hNode'), ('const
      // hipExternalSemaphoreSignalNodeParams*', 'nodeParams')]
    case HIP_API_ID_hipGraphExternalSemaphoresSignalNodeSetParams:
      if (data->args.hipGraphExternalSemaphoresSignalNodeSetParams.nodeParams)
        data->args.hipGraphExternalSemaphoresSignalNodeSetParams.nodeParams__val =
            *(data->args.hipGraphExternalSemaphoresSignalNodeSetParams.nodeParams);
      break;
      // hipGraphExternalSemaphoresWaitNodeGetParams[('hipGraphNode_t', 'hNode'),
      // ('hipExternalSemaphoreWaitNodeParams*', 'params_out')]
    case HIP_API_ID_hipGraphExternalSemaphoresWaitNodeGetParams:
    ...
    case HIP_API_ID_hipGraphExternalSemaphoresWaitNodeSetParams:
      ...
      break;
      // hipGraphGetEdges[('hipGraph_t', 'graph'), ('hipGraphNode_t*', 'from'), ('hipGraphNode_t*',
      // 'to'), ('size_t*', 'numEdges')]
    case HIP_API_ID_hipGraphGetEdges:
      ...
      if (data->args.hipGraphGetEdges.numEdges)
        data->args.hipGraphGetEdges.numEdges__val = *(data->args.hipGraphGetEdges.numEdges);
      break;
      // hipGraphGetNodes[('hipGraph_t', 'graph'), ('hipGraphNode_t*', 'nodes'), ('size_t*',
      // 'numNodes')]
    case HIP_API_ID_hipGraphGetNodes:
      if (data->args.hipGraphGetNodes.nodes)
        data->args.hipGraphGetNodes.nodes__val = *(data->args.hipGraphGetNodes.nodes);
      if (data->args.hipGraphGetNodes.numNodes)
        data->args.hipGraphGetNodes.numNodes__val = *(data->args.hipGraphGetNodes.numNodes);
      break;
      // hipGraphGetRootNodes[('hipGraph_t', 'graph'), ('hipGraphNode_t*', 'pRootNodes'),
      // ('size_t*', 'pNumRootNodes')]
    case HIP_API_ID_hipGraphGetRootNodes:
    ...
    case HIP_API_ID_hipGraphKernelNodeCopyAttributes:
      break;
      // hipGraphKernelNodeGetAttribute[('hipGraphNode_t', 'hNode'), ('hipLaunchAttributeID',
      // 'attr'), ('hipLaunchAttributeValue*', 'value')]
    case HIP_API_ID_hipGraphKernelNodeGetAttribute:
      ...
      break;
      // hipGraphKernelNodeGetParams[('hipGraphNode_t', 'node'), ('hipKernelNodeParams*',
      // 'pNodeParams')]
    case HIP_API_ID_hipGraphKernelNodeGetParams:
      ...
      break;
      // hipGraphKernelNodeSetAttribute[('hipGraphNode_t', 'hNode'), ('hipLaunchAttributeID',
    ...
    case HIP_API_ID_hipGraphMemcpyNodeSetParamsFromSymbol:
      break;
      // hipGraphMemcpyNodeSetParamsToSymbol[('hipGraphNode_t', 'node'), ('const void*', 'symbol'),
      // ('const void*', 'src'), ('size_t', 'count'), ('size_t', 'offset'), ('hipMemcpyKind',
      // 'kind')]
    case HIP_API_ID_hipGraphMemcpyNodeSetParamsToSymbol:
      break;
    ...
    case HIP_API_ID_hipGraphNodeFindInClone:
      if (data->args.hipGraphNodeFindInClone.pNode)
        data->args.hipGraphNodeFindInClone.pNode__val = *(data->args.hipGraphNodeFindInClone.pNode);
      break;
    ...
    case HIP_API_ID_hipGraphNodeGetDependentNodes:
      ...
      break;
      // hipGraphNodeGetEnabled[('hipGraphExec_t', 'hGraphExec'), ('hipGraphNode_t', 'hNode'),
      // ('unsigned int*', 'isEnabled')]
    case HIP_API_ID_hipGraphNodeGetEnabled:
    ...
    case HIP_API_ID_hipGraphNodeGetType:
      if (data->args.hipGraphNodeGetType.pType)
        data->args.hipGraphNodeGetType.pType__val = *(data->args.hipGraphNodeGetType.pType);
      break;
      // hipGraphNodeSetEnabled[('hipGraphExec_t', 'hGraphExec'), ('hipGraphNode_t', 'hNode'),
      // ('unsigned int', 'isEnabled')]
    case HIP_API_ID_hipGraphNodeSetEnabled:
      break;
      // hipGraphNodeSetParams[('hipGraphNode_t', 'node'), ('hipGraphNodeParams*', 'nodeParams')]
    ...
    case HIP_API_ID_hipGraphReleaseUserObject:
      break;
      // hipGraphRemoveDependencies[('hipGraph_t', 'graph'), ('const hipGraphNode_t*', 'from'),
    ...
    case HIP_API_ID_hipGraphRemoveDependencies:
      ...
      if (data->args.hipGraphRemoveDependencies.to)
        data->args.hipGraphRemoveDependencies.to__val = *(data->args.hipGraphRemoveDependencies.to);
      break;
      // hipGraphRetainUserObject[('hipGraph_t', 'graph'), ('hipUserObject_t', 'object'), ('unsigned
    ...
    case HIP_API_ID_hipGraphicsUnregisterResource:
      break;
      // hipHccModuleLaunchKernel[('hipFunction_t', 'f'), ('unsigned int', 'globalWorkSizeX'),
      // ('unsigned int', 'globalWorkSizeY'), ('unsigned int', 'globalWorkSizeZ'), ('unsigned int',
      // 'blockDimX'), ('unsigned int', 'blockDimY'), ('unsigned int', 'blockDimZ'), ('size_t',
      // 'sharedMemBytes'), ('hipStream_t', 'hStream'), ('void**', 'kernelParams'), ('void**',
      // 'extra'), ('hipEvent_t', 'startEvent'), ('hipEvent_t', 'stopEvent')]
    case HIP_API_ID_hipHccModuleLaunchKernel:
    ...
    case HIP_API_ID_hipHostFree:
      break;
      // hipHostGetDevicePointer[('void**', 'devPtr'), ('void*', 'hstPtr'), ('unsigned int',
      // 'flags')]
    case HIP_API_ID_hipHostGetDevicePointer:
    ...
    case HIP_API_ID_hipHostGetFlags:
      if (data->args.hipHostGetFlags.flagsPtr)
        data->args.hipHostGetFlags.flagsPtr__val = *(data->args.hipHostGetFlags.flagsPtr);
      break;
      // hipHostMalloc[('void**', 'ptr'), ('size_t', 'size'), ('unsigned int', 'flags')]
    case HIP_API_ID_hipHostMalloc:
    ...
    case HIP_API_ID_hipIpcGetEventHandle:
      if (data->args.hipIpcGetEventHandle.handle)
        data->args.hipIpcGetEventHandle.handle__val = *(data->args.hipIpcGetEventHandle.handle);
      break;
      // hipIpcGetMemHandle[('hipIpcMemHandle_t*', 'handle'), ('void*', 'devPtr')]
    case HIP_API_ID_hipIpcGetMemHandle:
      if (data->args.hipIpcGetMemHandle.handle)
        data->args.hipIpcGetMemHandle.handle__val = *(data->args.hipIpcGetMemHandle.handle);
      break;
      // hipIpcOpenEventHandle[('hipEvent_t*', 'event'), ('hipIpcEventHandle_t', 'handle')]
    case HIP_API_ID_hipIpcOpenEventHandle:
      if (data->args.hipIpcOpenEventHandle.event)
        data->args.hipIpcOpenEventHandle.event__val = *(data->args.hipIpcOpenEventHandle.event);
      break;
      // hipIpcOpenMemHandle[('void**', 'devPtr'), ('hipIpcMemHandle_t', 'handle'), ('unsigned int',
      // 'flags')]
    case HIP_API_ID_hipIpcOpenMemHandle:
      if (data->args.hipIpcOpenMemHandle.devPtr)
        data->args.hipIpcOpenMemHandle.devPtr__val = *(data->args.hipIpcOpenMemHandle.devPtr);
      break;
      // hipLaunchByPtr[('const void*', 'hostFunction')]
    case HIP_API_ID_hipLaunchByPtr:
      break;
      // hipLaunchCooperativeKernel[('const void*', 'f'), ('dim3', 'gridDim'), ('dim3',
      // 'blockDimX'), ('void**', 'kernelParams'), ('unsigned int', 'sharedMemBytes'),
      // ('hipStream_t', 'stream')]
    case HIP_API_ID_hipLaunchCooperativeKernel:
    ...
    case HIP_API_ID_hipLaunchKernel:
      ...
      break;
      // hipLaunchKernelExC[('const hipLaunchConfig_t*', 'config'), ('const void*', 'fPtr'),
      // ('void**', 'args')]
    case HIP_API_ID_hipLaunchKernelExC:
      if (data->args.hipLaunchKernelExC.config)
        data->args.hipLaunchKernelExC.config__val = *(data->args.hipLaunchKernelExC.config);
      if (data->args.hipLaunchKernelExC.args)
        data->args.hipLaunchKernelExC.args__val = *(data->args.hipLaunchKernelExC.args);
      break;
      // hipLinkAddData[('hipLinkState_t', 'state'), ('hipJitInputType', 'type'), ('void*', 'data'),
    ...
    case HIP_API_ID_hipLinkAddData:
      ...
      if (data->args.hipLinkAddData.optionValues)
        data->args.hipLinkAddData.optionValues__val = *(data->args.hipLinkAddData.optionValues);
      break;
      // hipLinkAddFile[('hipLinkState_t', 'state'), ('hipJitInputType', 'type'), ('const char*',
      // 'path'), ('unsigned int', 'numOptions'), ('hipJitOption*', 'options'), ('void**',
      // 'optionValues')]
    case HIP_API_ID_hipLinkAddFile:
      ...
      if (data->args.hipLinkAddFile.options)
        data->args.hipLinkAddFile.options__val = *(data->args.hipLinkAddFile.options);
      if (data->args.hipLinkAddFile.optionValues)
        data->args.hipLinkAddFile.optionValues__val = *(data->args.hipLinkAddFile.optionValues);
      break;
      // hipLinkComplete[('hipLinkState_t', 'state'), ('void**', 'hipBinOut'), ('size_t*',
      // 'sizeOut')]
    case HIP_API_ID_hipLinkComplete:
      if (data->args.hipLinkComplete.hipBinOut)
        data->args.hipLinkComplete.hipBinOut__val = *(data->args.hipLinkComplete.hipBinOut);
      if (data->args.hipLinkComplete.sizeOut)
        data->args.hipLinkComplete.sizeOut__val = *(data->args.hipLinkComplete.sizeOut);
      break;
      // hipLinkCreate[('unsigned int', 'numOptions'), ('hipJitOption*', 'options'), ('void**',
      // 'optionValues'), ('hipLinkState_t*', 'stateOut')]
    case HIP_API_ID_hipLinkCreate:
      if (data->args.hipLinkCreate.options)
        data->args.hipLinkCreate.options__val = *(data->args.hipLinkCreate.options);
      if (data->args.hipLinkCreate.optionValues)
        data->args.hipLinkCreate.optionValues__val = *(data->args.hipLinkCreate.optionValues);
      if (data->args.hipLinkCreate.stateOut)
        data->args.hipLinkCreate.stateOut__val = *(data->args.hipLinkCreate.stateOut);
      break;
      // hipLinkDestroy[('hipLinkState_t', 'state')]
    case HIP_API_ID_hipLinkDestroy:
      break;
    ...
    case HIP_API_ID_hipMalloc3D:
      if (data->args.hipMalloc3D.pitchedDevPtr)
        data->args.hipMalloc3D.pitchedDevPtr__val = *(data->args.hipMalloc3D.pitchedDevPtr);
      break;
      // hipMalloc3DArray[('hipArray_t*', 'array'), ('const hipChannelFormatDesc*', 'desc'),
      // ('hipExtent', 'extent'), ('unsigned int', 'flags')]
    case HIP_API_ID_hipMalloc3DArray:
      if (data->args.hipMalloc3DArray.array)
        data->args.hipMalloc3DArray.array__val = *(data->args.hipMalloc3DArray.array);
      if (data->args.hipMalloc3DArray.desc)
        data->args.hipMalloc3DArray.desc__val = *(data->args.hipMalloc3DArray.desc);
      break;
    ...
    case HIP_API_ID_hipMallocAsync:
      if (data->args.hipMallocAsync.dev_ptr)
        data->args.hipMallocAsync.dev_ptr__val = *(data->args.hipMallocAsync.dev_ptr);
      break;
      // hipMallocFromPoolAsync[('void**', 'dev_ptr'), ('size_t', 'size'), ('hipMemPool_t',
      // 'mem_pool'), ('hipStream_t', 'stream')]
    case HIP_API_ID_hipMallocFromPoolAsync:
    ...
    case HIP_API_ID_hipMallocManaged:
      if (data->args.hipMallocManaged.dev_ptr)
        data->args.hipMallocManaged.dev_ptr__val = *(data->args.hipMallocManaged.dev_ptr);
      break;
      // hipMallocMipmappedArray[('hipMipmappedArray_t*', 'mipmappedArray'), ('const
      // hipChannelFormatDesc*', 'desc'), ('hipExtent', 'extent'), ('unsigned int', 'numLevels'),
      // ('unsigned int', 'flags')]
    case HIP_API_ID_hipMallocMipmappedArray:
      ...
      if (data->args.hipMallocMipmappedArray.desc)
        data->args.hipMallocMipmappedArray.desc__val = *(data->args.hipMallocMipmappedArray.desc);
      break;
      // hipMallocPitch[('void**', 'ptr'), ('size_t*', 'pitch'), ('size_t', 'width'), ('size_t',
      // 'height')]
    case HIP_API_ID_hipMallocPitch:
    ...
    case HIP_API_ID_hipMemAddressReserve:
      if (data->args.hipMemAddressReserve.ptr)
        data->args.hipMemAddressReserve.ptr__val = *(data->args.hipMemAddressReserve.ptr);
      break;
      // hipMemAdvise[('const void*', 'dev_ptr'), ('size_t', 'count'), ('hipMemoryAdvise',
      // 'advice'), ('int', 'device')]
    case HIP_API_ID_hipMemAdvise:
      break;
      // hipMemAdvise_v2[('const void*', 'dev_ptr'), ('size_t', 'count'), ('hipMemoryAdvise',
      // 'advice'), ('hipMemLocation', 'location')]
    case HIP_API_ID_hipMemAdvise_v2:
      break;
      // hipMemAllocHost[('void**', 'ptr'), ('size_t', 'size')]
    case HIP_API_ID_hipMemAllocHost:
    ...
    case HIP_API_ID_hipMemAllocPitch:
      if (data->args.hipMemAllocPitch.dptr)
        data->args.hipMemAllocPitch.dptr__val = *(data->args.hipMemAllocPitch.dptr);
      if (data->args.hipMemAllocPitch.pitch)
        data->args.hipMemAllocPitch.pitch__val = *(data->args.hipMemAllocPitch.pitch);
      break;
      // hipMemCreate[('hipMemGenericAllocationHandle_t*', 'handle'), ('size_t', 'size'), ('const
      // hipMemAllocationProp*', 'prop'), ('unsigned long long', 'flags')]
    case HIP_API_ID_hipMemCreate:
    ...
    case HIP_API_ID_hipMemGetAccess:
      if (data->args.hipMemGetAccess.flags)
        data->args.hipMemGetAccess.flags__val = *(data->args.hipMemGetAccess.flags);
      if (data->args.hipMemGetAccess.location)
        data->args.hipMemGetAccess.location__val = *(data->args.hipMemGetAccess.location);
      break;
    ...
    case HIP_API_ID_hipMemGetAddressRange:
      ...
      if (data->args.hipMemGetAddressRange.psize)
        data->args.hipMemGetAddressRange.psize__val = *(data->args.hipMemGetAddressRange.psize);
      break;
      // hipMemGetAllocationGranularity[('size_t*', 'granularity'), ('const hipMemAllocationProp*',
      // 'prop'), ('hipMemAllocationGranularity_flags', 'option')]
    case HIP_API_ID_hipMemGetAllocationGranularity:
    ...
    case HIP_API_ID_hipMemPoolCreate:
      if (data->args.hipMemPoolCreate.mem_pool)
        data->args.hipMemPoolCreate.mem_pool__val = *(data->args.hipMemPoolCreate.mem_pool);
      if (data->args.hipMemPoolCreate.pool_props)
        data->args.hipMemPoolCreate.pool_props__val = *(data->args.hipMemPoolCreate.pool_props);
      break;
      // hipMemPoolDestroy[('hipMemPool_t', 'mem_pool')]
    case HIP_API_ID_hipMemPoolDestroy:
      break;
    ...
    case HIP_API_ID_hipMemPoolGetAccess:
      if (data->args.hipMemPoolGetAccess.flags)
        data->args.hipMemPoolGetAccess.flags__val = *(data->args.hipMemPoolGetAccess.flags);
      if (data->args.hipMemPoolGetAccess.location)
        data->args.hipMemPoolGetAccess.location__val = *(data->args.hipMemPoolGetAccess.location);
      break;
      // hipMemPoolGetAttribute[('hipMemPool_t', 'mem_pool'), ('hipMemPoolAttr', 'attr'), ('void*',
      // 'value')]
    case HIP_API_ID_hipMemPoolGetAttribute:
      ...
      // 'shared_handle'), ('hipMemAllocationHandleType', 'handle_type'), ('unsigned int', 'flags')]
    case HIP_API_ID_hipMemPoolImportFromShareableHandle:
    ...
    case HIP_API_ID_hipMemPoolSetAccess:
      if (data->args.hipMemPoolSetAccess.desc_list)
        data->args.hipMemPoolSetAccess.desc_list__val = *(data->args.hipMemPoolSetAccess.desc_list);
      break;
      // hipMemPoolSetAttribute[('hipMemPool_t', 'mem_pool'), ('hipMemPoolAttr', 'attr'), ('void*',
      // 'value')]
    case HIP_API_ID_hipMemPoolSetAttribute:
    ...
    case HIP_API_ID_hipMemPtrGetInfo:
      if (data->args.hipMemPtrGetInfo.size)
        data->args.hipMemPtrGetInfo.size__val = *(data->args.hipMemPtrGetInfo.size);
      break;
    ...
    case HIP_API_ID_hipMemRangeGetAttribute:
      ...
      // ('hipMemRangeAttribute*', 'attributes'), ('size_t', 'num_attributes'), ('const void*',
      // 'dev_ptr'), ('size_t', 'count')]
    case HIP_API_ID_hipMemRangeGetAttributes:
      if (data->args.hipMemRangeGetAttributes.data)
        data->args.hipMemRangeGetAttributes.data__val = *(data->args.hipMemRangeGetAttributes.data);
    ...
    case HIP_API_ID_hipMemRelease:
      break;
      // hipMemRetainAllocationHandle[('hipMemGenericAllocationHandle_t*', 'handle'), ('void*',
      // 'addr')]
    case HIP_API_ID_hipMemRetainAllocationHandle:
    ...
    case HIP_API_ID_hipMemcpy:
      break;
      // hipMemcpy2D[('void*', 'dst'), ('size_t', 'dpitch'), ('const void*', 'src'), ('size_t',
      // 'spitch'), ('size_t', 'width'), ('size_t', 'height'), ('hipMemcpyKind', 'kind')]
    case HIP_API_ID_hipMemcpy2D:
      break;
      // hipMemcpy2DArrayToArray[('hipArray_t', 'dst'), ('size_t', 'wOffsetDst'), ('size_t',
      // 'hOffsetDst'), ('hipArray_const_t', 'src'), ('size_t', 'wOffsetSrc'), ('size_t',
      // 'hOffsetSrc'), ('size_t', 'width'), ('size_t', 'height'), ('hipMemcpyKind', 'kind')]
    case HIP_API_ID_hipMemcpy2DArrayToArray:
      break;
      // hipMemcpy2DAsync[('void*', 'dst'), ('size_t', 'dpitch'), ('const void*', 'src'), ('size_t',
      // 'spitch'), ('size_t', 'width'), ('size_t', 'height'), ('hipMemcpyKind', 'kind'),
    ...
    case HIP_API_ID_hipMemcpy2DFromArray:
      break;
      // hipMemcpy2DFromArrayAsync[('void*', 'dst'), ('size_t', 'dpitch'), ('hipArray_const_t',
      // 'src'), ('size_t', 'wOffset'), ('size_t', 'hOffset'), ('size_t', 'width'), ('size_t',
      // 'height'), ('hipMemcpyKind', 'kind'), ('hipStream_t', 'stream')]
    case HIP_API_ID_hipMemcpy2DFromArrayAsync:
      break;
      // hipMemcpy2DToArray[('hipArray_t', 'dst'), ('size_t', 'wOffset'), ('size_t', 'hOffset'),
      // ('const void*', 'src'), ('size_t', 'spitch'), ('size_t', 'width'), ('size_t', 'height'),
      // ('hipMemcpyKind', 'kind')]
    case HIP_API_ID_hipMemcpy2DToArray:
      break;
      // hipMemcpy2DToArrayAsync[('hipArray_t', 'dst'), ('size_t', 'wOffset'), ('size_t',
      // 'hOffset'), ('const void*', 'src'), ('size_t', 'spitch'), ('size_t', 'width'), ('size_t',
      // 'height'), ('hipMemcpyKind', 'kind'), ('hipStream_t', 'stream')]
    case HIP_API_ID_hipMemcpy2DToArrayAsync:
      break;
      // hipMemcpy3D[('const hipMemcpy3DParms*', 'p')]
    ...
    case HIP_API_ID_hipMemcpy3DBatchAsync:
      if (data->args.hipMemcpy3DBatchAsync.opList)
        data->args.hipMemcpy3DBatchAsync.opList__val = *(data->args.hipMemcpy3DBatchAsync.opList);
      if (data->args.hipMemcpy3DBatchAsync.failIdx)
        data->args.hipMemcpy3DBatchAsync.failIdx__val = *(data->args.hipMemcpy3DBatchAsync.failIdx);
      break;
      // hipMemcpy3DPeer[('hipMemcpy3DPeerParms*', 'p')]
    case HIP_API_ID_hipMemcpy3DPeer:
    ...
    case HIP_API_ID_hipMemcpy3DPeerAsync:
      if (data->args.hipMemcpy3DPeerAsync.p)
        data->args.hipMemcpy3DPeerAsync.p__val = *(data->args.hipMemcpy3DPeerAsync.p);
      break;
      // hipMemcpyAsync[('void*', 'dst'), ('const void*', 'src'), ('size_t', 'sizeBytes'),
      // ('hipMemcpyKind', 'kind'), ('hipStream_t', 'stream')]
    case HIP_API_ID_hipMemcpyAsync:
      break;
      // hipMemcpyAtoA[('hipArray_t', 'dstArray'), ('size_t', 'dstOffset'), ('hipArray_t',
    ...
    case HIP_API_ID_hipMemcpyAtoD:
      break;
      // hipMemcpyAtoH[('void*', 'dst'), ('hipArray_t', 'srcArray'), ('size_t', 'srcOffset'),
      // ('size_t', 'count')]
    case HIP_API_ID_hipMemcpyAtoH:
      break;
      // hipMemcpyAtoHAsync[('void*', 'dstHost'), ('hipArray_t', 'srcArray'), ('size_t',
      // 'srcOffset'), ('size_t', 'ByteCount'), ('hipStream_t', 'stream')]
    case HIP_API_ID_hipMemcpyAtoHAsync:
      break;
      // hipMemcpyBatchAsync[('void**', 'dsts'), ('void**', 'srcs'), ('size_t*', 'sizes'),
      // ('size_t', 'count'), ('hipMemcpyAttributes*', 'attrs'), ('size_t*', 'attrsIdxs'),
      // ('size_t', 'numAttrs'), ('size_t*', 'failIdx'), ('hipStream_t', 'stream')]
    case HIP_API_ID_hipMemcpyBatchAsync:
      if (data->args.hipMemcpyBatchAsync.dsts)
        data->args.hipMemcpyBatchAsync.dsts__val = *(data->args.hipMemcpyBatchAsync.dsts);
      if (data->args.hipMemcpyBatchAsync.srcs)
        data->args.hipMemcpyBatchAsync.srcs__val = *(data->args.hipMemcpyBatchAsync.srcs);
      if (data->args.hipMemcpyBatchAsync.sizes)
        data->args.hipMemcpyBatchAsync.sizes__val = *(data->args.hipMemcpyBatchAsync.sizes);
      if (data->args.hipMemcpyBatchAsync.attrs)
        data->args.hipMemcpyBatchAsync.attrs__val = *(data->args.hipMemcpyBatchAsync.attrs);
      if (data->args.hipMemcpyBatchAsync.attrsIdxs)
        data->args.hipMemcpyBatchAsync.attrsIdxs__val = *(data->args.hipMemcpyBatchAsync.attrsIdxs);
      if (data->args.hipMemcpyBatchAsync.failIdx)
        data->args.hipMemcpyBatchAsync.failIdx__val = *(data->args.hipMemcpyBatchAsync.failIdx);
      break;
      // hipMemcpyDtoA[('hipArray_t', 'dstArray'), ('size_t', 'dstOffset'), ('hipDeviceptr_t',
      // 'srcDevice'), ('size_t', 'ByteCount')]
    case HIP_API_ID_hipMemcpyDtoA:
      break;
      // hipMemcpyDtoD[('hipDeviceptr_t', 'dst'), ('hipDeviceptr_t', 'src'), ('size_t',
      // 'sizeBytes')]
    case HIP_API_ID_hipMemcpyDtoD:
      break;
      // hipMemcpyDtoDAsync[('hipDeviceptr_t', 'dst'), ('hipDeviceptr_t', 'src'), ('size_t',
    ...
    case HIP_API_ID_hipMemcpyDtoHAsync:
      break;
      // hipMemcpyFromArray[('void*', 'dst'), ('hipArray_const_t', 'srcArray'), ('size_t',
      // 'wOffset'), ('size_t', 'hOffset'), ('size_t', 'count'), ('hipMemcpyKind', 'kind')]
    case HIP_API_ID_hipMemcpyFromArray:
      break;
      // hipMemcpyFromSymbol[('void*', 'dst'), ('const void*', 'symbol'), ('size_t', 'sizeBytes'),
      // ('size_t', 'offset'), ('hipMemcpyKind', 'kind')]
    case HIP_API_ID_hipMemcpyFromSymbol:
      break;
      // hipMemcpyFromSymbolAsync[('void*', 'dst'), ('const void*', 'symbol'), ('size_t',
      // 'sizeBytes'), ('size_t', 'offset'), ('hipMemcpyKind', 'kind'), ('hipStream_t', 'stream')]
    case HIP_API_ID_hipMemcpyFromSymbolAsync:
      break;
      // hipMemcpyHtoA[('hipArray_t', 'dstArray'), ('size_t', 'dstOffset'), ('const void*',
      // 'srcHost'), ('size_t', 'count')]
    case HIP_API_ID_hipMemcpyHtoA:
      break;
      // hipMemcpyHtoAAsync[('hipArray_t', 'dstArray'), ('size_t', 'dstOffset'), ('const void*',
      // 'srcHost'), ('size_t', 'ByteCount'), ('hipStream_t', 'stream')]
    ...
    case HIP_API_ID_hipMemcpyHtoD:
      break;
      // hipMemcpyHtoDAsync[('hipDeviceptr_t', 'dst'), ('const void*', 'src'), ('size_t',
      // 'sizeBytes'), ('hipStream_t', 'stream')]
    case HIP_API_ID_hipMemcpyHtoDAsync:
      break;
      // hipMemcpyParam2D[('const hip_Memcpy2D*', 'pCopy')]
    case HIP_API_ID_hipMemcpyParam2D:
      if (data->args.hipMemcpyParam2D.pCopy)
        data->args.hipMemcpyParam2D.pCopy__val = *(data->args.hipMemcpyParam2D.pCopy);
      break;
      // hipMemcpyParam2DAsync[('const hip_Memcpy2D*', 'pCopy'), ('hipStream_t', 'stream')]
    case HIP_API_ID_hipMemcpyParam2DAsync:
      if (data->args.hipMemcpyParam2DAsync.pCopy)
        data->args.hipMemcpyParam2DAsync.pCopy__val = *(data->args.hipMemcpyParam2DAsync.pCopy);
      break;
      // hipMemcpyPeer[('void*', 'dst'), ('int', 'dstDeviceId'), ('const void*', 'src'), ('int',
      // 'srcDeviceId'), ('size_t', 'sizeBytes')]
    case HIP_API_ID_hipMemcpyPeer:
    ...
    case HIP_API_ID_hipMemcpyToArray:
      break;
      // hipMemcpyToSymbol[('const void*', 'symbol'), ('const void*', 'src'), ('size_t',
    ...
    case HIP_API_ID_hipMemset2D:
      break;
      // hipMemset2DAsync[('void*', 'dst'), ('size_t', 'pitch'), ('int', 'value'), ('size_t',
      // 'width'), ('size_t', 'height'), ('hipStream_t', 'stream')]
    case HIP_API_ID_hipMemset2DAsync:
      break;
      // hipMemset3D[('hipPitchedPtr', 'pitchedDevPtr'), ('int', 'value'), ('hipExtent', 'extent')]
    case HIP_API_ID_hipMemset3D:
      break;
      // hipMemset3DAsync[('hipPitchedPtr', 'pitchedDevPtr'), ('int', 'value'), ('hipExtent',
      // 'extent'), ('hipStream_t', 'stream')]
    case HIP_API_ID_hipMemset3DAsync:
      break;
      // hipMemsetAsync[('void*', 'dst'), ('int', 'value'), ('size_t', 'sizeBytes'), ('hipStream_t',
      // 'stream')]
    ...
    case HIP_API_ID_hipMemsetD16:
      break;
      // hipMemsetD16Async[('hipDeviceptr_t', 'dest'), ('unsigned short', 'value'), ('size_t',
      // 'count'), ('hipStream_t', 'stream')]
    case HIP_API_ID_hipMemsetD16Async:
      break;
      // hipMemsetD2D16[('hipDeviceptr_t', 'dst'), ('size_t', 'dstPitch'), ('unsigned short',
      // 'value'), ('size_t', 'width'), ('size_t', 'height')]
    case HIP_API_ID_hipMemsetD2D16:
      break;
      // hipMemsetD2D16Async[('hipDeviceptr_t', 'dst'), ('size_t', 'dstPitch'), ('unsigned short',
      // 'value'), ('size_t', 'width'), ('size_t', 'height'), ('hipStream_t', 'stream')]
    case HIP_API_ID_hipMemsetD2D16Async:
      break;
      // hipMemsetD2D32[('hipDeviceptr_t', 'dst'), ('size_t', 'dstPitch'), ('unsigned int',
      // 'value'), ('size_t', 'width'), ('size_t', 'height')]
    case HIP_API_ID_hipMemsetD2D32:
      break;
      // hipMemsetD2D32Async[('hipDeviceptr_t', 'dst'), ('size_t', 'dstPitch'), ('unsigned int',
      // 'value'), ('size_t', 'width'), ('size_t', 'height'), ('hipStream_t', 'stream')]
    case HIP_API_ID_hipMemsetD2D32Async:
      break;
      // hipMemsetD2D8[('hipDeviceptr_t', 'dst'), ('size_t', 'dstPitch'), ('unsigned char',
      // 'value'), ('size_t', 'width'), ('size_t', 'height')]
    case HIP_API_ID_hipMemsetD2D8:
      break;
      // hipMemsetD2D8Async[('hipDeviceptr_t', 'dst'), ('size_t', 'dstPitch'), ('unsigned char',
      // 'value'), ('size_t', 'width'), ('size_t', 'height'), ('hipStream_t', 'stream')]
    case HIP_API_ID_hipMemsetD2D8Async:
      break;
      // hipMemsetD32[('hipDeviceptr_t', 'dest'), ('int', 'value'), ('size_t', 'count')]
    ...
    case HIP_API_ID_hipMemsetD8:
      break;
      // hipMemsetD8Async[('hipDeviceptr_t', 'dest'), ('unsigned char', 'value'), ('size_t',
      // 'count'), ('hipStream_t', 'stream')]
    case HIP_API_ID_hipMemsetD8Async:
      break;
      // hipMipmappedArrayCreate[('hipMipmappedArray_t*', 'pHandle'), ('HIP_ARRAY3D_DESCRIPTOR*',
    ...
    case HIP_API_ID_hipMipmappedArrayGetLevel:
      ...
      break;
      // hipMipmappedArrayGetMemoryRequirements[('hipArrayMemoryRequirements*',
      // 'memoryRequirements'), ('hipMipmappedArray', 'mipmap'), ('hipDevice_t', 'device')]
    case HIP_API_ID_hipMipmappedArrayGetMemoryRequirements:
      if (data->args.hipMipmappedArrayGetMemoryRequirements.memoryRequirements)
        data->args.hipMipmappedArrayGetMemoryRequirements.memoryRequirements__val =
            *(data->args.hipMipmappedArrayGetMemoryRequirements.memoryRequirements);
      break;
      // hipModuleGetFunction[('hipFunction_t*', 'function'), ('hipModule_t', 'module'), ('const
      // char*', 'kname')]
    case HIP_API_ID_hipModuleGetFunction:
      if (data->args.hipModuleGetFunction.function)
        data->args.hipModuleGetFunction.function__val = *(data->args.hipModuleGetFunction.function);
      if (data->args.hipModuleGetFunction.kname)
        data->args.hipModuleGetFunction.kname__val = *(data->args.hipModuleGetFunction.kname);
      break;
      // hipModuleGetGlobal[('hipDeviceptr_t*', 'dptr'), ('size_t*', 'bytes'), ('hipModule_t',
      // 'hmod'), ('const char*', 'name')]
    case HIP_API_ID_hipModuleGetGlobal:
      if (data->args.hipModuleGetGlobal.dptr)
        data->args.hipModuleGetGlobal.dptr__val = *(data->args.hipModuleGetGlobal.dptr);
      if (data->args.hipModuleGetGlobal.bytes)
        data->args.hipModuleGetGlobal.bytes__val = *(data->args.hipModuleGetGlobal.bytes);
      if (data->args.hipModuleGetGlobal.name)
        data->args.hipModuleGetGlobal.name__val = *(data->args.hipModuleGetGlobal.name);
      break;
      // hipModuleGetTexRef[('textureReference**', 'texRef'), ('hipModule_t', 'hmod'), ('const
      // char*', 'name')]
    case HIP_API_ID_hipModuleGetTexRef:
      if (data->args.hipModuleGetTexRef.texRef)
        data->args.hipModuleGetTexRef.texRef__val = *(data->args.hipModuleGetTexRef.texRef);
      if (data->args.hipModuleGetTexRef.name)
        data->args.hipModuleGetTexRef.name__val = *(data->args.hipModuleGetTexRef.name);
      break;
      // hipModuleLaunchCooperativeKernel[('hipFunction_t', 'f'), ('unsigned int', 'gridDimX'),
      ...
      // 'sharedMemBytes'), ('hipStream_t', 'stream'), ('void**', 'kernelParams')]
    case HIP_API_ID_hipModuleLaunchCooperativeKernel:
    ...
    case HIP_API_ID_hipModuleLaunchCooperativeKernelMultiDevice:
      if (data->args.hipModuleLaunchCooperativeKernelMultiDevice.launchParamsList)
        data->args.hipModuleLaunchCooperativeKernelMultiDevice.launchParamsList__val =
      ...
      // int', 'gridDimY'), ('unsigned int', 'gridDimZ'), ('unsigned int', 'blockDimX'), ('unsigned
      // int', 'blockDimY'), ('unsigned int', 'blockDimZ'), ('unsigned int', 'sharedMemBytes'),
    ...
    case HIP_API_ID_hipModuleLaunchKernel:
      ...
      if (data->args.hipModuleLaunchKernel.extra)
        data->args.hipModuleLaunchKernel.extra__val = *(data->args.hipModuleLaunchKernel.extra);
      break;
      // hipModuleLoadFatBinary[('hipModule_t*', 'module'), ('const void*', 'fatbin')]
    case HIP_API_ID_hipModuleLoadFatBinary:
      if (data->args.hipModuleLoadFatBinary.module)
        data->args.hipModuleLoadFatBinary.module__val = *(data->args.hipModuleLoadFatBinary.module);
      break;
      // hipModuleLoad[('hipModule_t*', 'module'), ('const char*', 'fname')]
    case HIP_API_ID_hipModuleLoad:
    ...
    case HIP_API_ID_hipModuleLoadData:
      if (data->args.hipModuleLoadData.module)
        data->args.hipModuleLoadData.module__val = *(data->args.hipModuleLoadData.module);
      break;
      // hipModuleLoadDataEx[('hipModule_t*', 'module'), ('const void*', 'image'), ('unsigned int',
      // 'numOptions'), ('hipJitOption*', 'options'), ('void**', 'optionsValues')]
    case HIP_API_ID_hipModuleLoadDataEx:
      if (data->args.hipModuleLoadDataEx.module)
        data->args.hipModuleLoadDataEx.module__val = *(data->args.hipModuleLoadDataEx.module);
      if (data->args.hipModuleLoadDataEx.options)
        data->args.hipModuleLoadDataEx.options__val = *(data->args.hipModuleLoadDataEx.options);
      ...
      break;
      // hipModuleOccupancyMaxActiveBlocksPerMultiprocessor[('int*', 'numBlocks'), ('hipFunction_t',
      // 'f'), ('int', 'blockSize'), ('size_t', 'dynSharedMemPerBlk')]
    case HIP_API_ID_hipModuleOccupancyMaxActiveBlocksPerMultiprocessor:
      if (data->args.hipModuleOccupancyMaxActiveBlocksPerMultiprocessor.numBlocks)
        data->args.hipModuleOccupancyMaxActiveBlocksPerMultiprocessor.numBlocks__val =
            *(data->args.hipModuleOccupancyMaxActiveBlocksPerMultiprocessor.numBlocks);
      break;
      // hipModuleOccupancyMaxActiveBlocksPerMultiprocessorWithFlags[('int*', 'numBlocks'),
      // ('hipFunction_t', 'f'), ('int', 'blockSize'), ('size_t', 'dynSharedMemPerBlk'), ('unsigned
      // int', 'flags')]
    case HIP_API_ID_hipModuleOccupancyMaxActiveBlocksPerMultiprocessorWithFlags:
      if (data->args.hipModuleOccupancyMaxActiveBlocksPerMultiprocessorWithFlags.numBlocks)
        data->args.hipModuleOccupancyMaxActiveBlocksPerMultiprocessorWithFlags.numBlocks__val =
            *(data->args.hipModuleOccupancyMaxActiveBlocksPerMultiprocessorWithFlags.numBlocks);
      break;
      // hipModuleOccupancyMaxPotentialBlockSize[('int*', 'gridSize'), ('int*', 'blockSize'),
      // ('hipFunction_t', 'f'), ('size_t', 'dynSharedMemPerBlk'), ('int', 'blockSizeLimit')]
    case HIP_API_ID_hipModuleOccupancyMaxPotentialBlockSize:
      ...
      break;
      // hipModuleOccupancyMaxPotentialBlockSizeWithFlags[('int*', 'gridSize'), ('int*',
      // 'blockSize'), ('hipFunction_t', 'f'), ('size_t', 'dynSharedMemPerBlk'), ('int',
      // 'blockSizeLimit'), ('unsigned int', 'flags')]
    case HIP_API_ID_hipModuleOccupancyMaxPotentialBlockSizeWithFlags:
      if (data->args.hipModuleOccupancyMaxPotentialBlockSizeWithFlags.gridSize)
        data->args.hipModuleOccupancyMaxPotentialBlockSizeWithFlags.gridSize__val =
      ...
      if (data->args.hipModuleOccupancyMaxPotentialBlockSizeWithFlags.blockSize)
        data->args.hipModuleOccupancyMaxPotentialBlockSizeWithFlags.blockSize__val =
            *(data->args.hipModuleOccupancyMaxPotentialBlockSizeWithFlags.blockSize);
      break;
      // hipModuleUnload[('hipModule_t', 'module')]
    case HIP_API_ID_hipModuleUnload:
      break;
    ...
    case HIP_API_ID_hipOccupancyMaxActiveBlocksPerMultiprocessor:
      ...
      break;
      // hipOccupancyMaxActiveBlocksPerMultiprocessorWithFlags[('int*', 'numBlocks'), ('const
      // void*', 'f'), ('int', 'blockSize'), ('size_t', 'dynamicSMemSize'), ('unsigned int',
      // 'flags')]
    case HIP_API_ID_hipOccupancyMaxActiveBlocksPerMultiprocessorWithFlags:
      if (data->args.hipOccupancyMaxActiveBlocksPerMultiprocessorWithFlags.numBlocks)
        data->args.hipOccupancyMaxActiveBlocksPerMultiprocessorWithFlags.numBlocks__val =
            *(data->args.hipOccupancyMaxActiveBlocksPerMultiprocessorWithFlags.numBlocks);
      break;
      // hipOccupancyMaxPotentialBlockSize[('int*', 'gridSize'), ('int*', 'blockSize'), ('const
      // void*', 'f'), ('size_t', 'dynSharedMemPerBlk'), ('int', 'blockSizeLimit')]
    case HIP_API_ID_hipOccupancyMaxPotentialBlockSize:
    ...
    case HIP_API_ID_hipSetValidDevices:
      if (data->args.hipSetValidDevices.device_arr)
        data->args.hipSetValidDevices.device_arr__val = *(data->args.hipSetValidDevices.device_arr);
      break;
      // hipSetupArgument[('const void*', 'arg'), ('size_t', 'size'), ('size_t', 'offset')]
    case HIP_API_ID_hipSetupArgument:
      break;
    ...
    case HIP_API_ID_hipStreamAddCallback:
      break;
      // hipStreamAttachMemAsync[('hipStream_t', 'stream'), ('void*', 'dev_ptr'), ('size_t',
    ...
    case HIP_API_ID_hipStreamBeginCapture:
      break;
      // hipStreamBeginCaptureToGraph[('hipStream_t', 'stream'), ('hipGraph_t', 'graph'), ('const
      // hipGraphNode_t*', 'dependencies'), ('const hipGraphEdgeData*', 'dependencyData'),
    ...
    case HIP_API_ID_hipStreamCreate:
      if (data->args.hipStreamCreate.stream)
        data->args.hipStreamCreate.stream__val = *(data->args.hipStreamCreate.stream);
      break;
      // hipStreamCreateWithFlags[('hipStream_t*', 'stream'), ('unsigned int', 'flags')]
    case HIP_API_ID_hipStreamCreateWithFlags:
    ...
    case HIP_API_ID_hipStreamEndCapture:
      if (data->args.hipStreamEndCapture.pGraph)
        data->args.hipStreamEndCapture.pGraph__val = *(data->args.hipStreamEndCapture.pGraph);
      break;
      // hipStreamGetAttribute[('hipStream_t', 'stream'), ('hipLaunchAttributeID', 'attr'), ('const
      // hipLaunchAttributeValue*', 'value_out')]
    case HIP_API_ID_hipStreamGetAttribute:
    ...
    case HIP_API_ID_hipStreamGetCaptureInfo:
      ...
      if (data->args.hipStreamGetCaptureInfo.pId)
        data->args.hipStreamGetCaptureInfo.pId__val = *(data->args.hipStreamGetCaptureInfo.pId);
      break;
      // hipStreamGetCaptureInfo_v2[('hipStream_t', 'stream'), ('hipStreamCaptureStatus*',
    ...
    case HIP_API_ID_hipStreamGetDevice:
      if (data->args.hipStreamGetDevice.device)
        data->args.hipStreamGetDevice.device__val = *(data->args.hipStreamGetDevice.device);
      break;
      // hipStreamGetFlags[('hipStream_t', 'stream'), ('unsigned int*', 'flags')]
    case HIP_API_ID_hipStreamGetFlags:
      if (data->args.hipStreamGetFlags.flags)
        data->args.hipStreamGetFlags.flags__val = *(data->args.hipStreamGetFlags.flags);
      break;
      // hipStreamGetId[('hipStream_t', 'stream'), ('unsigned long long*', 'streamId')]
    case HIP_API_ID_hipStreamGetId:
      if (data->args.hipStreamGetId.streamId)
        data->args.hipStreamGetId.streamId__val = *(data->args.hipStreamGetId.streamId);
      break;
      // hipStreamGetPriority[('hipStream_t', 'stream'), ('int*', 'priority')]
    case HIP_API_ID_hipStreamGetPriority:
      if (data->args.hipStreamGetPriority.priority)
        data->args.hipStreamGetPriority.priority__val = *(data->args.hipStreamGetPriority.priority);
      break;
    ...
    case HIP_API_ID_hipStreamSetAttribute:
      if (data->args.hipStreamSetAttribute.value)
        data->args.hipStreamSetAttribute.value__val = *(data->args.hipStreamSetAttribute.value);
      break;
      // hipStreamSynchronize[('hipStream_t', 'stream')]
    case HIP_API_ID_hipStreamSynchronize:
      break;
    ...
    case HIP_API_ID_hipStreamUpdateCaptureDependencies:
      ...
      break;
      // hipStreamWaitEvent[('hipStream_t', 'stream'), ('hipEvent_t', 'event'), ('unsigned int',
      // 'flags')]
    case HIP_API_ID_hipStreamWaitEvent:
      break;
      // hipStreamWaitValue32[('hipStream_t', 'stream'), ('void*', 'ptr'), ('unsigned int',
      // 'value'), ('unsigned int', 'flags'), ('unsigned int', 'mask')]
    case HIP_API_ID_hipStreamWaitValue32:
      break;
      // hipStreamWaitValue64[('hipStream_t', 'stream'), ('void*', 'ptr'), ('uint64_t', 'value'),
      // ('unsigned int', 'flags'), ('uint64_t', 'mask')]
    case HIP_API_ID_hipStreamWaitValue64:
      break;
      // hipStreamWriteValue32[('hipStream_t', 'stream'), ('void*', 'ptr'), ('unsigned int',
    ...
    case HIP_API_ID_hipTexRefGetAddress:
      if (data->args.hipTexRefGetAddress.dev_ptr)
        data->args.hipTexRefGetAddress.dev_ptr__val = *(data->args.hipTexRefGetAddress.dev_ptr);
      if (data->args.hipTexRefGetAddress.texRef)
        data->args.hipTexRefGetAddress.texRef__val = *(data->args.hipTexRefGetAddress.texRef);
      break;
      // hipTexRefGetArray[('hipArray_t*', 'pArray'), ('const textureReference*', 'texRef')]
    case HIP_API_ID_hipTexRefGetArray:
      if (data->args.hipTexRefGetArray.pArray)
        data->args.hipTexRefGetArray.pArray__val = *(data->args.hipTexRefGetArray.pArray);
      if (data->args.hipTexRefGetArray.texRef)
        data->args.hipTexRefGetArray.texRef__val = *(data->args.hipTexRefGetArray.texRef);
      break;
      // hipTexRefGetBorderColor[('float*', 'pBorderColor'), ('const textureReference*', 'texRef')]
    case HIP_API_ID_hipTexRefGetBorderColor:
    ...
    case HIP_API_ID_hipTexRefGetFlags:
      if (data->args.hipTexRefGetFlags.pFlags)
        data->args.hipTexRefGetFlags.pFlags__val = *(data->args.hipTexRefGetFlags.pFlags);
      if (data->args.hipTexRefGetFlags.texRef)
        data->args.hipTexRefGetFlags.texRef__val = *(data->args.hipTexRefGetFlags.texRef);
      break;
      // hipTexRefGetFormat[('hipArray_Format*', 'pFormat'), ('int*', 'pNumChannels'), ('const
      // textureReference*', 'texRef')]
    case HIP_API_ID_hipTexRefGetFormat:
      if (data->args.hipTexRefGetFormat.pFormat)
        data->args.hipTexRefGetFormat.pFormat__val = *(data->args.hipTexRefGetFormat.pFormat);
      ...
      if (data->args.hipTexRefGetFormat.texRef)
        data->args.hipTexRefGetFormat.texRef__val = *(data->args.hipTexRefGetFormat.texRef);
      break;
      // hipTexRefGetMaxAnisotropy[('int*', 'pmaxAnsio'), ('const textureReference*', 'texRef')]
    case HIP_API_ID_hipTexRefGetMaxAnisotropy:
    ...
    case HIP_API_ID_hipTexRefSetAddress:
      ...
      if (data->args.hipTexRefSetAddress.texRef)
        data->args.hipTexRefSetAddress.texRef__val = *(data->args.hipTexRefSetAddress.texRef);
      break;
      // hipTexRefSetAddress2D[('textureReference*', 'texRef'), ('const HIP_ARRAY_DESCRIPTOR*',
      // 'desc'), ('hipDeviceptr_t', 'dptr'), ('size_t', 'Pitch')]
    case HIP_API_ID_hipTexRefSetAddress2D:
      if (data->args.hipTexRefSetAddress2D.texRef)
        data->args.hipTexRefSetAddress2D.texRef__val = *(data->args.hipTexRefSetAddress2D.texRef);
      if (data->args.hipTexRefSetAddress2D.desc)
        data->args.hipTexRefSetAddress2D.desc__val = *(data->args.hipTexRefSetAddress2D.desc);
      break;
      // hipTexRefSetArray[('textureReference*', 'tex'), ('hipArray_const_t', 'array'), ('unsigned
      // int', 'flags')]
    case HIP_API_ID_hipTexRefSetArray:
      if (data->args.hipTexRefSetArray.tex)
        data->args.hipTexRefSetArray.tex__val = *(data->args.hipTexRefSetArray.tex);
      break;
      // hipTexRefSetBorderColor[('textureReference*', 'texRef'), ('float*', 'pBorderColor')]
    case HIP_API_ID_hipTexRefSetBorderColor:
    ...
    case HIP_API_ID_hipTexRefSetFlags:
      if (data->args.hipTexRefSetFlags.texRef)
        data->args.hipTexRefSetFlags.texRef__val = *(data->args.hipTexRefSetFlags.texRef);
      break;
      // hipTexRefSetFormat[('textureReference*', 'texRef'), ('hipArray_Format', 'fmt'), ('int',
      // 'NumPackedComponents')]
    case HIP_API_ID_hipTexRefSetFormat:
      if (data->args.hipTexRefSetFormat.texRef)
        data->args.hipTexRefSetFormat.texRef__val = *(data->args.hipTexRefSetFormat.texRef);
      break;
      // hipTexRefSetMaxAnisotropy[('textureReference*', 'texRef'), ('unsigned int', 'maxAniso')]
    case HIP_API_ID_hipTexRefSetMaxAnisotropy:
    ...
    case HIP_API_ID_hipUserObjectRetain:
      break;
      // hipWaitExternalSemaphoresAsync[('const hipExternalSemaphore_t*', 'extSemArray'), ('const
      // hipExternalSemaphoreWaitParams*', 'paramsArray'), ('unsigned int', 'numExtSems'),
      // ('hipStream_t', 'stream')]
    case HIP_API_ID_hipWaitExternalSemaphoresAsync:
  ...
  switch (id) {
    ...
    case HIP_API_ID___hipPushCallConfiguration:
      ...
      roctracer::hip_support::detail::operator<<(oss,
                                                 data->args.__hipPushCallConfiguration.gridDim);
      oss << ", blockDim=";
      roctracer::hip_support::detail::operator<<(oss,
                                                 data->args.__hipPushCallConfiguration.blockDim);
      oss << ", sharedMem=";
      roctracer::hip_support::detail::operator<<(oss,
                                                 data->args.__hipPushCallConfiguration.sharedMem);
      oss << ", stream=";
      roctracer::hip_support::detail::operator<<(oss, data->args.__hipPushCallConfiguration.stream);
      oss << ")";
      break;
    case HIP_API_ID_hipArray3DCreate:
      ...
      if (data->args.hipArray3DCreate.array == NULL)
        ...
        oss << "array=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipArray3DCreate.array__val);
      }
    ...
    case HIP_API_ID_hipArray3DGetDescriptor:
      ...
      oss << ", array=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipArray3DGetDescriptor.array);
      oss << ")";
      break;
    case HIP_API_ID_hipArrayCreate:
      oss << "hipArrayCreate(";
      if (data->args.hipArrayCreate.pHandle == NULL)
        ...
        oss << "pHandle=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipArrayCreate.pHandle__val);
      }
    ...
    case HIP_API_ID_hipArrayDestroy:
      oss << "hipArrayDestroy(";
      oss << "array=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipArrayDestroy.array);
      oss << ")";
      break;
    case HIP_API_ID_hipArrayGetDescriptor:
      ...
      oss << ", array=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipArrayGetDescriptor.array);
      oss << ")";
      break;
    case HIP_API_ID_hipArrayGetInfo:
      oss << "hipArrayGetInfo(";
      if (data->args.hipArrayGetInfo.desc == NULL)
        ...
        oss << "desc=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipArrayGetInfo.desc__val);
      }
      if (data->args.hipArrayGetInfo.extent == NULL)
        oss << ", extent=NULL";
      else {
        oss << ", extent=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipArrayGetInfo.extent__val);
      }
      if (data->args.hipArrayGetInfo.flags == NULL)
        oss << ", flags=NULL";
      else {
        oss << ", flags=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipArrayGetInfo.flags__val);
      }
      oss << ", array=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipArrayGetInfo.array);
      oss << ")";
      break;
    case HIP_API_ID_hipChooseDeviceR0000:
      ...
      if (data->args.hipChooseDeviceR0000.prop == NULL)
        ...
        oss << ", prop=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipChooseDeviceR0000.prop__val);
      }
      oss << ")";
      break;
    case HIP_API_ID_hipChooseDeviceR0600:
      ...
      if (data->args.hipChooseDeviceR0600.prop == NULL)
        ...
        oss << ", prop=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipChooseDeviceR0600.prop__val);
      }
      oss << ")";
      break;
    case HIP_API_ID_hipConfigureCall:
      ...
      oss << "gridDim=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipConfigureCall.gridDim);
      oss << ", blockDim=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipConfigureCall.blockDim);
      oss << ", sharedMem=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipConfigureCall.sharedMem);
      oss << ", stream=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipConfigureCall.stream);
      oss << ")";
      break;
    case HIP_API_ID_hipCreateSurfaceObject:
    ...
    case HIP_API_ID_hipCtxCreate:
      ...
      if (data->args.hipCtxCreate.ctx == NULL)
        ...
        oss << "ctx=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipCtxCreate.ctx__val);
      }
      oss << ", flags=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipCtxCreate.flags);
      oss << ", device=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipCtxCreate.device);
      oss << ")";
      break;
    case HIP_API_ID_hipCtxDestroy:
      oss << "hipCtxDestroy(";
      oss << "ctx=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipCtxDestroy.ctx);
      oss << ")";
      break;
    case HIP_API_ID_hipCtxDisablePeerAccess:
      oss << "hipCtxDisablePeerAccess(";
      oss << "peerCtx=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipCtxDisablePeerAccess.peerCtx);
      oss << ")";
      break;
    case HIP_API_ID_hipCtxEnablePeerAccess:
      oss << "hipCtxEnablePeerAccess(";
      oss << "peerCtx=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipCtxEnablePeerAccess.peerCtx);
      oss << ", flags=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipCtxEnablePeerAccess.flags);
      oss << ")";
      break;
    case HIP_API_ID_hipCtxGetApiVersion:
      oss << "hipCtxGetApiVersion(";
      oss << "ctx=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipCtxGetApiVersion.ctx);
    ...
    case HIP_API_ID_hipCtxGetCurrent:
      ...
      if (data->args.hipCtxGetCurrent.ctx == NULL)
        ...
        oss << "ctx=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipCtxGetCurrent.ctx__val);
      }
      oss << ")";
      break;
    case HIP_API_ID_hipCtxGetDevice:
      ...
      if (data->args.hipCtxGetDevice.device == NULL)
        ...
        oss << "device=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipCtxGetDevice.device__val);
      }
      oss << ")";
      break;
    case HIP_API_ID_hipCtxGetFlags:
      ...
      if (data->args.hipCtxGetFlags.flags == NULL)
        ...
        oss << "flags=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipCtxGetFlags.flags__val);
      }
      oss << ")";
      break;
    case HIP_API_ID_hipCtxGetSharedMemConfig:
    ...
    case HIP_API_ID_hipCtxPopCurrent:
      ...
      if (data->args.hipCtxPopCurrent.ctx == NULL)
        ...
        oss << "ctx=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipCtxPopCurrent.ctx__val);
      }
      oss << ")";
      break;
    case HIP_API_ID_hipCtxPushCurrent:
      ...
      oss << "ctx=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipCtxPushCurrent.ctx);
      oss << ")";
      break;
    case HIP_API_ID_hipCtxSetCacheConfig:
      oss << "hipCtxSetCacheConfig(";
      oss << "cacheConfig=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipCtxSetCacheConfig.cacheConfig);
      oss << ")";
      break;
    case HIP_API_ID_hipCtxSetCurrent:
      oss << "hipCtxSetCurrent(";
      oss << "ctx=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipCtxSetCurrent.ctx);
      oss << ")";
      break;
    case HIP_API_ID_hipCtxSetSharedMemConfig:
      oss << "hipCtxSetSharedMemConfig(";
      oss << "config=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipCtxSetSharedMemConfig.config);
      oss << ")";
      break;
    case HIP_API_ID_hipCtxSynchronize:
    ...
    case HIP_API_ID_hipDestroyExternalMemory:
      ...
      oss << "extMem=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipDestroyExternalMemory.extMem);
      oss << ")";
      break;
    case HIP_API_ID_hipDestroyExternalSemaphore:
      ...
      oss << "extSem=";
      roctracer::hip_support::detail::operator<<(oss,
                                                 data->args.hipDestroyExternalSemaphore.extSem);
      oss << ")";
      break;
    case HIP_API_ID_hipDestroySurfaceObject:
      ...
      oss << "surfaceObject=";
      roctracer::hip_support::detail::operator<<(oss,
                                                 data->args.hipDestroySurfaceObject.surfaceObject);
      oss << ")";
      break;
    case HIP_API_ID_hipDeviceCanAccessPeer:
      ...
      oss << ", deviceId=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipDeviceCanAccessPeer.deviceId);
      oss << ", peerDeviceId=";
      roctracer::hip_support::detail::operator<<(oss,
                                                 data->args.hipDeviceCanAccessPeer.peerDeviceId);
      oss << ")";
      break;
    case HIP_API_ID_hipDeviceComputeCapability:
      ...
      oss << ", device=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipDeviceComputeCapability.device);
      oss << ")";
      break;
    case HIP_API_ID_hipDeviceDisablePeerAccess:
    ...
    case HIP_API_ID_hipDeviceEnablePeerAccess:
      ...
      oss << "peerDeviceId=";
      roctracer::hip_support::detail::operator<<(oss,
                                                 data->args.hipDeviceEnablePeerAccess.peerDeviceId);
      oss << ", flags=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipDeviceEnablePeerAccess.flags);
      oss << ")";
      break;
    case HIP_API_ID_hipDeviceGet:
      oss << "hipDeviceGet(";
      if (data->args.hipDeviceGet.device == NULL)
        ...
        oss << "device=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipDeviceGet.device__val);
      }
      oss << ", ordinal=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipDeviceGet.ordinal);
      oss << ")";
      break;
    case HIP_API_ID_hipDeviceGetAttribute:
      ...
      if (data->args.hipDeviceGetAttribute.pi == NULL)
        ...
        oss << "pi=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipDeviceGetAttribute.pi__val);
      }
      oss << ", attr=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipDeviceGetAttribute.attr);
      oss << ", deviceId=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipDeviceGetAttribute.deviceId);
      oss << ")";
      break;
    case HIP_API_ID_hipDeviceGetByPCIBusId:
    ...
    case HIP_API_ID_hipDeviceGetDefaultMemPool:
      ...
      oss << ", device=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipDeviceGetDefaultMemPool.device);
      oss << ")";
      break;
    case HIP_API_ID_hipDeviceGetGraphMemAttribute:
      ...
      oss << "device=";
      roctracer::hip_support::detail::operator<<(oss,
                                                 data->args.hipDeviceGetGraphMemAttribute.device);
      oss << ", attr=";
      roctracer::hip_support::detail::operator<<(oss,
                                                 data->args.hipDeviceGetGraphMemAttribute.attr);
      oss << ", value=";
      roctracer::hip_support::detail::operator<<(oss,
                                                 data->args.hipDeviceGetGraphMemAttribute.value);
      oss << ")";
      break;
    case HIP_API_ID_hipDeviceGetLimit:
      ...
      if (data->args.hipDeviceGetLimit.pValue == NULL)
        ...
        oss << "pValue=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipDeviceGetLimit.pValue__val);
      }
      oss << ", limit=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipDeviceGetLimit.limit);
      oss << ")";
      break;
    case HIP_API_ID_hipDeviceGetMemPool:
      ...
      oss << ", device=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipDeviceGetMemPool.device);
      oss << ")";
      break;
    case HIP_API_ID_hipDeviceGetName:
      ...
      if (data->args.hipDeviceGetName.name == NULL)
        ...
        oss << "name=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipDeviceGetName.name__val);
      }
      oss << ", len=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipDeviceGetName.len);
      oss << ", device=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipDeviceGetName.device);
      oss << ")";
      break;
    case HIP_API_ID_hipDeviceGetP2PAttribute:
      ...
      oss << ", attr=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipDeviceGetP2PAttribute.attr);
      oss << ", srcDevice=";
      roctracer::hip_support::detail::operator<<(oss,
                                                 data->args.hipDeviceGetP2PAttribute.srcDevice);
      oss << ", dstDevice=";
      roctracer::hip_support::detail::operator<<(oss,
                                                 data->args.hipDeviceGetP2PAttribute.dstDevice);
      oss << ")";
      break;
    case HIP_API_ID_hipDeviceGetPCIBusId:
      ...
      if (data->args.hipDeviceGetPCIBusId.pciBusId == NULL)
        ...
        oss << "pciBusId=";
        roctracer::hip_support::detail::operator<<(oss,
                                                   data->args.hipDeviceGetPCIBusId.pciBusId__val);
      }
      oss << ", len=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipDeviceGetPCIBusId.len);
      oss << ", device=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipDeviceGetPCIBusId.device);
      oss << ")";
      break;
    case HIP_API_ID_hipDeviceGetSharedMemConfig:
    ...
    case HIP_API_ID_hipDeviceGetStreamPriorityRange:
      ...
      if (data->args.hipDeviceGetStreamPriorityRange.greatestPriority == NULL)
        ...
        roctracer::hip_support::detail::operator<<(
            oss, data->args.hipDeviceGetStreamPriorityRange.greatestPriority__val);
      }
      oss << ")";
      break;
    case HIP_API_ID_hipDeviceGetUuid:
      ...
      if (data->args.hipDeviceGetUuid.uuid == NULL)
        ...
        oss << "uuid=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipDeviceGetUuid.uuid__val);
      }
      oss << ", device=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipDeviceGetUuid.device);
      oss << ")";
      break;
    case HIP_API_ID_hipDeviceGraphMemTrim:
      oss << "hipDeviceGraphMemTrim(";
      oss << "device=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipDeviceGraphMemTrim.device);
      oss << ")";
      break;
    case HIP_API_ID_hipDevicePrimaryCtxGetState:
      oss << "hipDevicePrimaryCtxGetState(";
      oss << "dev=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipDevicePrimaryCtxGetState.dev);
    ...
    case HIP_API_ID_hipDevicePrimaryCtxRelease:
      ...
      oss << "dev=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipDevicePrimaryCtxRelease.dev);
      oss << ")";
      break;
    case HIP_API_ID_hipDevicePrimaryCtxReset:
      oss << "hipDevicePrimaryCtxReset(";
      oss << "dev=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipDevicePrimaryCtxReset.dev);
      oss << ")";
      break;
    case HIP_API_ID_hipDevicePrimaryCtxRetain:
      ...
      oss << ", dev=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipDevicePrimaryCtxRetain.dev);
      oss << ")";
      break;
    case HIP_API_ID_hipDevicePrimaryCtxSetFlags:
      oss << "hipDevicePrimaryCtxSetFlags(";
      oss << "dev=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipDevicePrimaryCtxSetFlags.dev);
      oss << ", flags=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipDevicePrimaryCtxSetFlags.flags);
      oss << ")";
      break;
    case HIP_API_ID_hipDeviceReset:
      oss << "hipDeviceReset(";
    ...
    case HIP_API_ID_hipDeviceSetCacheConfig:
      ...
      oss << "cacheConfig=";
      roctracer::hip_support::detail::operator<<(oss,
                                                 data->args.hipDeviceSetCacheConfig.cacheConfig);
      oss << ")";
      break;
    case HIP_API_ID_hipDeviceSetGraphMemAttribute:
      ...
      oss << "device=";
      roctracer::hip_support::detail::operator<<(oss,
                                                 data->args.hipDeviceSetGraphMemAttribute.device);
      oss << ", attr=";
      roctracer::hip_support::detail::operator<<(oss,
                                                 data->args.hipDeviceSetGraphMemAttribute.attr);
      oss << ", value=";
      roctracer::hip_support::detail::operator<<(oss,
                                                 data->args.hipDeviceSetGraphMemAttribute.value);
      oss << ")";
      break;
    case HIP_API_ID_hipDeviceSetLimit:
      oss << "hipDeviceSetLimit(";
      oss << "limit=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipDeviceSetLimit.limit);
      oss << ", value=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipDeviceSetLimit.value);
      oss << ")";
      break;
    case HIP_API_ID_hipDeviceSetMemPool:
      oss << "hipDeviceSetMemPool(";
      oss << "device=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipDeviceSetMemPool.device);
      oss << ", mem_pool=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipDeviceSetMemPool.mem_pool);
      oss << ")";
      break;
    case HIP_API_ID_hipDeviceSetSharedMemConfig:
      ...
      oss << "config=";
      roctracer::hip_support::detail::operator<<(oss,
                                                 data->args.hipDeviceSetSharedMemConfig.config);
      oss << ")";
      break;
    case HIP_API_ID_hipDeviceSynchronize:
    ...
    case HIP_API_ID_hipDeviceTotalMem:
      ...
      if (data->args.hipDeviceTotalMem.bytes == NULL)
        ...
        oss << "bytes=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipDeviceTotalMem.bytes__val);
      }
      oss << ", device=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipDeviceTotalMem.device);
      oss << ")";
      break;
    case HIP_API_ID_hipDriverGetVersion:
    ...
    case HIP_API_ID_hipDrvGraphAddMemFreeNode:
      ...
      oss << ", hGraph=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipDrvGraphAddMemFreeNode.hGraph);
      ...
      oss << ", dptr=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipDrvGraphAddMemFreeNode.dptr);
      oss << ")";
      break;
    case HIP_API_ID_hipDrvGraphAddMemcpyNode:
      ...
      oss << ", hGraph=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipDrvGraphAddMemcpyNode.hGraph);
      ...
      oss << ", ctx=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipDrvGraphAddMemcpyNode.ctx);
      oss << ")";
      break;
    case HIP_API_ID_hipDrvGraphAddMemsetNode:
      ...
      oss << ", hGraph=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipDrvGraphAddMemsetNode.hGraph);
      ...
      oss << ", ctx=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipDrvGraphAddMemsetNode.ctx);
      oss << ")";
      break;
    case HIP_API_ID_hipDrvGraphExecMemcpyNodeSetParams:
      ...
      oss << ", ctx=";
      roctracer::hip_support::detail::operator<<(oss,
                                                 data->args.hipDrvGraphExecMemcpyNodeSetParams.ctx);
      oss << ")";
      break;
    case HIP_API_ID_hipDrvGraphExecMemsetNodeSetParams:
      ...
      oss << ", ctx=";
      roctracer::hip_support::detail::operator<<(oss,
                                                 data->args.hipDrvGraphExecMemsetNodeSetParams.ctx);
      oss << ")";
      break;
    case HIP_API_ID_hipDrvGraphMemcpyNodeGetParams:
      ...
      oss << "hNode=";
      roctracer::hip_support::detail::operator<<(oss,
                                                 data->args.hipDrvGraphMemcpyNodeGetParams.hNode);
    ...
    case HIP_API_ID_hipDrvGraphMemcpyNodeSetParams:
      ...
      oss << "hNode=";
      roctracer::hip_support::detail::operator<<(oss,
                                                 data->args.hipDrvGraphMemcpyNodeSetParams.hNode);
    ...
    case HIP_API_ID_hipDrvLaunchKernelEx:
      ...
      oss << ", f=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipDrvLaunchKernelEx.f);
      ...
      if (data->args.hipDrvLaunchKernelEx.extra == NULL)
        ...
        oss << ", extra=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipDrvLaunchKernelEx.extra__val);
      }
      oss << ")";
      break;
    case HIP_API_ID_hipDrvMemcpy2DUnaligned:
    ...
    case HIP_API_ID_hipDrvMemcpy3D:
      ...
      if (data->args.hipDrvMemcpy3D.pCopy == NULL)
        ...
        oss << "pCopy=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipDrvMemcpy3D.pCopy__val);
      }
      oss << ")";
      break;
    case HIP_API_ID_hipDrvMemcpy3DAsync:
      ...
      if (data->args.hipDrvMemcpy3DAsync.pCopy == NULL)
        ...
        oss << "pCopy=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipDrvMemcpy3DAsync.pCopy__val);
      }
      oss << ", stream=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipDrvMemcpy3DAsync.stream);
      oss << ")";
      break;
    case HIP_API_ID_hipDrvPointerGetAttributes:
      ...
      oss << ", ptr=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipDrvPointerGetAttributes.ptr);
      oss << ")";
      break;
    case HIP_API_ID_hipEventCreate:
      oss << "hipEventCreate(";
      if (data->args.hipEventCreate.event == NULL)
        ...
        oss << "event=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipEventCreate.event__val);
      }
      oss << ")";
      break;
    case HIP_API_ID_hipEventCreateWithFlags:
      ...
      oss << ", flags=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipEventCreateWithFlags.flags);
      oss << ")";
      break;
    case HIP_API_ID_hipEventDestroy:
      oss << "hipEventDestroy(";
      oss << "event=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipEventDestroy.event);
      oss << ")";
      break;
    case HIP_API_ID_hipEventElapsedTime:
      ...
      if (data->args.hipEventElapsedTime.ms == NULL)
        ...
        oss << "ms=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipEventElapsedTime.ms__val);
      }
      oss << ", start=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipEventElapsedTime.start);
      oss << ", stop=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipEventElapsedTime.stop);
      oss << ")";
      break;
    case HIP_API_ID_hipEventQuery:
      oss << "hipEventQuery(";
      oss << "event=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipEventQuery.event);
      oss << ")";
      break;
    case HIP_API_ID_hipEventRecord:
      oss << "hipEventRecord(";
      oss << "event=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipEventRecord.event);
      oss << ", stream=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipEventRecord.stream);
      oss << ")";
      break;
    case HIP_API_ID_hipEventRecordWithFlags:
      oss << "hipEventRecordWithFlags(";
      oss << "event=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipEventRecordWithFlags.event);
      oss << ", stream=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipEventRecordWithFlags.stream);
      oss << ", flags=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipEventRecordWithFlags.flags);
      oss << ")";
      break;
    case HIP_API_ID_hipEventSynchronize:
      oss << "hipEventSynchronize(";
      oss << "event=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipEventSynchronize.event);
      oss << ")";
      break;
    case HIP_API_ID_hipExtGetLastError:
    ...
    case HIP_API_ID_hipExtGetLinkTypeAndHopCount:
      ...
      oss << "device1=";
      roctracer::hip_support::detail::operator<<(oss,
                                                 data->args.hipExtGetLinkTypeAndHopCount.device1);
      oss << ", device2=";
      roctracer::hip_support::detail::operator<<(oss,
                                                 data->args.hipExtGetLinkTypeAndHopCount.device2);
    ...
    case HIP_API_ID_hipExtLaunchKernel:
      ...
      oss << ", numBlocks=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipExtLaunchKernel.numBlocks);
      oss << ", dimBlocks=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipExtLaunchKernel.dimBlocks);
      if (data->args.hipExtLaunchKernel.args == NULL)
        oss << ", args=NULL";
      else {
        oss << ", args=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipExtLaunchKernel.args__val);
      }
      oss << ", sharedMemBytes=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipExtLaunchKernel.sharedMemBytes);
      oss << ", stream=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipExtLaunchKernel.stream);
      oss << ", startEvent=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipExtLaunchKernel.startEvent);
      oss << ", stopEvent=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipExtLaunchKernel.stopEvent);
      oss << ", flags=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipExtLaunchKernel.flags);
      oss << ")";
      break;
    case HIP_API_ID_hipExtLaunchMultiKernelMultiDevice:
      ...
      if (data->args.hipExtLaunchMultiKernelMultiDevice.launchParamsList == NULL)
        ...
        roctracer::hip_support::detail::operator<<(
            oss, data->args.hipExtLaunchMultiKernelMultiDevice.launchParamsList__val);
      }
      oss << ", numDevices=";
      roctracer::hip_support::detail::operator<<(
    ...
    case HIP_API_ID_hipExtMallocWithFlags:
      ...
      if (data->args.hipExtMallocWithFlags.ptr == NULL)
        ...
        oss << "ptr=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipExtMallocWithFlags.ptr__val);
      }
      oss << ", sizeBytes=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipExtMallocWithFlags.sizeBytes);
      oss << ", flags=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipExtMallocWithFlags.flags);
      oss << ")";
      break;
    case HIP_API_ID_hipExtModuleLaunchKernel:
      oss << "hipExtModuleLaunchKernel(";
      oss << "f=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipExtModuleLaunchKernel.f);
      oss << ", globalWorkSizeX=";
      roctracer::hip_support::detail::operator<<(
      ...
      oss << ", hStream=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipExtModuleLaunchKernel.hStream);
      ...
      oss << ", startEvent=";
      roctracer::hip_support::detail::operator<<(oss,
                                                 data->args.hipExtModuleLaunchKernel.startEvent);
      oss << ", stopEvent=";
      roctracer::hip_support::detail::operator<<(oss,
                                                 data->args.hipExtModuleLaunchKernel.stopEvent);
      oss << ", flags=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipExtModuleLaunchKernel.flags);
      oss << ")";
      break;
    case HIP_API_ID_hipExtStreamCreateWithCUMask:
    ...
    case HIP_API_ID_hipExtStreamGetCUMask:
      ...
      oss << "stream=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipExtStreamGetCUMask.stream);
      oss << ", cuMaskSize=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipExtStreamGetCUMask.cuMaskSize);
    ...
    case HIP_API_ID_hipExternalMemoryGetMappedMipmappedArray:
      ...
      if (data->args.hipExternalMemoryGetMappedMipmappedArray.mipmapDesc == NULL)
        ...
        oss << ", mipmapDesc=";
        roctracer::hip_support::detail::operator<<(
            oss, data->args.hipExternalMemoryGetMappedMipmappedArray.mipmapDesc__val);
      }
      oss << ")";
      break;
    case HIP_API_ID_hipFree:
    ...
    case HIP_API_ID_hipFreeArray:
      oss << "hipFreeArray(";
      oss << "array=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipFreeArray.array);
      oss << ")";
      break;
    case HIP_API_ID_hipFreeAsync:
      oss << "hipFreeAsync(";
      oss << "dev_ptr=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipFreeAsync.dev_ptr);
      oss << ", stream=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipFreeAsync.stream);
      oss << ")";
      break;
    case HIP_API_ID_hipFreeHost:
      oss << "hipFreeHost(";
    ...
    case HIP_API_ID_hipFreeMipmappedArray:
      ...
      oss << "mipmappedArray=";
      roctracer::hip_support::detail::operator<<(oss,
                                                 data->args.hipFreeMipmappedArray.mipmappedArray);
      oss << ")";
      break;
    case HIP_API_ID_hipFuncGetAttribute:
      ...
      if (data->args.hipFuncGetAttribute.value == NULL)
        ...
        oss << "value=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipFuncGetAttribute.value__val);
      }
      oss << ", attrib=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipFuncGetAttribute.attrib);
      oss << ", hfunc=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipFuncGetAttribute.hfunc);
      oss << ")";
      break;
    case HIP_API_ID_hipFuncGetAttributes:
      ...
      if (data->args.hipFuncGetAttributes.attr == NULL)
        ...
        oss << "attr=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipFuncGetAttributes.attr__val);
      }
      oss << ", func=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipFuncGetAttributes.func);
      oss << ")";
      break;
    case HIP_API_ID_hipFuncSetAttribute:
      oss << "hipFuncSetAttribute(";
      oss << "func=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipFuncSetAttribute.func);
      oss << ", attr=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipFuncSetAttribute.attr);
      oss << ", value=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipFuncSetAttribute.value);
      oss << ")";
      break;
    case HIP_API_ID_hipFuncSetCacheConfig:
      oss << "hipFuncSetCacheConfig(";
      oss << "func=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipFuncSetCacheConfig.func);
      oss << ", config=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipFuncSetCacheConfig.config);
      oss << ")";
      break;
    case HIP_API_ID_hipFuncSetSharedMemConfig:
      oss << "hipFuncSetSharedMemConfig(";
      oss << "func=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipFuncSetSharedMemConfig.func);
      oss << ", config=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipFuncSetSharedMemConfig.config);
      oss << ")";
      break;
    case HIP_API_ID_hipGLGetDevices:
      oss << "hipGLGetDevices(";
      ...
      oss << ", hipDeviceCount=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipGLGetDevices.hipDeviceCount);
      oss << ", deviceList=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipGLGetDevices.deviceList);
      oss << ")";
      break;
    case HIP_API_ID_hipGetChannelDesc:
      ...
      if (data->args.hipGetChannelDesc.desc == NULL)
        ...
        oss << "desc=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipGetChannelDesc.desc__val);
      }
      oss << ", array=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipGetChannelDesc.array);
      oss << ")";
      break;
    case HIP_API_ID_hipGetDevice:
      oss << "hipGetDevice(";
      if (data->args.hipGetDevice.deviceId == NULL)
        ...
        oss << "deviceId=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipGetDevice.deviceId__val);
      }
      oss << ")";
      break;
    case HIP_API_ID_hipGetDeviceCount:
      ...
      if (data->args.hipGetDeviceCount.count == NULL)
        ...
        oss << "count=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipGetDeviceCount.count__val);
      }
      oss << ")";
      break;
    case HIP_API_ID_hipGetDeviceFlags:
      ...
      if (data->args.hipGetDeviceFlags.flags == NULL)
        ...
        oss << "flags=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipGetDeviceFlags.flags__val);
      }
      oss << ")";
      break;
    case HIP_API_ID_hipGetDevicePropertiesR0000:
      ...
      oss << ", device=";
      roctracer::hip_support::detail::operator<<(oss,
                                                 data->args.hipGetDevicePropertiesR0000.device);
      oss << ")";
      break;
    case HIP_API_ID_hipGetDevicePropertiesR0600:
      ...
      oss << ", deviceId=";
      roctracer::hip_support::detail::operator<<(oss,
                                                 data->args.hipGetDevicePropertiesR0600.deviceId);
      oss << ")";
      break;
    case HIP_API_ID_hipGetDriverEntryPoint:
      ...
      oss << ", flags=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipGetDriverEntryPoint.flags);
    ...
    case HIP_API_ID_hipGetFuncBySymbol:
      ...
      oss << ", symbolPtr=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipGetFuncBySymbol.symbolPtr);
      oss << ")";
      break;
    case HIP_API_ID_hipGetLastError:
      oss << "hipGetLastError(";
    ...
    case HIP_API_ID_hipGetMipmappedArrayLevel:
      ...
      oss << ", level=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipGetMipmappedArrayLevel.level);
      oss << ")";
      break;
    case HIP_API_ID_hipGetProcAddress:
      ...
      if (data->args.hipGetProcAddress.symbol == NULL)
        ...
        oss << "symbol=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipGetProcAddress.symbol__val);
      }
      if (data->args.hipGetProcAddress.pfn == NULL)
        oss << ", pfn=NULL";
      else {
        oss << ", pfn=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipGetProcAddress.pfn__val);
      }
      oss << ", hipVersion=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipGetProcAddress.hipVersion);
      oss << ", flags=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipGetProcAddress.flags);
    ...
    case HIP_API_ID_hipGetSymbolAddress:
      ...
      if (data->args.hipGetSymbolAddress.devPtr == NULL)
        ...
        oss << "devPtr=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipGetSymbolAddress.devPtr__val);
      }
      oss << ", symbol=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipGetSymbolAddress.symbol);
      oss << ")";
      break;
    case HIP_API_ID_hipGetSymbolSize:
      ...
      if (data->args.hipGetSymbolSize.size == NULL)
        ...
        oss << "size=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipGetSymbolSize.size__val);
      }
      oss << ", symbol=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipGetSymbolSize.symbol);
      oss << ")";
      break;
    case HIP_API_ID_hipGraphAddBatchMemOpNode:
      ...
      oss << ", hGraph=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipGraphAddBatchMemOpNode.hGraph);
    ...
    case HIP_API_ID_hipGraphAddChildGraphNode:
      ...
      oss << ", graph=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipGraphAddChildGraphNode.graph);
      ...
      oss << ", childGraph=";
      roctracer::hip_support::detail::operator<<(oss,
                                                 data->args.hipGraphAddChildGraphNode.childGraph);
      oss << ")";
      break;
    case HIP_API_ID_hipGraphAddDependencies:
      oss << "hipGraphAddDependencies(";
      oss << "graph=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipGraphAddDependencies.graph);
      ...
      if (data->args.hipGraphAddDependencies.to == NULL)
        ...
        oss << ", to=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipGraphAddDependencies.to__val);
      }
      oss << ", numDependencies=";
      roctracer::hip_support::detail::operator<<(
    ...
    case HIP_API_ID_hipGraphAddEmptyNode:
      ...
      oss << ", graph=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipGraphAddEmptyNode.graph);
      ...
      oss << ", numDependencies=";
      roctracer::hip_support::detail::operator<<(oss,
                                                 data->args.hipGraphAddEmptyNode.numDependencies);
      oss << ")";
      break;
    case HIP_API_ID_hipGraphAddEventRecordNode:
      ...
      oss << ", graph=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipGraphAddEventRecordNode.graph);
      ...
      oss << ", event=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipGraphAddEventRecordNode.event);
      oss << ")";
      break;
    case HIP_API_ID_hipGraphAddEventWaitNode:
      ...
      oss << ", graph=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipGraphAddEventWaitNode.graph);
      ...
      oss << ", event=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipGraphAddEventWaitNode.event);
      oss << ")";
      break;
    case HIP_API_ID_hipGraphAddExternalSemaphoresSignalNode:
      ...
      if (data->args.hipGraphAddExternalSemaphoresSignalNode.pGraphNode == NULL)
        ...
        oss << "pGraphNode=";
        roctracer::hip_support::detail::operator<<(
            oss, data->args.hipGraphAddExternalSemaphoresSignalNode.pGraphNode__val);
      }
      oss << ", graph=";
      roctracer::hip_support::detail::operator<<(
          oss, data->args.hipGraphAddExternalSemaphoresSignalNode.graph);
      if (data->args.hipGraphAddExternalSemaphoresSignalNode.pDependencies == NULL)
        oss << ", pDependencies=NULL";
      else {
        oss << ", pDependencies=";
        roctracer::hip_support::detail::operator<<(
            oss, data->args.hipGraphAddExternalSemaphoresSignalNode.pDependencies__val);
      }
      oss << ", numDependencies=";
      roctracer::hip_support::detail::operator<<(
          oss, data->args.hipGraphAddExternalSemaphoresSignalNode.numDependencies);
      if (data->args.hipGraphAddExternalSemaphoresSignalNode.nodeParams == NULL)
        oss << ", nodeParams=NULL";
      else {
        oss << ", nodeParams=";
        roctracer::hip_support::detail::operator<<(
            oss, data->args.hipGraphAddExternalSemaphoresSignalNode.nodeParams__val);
      }
      oss << ")";
      break;
    case HIP_API_ID_hipGraphAddExternalSemaphoresWaitNode:
      ...
      if (data->args.hipGraphAddExternalSemaphoresWaitNode.pGraphNode == NULL)
        ...
        oss << "pGraphNode=";
        roctracer::hip_support::detail::operator<<(
            oss, data->args.hipGraphAddExternalSemaphoresWaitNode.pGraphNode__val);
      }
      oss << ", graph=";
      roctracer::hip_support::detail::operator<<(
      ...
      if (data->args.hipGraphAddExternalSemaphoresWaitNode.pDependencies == NULL)
        ...
        oss << ", pDependencies=";
        roctracer::hip_support::detail::operator<<(
            oss, data->args.hipGraphAddExternalSemaphoresWaitNode.pDependencies__val);
      }
      oss << ", numDependencies=";
      roctracer::hip_support::detail::operator<<(
      ...
      if (data->args.hipGraphAddExternalSemaphoresWaitNode.nodeParams == NULL)
        ...
        oss << ", nodeParams=";
        roctracer::hip_support::detail::operator<<(
            oss, data->args.hipGraphAddExternalSemaphoresWaitNode.nodeParams__val);
      }
      oss << ")";
      break;
    case HIP_API_ID_hipGraphAddHostNode:
      ...
      oss << ", graph=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipGraphAddHostNode.graph);
      ...
      oss << ", numDependencies=";
      roctracer::hip_support::detail::operator<<(oss,
                                                 data->args.hipGraphAddHostNode.numDependencies);
    ...
    case HIP_API_ID_hipGraphAddKernelNode:
      ...
      oss << ", graph=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipGraphAddKernelNode.graph);
      ...
      oss << ", numDependencies=";
      roctracer::hip_support::detail::operator<<(oss,
                                                 data->args.hipGraphAddKernelNode.numDependencies);
    ...
    case HIP_API_ID_hipGraphAddMemAllocNode:
      ...
      oss << ", graph=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipGraphAddMemAllocNode.graph);
    ...
    case HIP_API_ID_hipGraphAddMemFreeNode:
      ...
      oss << ", graph=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipGraphAddMemFreeNode.graph);
      ...
      oss << ", numDependencies=";
      roctracer::hip_support::detail::operator<<(oss,
                                                 data->args.hipGraphAddMemFreeNode.numDependencies);
      oss << ", dev_ptr=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipGraphAddMemFreeNode.dev_ptr);
      oss << ")";
      break;
    case HIP_API_ID_hipGraphAddMemcpyNode:
      ...
      oss << ", graph=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipGraphAddMemcpyNode.graph);
      ...
      oss << ", numDependencies=";
      roctracer::hip_support::detail::operator<<(oss,
                                                 data->args.hipGraphAddMemcpyNode.numDependencies);
    ...
    case HIP_API_ID_hipGraphAddMemcpyNode1D:
      ...
      oss << ", graph=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipGraphAddMemcpyNode1D.graph);
      ...
      oss << ", dst=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipGraphAddMemcpyNode1D.dst);
      oss << ", src=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipGraphAddMemcpyNode1D.src);
      oss << ", count=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipGraphAddMemcpyNode1D.count);
      oss << ", kind=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipGraphAddMemcpyNode1D.kind);
      oss << ")";
      break;
    case HIP_API_ID_hipGraphAddMemcpyNodeFromSymbol:
      ...
      oss << ", graph=";
      roctracer::hip_support::detail::operator<<(oss,
                                                 data->args.hipGraphAddMemcpyNodeFromSymbol.graph);
      ...
      oss << ", dst=";
      roctracer::hip_support::detail::operator<<(oss,
                                                 data->args.hipGraphAddMemcpyNodeFromSymbol.dst);
      oss << ", symbol=";
      roctracer::hip_support::detail::operator<<(oss,
                                                 data->args.hipGraphAddMemcpyNodeFromSymbol.symbol);
      oss << ", count=";
      roctracer::hip_support::detail::operator<<(oss,
                                                 data->args.hipGraphAddMemcpyNodeFromSymbol.count);
      oss << ", offset=";
      roctracer::hip_support::detail::operator<<(oss,
                                                 data->args.hipGraphAddMemcpyNodeFromSymbol.offset);
      oss << ", kind=";
      roctracer::hip_support::detail::operator<<(oss,
                                                 data->args.hipGraphAddMemcpyNodeFromSymbol.kind);
      oss << ")";
      break;
    case HIP_API_ID_hipGraphAddMemcpyNodeToSymbol:
      ...
      oss << ", graph=";
      roctracer::hip_support::detail::operator<<(oss,
                                                 data->args.hipGraphAddMemcpyNodeToSymbol.graph);
      ...
      oss << ", symbol=";
      roctracer::hip_support::detail::operator<<(oss,
                                                 data->args.hipGraphAddMemcpyNodeToSymbol.symbol);
      oss << ", src=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipGraphAddMemcpyNodeToSymbol.src);
      oss << ", count=";
      roctracer::hip_support::detail::operator<<(oss,
                                                 data->args.hipGraphAddMemcpyNodeToSymbol.count);
      oss << ", offset=";
      roctracer::hip_support::detail::operator<<(oss,
                                                 data->args.hipGraphAddMemcpyNodeToSymbol.offset);
      oss << ", kind=";
      roctracer::hip_support::detail::operator<<(oss,
                                                 data->args.hipGraphAddMemcpyNodeToSymbol.kind);
      oss << ")";
      break;
    case HIP_API_ID_hipGraphAddMemsetNode:
      ...
      oss << ", graph=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipGraphAddMemsetNode.graph);
      ...
      oss << ", numDependencies=";
      roctracer::hip_support::detail::operator<<(oss,
                                                 data->args.hipGraphAddMemsetNode.numDependencies);
    ...
    case HIP_API_ID_hipGraphAddNode:
      ...
      if (data->args.hipGraphAddNode.pGraphNode == NULL)
        ...
        oss << "pGraphNode=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipGraphAddNode.pGraphNode__val);
      }
      oss << ", graph=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipGraphAddNode.graph);
      ...
      oss << ", numDependencies=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipGraphAddNode.numDependencies);
      if (data->args.hipGraphAddNode.nodeParams == NULL)
        oss << ", nodeParams=NULL";
      else {
        oss << ", nodeParams=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipGraphAddNode.nodeParams__val);
      }
      oss << ")";
      break;
    case HIP_API_ID_hipGraphBatchMemOpNodeGetParams:
      ...
      oss << "hNode=";
      roctracer::hip_support::detail::operator<<(oss,
                                                 data->args.hipGraphBatchMemOpNodeGetParams.hNode);
    ...
    case HIP_API_ID_hipGraphBatchMemOpNodeSetParams:
      ...
      oss << "hNode=";
      roctracer::hip_support::detail::operator<<(oss,
                                                 data->args.hipGraphBatchMemOpNodeSetParams.hNode);
    ...
    case HIP_API_ID_hipGraphChildGraphNodeGetGraph:
      ...
      oss << "node=";
      roctracer::hip_support::detail::operator<<(oss,
                                                 data->args.hipGraphChildGraphNodeGetGraph.node);
    ...
    case HIP_API_ID_hipGraphClone:
      ...
      if (data->args.hipGraphClone.pGraphClone == NULL)
        ...
        oss << "pGraphClone=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipGraphClone.pGraphClone__val);
      }
      oss << ", originalGraph=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipGraphClone.originalGraph);
      oss << ")";
      break;
    case HIP_API_ID_hipGraphCreate:
      oss << "hipGraphCreate(";
      if (data->args.hipGraphCreate.pGraph == NULL)
        ...
        oss << "pGraph=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipGraphCreate.pGraph__val);
      }
      oss << ", flags=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipGraphCreate.flags);
      oss << ")";
      break;
    case HIP_API_ID_hipGraphDebugDotPrint:
      oss << "hipGraphDebugDotPrint(";
      oss << "graph=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipGraphDebugDotPrint.graph);
      if (data->args.hipGraphDebugDotPrint.path == NULL)
        oss << ", path=NULL";
      else {
        oss << ", path=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipGraphDebugDotPrint.path__val);
      }
      oss << ", flags=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipGraphDebugDotPrint.flags);
      oss << ")";
      break;
    case HIP_API_ID_hipGraphDestroy:
      oss << "hipGraphDestroy(";
      oss << "graph=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipGraphDestroy.graph);
      oss << ")";
      break;
    case HIP_API_ID_hipGraphDestroyNode:
      oss << "hipGraphDestroyNode(";
      oss << "node=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipGraphDestroyNode.node);
      oss << ")";
      break;
    case HIP_API_ID_hipGraphEventRecordNodeGetEvent:
      ...
      oss << "node=";
      roctracer::hip_support::detail::operator<<(oss,
                                                 data->args.hipGraphEventRecordNodeGetEvent.node);
    ...
    case HIP_API_ID_hipGraphEventRecordNodeSetEvent:
      ...
      oss << "node=";
      roctracer::hip_support::detail::operator<<(oss,
                                                 data->args.hipGraphEventRecordNodeSetEvent.node);
      oss << ", event=";
      roctracer::hip_support::detail::operator<<(oss,
                                                 data->args.hipGraphEventRecordNodeSetEvent.event);
      oss << ")";
      break;
    case HIP_API_ID_hipGraphEventWaitNodeGetEvent:
      ...
      oss << "node=";
      roctracer::hip_support::detail::operator<<(oss,
                                                 data->args.hipGraphEventWaitNodeGetEvent.node);
    ...
    case HIP_API_ID_hipGraphEventWaitNodeSetEvent:
      ...
      oss << "node=";
      roctracer::hip_support::detail::operator<<(oss,
                                                 data->args.hipGraphEventWaitNodeSetEvent.node);
      oss << ", event=";
      roctracer::hip_support::detail::operator<<(oss,
                                                 data->args.hipGraphEventWaitNodeSetEvent.event);
      oss << ")";
      break;
    case HIP_API_ID_hipGraphExecBatchMemOpNodeSetParams:
    ...
    case HIP_API_ID_hipGraphExecDestroy:
      ...
      oss << "graphExec=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipGraphExecDestroy.graphExec);
      oss << ")";
      break;
    case HIP_API_ID_hipGraphExecEventRecordNodeSetEvent:
    ...
    case HIP_API_ID_hipGraphExecExternalSemaphoresSignalNodeSetParams:
      ...
      oss << "hGraphExec=";
      roctracer::hip_support::detail::operator<<(
          oss, data->args.hipGraphExecExternalSemaphoresSignalNodeSetParams.hGraphExec);
      oss << ", hNode=";
      roctracer::hip_support::detail::operator<<(
          oss, data->args.hipGraphExecExternalSemaphoresSignalNodeSetParams.hNode);
      if (data->args.hipGraphExecExternalSemaphoresSignalNodeSetParams.nodeParams == NULL)
        oss << ", nodeParams=NULL";
      else {
        oss << ", nodeParams=";
        roctracer::hip_support::detail::operator<<(
            oss, data->args.hipGraphExecExternalSemaphoresSignalNodeSetParams.nodeParams__val);
      }
      oss << ")";
      break;
    case HIP_API_ID_hipGraphExecExternalSemaphoresWaitNodeSetParams:
      ...
      oss << "hGraphExec=";
      roctracer::hip_support::detail::operator<<(
          oss, data->args.hipGraphExecExternalSemaphoresWaitNodeSetParams.hGraphExec);
      oss << ", hNode=";
      roctracer::hip_support::detail::operator<<(
          oss, data->args.hipGraphExecExternalSemaphoresWaitNodeSetParams.hNode);
      if (data->args.hipGraphExecExternalSemaphoresWaitNodeSetParams.nodeParams == NULL)
        oss << ", nodeParams=NULL";
      else {
        oss << ", nodeParams=";
        roctracer::hip_support::detail::operator<<(
            oss, data->args.hipGraphExecExternalSemaphoresWaitNodeSetParams.nodeParams__val);
      }
      oss << ")";
      break;
    case HIP_API_ID_hipGraphExecGetFlags:
      ...
      oss << "graphExec=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipGraphExecGetFlags.graphExec);
      if (data->args.hipGraphExecGetFlags.flags == NULL)
        oss << ", flags=NULL";
      else {
        oss << ", flags=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipGraphExecGetFlags.flags__val);
      }
      oss << ")";
      break;
    case HIP_API_ID_hipGraphExecHostNodeSetParams:
      ...
      oss << ", node=";
      roctracer::hip_support::detail::operator<<(oss,
                                                 data->args.hipGraphExecHostNodeSetParams.node);
    ...
    case HIP_API_ID_hipGraphExecKernelNodeSetParams:
      ...
      oss << ", node=";
      roctracer::hip_support::detail::operator<<(oss,
                                                 data->args.hipGraphExecKernelNodeSetParams.node);
    ...
    case HIP_API_ID_hipGraphExecMemcpyNodeSetParams:
      ...
      oss << ", node=";
      roctracer::hip_support::detail::operator<<(oss,
                                                 data->args.hipGraphExecMemcpyNodeSetParams.node);
    ...
    case HIP_API_ID_hipGraphExecMemcpyNodeSetParams1D:
      ...
      oss << ", node=";
      roctracer::hip_support::detail::operator<<(oss,
                                                 data->args.hipGraphExecMemcpyNodeSetParams1D.node);
      oss << ", dst=";
      roctracer::hip_support::detail::operator<<(oss,
                                                 data->args.hipGraphExecMemcpyNodeSetParams1D.dst);
      oss << ", src=";
      roctracer::hip_support::detail::operator<<(oss,
                                                 data->args.hipGraphExecMemcpyNodeSetParams1D.src);
      oss << ", count=";
      roctracer::hip_support::detail::operator<<(
          oss, data->args.hipGraphExecMemcpyNodeSetParams1D.count);
      oss << ", kind=";
      roctracer::hip_support::detail::operator<<(oss,
                                                 data->args.hipGraphExecMemcpyNodeSetParams1D.kind);
      oss << ")";
      break;
    case HIP_API_ID_hipGraphExecMemcpyNodeSetParamsFromSymbol:
    ...
    case HIP_API_ID_hipGraphExecMemsetNodeSetParams:
      ...
      oss << ", node=";
      roctracer::hip_support::detail::operator<<(oss,
                                                 data->args.hipGraphExecMemsetNodeSetParams.node);
    ...
    case HIP_API_ID_hipGraphExecNodeSetParams:
      ...
      oss << "graphExec=";
      roctracer::hip_support::detail::operator<<(oss,
                                                 data->args.hipGraphExecNodeSetParams.graphExec);
      oss << ", node=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipGraphExecNodeSetParams.node);
    ...
    case HIP_API_ID_hipGraphExecUpdate:
      ...
      oss << "hGraphExec=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipGraphExecUpdate.hGraphExec);
      oss << ", hGraph=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipGraphExecUpdate.hGraph);
    ...
    case HIP_API_ID_hipGraphExternalSemaphoresSignalNodeGetParams:
      ...
      if (data->args.hipGraphExternalSemaphoresSignalNodeGetParams.params_out == NULL)
        oss << ", params_out=NULL";
      else {
        oss << ", params_out=";
        roctracer::hip_support::detail::operator<<(
            oss, data->args.hipGraphExternalSemaphoresSignalNodeGetParams.params_out__val);
      }
      oss << ")";
      break;
    case HIP_API_ID_hipGraphExternalSemaphoresSignalNodeSetParams:
      ...
      if (data->args.hipGraphExternalSemaphoresSignalNodeSetParams.nodeParams == NULL)
        oss << ", nodeParams=NULL";
      else {
        oss << ", nodeParams=";
        roctracer::hip_support::detail::operator<<(
            oss, data->args.hipGraphExternalSemaphoresSignalNodeSetParams.nodeParams__val);
      }
      oss << ")";
      break;
    case HIP_API_ID_hipGraphExternalSemaphoresWaitNodeGetParams:
      ...
      if (data->args.hipGraphExternalSemaphoresWaitNodeGetParams.params_out == NULL)
        oss << ", params_out=NULL";
      else {
        oss << ", params_out=";
        roctracer::hip_support::detail::operator<<(
            oss, data->args.hipGraphExternalSemaphoresWaitNodeGetParams.params_out__val);
      }
      oss << ")";
      break;
    case HIP_API_ID_hipGraphExternalSemaphoresWaitNodeSetParams:
      ...
      if (data->args.hipGraphExternalSemaphoresWaitNodeSetParams.nodeParams == NULL)
        oss << ", nodeParams=NULL";
      else {
        oss << ", nodeParams=";
        roctracer::hip_support::detail::operator<<(
            oss, data->args.hipGraphExternalSemaphoresWaitNodeSetParams.nodeParams__val);
      }
      oss << ")";
      break;
    case HIP_API_ID_hipGraphGetEdges:
      ...
      oss << "graph=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipGraphGetEdges.graph);
      if (data->args.hipGraphGetEdges.from == NULL)
        oss << ", from=NULL";
      else {
        oss << ", from=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipGraphGetEdges.from__val);
      }
      if (data->args.hipGraphGetEdges.to == NULL)
        oss << ", to=NULL";
      else {
        oss << ", to=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipGraphGetEdges.to__val);
      }
      if (data->args.hipGraphGetEdges.numEdges == NULL)
        oss << ", numEdges=NULL";
      else {
        oss << ", numEdges=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipGraphGetEdges.numEdges__val);
      }
      oss << ")";
      break;
    case HIP_API_ID_hipGraphGetNodes:
      ...
      oss << "graph=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipGraphGetNodes.graph);
      if (data->args.hipGraphGetNodes.nodes == NULL)
        oss << ", nodes=NULL";
      else {
        oss << ", nodes=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipGraphGetNodes.nodes__val);
      }
      if (data->args.hipGraphGetNodes.numNodes == NULL)
        oss << ", numNodes=NULL";
      else {
        oss << ", numNodes=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipGraphGetNodes.numNodes__val);
      }
      oss << ")";
      break;
    case HIP_API_ID_hipGraphGetRootNodes:
      ...
      oss << "graph=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipGraphGetRootNodes.graph);
    ...
    case HIP_API_ID_hipGraphHostNodeGetParams:
      ...
      oss << "node=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipGraphHostNodeGetParams.node);
    ...
    case HIP_API_ID_hipGraphHostNodeSetParams:
      ...
      oss << "node=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipGraphHostNodeSetParams.node);
    ...
    case HIP_API_ID_hipGraphInstantiate:
      ...
      oss << ", graph=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipGraphInstantiate.graph);
      ...
      if (data->args.hipGraphInstantiate.pLogBuffer == NULL)
        ...
        oss << ", pLogBuffer=";
        roctracer::hip_support::detail::operator<<(oss,
                                                   data->args.hipGraphInstantiate.pLogBuffer__val);
      }
      oss << ", bufferSize=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipGraphInstantiate.bufferSize);
      oss << ")";
      break;
    case HIP_API_ID_hipGraphInstantiateWithFlags:
      ...
      oss << ", graph=";
      roctracer::hip_support::detail::operator<<(oss,
                                                 data->args.hipGraphInstantiateWithFlags.graph);
      oss << ", flags=";
      roctracer::hip_support::detail::operator<<(oss,
                                                 data->args.hipGraphInstantiateWithFlags.flags);
      oss << ")";
      break;
    case HIP_API_ID_hipGraphInstantiateWithParams:
      ...
      oss << ", graph=";
      roctracer::hip_support::detail::operator<<(oss,
                                                 data->args.hipGraphInstantiateWithParams.graph);
    ...
    case HIP_API_ID_hipGraphKernelNodeCopyAttributes:
      ...
      oss << "hSrc=";
      roctracer::hip_support::detail::operator<<(oss,
                                                 data->args.hipGraphKernelNodeCopyAttributes.hSrc);
      oss << ", hDst=";
      roctracer::hip_support::detail::operator<<(oss,
                                                 data->args.hipGraphKernelNodeCopyAttributes.hDst);
      oss << ")";
      break;
    case HIP_API_ID_hipGraphKernelNodeGetAttribute:
      ...
      oss << "hNode=";
      roctracer::hip_support::detail::operator<<(oss,
                                                 data->args.hipGraphKernelNodeGetAttribute.hNode);
      oss << ", attr=";
      roctracer::hip_support::detail::operator<<(oss,
                                                 data->args.hipGraphKernelNodeGetAttribute.attr);
    ...
    case HIP_API_ID_hipGraphKernelNodeGetParams:
      ...
      oss << "node=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipGraphKernelNodeGetParams.node);
    ...
    case HIP_API_ID_hipGraphKernelNodeSetAttribute:
      ...
      oss << "hNode=";
      roctracer::hip_support::detail::operator<<(oss,
                                                 data->args.hipGraphKernelNodeSetAttribute.hNode);
      oss << ", attr=";
      roctracer::hip_support::detail::operator<<(oss,
                                                 data->args.hipGraphKernelNodeSetAttribute.attr);
    ...
    case HIP_API_ID_hipGraphKernelNodeSetParams:
      ...
      oss << "node=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipGraphKernelNodeSetParams.node);
    ...
    case HIP_API_ID_hipGraphLaunch:
      oss << "hipGraphLaunch(";
      oss << "graphExec=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipGraphLaunch.graphExec);
      oss << ", stream=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipGraphLaunch.stream);
      oss << ")";
      break;
    case HIP_API_ID_hipGraphMemAllocNodeGetParams:
      ...
      oss << "node=";
      roctracer::hip_support::detail::operator<<(oss,
                                                 data->args.hipGraphMemAllocNodeGetParams.node);
    ...
    case HIP_API_ID_hipGraphMemFreeNodeGetParams:
      ...
      oss << "node=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipGraphMemFreeNodeGetParams.node);
      oss << ", dev_ptr=";
      roctracer::hip_support::detail::operator<<(oss,
                                                 data->args.hipGraphMemFreeNodeGetParams.dev_ptr);
      oss << ")";
      break;
    case HIP_API_ID_hipGraphMemcpyNodeGetParams:
      oss << "hipGraphMemcpyNodeGetParams(";
      oss << "node=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipGraphMemcpyNodeGetParams.node);
    ...
    case HIP_API_ID_hipGraphMemcpyNodeSetParams:
      ...
      oss << "node=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipGraphMemcpyNodeSetParams.node);
    ...
    case HIP_API_ID_hipGraphMemcpyNodeSetParams1D:
      ...
      oss << "node=";
      roctracer::hip_support::detail::operator<<(oss,
                                                 data->args.hipGraphMemcpyNodeSetParams1D.node);
      oss << ", dst=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipGraphMemcpyNodeSetParams1D.dst);
      oss << ", src=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipGraphMemcpyNodeSetParams1D.src);
      oss << ", count=";
      roctracer::hip_support::detail::operator<<(oss,
                                                 data->args.hipGraphMemcpyNodeSetParams1D.count);
      oss << ", kind=";
      roctracer::hip_support::detail::operator<<(oss,
                                                 data->args.hipGraphMemcpyNodeSetParams1D.kind);
      oss << ")";
      break;
    case HIP_API_ID_hipGraphMemcpyNodeSetParamsFromSymbol:
    ...
    case HIP_API_ID_hipGraphMemsetNodeGetParams:
      ...
      oss << "node=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipGraphMemsetNodeGetParams.node);
    ...
    case HIP_API_ID_hipGraphNodeFindInClone:
      ...
      oss << ", originalNode=";
      roctracer::hip_support::detail::operator<<(oss,
                                                 data->args.hipGraphNodeFindInClone.originalNode);
      oss << ", clonedGraph=";
      roctracer::hip_support::detail::operator<<(oss,
                                                 data->args.hipGraphNodeFindInClone.clonedGraph);
      oss << ")";
      break;
    case HIP_API_ID_hipGraphNodeGetDependencies:
      oss << "hipGraphNodeGetDependencies(";
      oss << "node=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipGraphNodeGetDependencies.node);
    ...
    case HIP_API_ID_hipGraphNodeGetDependentNodes:
      ...
      oss << "node=";
      roctracer::hip_support::detail::operator<<(oss,
                                                 data->args.hipGraphNodeGetDependentNodes.node);
      ...
      if (data->args.hipGraphNodeGetDependentNodes.pNumDependentNodes == NULL)
        ...
        roctracer::hip_support::detail::operator<<(
            oss, data->args.hipGraphNodeGetDependentNodes.pNumDependentNodes__val);
      }
      oss << ")";
      break;
    case HIP_API_ID_hipGraphNodeGetEnabled:
      ...
      oss << "hGraphExec=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipGraphNodeGetEnabled.hGraphExec);
      oss << ", hNode=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipGraphNodeGetEnabled.hNode);
    ...
    case HIP_API_ID_hipGraphNodeGetType:
      ...
      oss << "node=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipGraphNodeGetType.node);
      if (data->args.hipGraphNodeGetType.pType == NULL)
        oss << ", pType=NULL";
      else {
        oss << ", pType=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipGraphNodeGetType.pType__val);
      }
      oss << ")";
      break;
    case HIP_API_ID_hipGraphNodeSetEnabled:
      ...
      oss << "hGraphExec=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipGraphNodeSetEnabled.hGraphExec);
      oss << ", hNode=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipGraphNodeSetEnabled.hNode);
      oss << ", isEnabled=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipGraphNodeSetEnabled.isEnabled);
      oss << ")";
      break;
    case HIP_API_ID_hipGraphNodeSetParams:
      oss << "hipGraphNodeSetParams(";
      oss << "node=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipGraphNodeSetParams.node);
    ...
    case HIP_API_ID_hipGraphReleaseUserObject:
      ...
      oss << "graph=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipGraphReleaseUserObject.graph);
      oss << ", object=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipGraphReleaseUserObject.object);
      oss << ", count=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipGraphReleaseUserObject.count);
      oss << ")";
      break;
    case HIP_API_ID_hipGraphRemoveDependencies:
      oss << "hipGraphRemoveDependencies(";
      oss << "graph=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipGraphRemoveDependencies.graph);
    ...
    case HIP_API_ID_hipGraphRetainUserObject:
      ...
      oss << "graph=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipGraphRetainUserObject.graph);
      oss << ", object=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipGraphRetainUserObject.object);
      oss << ", count=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipGraphRetainUserObject.count);
      oss << ", flags=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipGraphRetainUserObject.flags);
      oss << ")";
      break;
    case HIP_API_ID_hipGraphUpload:
      oss << "hipGraphUpload(";
      oss << "graphExec=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipGraphUpload.graphExec);
      oss << ", stream=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipGraphUpload.stream);
      oss << ")";
      break;
    case HIP_API_ID_hipGraphicsGLRegisterBuffer:
      ...
      oss << ", buffer=";
      roctracer::hip_support::detail::operator<<(oss,
                                                 data->args.hipGraphicsGLRegisterBuffer.buffer);
      oss << ", flags=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipGraphicsGLRegisterBuffer.flags);
      oss << ")";
      break;
    case HIP_API_ID_hipGraphicsGLRegisterImage:
      ...
      oss << ", image=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipGraphicsGLRegisterImage.image);
      oss << ", target=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipGraphicsGLRegisterImage.target);
      oss << ", flags=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipGraphicsGLRegisterImage.flags);
      oss << ")";
      break;
    case HIP_API_ID_hipGraphicsMapResources:
      oss << "hipGraphicsMapResources(";
      oss << "count=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipGraphicsMapResources.count);
      ...
      oss << ", stream=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipGraphicsMapResources.stream);
      oss << ")";
      break;
    case HIP_API_ID_hipGraphicsResourceGetMappedPointer:
    ...
    case HIP_API_ID_hipGraphicsUnmapResources:
      ...
      oss << "count=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipGraphicsUnmapResources.count);
      ...
      oss << ", stream=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipGraphicsUnmapResources.stream);
      oss << ")";
      break;
    case HIP_API_ID_hipGraphicsUnregisterResource:
      ...
      oss << "resource=";
      roctracer::hip_support::detail::operator<<(oss,
                                                 data->args.hipGraphicsUnregisterResource.resource);
      oss << ")";
      break;
    case HIP_API_ID_hipHccModuleLaunchKernel:
      oss << "hipHccModuleLaunchKernel(";
      oss << "f=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipHccModuleLaunchKernel.f);
      oss << ", globalWorkSizeX=";
      roctracer::hip_support::detail::operator<<(
      ...
      oss << ", hStream=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipHccModuleLaunchKernel.hStream);
      ...
      oss << ", startEvent=";
      roctracer::hip_support::detail::operator<<(oss,
                                                 data->args.hipHccModuleLaunchKernel.startEvent);
      oss << ", stopEvent=";
      roctracer::hip_support::detail::operator<<(oss,
                                                 data->args.hipHccModuleLaunchKernel.stopEvent);
      oss << ")";
      break;
    case HIP_API_ID_hipHostAlloc:
      oss << "hipHostAlloc(";
      if (data->args.hipHostAlloc.ptr == NULL)
        ...
        oss << "ptr=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipHostAlloc.ptr__val);
      }
      oss << ", size=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipHostAlloc.size);
      oss << ", flags=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipHostAlloc.flags);
      oss << ")";
      break;
    case HIP_API_ID_hipHostFree:
      oss << "hipHostFree(";
    ...
    case HIP_API_ID_hipHostGetDevicePointer:
      ...
      oss << ", hstPtr=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipHostGetDevicePointer.hstPtr);
      oss << ", flags=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipHostGetDevicePointer.flags);
      oss << ")";
      break;
    case HIP_API_ID_hipHostGetFlags:
      oss << "hipHostGetFlags(";
      if (data->args.hipHostGetFlags.flagsPtr == NULL)
        ...
        oss << "flagsPtr=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipHostGetFlags.flagsPtr__val);
      }
      oss << ", hostPtr=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipHostGetFlags.hostPtr);
      oss << ")";
      break;
    case HIP_API_ID_hipHostMalloc:
      oss << "hipHostMalloc(";
      if (data->args.hipHostMalloc.ptr == NULL)
        ...
        oss << "ptr=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipHostMalloc.ptr__val);
      }
      oss << ", size=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipHostMalloc.size);
      oss << ", flags=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipHostMalloc.flags);
      oss << ")";
      break;
    case HIP_API_ID_hipHostRegister:
      oss << "hipHostRegister(";
      oss << "hostPtr=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipHostRegister.hostPtr);
      oss << ", sizeBytes=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipHostRegister.sizeBytes);
      oss << ", flags=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipHostRegister.flags);
      oss << ")";
      break;
    case HIP_API_ID_hipHostUnregister:
      oss << "hipHostUnregister(";
      oss << "hostPtr=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipHostUnregister.hostPtr);
      oss << ")";
      break;
    case HIP_API_ID_hipImportExternalMemory:
    ...
    case HIP_API_ID_hipIpcCloseMemHandle:
      ...
      oss << "devPtr=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipIpcCloseMemHandle.devPtr);
      oss << ")";
      break;
    case HIP_API_ID_hipIpcGetEventHandle:
      ...
      oss << ", event=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipIpcGetEventHandle.event);
      oss << ")";
      break;
    case HIP_API_ID_hipIpcGetMemHandle:
      ...
      if (data->args.hipIpcGetMemHandle.handle == NULL)
        ...
        oss << "handle=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipIpcGetMemHandle.handle__val);
      }
      oss << ", devPtr=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipIpcGetMemHandle.devPtr);
      oss << ")";
      break;
    case HIP_API_ID_hipIpcOpenEventHandle:
      ...
      oss << ", handle=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipIpcOpenEventHandle.handle);
      oss << ")";
      break;
    case HIP_API_ID_hipIpcOpenMemHandle:
      ...
      if (data->args.hipIpcOpenMemHandle.devPtr == NULL)
        ...
        oss << "devPtr=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipIpcOpenMemHandle.devPtr__val);
      }
      oss << ", handle=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipIpcOpenMemHandle.handle);
      oss << ", flags=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipIpcOpenMemHandle.flags);
      oss << ")";
      break;
    case HIP_API_ID_hipLaunchByPtr:
      oss << "hipLaunchByPtr(";
      oss << "hostFunction=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipLaunchByPtr.hostFunction);
      oss << ")";
      break;
    case HIP_API_ID_hipLaunchCooperativeKernel:
      oss << "hipLaunchCooperativeKernel(";
      oss << "f=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipLaunchCooperativeKernel.f);
      oss << ", gridDim=";
      roctracer::hip_support::detail::operator<<(oss,
                                                 data->args.hipLaunchCooperativeKernel.gridDim);
      oss << ", blockDimX=";
      roctracer::hip_support::detail::operator<<(oss,
                                                 data->args.hipLaunchCooperativeKernel.blockDimX);
      ...
      oss << ", stream=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipLaunchCooperativeKernel.stream);
      oss << ")";
      break;
    case HIP_API_ID_hipLaunchCooperativeKernelMultiDevice:
      oss << "hipLaunchCooperativeKernelMultiDevice(";
      if (data->args.hipLaunchCooperativeKernelMultiDevice.launchParamsList == NULL)
        oss << "launchParamsList=NULL";
      else {
        oss << "launchParamsList=";
        roctracer::hip_support::detail::operator<<(
            oss, data->args.hipLaunchCooperativeKernelMultiDevice.launchParamsList__val);
      }
      oss << ", numDevices=";
      roctracer::hip_support::detail::operator<<(
    ...
    case HIP_API_ID_hipLaunchHostFunc:
      ...
      oss << "stream=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipLaunchHostFunc.stream);
      oss << ", fn=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipLaunchHostFunc.fn);
      oss << ", userData=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipLaunchHostFunc.userData);
      oss << ")";
      break;
    case HIP_API_ID_hipLaunchKernel:
      oss << "hipLaunchKernel(";
      oss << "function_address=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipLaunchKernel.function_address);
      oss << ", numBlocks=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipLaunchKernel.numBlocks);
      oss << ", dimBlocks=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipLaunchKernel.dimBlocks);
      if (data->args.hipLaunchKernel.args == NULL)
        oss << ", args=NULL";
      else {
        oss << ", args=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipLaunchKernel.args__val);
      }
      oss << ", sharedMemBytes=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipLaunchKernel.sharedMemBytes);
      oss << ", stream=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipLaunchKernel.stream);
      oss << ")";
      break;
    case HIP_API_ID_hipLaunchKernelExC:
      ...
      if (data->args.hipLaunchKernelExC.config == NULL)
        ...
        oss << "config=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipLaunchKernelExC.config__val);
      }
      oss << ", fPtr=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipLaunchKernelExC.fPtr);
      if (data->args.hipLaunchKernelExC.args == NULL)
        oss << ", args=NULL";
      else {
        oss << ", args=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipLaunchKernelExC.args__val);
      }
      oss << ")";
      break;
    case HIP_API_ID_hipLinkAddData:
      oss << "hipLinkAddData(";
      oss << "state=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipLinkAddData.state);
      oss << ", type=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipLinkAddData.type);
      oss << ", data=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipLinkAddData.data);
      oss << ", size=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipLinkAddData.size);
      if (data->args.hipLinkAddData.name == NULL)
        oss << ", name=NULL";
      else {
        oss << ", name=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipLinkAddData.name__val);
      }
      oss << ", numOptions=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipLinkAddData.numOptions);
      if (data->args.hipLinkAddData.options == NULL)
        oss << ", options=NULL";
      else {
        oss << ", options=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipLinkAddData.options__val);
      }
    ...
    case HIP_API_ID_hipLinkAddFile:
      oss << "hipLinkAddFile(";
      oss << "state=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipLinkAddFile.state);
      oss << ", type=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipLinkAddFile.type);
      if (data->args.hipLinkAddFile.path == NULL)
        oss << ", path=NULL";
      else {
        oss << ", path=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipLinkAddFile.path__val);
      }
      oss << ", numOptions=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipLinkAddFile.numOptions);
      if (data->args.hipLinkAddFile.options == NULL)
        oss << ", options=NULL";
      else {
        oss << ", options=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipLinkAddFile.options__val);
      }
    ...
    case HIP_API_ID_hipLinkComplete:
      oss << "hipLinkComplete(";
      oss << "state=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipLinkComplete.state);
      if (data->args.hipLinkComplete.hipBinOut == NULL)
        oss << ", hipBinOut=NULL";
      else {
        oss << ", hipBinOut=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipLinkComplete.hipBinOut__val);
      }
      if (data->args.hipLinkComplete.sizeOut == NULL)
        oss << ", sizeOut=NULL";
      else {
        oss << ", sizeOut=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipLinkComplete.sizeOut__val);
      }
      oss << ")";
      break;
    case HIP_API_ID_hipLinkCreate:
      oss << "hipLinkCreate(";
      oss << "numOptions=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipLinkCreate.numOptions);
      if (data->args.hipLinkCreate.options == NULL)
        oss << ", options=NULL";
      else {
        oss << ", options=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipLinkCreate.options__val);
      }
      if (data->args.hipLinkCreate.optionValues == NULL)
        oss << ", optionValues=NULL";
      else {
        oss << ", optionValues=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipLinkCreate.optionValues__val);
      }
      if (data->args.hipLinkCreate.stateOut == NULL)
        oss << ", stateOut=NULL";
      else {
        oss << ", stateOut=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipLinkCreate.stateOut__val);
      }
      oss << ")";
      break;
    case HIP_API_ID_hipLinkDestroy:
      oss << "hipLinkDestroy(";
      oss << "state=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipLinkDestroy.state);
      oss << ")";
      break;
    case HIP_API_ID_hipMalloc:
      oss << "hipMalloc(";
      if (data->args.hipMalloc.ptr == NULL)
        ...
        oss << "ptr=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipMalloc.ptr__val);
      }
      oss << ", size=";
    ...
    case HIP_API_ID_hipMalloc3D:
      ...
      if (data->args.hipMalloc3D.pitchedDevPtr == NULL)
        ...
        oss << "pitchedDevPtr=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipMalloc3D.pitchedDevPtr__val);
      }
      oss << ", extent=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMalloc3D.extent);
      oss << ")";
      break;
    case HIP_API_ID_hipMalloc3DArray:
      ...
      if (data->args.hipMalloc3DArray.array == NULL)
        ...
        oss << "array=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipMalloc3DArray.array__val);
      }
      if (data->args.hipMalloc3DArray.desc == NULL)
        oss << ", desc=NULL";
      else {
        oss << ", desc=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipMalloc3DArray.desc__val);
      }
      oss << ", extent=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMalloc3DArray.extent);
      oss << ", flags=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMalloc3DArray.flags);
      oss << ")";
      break;
    case HIP_API_ID_hipMallocArray:
      oss << "hipMallocArray(";
      if (data->args.hipMallocArray.array == NULL)
        ...
        oss << "array=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipMallocArray.array__val);
      }
      if (data->args.hipMallocArray.desc == NULL)
        oss << ", desc=NULL";
      else {
        oss << ", desc=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipMallocArray.desc__val);
      }
      oss << ", width=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMallocArray.width);
      oss << ", height=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMallocArray.height);
      oss << ", flags=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMallocArray.flags);
      oss << ")";
      break;
    case HIP_API_ID_hipMallocAsync:
      oss << "hipMallocAsync(";
      if (data->args.hipMallocAsync.dev_ptr == NULL)
        ...
        oss << "dev_ptr=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipMallocAsync.dev_ptr__val);
      }
      oss << ", size=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMallocAsync.size);
      oss << ", stream=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMallocAsync.stream);
      oss << ")";
      break;
    case HIP_API_ID_hipMallocFromPoolAsync:
      ...
      oss << ", size=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMallocFromPoolAsync.size);
      oss << ", mem_pool=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMallocFromPoolAsync.mem_pool);
      oss << ", stream=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMallocFromPoolAsync.stream);
      oss << ")";
      break;
    case HIP_API_ID_hipMallocHost:
      oss << "hipMallocHost(";
      if (data->args.hipMallocHost.ptr == NULL)
        ...
        oss << "ptr=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipMallocHost.ptr__val);
      }
      oss << ", size=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMallocHost.size);
      oss << ")";
      break;
    case HIP_API_ID_hipMallocManaged:
      ...
      if (data->args.hipMallocManaged.dev_ptr == NULL)
        ...
        oss << "dev_ptr=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipMallocManaged.dev_ptr__val);
      }
      oss << ", size=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMallocManaged.size);
      oss << ", flags=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMallocManaged.flags);
      oss << ")";
      break;
    case HIP_API_ID_hipMallocMipmappedArray:
      ...
      oss << ", extent=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMallocMipmappedArray.extent);
      oss << ", numLevels=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMallocMipmappedArray.numLevels);
      oss << ", flags=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMallocMipmappedArray.flags);
      oss << ")";
      break;
    case HIP_API_ID_hipMallocPitch:
      oss << "hipMallocPitch(";
      if (data->args.hipMallocPitch.ptr == NULL)
        ...
        oss << "ptr=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipMallocPitch.ptr__val);
      }
      if (data->args.hipMallocPitch.pitch == NULL)
        oss << ", pitch=NULL";
      else {
        oss << ", pitch=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipMallocPitch.pitch__val);
      }
      oss << ", width=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMallocPitch.width);
      oss << ", height=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMallocPitch.height);
      oss << ")";
      break;
    case HIP_API_ID_hipMemAddressFree:
      oss << "hipMemAddressFree(";
      oss << "devPtr=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemAddressFree.devPtr);
      oss << ", size=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemAddressFree.size);
      oss << ")";
      break;
    case HIP_API_ID_hipMemAddressReserve:
      ...
      if (data->args.hipMemAddressReserve.ptr == NULL)
        ...
        oss << "ptr=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipMemAddressReserve.ptr__val);
      }
      oss << ", size=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemAddressReserve.size);
      oss << ", alignment=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemAddressReserve.alignment);
      oss << ", addr=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemAddressReserve.addr);
      oss << ", flags=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemAddressReserve.flags);
      oss << ")";
      break;
    case HIP_API_ID_hipMemAdvise:
      oss << "hipMemAdvise(";
      oss << "dev_ptr=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemAdvise.dev_ptr);
      oss << ", count=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemAdvise.count);
      oss << ", advice=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemAdvise.advice);
      oss << ", device=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemAdvise.device);
      oss << ")";
      break;
    case HIP_API_ID_hipMemAdvise_v2:
      oss << "hipMemAdvise_v2(";
      oss << "dev_ptr=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemAdvise_v2.dev_ptr);
      oss << ", count=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemAdvise_v2.count);
      oss << ", advice=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemAdvise_v2.advice);
      oss << ", location=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemAdvise_v2.location);
      oss << ")";
      break;
    case HIP_API_ID_hipMemAllocHost:
      oss << "hipMemAllocHost(";
      if (data->args.hipMemAllocHost.ptr == NULL)
        ...
        oss << "ptr=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipMemAllocHost.ptr__val);
      }
      oss << ", size=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemAllocHost.size);
      oss << ")";
      break;
    case HIP_API_ID_hipMemAllocPitch:
      ...
      if (data->args.hipMemAllocPitch.dptr == NULL)
        ...
        oss << "dptr=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipMemAllocPitch.dptr__val);
      }
      if (data->args.hipMemAllocPitch.pitch == NULL)
        oss << ", pitch=NULL";
      else {
        oss << ", pitch=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipMemAllocPitch.pitch__val);
      }
      oss << ", widthInBytes=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemAllocPitch.widthInBytes);
      oss << ", height=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemAllocPitch.height);
      oss << ", elementSizeBytes=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemAllocPitch.elementSizeBytes);
      oss << ")";
      break;
    case HIP_API_ID_hipMemCreate:
      oss << "hipMemCreate(";
      if (data->args.hipMemCreate.handle == NULL)
        ...
        oss << "handle=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipMemCreate.handle__val);
      }
      oss << ", size=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemCreate.size);
      if (data->args.hipMemCreate.prop == NULL)
        oss << ", prop=NULL";
      else {
        oss << ", prop=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipMemCreate.prop__val);
      }
      oss << ", flags=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemCreate.flags);
      oss << ")";
      break;
    case HIP_API_ID_hipMemExportToShareableHandle:
      ...
      oss << ", handle=";
      roctracer::hip_support::detail::operator<<(oss,
                                                 data->args.hipMemExportToShareableHandle.handle);
      oss << ", handleType=";
      roctracer::hip_support::detail::operator<<(
          oss, data->args.hipMemExportToShareableHandle.handleType);
      oss << ", flags=";
      roctracer::hip_support::detail::operator<<(oss,
                                                 data->args.hipMemExportToShareableHandle.flags);
      oss << ")";
      break;
    case HIP_API_ID_hipMemGetAccess:
      oss << "hipMemGetAccess(";
      if (data->args.hipMemGetAccess.flags == NULL)
        ...
        oss << "flags=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipMemGetAccess.flags__val);
      }
      if (data->args.hipMemGetAccess.location == NULL)
        oss << ", location=NULL";
      else {
        oss << ", location=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipMemGetAccess.location__val);
      }
      oss << ", ptr=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemGetAccess.ptr);
      oss << ")";
      break;
    case HIP_API_ID_hipMemGetAddressRange:
      ...
      oss << ", dptr=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemGetAddressRange.dptr);
      oss << ")";
      break;
    case HIP_API_ID_hipMemGetAllocationGranularity:
      ...
      oss << ", option=";
      roctracer::hip_support::detail::operator<<(oss,
                                                 data->args.hipMemGetAllocationGranularity.option);
      oss << ")";
      break;
    case HIP_API_ID_hipMemGetAllocationPropertiesFromHandle:
    ...
    case HIP_API_ID_hipMemGetInfo:
      ...
      if (data->args.hipMemGetInfo.free == NULL)
        ...
        oss << "free=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipMemGetInfo.free__val);
      }
      if (data->args.hipMemGetInfo.total == NULL)
        oss << ", total=NULL";
      else {
        oss << ", total=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipMemGetInfo.total__val);
      }
      oss << ")";
      break;
    case HIP_API_ID_hipMemImportFromShareableHandle:
    ...
    case HIP_API_ID_hipMemMap:
      ...
      oss << ", offset=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemMap.offset);
      oss << ", handle=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemMap.handle);
      oss << ", flags=";
    ...
    case HIP_API_ID_hipMemMapArrayAsync:
      ...
      oss << ", count=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemMapArrayAsync.count);
      oss << ", stream=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemMapArrayAsync.stream);
      oss << ")";
      break;
    case HIP_API_ID_hipMemPoolCreate:
      ...
      if (data->args.hipMemPoolCreate.mem_pool == NULL)
        ...
        oss << "mem_pool=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipMemPoolCreate.mem_pool__val);
      }
    ...
    case HIP_API_ID_hipMemPoolDestroy:
      ...
      oss << "mem_pool=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemPoolDestroy.mem_pool);
      oss << ")";
      break;
    case HIP_API_ID_hipMemPoolExportPointer:
      ...
      oss << ", dev_ptr=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemPoolExportPointer.dev_ptr);
      oss << ")";
      break;
    case HIP_API_ID_hipMemPoolExportToShareableHandle:
    ...
    case HIP_API_ID_hipMemPoolGetAccess:
      ...
      if (data->args.hipMemPoolGetAccess.flags == NULL)
        ...
        oss << "flags=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipMemPoolGetAccess.flags__val);
      }
      oss << ", mem_pool=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemPoolGetAccess.mem_pool);
    ...
    case HIP_API_ID_hipMemPoolGetAttribute:
      ...
      oss << "mem_pool=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemPoolGetAttribute.mem_pool);
      oss << ", attr=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemPoolGetAttribute.attr);
      oss << ", value=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemPoolGetAttribute.value);
      oss << ")";
      break;
    case HIP_API_ID_hipMemPoolImportFromShareableHandle:
    ...
    case HIP_API_ID_hipMemPoolImportPointer:
      ...
      oss << ", mem_pool=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemPoolImportPointer.mem_pool);
    ...
    case HIP_API_ID_hipMemPoolSetAccess:
      ...
      oss << "mem_pool=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemPoolSetAccess.mem_pool);
      ...
      oss << ", count=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemPoolSetAccess.count);
      oss << ")";
      break;
    case HIP_API_ID_hipMemPoolSetAttribute:
      oss << "hipMemPoolSetAttribute(";
      oss << "mem_pool=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemPoolSetAttribute.mem_pool);
      oss << ", attr=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemPoolSetAttribute.attr);
      oss << ", value=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemPoolSetAttribute.value);
      oss << ")";
      break;
    case HIP_API_ID_hipMemPoolTrimTo:
      oss << "hipMemPoolTrimTo(";
      oss << "mem_pool=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemPoolTrimTo.mem_pool);
      oss << ", min_bytes_to_hold=";
      roctracer::hip_support::detail::operator<<(oss,
                                                 data->args.hipMemPoolTrimTo.min_bytes_to_hold);
      oss << ")";
      break;
    case HIP_API_ID_hipMemPrefetchAsync:
      oss << "hipMemPrefetchAsync(";
      oss << "dev_ptr=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemPrefetchAsync.dev_ptr);
      oss << ", count=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemPrefetchAsync.count);
      oss << ", device=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemPrefetchAsync.device);
      oss << ", stream=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemPrefetchAsync.stream);
      oss << ")";
      break;
    case HIP_API_ID_hipMemPrefetchAsync_v2:
      oss << "hipMemPrefetchAsync_v2(";
      oss << "dev_ptr=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemPrefetchAsync_v2.dev_ptr);
      oss << ", count=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemPrefetchAsync_v2.count);
      oss << ", location=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemPrefetchAsync_v2.location);
      oss << ", flags=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemPrefetchAsync_v2.flags);
      oss << ", stream=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemPrefetchAsync_v2.stream);
      oss << ")";
      break;
    case HIP_API_ID_hipMemPtrGetInfo:
      oss << "hipMemPtrGetInfo(";
      oss << "ptr=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemPtrGetInfo.ptr);
      if (data->args.hipMemPtrGetInfo.size == NULL)
        oss << ", size=NULL";
      else {
        oss << ", size=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipMemPtrGetInfo.size__val);
      }
      oss << ")";
      break;
    case HIP_API_ID_hipMemRangeGetAttribute:
      ...
      oss << "data=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemRangeGetAttribute.data);
      oss << ", data_size=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemRangeGetAttribute.data_size);
      oss << ", attribute=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemRangeGetAttribute.attribute);
      oss << ", dev_ptr=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemRangeGetAttribute.dev_ptr);
      oss << ", count=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemRangeGetAttribute.count);
      oss << ")";
      break;
    case HIP_API_ID_hipMemRangeGetAttributes:
      ...
      oss << ", dev_ptr=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemRangeGetAttributes.dev_ptr);
      oss << ", count=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemRangeGetAttributes.count);
      oss << ")";
      break;
    case HIP_API_ID_hipMemRelease:
      oss << "hipMemRelease(";
      oss << "handle=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemRelease.handle);
      oss << ")";
      break;
    case HIP_API_ID_hipMemRetainAllocationHandle:
      ...
      oss << ", addr=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemRetainAllocationHandle.addr);
      oss << ")";
      break;
    case HIP_API_ID_hipMemSetAccess:
      oss << "hipMemSetAccess(";
      oss << "ptr=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemSetAccess.ptr);
      oss << ", size=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemSetAccess.size);
      if (data->args.hipMemSetAccess.desc == NULL)
        oss << ", desc=NULL";
      else {
        oss << ", desc=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipMemSetAccess.desc__val);
      }
      oss << ", count=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemSetAccess.count);
      oss << ")";
      break;
    case HIP_API_ID_hipMemUnmap:
      oss << "hipMemUnmap(";
      ...
      oss << ", size=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemUnmap.size);
      oss << ")";
      break;
    case HIP_API_ID_hipMemcpy:
      oss << "hipMemcpy(";
      ...
      oss << ", sizeBytes=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpy.sizeBytes);
      oss << ", kind=";
    ...
    case HIP_API_ID_hipMemcpy2D:
      ...
      oss << ", dpitch=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpy2D.dpitch);
      oss << ", src=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpy2D.src);
      oss << ", spitch=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpy2D.spitch);
      oss << ", width=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpy2D.width);
      oss << ", height=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpy2D.height);
      oss << ", kind=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpy2D.kind);
      oss << ")";
      break;
    case HIP_API_ID_hipMemcpy2DArrayToArray:
      oss << "hipMemcpy2DArrayToArray(";
      oss << "dst=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpy2DArrayToArray.dst);
      oss << ", wOffsetDst=";
      roctracer::hip_support::detail::operator<<(oss,
                                                 data->args.hipMemcpy2DArrayToArray.wOffsetDst);
      oss << ", hOffsetDst=";
      roctracer::hip_support::detail::operator<<(oss,
                                                 data->args.hipMemcpy2DArrayToArray.hOffsetDst);
      oss << ", src=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpy2DArrayToArray.src);
      oss << ", wOffsetSrc=";
      roctracer::hip_support::detail::operator<<(oss,
                                                 data->args.hipMemcpy2DArrayToArray.wOffsetSrc);
      oss << ", hOffsetSrc=";
      roctracer::hip_support::detail::operator<<(oss,
                                                 data->args.hipMemcpy2DArrayToArray.hOffsetSrc);
      oss << ", width=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpy2DArrayToArray.width);
      oss << ", height=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpy2DArrayToArray.height);
      oss << ", kind=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpy2DArrayToArray.kind);
      oss << ")";
      break;
    case HIP_API_ID_hipMemcpy2DAsync:
      oss << "hipMemcpy2DAsync(";
      oss << "dst=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpy2DAsync.dst);
      oss << ", dpitch=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpy2DAsync.dpitch);
      oss << ", src=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpy2DAsync.src);
      oss << ", spitch=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpy2DAsync.spitch);
      oss << ", width=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpy2DAsync.width);
      oss << ", height=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpy2DAsync.height);
      oss << ", kind=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpy2DAsync.kind);
      oss << ", stream=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpy2DAsync.stream);
      oss << ")";
      break;
    case HIP_API_ID_hipMemcpy2DFromArray:
      oss << "hipMemcpy2DFromArray(";
      oss << "dst=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpy2DFromArray.dst);
      oss << ", dpitch=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpy2DFromArray.dpitch);
      oss << ", src=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpy2DFromArray.src);
      oss << ", wOffset=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpy2DFromArray.wOffset);
      oss << ", hOffset=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpy2DFromArray.hOffset);
      oss << ", width=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpy2DFromArray.width);
      oss << ", height=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpy2DFromArray.height);
      oss << ", kind=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpy2DFromArray.kind);
      oss << ")";
      break;
    case HIP_API_ID_hipMemcpy2DFromArrayAsync:
      oss << "hipMemcpy2DFromArrayAsync(";
      oss << "dst=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpy2DFromArrayAsync.dst);
      oss << ", dpitch=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpy2DFromArrayAsync.dpitch);
      oss << ", src=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpy2DFromArrayAsync.src);
      oss << ", wOffset=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpy2DFromArrayAsync.wOffset);
      oss << ", hOffset=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpy2DFromArrayAsync.hOffset);
      oss << ", width=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpy2DFromArrayAsync.width);
      oss << ", height=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpy2DFromArrayAsync.height);
      oss << ", kind=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpy2DFromArrayAsync.kind);
      oss << ", stream=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpy2DFromArrayAsync.stream);
      oss << ")";
      break;
    case HIP_API_ID_hipMemcpy2DToArray:
      oss << "hipMemcpy2DToArray(";
      oss << "dst=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpy2DToArray.dst);
      oss << ", wOffset=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpy2DToArray.wOffset);
      oss << ", hOffset=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpy2DToArray.hOffset);
      oss << ", src=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpy2DToArray.src);
      oss << ", spitch=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpy2DToArray.spitch);
      oss << ", width=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpy2DToArray.width);
      oss << ", height=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpy2DToArray.height);
      oss << ", kind=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpy2DToArray.kind);
      oss << ")";
      break;
    case HIP_API_ID_hipMemcpy2DToArrayAsync:
      oss << "hipMemcpy2DToArrayAsync(";
      oss << "dst=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpy2DToArrayAsync.dst);
      oss << ", wOffset=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpy2DToArrayAsync.wOffset);
      oss << ", hOffset=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpy2DToArrayAsync.hOffset);
      oss << ", src=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpy2DToArrayAsync.src);
      oss << ", spitch=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpy2DToArrayAsync.spitch);
      oss << ", width=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpy2DToArrayAsync.width);
      oss << ", height=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpy2DToArrayAsync.height);
      oss << ", kind=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpy2DToArrayAsync.kind);
      oss << ", stream=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpy2DToArrayAsync.stream);
      oss << ")";
      break;
    case HIP_API_ID_hipMemcpy3D:
      oss << "hipMemcpy3D(";
      if (data->args.hipMemcpy3D.p == NULL)
        ...
        oss << "p=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpy3D.p__val);
      }
      oss << ")";
      break;
    case HIP_API_ID_hipMemcpy3DAsync:
      ...
      if (data->args.hipMemcpy3DAsync.p == NULL)
        ...
        oss << "p=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpy3DAsync.p__val);
      }
      oss << ", stream=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpy3DAsync.stream);
      oss << ")";
      break;
    case HIP_API_ID_hipMemcpy3DBatchAsync:
      oss << "hipMemcpy3DBatchAsync(";
      oss << "numOps=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpy3DBatchAsync.numOps);
      ...
      oss << ", flags=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpy3DBatchAsync.flags);
      oss << ", stream=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpy3DBatchAsync.stream);
      oss << ")";
      break;
    case HIP_API_ID_hipMemcpy3DPeer:
      oss << "hipMemcpy3DPeer(";
      if (data->args.hipMemcpy3DPeer.p == NULL)
        ...
        oss << "p=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpy3DPeer.p__val);
      }
      oss << ")";
      break;
    case HIP_API_ID_hipMemcpy3DPeerAsync:
      ...
      if (data->args.hipMemcpy3DPeerAsync.p == NULL)
        ...
        oss << "p=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpy3DPeerAsync.p__val);
      }
      oss << ", stream=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpy3DPeerAsync.stream);
      oss << ")";
      break;
    case HIP_API_ID_hipMemcpyAsync:
      oss << "hipMemcpyAsync(";
      oss << "dst=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyAsync.dst);
      oss << ", src=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyAsync.src);
      oss << ", sizeBytes=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyAsync.sizeBytes);
      oss << ", kind=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyAsync.kind);
      oss << ", stream=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyAsync.stream);
      oss << ")";
      break;
    case HIP_API_ID_hipMemcpyAtoA:
      oss << "hipMemcpyAtoA(";
      oss << "dstArray=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyAtoA.dstArray);
      oss << ", dstOffset=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyAtoA.dstOffset);
      oss << ", srcArray=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyAtoA.srcArray);
      oss << ", srcOffset=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyAtoA.srcOffset);
      oss << ", ByteCount=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyAtoA.ByteCount);
      oss << ")";
      break;
    case HIP_API_ID_hipMemcpyAtoD:
      oss << "hipMemcpyAtoD(";
      oss << "dstDevice=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyAtoD.dstDevice);
      oss << ", srcArray=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyAtoD.srcArray);
      oss << ", srcOffset=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyAtoD.srcOffset);
      oss << ", ByteCount=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyAtoD.ByteCount);
      oss << ")";
      break;
    case HIP_API_ID_hipMemcpyAtoH:
      oss << "hipMemcpyAtoH(";
      oss << "dst=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyAtoH.dst);
      oss << ", srcArray=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyAtoH.srcArray);
      oss << ", srcOffset=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyAtoH.srcOffset);
      oss << ", count=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyAtoH.count);
      oss << ")";
      break;
    case HIP_API_ID_hipMemcpyAtoHAsync:
      oss << "hipMemcpyAtoHAsync(";
      oss << "dstHost=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyAtoHAsync.dstHost);
      oss << ", srcArray=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyAtoHAsync.srcArray);
      oss << ", srcOffset=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyAtoHAsync.srcOffset);
      oss << ", ByteCount=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyAtoHAsync.ByteCount);
      oss << ", stream=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyAtoHAsync.stream);
      oss << ")";
      break;
    case HIP_API_ID_hipMemcpyBatchAsync:
      ...
      if (data->args.hipMemcpyBatchAsync.dsts == NULL)
        ...
        oss << "dsts=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyBatchAsync.dsts__val);
      }
      if (data->args.hipMemcpyBatchAsync.srcs == NULL)
        oss << ", srcs=NULL";
      else {
        oss << ", srcs=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyBatchAsync.srcs__val);
      }
      if (data->args.hipMemcpyBatchAsync.sizes == NULL)
        oss << ", sizes=NULL";
      else {
        oss << ", sizes=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyBatchAsync.sizes__val);
      }
      oss << ", count=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyBatchAsync.count);
      if (data->args.hipMemcpyBatchAsync.attrs == NULL)
        oss << ", attrs=NULL";
      else {
        oss << ", attrs=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyBatchAsync.attrs__val);
      }
      ...
      oss << ", numAttrs=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyBatchAsync.numAttrs);
      ...
      oss << ", stream=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyBatchAsync.stream);
      oss << ")";
      break;
    case HIP_API_ID_hipMemcpyDtoA:
      oss << "hipMemcpyDtoA(";
      oss << "dstArray=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyDtoA.dstArray);
      oss << ", dstOffset=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyDtoA.dstOffset);
      oss << ", srcDevice=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyDtoA.srcDevice);
      oss << ", ByteCount=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyDtoA.ByteCount);
      oss << ")";
      break;
    case HIP_API_ID_hipMemcpyDtoD:
      oss << "hipMemcpyDtoD(";
      oss << "dst=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyDtoD.dst);
      oss << ", src=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyDtoD.src);
      oss << ", sizeBytes=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyDtoD.sizeBytes);
      oss << ")";
      break;
    case HIP_API_ID_hipMemcpyDtoDAsync:
      oss << "hipMemcpyDtoDAsync(";
      oss << "dst=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyDtoDAsync.dst);
      oss << ", src=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyDtoDAsync.src);
      oss << ", sizeBytes=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyDtoDAsync.sizeBytes);
      oss << ", stream=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyDtoDAsync.stream);
      oss << ")";
      break;
    case HIP_API_ID_hipMemcpyDtoH:
      oss << "hipMemcpyDtoH(";
      oss << "dst=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyDtoH.dst);
      oss << ", src=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyDtoH.src);
      oss << ", sizeBytes=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyDtoH.sizeBytes);
      oss << ")";
      break;
    case HIP_API_ID_hipMemcpyDtoHAsync:
      oss << "hipMemcpyDtoHAsync(";
      oss << "dst=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyDtoHAsync.dst);
      oss << ", src=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyDtoHAsync.src);
      oss << ", sizeBytes=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyDtoHAsync.sizeBytes);
      oss << ", stream=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyDtoHAsync.stream);
      oss << ")";
      break;
    case HIP_API_ID_hipMemcpyFromArray:
      oss << "hipMemcpyFromArray(";
      oss << "dst=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyFromArray.dst);
      oss << ", srcArray=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyFromArray.srcArray);
      oss << ", wOffset=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyFromArray.wOffset);
      oss << ", hOffset=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyFromArray.hOffset);
      oss << ", count=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyFromArray.count);
      oss << ", kind=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyFromArray.kind);
      oss << ")";
      break;
    case HIP_API_ID_hipMemcpyFromSymbol:
      oss << "hipMemcpyFromSymbol(";
      oss << "dst=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyFromSymbol.dst);
      oss << ", symbol=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyFromSymbol.symbol);
      oss << ", sizeBytes=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyFromSymbol.sizeBytes);
      oss << ", offset=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyFromSymbol.offset);
      oss << ", kind=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyFromSymbol.kind);
      oss << ")";
      break;
    case HIP_API_ID_hipMemcpyFromSymbolAsync:
      oss << "hipMemcpyFromSymbolAsync(";
      oss << "dst=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyFromSymbolAsync.dst);
      oss << ", symbol=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyFromSymbolAsync.symbol);
      oss << ", sizeBytes=";
      roctracer::hip_support::detail::operator<<(oss,
                                                 data->args.hipMemcpyFromSymbolAsync.sizeBytes);
      oss << ", offset=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyFromSymbolAsync.offset);
      oss << ", kind=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyFromSymbolAsync.kind);
      oss << ", stream=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyFromSymbolAsync.stream);
      oss << ")";
      break;
    case HIP_API_ID_hipMemcpyHtoA:
      oss << "hipMemcpyHtoA(";
      oss << "dstArray=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyHtoA.dstArray);
      oss << ", dstOffset=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyHtoA.dstOffset);
      oss << ", srcHost=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyHtoA.srcHost);
      oss << ", count=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyHtoA.count);
      oss << ")";
      break;
    case HIP_API_ID_hipMemcpyHtoAAsync:
      oss << "hipMemcpyHtoAAsync(";
      oss << "dstArray=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyHtoAAsync.dstArray);
      oss << ", dstOffset=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyHtoAAsync.dstOffset);
      oss << ", srcHost=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyHtoAAsync.srcHost);
      oss << ", ByteCount=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyHtoAAsync.ByteCount);
      oss << ", stream=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyHtoAAsync.stream);
      oss << ")";
      break;
    case HIP_API_ID_hipMemcpyHtoD:
      oss << "hipMemcpyHtoD(";
      oss << "dst=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyHtoD.dst);
      oss << ", src=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyHtoD.src);
      oss << ", sizeBytes=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyHtoD.sizeBytes);
      oss << ")";
      break;
    case HIP_API_ID_hipMemcpyHtoDAsync:
      oss << "hipMemcpyHtoDAsync(";
      oss << "dst=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyHtoDAsync.dst);
      oss << ", src=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyHtoDAsync.src);
      oss << ", sizeBytes=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyHtoDAsync.sizeBytes);
      oss << ", stream=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyHtoDAsync.stream);
      oss << ")";
      break;
    case HIP_API_ID_hipMemcpyParam2D:
      ...
      if (data->args.hipMemcpyParam2D.pCopy == NULL)
        ...
        oss << "pCopy=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyParam2D.pCopy__val);
      }
      oss << ")";
      break;
    case HIP_API_ID_hipMemcpyParam2DAsync:
      ...
      oss << ", stream=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyParam2DAsync.stream);
      oss << ")";
      break;
    case HIP_API_ID_hipMemcpyPeer:
      oss << "hipMemcpyPeer(";
      oss << "dst=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyPeer.dst);
      oss << ", dstDeviceId=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyPeer.dstDeviceId);
      oss << ", src=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyPeer.src);
      oss << ", srcDeviceId=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyPeer.srcDeviceId);
      oss << ", sizeBytes=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyPeer.sizeBytes);
      oss << ")";
      break;
    case HIP_API_ID_hipMemcpyPeerAsync:
      oss << "hipMemcpyPeerAsync(";
      oss << "dst=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyPeerAsync.dst);
      oss << ", dstDeviceId=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyPeerAsync.dstDeviceId);
      oss << ", src=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyPeerAsync.src);
      oss << ", srcDevice=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyPeerAsync.srcDevice);
      oss << ", sizeBytes=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyPeerAsync.sizeBytes);
      oss << ", stream=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyPeerAsync.stream);
      oss << ")";
      break;
    case HIP_API_ID_hipMemcpyToArray:
      oss << "hipMemcpyToArray(";
      oss << "dst=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyToArray.dst);
      oss << ", wOffset=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyToArray.wOffset);
      oss << ", hOffset=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyToArray.hOffset);
      oss << ", src=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyToArray.src);
      oss << ", count=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyToArray.count);
      oss << ", kind=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyToArray.kind);
      oss << ")";
      break;
    case HIP_API_ID_hipMemcpyToSymbol:
      oss << "hipMemcpyToSymbol(";
      oss << "symbol=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyToSymbol.symbol);
      oss << ", src=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyToSymbol.src);
      oss << ", sizeBytes=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyToSymbol.sizeBytes);
      oss << ", offset=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyToSymbol.offset);
      oss << ", kind=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyToSymbol.kind);
      oss << ")";
      break;
    case HIP_API_ID_hipMemcpyToSymbolAsync:
      oss << "hipMemcpyToSymbolAsync(";
      oss << "symbol=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyToSymbolAsync.symbol);
      oss << ", src=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyToSymbolAsync.src);
      oss << ", sizeBytes=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyToSymbolAsync.sizeBytes);
      oss << ", offset=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyToSymbolAsync.offset);
      oss << ", kind=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyToSymbolAsync.kind);
      oss << ", stream=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyToSymbolAsync.stream);
      oss << ")";
      break;
    case HIP_API_ID_hipMemcpyWithStream:
      oss << "hipMemcpyWithStream(";
      oss << "dst=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyWithStream.dst);
      oss << ", src=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyWithStream.src);
      oss << ", sizeBytes=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyWithStream.sizeBytes);
      oss << ", kind=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyWithStream.kind);
      oss << ", stream=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemcpyWithStream.stream);
      oss << ")";
      break;
    case HIP_API_ID_hipMemset:
      oss << "hipMemset(";
      ...
      oss << ", sizeBytes=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemset.sizeBytes);
      oss << ")";
      break;
    case HIP_API_ID_hipMemset2D:
      oss << "hipMemset2D(";
      ...
      oss << ", pitch=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemset2D.pitch);
      oss << ", value=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemset2D.value);
      oss << ", width=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemset2D.width);
      oss << ", height=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemset2D.height);
      oss << ")";
      break;
    case HIP_API_ID_hipMemset2DAsync:
      oss << "hipMemset2DAsync(";
      oss << "dst=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemset2DAsync.dst);
      oss << ", pitch=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemset2DAsync.pitch);
      oss << ", value=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemset2DAsync.value);
      oss << ", width=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemset2DAsync.width);
      oss << ", height=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemset2DAsync.height);
      oss << ", stream=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemset2DAsync.stream);
      oss << ")";
      break;
    case HIP_API_ID_hipMemset3D:
      oss << "hipMemset3D(";
      oss << "pitchedDevPtr=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemset3D.pitchedDevPtr);
      oss << ", value=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemset3D.value);
      oss << ", extent=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemset3D.extent);
      oss << ")";
      break;
    case HIP_API_ID_hipMemset3DAsync:
      oss << "hipMemset3DAsync(";
      oss << "pitchedDevPtr=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemset3DAsync.pitchedDevPtr);
      oss << ", value=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemset3DAsync.value);
      oss << ", extent=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemset3DAsync.extent);
      oss << ", stream=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemset3DAsync.stream);
      oss << ")";
      break;
    case HIP_API_ID_hipMemsetAsync:
      oss << "hipMemsetAsync(";
      oss << "dst=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemsetAsync.dst);
      oss << ", value=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemsetAsync.value);
      oss << ", sizeBytes=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemsetAsync.sizeBytes);
      oss << ", stream=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemsetAsync.stream);
      oss << ")";
      break;
    case HIP_API_ID_hipMemsetD16:
      oss << "hipMemsetD16(";
      oss << "dest=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemsetD16.dest);
      oss << ", value=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemsetD16.value);
      oss << ", count=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemsetD16.count);
      oss << ")";
      break;
    case HIP_API_ID_hipMemsetD16Async:
      oss << "hipMemsetD16Async(";
      oss << "dest=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemsetD16Async.dest);
      oss << ", value=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemsetD16Async.value);
      oss << ", count=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemsetD16Async.count);
      oss << ", stream=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemsetD16Async.stream);
      oss << ")";
      break;
    case HIP_API_ID_hipMemsetD2D16:
      oss << "hipMemsetD2D16(";
      oss << "dst=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemsetD2D16.dst);
      oss << ", dstPitch=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemsetD2D16.dstPitch);
      oss << ", value=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemsetD2D16.value);
      oss << ", width=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemsetD2D16.width);
      oss << ", height=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemsetD2D16.height);
      oss << ")";
      break;
    case HIP_API_ID_hipMemsetD2D16Async:
      oss << "hipMemsetD2D16Async(";
      oss << "dst=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemsetD2D16Async.dst);
      oss << ", dstPitch=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemsetD2D16Async.dstPitch);
      oss << ", value=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemsetD2D16Async.value);
      oss << ", width=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemsetD2D16Async.width);
      oss << ", height=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemsetD2D16Async.height);
      oss << ", stream=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemsetD2D16Async.stream);
      oss << ")";
      break;
    case HIP_API_ID_hipMemsetD2D32:
      oss << "hipMemsetD2D32(";
      oss << "dst=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemsetD2D32.dst);
      oss << ", dstPitch=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemsetD2D32.dstPitch);
      oss << ", value=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemsetD2D32.value);
      oss << ", width=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemsetD2D32.width);
      oss << ", height=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemsetD2D32.height);
      oss << ")";
      break;
    case HIP_API_ID_hipMemsetD2D32Async:
      oss << "hipMemsetD2D32Async(";
      oss << "dst=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemsetD2D32Async.dst);
      oss << ", dstPitch=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemsetD2D32Async.dstPitch);
      oss << ", value=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemsetD2D32Async.value);
      oss << ", width=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemsetD2D32Async.width);
      oss << ", height=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemsetD2D32Async.height);
      oss << ", stream=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemsetD2D32Async.stream);
      oss << ")";
      break;
    case HIP_API_ID_hipMemsetD2D8:
      oss << "hipMemsetD2D8(";
      oss << "dst=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemsetD2D8.dst);
      oss << ", dstPitch=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemsetD2D8.dstPitch);
      oss << ", value=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemsetD2D8.value);
      oss << ", width=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemsetD2D8.width);
      oss << ", height=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemsetD2D8.height);
      oss << ")";
      break;
    case HIP_API_ID_hipMemsetD2D8Async:
      oss << "hipMemsetD2D8Async(";
      oss << "dst=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemsetD2D8Async.dst);
      oss << ", dstPitch=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemsetD2D8Async.dstPitch);
      oss << ", value=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemsetD2D8Async.value);
      oss << ", width=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemsetD2D8Async.width);
      oss << ", height=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemsetD2D8Async.height);
      oss << ", stream=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemsetD2D8Async.stream);
      oss << ")";
      break;
    case HIP_API_ID_hipMemsetD32:
      oss << "hipMemsetD32(";
      oss << "dest=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemsetD32.dest);
      oss << ", value=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemsetD32.value);
      oss << ", count=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemsetD32.count);
      oss << ")";
      break;
    case HIP_API_ID_hipMemsetD32Async:
      oss << "hipMemsetD32Async(";
      oss << "dst=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemsetD32Async.dst);
      oss << ", value=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemsetD32Async.value);
      oss << ", count=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemsetD32Async.count);
      oss << ", stream=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemsetD32Async.stream);
      oss << ")";
      break;
    case HIP_API_ID_hipMemsetD8:
      oss << "hipMemsetD8(";
      oss << "dest=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemsetD8.dest);
      oss << ", value=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemsetD8.value);
      oss << ", count=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemsetD8.count);
      oss << ")";
      break;
    case HIP_API_ID_hipMemsetD8Async:
      oss << "hipMemsetD8Async(";
      oss << "dest=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemsetD8Async.dest);
      oss << ", value=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemsetD8Async.value);
      oss << ", count=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemsetD8Async.count);
      oss << ", stream=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMemsetD8Async.stream);
      oss << ")";
      break;
    case HIP_API_ID_hipMipmappedArrayCreate:
    ...
    case HIP_API_ID_hipMipmappedArrayGetLevel:
      ...
      oss << ", level=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipMipmappedArrayGetLevel.level);
      oss << ")";
      break;
    case HIP_API_ID_hipMipmappedArrayGetMemoryRequirements:
      oss << "hipMipmappedArrayGetMemoryRequirements(";
      if (data->args.hipMipmappedArrayGetMemoryRequirements.memoryRequirements == NULL)
        oss << "memoryRequirements=NULL";
      else {
        oss << "memoryRequirements=";
        roctracer::hip_support::detail::operator<<(
            oss, data->args.hipMipmappedArrayGetMemoryRequirements.memoryRequirements__val);
      }
      oss << ", mipmap=";
      roctracer::hip_support::detail::operator<<(
          oss, data->args.hipMipmappedArrayGetMemoryRequirements.mipmap);
      oss << ", device=";
      roctracer::hip_support::detail::operator<<(
          oss, data->args.hipMipmappedArrayGetMemoryRequirements.device);
      oss << ")";
      break;
    case HIP_API_ID_hipModuleGetFunction:
      ...
      oss << ", module=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipModuleGetFunction.module);
      if (data->args.hipModuleGetFunction.kname == NULL)
        oss << ", kname=NULL";
      else {
        oss << ", kname=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipModuleGetFunction.kname__val);
      }
      oss << ")";
      break;
    case HIP_API_ID_hipModuleGetGlobal:
      ...
      if (data->args.hipModuleGetGlobal.dptr == NULL)
        ...
        oss << "dptr=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipModuleGetGlobal.dptr__val);
      }
      if (data->args.hipModuleGetGlobal.bytes == NULL)
        oss << ", bytes=NULL";
      else {
        oss << ", bytes=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipModuleGetGlobal.bytes__val);
      }
      oss << ", hmod=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipModuleGetGlobal.hmod);
      if (data->args.hipModuleGetGlobal.name == NULL)
        oss << ", name=NULL";
      else {
        oss << ", name=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipModuleGetGlobal.name__val);
      }
      oss << ")";
      break;
    case HIP_API_ID_hipModuleGetTexRef:
      ...
      oss << ", hmod=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipModuleGetTexRef.hmod);
      if (data->args.hipModuleGetTexRef.name == NULL)
        oss << ", name=NULL";
      else {
        oss << ", name=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipModuleGetTexRef.name__val);
      }
      oss << ")";
      break;
    case HIP_API_ID_hipModuleLaunchCooperativeKernel:
    ...
    case HIP_API_ID_hipModuleLaunchCooperativeKernelMultiDevice:
      ...
      if (data->args.hipModuleLaunchCooperativeKernelMultiDevice.launchParamsList == NULL)
        oss << "launchParamsList=NULL";
      else {
        oss << "launchParamsList=";
        roctracer::hip_support::detail::operator<<(
            oss, data->args.hipModuleLaunchCooperativeKernelMultiDevice.launchParamsList__val);
      }
      oss << ", numDevices=";
      roctracer::hip_support::detail::operator<<(
    ...
    case HIP_API_ID_hipModuleLaunchKernel:
      ...
      oss << "f=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipModuleLaunchKernel.f);
      oss << ", gridDimX=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipModuleLaunchKernel.gridDimX);
      oss << ", gridDimY=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipModuleLaunchKernel.gridDimY);
      oss << ", gridDimZ=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipModuleLaunchKernel.gridDimZ);
      oss << ", blockDimX=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipModuleLaunchKernel.blockDimX);
      oss << ", blockDimY=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipModuleLaunchKernel.blockDimY);
      oss << ", blockDimZ=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipModuleLaunchKernel.blockDimZ);
      oss << ", sharedMemBytes=";
      roctracer::hip_support::detail::operator<<(oss,
                                                 data->args.hipModuleLaunchKernel.sharedMemBytes);
      oss << ", stream=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipModuleLaunchKernel.stream);
    ...
    case HIP_API_ID_hipModuleLoadFatBinary:
      ...
      oss << ", fatbin=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipModuleLoadFatBinary.fatbin);
      oss << ")";
      break;
    case HIP_API_ID_hipModuleLoad:
      oss << "hipModuleLoad(";
      if (data->args.hipModuleLoad.module == NULL)
        ...
        oss << "module=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipModuleLoad.module__val);
      }
      if (data->args.hipModuleLoad.fname == NULL)
        oss << ", fname=NULL";
      else {
        oss << ", fname=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipModuleLoad.fname__val);
      }
      oss << ")";
      break;
    case HIP_API_ID_hipModuleLoadData:
      ...
      if (data->args.hipModuleLoadData.module == NULL)
        ...
        oss << "module=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipModuleLoadData.module__val);
      }
      oss << ", image=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipModuleLoadData.image);
      oss << ")";
      break;
    case HIP_API_ID_hipModuleLoadDataEx:
      ...
      if (data->args.hipModuleLoadDataEx.module == NULL)
        ...
        oss << "module=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipModuleLoadDataEx.module__val);
      }
      oss << ", image=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipModuleLoadDataEx.image);
      oss << ", numOptions=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipModuleLoadDataEx.numOptions);
    ...
    case HIP_API_ID_hipModuleOccupancyMaxActiveBlocksPerMultiprocessor:
      ...
      if (data->args.hipModuleOccupancyMaxActiveBlocksPerMultiprocessor.numBlocks == NULL)
        oss << "numBlocks=NULL";
      else {
        oss << "numBlocks=";
        roctracer::hip_support::detail::operator<<(
            oss, data->args.hipModuleOccupancyMaxActiveBlocksPerMultiprocessor.numBlocks__val);
      }
      oss << ", f=";
      roctracer::hip_support::detail::operator<<(
    ...
    case HIP_API_ID_hipModuleOccupancyMaxActiveBlocksPerMultiprocessorWithFlags:
      ...
      if (data->args.hipModuleOccupancyMaxActiveBlocksPerMultiprocessorWithFlags.numBlocks == NULL)
        oss << "numBlocks=NULL";
      else {
        oss << "numBlocks=";
        roctracer::hip_support::detail::operator<<(
    ...
    case HIP_API_ID_hipModuleOccupancyMaxPotentialBlockSize:
      ...
      if (data->args.hipModuleOccupancyMaxPotentialBlockSize.gridSize == NULL)
        ...
        oss << "gridSize=";
        roctracer::hip_support::detail::operator<<(
            oss, data->args.hipModuleOccupancyMaxPotentialBlockSize.gridSize__val);
      }
      if (data->args.hipModuleOccupancyMaxPotentialBlockSize.blockSize == NULL)
        ...
        oss << ", blockSize=";
        roctracer::hip_support::detail::operator<<(
            oss, data->args.hipModuleOccupancyMaxPotentialBlockSize.blockSize__val);
      }
      oss << ", f=";
      roctracer::hip_support::detail::operator<<(
    ...
    case HIP_API_ID_hipModuleOccupancyMaxPotentialBlockSizeWithFlags:
      ...
      if (data->args.hipModuleOccupancyMaxPotentialBlockSizeWithFlags.gridSize == NULL)
        oss << "gridSize=NULL";
      else {
        oss << "gridSize=";
        roctracer::hip_support::detail::operator<<(
            oss, data->args.hipModuleOccupancyMaxPotentialBlockSizeWithFlags.gridSize__val);
      }
      if (data->args.hipModuleOccupancyMaxPotentialBlockSizeWithFlags.blockSize == NULL)
        oss << ", blockSize=NULL";
      else {
        oss << ", blockSize=";
        roctracer::hip_support::detail::operator<<(
            oss, data->args.hipModuleOccupancyMaxPotentialBlockSizeWithFlags.blockSize__val);
      }
      oss << ", f=";
      roctracer::hip_support::detail::operator<<(
    ...
    case HIP_API_ID_hipModuleUnload:
      oss << "hipModuleUnload(";
      oss << "module=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipModuleUnload.module);
      oss << ")";
      break;
    case HIP_API_ID_hipOccupancyMaxActiveBlocksPerMultiprocessor:
      oss << "hipOccupancyMaxActiveBlocksPerMultiprocessor(";
      if (data->args.hipOccupancyMaxActiveBlocksPerMultiprocessor.numBlocks == NULL)
        oss << "numBlocks=NULL";
      else {
        oss << "numBlocks=";
        roctracer::hip_support::detail::operator<<(
            oss, data->args.hipOccupancyMaxActiveBlocksPerMultiprocessor.numBlocks__val);
      }
      oss << ", f=";
      roctracer::hip_support::detail::operator<<(
    ...
    case HIP_API_ID_hipOccupancyMaxActiveBlocksPerMultiprocessorWithFlags:
      ...
      if (data->args.hipOccupancyMaxActiveBlocksPerMultiprocessorWithFlags.numBlocks == NULL)
        oss << "numBlocks=NULL";
      else {
        oss << "numBlocks=";
        roctracer::hip_support::detail::operator<<(
            oss, data->args.hipOccupancyMaxActiveBlocksPerMultiprocessorWithFlags.numBlocks__val);
      }
      oss << ", f=";
      roctracer::hip_support::detail::operator<<(
    ...
    case HIP_API_ID_hipOccupancyMaxPotentialBlockSize:
      ...
      oss << ", f=";
      roctracer::hip_support::detail::operator<<(oss,
                                                 data->args.hipOccupancyMaxPotentialBlockSize.f);
      oss << ", dynSharedMemPerBlk=";
      roctracer::hip_support::detail::operator<<(
    ...
    case HIP_API_ID_hipPointerGetAttribute:
      ...
      oss << "data=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipPointerGetAttribute.data);
      oss << ", attribute=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipPointerGetAttribute.attribute);
      oss << ", ptr=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipPointerGetAttribute.ptr);
      oss << ")";
      break;
    case HIP_API_ID_hipPointerGetAttributes:
      ...
      oss << ", ptr=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipPointerGetAttributes.ptr);
      oss << ")";
      break;
    case HIP_API_ID_hipPointerSetAttribute:
      oss << "hipPointerSetAttribute(";
      oss << "value=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipPointerSetAttribute.value);
      oss << ", attribute=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipPointerSetAttribute.attribute);
      oss << ", ptr=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipPointerSetAttribute.ptr);
      oss << ")";
      break;
    case HIP_API_ID_hipProfilerStart:
    ...
    case HIP_API_ID_hipSetDevice:
      oss << "hipSetDevice(";
      oss << "deviceId=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipSetDevice.deviceId);
      oss << ")";
      break;
    case HIP_API_ID_hipSetDeviceFlags:
      oss << "hipSetDeviceFlags(";
      oss << "flags=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipSetDeviceFlags.flags);
      oss << ")";
      break;
    case HIP_API_ID_hipSetValidDevices:
      ...
      oss << ", len=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipSetValidDevices.len);
      oss << ")";
      break;
    case HIP_API_ID_hipSetupArgument:
      oss << "hipSetupArgument(";
      oss << "arg=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipSetupArgument.arg);
      oss << ", size=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipSetupArgument.size);
      oss << ", offset=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipSetupArgument.offset);
      oss << ")";
      break;
    case HIP_API_ID_hipSignalExternalSemaphoresAsync:
    ...
    case HIP_API_ID_hipStreamAddCallback:
      ...
      oss << "stream=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipStreamAddCallback.stream);
      oss << ", callback=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipStreamAddCallback.callback);
      oss << ", userData=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipStreamAddCallback.userData);
      oss << ", flags=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipStreamAddCallback.flags);
      oss << ")";
      break;
    case HIP_API_ID_hipStreamAttachMemAsync:
      oss << "hipStreamAttachMemAsync(";
      oss << "stream=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipStreamAttachMemAsync.stream);
      oss << ", dev_ptr=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipStreamAttachMemAsync.dev_ptr);
      oss << ", length=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipStreamAttachMemAsync.length);
      oss << ", flags=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipStreamAttachMemAsync.flags);
      oss << ")";
      break;
    case HIP_API_ID_hipStreamBatchMemOp:
      oss << "hipStreamBatchMemOp(";
      oss << "stream=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipStreamBatchMemOp.stream);
      oss << ", count=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipStreamBatchMemOp.count);
      ...
      oss << ", flags=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipStreamBatchMemOp.flags);
      oss << ")";
      break;
    case HIP_API_ID_hipStreamBeginCapture:
      oss << "hipStreamBeginCapture(";
      oss << "stream=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipStreamBeginCapture.stream);
      oss << ", mode=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipStreamBeginCapture.mode);
      oss << ")";
      break;
    case HIP_API_ID_hipStreamBeginCaptureToGraph:
      ...
      oss << "stream=";
      roctracer::hip_support::detail::operator<<(oss,
                                                 data->args.hipStreamBeginCaptureToGraph.stream);
      oss << ", graph=";
      roctracer::hip_support::detail::operator<<(oss,
                                                 data->args.hipStreamBeginCaptureToGraph.graph);
      ...
      oss << ", mode=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipStreamBeginCaptureToGraph.mode);
      oss << ")";
      break;
    case HIP_API_ID_hipStreamCreate:
      oss << "hipStreamCreate(";
      if (data->args.hipStreamCreate.stream == NULL)
        ...
        oss << "stream=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipStreamCreate.stream__val);
      }
      oss << ")";
      break;
    case HIP_API_ID_hipStreamCreateWithFlags:
      ...
      oss << ", flags=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipStreamCreateWithFlags.flags);
      oss << ")";
      break;
    case HIP_API_ID_hipStreamCreateWithPriority:
      ...
      oss << ", flags=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipStreamCreateWithPriority.flags);
      oss << ", priority=";
      roctracer::hip_support::detail::operator<<(oss,
    ...
    case HIP_API_ID_hipStreamDestroy:
      ...
      oss << "stream=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipStreamDestroy.stream);
      oss << ")";
      break;
    case HIP_API_ID_hipStreamEndCapture:
      oss << "hipStreamEndCapture(";
      oss << "stream=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipStreamEndCapture.stream);
      if (data->args.hipStreamEndCapture.pGraph == NULL)
        oss << ", pGraph=NULL";
      else {
        oss << ", pGraph=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipStreamEndCapture.pGraph__val);
      }
      oss << ")";
      break;
    case HIP_API_ID_hipStreamGetAttribute:
      ...
      oss << "stream=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipStreamGetAttribute.stream);
      oss << ", attr=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipStreamGetAttribute.attr);
    ...
    case HIP_API_ID_hipStreamGetCaptureInfo:
      ...
      oss << "stream=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipStreamGetCaptureInfo.stream);
    ...
    case HIP_API_ID_hipStreamGetCaptureInfo_v2:
      ...
      oss << "stream=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipStreamGetCaptureInfo_v2.stream);
      ...
      if (data->args.hipStreamGetCaptureInfo_v2.dependencies_out == NULL)
        ...
        roctracer::hip_support::detail::operator<<(
            oss, (void*)data->args.hipStreamGetCaptureInfo_v2.dependencies_out__val);
      }
    ...
    case HIP_API_ID_hipStreamGetDevice:
      ...
      oss << "stream=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipStreamGetDevice.stream);
      if (data->args.hipStreamGetDevice.device == NULL)
        oss << ", device=NULL";
      else {
        oss << ", device=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipStreamGetDevice.device__val);
      }
      oss << ")";
      break;
    case HIP_API_ID_hipStreamGetFlags:
      ...
      oss << "stream=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipStreamGetFlags.stream);
      if (data->args.hipStreamGetFlags.flags == NULL)
        oss << ", flags=NULL";
      else {
        oss << ", flags=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipStreamGetFlags.flags__val);
      }
      oss << ")";
      break;
    case HIP_API_ID_hipStreamGetId:
      oss << "hipStreamGetId(";
      oss << "stream=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipStreamGetId.stream);
      if (data->args.hipStreamGetId.streamId == NULL)
        oss << ", streamId=NULL";
      else {
        oss << ", streamId=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipStreamGetId.streamId__val);
      }
      oss << ")";
      break;
    case HIP_API_ID_hipStreamGetPriority:
      ...
      oss << "stream=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipStreamGetPriority.stream);
    ...
    case HIP_API_ID_hipStreamIsCapturing:
      ...
      oss << "stream=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipStreamIsCapturing.stream);
    ...
    case HIP_API_ID_hipStreamQuery:
      oss << "hipStreamQuery(";
      oss << "stream=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipStreamQuery.stream);
      oss << ")";
      break;
    case HIP_API_ID_hipStreamSetAttribute:
      oss << "hipStreamSetAttribute(";
      oss << "stream=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipStreamSetAttribute.stream);
      oss << ", attr=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipStreamSetAttribute.attr);
    ...
    case HIP_API_ID_hipStreamSynchronize:
      ...
      oss << "stream=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipStreamSynchronize.stream);
      oss << ")";
      break;
    case HIP_API_ID_hipStreamUpdateCaptureDependencies:
    ...
    case HIP_API_ID_hipStreamWaitEvent:
      ...
      oss << "stream=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipStreamWaitEvent.stream);
      oss << ", event=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipStreamWaitEvent.event);
      oss << ", flags=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipStreamWaitEvent.flags);
      oss << ")";
      break;
    case HIP_API_ID_hipStreamWaitValue32:
      oss << "hipStreamWaitValue32(";
      oss << "stream=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipStreamWaitValue32.stream);
      oss << ", ptr=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipStreamWaitValue32.ptr);
      oss << ", value=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipStreamWaitValue32.value);
      oss << ", flags=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipStreamWaitValue32.flags);
      oss << ", mask=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipStreamWaitValue32.mask);
      oss << ")";
      break;
    case HIP_API_ID_hipStreamWaitValue64:
      oss << "hipStreamWaitValue64(";
      oss << "stream=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipStreamWaitValue64.stream);
      oss << ", ptr=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipStreamWaitValue64.ptr);
      oss << ", value=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipStreamWaitValue64.value);
      oss << ", flags=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipStreamWaitValue64.flags);
      oss << ", mask=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipStreamWaitValue64.mask);
      oss << ")";
      break;
    case HIP_API_ID_hipStreamWriteValue32:
      oss << "hipStreamWriteValue32(";
      oss << "stream=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipStreamWriteValue32.stream);
      oss << ", ptr=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipStreamWriteValue32.ptr);
      oss << ", value=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipStreamWriteValue32.value);
      oss << ", flags=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipStreamWriteValue32.flags);
      oss << ")";
      break;
    case HIP_API_ID_hipStreamWriteValue64:
      oss << "hipStreamWriteValue64(";
      oss << "stream=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipStreamWriteValue64.stream);
      oss << ", ptr=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipStreamWriteValue64.ptr);
      oss << ", value=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipStreamWriteValue64.value);
      oss << ", flags=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipStreamWriteValue64.flags);
      oss << ")";
      break;
    case HIP_API_ID_hipTexRefGetAddress:
      ...
      if (data->args.hipTexRefGetAddress.texRef == NULL)
        ...
        oss << ", texRef=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipTexRefGetAddress.texRef__val);
      }
      oss << ")";
      break;
    case HIP_API_ID_hipTexRefGetArray:
      ...
      if (data->args.hipTexRefGetArray.pArray == NULL)
        ...
        oss << "pArray=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipTexRefGetArray.pArray__val);
      }
      if (data->args.hipTexRefGetArray.texRef == NULL)
        oss << ", texRef=NULL";
      else {
        oss << ", texRef=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipTexRefGetArray.texRef__val);
      }
      oss << ")";
      break;
    case HIP_API_ID_hipTexRefGetBorderColor:
    ...
    case HIP_API_ID_hipTexRefGetFlags:
      ...
      if (data->args.hipTexRefGetFlags.pFlags == NULL)
        ...
        oss << "pFlags=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipTexRefGetFlags.pFlags__val);
      }
      if (data->args.hipTexRefGetFlags.texRef == NULL)
        oss << ", texRef=NULL";
      else {
        oss << ", texRef=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipTexRefGetFlags.texRef__val);
      }
      oss << ")";
      break;
    case HIP_API_ID_hipTexRefGetFormat:
      ...
      if (data->args.hipTexRefGetFormat.pFormat == NULL)
        ...
        oss << "pFormat=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipTexRefGetFormat.pFormat__val);
      }
      ...
      if (data->args.hipTexRefGetFormat.texRef == NULL)
        ...
        oss << ", texRef=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipTexRefGetFormat.texRef__val);
      }
      oss << ")";
      break;
    case HIP_API_ID_hipTexRefGetMaxAnisotropy:
    ...
    case HIP_API_ID_hipTexRefGetMipmapLevelClamp:
      ...
      if (data->args.hipTexRefGetMipmapLevelClamp.pminMipmapLevelClamp == NULL)
        ...
        roctracer::hip_support::detail::operator<<(
            oss, data->args.hipTexRefGetMipmapLevelClamp.pminMipmapLevelClamp__val);
      }
      if (data->args.hipTexRefGetMipmapLevelClamp.pmaxMipmapLevelClamp == NULL)
        ...
        roctracer::hip_support::detail::operator<<(
            oss, data->args.hipTexRefGetMipmapLevelClamp.pmaxMipmapLevelClamp__val);
      }
    ...
    case HIP_API_ID_hipTexRefSetAddress:
      ...
      if (data->args.hipTexRefSetAddress.texRef == NULL)
        ...
        oss << ", texRef=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipTexRefSetAddress.texRef__val);
      }
      oss << ", dptr=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipTexRefSetAddress.dptr);
      oss << ", bytes=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipTexRefSetAddress.bytes);
      oss << ")";
      break;
    case HIP_API_ID_hipTexRefSetAddress2D:
      ...
      if (data->args.hipTexRefSetAddress2D.desc == NULL)
        ...
        oss << ", desc=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipTexRefSetAddress2D.desc__val);
      }
      oss << ", dptr=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipTexRefSetAddress2D.dptr);
      oss << ", Pitch=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipTexRefSetAddress2D.Pitch);
      oss << ")";
      break;
    case HIP_API_ID_hipTexRefSetArray:
      ...
      if (data->args.hipTexRefSetArray.tex == NULL)
        ...
        oss << "tex=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipTexRefSetArray.tex__val);
      }
      oss << ", array=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipTexRefSetArray.array);
      oss << ", flags=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipTexRefSetArray.flags);
      oss << ")";
      break;
    case HIP_API_ID_hipTexRefSetBorderColor:
    ...
    case HIP_API_ID_hipTexRefSetFlags:
      ...
      if (data->args.hipTexRefSetFlags.texRef == NULL)
        ...
        oss << "texRef=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipTexRefSetFlags.texRef__val);
      }
      oss << ", Flags=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipTexRefSetFlags.Flags);
      oss << ")";
      break;
    case HIP_API_ID_hipTexRefSetFormat:
      ...
      if (data->args.hipTexRefSetFormat.texRef == NULL)
        ...
        oss << "texRef=";
        roctracer::hip_support::detail::operator<<(oss, data->args.hipTexRefSetFormat.texRef__val);
      }
      oss << ", fmt=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipTexRefSetFormat.fmt);
      oss << ", NumPackedComponents=";
      roctracer::hip_support::detail::operator<<(oss,
                                                 data->args.hipTexRefSetFormat.NumPackedComponents);
      oss << ")";
      break;
    case HIP_API_ID_hipTexRefSetMaxAnisotropy:
      ...
      oss << ", maxAniso=";
      roctracer::hip_support::detail::operator<<(oss,
                                                 data->args.hipTexRefSetMaxAnisotropy.maxAniso);
      oss << ")";
      break;
    case HIP_API_ID_hipTexRefSetMipmapLevelBias:
      ...
      oss << ", bias=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipTexRefSetMipmapLevelBias.bias);
      oss << ")";
      break;
    case HIP_API_ID_hipTexRefSetMipmapLevelClamp:
    ...
    case HIP_API_ID_hipTexRefSetMipmappedArray:
      ...
      oss << ", Flags=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipTexRefSetMipmappedArray.Flags);
      oss << ")";
      break;
    case HIP_API_ID_hipThreadExchangeStreamCaptureMode:
    ...
    case HIP_API_ID_hipUserObjectCreate:
      ...
      oss << ", ptr=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipUserObjectCreate.ptr);
      oss << ", destroy=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipUserObjectCreate.destroy);
      oss << ", initialRefcount=";
      roctracer::hip_support::detail::operator<<(oss,
                                                 data->args.hipUserObjectCreate.initialRefcount);
      oss << ", flags=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipUserObjectCreate.flags);
      oss << ")";
      break;
    case HIP_API_ID_hipUserObjectRelease:
      oss << "hipUserObjectRelease(";
      oss << "object=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipUserObjectRelease.object);
      oss << ", count=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipUserObjectRelease.count);
      oss << ")";
      break;
    case HIP_API_ID_hipUserObjectRetain:
      oss << "hipUserObjectRetain(";
      oss << "object=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipUserObjectRetain.object);
      oss << ", count=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipUserObjectRetain.count);
      oss << ")";
      break;
    case HIP_API_ID_hipWaitExternalSemaphoresAsync:
      ...
      oss << ", stream=";
      roctracer::hip_support::detail::operator<<(oss,
                                                 data->args.hipWaitExternalSemaphoresAsync.stream);
      oss << ")";
      break;
    case HIP_API_ID_hipModuleGetFunctionCount:
      ...
      oss << ", mod=";
      roctracer::hip_support::detail::operator<<(oss, data->args.hipModuleGetFunctionCount.mod);
      oss << ")";
      break;
    default:
      oss << "unknown";
