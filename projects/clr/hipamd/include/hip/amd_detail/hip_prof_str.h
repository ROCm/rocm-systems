...
enum hip_api_id_t {
  ...
  HIP_API_ID_hipDevSmResourceSplit = 466,
  HIP_API_ID_hipDevResourceGenerateDesc = 467,
  HIP_API_ID_hipDeviceGetExecutionCtx = 468,
  HIP_API_ID_hipExecutionCtxGetDevResource = 469,
  HIP_API_ID_hipExecutionCtxGetDevice = 470,
  HIP_API_ID_hipExecutionCtxGetId = 471,
  HIP_API_ID_hipStreamGetDevResource = 472,
  HIP_API_ID_hipExecutionCtxRecordEvent = 473,
  HIP_API_ID_hipExecutionCtxSynchronize = 474,
  HIP_API_ID_hipExecutionCtxWaitEvent = 475,
  HIP_API_ID_LAST = 475,
