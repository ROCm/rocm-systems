...
static const char* hipApiNameLayer(uint32_t id) {
  auto* _rec = HipClrGetActiveRecord(0u);
...
static hipError_t hipArray3DCreateLayer(hipArray_t* array,
  ...
  auto* _rec = HipClrGetActiveRecord(1u);
...
static hipError_t hipArray3DGetDescriptorLayer(HIP_ARRAY3D_DESCRIPTOR* pArrayDescriptor,
                                                hipArray_t array) {
  auto* _rec = HipClrGetActiveRecord(2u);
...
static hipError_t hipArrayCreateLayer(hipArray_t* pHandle,
  ...
  auto* _rec = HipClrGetActiveRecord(3u);
...
static hipError_t hipArrayDestroyLayer(hipArray_t array) {
  auto* _rec = HipClrGetActiveRecord(4u);
...
static hipError_t hipArrayGetDescriptorLayer(HIP_ARRAY_DESCRIPTOR* pArrayDescriptor,
                                              hipArray_t array) {
  auto* _rec = HipClrGetActiveRecord(5u);
...
static hipError_t hipArrayGetInfoLayer(hipChannelFormatDesc* desc, hipExtent* extent,
  ...
  auto* _rec = HipClrGetActiveRecord(6u);
...
static hipError_t hipBindTextureLayer(size_t* offset, const textureReference* tex,
                                       ...
                                       size_t size) {
  auto* _rec = HipClrGetActiveRecord(7u);
...
static hipError_t hipBindTexture2DLayer(size_t* offset, const textureReference* tex,
  ...
  auto* _rec = HipClrGetActiveRecord(8u);
...
static hipError_t hipBindTextureToArrayLayer(const textureReference* tex, hipArray_const_t array,
  ...
  auto* _rec = HipClrGetActiveRecord(9u);
...
static hipError_t hipBindTextureToMipmappedArrayLayer(const textureReference* tex,
                                                       ...
                                                       const hipChannelFormatDesc* desc) {
  auto* _rec = HipClrGetActiveRecord(10u);
...
static hipError_t hipChooseDeviceLayer(int* device, const hipDeviceProp_t* prop) {
  auto* _rec = HipClrGetActiveRecord(11u);
...
static hipError_t hipChooseDeviceR0000Layer(int* device, const hipDeviceProp_tR0000* properties) {
  auto* _rec = HipClrGetActiveRecord(12u);
...
static hipError_t hipConfigureCallLayer(dim3 gridDim, dim3 blockDim, size_t sharedMem,
                                         hipStream_t stream) {
  auto* _rec = HipClrGetActiveRecord(13u);
...
static hipError_t hipCreateSurfaceObjectLayer(hipSurfaceObject_t* pSurfObject,
  ...
  auto* _rec = HipClrGetActiveRecord(14u);
...
static hipError_t hipCreateTextureObjectLayer(hipTextureObject_t* pTexObject,
  ...
  auto* _rec = HipClrGetActiveRecord(15u);
...
static hipError_t hipCtxCreateLayer(hipCtx_t* ctx, unsigned int flags, hipDevice_t device) {
  auto* _rec = HipClrGetActiveRecord(16u);
...
static hipError_t hipCtxDestroyLayer(hipCtx_t ctx) {
  auto* _rec = HipClrGetActiveRecord(17u);
...
static hipError_t hipCtxDisablePeerAccessLayer(hipCtx_t peerCtx) {
  auto* _rec = HipClrGetActiveRecord(18u);
...
static hipError_t hipCtxEnablePeerAccessLayer(hipCtx_t peerCtx, unsigned int flags) {
  auto* _rec = HipClrGetActiveRecord(19u);
...
static hipError_t hipCtxGetApiVersionLayer(hipCtx_t ctx, unsigned int* apiVersion) {
  auto* _rec = HipClrGetActiveRecord(20u);
...
static hipError_t hipCtxGetCacheConfigLayer(hipFuncCache_t* cacheConfig) {
  auto* _rec = HipClrGetActiveRecord(21u);
...
static hipError_t hipCtxGetCurrentLayer(hipCtx_t* ctx) {
  auto* _rec = HipClrGetActiveRecord(22u);
...
static hipError_t hipCtxGetDeviceLayer(hipDevice_t* device) {
  auto* _rec = HipClrGetActiveRecord(23u);
...
static hipError_t hipCtxGetFlagsLayer(unsigned int* flags) {
  auto* _rec = HipClrGetActiveRecord(24u);
...
static hipError_t hipCtxGetSharedMemConfigLayer(hipSharedMemConfig* pConfig) {
  auto* _rec = HipClrGetActiveRecord(25u);
...
static hipError_t hipCtxPopCurrentLayer(hipCtx_t* ctx) {
  auto* _rec = HipClrGetActiveRecord(26u);
...
static hipError_t hipCtxPushCurrentLayer(hipCtx_t ctx) {
  auto* _rec = HipClrGetActiveRecord(27u);
...
static hipError_t hipCtxSetCacheConfigLayer(hipFuncCache_t cacheConfig) {
  auto* _rec = HipClrGetActiveRecord(28u);
...
static hipError_t hipCtxSetCurrentLayer(hipCtx_t ctx) {
  auto* _rec = HipClrGetActiveRecord(29u);
...
static hipError_t hipCtxSetSharedMemConfigLayer(hipSharedMemConfig config) {
  auto* _rec = HipClrGetActiveRecord(30u);
...
static hipError_t hipCtxSynchronizeLayer(void) {
  auto* _rec = HipClrGetActiveRecord(31u);
...
static hipError_t hipDestroyExternalMemoryLayer(hipExternalMemory_t extMem) {
  auto* _rec = HipClrGetActiveRecord(32u);
...
static hipError_t hipDestroyExternalSemaphoreLayer(hipExternalSemaphore_t extSem) {
  auto* _rec = HipClrGetActiveRecord(33u);
...
static hipError_t hipDestroySurfaceObjectLayer(hipSurfaceObject_t surfaceObject) {
  auto* _rec = HipClrGetActiveRecord(34u);
...
static hipError_t hipDestroyTextureObjectLayer(hipTextureObject_t textureObject) {
  auto* _rec = HipClrGetActiveRecord(35u);
...
static hipError_t hipDeviceCanAccessPeerLayer(int* canAccessPeer, int deviceId, int peerDeviceId) {
  auto* _rec = HipClrGetActiveRecord(36u);
...
static hipError_t hipDeviceComputeCapabilityLayer(int* major, int* minor, hipDevice_t device) {
  auto* _rec = HipClrGetActiveRecord(37u);
...
static hipError_t hipDeviceDisablePeerAccessLayer(int peerDeviceId) {
  auto* _rec = HipClrGetActiveRecord(38u);
...
static hipError_t hipDeviceEnablePeerAccessLayer(int peerDeviceId, unsigned int flags) {
  auto* _rec = HipClrGetActiveRecord(39u);
...
static hipError_t hipDeviceGetLayer(hipDevice_t* device, int ordinal) {
  auto* _rec = HipClrGetActiveRecord(40u);
...
static hipError_t hipDeviceGetAttributeLayer(int* pi, hipDeviceAttribute_t attr, int deviceId) {
  auto* _rec = HipClrGetActiveRecord(41u);
...
static hipError_t hipDeviceGetByPCIBusIdLayer(int* device, const char* pciBusId) {
  auto* _rec = HipClrGetActiveRecord(42u);
...
static hipError_t hipDeviceGetCacheConfigLayer(hipFuncCache_t* cacheConfig) {
  auto* _rec = HipClrGetActiveRecord(43u);
...
static hipError_t hipDeviceGetDefaultMemPoolLayer(hipMemPool_t* mem_pool, int device) {
  auto* _rec = HipClrGetActiveRecord(44u);
...
static hipError_t hipDeviceGetGraphMemAttributeLayer(int device, hipGraphMemAttributeType attr,
                                                      void* value) {
  auto* _rec = HipClrGetActiveRecord(45u);
...
static hipError_t hipDeviceGetLimitLayer(size_t* pValue, enum hipLimit_t limit) {
  auto* _rec = HipClrGetActiveRecord(46u);
...
static hipError_t hipDeviceGetMemPoolLayer(hipMemPool_t* mem_pool, int device) {
  auto* _rec = HipClrGetActiveRecord(47u);
...
static hipError_t hipDeviceGetNameLayer(char* name, int len, hipDevice_t device) {
  auto* _rec = HipClrGetActiveRecord(48u);
...
static hipError_t hipDeviceGetP2PAttributeLayer(int* value, hipDeviceP2PAttr attr, int srcDevice,
                                                 int dstDevice) {
  auto* _rec = HipClrGetActiveRecord(49u);
...
static hipError_t hipDeviceGetPCIBusIdLayer(char* pciBusId, int len, int device) {
  auto* _rec = HipClrGetActiveRecord(50u);
...
static hipError_t hipDeviceGetSharedMemConfigLayer(hipSharedMemConfig* pConfig) {
  auto* _rec = HipClrGetActiveRecord(51u);
...
static hipError_t hipDeviceGetStreamPriorityRangeLayer(int* leastPriority, int* greatestPriority) {
  auto* _rec = HipClrGetActiveRecord(52u);
...
static hipError_t hipDeviceGetTexture1DLinearMaxWidthLayer(size_t* maxWidthInElements,
                                                            ...
                                                            int device) {
  auto* _rec = HipClrGetActiveRecord(53u);
...
static hipError_t hipDeviceGetUuidLayer(hipUUID* uuid, hipDevice_t device) {
  auto* _rec = HipClrGetActiveRecord(54u);
...
static hipError_t hipDeviceGraphMemTrimLayer(int device) {
  auto* _rec = HipClrGetActiveRecord(55u);
...
static hipError_t hipDevicePrimaryCtxGetStateLayer(hipDevice_t dev, unsigned int* flags,
                                                    int* active) {
  auto* _rec = HipClrGetActiveRecord(56u);
...
static hipError_t hipDevicePrimaryCtxReleaseLayer(hipDevice_t dev) {
  auto* _rec = HipClrGetActiveRecord(57u);
...
static hipError_t hipDevicePrimaryCtxResetLayer(hipDevice_t dev) {
  auto* _rec = HipClrGetActiveRecord(58u);
...
static hipError_t hipDevicePrimaryCtxRetainLayer(hipCtx_t* pctx, hipDevice_t dev) {
  auto* _rec = HipClrGetActiveRecord(59u);
...
static hipError_t hipDevicePrimaryCtxSetFlagsLayer(hipDevice_t dev, unsigned int flags) {
  auto* _rec = HipClrGetActiveRecord(60u);
...
static hipError_t hipDeviceResetLayer(void) {
  auto* _rec = HipClrGetActiveRecord(61u);
...
static hipError_t hipDeviceSetCacheConfigLayer(hipFuncCache_t cacheConfig) {
  auto* _rec = HipClrGetActiveRecord(62u);
...
static hipError_t hipDeviceSetGraphMemAttributeLayer(int device, hipGraphMemAttributeType attr,
                                                      void* value) {
  auto* _rec = HipClrGetActiveRecord(63u);
...
static hipError_t hipDeviceSetLimitLayer(enum hipLimit_t limit, size_t value) {
  auto* _rec = HipClrGetActiveRecord(64u);
...
static hipError_t hipDeviceSetMemPoolLayer(int device, hipMemPool_t mem_pool) {
  auto* _rec = HipClrGetActiveRecord(65u);
...
static hipError_t hipDeviceSetSharedMemConfigLayer(hipSharedMemConfig config) {
  auto* _rec = HipClrGetActiveRecord(66u);
...
static hipError_t hipDeviceSynchronizeLayer(void) {
  auto* _rec = HipClrGetActiveRecord(67u);
...
static hipError_t hipDeviceTotalMemLayer(size_t* bytes, hipDevice_t device) {
  auto* _rec = HipClrGetActiveRecord(68u);
...
static hipError_t hipDriverGetVersionLayer(int* driverVersion) {
  auto* _rec = HipClrGetActiveRecord(69u);
...
static hipError_t hipDrvGetErrorNameLayer(hipError_t hipError, const char** errorString) {
  auto* _rec = HipClrGetActiveRecord(70u);
...
static hipError_t hipDrvGetErrorStringLayer(hipError_t hipError, const char** errorString) {
  auto* _rec = HipClrGetActiveRecord(71u);
...
static hipError_t hipDrvGraphAddMemcpyNodeLayer(hipGraphNode_t* phGraphNode, hipGraph_t hGraph,
  ...
  auto* _rec = HipClrGetActiveRecord(72u);
...
static hipError_t hipDrvMemcpy2DUnalignedLayer(const hip_Memcpy2D* pCopy) {
  auto* _rec = HipClrGetActiveRecord(73u);
...
static hipError_t hipDrvMemcpy3DLayer(const HIP_MEMCPY3D* pCopy) {
  auto* _rec = HipClrGetActiveRecord(74u);
...
static hipError_t hipDrvMemcpy3DAsyncLayer(const HIP_MEMCPY3D* pCopy, hipStream_t stream) {
  auto* _rec = HipClrGetActiveRecord(75u);
...
static hipError_t hipDrvPointerGetAttributesLayer(unsigned int numAttributes,
                                                   ...
                                                   hipDeviceptr_t ptr) {
  auto* _rec = HipClrGetActiveRecord(76u);
...
static hipError_t hipEventCreateLayer(hipEvent_t* event) {
  auto* _rec = HipClrGetActiveRecord(77u);
...
static hipError_t hipEventCreateWithFlagsLayer(hipEvent_t* event, unsigned flags) {
  auto* _rec = HipClrGetActiveRecord(78u);
...
static hipError_t hipEventDestroyLayer(hipEvent_t event) {
  auto* _rec = HipClrGetActiveRecord(79u);
...
static hipError_t hipEventElapsedTimeLayer(float* ms, hipEvent_t start, hipEvent_t stop) {
  auto* _rec = HipClrGetActiveRecord(80u);
...
static hipError_t hipEventQueryLayer(hipEvent_t event) {
  auto* _rec = HipClrGetActiveRecord(81u);
...
static hipError_t hipEventRecordLayer(hipEvent_t event, hipStream_t stream) {
  auto* _rec = HipClrGetActiveRecord(82u);
...
static hipError_t hipEventSynchronizeLayer(hipEvent_t event) {
  auto* _rec = HipClrGetActiveRecord(83u);
...
static hipError_t hipExtGetLinkTypeAndHopCountLayer(int device1, int device2, uint32_t* linktype,
                                                     uint32_t* hopcount) {
  auto* _rec = HipClrGetActiveRecord(84u);
...
static hipError_t hipExtLaunchKernelLayer(const void* function_address, dim3 numBlocks,
  ...
  auto* _rec = HipClrGetActiveRecord(85u);
...
static hipError_t hipExtLaunchMultiKernelMultiDeviceLayer(hipLaunchParams* launchParamsList,
  ...
  auto* _rec = HipClrGetActiveRecord(86u);
...
static hipError_t hipExtMallocWithFlagsLayer(void** ptr, size_t sizeBytes, unsigned int flags) {
  auto* _rec = HipClrGetActiveRecord(87u);
...
static hipError_t hipExtStreamCreateWithCUMaskLayer(hipStream_t* stream, uint32_t cuMaskSize,
  ...
  auto* _rec = HipClrGetActiveRecord(88u);
...
static hipError_t hipExtStreamGetCUMaskLayer(hipStream_t stream, uint32_t cuMaskSize,
                                              uint32_t* cuMask) {
  auto* _rec = HipClrGetActiveRecord(89u);
...
static hipError_t hipExternalMemoryGetMappedBufferLayer(void** devPtr, hipExternalMemory_t extMem, const hipExternalMemoryBufferDesc* bufferDesc) {
  auto* _rec = HipClrGetActiveRecord(90u);
...
static hipError_t hipFreeLayer(void* ptr) {
  auto* _rec = HipClrGetActiveRecord(91u);
...
static hipError_t hipFreeArrayLayer(hipArray_t array) {
  auto* _rec = HipClrGetActiveRecord(92u);
...
static hipError_t hipFreeAsyncLayer(void* dev_ptr, hipStream_t stream) {
  auto* _rec = HipClrGetActiveRecord(93u);
...
static hipError_t hipFreeHostLayer(void* ptr) {
  auto* _rec = HipClrGetActiveRecord(94u);
...
static hipError_t hipFreeMipmappedArrayLayer(hipMipmappedArray_t mipmappedArray) {
  auto* _rec = HipClrGetActiveRecord(95u);
...
static hipError_t hipFuncGetAttributeLayer(int* value, hipFunction_attribute attrib,
                                            hipFunction_t hfunc) {
  auto* _rec = HipClrGetActiveRecord(96u);
...
static hipError_t hipFuncGetAttributesLayer(struct hipFuncAttributes* attr, const void* func) {
  auto* _rec = HipClrGetActiveRecord(97u);
...
static hipError_t hipFuncSetAttributeLayer(const void* func, hipFuncAttribute attr, int value) {
  auto* _rec = HipClrGetActiveRecord(98u);
...
static hipError_t hipFuncSetCacheConfigLayer(const void* func, hipFuncCache_t config) {
  auto* _rec = HipClrGetActiveRecord(99u);
...
static hipError_t hipFuncSetSharedMemConfigLayer(const void* func, hipSharedMemConfig config) {
  auto* _rec = HipClrGetActiveRecord(100u);
...
static hipError_t hipGLGetDevicesLayer(unsigned int* pHipDeviceCount, int* pHipDevices,
  ...
  auto* _rec = HipClrGetActiveRecord(101u);
...
static hipError_t hipGetChannelDescLayer(hipChannelFormatDesc* desc, hipArray_const_t array) {
  auto* _rec = HipClrGetActiveRecord(102u);
...
static hipError_t hipGetDeviceLayer(int* deviceId) {
  auto* _rec = HipClrGetActiveRecord(103u);
...
static hipError_t hipGetDeviceCountLayer(int* count) {
  auto* _rec = HipClrGetActiveRecord(104u);
...
static hipError_t hipGetDeviceFlagsLayer(unsigned int* flags) {
  auto* _rec = HipClrGetActiveRecord(105u);
...
static hipError_t hipGetDevicePropertiesR0600Layer(hipDeviceProp_tR0600* prop, int device) {
  auto* _rec = HipClrGetActiveRecord(106u);
...
static const char* hipGetErrorNameLayer(hipError_t hip_error) {
  auto* _rec = HipClrGetActiveRecord(107u);
...
static const char* hipGetErrorStringLayer(hipError_t hipError) {
  auto* _rec = HipClrGetActiveRecord(108u);
...
static hipError_t hipGetLastErrorLayer(void) {
  auto* _rec = HipClrGetActiveRecord(109u);
...
static hipError_t hipGetMipmappedArrayLevelLayer(hipArray_t* levelArray,
                                                  hipMipmappedArray_const_t mipmappedArray,
                                                  unsigned int level) {
  auto* _rec = HipClrGetActiveRecord(110u);
...
static hipError_t hipGetSymbolAddressLayer(void** devPtr, const void* symbol) {
  auto* _rec = HipClrGetActiveRecord(111u);
...
static hipError_t hipGetSymbolSizeLayer(size_t* size, const void* symbol) {
  auto* _rec = HipClrGetActiveRecord(112u);
...
static hipError_t hipGetTextureAlignmentOffsetLayer(size_t* offset,
  ...
  auto* _rec = HipClrGetActiveRecord(113u);
...
static hipError_t hipGetTextureObjectResourceDescLayer(hipResourceDesc* pResDesc,
  ...
  auto* _rec = HipClrGetActiveRecord(114u);
...
static hipError_t hipGetTextureObjectResourceViewDescLayer(struct hipResourceViewDesc* pResViewDesc, hipTextureObject_t textureObject) {
  auto* _rec = HipClrGetActiveRecord(115u);
...
static hipError_t hipGetTextureObjectTextureDescLayer(hipTextureDesc* pTexDesc,
                                                       hipTextureObject_t textureObject) {
  auto* _rec = HipClrGetActiveRecord(116u);
...
static hipError_t hipGetTextureReferenceLayer(const textureReference** texref, const void* symbol) {
  auto* _rec = HipClrGetActiveRecord(117u);
...
static hipError_t hipGraphAddChildGraphNodeLayer(hipGraphNode_t* pGraphNode, hipGraph_t graph,
  ...
  auto* _rec = HipClrGetActiveRecord(118u);
...
static hipError_t hipGraphAddDependenciesLayer(hipGraph_t graph, const hipGraphNode_t* from,
  ...
  auto* _rec = HipClrGetActiveRecord(119u);
...
static hipError_t hipGraphAddEmptyNodeLayer(hipGraphNode_t* pGraphNode, hipGraph_t graph,
                                             const hipGraphNode_t* pDependencies,
                                             size_t numDependencies) {
  auto* _rec = HipClrGetActiveRecord(120u);
...
static hipError_t hipGraphAddEventRecordNodeLayer(hipGraphNode_t* pGraphNode, hipGraph_t graph,
  ...
  auto* _rec = HipClrGetActiveRecord(121u);
...
static hipError_t hipGraphAddEventWaitNodeLayer(hipGraphNode_t* pGraphNode, hipGraph_t graph,
                                                 const hipGraphNode_t* pDependencies,
                                                 size_t numDependencies, hipEvent_t event) {
  auto* _rec = HipClrGetActiveRecord(122u);
...
static hipError_t hipGraphAddHostNodeLayer(hipGraphNode_t* pGraphNode, hipGraph_t graph,
  ...
  auto* _rec = HipClrGetActiveRecord(123u);
...
static hipError_t hipGraphAddKernelNodeLayer(hipGraphNode_t* pGraphNode, hipGraph_t graph,
  ...
  auto* _rec = HipClrGetActiveRecord(124u);
...
static hipError_t hipGraphAddMemAllocNodeLayer(hipGraphNode_t* pGraphNode, hipGraph_t graph,
  ...
  auto* _rec = HipClrGetActiveRecord(125u);
...
static hipError_t hipGraphAddMemFreeNodeLayer(hipGraphNode_t* pGraphNode, hipGraph_t graph,
  ...
  auto* _rec = HipClrGetActiveRecord(126u);
...
static hipError_t hipGraphAddMemcpyNodeLayer(hipGraphNode_t* pGraphNode, hipGraph_t graph,
  ...
  auto* _rec = HipClrGetActiveRecord(127u);
...
static hipError_t hipGraphAddMemcpyNode1DLayer(hipGraphNode_t* pGraphNode, hipGraph_t graph,
  ...
  auto* _rec = HipClrGetActiveRecord(128u);
...
static hipError_t hipGraphAddMemcpyNodeFromSymbolLayer(hipGraphNode_t* pGraphNode,
  ...
  auto* _rec = HipClrGetActiveRecord(129u);
...
static hipError_t hipGraphAddMemcpyNodeToSymbolLayer(hipGraphNode_t* pGraphNode, hipGraph_t graph,
                                                      ...
                                                      hipMemcpyKind kind) {
  auto* _rec = HipClrGetActiveRecord(130u);
...
static hipError_t hipGraphAddMemsetNodeLayer(hipGraphNode_t* pGraphNode, hipGraph_t graph,
  ...
  auto* _rec = HipClrGetActiveRecord(131u);
...
static hipError_t hipGraphAddNodeLayer(hipGraphNode_t* pGraphNode, hipGraph_t graph,
  ...
  auto* _rec = HipClrGetActiveRecord(132u);
...
static hipError_t hipGraphChildGraphNodeGetGraphLayer(hipGraphNode_t node, hipGraph_t* pGraph) {
  auto* _rec = HipClrGetActiveRecord(133u);
...
static hipError_t hipGraphCloneLayer(hipGraph_t* pGraphClone, hipGraph_t originalGraph) {
  auto* _rec = HipClrGetActiveRecord(134u);
...
static hipError_t hipGraphCreateLayer(hipGraph_t* pGraph, unsigned int flags) {
  auto* _rec = HipClrGetActiveRecord(135u);
...
static hipError_t hipGraphDebugDotPrintLayer(hipGraph_t graph, const char* path,
                                              unsigned int flags) {
  auto* _rec = HipClrGetActiveRecord(136u);
...
static hipError_t hipGraphDestroyLayer(hipGraph_t graph) {
  auto* _rec = HipClrGetActiveRecord(137u);
...
static hipError_t hipGraphDestroyNodeLayer(hipGraphNode_t node) {
  auto* _rec = HipClrGetActiveRecord(138u);
...
static hipError_t hipGraphEventRecordNodeGetEventLayer(hipGraphNode_t node, hipEvent_t* event_out) {
  auto* _rec = HipClrGetActiveRecord(139u);
...
static hipError_t hipGraphEventRecordNodeSetEventLayer(hipGraphNode_t node, hipEvent_t event) {
  auto* _rec = HipClrGetActiveRecord(140u);
...
static hipError_t hipGraphEventWaitNodeGetEventLayer(hipGraphNode_t node, hipEvent_t* event_out) {
  auto* _rec = HipClrGetActiveRecord(141u);
...
static hipError_t hipGraphEventWaitNodeSetEventLayer(hipGraphNode_t node, hipEvent_t event) {
  auto* _rec = HipClrGetActiveRecord(142u);
...
static hipError_t hipGraphExecChildGraphNodeSetParamsLayer(hipGraphExec_t hGraphExec,
  ...
  auto* _rec = HipClrGetActiveRecord(143u);
...
static hipError_t hipGraphExecDestroyLayer(hipGraphExec_t graphExec) {
  auto* _rec = HipClrGetActiveRecord(144u);
...
static hipError_t hipGraphExecEventRecordNodeSetEventLayer(hipGraphExec_t hGraphExec,
  ...
  auto* _rec = HipClrGetActiveRecord(145u);
...
static hipError_t hipGraphExecEventWaitNodeSetEventLayer(hipGraphExec_t hGraphExec,
                                                          hipGraphNode_t hNode, hipEvent_t event) {
  auto* _rec = HipClrGetActiveRecord(146u);
...
static hipError_t hipGraphExecHostNodeSetParamsLayer(hipGraphExec_t hGraphExec,
                                                      hipGraphNode_t node,
                                                      const hipHostNodeParams* pNodeParams) {
  auto* _rec = HipClrGetActiveRecord(147u);
...
static hipError_t hipGraphExecKernelNodeSetParamsLayer(hipGraphExec_t hGraphExec,
                                                        hipGraphNode_t node,
                                                        const hipKernelNodeParams* pNodeParams) {
  auto* _rec = HipClrGetActiveRecord(148u);
...
static hipError_t hipGraphExecMemcpyNodeSetParamsLayer(hipGraphExec_t hGraphExec,
  ...
  auto* _rec = HipClrGetActiveRecord(149u);
...
static hipError_t hipGraphExecMemcpyNodeSetParams1DLayer(hipGraphExec_t hGraphExec,
                                                          ...
                                                          hipMemcpyKind kind) {
  auto* _rec = HipClrGetActiveRecord(150u);
...
static hipError_t hipGraphExecMemcpyNodeSetParamsFromSymbolLayer(hipGraphExec_t hGraphExec,
                                                                  ...
                                                                  size_t offset,
                                                                  hipMemcpyKind kind) {
  auto* _rec = HipClrGetActiveRecord(151u);
...
static hipError_t hipGraphExecMemcpyNodeSetParamsToSymbolLayer(hipGraphExec_t hGraphExec,
                                                                ...
                                                                hipMemcpyKind kind) {
  auto* _rec = HipClrGetActiveRecord(152u);
...
static hipError_t hipGraphExecMemsetNodeSetParamsLayer(hipGraphExec_t hGraphExec,
  ...
  auto* _rec = HipClrGetActiveRecord(153u);
...
static hipError_t hipGraphExecUpdateLayer(hipGraphExec_t hGraphExec, hipGraph_t hGraph,
  ...
  auto* _rec = HipClrGetActiveRecord(154u);
...
static hipError_t hipGraphGetEdgesLayer(hipGraph_t graph, hipGraphNode_t* from, hipGraphNode_t* to,
                                         size_t* numEdges) {
  auto* _rec = HipClrGetActiveRecord(155u);
...
static hipError_t hipGraphGetNodesLayer(hipGraph_t graph, hipGraphNode_t* nodes, size_t* numNodes) {
  auto* _rec = HipClrGetActiveRecord(156u);
...
static hipError_t hipGraphGetRootNodesLayer(hipGraph_t graph, hipGraphNode_t* pRootNodes,
  ...
  auto* _rec = HipClrGetActiveRecord(157u);
...
static hipError_t hipGraphHostNodeGetParamsLayer(hipGraphNode_t node,
  ...
  auto* _rec = HipClrGetActiveRecord(158u);
...
static hipError_t hipGraphHostNodeSetParamsLayer(hipGraphNode_t node,
                                                  const hipHostNodeParams* pNodeParams) {
  auto* _rec = HipClrGetActiveRecord(159u);
...
static hipError_t hipGraphInstantiateLayer(hipGraphExec_t* pGraphExec, hipGraph_t graph,
                                            ...
                                            size_t bufferSize) {
  auto* _rec = HipClrGetActiveRecord(160u);
...
static hipError_t hipGraphInstantiateWithFlagsLayer(hipGraphExec_t* pGraphExec, hipGraph_t graph,
  ...
  auto* _rec = HipClrGetActiveRecord(161u);
...
static hipError_t hipGraphInstantiateWithParamsLayer(hipGraphExec_t* pGraphExec, hipGraph_t graph,
  ...
  auto* _rec = HipClrGetActiveRecord(162u);
...
static hipError_t hipGraphKernelNodeCopyAttributesLayer(hipGraphNode_t hSrc, hipGraphNode_t hDst) {
  auto* _rec = HipClrGetActiveRecord(163u);
...
static hipError_t hipGraphKernelNodeGetAttributeLayer(hipGraphNode_t hNode,
  ...
  auto* _rec = HipClrGetActiveRecord(164u);
...
static hipError_t hipGraphKernelNodeGetParamsLayer(hipGraphNode_t node,
  ...
  auto* _rec = HipClrGetActiveRecord(165u);
...
static hipError_t hipGraphKernelNodeSetAttributeLayer(hipGraphNode_t hNode,
  ...
  auto* _rec = HipClrGetActiveRecord(166u);
...
static hipError_t hipGraphKernelNodeSetParamsLayer(hipGraphNode_t node,
                                                    const hipKernelNodeParams* pNodeParams) {
  auto* _rec = HipClrGetActiveRecord(167u);
...
static hipError_t hipGraphLaunchLayer(hipGraphExec_t graphExec, hipStream_t stream) {
  auto* _rec = HipClrGetActiveRecord(168u);
...
static hipError_t hipGraphMemAllocNodeGetParamsLayer(hipGraphNode_t node,
                                                      hipMemAllocNodeParams* pNodeParams) {
  auto* _rec = HipClrGetActiveRecord(169u);
...
static hipError_t hipGraphMemFreeNodeGetParamsLayer(hipGraphNode_t node, void* dev_ptr) {
  auto* _rec = HipClrGetActiveRecord(170u);
...
static hipError_t hipGraphMemcpyNodeGetParamsLayer(hipGraphNode_t node,
                                                    hipMemcpy3DParms* pNodeParams) {
  auto* _rec = HipClrGetActiveRecord(171u);
...
static hipError_t hipGraphMemcpyNodeSetParamsLayer(hipGraphNode_t node,
  ...
  auto* _rec = HipClrGetActiveRecord(172u);
...
static hipError_t hipGraphMemcpyNodeSetParams1DLayer(hipGraphNode_t node, void* dst,
                                                      const void* src, size_t count,
                                                      hipMemcpyKind kind) {
  auto* _rec = HipClrGetActiveRecord(173u);
...
static hipError_t hipGraphMemcpyNodeSetParamsFromSymbolLayer(hipGraphNode_t node, void* dst,
                                                              const void* symbol, size_t count,
                                                              size_t offset, hipMemcpyKind kind) {
  auto* _rec = HipClrGetActiveRecord(174u);
...
static hipError_t hipGraphMemcpyNodeSetParamsToSymbolLayer(hipGraphNode_t node, const void* symbol,
                                                            const void* src, size_t count,
                                                            size_t offset, hipMemcpyKind kind) {
  auto* _rec = HipClrGetActiveRecord(175u);
...
static hipError_t hipGraphMemsetNodeGetParamsLayer(hipGraphNode_t node,
  ...
  auto* _rec = HipClrGetActiveRecord(176u);
...
static hipError_t hipGraphMemsetNodeSetParamsLayer(hipGraphNode_t node,
                                                    const hipMemsetParams* pNodeParams) {
  auto* _rec = HipClrGetActiveRecord(177u);
...
static hipError_t hipGraphNodeFindInCloneLayer(hipGraphNode_t* pNode, hipGraphNode_t originalNode,
  ...
  auto* _rec = HipClrGetActiveRecord(178u);
...
static hipError_t hipGraphNodeGetDependenciesLayer(hipGraphNode_t node,
  ...
  auto* _rec = HipClrGetActiveRecord(179u);
...
static hipError_t hipGraphNodeGetDependentNodesLayer(hipGraphNode_t node,
  ...
  auto* _rec = HipClrGetActiveRecord(180u);
...
static hipError_t hipGraphNodeGetEnabledLayer(hipGraphExec_t hGraphExec, hipGraphNode_t hNode,
  ...
  auto* _rec = HipClrGetActiveRecord(181u);
...
static hipError_t hipGraphNodeGetTypeLayer(hipGraphNode_t node, hipGraphNodeType* pType) {
  auto* _rec = HipClrGetActiveRecord(182u);
...
static hipError_t hipGraphNodeSetEnabledLayer(hipGraphExec_t hGraphExec, hipGraphNode_t hNode,
                                               unsigned int isEnabled) {
  auto* _rec = HipClrGetActiveRecord(183u);
...
static hipError_t hipGraphReleaseUserObjectLayer(hipGraph_t graph, hipUserObject_t object,
                                                  unsigned int count) {
  auto* _rec = HipClrGetActiveRecord(184u);
...
static hipError_t hipGraphRemoveDependenciesLayer(hipGraph_t graph, const hipGraphNode_t* from,
                                                   ...
                                                   size_t numDependencies) {
  auto* _rec = HipClrGetActiveRecord(185u);
...
static hipError_t hipGraphRetainUserObjectLayer(hipGraph_t graph, hipUserObject_t object,
  ...
  auto* _rec = HipClrGetActiveRecord(186u);
...
static hipError_t hipGraphUploadLayer(hipGraphExec_t graphExec, hipStream_t stream) {
  auto* _rec = HipClrGetActiveRecord(187u);
...
static hipError_t hipGraphicsGLRegisterBufferLayer(hipGraphicsResource** resource, GLuint buffer,
                                                    unsigned int flags) {
  auto* _rec = HipClrGetActiveRecord(188u);
...
static hipError_t hipGraphicsGLRegisterImageLayer(hipGraphicsResource** resource, GLuint image,
  ...
  auto* _rec = HipClrGetActiveRecord(189u);
...
static hipError_t hipGraphicsMapResourcesLayer(int count, hipGraphicsResource_t* resources,
                                                hipStream_t stream) {
  auto* _rec = HipClrGetActiveRecord(190u);
...
static hipError_t hipGraphicsResourceGetMappedPointerLayer(void** devPtr, size_t* size,
  ...
  auto* _rec = HipClrGetActiveRecord(191u);
...
static hipError_t hipGraphicsSubResourceGetMappedArrayLayer(hipArray_t* array,
  ...
  auto* _rec = HipClrGetActiveRecord(192u);
...
static hipError_t hipGraphicsUnmapResourcesLayer(int count, hipGraphicsResource_t* resources,
                                                  hipStream_t stream) {
  auto* _rec = HipClrGetActiveRecord(193u);
...
static hipError_t hipGraphicsUnregisterResourceLayer(hipGraphicsResource_t resource) {
  auto* _rec = HipClrGetActiveRecord(194u);
...
static hipError_t hipHostAllocLayer(void** ptr, size_t size, unsigned int flags) {
  auto* _rec = HipClrGetActiveRecord(195u);
...
static hipError_t hipHostFreeLayer(void* ptr) {
  auto* _rec = HipClrGetActiveRecord(196u);
...
static hipError_t hipHostGetDevicePointerLayer(void** devPtr, void* hstPtr, unsigned int flags) {
  auto* _rec = HipClrGetActiveRecord(197u);
...
static hipError_t hipHostGetFlagsLayer(unsigned int* flagsPtr, void* hostPtr) {
  auto* _rec = HipClrGetActiveRecord(198u);
...
static hipError_t hipHostMallocLayer(void** ptr, size_t size, unsigned int flags) {
  auto* _rec = HipClrGetActiveRecord(199u);
...
static hipError_t hipExtHostAllocLayer(void** ptr, size_t size, unsigned int flags) {
  auto* _rec = HipClrGetActiveRecord(200u);
...
static hipError_t hipHostRegisterLayer(void* hostPtr, size_t sizeBytes, unsigned int flags) {
  auto* _rec = HipClrGetActiveRecord(201u);
...
static hipError_t hipHostUnregisterLayer(void* hostPtr) {
  auto* _rec = HipClrGetActiveRecord(202u);
...
static hipError_t hipImportExternalMemoryLayer(hipExternalMemory_t* extMem_out,
  ...
  auto* _rec = HipClrGetActiveRecord(203u);
...
static hipError_t hipImportExternalSemaphoreLayer(hipExternalSemaphore_t* extSem_out, const hipExternalSemaphoreHandleDesc* semHandleDesc) {
  auto* _rec = HipClrGetActiveRecord(204u);
...
static hipError_t hipInitLayer(unsigned int flags) {
  auto* _rec = HipClrGetActiveRecord(205u);
...
static hipError_t hipIpcCloseMemHandleLayer(void* devPtr) {
  auto* _rec = HipClrGetActiveRecord(206u);
...
static hipError_t hipIpcGetEventHandleLayer(hipIpcEventHandle_t* handle, hipEvent_t event) {
  auto* _rec = HipClrGetActiveRecord(207u);
...
static hipError_t hipIpcGetMemHandleLayer(hipIpcMemHandle_t* handle, void* devPtr) {
  auto* _rec = HipClrGetActiveRecord(208u);
...
static hipError_t hipIpcOpenEventHandleLayer(hipEvent_t* event, hipIpcEventHandle_t handle) {
  auto* _rec = HipClrGetActiveRecord(209u);
...
static hipError_t hipIpcOpenMemHandleLayer(void** devPtr, hipIpcMemHandle_t handle,
                                            unsigned int flags) {
  auto* _rec = HipClrGetActiveRecord(210u);
...
static const char* hipKernelNameRefLayer(const hipFunction_t f) {
  auto* _rec = HipClrGetActiveRecord(211u);
...
static const char* hipKernelNameRefByPtrLayer(const void* hostFunction, hipStream_t stream) {
  auto* _rec = HipClrGetActiveRecord(212u);
...
static hipError_t hipLaunchByPtrLayer(const void* func) {
  auto* _rec = HipClrGetActiveRecord(213u);
...
static hipError_t hipLaunchCooperativeKernelLayer(const void* f, dim3 gridDim, dim3 blockDimX,
                                                   ...
                                                   hipStream_t stream) {
  auto* _rec = HipClrGetActiveRecord(214u);
...
static hipError_t hipLaunchCooperativeKernelMultiDeviceLayer(hipLaunchParams* launchParamsList,
                                                              int numDevices, unsigned int flags) {
  auto* _rec = HipClrGetActiveRecord(215u);
...
static hipError_t hipLaunchHostFuncLayer(hipStream_t stream, hipHostFn_t fn, void* userData) {
  auto* _rec = HipClrGetActiveRecord(216u);
...
static hipError_t hipLaunchKernelLayer(const void* function_address, dim3 numBlocks,
                                        dim3 dimBlocks, void** args, size_t sharedMemBytes,
                                        hipStream_t stream) {
  auto* _rec = HipClrGetActiveRecord(217u);
...
static hipError_t hipMallocLayer(void** ptr, size_t size) {
  auto* _rec = HipClrGetActiveRecord(218u);
...
static hipError_t hipMalloc3DLayer(hipPitchedPtr* pitchedDevPtr, hipExtent extent) {
  auto* _rec = HipClrGetActiveRecord(219u);
...
static hipError_t hipMalloc3DArrayLayer(hipArray_t* array, const struct hipChannelFormatDesc* desc,
  ...
  auto* _rec = HipClrGetActiveRecord(220u);
...
static hipError_t hipMallocArrayLayer(hipArray_t* array, const hipChannelFormatDesc* desc,
  ...
  auto* _rec = HipClrGetActiveRecord(221u);
...
static hipError_t hipMallocAsyncLayer(void** dev_ptr, size_t size, hipStream_t stream) {
  auto* _rec = HipClrGetActiveRecord(222u);
...
static hipError_t hipMallocFromPoolAsyncLayer(void** dev_ptr, size_t size, hipMemPool_t mem_pool,
                                               hipStream_t stream) {
  auto* _rec = HipClrGetActiveRecord(223u);
...
static hipError_t hipMallocHostLayer(void** ptr, size_t size) {
  auto* _rec = HipClrGetActiveRecord(224u);
...
static hipError_t hipMallocManagedLayer(void** dev_ptr, size_t size, unsigned int flags) {
  auto* _rec = HipClrGetActiveRecord(225u);
...
static hipError_t hipMallocMipmappedArrayLayer(hipMipmappedArray_t* mipmappedArray,
                                                ...
                                                unsigned int flags) {
  auto* _rec = HipClrGetActiveRecord(226u);
...
static hipError_t hipMallocPitchLayer(void** ptr, size_t* pitch, size_t width, size_t height) {
  auto* _rec = HipClrGetActiveRecord(227u);
...
static hipError_t hipMemAddressFreeLayer(void* devPtr, size_t size) {
  auto* _rec = HipClrGetActiveRecord(228u);
...
static hipError_t hipMemAddressReserveLayer(void** ptr, size_t size, size_t alignment, void* addr,
                                             unsigned long long flags) {
  auto* _rec = HipClrGetActiveRecord(229u);
...
static hipError_t hipMemAdviseLayer(const void* dev_ptr, size_t count, hipMemoryAdvise advice,
                                     int device) {
  auto* _rec = HipClrGetActiveRecord(230u);
...
static hipError_t hipMemAdvise_v2Layer(const void* dev_ptr, size_t count, hipMemoryAdvise advice,
  ...
  auto* _rec = HipClrGetActiveRecord(231u);
...
static hipError_t hipMemAllocHostLayer(void** ptr, size_t size) {
  auto* _rec = HipClrGetActiveRecord(232u);
...
static hipError_t hipMemAllocPitchLayer(hipDeviceptr_t* dptr, size_t* pitch, size_t widthInBytes,
  ...
  auto* _rec = HipClrGetActiveRecord(233u);
...
static hipError_t hipMemCreateLayer(hipMemGenericAllocationHandle_t* handle, size_t size,
  ...
  auto* _rec = HipClrGetActiveRecord(234u);
...
static hipError_t hipMemExportToShareableHandleLayer(void* shareableHandle,
                                                      ...
                                                      unsigned long long flags) {
  auto* _rec = HipClrGetActiveRecord(235u);
...
static hipError_t hipMemGetAccessLayer(unsigned long long* flags, const hipMemLocation* location,
                                        void* ptr) {
  auto* _rec = HipClrGetActiveRecord(236u);
...
static hipError_t hipMemGetAddressRangeLayer(hipDeviceptr_t* pbase, size_t* psize,
                                              hipDeviceptr_t dptr) {
  auto* _rec = HipClrGetActiveRecord(237u);
...
static hipError_t hipMemGetAllocationGranularityLayer(size_t* granularity,
  ...
  auto* _rec = HipClrGetActiveRecord(238u);
...
static hipError_t hipMemGetAllocationPropertiesFromHandleLayer(hipMemAllocationProp* prop, hipMemGenericAllocationHandle_t handle) {
  auto* _rec = HipClrGetActiveRecord(239u);
...
static hipError_t hipMemGetInfoLayer(size_t* free, size_t* total) {
  auto* _rec = HipClrGetActiveRecord(240u);
...
static hipError_t hipMemImportFromShareableHandleLayer(hipMemGenericAllocationHandle_t* handle,
  ...
  auto* _rec = HipClrGetActiveRecord(241u);
...
static hipError_t hipMemMapLayer(void* ptr, size_t size, size_t offset,
  ...
  auto* _rec = HipClrGetActiveRecord(242u);
...
static hipError_t hipMemMapArrayAsyncLayer(hipArrayMapInfo* mapInfoList, unsigned int count,
                                            hipStream_t stream) {
  auto* _rec = HipClrGetActiveRecord(243u);
...
static hipError_t hipMemPoolCreateLayer(hipMemPool_t* mem_pool, const hipMemPoolProps* pool_props) {
  auto* _rec = HipClrGetActiveRecord(244u);
...
static hipError_t hipMemPoolDestroyLayer(hipMemPool_t mem_pool) {
  auto* _rec = HipClrGetActiveRecord(245u);
...
static hipError_t hipMemPoolExportPointerLayer(hipMemPoolPtrExportData* export_data,
                                                void* dev_ptr) {
  auto* _rec = HipClrGetActiveRecord(246u);
...
static hipError_t hipMemPoolExportToShareableHandleLayer(void* shared_handle,
                                                          ...
                                                          unsigned int flags) {
  auto* _rec = HipClrGetActiveRecord(247u);
...
static hipError_t hipMemPoolGetAccessLayer(hipMemAccessFlags* flags, hipMemPool_t mem_pool,
  ...
  auto* _rec = HipClrGetActiveRecord(248u);
...
static hipError_t hipMemPoolGetAttributeLayer(hipMemPool_t mem_pool, hipMemPoolAttr attr,
                                               void* value) {
  auto* _rec = HipClrGetActiveRecord(249u);
...
static hipError_t hipMemPoolImportFromShareableHandleLayer(hipMemPool_t* mem_pool,
                                                            ...
                                                            hipMemAllocationHandleType handle_type,
                                                            unsigned int flags) {
  auto* _rec = HipClrGetActiveRecord(250u);
...
static hipError_t hipMemPoolImportPointerLayer(void** dev_ptr, hipMemPool_t mem_pool,
  ...
  auto* _rec = HipClrGetActiveRecord(251u);
...
static hipError_t hipMemPoolSetAccessLayer(hipMemPool_t mem_pool,
  ...
  auto* _rec = HipClrGetActiveRecord(252u);
...
static hipError_t hipMemPoolSetAttributeLayer(hipMemPool_t mem_pool, hipMemPoolAttr attr,
                                               void* value) {
  auto* _rec = HipClrGetActiveRecord(253u);
...
static hipError_t hipMemPoolTrimToLayer(hipMemPool_t mem_pool, size_t min_bytes_to_hold) {
  auto* _rec = HipClrGetActiveRecord(254u);
...
static hipError_t hipMemPrefetchAsyncLayer(const void* dev_ptr, size_t count, int device,
                                            hipStream_t stream) {
  auto* _rec = HipClrGetActiveRecord(255u);
...
static hipError_t hipMemPrefetchAsync_v2Layer(const void* dev_ptr, size_t count,
                                               ...
                                               hipStream_t stream) {
  auto* _rec = HipClrGetActiveRecord(256u);
...
static hipError_t hipMemPrefetchBatchAsyncLayer(void** dev_ptrs, size_t* sizes, size_t count,
                                                ...
                                                hipStream_t stream) {
  auto* _rec = HipClrGetActiveRecord(257u);
...
static hipError_t hipMemPtrGetInfoLayer(void* ptr, size_t* size) {
  auto* _rec = HipClrGetActiveRecord(258u);
...
static hipError_t hipMemRangeGetAttributeLayer(void* data, size_t data_size,
                                                ...
                                                size_t count) {
  auto* _rec = HipClrGetActiveRecord(259u);
...
static hipError_t hipMemRangeGetAttributesLayer(void** data, size_t* data_sizes,
                                                 ...
                                                 size_t count) {
  auto* _rec = HipClrGetActiveRecord(260u);
...
static hipError_t hipMemReleaseLayer(hipMemGenericAllocationHandle_t handle) {
  auto* _rec = HipClrGetActiveRecord(261u);
...
static hipError_t hipMemRetainAllocationHandleLayer(hipMemGenericAllocationHandle_t* handle,
                                                     void* addr) {
  auto* _rec = HipClrGetActiveRecord(262u);
...
static hipError_t hipMemSetAccessLayer(void* ptr, size_t size, const hipMemAccessDesc* desc,
                                        size_t count) {
  auto* _rec = HipClrGetActiveRecord(263u);
...
static hipError_t hipMemUnmapLayer(void* ptr, size_t size) {
  auto* _rec = HipClrGetActiveRecord(264u);
...
static hipError_t hipMemcpyLayer(void* dst, const void* src, size_t sizeBytes, hipMemcpyKind kind) {
  auto* _rec = HipClrGetActiveRecord(265u);
...
static hipError_t hipMemcpy2DLayer(void* dst, size_t dpitch, const void* src, size_t spitch,
  ...
  auto* _rec = HipClrGetActiveRecord(266u);
...
static hipError_t hipMemcpy2DAsyncLayer(void* dst, size_t dpitch, const void* src, size_t spitch,
                                         size_t width, size_t height, hipMemcpyKind kind,
                                         hipStream_t stream) {
  auto* _rec = HipClrGetActiveRecord(267u);
...
static hipError_t hipMemcpy2DFromArrayLayer(void* dst, size_t dpitch, hipArray_const_t src,
  ...
  auto* _rec = HipClrGetActiveRecord(268u);
...
static hipError_t hipMemcpy2DFromArrayAsyncLayer(void* dst, size_t dpitch, hipArray_const_t src,
                                                  ...
                                                  size_t height, hipMemcpyKind kind,
                                                  hipStream_t stream) {
  auto* _rec = HipClrGetActiveRecord(269u);
...
static hipError_t hipMemcpy2DToArrayLayer(hipArray_t dst, size_t wOffset, size_t hOffset,
                                           ...
                                           size_t height, hipMemcpyKind kind) {
  auto* _rec = HipClrGetActiveRecord(270u);
...
static hipError_t hipMemcpy2DToArrayAsyncLayer(hipArray_t dst, size_t wOffset, size_t hOffset,
                                                ...
                                                size_t height, hipMemcpyKind kind,
                                                hipStream_t stream) {
  auto* _rec = HipClrGetActiveRecord(271u);
...
static hipError_t hipMemcpy3DLayer(const struct hipMemcpy3DParms* p) {
  auto* _rec = HipClrGetActiveRecord(272u);
...
static hipError_t hipMemcpy3DAsyncLayer(const struct hipMemcpy3DParms* p, hipStream_t stream) {
  auto* _rec = HipClrGetActiveRecord(273u);
...
static hipError_t hipMemcpyAsyncLayer(void* dst, const void* src, size_t sizeBytes,
  ...
  auto* _rec = HipClrGetActiveRecord(274u);
...
static hipError_t hipMemcpyAtoHLayer(void* dst, hipArray_t srcArray, size_t srcOffset,
                                      size_t count) {
  auto* _rec = HipClrGetActiveRecord(275u);
...
static hipError_t hipMemcpyDtoDLayer(hipDeviceptr_t dst, hipDeviceptr_t src, size_t sizeBytes) {
  auto* _rec = HipClrGetActiveRecord(276u);
...
static hipError_t hipMemcpyDtoDAsyncLayer(hipDeviceptr_t dst, hipDeviceptr_t src, size_t sizeBytes,
                                           hipStream_t stream) {
  auto* _rec = HipClrGetActiveRecord(277u);
...
static hipError_t hipMemcpyDtoHLayer(void* dst, hipDeviceptr_t src, size_t sizeBytes) {
  auto* _rec = HipClrGetActiveRecord(278u);
...
static hipError_t hipMemcpyDtoHAsyncLayer(void* dst, hipDeviceptr_t src, size_t sizeBytes,
                                           hipStream_t stream) {
  auto* _rec = HipClrGetActiveRecord(279u);
...
static hipError_t hipMemcpyFromArrayLayer(void* dst, hipArray_const_t srcArray, size_t wOffset,
  ...
  auto* _rec = HipClrGetActiveRecord(280u);
...
static hipError_t hipMemcpyFromSymbolLayer(void* dst, const void* symbol, size_t sizeBytes,
                                            size_t offset, hipMemcpyKind kind) {
  auto* _rec = HipClrGetActiveRecord(281u);
...
static hipError_t hipMemcpyFromSymbolAsyncLayer(void* dst, const void* symbol, size_t sizeBytes,
                                                 size_t offset, hipMemcpyKind kind,
                                                 hipStream_t stream) {
  auto* _rec = HipClrGetActiveRecord(282u);
...
static hipError_t hipMemcpyHtoALayer(hipArray_t dstArray, size_t dstOffset, const void* srcHost,
                                      size_t count) {
  auto* _rec = HipClrGetActiveRecord(283u);
...
static hipError_t hipMemcpyHtoDLayer(hipDeviceptr_t dst, const void* src, size_t sizeBytes) {
  auto* _rec = HipClrGetActiveRecord(284u);
...
static hipError_t hipMemcpyHtoDAsyncLayer(hipDeviceptr_t dst, const void* src, size_t sizeBytes,
                                           hipStream_t stream) {
  auto* _rec = HipClrGetActiveRecord(285u);
...
static hipError_t hipMemcpyParam2DLayer(const hip_Memcpy2D* pCopy) {
  auto* _rec = HipClrGetActiveRecord(286u);
...
static hipError_t hipMemcpyParam2DAsyncLayer(const hip_Memcpy2D* pCopy, hipStream_t stream) {
  auto* _rec = HipClrGetActiveRecord(287u);
...
static hipError_t hipMemcpyPeerLayer(void* dst, int dstDeviceId, const void* src, int srcDeviceId,
                                      size_t sizeBytes) {
  auto* _rec = HipClrGetActiveRecord(288u);
...
static hipError_t hipMemcpyPeerAsyncLayer(void* dst, int dstDeviceId, const void* src,
  ...
  auto* _rec = HipClrGetActiveRecord(289u);
...
static hipError_t hipMemcpyToArrayLayer(hipArray_t dst, size_t wOffset, size_t hOffset,
  ...
  auto* _rec = HipClrGetActiveRecord(290u);
...
static hipError_t hipMemcpyToSymbolLayer(const void* symbol, const void* src, size_t sizeBytes,
                                          size_t offset, hipMemcpyKind kind) {
  auto* _rec = HipClrGetActiveRecord(291u);
...
static hipError_t hipMemcpyToSymbolAsyncLayer(const void* symbol, const void* src,
                                               ...
                                               hipStream_t stream) {
  auto* _rec = HipClrGetActiveRecord(292u);
...
static hipError_t hipMemcpyWithStreamLayer(void* dst, const void* src, size_t sizeBytes,
                                            hipMemcpyKind kind, hipStream_t stream) {
  auto* _rec = HipClrGetActiveRecord(293u);
...
static hipError_t hipMemsetLayer(void* dst, int value, size_t sizeBytes) {
  auto* _rec = HipClrGetActiveRecord(294u);
...
static hipError_t hipMemset2DLayer(void* dst, size_t pitch, int value, size_t width,
                                    size_t height) {
  auto* _rec = HipClrGetActiveRecord(295u);
...
static hipError_t hipMemset2DAsyncLayer(void* dst, size_t pitch, int value, size_t width,
  ...
  auto* _rec = HipClrGetActiveRecord(296u);
...
static hipError_t hipMemset3DLayer(hipPitchedPtr pitchedDevPtr, int value, hipExtent extent) {
  auto* _rec = HipClrGetActiveRecord(297u);
...
static hipError_t hipMemset3DAsyncLayer(hipPitchedPtr pitchedDevPtr, int value, hipExtent extent,
                                         hipStream_t stream) {
  auto* _rec = HipClrGetActiveRecord(298u);
...
static hipError_t hipMemsetAsyncLayer(void* dst, int value, size_t sizeBytes, hipStream_t stream) {
  auto* _rec = HipClrGetActiveRecord(299u);
...
static hipError_t hipMemsetD16Layer(hipDeviceptr_t dest, unsigned short value, size_t count) {
  auto* _rec = HipClrGetActiveRecord(300u);
...
static hipError_t hipMemsetD16AsyncLayer(hipDeviceptr_t dest, unsigned short value, size_t count,
                                          hipStream_t stream) {
  auto* _rec = HipClrGetActiveRecord(301u);
...
static hipError_t hipMemsetD32Layer(hipDeviceptr_t dest, int value, size_t count) {
  auto* _rec = HipClrGetActiveRecord(302u);
...
static hipError_t hipMemsetD32AsyncLayer(hipDeviceptr_t dst, int value, size_t count,
                                          hipStream_t stream) {
  auto* _rec = HipClrGetActiveRecord(303u);
...
static hipError_t hipMemsetD8Layer(hipDeviceptr_t dest, unsigned char value, size_t count) {
  auto* _rec = HipClrGetActiveRecord(304u);
...
static hipError_t hipMemsetD8AsyncLayer(hipDeviceptr_t dest, unsigned char value, size_t count,
                                         hipStream_t stream) {
  auto* _rec = HipClrGetActiveRecord(305u);
...
static hipError_t hipMipmappedArrayCreateLayer(hipMipmappedArray_t* pHandle,
  ...
  auto* _rec = HipClrGetActiveRecord(306u);
...
static hipError_t hipMipmappedArrayDestroyLayer(hipMipmappedArray_t hMipmappedArray) {
  auto* _rec = HipClrGetActiveRecord(307u);
...
static hipError_t hipMipmappedArrayGetMemoryRequirementsLayer(hipArrayMemoryRequirements* memoryRequirements, hipMipmappedArray_t mipmap, hipDevice_t device) {
  auto* _rec = HipClrGetActiveRecord(308u);
...
static hipError_t hipMipmappedArrayGetLevelLayer(hipArray_t* pLevelArray,
                                                  ...
                                                  unsigned int level) {
  auto* _rec = HipClrGetActiveRecord(309u);
...
static hipError_t hipModuleGetFunctionLayer(hipFunction_t* function, hipModule_t module,
                                             const char* kname) {
  auto* _rec = HipClrGetActiveRecord(310u);
...
static hipError_t hipModuleGetFunctionCountLayer(unsigned int* count, hipModule_t module) {
  auto* _rec = HipClrGetActiveRecord(311u);
...
static hipError_t hipModuleGetGlobalLayer(hipDeviceptr_t* dptr, size_t* bytes, hipModule_t hmod,
                                           const char* name) {
  auto* _rec = HipClrGetActiveRecord(312u);
...
static hipError_t hipModuleGetTexRefLayer(textureReference** texRef, hipModule_t hmod,
                                           const char* name) {
  auto* _rec = HipClrGetActiveRecord(313u);
...
static hipError_t hipModuleLaunchCooperativeKernelLayer(hipFunction_t f, unsigned int gridDimX, unsigned int gridDimY, unsigned int gridDimZ,
  ...
  auto* _rec = HipClrGetActiveRecord(314u);
...
static hipError_t hipModuleLaunchCooperativeKernelMultiDeviceLayer(hipFunctionLaunchParams* launchParamsList, unsigned int numDevices, unsigned int flags) {
  auto* _rec = HipClrGetActiveRecord(315u);
...
static hipError_t hipModuleLaunchKernelLayer(hipFunction_t f, unsigned int gridDimX,
                                              ...
                                              void** extra) {
  auto* _rec = HipClrGetActiveRecord(316u);
...
static hipError_t hipModuleLoadFatBinaryLayer(hipModule_t* module, const void* fatbin) {
  auto* _rec = HipClrGetActiveRecord(317u);
...
static hipError_t hipModuleLoadLayer(hipModule_t* module, const char* fname) {
  auto* _rec = HipClrGetActiveRecord(318u);
...
static hipError_t hipModuleLoadDataLayer(hipModule_t* module, const void* image) {
  auto* _rec = HipClrGetActiveRecord(319u);
...
static hipError_t hipModuleLoadDataExLayer(hipModule_t* module, const void* image,
                                            ...
                                            void** optionValues) {
  auto* _rec = HipClrGetActiveRecord(320u);
...
static hipError_t hipLinkAddDataLayer(hipLinkState_t state, hipJitInputType type, void* data,
  ...
  auto* _rec = HipClrGetActiveRecord(321u);
...
static hipError_t hipLinkAddFileLayer(hipLinkState_t state, hipJitInputType type, const char* path,
                                       unsigned int numOptions, hipJitOption* options,
                                       void** optionValues) {
  auto* _rec = HipClrGetActiveRecord(322u);
...
static hipError_t hipLinkCompleteLayer(hipLinkState_t state, void** hipBinOut, size_t* sizeOut) {
  auto* _rec = HipClrGetActiveRecord(323u);
...
static hipError_t hipLinkCreateLayer(unsigned int numOptions, hipJitOption* options,
  ...
  auto* _rec = HipClrGetActiveRecord(324u);
...
static hipError_t hipLinkDestroyLayer(hipLinkState_t state) {
  auto* _rec = HipClrGetActiveRecord(325u);
...
static hipError_t hipModuleOccupancyMaxActiveBlocksPerMultiprocessorLayer(int* numBlocks, hipFunction_t f, int blockSize, size_t dynSharedMemPerBlk) {
  auto* _rec = HipClrGetActiveRecord(326u);
...
static hipError_t hipModuleOccupancyMaxActiveBlocksPerMultiprocessorWithFlagsLayer(int* numBlocks, hipFunction_t f, int blockSize, size_t dynSharedMemPerBlk, unsigned int flags) {
  auto* _rec = HipClrGetActiveRecord(327u);
...
static hipError_t hipModuleOccupancyMaxPotentialBlockSizeLayer(int* gridSize, int* blockSize,
                                                                ...
                                                                int blockSizeLimit) {
  auto* _rec = HipClrGetActiveRecord(328u);
...
static hipError_t hipModuleOccupancyMaxPotentialBlockSizeWithFlagsLayer(int* gridSize, int* blockSize, hipFunction_t f, size_t dynSharedMemPerBlk, int blockSizeLimit,
    unsigned int flags) {
  auto* _rec = HipClrGetActiveRecord(329u);
...
static hipError_t hipModuleUnloadLayer(hipModule_t module) {
  auto* _rec = HipClrGetActiveRecord(330u);
...
static hipError_t hipOccupancyMaxActiveBlocksPerMultiprocessorLayer(int* numBlocks, const void* f,
                                                                     int blockSize,
                                                                     size_t dynSharedMemPerBlk) {
  auto* _rec = HipClrGetActiveRecord(331u);
...
static hipError_t hipOccupancyMaxActiveBlocksPerMultiprocessorWithFlagsLayer(int* numBlocks, const void* f, int blockSize, size_t dynSharedMemPerBlk, unsigned int flags) {
  auto* _rec = HipClrGetActiveRecord(332u);
...
static hipError_t hipOccupancyMaxPotentialBlockSizeLayer(int* gridSize, int* blockSize,
                                                          ...
                                                          int blockSizeLimit) {
  auto* _rec = HipClrGetActiveRecord(333u);
...
static hipError_t hipPeekAtLastErrorLayer(void) {
  auto* _rec = HipClrGetActiveRecord(334u);
...
static hipError_t hipPointerGetAttributeLayer(void* data, hipPointer_attribute attribute,
                                               hipDeviceptr_t ptr) {
  auto* _rec = HipClrGetActiveRecord(335u);
...
static hipError_t hipPointerGetAttributesLayer(hipPointerAttribute_t* attributes, const void* ptr) {
  auto* _rec = HipClrGetActiveRecord(336u);
...
static hipError_t hipPointerSetAttributeLayer(const void* value, hipPointer_attribute attribute,
                                               hipDeviceptr_t ptr) {
  auto* _rec = HipClrGetActiveRecord(337u);
...
static hipError_t hipProfilerStartLayer(void) {
  auto* _rec = HipClrGetActiveRecord(338u);
...
static hipError_t hipProfilerStopLayer(void) {
  auto* _rec = HipClrGetActiveRecord(339u);
...
static hipError_t hipRuntimeGetVersionLayer(int* runtimeVersion) {
  auto* _rec = HipClrGetActiveRecord(340u);
...
static hipError_t hipSetDeviceLayer(int deviceId) {
  auto* _rec = HipClrGetActiveRecord(341u);
...
static hipError_t hipSetDeviceFlagsLayer(unsigned flags) {
  auto* _rec = HipClrGetActiveRecord(342u);
...
static hipError_t hipSetupArgumentLayer(const void* arg, size_t size, size_t offset) {
  auto* _rec = HipClrGetActiveRecord(343u);
...
static hipError_t hipSignalExternalSemaphoresAsyncLayer(const hipExternalSemaphore_t* extSemArray, const hipExternalSemaphoreSignalParams* paramsArray,
  ...
  auto* _rec = HipClrGetActiveRecord(344u);
...
static hipError_t hipStreamAddCallbackLayer(hipStream_t stream, hipStreamCallback_t callback,
  ...
  auto* _rec = HipClrGetActiveRecord(345u);
...
static hipError_t hipStreamAttachMemAsyncLayer(hipStream_t stream, void* dev_ptr, size_t length,
                                                unsigned int flags) {
  auto* _rec = HipClrGetActiveRecord(346u);
...
static hipError_t hipStreamBeginCaptureLayer(hipStream_t stream, hipStreamCaptureMode mode) {
  auto* _rec = HipClrGetActiveRecord(347u);
...
static hipError_t hipStreamCopyAttributesLayer(hipStream_t dst, hipStream_t src) {
  auto* _rec = HipClrGetActiveRecord(348u);
...
static hipError_t hipStreamCreateLayer(hipStream_t* stream) {
  auto* _rec = HipClrGetActiveRecord(349u);
...
static hipError_t hipStreamCreateWithFlagsLayer(hipStream_t* stream, unsigned int flags) {
  auto* _rec = HipClrGetActiveRecord(350u);
...
static hipError_t hipStreamCreateWithPriorityLayer(hipStream_t* stream, unsigned int flags,
                                                    int priority) {
  auto* _rec = HipClrGetActiveRecord(351u);
...
static hipError_t hipStreamDestroyLayer(hipStream_t stream) {
  auto* _rec = HipClrGetActiveRecord(352u);
...
static hipError_t hipStreamEndCaptureLayer(hipStream_t stream, hipGraph_t* pGraph) {
  auto* _rec = HipClrGetActiveRecord(353u);
...
static hipError_t hipStreamGetCaptureInfoLayer(hipStream_t stream,
  ...
  auto* _rec = HipClrGetActiveRecord(354u);
...
static hipError_t hipStreamGetCaptureInfo_v2Layer(hipStream_t stream, hipStreamCaptureStatus* captureStatus_out, unsigned long long* id_out,
  ...
  auto* _rec = HipClrGetActiveRecord(355u);
...
static hipError_t hipStreamGetDeviceLayer(hipStream_t stream, hipDevice_t* device) {
  auto* _rec = HipClrGetActiveRecord(356u);
...
static hipError_t hipStreamGetFlagsLayer(hipStream_t stream, unsigned int* flags) {
  auto* _rec = HipClrGetActiveRecord(357u);
...
static hipError_t hipStreamGetIdLayer(hipStream_t stream, unsigned long long* streamId) {
  auto* _rec = HipClrGetActiveRecord(358u);
...
static hipError_t hipStreamGetPriorityLayer(hipStream_t stream, int* priority) {
  auto* _rec = HipClrGetActiveRecord(359u);
...
static hipError_t hipStreamIsCapturingLayer(hipStream_t stream,
                                             hipStreamCaptureStatus* pCaptureStatus) {
  auto* _rec = HipClrGetActiveRecord(360u);
...
static hipError_t hipStreamQueryLayer(hipStream_t stream) {
  auto* _rec = HipClrGetActiveRecord(361u);
...
static hipError_t hipStreamSynchronizeLayer(hipStream_t stream) {
  auto* _rec = HipClrGetActiveRecord(362u);
...
static hipError_t hipStreamUpdateCaptureDependenciesLayer(hipStream_t stream,
                                                           ...
                                                           size_t numDependencies,
                                                           unsigned int flags) {
  auto* _rec = HipClrGetActiveRecord(363u);
...
static hipError_t hipStreamWaitEventLayer(hipStream_t stream, hipEvent_t event,
                                           unsigned int flags) {
  auto* _rec = HipClrGetActiveRecord(364u);
...
static hipError_t hipStreamWaitValue32Layer(hipStream_t stream, void* ptr, uint32_t value,
  ...
  auto* _rec = HipClrGetActiveRecord(365u);
...
static hipError_t hipStreamWaitValue64Layer(hipStream_t stream, void* ptr, uint64_t value,
  ...
  auto* _rec = HipClrGetActiveRecord(366u);
...
static hipError_t hipStreamWriteValue32Layer(hipStream_t stream, void* ptr, uint32_t value,
                                              unsigned int flags) {
  auto* _rec = HipClrGetActiveRecord(367u);
...
static hipError_t hipStreamWriteValue64Layer(hipStream_t stream, void* ptr, uint64_t value,
                                              unsigned int flags) {
  auto* _rec = HipClrGetActiveRecord(368u);
...
static hipError_t hipStreamBatchMemOpLayer(hipStream_t stream, unsigned int count,
                                            ...
                                            unsigned int flags) {
  auto* _rec = HipClrGetActiveRecord(369u);
...
static hipError_t hipTexObjectCreateLayer(hipTextureObject_t* pTexObject,
  ...
  auto* _rec = HipClrGetActiveRecord(370u);
...
static hipError_t hipTexObjectDestroyLayer(hipTextureObject_t texObject) {
  auto* _rec = HipClrGetActiveRecord(371u);
...
static hipError_t hipTexObjectGetResourceDescLayer(HIP_RESOURCE_DESC* pResDesc,
  ...
  auto* _rec = HipClrGetActiveRecord(372u);
...
static hipError_t hipTexObjectGetResourceViewDescLayer(HIP_RESOURCE_VIEW_DESC* pResViewDesc,
                                                        hipTextureObject_t texObject) {
  auto* _rec = HipClrGetActiveRecord(373u);
...
static hipError_t hipTexObjectGetTextureDescLayer(HIP_TEXTURE_DESC* pTexDesc,
                                                   hipTextureObject_t texObject) {
  auto* _rec = HipClrGetActiveRecord(374u);
...
static hipError_t hipTexRefGetAddressLayer(hipDeviceptr_t* dev_ptr,
                                            const textureReference* texRef) {
  auto* _rec = HipClrGetActiveRecord(375u);
...
static hipError_t hipTexRefGetAddressModeLayer(enum hipTextureAddressMode* pam,
  ...
  auto* _rec = HipClrGetActiveRecord(376u);
...
static hipError_t hipTexRefGetFilterModeLayer(enum hipTextureFilterMode* pfm,
                                               const textureReference* texRef) {
  auto* _rec = HipClrGetActiveRecord(377u);
...
static hipError_t hipTexRefGetFlagsLayer(unsigned int* pFlags, const textureReference* texRef) {
  auto* _rec = HipClrGetActiveRecord(378u);
...
static hipError_t hipTexRefGetFormatLayer(hipArray_Format* pFormat, int* pNumChannels,
                                           const textureReference* texRef) {
  auto* _rec = HipClrGetActiveRecord(379u);
...
static hipError_t hipTexRefGetMaxAnisotropyLayer(int* pmaxAnsio, const textureReference* texRef) {
  auto* _rec = HipClrGetActiveRecord(380u);
...
static hipError_t hipTexRefGetMipMappedArrayLayer(hipMipmappedArray_t* pArray,
                                                   const textureReference* texRef) {
  auto* _rec = HipClrGetActiveRecord(381u);
...
static hipError_t hipTexRefGetMipmapFilterModeLayer(enum hipTextureFilterMode* pfm,
                                                     const textureReference* texRef) {
  auto* _rec = HipClrGetActiveRecord(382u);
...
static hipError_t hipTexRefGetMipmapLevelBiasLayer(float* pbias, const textureReference* texRef) {
  auto* _rec = HipClrGetActiveRecord(383u);
...
static hipError_t hipTexRefGetMipmapLevelClampLayer(float* pminMipmapLevelClamp,
                                                     ...
                                                     const textureReference* texRef) {
  auto* _rec = HipClrGetActiveRecord(384u);
...
static hipError_t hipTexRefSetAddressLayer(size_t* ByteOffset, textureReference* texRef,
  ...
  auto* _rec = HipClrGetActiveRecord(385u);
...
static hipError_t hipTexRefSetAddress2DLayer(textureReference* texRef,
                                              ...
                                              size_t Pitch) {
  auto* _rec = HipClrGetActiveRecord(386u);
...
static hipError_t hipTexRefSetAddressModeLayer(textureReference* texRef, int dim,
  ...
  auto* _rec = HipClrGetActiveRecord(387u);
...
static hipError_t hipTexRefSetArrayLayer(textureReference* tex, hipArray_const_t array,
                                          unsigned int flags) {
  auto* _rec = HipClrGetActiveRecord(388u);
...
static hipError_t hipTexRefSetBorderColorLayer(textureReference* texRef, float* pBorderColor) {
  auto* _rec = HipClrGetActiveRecord(389u);
...
static hipError_t hipTexRefSetFilterModeLayer(textureReference* texRef,
  ...
  auto* _rec = HipClrGetActiveRecord(390u);
...
static hipError_t hipTexRefSetFlagsLayer(textureReference* texRef, unsigned int Flags) {
  auto* _rec = HipClrGetActiveRecord(391u);
...
static hipError_t hipTexRefSetFormatLayer(textureReference* texRef, hipArray_Format fmt,
  ...
  auto* _rec = HipClrGetActiveRecord(392u);
...
static hipError_t hipTexRefSetMaxAnisotropyLayer(textureReference* texRef, unsigned int maxAniso) {
  auto* _rec = HipClrGetActiveRecord(393u);
...
static hipError_t hipTexRefSetMipmapFilterModeLayer(textureReference* texRef,
                                                     enum hipTextureFilterMode fm) {
  auto* _rec = HipClrGetActiveRecord(394u);
...
static hipError_t hipTexRefSetMipmapLevelBiasLayer(textureReference* texRef, float bias) {
  auto* _rec = HipClrGetActiveRecord(395u);
...
static hipError_t hipTexRefSetMipmapLevelClampLayer(textureReference* texRef,
  ...
  auto* _rec = HipClrGetActiveRecord(396u);
...
static hipError_t hipTexRefSetMipmappedArrayLayer(textureReference* texRef,
                                                   ...
                                                   unsigned int Flags) {
  auto* _rec = HipClrGetActiveRecord(397u);
...
static hipError_t hipThreadExchangeStreamCaptureModeLayer(hipStreamCaptureMode* mode) {
  auto* _rec = HipClrGetActiveRecord(398u);
...
static hipError_t hipUnbindTextureLayer(const textureReference* tex) {
  auto* _rec = HipClrGetActiveRecord(399u);
...
static hipError_t hipUserObjectCreateLayer(hipUserObject_t* object_out, void* ptr,
                                            ...
                                            unsigned int flags) {
  auto* _rec = HipClrGetActiveRecord(400u);
...
static hipError_t hipUserObjectReleaseLayer(hipUserObject_t object, unsigned int count) {
  auto* _rec = HipClrGetActiveRecord(401u);
...
static hipError_t hipUserObjectRetainLayer(hipUserObject_t object, unsigned int count) {
  auto* _rec = HipClrGetActiveRecord(402u);
...
static hipError_t hipWaitExternalSemaphoresAsyncLayer(const hipExternalSemaphore_t* extSemArray, const hipExternalSemaphoreWaitParams* paramsArray,
    unsigned int numExtSems, hipStream_t stream) {
  auto* _rec = HipClrGetActiveRecord(403u);
...
static hipChannelFormatDesc hipCreateChannelDescLayer(int x, int y, int z, int w,
  ...
  auto* _rec = HipClrGetActiveRecord(404u);
...
static hipError_t hipExtModuleLaunchKernelLayer(hipFunction_t f, uint32_t globalWorkSizeX,
  ...
  auto* _rec = HipClrGetActiveRecord(405u);
...
static hipError_t hipHccModuleLaunchKernelLayer(hipFunction_t f, uint32_t globalWorkSizeX,
  ...
  auto* _rec = HipClrGetActiveRecord(406u);
...
static hipError_t hipMemcpy_sptLayer(void* dst, const void* src, size_t sizeBytes,
                                      hipMemcpyKind kind) {
  auto* _rec = HipClrGetActiveRecord(407u);
...
static hipError_t hipMemcpyToSymbol_sptLayer(const void* symbol, const void* src, size_t sizeBytes,
                                              size_t offset, hipMemcpyKind kind) {
  auto* _rec = HipClrGetActiveRecord(408u);
...
static hipError_t hipMemcpyFromSymbol_sptLayer(void* dst, const void* symbol, size_t sizeBytes,
                                                size_t offset, hipMemcpyKind kind) {
  auto* _rec = HipClrGetActiveRecord(409u);
...
static hipError_t hipMemcpy2D_sptLayer(void* dst, size_t dpitch, const void* src, size_t spitch,
                                        size_t width, size_t height, hipMemcpyKind kind) {
  auto* _rec = HipClrGetActiveRecord(410u);
...
static hipError_t hipMemcpy2DFromArray_sptLayer(void* dst, size_t dpitch, hipArray_const_t src,
                                                 size_t wOffset, size_t hOffset, size_t width,
                                                 size_t height, hipMemcpyKind kind) {
  auto* _rec = HipClrGetActiveRecord(411u);
...
static hipError_t hipMemcpy3D_sptLayer(const struct hipMemcpy3DParms* p) {
  auto* _rec = HipClrGetActiveRecord(412u);
...
static hipError_t hipMemset_sptLayer(void* dst, int value, size_t sizeBytes) {
  auto* _rec = HipClrGetActiveRecord(413u);
...
static hipError_t hipMemsetAsync_sptLayer(void* dst, int value, size_t sizeBytes,
                                           hipStream_t stream) {
  auto* _rec = HipClrGetActiveRecord(414u);
...
static hipError_t hipMemset2D_sptLayer(void* dst, size_t pitch, int value, size_t width,
                                        size_t height) {
  auto* _rec = HipClrGetActiveRecord(415u);
...
static hipError_t hipMemset2DAsync_sptLayer(void* dst, size_t pitch, int value, size_t width,
                                             size_t height, hipStream_t stream) {
  auto* _rec = HipClrGetActiveRecord(416u);
...
static hipError_t hipMemset3DAsync_sptLayer(hipPitchedPtr pitchedDevPtr, int value,
  ...
  auto* _rec = HipClrGetActiveRecord(417u);
...
static hipError_t hipMemset3D_sptLayer(hipPitchedPtr pitchedDevPtr, int value, hipExtent extent) {
  auto* _rec = HipClrGetActiveRecord(418u);
...
static hipError_t hipMemcpyAsync_sptLayer(void* dst, const void* src, size_t sizeBytes,
                                           hipMemcpyKind kind, hipStream_t stream) {
  auto* _rec = HipClrGetActiveRecord(419u);
...
static hipError_t hipMemcpy3DAsync_sptLayer(const hipMemcpy3DParms* p, hipStream_t stream) {
  auto* _rec = HipClrGetActiveRecord(420u);
...
static hipError_t hipMemcpy2DAsync_sptLayer(void* dst, size_t dpitch, const void* src,
                                             ...
                                             hipMemcpyKind kind, hipStream_t stream) {
  auto* _rec = HipClrGetActiveRecord(421u);
...
static hipError_t hipMemcpyFromSymbolAsync_sptLayer(void* dst, const void* symbol,
                                                     ...
                                                     hipMemcpyKind kind, hipStream_t stream) {
  auto* _rec = HipClrGetActiveRecord(422u);
...
static hipError_t hipMemcpyToSymbolAsync_sptLayer(const void* symbol, const void* src,
                                                   size_t sizeBytes, size_t offset,
                                                   hipMemcpyKind kind, hipStream_t stream) {
  auto* _rec = HipClrGetActiveRecord(423u);
...
static hipError_t hipMemcpyFromArray_sptLayer(void* dst, hipArray_const_t src, size_t wOffsetSrc,
                                               size_t hOffset, size_t count, hipMemcpyKind kind) {
  auto* _rec = HipClrGetActiveRecord(424u);
...
static hipError_t hipMemcpy2DToArray_sptLayer(hipArray_t dst, size_t wOffset, size_t hOffset,
                                               const void* src, size_t spitch, size_t width,
                                               size_t height, hipMemcpyKind kind) {
  auto* _rec = HipClrGetActiveRecord(425u);
...
static hipError_t hipMemcpy2DFromArrayAsync_sptLayer(void* dst, size_t dpitch,
                                                      ...
                                                      size_t height, hipMemcpyKind kind,
                                                      hipStream_t stream) {
  auto* _rec = HipClrGetActiveRecord(426u);
...
static hipError_t hipMemcpy2DToArrayAsync_sptLayer(hipArray_t dst, size_t wOffset, size_t hOffset,
                                                    ...
                                                    size_t height, hipMemcpyKind kind,
                                                    hipStream_t stream) {
  auto* _rec = HipClrGetActiveRecord(427u);
...
static hipError_t hipStreamQuery_sptLayer(hipStream_t stream) {
  auto* _rec = HipClrGetActiveRecord(428u);
...
static hipError_t hipStreamSynchronize_sptLayer(hipStream_t stream) {
  auto* _rec = HipClrGetActiveRecord(429u);
...
static hipError_t hipStreamGetPriority_sptLayer(hipStream_t stream, int* priority) {
  auto* _rec = HipClrGetActiveRecord(430u);
...
static hipError_t hipStreamWaitEvent_sptLayer(hipStream_t stream, hipEvent_t event,
                                               unsigned int flags) {
  auto* _rec = HipClrGetActiveRecord(431u);
...
static hipError_t hipStreamGetFlags_sptLayer(hipStream_t stream, unsigned int* flags) {
  auto* _rec = HipClrGetActiveRecord(432u);
...
static hipError_t hipStreamAddCallback_sptLayer(hipStream_t stream, hipStreamCallback_t callback,
                                                 void* userData, unsigned int flags) {
  auto* _rec = HipClrGetActiveRecord(433u);
...
static hipError_t hipEventRecord_sptLayer(hipEvent_t event, hipStream_t stream) {
  auto* _rec = HipClrGetActiveRecord(434u);
...
static hipError_t hipLaunchCooperativeKernel_sptLayer(const void* f, dim3 gridDim, dim3 blockDim,
                                                       ...
                                                       hipStream_t hStream) {
  auto* _rec = HipClrGetActiveRecord(435u);
...
static hipError_t hipLaunchKernel_sptLayer(const void* function_address, dim3 numBlocks,
                                            dim3 dimBlocks, void** args, size_t sharedMemBytes,
                                            hipStream_t stream) {
  auto* _rec = HipClrGetActiveRecord(436u);
...
static hipError_t hipGraphLaunch_sptLayer(hipGraphExec_t graphExec, hipStream_t stream) {
  auto* _rec = HipClrGetActiveRecord(437u);
...
static hipError_t hipStreamBeginCapture_sptLayer(hipStream_t stream, hipStreamCaptureMode mode) {
  auto* _rec = HipClrGetActiveRecord(438u);
...
static hipError_t hipStreamEndCapture_sptLayer(hipStream_t stream, hipGraph_t* pGraph) {
  auto* _rec = HipClrGetActiveRecord(439u);
...
static hipError_t hipStreamIsCapturing_sptLayer(hipStream_t stream,
                                                 hipStreamCaptureStatus* pCaptureStatus) {
  auto* _rec = HipClrGetActiveRecord(440u);
...
static hipError_t hipStreamGetCaptureInfo_sptLayer(hipStream_t stream,
                                                    hipStreamCaptureStatus* pCaptureStatus,
                                                    unsigned long long* pId) {
  auto* _rec = HipClrGetActiveRecord(441u);
...
static hipError_t hipStreamGetCaptureInfo_v2_sptLayer(hipStream_t stream, hipStreamCaptureStatus* captureStatus_out, unsigned long long* id_out,
    hipGraph_t* graph_out, const hipGraphNode_t** dependencies_out, size_t* numDependencies_out) {
  auto* _rec = HipClrGetActiveRecord(442u);
...
static hipError_t hipLaunchHostFunc_sptLayer(hipStream_t stream, hipHostFn_t fn, void* userData) {
  auto* _rec = HipClrGetActiveRecord(443u);
...
static int hipGetStreamDeviceIdLayer(hipStream_t stream) {
  auto* _rec = HipClrGetActiveRecord(444u);
...
static hipError_t hipDrvGraphAddMemsetNodeLayer(hipGraphNode_t* phGraphNode, hipGraph_t hGraph,
  ...
  auto* _rec = HipClrGetActiveRecord(445u);
...
static hipError_t hipGetDevicePropertiesR0000Layer(hipDeviceProp_tR0000* prop, int device) {
  auto* _rec = HipClrGetActiveRecord(446u);
...
static hipError_t hipGetDriverEntryPointLayer(const char* symbol, void** funcPtr,
  ...
  auto* _rec = HipClrGetActiveRecord(447u);
...
static hipError_t hipGetDriverEntryPoint_sptLayer(const char* symbol, void** funcPtr,
                                                   unsigned long long flags,
                                                   hipDriverEntryPointQueryResult* status) {
  auto* _rec = HipClrGetActiveRecord(448u);
...
static hipError_t hipExtGetLastErrorLayer(void) {
  auto* _rec = HipClrGetActiveRecord(449u);
...
static hipError_t hipTexRefGetBorderColorLayer(float* pBorderColor,
                                                const textureReference* texRef) {
  auto* _rec = HipClrGetActiveRecord(450u);
...
static hipError_t hipTexRefGetArrayLayer(hipArray_t* pArray, const textureReference* texRef) {
  auto* _rec = HipClrGetActiveRecord(451u);
...
static hipError_t hipGetProcAddressLayer(const char* symbol, void** pfn, int hipVersion,
  ...
  auto* _rec = HipClrGetActiveRecord(452u);
...
static hipError_t hipGetProcAddress_sptLayer(const char* symbol, void** pfn, int hipVersion, uint64_t flags,
                                              hipDriverProcAddressQueryResult* symbolStatus) {
  auto* _rec = HipClrGetActiveRecord(453u);
...
static hipError_t hipStreamBeginCaptureToGraphLayer(hipStream_t stream, hipGraph_t graph,
  ...
  auto* _rec = HipClrGetActiveRecord(454u);
...
static hipError_t hipGetFuncBySymbolLayer(hipFunction_t* functionPtr, const void* symbolPtr) {
  auto* _rec = HipClrGetActiveRecord(455u);
...
static hipError_t hipSetValidDevicesLayer(int* device_arr, int len) {
  auto* _rec = HipClrGetActiveRecord(456u);
...
static hipError_t hipMemcpyAtoDLayer(hipDeviceptr_t dstDevice, hipArray_t srcArray,
  ...
  auto* _rec = HipClrGetActiveRecord(457u);
...
static hipError_t hipMemcpyDtoALayer(hipArray_t dstArray, size_t dstOffset,
  ...
  auto* _rec = HipClrGetActiveRecord(458u);
...
static hipError_t hipMemcpyAtoALayer(hipArray_t dstArray, size_t dstOffset, hipArray_t srcArray,
                                      size_t srcOffset, size_t ByteCount) {
  auto* _rec = HipClrGetActiveRecord(459u);
...
static hipError_t hipMemcpyAtoHAsyncLayer(void* dstHost, hipArray_t srcArray, size_t srcOffset,
  ...
  auto* _rec = HipClrGetActiveRecord(460u);
...
static hipError_t hipMemcpyHtoAAsyncLayer(hipArray_t dstArray, size_t dstOffset,
                                           ...
                                           hipStream_t stream) {
  auto* _rec = HipClrGetActiveRecord(461u);
...
static hipError_t hipMemcpy2DArrayToArrayLayer(hipArray_t dst, size_t wOffsetDst,
                                                ...
                                                size_t height, hipMemcpyKind kind) {
  auto* _rec = HipClrGetActiveRecord(462u);
...
static hipError_t hipDrvGraphAddMemFreeNodeLayer(hipGraphNode_t* phGraphNode, hipGraph_t hGraph,
  ...
  auto* _rec = HipClrGetActiveRecord(463u);
...
static hipError_t hipDrvGraphExecMemcpyNodeSetParamsLayer(hipGraphExec_t hGraphExec,
                                                           ...
                                                           hipCtx_t ctx) {
  auto* _rec = HipClrGetActiveRecord(464u);
...
static hipError_t hipDrvGraphExecMemsetNodeSetParamsLayer(hipGraphExec_t hGraphExec,
                                                           ...
                                                           hipCtx_t ctx) {
  auto* _rec = HipClrGetActiveRecord(465u);
...
static hipError_t hipGraphExecGetFlagsLayer(hipGraphExec_t graphExec, unsigned long long* flags) {
  auto* _rec = HipClrGetActiveRecord(466u);
...
static hipError_t hipGraphNodeSetParamsLayer(hipGraphNode_t node, hipGraphNodeParams* nodeParams) {
  auto* _rec = HipClrGetActiveRecord(467u);
...
static hipError_t hipGraphExecNodeSetParamsLayer(hipGraphExec_t graphExec, hipGraphNode_t node,
                                                  hipGraphNodeParams* nodeParams) {
  auto* _rec = HipClrGetActiveRecord(468u);
...
static hipError_t hipExternalMemoryGetMappedMipmappedArrayLayer(hipMipmappedArray_t* mipmap, hipExternalMemory_t extMem,
  ...
  auto* _rec = HipClrGetActiveRecord(469u);
...
static hipError_t hipDrvGraphMemcpyNodeGetParamsLayer(hipGraphNode_t hNode,
  ...
  auto* _rec = HipClrGetActiveRecord(470u);
...
static hipError_t hipDrvGraphMemcpyNodeSetParamsLayer(hipGraphNode_t hNode,
  ...
  auto* _rec = HipClrGetActiveRecord(471u);
...
static hipError_t hipGraphAddBatchMemOpNodeLayer(hipGraphNode_t* phGraphNode, hipGraph_t hGraph,
  ...
  auto* _rec = HipClrGetActiveRecord(472u);
...
static hipError_t hipGraphBatchMemOpNodeGetParamsLayer(hipGraphNode_t hNode,
  ...
  auto* _rec = HipClrGetActiveRecord(473u);
...
static hipError_t hipGraphBatchMemOpNodeSetParamsLayer(hipGraphNode_t hNode,
  ...
  auto* _rec = HipClrGetActiveRecord(474u);
...
static hipError_t hipGraphExecBatchMemOpNodeSetParamsLayer(hipGraphExec_t hGraphExec, hipGraphNode_t hNode, const hipBatchMemOpNodeParams* nodeParams) {
  auto* _rec = HipClrGetActiveRecord(475u);
...
static hipError_t hipEventRecordWithFlagsLayer(hipEvent_t event, hipStream_t stream,
                                                unsigned int flags) {
  auto* _rec = HipClrGetActiveRecord(476u);
...
static hipError_t hipLaunchKernelExCLayer(const hipLaunchConfig_t* config, const void* fPtr,
                                           void** args) {
  auto* _rec = HipClrGetActiveRecord(477u);
...
static hipError_t hipDrvLaunchKernelExLayer(const HIP_LAUNCH_CONFIG* config, hipFunction_t f,
  ...
  auto* _rec = HipClrGetActiveRecord(478u);
...
static hipError_t hipMemGetHandleForAddressRangeLayer(void* handle, hipDeviceptr_t dptr,
                                                       ...
                                                       unsigned long long flags) {
  auto* _rec = HipClrGetActiveRecord(479u);
...
static hipError_t hipMemsetD2D8Layer(hipDeviceptr_t dst, size_t dstPitch, unsigned char value,
  ...
  auto* _rec = HipClrGetActiveRecord(480u);
...
static hipError_t hipMemsetD2D8AsyncLayer(hipDeviceptr_t dst, size_t dstPitch, unsigned char value,
  ...
  auto* _rec = HipClrGetActiveRecord(481u);
...
static hipError_t hipMemsetD2D16Layer(hipDeviceptr_t dst, size_t dstPitch, unsigned short value,
                                       size_t width, size_t height) {
  auto* _rec = HipClrGetActiveRecord(482u);
...
static hipError_t hipMemsetD2D16AsyncLayer(hipDeviceptr_t dst, size_t dstPitch,
                                            ...
                                            hipStream_t stream) {
  auto* _rec = HipClrGetActiveRecord(483u);
...
static hipError_t hipMemsetD2D32Layer(hipDeviceptr_t dst, size_t dstPitch, unsigned int value,
                                       size_t width, size_t height) {
  auto* _rec = HipClrGetActiveRecord(484u);
...
static hipError_t hipMemsetD2D32AsyncLayer(hipDeviceptr_t dst, size_t dstPitch, unsigned int value,
                                            size_t width, size_t height, hipStream_t stream) {
  auto* _rec = HipClrGetActiveRecord(485u);
...
static hipError_t hipStreamGetAttributeLayer(hipStream_t stream, hipStreamAttrID attr,
  ...
  auto* _rec = HipClrGetActiveRecord(486u);
...
static hipError_t hipStreamSetAttributeLayer(hipStream_t stream, hipStreamAttrID attr,
  ...
  auto* _rec = HipClrGetActiveRecord(487u);
...
static hipError_t hipMemcpyBatchAsyncLayer(void** dsts, void** srcs, size_t* sizes, size_t count,
  ...
  auto* _rec = HipClrGetActiveRecord(488u);
...
static hipError_t hipMemcpy3DBatchAsyncLayer(size_t numOps, struct hipMemcpy3DBatchOp* opList,
                                              ...
                                              hipStream_t stream) {
  auto* _rec = HipClrGetActiveRecord(489u);
...
static hipError_t hipMemcpy3DPeerLayer(hipMemcpy3DPeerParms* p) {
  auto* _rec = HipClrGetActiveRecord(490u);
...
static hipError_t hipMemcpy3DPeerAsyncLayer(hipMemcpy3DPeerParms* p, hipStream_t stream) {
  auto* _rec = HipClrGetActiveRecord(491u);
...
static hipError_t hipLibraryLoadDataLayer(hipLibrary_t* library, const void* code,
  ...
  auto* _rec = HipClrGetActiveRecord(492u);
...
static hipError_t hipLibraryLoadFromFileLayer(hipLibrary_t* library, const char* fileName,
                                               ...
                                               void** libraryOptionValues,
                                               unsigned int numLibraryOptions) {
  auto* _rec = HipClrGetActiveRecord(493u);
...
static hipError_t hipLibraryUnloadLayer(hipLibrary_t library) {
  auto* _rec = HipClrGetActiveRecord(494u);
...
static hipError_t hipLibraryGetKernelLayer(hipKernel_t* pKernel, hipLibrary_t library,
                                            const char* name) {
  auto* _rec = HipClrGetActiveRecord(495u);
...
static hipError_t hipLibraryGetKernelCountLayer(unsigned int *count,
  ...
  auto* _rec = HipClrGetActiveRecord(496u);
...
static hipError_t hipLibraryEnumerateKernelsLayer(hipKernel_t* kernels, unsigned int numKernels,
                                                   hipLibrary_t library) {
  auto* _rec = HipClrGetActiveRecord(497u);
...
static hipError_t hipKernelGetLibraryLayer(hipLibrary_t* library, hipKernel_t kernel) {
  auto* _rec = HipClrGetActiveRecord(498u);
...
static hipError_t hipKernelGetNameLayer(const char** name, hipKernel_t kernel) {
  auto* _rec = HipClrGetActiveRecord(499u);
...
static hipError_t hipOccupancyAvailableDynamicSMemPerBlockLayer(size_t* dynamicSmemSize, const void* f,
  ...
  auto* _rec = HipClrGetActiveRecord(500u);
...
static hipError_t hipKernelGetParamInfoLayer(hipKernel_t kernel, size_t paramIndex,
  ...
  auto* _rec = HipClrGetActiveRecord(501u);
...
static hipError_t hipExtDisableLoggingLayer(void) {
  auto* _rec = HipClrGetActiveRecord(502u);
...
static hipError_t hipExtEnableLoggingLayer(void) {
  auto* _rec = HipClrGetActiveRecord(503u);
...
static hipError_t hipExtSetLoggingParamsLayer(size_t log_level, size_t log_size, size_t log_mask) {
  auto* _rec = HipClrGetActiveRecord(504u);
...
static hipError_t hipMemSetMemPoolLayer(hipMemLocation* location, hipMemAllocationType type,
                                         hipMemPool_t pool) {
  auto* _rec = HipClrGetActiveRecord(505u);
...
static hipError_t hipMemGetMemPoolLayer(hipMemPool_t* pool, hipMemLocation* location,
  ...
  auto* _rec = HipClrGetActiveRecord(506u);
...
static hipError_t hipKernelGetAttributeLayer(int* pi, hipFunction_attribute attrib, hipKernel_t kernel,
                                              hipDevice_t dev) {
  auto* _rec = HipClrGetActiveRecord(507u);
...
static hipError_t hipKernelSetAttributeLayer(hipFunction_attribute attrib,
  ...
  auto* _rec = HipClrGetActiveRecord(508u);
...
static hipError_t hipKernelGetFunctionLayer(hipFunction_t* pFunc, hipKernel_t kernel) {
  auto* _rec = HipClrGetActiveRecord(509u);
...
const char* const kHipClrApiNames[] = {
  "hipApiName",
  "hipArray3DCreate",
...
const size_t kHipClrApiNamesCount = 510;
...
void HipClrProfilerInstallWrappers(HipDispatchTable* tbl) {
  ...
  g_next = *tbl;
  HipDispatchTable wrapper_tbl = g_next;  // start from a full valid copy
  wrapper_tbl.hipApiName_fn = hipApiNameLayer;
  wrapper_tbl.hipArray3DCreate_fn = hipArray3DCreateLayer;
  wrapper_tbl.hipArray3DGetDescriptor_fn = hipArray3DGetDescriptorLayer;
  wrapper_tbl.hipArrayCreate_fn = hipArrayCreateLayer;
  wrapper_tbl.hipArrayDestroy_fn = hipArrayDestroyLayer;
  wrapper_tbl.hipArrayGetDescriptor_fn = hipArrayGetDescriptorLayer;
  wrapper_tbl.hipArrayGetInfo_fn = hipArrayGetInfoLayer;
  wrapper_tbl.hipBindTexture_fn = hipBindTextureLayer;
  wrapper_tbl.hipBindTexture2D_fn = hipBindTexture2DLayer;
  wrapper_tbl.hipBindTextureToArray_fn = hipBindTextureToArrayLayer;
  wrapper_tbl.hipBindTextureToMipmappedArray_fn = hipBindTextureToMipmappedArrayLayer;
  wrapper_tbl.hipChooseDevice_fn = hipChooseDeviceLayer;
  wrapper_tbl.hipChooseDeviceR0000_fn = hipChooseDeviceR0000Layer;
  wrapper_tbl.hipConfigureCall_fn = hipConfigureCallLayer;
  wrapper_tbl.hipCreateSurfaceObject_fn = hipCreateSurfaceObjectLayer;
  wrapper_tbl.hipCreateTextureObject_fn = hipCreateTextureObjectLayer;
  wrapper_tbl.hipCtxCreate_fn = hipCtxCreateLayer;
  wrapper_tbl.hipCtxDestroy_fn = hipCtxDestroyLayer;
  wrapper_tbl.hipCtxDisablePeerAccess_fn = hipCtxDisablePeerAccessLayer;
  wrapper_tbl.hipCtxEnablePeerAccess_fn = hipCtxEnablePeerAccessLayer;
  wrapper_tbl.hipCtxGetApiVersion_fn = hipCtxGetApiVersionLayer;
  wrapper_tbl.hipCtxGetCacheConfig_fn = hipCtxGetCacheConfigLayer;
  wrapper_tbl.hipCtxGetCurrent_fn = hipCtxGetCurrentLayer;
  wrapper_tbl.hipCtxGetDevice_fn = hipCtxGetDeviceLayer;
  wrapper_tbl.hipCtxGetFlags_fn = hipCtxGetFlagsLayer;
  wrapper_tbl.hipCtxGetSharedMemConfig_fn = hipCtxGetSharedMemConfigLayer;
  wrapper_tbl.hipCtxPopCurrent_fn = hipCtxPopCurrentLayer;
  wrapper_tbl.hipCtxPushCurrent_fn = hipCtxPushCurrentLayer;
  wrapper_tbl.hipCtxSetCacheConfig_fn = hipCtxSetCacheConfigLayer;
  wrapper_tbl.hipCtxSetCurrent_fn = hipCtxSetCurrentLayer;
  wrapper_tbl.hipCtxSetSharedMemConfig_fn = hipCtxSetSharedMemConfigLayer;
  wrapper_tbl.hipCtxSynchronize_fn = hipCtxSynchronizeLayer;
  wrapper_tbl.hipDestroyExternalMemory_fn = hipDestroyExternalMemoryLayer;
  wrapper_tbl.hipDestroyExternalSemaphore_fn = hipDestroyExternalSemaphoreLayer;
  wrapper_tbl.hipDestroySurfaceObject_fn = hipDestroySurfaceObjectLayer;
  wrapper_tbl.hipDestroyTextureObject_fn = hipDestroyTextureObjectLayer;
  wrapper_tbl.hipDeviceCanAccessPeer_fn = hipDeviceCanAccessPeerLayer;
  wrapper_tbl.hipDeviceComputeCapability_fn = hipDeviceComputeCapabilityLayer;
  wrapper_tbl.hipDeviceDisablePeerAccess_fn = hipDeviceDisablePeerAccessLayer;
  wrapper_tbl.hipDeviceEnablePeerAccess_fn = hipDeviceEnablePeerAccessLayer;
  wrapper_tbl.hipDeviceGet_fn = hipDeviceGetLayer;
  wrapper_tbl.hipDeviceGetAttribute_fn = hipDeviceGetAttributeLayer;
  wrapper_tbl.hipDeviceGetByPCIBusId_fn = hipDeviceGetByPCIBusIdLayer;
  wrapper_tbl.hipDeviceGetCacheConfig_fn = hipDeviceGetCacheConfigLayer;
  wrapper_tbl.hipDeviceGetDefaultMemPool_fn = hipDeviceGetDefaultMemPoolLayer;
  wrapper_tbl.hipDeviceGetGraphMemAttribute_fn = hipDeviceGetGraphMemAttributeLayer;
  wrapper_tbl.hipDeviceGetLimit_fn = hipDeviceGetLimitLayer;
  wrapper_tbl.hipDeviceGetMemPool_fn = hipDeviceGetMemPoolLayer;
  wrapper_tbl.hipDeviceGetName_fn = hipDeviceGetNameLayer;
  wrapper_tbl.hipDeviceGetP2PAttribute_fn = hipDeviceGetP2PAttributeLayer;
  wrapper_tbl.hipDeviceGetPCIBusId_fn = hipDeviceGetPCIBusIdLayer;
  wrapper_tbl.hipDeviceGetSharedMemConfig_fn = hipDeviceGetSharedMemConfigLayer;
  wrapper_tbl.hipDeviceGetStreamPriorityRange_fn = hipDeviceGetStreamPriorityRangeLayer;
  wrapper_tbl.hipDeviceGetTexture1DLinearMaxWidth_fn = hipDeviceGetTexture1DLinearMaxWidthLayer;
  wrapper_tbl.hipDeviceGetUuid_fn = hipDeviceGetUuidLayer;
  wrapper_tbl.hipDeviceGraphMemTrim_fn = hipDeviceGraphMemTrimLayer;
  wrapper_tbl.hipDevicePrimaryCtxGetState_fn = hipDevicePrimaryCtxGetStateLayer;
  wrapper_tbl.hipDevicePrimaryCtxRelease_fn = hipDevicePrimaryCtxReleaseLayer;
  wrapper_tbl.hipDevicePrimaryCtxReset_fn = hipDevicePrimaryCtxResetLayer;
  wrapper_tbl.hipDevicePrimaryCtxRetain_fn = hipDevicePrimaryCtxRetainLayer;
  wrapper_tbl.hipDevicePrimaryCtxSetFlags_fn = hipDevicePrimaryCtxSetFlagsLayer;
  wrapper_tbl.hipDeviceReset_fn = hipDeviceResetLayer;
  wrapper_tbl.hipDeviceSetCacheConfig_fn = hipDeviceSetCacheConfigLayer;
  wrapper_tbl.hipDeviceSetGraphMemAttribute_fn = hipDeviceSetGraphMemAttributeLayer;
  wrapper_tbl.hipDeviceSetLimit_fn = hipDeviceSetLimitLayer;
  wrapper_tbl.hipDeviceSetMemPool_fn = hipDeviceSetMemPoolLayer;
  wrapper_tbl.hipDeviceSetSharedMemConfig_fn = hipDeviceSetSharedMemConfigLayer;
  wrapper_tbl.hipDeviceSynchronize_fn = hipDeviceSynchronizeLayer;
  wrapper_tbl.hipDeviceTotalMem_fn = hipDeviceTotalMemLayer;
  wrapper_tbl.hipDriverGetVersion_fn = hipDriverGetVersionLayer;
  wrapper_tbl.hipDrvGetErrorName_fn = hipDrvGetErrorNameLayer;
  wrapper_tbl.hipDrvGetErrorString_fn = hipDrvGetErrorStringLayer;
  wrapper_tbl.hipDrvGraphAddMemcpyNode_fn = hipDrvGraphAddMemcpyNodeLayer;
  wrapper_tbl.hipDrvMemcpy2DUnaligned_fn = hipDrvMemcpy2DUnalignedLayer;
  wrapper_tbl.hipDrvMemcpy3D_fn = hipDrvMemcpy3DLayer;
  wrapper_tbl.hipDrvMemcpy3DAsync_fn = hipDrvMemcpy3DAsyncLayer;
  wrapper_tbl.hipDrvPointerGetAttributes_fn = hipDrvPointerGetAttributesLayer;
  wrapper_tbl.hipEventCreate_fn = hipEventCreateLayer;
  wrapper_tbl.hipEventCreateWithFlags_fn = hipEventCreateWithFlagsLayer;
  wrapper_tbl.hipEventDestroy_fn = hipEventDestroyLayer;
  wrapper_tbl.hipEventElapsedTime_fn = hipEventElapsedTimeLayer;
  wrapper_tbl.hipEventQuery_fn = hipEventQueryLayer;
  wrapper_tbl.hipEventRecord_fn = hipEventRecordLayer;
  wrapper_tbl.hipEventSynchronize_fn = hipEventSynchronizeLayer;
  wrapper_tbl.hipExtGetLinkTypeAndHopCount_fn = hipExtGetLinkTypeAndHopCountLayer;
  wrapper_tbl.hipExtLaunchKernel_fn = hipExtLaunchKernelLayer;
  wrapper_tbl.hipExtLaunchMultiKernelMultiDevice_fn = hipExtLaunchMultiKernelMultiDeviceLayer;
  wrapper_tbl.hipExtMallocWithFlags_fn = hipExtMallocWithFlagsLayer;
  wrapper_tbl.hipExtStreamCreateWithCUMask_fn = hipExtStreamCreateWithCUMaskLayer;
  wrapper_tbl.hipExtStreamGetCUMask_fn = hipExtStreamGetCUMaskLayer;
  wrapper_tbl.hipExternalMemoryGetMappedBuffer_fn = hipExternalMemoryGetMappedBufferLayer;
  wrapper_tbl.hipFree_fn = hipFreeLayer;
  wrapper_tbl.hipFreeArray_fn = hipFreeArrayLayer;
  wrapper_tbl.hipFreeAsync_fn = hipFreeAsyncLayer;
  wrapper_tbl.hipFreeHost_fn = hipFreeHostLayer;
  wrapper_tbl.hipFreeMipmappedArray_fn = hipFreeMipmappedArrayLayer;
  wrapper_tbl.hipFuncGetAttribute_fn = hipFuncGetAttributeLayer;
  wrapper_tbl.hipFuncGetAttributes_fn = hipFuncGetAttributesLayer;
  wrapper_tbl.hipFuncSetAttribute_fn = hipFuncSetAttributeLayer;
  wrapper_tbl.hipFuncSetCacheConfig_fn = hipFuncSetCacheConfigLayer;
  wrapper_tbl.hipFuncSetSharedMemConfig_fn = hipFuncSetSharedMemConfigLayer;
  wrapper_tbl.hipGLGetDevices_fn = hipGLGetDevicesLayer;
  wrapper_tbl.hipGetChannelDesc_fn = hipGetChannelDescLayer;
  wrapper_tbl.hipGetDevice_fn = hipGetDeviceLayer;
  wrapper_tbl.hipGetDeviceCount_fn = hipGetDeviceCountLayer;
  wrapper_tbl.hipGetDeviceFlags_fn = hipGetDeviceFlagsLayer;
  wrapper_tbl.hipGetDevicePropertiesR0600_fn = hipGetDevicePropertiesR0600Layer;
  wrapper_tbl.hipGetErrorName_fn = hipGetErrorNameLayer;
  wrapper_tbl.hipGetErrorString_fn = hipGetErrorStringLayer;
  wrapper_tbl.hipGetLastError_fn = hipGetLastErrorLayer;
  wrapper_tbl.hipGetMipmappedArrayLevel_fn = hipGetMipmappedArrayLevelLayer;
  wrapper_tbl.hipGetSymbolAddress_fn = hipGetSymbolAddressLayer;
  wrapper_tbl.hipGetSymbolSize_fn = hipGetSymbolSizeLayer;
  wrapper_tbl.hipGetTextureAlignmentOffset_fn = hipGetTextureAlignmentOffsetLayer;
  wrapper_tbl.hipGetTextureObjectResourceDesc_fn = hipGetTextureObjectResourceDescLayer;
  wrapper_tbl.hipGetTextureObjectResourceViewDesc_fn = hipGetTextureObjectResourceViewDescLayer;
  wrapper_tbl.hipGetTextureObjectTextureDesc_fn = hipGetTextureObjectTextureDescLayer;
  wrapper_tbl.hipGetTextureReference_fn = hipGetTextureReferenceLayer;
  wrapper_tbl.hipGraphAddChildGraphNode_fn = hipGraphAddChildGraphNodeLayer;
  wrapper_tbl.hipGraphAddDependencies_fn = hipGraphAddDependenciesLayer;
  wrapper_tbl.hipGraphAddEmptyNode_fn = hipGraphAddEmptyNodeLayer;
  wrapper_tbl.hipGraphAddEventRecordNode_fn = hipGraphAddEventRecordNodeLayer;
  wrapper_tbl.hipGraphAddEventWaitNode_fn = hipGraphAddEventWaitNodeLayer;
  wrapper_tbl.hipGraphAddHostNode_fn = hipGraphAddHostNodeLayer;
  wrapper_tbl.hipGraphAddKernelNode_fn = hipGraphAddKernelNodeLayer;
  wrapper_tbl.hipGraphAddMemAllocNode_fn = hipGraphAddMemAllocNodeLayer;
  wrapper_tbl.hipGraphAddMemFreeNode_fn = hipGraphAddMemFreeNodeLayer;
  wrapper_tbl.hipGraphAddMemcpyNode_fn = hipGraphAddMemcpyNodeLayer;
  wrapper_tbl.hipGraphAddMemcpyNode1D_fn = hipGraphAddMemcpyNode1DLayer;
  wrapper_tbl.hipGraphAddMemcpyNodeFromSymbol_fn = hipGraphAddMemcpyNodeFromSymbolLayer;
  wrapper_tbl.hipGraphAddMemcpyNodeToSymbol_fn = hipGraphAddMemcpyNodeToSymbolLayer;
  wrapper_tbl.hipGraphAddMemsetNode_fn = hipGraphAddMemsetNodeLayer;
  wrapper_tbl.hipGraphAddNode_fn = hipGraphAddNodeLayer;
  wrapper_tbl.hipGraphChildGraphNodeGetGraph_fn = hipGraphChildGraphNodeGetGraphLayer;
  wrapper_tbl.hipGraphClone_fn = hipGraphCloneLayer;
  wrapper_tbl.hipGraphCreate_fn = hipGraphCreateLayer;
  wrapper_tbl.hipGraphDebugDotPrint_fn = hipGraphDebugDotPrintLayer;
  wrapper_tbl.hipGraphDestroy_fn = hipGraphDestroyLayer;
  wrapper_tbl.hipGraphDestroyNode_fn = hipGraphDestroyNodeLayer;
  wrapper_tbl.hipGraphEventRecordNodeGetEvent_fn = hipGraphEventRecordNodeGetEventLayer;
  wrapper_tbl.hipGraphEventRecordNodeSetEvent_fn = hipGraphEventRecordNodeSetEventLayer;
  wrapper_tbl.hipGraphEventWaitNodeGetEvent_fn = hipGraphEventWaitNodeGetEventLayer;
  wrapper_tbl.hipGraphEventWaitNodeSetEvent_fn = hipGraphEventWaitNodeSetEventLayer;
  wrapper_tbl.hipGraphExecChildGraphNodeSetParams_fn = hipGraphExecChildGraphNodeSetParamsLayer;
  wrapper_tbl.hipGraphExecDestroy_fn = hipGraphExecDestroyLayer;
  wrapper_tbl.hipGraphExecEventRecordNodeSetEvent_fn = hipGraphExecEventRecordNodeSetEventLayer;
  wrapper_tbl.hipGraphExecEventWaitNodeSetEvent_fn = hipGraphExecEventWaitNodeSetEventLayer;
  wrapper_tbl.hipGraphExecHostNodeSetParams_fn = hipGraphExecHostNodeSetParamsLayer;
  wrapper_tbl.hipGraphExecKernelNodeSetParams_fn = hipGraphExecKernelNodeSetParamsLayer;
  wrapper_tbl.hipGraphExecMemcpyNodeSetParams_fn = hipGraphExecMemcpyNodeSetParamsLayer;
  wrapper_tbl.hipGraphExecMemcpyNodeSetParams1D_fn = hipGraphExecMemcpyNodeSetParams1DLayer;
  wrapper_tbl.hipGraphExecMemcpyNodeSetParamsFromSymbol_fn = hipGraphExecMemcpyNodeSetParamsFromSymbolLayer;
  wrapper_tbl.hipGraphExecMemcpyNodeSetParamsToSymbol_fn = hipGraphExecMemcpyNodeSetParamsToSymbolLayer;
  wrapper_tbl.hipGraphExecMemsetNodeSetParams_fn = hipGraphExecMemsetNodeSetParamsLayer;
  wrapper_tbl.hipGraphExecUpdate_fn = hipGraphExecUpdateLayer;
  wrapper_tbl.hipGraphGetEdges_fn = hipGraphGetEdgesLayer;
  wrapper_tbl.hipGraphGetNodes_fn = hipGraphGetNodesLayer;
  wrapper_tbl.hipGraphGetRootNodes_fn = hipGraphGetRootNodesLayer;
  wrapper_tbl.hipGraphHostNodeGetParams_fn = hipGraphHostNodeGetParamsLayer;
  wrapper_tbl.hipGraphHostNodeSetParams_fn = hipGraphHostNodeSetParamsLayer;
  wrapper_tbl.hipGraphInstantiate_fn = hipGraphInstantiateLayer;
  wrapper_tbl.hipGraphInstantiateWithFlags_fn = hipGraphInstantiateWithFlagsLayer;
  wrapper_tbl.hipGraphInstantiateWithParams_fn = hipGraphInstantiateWithParamsLayer;
  wrapper_tbl.hipGraphKernelNodeCopyAttributes_fn = hipGraphKernelNodeCopyAttributesLayer;
  wrapper_tbl.hipGraphKernelNodeGetAttribute_fn = hipGraphKernelNodeGetAttributeLayer;
  wrapper_tbl.hipGraphKernelNodeGetParams_fn = hipGraphKernelNodeGetParamsLayer;
  wrapper_tbl.hipGraphKernelNodeSetAttribute_fn = hipGraphKernelNodeSetAttributeLayer;
  wrapper_tbl.hipGraphKernelNodeSetParams_fn = hipGraphKernelNodeSetParamsLayer;
  wrapper_tbl.hipGraphLaunch_fn = hipGraphLaunchLayer;
  wrapper_tbl.hipGraphMemAllocNodeGetParams_fn = hipGraphMemAllocNodeGetParamsLayer;
  wrapper_tbl.hipGraphMemFreeNodeGetParams_fn = hipGraphMemFreeNodeGetParamsLayer;
  wrapper_tbl.hipGraphMemcpyNodeGetParams_fn = hipGraphMemcpyNodeGetParamsLayer;
  wrapper_tbl.hipGraphMemcpyNodeSetParams_fn = hipGraphMemcpyNodeSetParamsLayer;
  wrapper_tbl.hipGraphMemcpyNodeSetParams1D_fn = hipGraphMemcpyNodeSetParams1DLayer;
  wrapper_tbl.hipGraphMemcpyNodeSetParamsFromSymbol_fn = hipGraphMemcpyNodeSetParamsFromSymbolLayer;
  wrapper_tbl.hipGraphMemcpyNodeSetParamsToSymbol_fn = hipGraphMemcpyNodeSetParamsToSymbolLayer;
  wrapper_tbl.hipGraphMemsetNodeGetParams_fn = hipGraphMemsetNodeGetParamsLayer;
  wrapper_tbl.hipGraphMemsetNodeSetParams_fn = hipGraphMemsetNodeSetParamsLayer;
  wrapper_tbl.hipGraphNodeFindInClone_fn = hipGraphNodeFindInCloneLayer;
  wrapper_tbl.hipGraphNodeGetDependencies_fn = hipGraphNodeGetDependenciesLayer;
  wrapper_tbl.hipGraphNodeGetDependentNodes_fn = hipGraphNodeGetDependentNodesLayer;
  wrapper_tbl.hipGraphNodeGetEnabled_fn = hipGraphNodeGetEnabledLayer;
  wrapper_tbl.hipGraphNodeGetType_fn = hipGraphNodeGetTypeLayer;
  wrapper_tbl.hipGraphNodeSetEnabled_fn = hipGraphNodeSetEnabledLayer;
  wrapper_tbl.hipGraphReleaseUserObject_fn = hipGraphReleaseUserObjectLayer;
  wrapper_tbl.hipGraphRemoveDependencies_fn = hipGraphRemoveDependenciesLayer;
  wrapper_tbl.hipGraphRetainUserObject_fn = hipGraphRetainUserObjectLayer;
  wrapper_tbl.hipGraphUpload_fn = hipGraphUploadLayer;
  wrapper_tbl.hipGraphicsGLRegisterBuffer_fn = hipGraphicsGLRegisterBufferLayer;
  wrapper_tbl.hipGraphicsGLRegisterImage_fn = hipGraphicsGLRegisterImageLayer;
  wrapper_tbl.hipGraphicsMapResources_fn = hipGraphicsMapResourcesLayer;
  wrapper_tbl.hipGraphicsResourceGetMappedPointer_fn = hipGraphicsResourceGetMappedPointerLayer;
  wrapper_tbl.hipGraphicsSubResourceGetMappedArray_fn = hipGraphicsSubResourceGetMappedArrayLayer;
  wrapper_tbl.hipGraphicsUnmapResources_fn = hipGraphicsUnmapResourcesLayer;
  wrapper_tbl.hipGraphicsUnregisterResource_fn = hipGraphicsUnregisterResourceLayer;
  wrapper_tbl.hipHostAlloc_fn = hipHostAllocLayer;
  wrapper_tbl.hipHostFree_fn = hipHostFreeLayer;
  wrapper_tbl.hipHostGetDevicePointer_fn = hipHostGetDevicePointerLayer;
  wrapper_tbl.hipHostGetFlags_fn = hipHostGetFlagsLayer;
  wrapper_tbl.hipHostMalloc_fn = hipHostMallocLayer;
  wrapper_tbl.hipExtHostAlloc_fn = hipExtHostAllocLayer;
  wrapper_tbl.hipHostRegister_fn = hipHostRegisterLayer;
  wrapper_tbl.hipHostUnregister_fn = hipHostUnregisterLayer;
  wrapper_tbl.hipImportExternalMemory_fn = hipImportExternalMemoryLayer;
  wrapper_tbl.hipImportExternalSemaphore_fn = hipImportExternalSemaphoreLayer;
  wrapper_tbl.hipInit_fn = hipInitLayer;
  wrapper_tbl.hipIpcCloseMemHandle_fn = hipIpcCloseMemHandleLayer;
  wrapper_tbl.hipIpcGetEventHandle_fn = hipIpcGetEventHandleLayer;
  wrapper_tbl.hipIpcGetMemHandle_fn = hipIpcGetMemHandleLayer;
  wrapper_tbl.hipIpcOpenEventHandle_fn = hipIpcOpenEventHandleLayer;
  wrapper_tbl.hipIpcOpenMemHandle_fn = hipIpcOpenMemHandleLayer;
  wrapper_tbl.hipKernelNameRef_fn = hipKernelNameRefLayer;
  wrapper_tbl.hipKernelNameRefByPtr_fn = hipKernelNameRefByPtrLayer;
  wrapper_tbl.hipLaunchByPtr_fn = hipLaunchByPtrLayer;
  wrapper_tbl.hipLaunchCooperativeKernel_fn = hipLaunchCooperativeKernelLayer;
  wrapper_tbl.hipLaunchCooperativeKernelMultiDevice_fn = hipLaunchCooperativeKernelMultiDeviceLayer;
  wrapper_tbl.hipLaunchHostFunc_fn = hipLaunchHostFuncLayer;
  wrapper_tbl.hipLaunchKernel_fn = hipLaunchKernelLayer;
  wrapper_tbl.hipMalloc_fn = hipMallocLayer;
  wrapper_tbl.hipMalloc3D_fn = hipMalloc3DLayer;
  wrapper_tbl.hipMalloc3DArray_fn = hipMalloc3DArrayLayer;
  wrapper_tbl.hipMallocArray_fn = hipMallocArrayLayer;
  wrapper_tbl.hipMallocAsync_fn = hipMallocAsyncLayer;
  wrapper_tbl.hipMallocFromPoolAsync_fn = hipMallocFromPoolAsyncLayer;
  wrapper_tbl.hipMallocHost_fn = hipMallocHostLayer;
  wrapper_tbl.hipMallocManaged_fn = hipMallocManagedLayer;
  wrapper_tbl.hipMallocMipmappedArray_fn = hipMallocMipmappedArrayLayer;
  wrapper_tbl.hipMallocPitch_fn = hipMallocPitchLayer;
  wrapper_tbl.hipMemAddressFree_fn = hipMemAddressFreeLayer;
  wrapper_tbl.hipMemAddressReserve_fn = hipMemAddressReserveLayer;
  wrapper_tbl.hipMemAdvise_fn = hipMemAdviseLayer;
  wrapper_tbl.hipMemAdvise_v2_fn = hipMemAdvise_v2Layer;
  wrapper_tbl.hipMemAllocHost_fn = hipMemAllocHostLayer;
  wrapper_tbl.hipMemAllocPitch_fn = hipMemAllocPitchLayer;
  wrapper_tbl.hipMemCreate_fn = hipMemCreateLayer;
  wrapper_tbl.hipMemExportToShareableHandle_fn = hipMemExportToShareableHandleLayer;
  wrapper_tbl.hipMemGetAccess_fn = hipMemGetAccessLayer;
  wrapper_tbl.hipMemGetAddressRange_fn = hipMemGetAddressRangeLayer;
  wrapper_tbl.hipMemGetAllocationGranularity_fn = hipMemGetAllocationGranularityLayer;
  wrapper_tbl.hipMemGetAllocationPropertiesFromHandle_fn = hipMemGetAllocationPropertiesFromHandleLayer;
  wrapper_tbl.hipMemGetInfo_fn = hipMemGetInfoLayer;
  wrapper_tbl.hipMemImportFromShareableHandle_fn = hipMemImportFromShareableHandleLayer;
  wrapper_tbl.hipMemMap_fn = hipMemMapLayer;
  wrapper_tbl.hipMemMapArrayAsync_fn = hipMemMapArrayAsyncLayer;
  wrapper_tbl.hipMemPoolCreate_fn = hipMemPoolCreateLayer;
  wrapper_tbl.hipMemPoolDestroy_fn = hipMemPoolDestroyLayer;
  wrapper_tbl.hipMemPoolExportPointer_fn = hipMemPoolExportPointerLayer;
  wrapper_tbl.hipMemPoolExportToShareableHandle_fn = hipMemPoolExportToShareableHandleLayer;
  wrapper_tbl.hipMemPoolGetAccess_fn = hipMemPoolGetAccessLayer;
  wrapper_tbl.hipMemPoolGetAttribute_fn = hipMemPoolGetAttributeLayer;
  wrapper_tbl.hipMemPoolImportFromShareableHandle_fn = hipMemPoolImportFromShareableHandleLayer;
  wrapper_tbl.hipMemPoolImportPointer_fn = hipMemPoolImportPointerLayer;
  wrapper_tbl.hipMemPoolSetAccess_fn = hipMemPoolSetAccessLayer;
  wrapper_tbl.hipMemPoolSetAttribute_fn = hipMemPoolSetAttributeLayer;
  wrapper_tbl.hipMemPoolTrimTo_fn = hipMemPoolTrimToLayer;
  wrapper_tbl.hipMemPrefetchAsync_fn = hipMemPrefetchAsyncLayer;
  wrapper_tbl.hipMemPrefetchAsync_v2_fn = hipMemPrefetchAsync_v2Layer;
  wrapper_tbl.hipMemPrefetchBatchAsync_fn = hipMemPrefetchBatchAsyncLayer;
  wrapper_tbl.hipMemPtrGetInfo_fn = hipMemPtrGetInfoLayer;
  wrapper_tbl.hipMemRangeGetAttribute_fn = hipMemRangeGetAttributeLayer;
  wrapper_tbl.hipMemRangeGetAttributes_fn = hipMemRangeGetAttributesLayer;
  wrapper_tbl.hipMemRelease_fn = hipMemReleaseLayer;
  wrapper_tbl.hipMemRetainAllocationHandle_fn = hipMemRetainAllocationHandleLayer;
  wrapper_tbl.hipMemSetAccess_fn = hipMemSetAccessLayer;
  wrapper_tbl.hipMemUnmap_fn = hipMemUnmapLayer;
  wrapper_tbl.hipMemcpy_fn = hipMemcpyLayer;
  wrapper_tbl.hipMemcpy2D_fn = hipMemcpy2DLayer;
  wrapper_tbl.hipMemcpy2DAsync_fn = hipMemcpy2DAsyncLayer;
  wrapper_tbl.hipMemcpy2DFromArray_fn = hipMemcpy2DFromArrayLayer;
  wrapper_tbl.hipMemcpy2DFromArrayAsync_fn = hipMemcpy2DFromArrayAsyncLayer;
  wrapper_tbl.hipMemcpy2DToArray_fn = hipMemcpy2DToArrayLayer;
  wrapper_tbl.hipMemcpy2DToArrayAsync_fn = hipMemcpy2DToArrayAsyncLayer;
  wrapper_tbl.hipMemcpy3D_fn = hipMemcpy3DLayer;
  wrapper_tbl.hipMemcpy3DAsync_fn = hipMemcpy3DAsyncLayer;
  wrapper_tbl.hipMemcpyAsync_fn = hipMemcpyAsyncLayer;
  wrapper_tbl.hipMemcpyAtoH_fn = hipMemcpyAtoHLayer;
  wrapper_tbl.hipMemcpyDtoD_fn = hipMemcpyDtoDLayer;
  wrapper_tbl.hipMemcpyDtoDAsync_fn = hipMemcpyDtoDAsyncLayer;
  wrapper_tbl.hipMemcpyDtoH_fn = hipMemcpyDtoHLayer;
  wrapper_tbl.hipMemcpyDtoHAsync_fn = hipMemcpyDtoHAsyncLayer;
  wrapper_tbl.hipMemcpyFromArray_fn = hipMemcpyFromArrayLayer;
  wrapper_tbl.hipMemcpyFromSymbol_fn = hipMemcpyFromSymbolLayer;
  wrapper_tbl.hipMemcpyFromSymbolAsync_fn = hipMemcpyFromSymbolAsyncLayer;
  wrapper_tbl.hipMemcpyHtoA_fn = hipMemcpyHtoALayer;
  wrapper_tbl.hipMemcpyHtoD_fn = hipMemcpyHtoDLayer;
  wrapper_tbl.hipMemcpyHtoDAsync_fn = hipMemcpyHtoDAsyncLayer;
  wrapper_tbl.hipMemcpyParam2D_fn = hipMemcpyParam2DLayer;
  wrapper_tbl.hipMemcpyParam2DAsync_fn = hipMemcpyParam2DAsyncLayer;
  wrapper_tbl.hipMemcpyPeer_fn = hipMemcpyPeerLayer;
  wrapper_tbl.hipMemcpyPeerAsync_fn = hipMemcpyPeerAsyncLayer;
  wrapper_tbl.hipMemcpyToArray_fn = hipMemcpyToArrayLayer;
  wrapper_tbl.hipMemcpyToSymbol_fn = hipMemcpyToSymbolLayer;
  wrapper_tbl.hipMemcpyToSymbolAsync_fn = hipMemcpyToSymbolAsyncLayer;
  wrapper_tbl.hipMemcpyWithStream_fn = hipMemcpyWithStreamLayer;
  wrapper_tbl.hipMemset_fn = hipMemsetLayer;
  wrapper_tbl.hipMemset2D_fn = hipMemset2DLayer;
  wrapper_tbl.hipMemset2DAsync_fn = hipMemset2DAsyncLayer;
  wrapper_tbl.hipMemset3D_fn = hipMemset3DLayer;
  wrapper_tbl.hipMemset3DAsync_fn = hipMemset3DAsyncLayer;
  wrapper_tbl.hipMemsetAsync_fn = hipMemsetAsyncLayer;
  wrapper_tbl.hipMemsetD16_fn = hipMemsetD16Layer;
  wrapper_tbl.hipMemsetD16Async_fn = hipMemsetD16AsyncLayer;
  wrapper_tbl.hipMemsetD32_fn = hipMemsetD32Layer;
  wrapper_tbl.hipMemsetD32Async_fn = hipMemsetD32AsyncLayer;
  wrapper_tbl.hipMemsetD8_fn = hipMemsetD8Layer;
  wrapper_tbl.hipMemsetD8Async_fn = hipMemsetD8AsyncLayer;
  wrapper_tbl.hipMipmappedArrayCreate_fn = hipMipmappedArrayCreateLayer;
  wrapper_tbl.hipMipmappedArrayDestroy_fn = hipMipmappedArrayDestroyLayer;
  wrapper_tbl.hipMipmappedArrayGetMemoryRequirements_fn = hipMipmappedArrayGetMemoryRequirementsLayer;
  wrapper_tbl.hipMipmappedArrayGetLevel_fn = hipMipmappedArrayGetLevelLayer;
  wrapper_tbl.hipModuleGetFunction_fn = hipModuleGetFunctionLayer;
  wrapper_tbl.hipModuleGetFunctionCount_fn = hipModuleGetFunctionCountLayer;
  wrapper_tbl.hipModuleGetGlobal_fn = hipModuleGetGlobalLayer;
  wrapper_tbl.hipModuleGetTexRef_fn = hipModuleGetTexRefLayer;
  wrapper_tbl.hipModuleLaunchCooperativeKernel_fn = hipModuleLaunchCooperativeKernelLayer;
  wrapper_tbl.hipModuleLaunchCooperativeKernelMultiDevice_fn = hipModuleLaunchCooperativeKernelMultiDeviceLayer;
  wrapper_tbl.hipModuleLaunchKernel_fn = hipModuleLaunchKernelLayer;
  wrapper_tbl.hipModuleLoadFatBinary_fn = hipModuleLoadFatBinaryLayer;
  wrapper_tbl.hipModuleLoad_fn = hipModuleLoadLayer;
  wrapper_tbl.hipModuleLoadData_fn = hipModuleLoadDataLayer;
  wrapper_tbl.hipModuleLoadDataEx_fn = hipModuleLoadDataExLayer;
  wrapper_tbl.hipLinkAddData_fn = hipLinkAddDataLayer;
  wrapper_tbl.hipLinkAddFile_fn = hipLinkAddFileLayer;
  wrapper_tbl.hipLinkComplete_fn = hipLinkCompleteLayer;
  wrapper_tbl.hipLinkCreate_fn = hipLinkCreateLayer;
  wrapper_tbl.hipLinkDestroy_fn = hipLinkDestroyLayer;
  wrapper_tbl.hipModuleOccupancyMaxActiveBlocksPerMultiprocessor_fn = hipModuleOccupancyMaxActiveBlocksPerMultiprocessorLayer;
  wrapper_tbl.hipModuleOccupancyMaxActiveBlocksPerMultiprocessorWithFlags_fn = hipModuleOccupancyMaxActiveBlocksPerMultiprocessorWithFlagsLayer;
  wrapper_tbl.hipModuleOccupancyMaxPotentialBlockSize_fn = hipModuleOccupancyMaxPotentialBlockSizeLayer;
  wrapper_tbl.hipModuleOccupancyMaxPotentialBlockSizeWithFlags_fn = hipModuleOccupancyMaxPotentialBlockSizeWithFlagsLayer;
  wrapper_tbl.hipModuleUnload_fn = hipModuleUnloadLayer;
  ...
  wrapper_tbl.hipPointerSetAttribute_fn = hipPointerSetAttributeLayer;
  wrapper_tbl.hipProfilerStart_fn = hipProfilerStartLayer;
  wrapper_tbl.hipProfilerStop_fn = hipProfilerStopLayer;
  wrapper_tbl.hipRuntimeGetVersion_fn = hipRuntimeGetVersionLayer;
  wrapper_tbl.hipSetDevice_fn = hipSetDeviceLayer;
  wrapper_tbl.hipSetDeviceFlags_fn = hipSetDeviceFlagsLayer;
  wrapper_tbl.hipSetupArgument_fn = hipSetupArgumentLayer;
  wrapper_tbl.hipSignalExternalSemaphoresAsync_fn = hipSignalExternalSemaphoresAsyncLayer;
  wrapper_tbl.hipStreamAddCallback_fn = hipStreamAddCallbackLayer;
  wrapper_tbl.hipStreamAttachMemAsync_fn = hipStreamAttachMemAsyncLayer;
  wrapper_tbl.hipStreamBeginCapture_fn = hipStreamBeginCaptureLayer;
  wrapper_tbl.hipStreamCopyAttributes_fn = hipStreamCopyAttributesLayer;
  wrapper_tbl.hipStreamCreate_fn = hipStreamCreateLayer;
  wrapper_tbl.hipStreamCreateWithFlags_fn = hipStreamCreateWithFlagsLayer;
  wrapper_tbl.hipStreamCreateWithPriority_fn = hipStreamCreateWithPriorityLayer;
  wrapper_tbl.hipStreamDestroy_fn = hipStreamDestroyLayer;
  wrapper_tbl.hipStreamEndCapture_fn = hipStreamEndCaptureLayer;
  wrapper_tbl.hipStreamGetCaptureInfo_fn = hipStreamGetCaptureInfoLayer;
  wrapper_tbl.hipStreamGetCaptureInfo_v2_fn = hipStreamGetCaptureInfo_v2Layer;
  wrapper_tbl.hipStreamGetDevice_fn = hipStreamGetDeviceLayer;
  wrapper_tbl.hipStreamGetFlags_fn = hipStreamGetFlagsLayer;
  wrapper_tbl.hipStreamGetId_fn = hipStreamGetIdLayer;
  wrapper_tbl.hipStreamGetPriority_fn = hipStreamGetPriorityLayer;
  wrapper_tbl.hipStreamIsCapturing_fn = hipStreamIsCapturingLayer;
  wrapper_tbl.hipStreamQuery_fn = hipStreamQueryLayer;
  wrapper_tbl.hipStreamSynchronize_fn = hipStreamSynchronizeLayer;
  wrapper_tbl.hipStreamUpdateCaptureDependencies_fn = hipStreamUpdateCaptureDependenciesLayer;
  wrapper_tbl.hipStreamWaitEvent_fn = hipStreamWaitEventLayer;
  wrapper_tbl.hipStreamWaitValue32_fn = hipStreamWaitValue32Layer;
  wrapper_tbl.hipStreamWaitValue64_fn = hipStreamWaitValue64Layer;
  wrapper_tbl.hipStreamWriteValue32_fn = hipStreamWriteValue32Layer;
  wrapper_tbl.hipStreamWriteValue64_fn = hipStreamWriteValue64Layer;
  wrapper_tbl.hipStreamBatchMemOp_fn = hipStreamBatchMemOpLayer;
  wrapper_tbl.hipTexObjectCreate_fn = hipTexObjectCreateLayer;
  wrapper_tbl.hipTexObjectDestroy_fn = hipTexObjectDestroyLayer;
  wrapper_tbl.hipTexObjectGetResourceDesc_fn = hipTexObjectGetResourceDescLayer;
  wrapper_tbl.hipTexObjectGetResourceViewDesc_fn = hipTexObjectGetResourceViewDescLayer;
  wrapper_tbl.hipTexObjectGetTextureDesc_fn = hipTexObjectGetTextureDescLayer;
  wrapper_tbl.hipTexRefGetAddress_fn = hipTexRefGetAddressLayer;
  wrapper_tbl.hipTexRefGetAddressMode_fn = hipTexRefGetAddressModeLayer;
  wrapper_tbl.hipTexRefGetFilterMode_fn = hipTexRefGetFilterModeLayer;
  wrapper_tbl.hipTexRefGetFlags_fn = hipTexRefGetFlagsLayer;
  wrapper_tbl.hipTexRefGetFormat_fn = hipTexRefGetFormatLayer;
  wrapper_tbl.hipTexRefGetMaxAnisotropy_fn = hipTexRefGetMaxAnisotropyLayer;
  wrapper_tbl.hipTexRefGetMipMappedArray_fn = hipTexRefGetMipMappedArrayLayer;
  wrapper_tbl.hipTexRefGetMipmapFilterMode_fn = hipTexRefGetMipmapFilterModeLayer;
  wrapper_tbl.hipTexRefGetMipmapLevelBias_fn = hipTexRefGetMipmapLevelBiasLayer;
  wrapper_tbl.hipTexRefGetMipmapLevelClamp_fn = hipTexRefGetMipmapLevelClampLayer;
  wrapper_tbl.hipTexRefSetAddress_fn = hipTexRefSetAddressLayer;
  wrapper_tbl.hipTexRefSetAddress2D_fn = hipTexRefSetAddress2DLayer;
  wrapper_tbl.hipTexRefSetAddressMode_fn = hipTexRefSetAddressModeLayer;
  wrapper_tbl.hipTexRefSetArray_fn = hipTexRefSetArrayLayer;
  wrapper_tbl.hipTexRefSetBorderColor_fn = hipTexRefSetBorderColorLayer;
  wrapper_tbl.hipTexRefSetFilterMode_fn = hipTexRefSetFilterModeLayer;
  wrapper_tbl.hipTexRefSetFlags_fn = hipTexRefSetFlagsLayer;
  wrapper_tbl.hipTexRefSetFormat_fn = hipTexRefSetFormatLayer;
  wrapper_tbl.hipTexRefSetMaxAnisotropy_fn = hipTexRefSetMaxAnisotropyLayer;
  wrapper_tbl.hipTexRefSetMipmapFilterMode_fn = hipTexRefSetMipmapFilterModeLayer;
  wrapper_tbl.hipTexRefSetMipmapLevelBias_fn = hipTexRefSetMipmapLevelBiasLayer;
  wrapper_tbl.hipTexRefSetMipmapLevelClamp_fn = hipTexRefSetMipmapLevelClampLayer;
  wrapper_tbl.hipTexRefSetMipmappedArray_fn = hipTexRefSetMipmappedArrayLayer;
  wrapper_tbl.hipThreadExchangeStreamCaptureMode_fn = hipThreadExchangeStreamCaptureModeLayer;
  wrapper_tbl.hipUnbindTexture_fn = hipUnbindTextureLayer;
  wrapper_tbl.hipUserObjectCreate_fn = hipUserObjectCreateLayer;
  wrapper_tbl.hipUserObjectRelease_fn = hipUserObjectReleaseLayer;
  wrapper_tbl.hipUserObjectRetain_fn = hipUserObjectRetainLayer;
  wrapper_tbl.hipWaitExternalSemaphoresAsync_fn = hipWaitExternalSemaphoresAsyncLayer;
  wrapper_tbl.hipCreateChannelDesc_fn = hipCreateChannelDescLayer;
  wrapper_tbl.hipExtModuleLaunchKernel_fn = hipExtModuleLaunchKernelLayer;
  wrapper_tbl.hipHccModuleLaunchKernel_fn = hipHccModuleLaunchKernelLayer;
  wrapper_tbl.hipMemcpy_spt_fn = hipMemcpy_sptLayer;
  wrapper_tbl.hipMemcpyToSymbol_spt_fn = hipMemcpyToSymbol_sptLayer;
  wrapper_tbl.hipMemcpyFromSymbol_spt_fn = hipMemcpyFromSymbol_sptLayer;
  wrapper_tbl.hipMemcpy2D_spt_fn = hipMemcpy2D_sptLayer;
  wrapper_tbl.hipMemcpy2DFromArray_spt_fn = hipMemcpy2DFromArray_sptLayer;
  wrapper_tbl.hipMemcpy3D_spt_fn = hipMemcpy3D_sptLayer;
  wrapper_tbl.hipMemset_spt_fn = hipMemset_sptLayer;
  wrapper_tbl.hipMemsetAsync_spt_fn = hipMemsetAsync_sptLayer;
  wrapper_tbl.hipMemset2D_spt_fn = hipMemset2D_sptLayer;
  wrapper_tbl.hipMemset2DAsync_spt_fn = hipMemset2DAsync_sptLayer;
  wrapper_tbl.hipMemset3DAsync_spt_fn = hipMemset3DAsync_sptLayer;
  wrapper_tbl.hipMemset3D_spt_fn = hipMemset3D_sptLayer;
  wrapper_tbl.hipMemcpyAsync_spt_fn = hipMemcpyAsync_sptLayer;
  wrapper_tbl.hipMemcpy3DAsync_spt_fn = hipMemcpy3DAsync_sptLayer;
  wrapper_tbl.hipMemcpy2DAsync_spt_fn = hipMemcpy2DAsync_sptLayer;
  wrapper_tbl.hipMemcpyFromSymbolAsync_spt_fn = hipMemcpyFromSymbolAsync_sptLayer;
  wrapper_tbl.hipMemcpyToSymbolAsync_spt_fn = hipMemcpyToSymbolAsync_sptLayer;
  wrapper_tbl.hipMemcpyFromArray_spt_fn = hipMemcpyFromArray_sptLayer;
  wrapper_tbl.hipMemcpy2DToArray_spt_fn = hipMemcpy2DToArray_sptLayer;
  wrapper_tbl.hipMemcpy2DFromArrayAsync_spt_fn = hipMemcpy2DFromArrayAsync_sptLayer;
  wrapper_tbl.hipMemcpy2DToArrayAsync_spt_fn = hipMemcpy2DToArrayAsync_sptLayer;
  wrapper_tbl.hipStreamQuery_spt_fn = hipStreamQuery_sptLayer;
  wrapper_tbl.hipStreamSynchronize_spt_fn = hipStreamSynchronize_sptLayer;
  wrapper_tbl.hipStreamGetPriority_spt_fn = hipStreamGetPriority_sptLayer;
  wrapper_tbl.hipStreamWaitEvent_spt_fn = hipStreamWaitEvent_sptLayer;
  wrapper_tbl.hipStreamGetFlags_spt_fn = hipStreamGetFlags_sptLayer;
  wrapper_tbl.hipStreamAddCallback_spt_fn = hipStreamAddCallback_sptLayer;
  wrapper_tbl.hipEventRecord_spt_fn = hipEventRecord_sptLayer;
  wrapper_tbl.hipLaunchCooperativeKernel_spt_fn = hipLaunchCooperativeKernel_sptLayer;
  wrapper_tbl.hipLaunchKernel_spt_fn = hipLaunchKernel_sptLayer;
  wrapper_tbl.hipGraphLaunch_spt_fn = hipGraphLaunch_sptLayer;
  wrapper_tbl.hipStreamBeginCapture_spt_fn = hipStreamBeginCapture_sptLayer;
  wrapper_tbl.hipStreamEndCapture_spt_fn = hipStreamEndCapture_sptLayer;
  wrapper_tbl.hipStreamIsCapturing_spt_fn = hipStreamIsCapturing_sptLayer;
  wrapper_tbl.hipStreamGetCaptureInfo_spt_fn = hipStreamGetCaptureInfo_sptLayer;
  wrapper_tbl.hipStreamGetCaptureInfo_v2_spt_fn = hipStreamGetCaptureInfo_v2_sptLayer;
  wrapper_tbl.hipLaunchHostFunc_spt_fn = hipLaunchHostFunc_sptLayer;
  wrapper_tbl.hipGetStreamDeviceId_fn = hipGetStreamDeviceIdLayer;
  wrapper_tbl.hipDrvGraphAddMemsetNode_fn = hipDrvGraphAddMemsetNodeLayer;
  wrapper_tbl.hipGetDevicePropertiesR0000_fn = hipGetDevicePropertiesR0000Layer;
  wrapper_tbl.hipGetDriverEntryPoint_fn = hipGetDriverEntryPointLayer;
  wrapper_tbl.hipGetDriverEntryPoint_spt_fn = hipGetDriverEntryPoint_sptLayer;
  wrapper_tbl.hipExtGetLastError_fn = hipExtGetLastErrorLayer;
  wrapper_tbl.hipTexRefGetBorderColor_fn = hipTexRefGetBorderColorLayer;
  wrapper_tbl.hipTexRefGetArray_fn = hipTexRefGetArrayLayer;
  wrapper_tbl.hipGetProcAddress_fn = hipGetProcAddressLayer;
  wrapper_tbl.hipGetProcAddress_spt_fn = hipGetProcAddress_sptLayer;
  wrapper_tbl.hipStreamBeginCaptureToGraph_fn = hipStreamBeginCaptureToGraphLayer;
  wrapper_tbl.hipGetFuncBySymbol_fn = hipGetFuncBySymbolLayer;
  wrapper_tbl.hipSetValidDevices_fn = hipSetValidDevicesLayer;
  wrapper_tbl.hipMemcpyAtoD_fn = hipMemcpyAtoDLayer;
  wrapper_tbl.hipMemcpyDtoA_fn = hipMemcpyDtoALayer;
  wrapper_tbl.hipMemcpyAtoA_fn = hipMemcpyAtoALayer;
  wrapper_tbl.hipMemcpyAtoHAsync_fn = hipMemcpyAtoHAsyncLayer;
  wrapper_tbl.hipMemcpyHtoAAsync_fn = hipMemcpyHtoAAsyncLayer;
  wrapper_tbl.hipMemcpy2DArrayToArray_fn = hipMemcpy2DArrayToArrayLayer;
  wrapper_tbl.hipDrvGraphAddMemFreeNode_fn = hipDrvGraphAddMemFreeNodeLayer;
  wrapper_tbl.hipDrvGraphExecMemcpyNodeSetParams_fn = hipDrvGraphExecMemcpyNodeSetParamsLayer;
  wrapper_tbl.hipDrvGraphExecMemsetNodeSetParams_fn = hipDrvGraphExecMemsetNodeSetParamsLayer;
  wrapper_tbl.hipGraphExecGetFlags_fn = hipGraphExecGetFlagsLayer;
  wrapper_tbl.hipGraphNodeSetParams_fn = hipGraphNodeSetParamsLayer;
  wrapper_tbl.hipGraphExecNodeSetParams_fn = hipGraphExecNodeSetParamsLayer;
  wrapper_tbl.hipExternalMemoryGetMappedMipmappedArray_fn = hipExternalMemoryGetMappedMipmappedArrayLayer;
  wrapper_tbl.hipDrvGraphMemcpyNodeGetParams_fn = hipDrvGraphMemcpyNodeGetParamsLayer;
  wrapper_tbl.hipDrvGraphMemcpyNodeSetParams_fn = hipDrvGraphMemcpyNodeSetParamsLayer;
  wrapper_tbl.hipGraphAddBatchMemOpNode_fn = hipGraphAddBatchMemOpNodeLayer;
  wrapper_tbl.hipGraphBatchMemOpNodeGetParams_fn = hipGraphBatchMemOpNodeGetParamsLayer;
  wrapper_tbl.hipGraphBatchMemOpNodeSetParams_fn = hipGraphBatchMemOpNodeSetParamsLayer;
  wrapper_tbl.hipGraphExecBatchMemOpNodeSetParams_fn = hipGraphExecBatchMemOpNodeSetParamsLayer;
  wrapper_tbl.hipEventRecordWithFlags_fn = hipEventRecordWithFlagsLayer;
  wrapper_tbl.hipLaunchKernelExC_fn = hipLaunchKernelExCLayer;
  wrapper_tbl.hipDrvLaunchKernelEx_fn = hipDrvLaunchKernelExLayer;
  wrapper_tbl.hipMemGetHandleForAddressRange_fn = hipMemGetHandleForAddressRangeLayer;
  wrapper_tbl.hipMemsetD2D8_fn = hipMemsetD2D8Layer;
  wrapper_tbl.hipMemsetD2D8Async_fn = hipMemsetD2D8AsyncLayer;
  wrapper_tbl.hipMemsetD2D16_fn = hipMemsetD2D16Layer;
  wrapper_tbl.hipMemsetD2D16Async_fn = hipMemsetD2D16AsyncLayer;
  wrapper_tbl.hipMemsetD2D32_fn = hipMemsetD2D32Layer;
  wrapper_tbl.hipMemsetD2D32Async_fn = hipMemsetD2D32AsyncLayer;
  wrapper_tbl.hipStreamGetAttribute_fn = hipStreamGetAttributeLayer;
  wrapper_tbl.hipStreamSetAttribute_fn = hipStreamSetAttributeLayer;
  wrapper_tbl.hipMemcpyBatchAsync_fn = hipMemcpyBatchAsyncLayer;
  wrapper_tbl.hipMemcpy3DBatchAsync_fn = hipMemcpy3DBatchAsyncLayer;
  wrapper_tbl.hipMemcpy3DPeer_fn = hipMemcpy3DPeerLayer;
  wrapper_tbl.hipMemcpy3DPeerAsync_fn = hipMemcpy3DPeerAsyncLayer;
  wrapper_tbl.hipLibraryLoadData_fn = hipLibraryLoadDataLayer;
  wrapper_tbl.hipLibraryLoadFromFile_fn = hipLibraryLoadFromFileLayer;
  wrapper_tbl.hipLibraryUnload_fn = hipLibraryUnloadLayer;
  wrapper_tbl.hipLibraryGetKernel_fn = hipLibraryGetKernelLayer;
  wrapper_tbl.hipLibraryGetKernelCount_fn = hipLibraryGetKernelCountLayer;
  wrapper_tbl.hipLibraryEnumerateKernels_fn = hipLibraryEnumerateKernelsLayer;
  wrapper_tbl.hipKernelGetLibrary_fn = hipKernelGetLibraryLayer;
  wrapper_tbl.hipKernelGetName_fn = hipKernelGetNameLayer;
  wrapper_tbl.hipOccupancyAvailableDynamicSMemPerBlock_fn = hipOccupancyAvailableDynamicSMemPerBlockLayer;
  wrapper_tbl.hipKernelGetParamInfo_fn = hipKernelGetParamInfoLayer;
  wrapper_tbl.hipExtDisableLogging_fn = hipExtDisableLoggingLayer;
  wrapper_tbl.hipExtEnableLogging_fn = hipExtEnableLoggingLayer;
  wrapper_tbl.hipExtSetLoggingParams_fn = hipExtSetLoggingParamsLayer;
  wrapper_tbl.hipMemSetMemPool_fn = hipMemSetMemPoolLayer;
  wrapper_tbl.hipMemGetMemPool_fn = hipMemGetMemPoolLayer;
  wrapper_tbl.hipKernelGetAttribute_fn = hipKernelGetAttributeLayer;
  wrapper_tbl.hipKernelSetAttribute_fn = hipKernelSetAttributeLayer;
  wrapper_tbl.hipKernelGetFunction_fn = hipKernelGetFunctionLayer;
  std::atomic_thread_fence(std::memory_order_release);
  std::memcpy(tbl, &wrapper_tbl, sizeof(HipDispatchTable));
}
