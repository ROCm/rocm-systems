...
typedef enum hrr_api_id {
    ...
    HRR_API_HIPPOPCALLCONFIGURATION = 543,
    HRR_API_HIPPUSHCALLCONFIGURATION = 544,
    HRR_API_HIPREGISTERFATBINARY = 545,
    HRR_API_HIPREGISTERFUNCTION = 546,
    HRR_API_HIPREGISTERMANAGEDVAR = 547,
    HRR_API_HIPREGISTERSURFACE = 548,
    HRR_API_HIPREGISTERTEXTURE = 549,
    HRR_API_HIPREGISTERVAR = 550,
    HRR_API_HIPUNREGISTERFATBINARY = 551,
    HRR_API_COUNT = 552
} hrr_api_id_t;
