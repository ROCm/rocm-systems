...
// The segmented executor is the concrete GraphExec used for sub-graph/conditional
// body execution on the ROCm path. Alias keeps legacy `GraphExec` references valid.
