...
static inline void rocm_trace_emit_hipStreamCreateWithFlags_args(hipStream_t* stream_out_ptr,
  ...
  if (lttng_ust_tracepoint_enabled(rocm_hip, hipStreamCreateWithFlags_args)) {
    const uint64_t stream_val = (status == hipSuccess && stream_out_ptr != NULL)
                                    ? (uint64_t)((uint64_t)(uintptr_t)(*stream_out_ptr))
                                    : 0ULL;
    lttng_ust_do_tracepoint(rocm_hip, hipStreamCreateWithFlags_args, stream_val,
                            (uint32_t)(flags));
  }
}
...
static inline void rocm_trace_emit_hipStreamDestroy_args(
  ...
  if (lttng_ust_tracepoint_enabled(rocm_hip, hipStreamDestroy_args)) {
    lttng_ust_do_tracepoint(rocm_hip, hipStreamDestroy_args,
(uint64_t)(uintptr_t)(stream));
  }
}

static inline void rocm_trace_emit_hipStreamGetFlags_args(uint64_t stream,
  ...
  if (lttng_ust_tracepoint_enabled(rocm_hip, hipStreamGetFlags_args)) {
    ...
    lttng_ust_do_tracepoint(rocm_hip, hipStreamGetFlags_args,
...
static inline void rocm_trace_emit_hipStreamGetPriority_args(uint64_t stream,
  ...
  if (lttng_ust_tracepoint_enabled(rocm_hip, hipStreamGetPriority_args)) {
    ...
    lttng_ust_do_tracepoint(rocm_hip, hipStreamGetPriority_args,
...
static inline void rocm_trace_emit_hipStreamSynchronize_args(
  ...
  if (lttng_ust_tracepoint_enabled(rocm_hip, hipStreamSynchronize_args)) {
    lttng_ust_do_tracepoint(rocm_hip, hipStreamSynchronize_args,
(uint64_t)(uintptr_t)(stream));
  }
}
...
static inline void rocm_trace_emit_hipStreamWaitEvent_args(
  ...
  if (lttng_ust_tracepoint_enabled(rocm_hip, hipStreamWaitEvent_args)) {
    lttng_ust_do_tracepoint(rocm_hip, hipStreamWaitEvent_args,
...
static inline void rocm_trace_emit_hipStreamAddCallback_args(
  ...
  if (lttng_ust_tracepoint_enabled(rocm_hip, hipStreamAddCallback_args)) {
    lttng_ust_do_tracepoint(rocm_hip, hipStreamAddCallback_args,
...
static inline void rocm_trace_emit_hipStreamAttachMemAsync_args(
  ...
  if (lttng_ust_tracepoint_enabled(rocm_hip, hipStreamAttachMemAsync_args)) {
    lttng_ust_do_tracepoint(rocm_hip, hipStreamAttachMemAsync_args,
...
static inline void rocm_trace_emit_hipEventCreateWithFlags_args(hipEvent_t* event_out_ptr,
  ...
  if (lttng_ust_tracepoint_enabled(rocm_hip, hipEventCreateWithFlags_args)) {
    const uint64_t event_val = (status == hipSuccess && event_out_ptr != NULL)
                                   ? (uint64_t)((uint64_t)(uintptr_t)(*event_out_ptr))
                                   : 0ULL;
    lttng_ust_do_tracepoint(rocm_hip, hipEventCreateWithFlags_args, event_val,
                            (uint32_t)(flags));
  }
}
...
static inline void rocm_trace_emit_hipEventSynchronize_args(
  ...
  if (lttng_ust_tracepoint_enabled(rocm_hip, hipEventSynchronize_args)) {
    lttng_ust_do_tracepoint(rocm_hip, hipEventSynchronize_args,
...
static inline void rocm_trace_emit_hipEventElapsedTime_args(float* ms_out_ptr,
...
static inline void rocm_trace_emit_hipLaunchKernel_args(
  ...
  if (lttng_ust_tracepoint_enabled(rocm_hip, hipLaunchKernel_args)) {
    ...
    lttng_ust_do_tracepoint(rocm_hip, hipLaunchKernel_args,
...
static inline void rocm_trace_emit_hipLaunchCooperativeKernel_args(
    const void* f, dim3 gridDim, dim3 blockDimX, const void* kernelParams,
  ...
  if (lttng_ust_tracepoint_enabled(rocm_hip, hipLaunchCooperativeKernel_args)) {
    ...
    lttng_ust_do_tracepoint(rocm_hip, hipLaunchCooperativeKernel_args,
...
static inline void rocm_trace_emit_hipModuleLaunchKernel_args(
    uint64_t f, uint32_t sharedMemBytes, uint64_t stream,
...
static inline void rocm_trace_emit_hipModuleLoadDataEx_args(
    hipModule_t* module_out_ptr, const void* image, uint32_t numOptions,
...
static inline void rocm_trace_emit_hipMemcpy_args(const void* dst,
...
static inline void rocm_trace_emit_hipMemcpyDtoD_args(
    uint64_t dst, uint64_t src, size_t sizeBytes,
    hipError_t /*status*/ /* unused: all-IN API */) {
  if (rocm_trace_disabled()) return;
...
static inline void rocm_trace_emit_hipMemcpyPeer_args(
    const void* dst, int32_t dstDeviceId, const void* src, int32_t srcDeviceId,
...
static inline void rocm_trace_emit_hipMemcpyAsync_args(
    const void* dst, const void* src, size_t sizeBytes, int32_t kind,
    uint64_t stream, hipError_t /*status*/ /* unused: all-IN API */) {
  if (rocm_trace_disabled()) return;
...
static inline void rocm_trace_emit_hipMemcpyDtoDAsync_args(
  ...
  if (lttng_ust_tracepoint_enabled(rocm_hip, hipMemcpyDtoDAsync_args)) {
    lttng_ust_do_tracepoint(rocm_hip, hipMemcpyDtoDAsync_args, (uint64_t)(dst),
                            (uint64_t)(src), (uint64_t)(sizeBytes), (uint64_t)(uintptr_t)(stream));
  }
}

static inline void rocm_trace_emit_hipMemcpyPeerAsync_args(
    const void* dst, int32_t dstDeviceId, const void* src, int32_t srcDevice,
...
static inline void rocm_trace_emit_hipMemcpy2DAsync_args(
    const void* dst, size_t dpitch, const void* src, size_t spitch, size_t width,
...
static inline void rocm_trace_emit_hipMallocAsync_args(void** dev_ptr_out_ptr,
...
static inline void rocm_trace_emit_hipMallocHost_args(void** ptr_out_ptr,
...
static inline void rocm_trace_emit_hipHostMalloc_args(void** ptr_out_ptr,
...
static inline void rocm_trace_emit_hipMallocManaged_args(void** dev_ptr_out_ptr,
                                                         size_t size, uint32_t flags,
                                                         hipError_t status) {
  if (rocm_trace_disabled()) return;
...
static inline void rocm_trace_emit_hipFreeAsync_args(
    const void* dev_ptr, uint64_t stream,
    hipError_t /*status*/ /* unused: all-IN API */) {
  if (rocm_trace_disabled()) return;
...
static inline void rocm_trace_emit_hipMemset_args(const void* dst, int32_t value,
                                                  size_t sizeBytes,
                                                  hipError_t /*status*/ /* unused: all-IN API */) {
  if (rocm_trace_disabled()) return;
  if (lttng_ust_tracepoint_enabled(rocm_hip, hipMemset_args)) {
    lttng_ust_do_tracepoint(rocm_hip, hipMemset_args, (uint64_t)(uintptr_t)(dst),
...
static inline void rocm_trace_emit_hipMemsetD8_args(
    uint64_t dest, uint32_t value, size_t count,
    hipError_t /*status*/ /* unused: all-IN API */) {
  if (rocm_trace_disabled()) return;
  if (lttng_ust_tracepoint_enabled(rocm_hip, hipMemsetD8_args)) {
    lttng_ust_do_tracepoint(rocm_hip, hipMemsetD8_args, (uint64_t)(dest),
...
static inline void rocm_trace_emit_hipMemsetD16_args(
  ...
  if (lttng_ust_tracepoint_enabled(rocm_hip, hipMemsetD16_args)) {
    lttng_ust_do_tracepoint(rocm_hip, hipMemsetD16_args, (uint64_t)(dest),
                            (uint32_t)(value), (uint64_t)(count));
  }
}

static inline void rocm_trace_emit_hipMemsetD32_args(
    uint64_t dest, int32_t value, size_t count,
    hipError_t /*status*/ /* unused: all-IN API */) {
  if (rocm_trace_disabled()) return;
  if (lttng_ust_tracepoint_enabled(rocm_hip, hipMemsetD32_args)) {
    lttng_ust_do_tracepoint(rocm_hip, hipMemsetD32_args, (uint64_t)(dest),
...
static inline void rocm_trace_emit_hipMemPrefetchAsync_args(
  ...
  if (lttng_ust_tracepoint_enabled(rocm_hip, hipMemPrefetchAsync_args)) {
    lttng_ust_do_tracepoint(rocm_hip, hipMemPrefetchAsync_args,
...
static inline void rocm_trace_emit_hipGraphCreate_args(hipGraph_t* pGraph_out_ptr,
                                                       uint32_t flags, hipError_t status) {
  if (rocm_trace_disabled()) return;
...
static inline void rocm_trace_emit_hipStreamEndCapture_args(uint64_t stream,
  ...
  if (lttng_ust_tracepoint_enabled(rocm_hip, hipStreamEndCapture_args)) {
    const uint64_t pGraph_val = (status == hipSuccess && pGraph_out_ptr != NULL)
                                    ? (uint64_t)((uint64_t)(uintptr_t)(*pGraph_out_ptr))
                                    : 0ULL;
    lttng_ust_do_tracepoint(rocm_hip, hipStreamEndCapture_args,
...
static inline void rocm_trace_emit_hipStreamIsCapturing_args(uint64_t stream,
  ...
  if (lttng_ust_tracepoint_enabled(rocm_hip, hipStreamIsCapturing_args)) {
    ...
    lttng_ust_do_tracepoint(rocm_hip, hipStreamIsCapturing_args,
...
static inline void rocm_trace_emit_hipGraphAddDependencies_args(
  ...
  if (lttng_ust_tracepoint_enabled(rocm_hip, hipGraphAddDependencies_args)) {
    lttng_ust_do_tracepoint(rocm_hip, hipGraphAddDependencies_args,
...
static inline void rocm_trace_emit_hipGraphLaunch_args(
    uint64_t graphExec, uint64_t stream,
    hipError_t /*status*/ /* unused: all-IN API */) {
  if (rocm_trace_disabled()) return;
  if (lttng_ust_tracepoint_enabled(rocm_hip, hipGraphLaunch_args)) {
    lttng_ust_do_tracepoint(rocm_hip, hipGraphLaunch_args,
...
static inline void rocm_trace_emit_hipGraphExecMemcpyNodeSetParams1D_args(
    uint64_t hGraphExec, uint64_t node, const void* dst, const void* src,
...
static inline void rocm_trace_emit_hipStreamCreateWithFlags_args(hipStream_t*, uint32_t,
                                                                 hipError_t) {}
static inline void rocm_trace_emit_hipStreamCreateWithPriority_args(hipStream_t*,
                                                                    uint32_t, int32_t, hipError_t) {
}
static inline void rocm_trace_emit_hipStreamDestroy_args(uint64_t, hipError_t) {}
static inline void rocm_trace_emit_hipStreamGetFlags_args(uint64_t, uint32_t*,
                                                          hipError_t) {}
static inline void rocm_trace_emit_hipStreamGetPriority_args(uint64_t, int32_t*,
                                                             hipError_t) {}
...
static inline void rocm_trace_emit_hipStreamAddCallback_args(uint64_t, const void*,
                                                             const void*, uint32_t, hipError_t) {}
static inline void rocm_trace_emit_hipDeviceSynchronize_args(hipError_t) {}
static inline void rocm_trace_emit_hipStreamAttachMemAsync_args(uint64_t, const void*,
                                                                size_t, uint32_t, hipError_t) {}
static inline void rocm_trace_emit_hipEventCreate_args(hipEvent_t*, hipError_t) {}
static inline void rocm_trace_emit_hipEventCreateWithFlags_args(hipEvent_t*, uint32_t,
                                                                hipError_t) {}
...
static inline void rocm_trace_emit_hipEventElapsedTime_args(float*, uint64_t, uint64_t,
                                                            hipError_t) {}
static inline void rocm_trace_emit_hipLaunchKernel_args(const void*, dim3, dim3,
                                                        const void*, size_t, uint64_t, hipError_t) {
}
static inline void rocm_trace_emit_hipLaunchCooperativeKernel_args(const void*, dim3,
                                                                   dim3, const void*, uint32_t,
                                                                   uint64_t, hipError_t) {}
static inline void rocm_trace_emit_hipLaunchCooperativeKernelMultiDevice_args(const void*,
                                                                              int32_t, uint32_t,
                                                                              hipError_t) {}
static inline void rocm_trace_emit_hipModuleLaunchKernel_args(uint64_t, uint32_t,
                                                              uint64_t, const void*, const void*,
                                                              hipError_t) {}
static inline void rocm_trace_emit_hipExtLaunchKernel_args(const void*, dim3, dim3,
                                                           const void*, size_t, uint64_t, uint64_t,
                                                           uint64_t, int32_t, hipError_t) {}
static inline void rocm_trace_emit_hipExtLaunchMultiKernelMultiDevice_args(const void*,
                                                                           int32_t, uint32_t,
                                                                           hipError_t) {}
static inline void rocm_trace_emit_hipModuleGetFunction_args(hipFunction_t*, uint64_t,
                                                             const char*, hipError_t) {}
static inline void rocm_trace_emit_hipModuleLoadData_args(hipModule_t*, const void*,
                                                          hipError_t) {}
static inline void rocm_trace_emit_hipModuleLoadDataEx_args(hipModule_t*, const void*,
                                                            uint32_t, const void*, const void*,
                                                            hipError_t) {}
static inline void rocm_trace_emit_hipModuleUnload_args(uint64_t, hipError_t) {}
static inline void rocm_trace_emit_hipMemcpy_args(const void*, const void*, size_t,
                                                  int32_t, hipError_t) {}
static inline void rocm_trace_emit_hipMemcpyDtoH_args(const void*, uint64_t, size_t,
                                                      hipError_t) {}
static inline void rocm_trace_emit_hipMemcpyHtoD_args(uint64_t, const void*, size_t,
                                                      hipError_t) {}
static inline void rocm_trace_emit_hipMemcpyDtoD_args(uint64_t, uint64_t, size_t,
                                                      hipError_t) {}
static inline void rocm_trace_emit_hipMemcpyPeer_args(const void*, int32_t, const void*,
                                                      int32_t, size_t, hipError_t) {}
static inline void rocm_trace_emit_hipMemcpyAsync_args(const void*, const void*, size_t,
                                                       int32_t, uint64_t, hipError_t) {}
static inline void rocm_trace_emit_hipMemcpyDtoHAsync_args(const void*, uint64_t, size_t,
                                                           uint64_t, hipError_t) {}
static inline void rocm_trace_emit_hipMemcpyHtoDAsync_args(uint64_t, const void*, size_t,
                                                           uint64_t, hipError_t) {}
static inline void rocm_trace_emit_hipMemcpyDtoDAsync_args(uint64_t, uint64_t, size_t,
                                                           uint64_t, hipError_t) {}
static inline void rocm_trace_emit_hipMemcpyPeerAsync_args(const void*, int32_t,
                                                           const void*, int32_t, size_t, uint64_t,
                                                           hipError_t) {}
static inline void rocm_trace_emit_hipMemcpy2DAsync_args(const void*, size_t, const void*,
                                                         size_t, size_t, size_t, int32_t, uint64_t,
                                                         hipError_t) {}
static inline void rocm_trace_emit_hipMemcpy3DAsync_args(const void*, uint64_t,
                                                         hipError_t) {}
static inline void rocm_trace_emit_hipMalloc_args(void**, size_t, hipError_t) {}
static inline void rocm_trace_emit_hipMallocAsync_args(void**, size_t, uint64_t,
                                                       hipError_t) {}
static inline void rocm_trace_emit_hipMallocHost_args(void**, size_t, hipError_t) {}
static inline void rocm_trace_emit_hipHostMalloc_args(void**, size_t, uint32_t,
                                                      hipError_t) {}
static inline void rocm_trace_emit_hipMallocManaged_args(void**, size_t, uint32_t,
                                                         hipError_t) {}
...
static inline void rocm_trace_emit_hipMemset_args(const void*, int32_t, size_t,
                                                  hipError_t) {}
static inline void rocm_trace_emit_hipMemsetAsync_args(const void*, int32_t, size_t,
                                                       uint64_t, hipError_t) {}
static inline void rocm_trace_emit_hipMemsetD8_args(uint64_t, uint32_t, size_t,
                                                    hipError_t) {}
static inline void rocm_trace_emit_hipMemsetD16_args(uint64_t, uint32_t, size_t,
                                                     hipError_t) {}
static inline void rocm_trace_emit_hipMemsetD32_args(uint64_t, int32_t, size_t,
                                                     hipError_t) {}
static inline void rocm_trace_emit_hipMemPrefetchAsync_args(const void*, size_t, int32_t,
                                                            uint64_t, hipError_t) {}
static inline void rocm_trace_emit_hipMemAdvise_args(const void*, size_t, int32_t,
                                                     int32_t, hipError_t) {}
static inline void rocm_trace_emit_hipGraphCreate_args(hipGraph_t*, uint32_t,
                                                       hipError_t) {}
static inline void rocm_trace_emit_hipGraphDestroy_args(uint64_t, hipError_t) {}
static inline void rocm_trace_emit_hipGraphInstantiate_args(hipGraphExec_t*, uint64_t,
                                                            const void*, const void*, size_t,
                                                            hipError_t) {}
static inline void rocm_trace_emit_hipGraphExecDestroy_args(uint64_t, hipError_t) {}
static inline void rocm_trace_emit_hipStreamBeginCapture_args(uint64_t, int32_t,
                                                              hipError_t) {}
static inline void rocm_trace_emit_hipStreamEndCapture_args(uint64_t, hipGraph_t*,
                                                            hipError_t) {}
static inline void rocm_trace_emit_hipStreamIsCapturing_args(uint64_t, int32_t*,
                                                             hipError_t) {}
...
static inline void rocm_trace_emit_hipGraphAddMemsetNode_args(hipGraphNode_t*, uint64_t,
                                                              const void*, size_t, const void*,
                                                              hipError_t) {}
static inline void rocm_trace_emit_hipGraphAddEventRecordNode_args(hipGraphNode_t*,
                                                                   uint64_t, const void*, size_t,
                                                                   uint64_t, hipError_t) {}
static inline void rocm_trace_emit_hipGraphAddEventWaitNode_args(hipGraphNode_t*,
                                                                 uint64_t, const void*, size_t,
                                                                 uint64_t, hipError_t) {}
static inline void rocm_trace_emit_hipGraphAddDependencies_args(uint64_t, const void*,
                                                                const void*, size_t, hipError_t) {}
static inline void rocm_trace_emit_hipGraphLaunch_args(uint64_t, uint64_t, hipError_t) {}
static inline void rocm_trace_emit_hipGraphExecKernelNodeSetParams_args(uint64_t,
                                                                        uint64_t, const void*,
                                                                        hipError_t) {}
static inline void rocm_trace_emit_hipGraphExecMemcpyNodeSetParams1D_args(uint64_t,
                                                                          uint64_t, const void*,
                                                                          const void*, size_t,
                                                                          int32_t, hipError_t) {}
