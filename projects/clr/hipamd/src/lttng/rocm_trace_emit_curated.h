...
static inline bool rocm_trace_disabled(void) {
    return rocm_hip_trace_g_disabled.load(std::memory_order_relaxed);
        ...
        static inline void rocm_trace_emit_hipStreamCreate_args(
            uint64_t corr_id,
    hipStream_t * stream_out_ptr,
    hipError_t status) {
            if (rocm_trace_disabled()) return;
            if (lttng_ust_tracepoint_enabled(rocm_hip, hipStreamCreate_args)) {
        const uint64_t stream_val =
    (status == hipSuccess && stream_out_ptr != NULL)
        ? (uint64_t)((uint64_t)(uintptr_t)(*stream_out_ptr)) : 0ULL;
    lttng_ust_do_tracepoint(rocm_hip, hipStreamCreate_args, corr_id,
stream_val);
            }
        }

        static inline void rocm_trace_emit_hipStreamCreateWithFlags_args(
            uint64_t corr_id,
    hipStream_t * stream_out_ptr,
    uint32_t flags,
    hipError_t status) {
    ...
    (status == hipSuccess && stream_out_ptr != NULL)
        ? (uint64_t)((uint64_t)(uintptr_t)(*stream_out_ptr)) : 0ULL;
    lttng_ust_do_tracepoint(rocm_hip, hipStreamCreateWithFlags_args, corr_id,
stream_val,
(uint32_t)(flags));
            }
        }

        static inline void rocm_trace_emit_hipStreamCreateWithPriority_args(
            uint64_t corr_id,
    hipStream_t * stream_out_ptr,
    uint32_t flags,
    int32_t priority,
    ...
    (status == hipSuccess && stream_out_ptr != NULL)
        ? (uint64_t)((uint64_t)(uintptr_t)(*stream_out_ptr)) : 0ULL;
    lttng_ust_do_tracepoint(rocm_hip, hipStreamCreateWithPriority_args, corr_id,
stream_val,
(uint32_t)(flags),
(int32_t)(priority));
            }
...
(uint64_t)(uintptr_t)(stream));
        ...
        static inline void rocm_trace_emit_hipStreamGetFlags_args(
            uint64_t corr_id,
    uint64_t stream,
    ...
    hipError_t status) {
        ...
        const auto flags_val =
    (status == hipSuccess && flags_out_ptr != NULL)
        ? *flags_out_ptr : 0;
...
(uint32_t)(flags_val));
        ...
        static inline void rocm_trace_emit_hipStreamGetPriority_args(
            uint64_t corr_id,
    uint64_t stream,
    ...
    (status == hipSuccess && priority_out_ptr != NULL)
        ? *priority_out_ptr : 0;
...
(uint32_t)(flags));
    ...
    hipError_t /*status*/ /* unused: all-IN API */) {
            ...
            lttng_ust_do_tracepoint(rocm_hip, hipStreamQuery_args, corr_id,
(uint64_t)(uintptr_t)(stream));
            }
        }
...
(uint64_t)(uintptr_t)(stream),
(uint64_t)(uintptr_t)(dev_ptr),
(uint64_t)(length),
(uint32_t)(flags));
            }
        }

        static inline void rocm_trace_emit_hipEventCreate_args(
            uint64_t corr_id,
    hipEvent_t * event_out_ptr,
    hipError_t status) {
            if (rocm_trace_disabled()) return;
            if (lttng_ust_tracepoint_enabled(rocm_hip, hipEventCreate_args)) {
        const uint64_t event_val =
    (status == hipSuccess && event_out_ptr != NULL)
        ? (uint64_t)((uint64_t)(uintptr_t)(*event_out_ptr)) : 0ULL;
    lttng_ust_do_tracepoint(rocm_hip, hipEventCreate_args, corr_id,
event_val);
            }
        }

        static inline void rocm_trace_emit_hipEventCreateWithFlags_args(
            uint64_t corr_id,
    hipEvent_t * event_out_ptr,
    uint32_t flags,
    hipError_t status) {
    ...
    (status == hipSuccess && event_out_ptr != NULL)
        ? (uint64_t)((uint64_t)(uintptr_t)(*event_out_ptr)) : 0ULL;
    lttng_ust_do_tracepoint(rocm_hip, hipEventCreateWithFlags_args, corr_id,
event_val,
(uint32_t)(flags));
            }
        }
    ...
    hipError_t /*status*/ /* unused: all-IN API */) {
            ...
            lttng_ust_do_tracepoint(rocm_hip, hipEventDestroy_args, corr_id,
(uint64_t)(uintptr_t)(event));
            }
        }
    ...
    hipError_t /*status*/ /* unused: all-IN API */) {
            ...
            lttng_ust_do_tracepoint(rocm_hip, hipEventRecord_args, corr_id,
(uint64_t)(uintptr_t)(event),
(uint64_t)(uintptr_t)(stream));
            }
        }
...
(uint64_t)(uintptr_t)(event));
    ...
    hipError_t /*status*/ /* unused: all-IN API */) {
            ...
            lttng_ust_do_tracepoint(rocm_hip, hipEventQuery_args, corr_id,
(uint64_t)(uintptr_t)(event));
            }
        }

        static inline void rocm_trace_emit_hipEventElapsedTime_args(
            uint64_t corr_id,
    float* ms_out_ptr,
    uint64_t start,
    uint64_t stop,
    hipError_t status) {
        ...
        const auto ms_val =
    (status == hipSuccess && ms_out_ptr != NULL)
        ? *ms_out_ptr : 0;
    lttng_ust_do_tracepoint(rocm_hip, hipEventElapsedTime_args, corr_id,
(float)(ms_val),
(uint64_t)(uintptr_t)(start),
(uint64_t)(uintptr_t)(stop));
            }
        }
...
gridDim_packed,
blockDimX_packed,
(uint64_t)(uintptr_t)(kernelParams),
(uint32_t)(sharedMemBytes),
(uint64_t)(uintptr_t)(stream));
            }
        }
...
(uint64_t)(uintptr_t)(launchParamsList),
(int32_t)(numDevices),
(uint32_t)(flags));
            }
        }
    ...
    hipError_t /*status*/ /* unused: all-IN API */) {
            ...
            lttng_ust_do_tracepoint(rocm_hip, hipModuleLaunchKernel_args, corr_id,
(uint64_t)(uintptr_t)(f),
(uint32_t)(sharedMemBytes),
(uint64_t)(uintptr_t)(stream),
(uint64_t)(uintptr_t)(kernelParams),
(uint64_t)(uintptr_t)(extra));
            }
        }
    ...
    hipError_t /*status*/ /* unused: all-IN API */) {
            ...
            if (lttng_ust_tracepoint_enabled(rocm_hip, hipExtLaunchKernel_args)) {
                const uint64_t numBlocks_packed = ROCM_DIM3_PACK(numBlocks);
        const uint64_t dimBlocks_packed = ROCM_DIM3_PACK(dimBlocks);
    lttng_ust_do_tracepoint(rocm_hip, hipExtLaunchKernel_args, corr_id,
(uint64_t)(uintptr_t)(function_address),
numBlocks_packed,
dimBlocks_packed,
(uint64_t)(uintptr_t)(args),
(uint64_t)(sharedMemBytes),
(uint64_t)(uintptr_t)(stream),
(uint64_t)(uintptr_t)(startEvent),
(uint64_t)(uintptr_t)(stopEvent),
(int32_t)(flags));
            }
        }
...
(uint32_t)(flags));
        ...
        static inline void rocm_trace_emit_hipModuleGetFunction_args(
            uint64_t corr_id,
    ...
    hipError_t status) {
        ...
        const uint64_t function_val =
    (status == hipSuccess && function_out_ptr != NULL)
        ? (uint64_t)((uint64_t)(uintptr_t)(*function_out_ptr)) : 0ULL;
    lttng_ust_do_tracepoint(rocm_hip, hipModuleGetFunction_args, corr_id,
function_val,
...
(kname ? kname : ""));
        ...
        static inline void rocm_trace_emit_hipModuleLoadData_args(
            uint64_t corr_id,
    ...
    hipError_t status) {
        ...
        const uint64_t module_val =
    (status == hipSuccess && module_out_ptr != NULL)
        ? (uint64_t)((uint64_t)(uintptr_t)(*module_out_ptr)) : 0ULL;
    lttng_ust_do_tracepoint(rocm_hip, hipModuleLoadData_args, corr_id,
module_val,
(uint64_t)(uintptr_t)(image));
    ...
    (status == hipSuccess && module_out_ptr != NULL)
        ? (uint64_t)((uint64_t)(uintptr_t)(*module_out_ptr)) : 0ULL;
    lttng_ust_do_tracepoint(rocm_hip, hipModuleLoadDataEx_args, corr_id,
module_val,
(uint64_t)(uintptr_t)(image),
(uint32_t)(numOptions),
(uint64_t)(uintptr_t)(options),
(uint64_t)(uintptr_t)(optionValues));
            }
        }
    ...
    hipError_t /*status*/ /* unused: all-IN API */) {
            ...
            lttng_ust_do_tracepoint(rocm_hip, hipModuleUnload_args, corr_id,
(uint64_t)(uintptr_t)(module));
            }
        }

        static inline void rocm_trace_emit_hipMemcpy_args(
            uint64_t corr_id,
    const void* dst,
    const void* src,
    size_t sizeBytes,
    ...
    hipError_t /*status*/ /* unused: all-IN API */) {
            ...
            lttng_ust_do_tracepoint(rocm_hip, hipMemcpy_args, corr_id,
...
(int32_t)(kind));
    ...
    hipError_t /*status*/ /* unused: all-IN API */) {
            ...
            lttng_ust_do_tracepoint(rocm_hip, hipMemcpyDtoH_args, corr_id,
(uint64_t)(uintptr_t)(dst),
(uint64_t)(src),
(uint64_t)(sizeBytes));
            }
    ...
    hipError_t /*status*/ /* unused: all-IN API */) {
            ...
            lttng_ust_do_tracepoint(rocm_hip, hipMemcpyHtoD_args, corr_id,
(uint64_t)(dst),
(uint64_t)(uintptr_t)(src),
(uint64_t)(sizeBytes));
            }
    ...
    hipError_t /*status*/ /* unused: all-IN API */) {
            ...
            lttng_ust_do_tracepoint(rocm_hip, hipMemcpyDtoD_args, corr_id,
(uint64_t)(dst),
(uint64_t)(src),
(uint64_t)(sizeBytes));
            }
    ...
    hipError_t /*status*/ /* unused: all-IN API */) {
            ...
            lttng_ust_do_tracepoint(rocm_hip, hipMemcpyPeer_args, corr_id,
(uint64_t)(uintptr_t)(dst),
(int32_t)(dstDeviceId),
(uint64_t)(uintptr_t)(src),
(int32_t)(srcDeviceId),
...
(uint64_t)(uintptr_t)(stream));
    ...
    hipError_t /*status*/ /* unused: all-IN API */) {
            ...
            lttng_ust_do_tracepoint(rocm_hip, hipMemcpyDtoHAsync_args, corr_id,
(uint64_t)(uintptr_t)(dst),
(uint64_t)(src),
(uint64_t)(sizeBytes),
(uint64_t)(uintptr_t)(stream));
    ...
    hipError_t /*status*/ /* unused: all-IN API */) {
            ...
            lttng_ust_do_tracepoint(rocm_hip, hipMemcpyHtoDAsync_args, corr_id,
(uint64_t)(dst),
(uint64_t)(uintptr_t)(src),
(uint64_t)(sizeBytes),
(uint64_t)(uintptr_t)(stream));
    ...
    hipError_t /*status*/ /* unused: all-IN API */) {
            ...
            lttng_ust_do_tracepoint(rocm_hip, hipMemcpyDtoDAsync_args, corr_id,
(uint64_t)(dst),
(uint64_t)(src),
(uint64_t)(sizeBytes),
(uint64_t)(uintptr_t)(stream));
    ...
    hipError_t /*status*/ /* unused: all-IN API */) {
            ...
            lttng_ust_do_tracepoint(rocm_hip, hipMemcpyPeerAsync_args, corr_id,
(uint64_t)(uintptr_t)(dst),
(int32_t)(dstDeviceId),
(uint64_t)(uintptr_t)(src),
(int32_t)(srcDevice),
...
(uint64_t)(uintptr_t)(stream));
    ...
    hipError_t /*status*/ /* unused: all-IN API */) {
            ...
            lttng_ust_do_tracepoint(rocm_hip, hipMemcpy2DAsync_args, corr_id,
(uint64_t)(uintptr_t)(dst),
(uint64_t)(dpitch),
(uint64_t)(uintptr_t)(src),
(uint64_t)(spitch),
...
(uint64_t)(uintptr_t)(stream));
    ...
    hipError_t /*status*/ /* unused: all-IN API */) {
            ...
            lttng_ust_do_tracepoint(rocm_hip, hipMemcpy3DAsync_args, corr_id,
...
(uint64_t)(size));
        ...
        static inline void rocm_trace_emit_hipMallocAsync_args(
            uint64_t corr_id,
    void ** dev_ptr_out_ptr,
    size_t size,
    uint64_t stream,
    hipError_t status) {
            if (rocm_trace_disabled()) return;
            if (lttng_ust_tracepoint_enabled(rocm_hip, hipMallocAsync_args)) {
        const uint64_t dev_ptr_val =
    (status == hipSuccess && dev_ptr_out_ptr != NULL)
        ? (uint64_t)((uint64_t)(uintptr_t)(*dev_ptr_out_ptr)) : 0ULL;
    lttng_ust_do_tracepoint(rocm_hip, hipMallocAsync_args, corr_id,
dev_ptr_val,
(uint64_t)(size),
(uint64_t)(uintptr_t)(stream));
            }
        ...
        static inline void rocm_trace_emit_hipMallocHost_args(
            uint64_t corr_id,
    void ** ptr_out_ptr,
    size_t size,
    hipError_t status) {
    ...
    (status == hipSuccess && ptr_out_ptr != NULL)
        ? (uint64_t)((uint64_t)(uintptr_t)(*ptr_out_ptr)) : 0ULL;
    lttng_ust_do_tracepoint(rocm_hip, hipMallocHost_args, corr_id,
ptr_val,
(uint64_t)(size));
            }
        }

        static inline void rocm_trace_emit_hipHostMalloc_args(
            uint64_t corr_id,
    void ** ptr_out_ptr,
    size_t size,
    uint32_t flags,
    ...
    (status == hipSuccess && ptr_out_ptr != NULL)
        ? (uint64_t)((uint64_t)(uintptr_t)(*ptr_out_ptr)) : 0ULL;
    lttng_ust_do_tracepoint(rocm_hip, hipHostMalloc_args, corr_id,
ptr_val,
(uint64_t)(size),
(uint32_t)(flags));
            }
        ...
        static inline void rocm_trace_emit_hipMallocManaged_args(
            uint64_t corr_id,
    void ** dev_ptr_out_ptr,
    size_t size,
    uint32_t flags,
    ...
    (status == hipSuccess && dev_ptr_out_ptr != NULL)
        ? (uint64_t)((uint64_t)(uintptr_t)(*dev_ptr_out_ptr)) : 0ULL;
    lttng_ust_do_tracepoint(rocm_hip, hipMallocManaged_args, corr_id,
dev_ptr_val,
(uint64_t)(size),
(uint32_t)(flags));
            }
        ...
        static inline void rocm_trace_emit_hipFree_args(
            uint64_t corr_id,
    const void* ptr,
    hipError_t /*status*/ /* unused: all-IN API */) {
            if (rocm_trace_disabled()) return;
            if (lttng_ust_tracepoint_enabled(rocm_hip, hipFree_args)) {
            lttng_ust_do_tracepoint(rocm_hip, hipFree_args, corr_id,
(uint64_t)(uintptr_t)(ptr));
    ...
    hipError_t /*status*/ /* unused: all-IN API */) {
            ...
            lttng_ust_do_tracepoint(rocm_hip, hipFreeAsync_args, corr_id,
(uint64_t)(uintptr_t)(dev_ptr),
(uint64_t)(uintptr_t)(stream));
            }
        }
    ...
    hipError_t /*status*/ /* unused: all-IN API */) {
            ...
            lttng_ust_do_tracepoint(rocm_hip, hipFreeHost_args, corr_id,
(uint64_t)(uintptr_t)(ptr));
            }
        }
    ...
    hipError_t /*status*/ /* unused: all-IN API */) {
            ...
            lttng_ust_do_tracepoint(rocm_hip, hipHostFree_args, corr_id,
(uint64_t)(uintptr_t)(ptr));
            }
        }

        static inline void rocm_trace_emit_hipMemset_args(
            uint64_t corr_id,
    const void* dst,
    int32_t value,
    size_t sizeBytes,
    hipError_t /*status*/ /* unused: all-IN API */) {
            ...
            lttng_ust_do_tracepoint(rocm_hip, hipMemset_args, corr_id,
(uint64_t)(uintptr_t)(dst),
(int32_t)(value),
(uint64_t)(sizeBytes));
            }
    ...
    hipError_t /*status*/ /* unused: all-IN API */) {
            ...
            lttng_ust_do_tracepoint(rocm_hip, hipMemsetAsync_args, corr_id,
(uint64_t)(uintptr_t)(dst),
(int32_t)(value),
(uint64_t)(sizeBytes),
(uint64_t)(uintptr_t)(stream));
    ...
    hipError_t /*status*/ /* unused: all-IN API */) {
            ...
            lttng_ust_do_tracepoint(rocm_hip, hipMemsetD8_args, corr_id,
(uint64_t)(dest),
(uint32_t)(value),
(uint64_t)(count));
            }
    ...
    hipError_t /*status*/ /* unused: all-IN API */) {
            ...
            lttng_ust_do_tracepoint(rocm_hip, hipMemsetD16_args, corr_id,
(uint64_t)(dest),
(uint32_t)(value),
(uint64_t)(count));
            }
    ...
    hipError_t /*status*/ /* unused: all-IN API */) {
            ...
            lttng_ust_do_tracepoint(rocm_hip, hipMemsetD32_args, corr_id,
(uint64_t)(dest),
(int32_t)(value),
(uint64_t)(count));
            }
...
(uint64_t)(uintptr_t)(stream));
    ...
    hipError_t /*status*/ /* unused: all-IN API */) {
            ...
            lttng_ust_do_tracepoint(rocm_hip, hipMemAdvise_args, corr_id,
(uint64_t)(uintptr_t)(dev_ptr),
(uint64_t)(count),
(int32_t)(advice),
(int32_t)(device));
        ...
        static inline void rocm_trace_emit_hipGraphCreate_args(
            uint64_t corr_id,
    ...
    hipError_t status) {
        ...
        const uint64_t pGraph_val =
    (status == hipSuccess && pGraph_out_ptr != NULL)
        ? (uint64_t)((uint64_t)(uintptr_t)(*pGraph_out_ptr)) : 0ULL;
    lttng_ust_do_tracepoint(rocm_hip, hipGraphCreate_args, corr_id,
pGraph_val,
(uint32_t)(flags));
            }
        }
    ...
    hipError_t /*status*/ /* unused: all-IN API */) {
            ...
            lttng_ust_do_tracepoint(rocm_hip, hipGraphDestroy_args, corr_id,
(uint64_t)(uintptr_t)(graph));
            }
        }

        static inline void rocm_trace_emit_hipGraphInstantiate_args(
            uint64_t corr_id,
    hipGraphExec_t * pGraphExec_out_ptr,
    uint64_t graph,
    const void* pErrorNode,
    const void* pLogBuffer,
    size_t bufferSize,
    hipError_t status) {
            if (rocm_trace_disabled()) return;
            if (lttng_ust_tracepoint_enabled(rocm_hip, hipGraphInstantiate_args)) {
        const uint64_t pGraphExec_val =
    (status == hipSuccess && pGraphExec_out_ptr != NULL)
        ? (uint64_t)((uint64_t)(uintptr_t)(*pGraphExec_out_ptr)) : 0ULL;
    lttng_ust_do_tracepoint(rocm_hip, hipGraphInstantiate_args, corr_id,
pGraphExec_val,
(uint64_t)(uintptr_t)(graph),
(uint64_t)(uintptr_t)(pErrorNode),
(uint64_t)(uintptr_t)(pLogBuffer),
(uint64_t)(bufferSize));
            }
        }
...
(int32_t)(mode));
        ...
        static inline void rocm_trace_emit_hipStreamEndCapture_args(
            uint64_t corr_id,
    uint64_t stream,
    hipGraph_t * pGraph_out_ptr,
    hipError_t status) {
...
pGraph_val);
        ...
        static inline void rocm_trace_emit_hipStreamIsCapturing_args(
            uint64_t corr_id,
    uint64_t stream,
    ...
    (status == hipSuccess && pCaptureStatus_out_ptr != NULL)
        ? *pCaptureStatus_out_ptr : 0;
...
(int32_t)(pCaptureStatus_val));
        ...
        static inline void rocm_trace_emit_hipGraphAddKernelNode_args(
            uint64_t corr_id,
    hipGraphNode_t * pGraphNode_out_ptr,
    uint64_t graph,
    ...
    hipError_t status) {
        ...
        const uint64_t pGraphNode_val =
    (status == hipSuccess && pGraphNode_out_ptr != NULL)
        ? (uint64_t)((uint64_t)(uintptr_t)(*pGraphNode_out_ptr)) : 0ULL;
    lttng_ust_do_tracepoint(rocm_hip, hipGraphAddKernelNode_args, corr_id,
pGraphNode_val,
(uint64_t)(uintptr_t)(graph),
(uint64_t)(uintptr_t)(pDependencies),
...
(uint64_t)(uintptr_t)(pNodeParams));
    ...
    (status == hipSuccess && pGraphNode_out_ptr != NULL)
        ? (uint64_t)((uint64_t)(uintptr_t)(*pGraphNode_out_ptr)) : 0ULL;
    lttng_ust_do_tracepoint(rocm_hip, hipGraphAddMemcpyNode_args, corr_id,
pGraphNode_val,
(uint64_t)(uintptr_t)(graph),
(uint64_t)(uintptr_t)(pDependencies),
(uint64_t)(numDependencies),
(uint64_t)(uintptr_t)(pCopyParams));
            }
        }
    ...
    (status == hipSuccess && pGraphNode_out_ptr != NULL)
        ? (uint64_t)((uint64_t)(uintptr_t)(*pGraphNode_out_ptr)) : 0ULL;
    lttng_ust_do_tracepoint(rocm_hip, hipGraphAddMemsetNode_args, corr_id,
pGraphNode_val,
(uint64_t)(uintptr_t)(graph),
(uint64_t)(uintptr_t)(pDependencies),
(uint64_t)(numDependencies),
(uint64_t)(uintptr_t)(pMemsetParams));
            }
        }
    ...
    (status == hipSuccess && pGraphNode_out_ptr != NULL)
        ? (uint64_t)((uint64_t)(uintptr_t)(*pGraphNode_out_ptr)) : 0ULL;
    lttng_ust_do_tracepoint(rocm_hip, hipGraphAddEventRecordNode_args, corr_id,
pGraphNode_val,
(uint64_t)(uintptr_t)(graph),
(uint64_t)(uintptr_t)(pDependencies),
(uint64_t)(numDependencies),
(uint64_t)(uintptr_t)(event));
    ...
    (status == hipSuccess && pGraphNode_out_ptr != NULL)
        ? (uint64_t)((uint64_t)(uintptr_t)(*pGraphNode_out_ptr)) : 0ULL;
    lttng_ust_do_tracepoint(rocm_hip, hipGraphAddEventWaitNode_args, corr_id,
pGraphNode_val,
(uint64_t)(uintptr_t)(graph),
(uint64_t)(uintptr_t)(pDependencies),
(uint64_t)(numDependencies),
...
static inline void rocm_trace_emit_hipStreamCreateWithFlags_args(uint64_t, hipStream_t *, uint32_t, hipError_t) {}
static inline void rocm_trace_emit_hipStreamCreateWithPriority_args(uint64_t, hipStream_t *, uint32_t, int32_t, hipError_t) {}
static inline void rocm_trace_emit_hipStreamDestroy_args(uint64_t, uint64_t, hipError_t) {}
static inline void rocm_trace_emit_hipStreamGetFlags_args(uint64_t, uint64_t, uint32_t*, hipError_t) {}
static inline void rocm_trace_emit_hipStreamGetPriority_args(uint64_t, uint64_t, int32_t*, hipError_t) {}
static inline void rocm_trace_emit_hipStreamSynchronize_args(uint64_t, uint64_t, hipError_t) {}
static inline void rocm_trace_emit_hipStreamWaitEvent_args(uint64_t, uint64_t, uint64_t, uint32_t, hipError_t) {}
static inline void rocm_trace_emit_hipStreamQuery_args(uint64_t, uint64_t, hipError_t) {}
static inline void rocm_trace_emit_hipStreamAddCallback_args(uint64_t, uint64_t, const void*, const void*, uint32_t, hipError_t) {}
static inline void rocm_trace_emit_hipDeviceSynchronize_args(uint64_t, hipError_t) {}
static inline void rocm_trace_emit_hipStreamAttachMemAsync_args(uint64_t, uint64_t, const void*, size_t, uint32_t, hipError_t) {}
static inline void rocm_trace_emit_hipEventCreate_args(uint64_t, hipEvent_t *, hipError_t) {}
static inline void rocm_trace_emit_hipEventCreateWithFlags_args(uint64_t, hipEvent_t *, uint32_t, hipError_t) {}
...
static inline void rocm_trace_emit_hipEventElapsedTime_args(uint64_t, float*, uint64_t, uint64_t, hipError_t) {}
static inline void rocm_trace_emit_hipLaunchKernel_args(uint64_t, const void*, dim3, dim3, const void*, size_t, uint64_t, hipError_t) {}
static inline void rocm_trace_emit_hipLaunchCooperativeKernel_args(uint64_t, const void*, dim3, dim3, const void*, uint32_t, uint64_t, hipError_t) {}
static inline void rocm_trace_emit_hipLaunchCooperativeKernelMultiDevice_args(uint64_t, const void*, int32_t, uint32_t, hipError_t) {}
static inline void rocm_trace_emit_hipModuleLaunchKernel_args(uint64_t, uint64_t, uint32_t, uint64_t, const void*, const void*, hipError_t) {}
static inline void rocm_trace_emit_hipExtLaunchKernel_args(uint64_t, const void*, dim3, dim3, const void*, size_t, uint64_t, uint64_t, uint64_t, int32_t, hipError_t) {}
static inline void rocm_trace_emit_hipExtLaunchMultiKernelMultiDevice_args(uint64_t, const void*, int32_t, uint32_t, hipError_t) {}
static inline void rocm_trace_emit_hipModuleGetFunction_args(uint64_t, hipFunction_t *, uint64_t, const char*, hipError_t) {}
static inline void rocm_trace_emit_hipModuleLoadData_args(uint64_t, hipModule_t *, const void*, hipError_t) {}
static inline void rocm_trace_emit_hipModuleLoadDataEx_args(uint64_t, hipModule_t *, const void*, uint32_t, const void*, const void*, hipError_t) {}
static inline void rocm_trace_emit_hipModuleUnload_args(uint64_t, uint64_t, hipError_t) {}
static inline void rocm_trace_emit_hipMemcpy_args(uint64_t, const void*, const void*, size_t, int32_t, hipError_t) {}
static inline void rocm_trace_emit_hipMemcpyDtoH_args(uint64_t, const void*, uint64_t, size_t, hipError_t) {}
static inline void rocm_trace_emit_hipMemcpyHtoD_args(uint64_t, uint64_t, const void*, size_t, hipError_t) {}
static inline void rocm_trace_emit_hipMemcpyDtoD_args(uint64_t, uint64_t, uint64_t, size_t, hipError_t) {}
static inline void rocm_trace_emit_hipMemcpyPeer_args(uint64_t, const void*, int32_t, const void*, int32_t, size_t, hipError_t) {}
static inline void rocm_trace_emit_hipMemcpyAsync_args(uint64_t, const void*, const void*, size_t, int32_t, uint64_t, hipError_t) {}
static inline void rocm_trace_emit_hipMemcpyDtoHAsync_args(uint64_t, const void*, uint64_t, size_t, uint64_t, hipError_t) {}
static inline void rocm_trace_emit_hipMemcpyHtoDAsync_args(uint64_t, uint64_t, const void*, size_t, uint64_t, hipError_t) {}
static inline void rocm_trace_emit_hipMemcpyDtoDAsync_args(uint64_t, uint64_t, uint64_t, size_t, uint64_t, hipError_t) {}
static inline void rocm_trace_emit_hipMemcpyPeerAsync_args(uint64_t, const void*, int32_t, const void*, int32_t, size_t, uint64_t, hipError_t) {}
static inline void rocm_trace_emit_hipMemcpy2DAsync_args(uint64_t, const void*, size_t, const void*, size_t, size_t, size_t, int32_t, uint64_t, hipError_t) {}
static inline void rocm_trace_emit_hipMemcpy3DAsync_args(uint64_t, const void*, uint64_t, hipError_t) {}
static inline void rocm_trace_emit_hipMalloc_args(uint64_t, void **, size_t, hipError_t) {}
static inline void rocm_trace_emit_hipMallocAsync_args(uint64_t, void **, size_t, uint64_t, hipError_t) {}
static inline void rocm_trace_emit_hipMallocHost_args(uint64_t, void **, size_t, hipError_t) {}
static inline void rocm_trace_emit_hipHostMalloc_args(uint64_t, void **, size_t, uint32_t, hipError_t) {}
static inline void rocm_trace_emit_hipMallocManaged_args(uint64_t, void **, size_t, uint32_t, hipError_t) {}
...
static inline void rocm_trace_emit_hipMemset_args(uint64_t, const void*, int32_t, size_t, hipError_t) {}
static inline void rocm_trace_emit_hipMemsetAsync_args(uint64_t, const void*, int32_t, size_t, uint64_t, hipError_t) {}
static inline void rocm_trace_emit_hipMemsetD8_args(uint64_t, uint64_t, uint32_t, size_t, hipError_t) {}
static inline void rocm_trace_emit_hipMemsetD16_args(uint64_t, uint64_t, uint32_t, size_t, hipError_t) {}
static inline void rocm_trace_emit_hipMemsetD32_args(uint64_t, uint64_t, int32_t, size_t, hipError_t) {}
static inline void rocm_trace_emit_hipMemPrefetchAsync_args(uint64_t, const void*, size_t, int32_t, uint64_t, hipError_t) {}
static inline void rocm_trace_emit_hipMemAdvise_args(uint64_t, const void*, size_t, int32_t, int32_t, hipError_t) {}
static inline void rocm_trace_emit_hipGraphCreate_args(uint64_t, hipGraph_t *, uint32_t, hipError_t) {}
static inline void rocm_trace_emit_hipGraphDestroy_args(uint64_t, uint64_t, hipError_t) {}
static inline void rocm_trace_emit_hipGraphInstantiate_args(uint64_t, hipGraphExec_t *, uint64_t, const void*, const void*, size_t, hipError_t) {}
static inline void rocm_trace_emit_hipGraphExecDestroy_args(uint64_t, uint64_t, hipError_t) {}
static inline void rocm_trace_emit_hipStreamBeginCapture_args(uint64_t, uint64_t, int32_t, hipError_t) {}
static inline void rocm_trace_emit_hipStreamEndCapture_args(uint64_t, uint64_t, hipGraph_t *, hipError_t) {}
static inline void rocm_trace_emit_hipStreamIsCapturing_args(uint64_t, uint64_t, int32_t*, hipError_t) {}
static inline void rocm_trace_emit_hipGraphAddKernelNode_args(uint64_t, hipGraphNode_t *, uint64_t, const void*, size_t, const void*, hipError_t) {}
static inline void rocm_trace_emit_hipGraphAddMemcpyNode_args(uint64_t, hipGraphNode_t *, uint64_t, const void*, size_t, const void*, hipError_t) {}
static inline void rocm_trace_emit_hipGraphAddMemsetNode_args(uint64_t, hipGraphNode_t *, uint64_t, const void*, size_t, const void*, hipError_t) {}
static inline void rocm_trace_emit_hipGraphAddEventRecordNode_args(uint64_t, hipGraphNode_t *, uint64_t, const void*, size_t, uint64_t, hipError_t) {}
static inline void rocm_trace_emit_hipGraphAddEventWaitNode_args(uint64_t, hipGraphNode_t *, uint64_t, const void*, size_t, uint64_t, hipError_t) {}
static inline void rocm_trace_emit_hipGraphAddDependencies_args(uint64_t, uint64_t, const void*, const void*, size_t, hipError_t) {}
static inline void rocm_trace_emit_hipGraphLaunch_args(uint64_t, uint64_t, uint64_t, hipError_t) {}
static inline void rocm_trace_emit_hipGraphExecKernelNodeSetParams_args(uint64_t, uint64_t, uint64_t, const void*, hipError_t) {}
static inline void rocm_trace_emit_hipGraphExecMemcpyNodeSetParams1D_args(uint64_t, uint64_t, uint64_t, const void*, const void*, size_t, int32_t, hipError_t) {}
