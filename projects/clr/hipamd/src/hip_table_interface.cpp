...
extern "C" hipError_t __hipPopCallConfiguration(dim3* gridDim, dim3* blockDim, size_t* sharedMem,
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(hip::GetHipCompilerDispatchTable()->__hipPopCallConfiguration_fn(
...
extern "C" hipError_t __hipPushCallConfiguration(dim3 gridDim, dim3 blockDim, size_t sharedMem,
  ...
  rocm_trace_emit_hip_api_enter(__func__);
  TRY;
  ROCM_TRACE_RET_STATUS(hip::GetHipCompilerDispatchTable()->__hipPushCallConfiguration_fn(
      gridDim, blockDim, sharedMem, stream));
  CATCH;
}
...
extern "C" void __hipRegisterSurface(void** modules, void* var, char* hostVar, char* deviceVar,
  ...
  rocm_trace_emit_hip_api_enter(__func__);
  TRY;
  ROCM_TRACE_RET_VOID(hip::GetHipCompilerDispatchTable()->__hipRegisterSurface_fn(
      modules, var, hostVar, deviceVar, type, ext));
  CATCHRET(void);
}
extern "C" void __hipRegisterTexture(void** modules, void* var, char* hostVar, char* deviceVar,
  ...
  rocm_trace_emit_hip_api_enter(__func__);
  TRY;
  ROCM_TRACE_RET_VOID(hip::GetHipCompilerDispatchTable()->__hipRegisterTexture_fn(
...
extern "C" void __hipRegisterVar(void** modules, void* var, char* hostVar, char* deviceVar, int ext,
  ...
  rocm_trace_emit_hip_api_enter(__func__);
  TRY;
  ROCM_TRACE_RET_VOID(hip::GetHipCompilerDispatchTable()->__hipRegisterVar_fn(
...
hipError_t hipArray3DGetDescriptor(HIP_ARRAY3D_DESCRIPTOR* pArrayDescriptor, hipArray_t array) {
  ...
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipArray3DGetDescriptor_fn(pArrayDescriptor, array));
  CATCH;
}
...
hipError_t hipArrayGetDescriptor(HIP_ARRAY_DESCRIPTOR* pArrayDescriptor, hipArray_t array) {
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipArrayGetDescriptor_fn(pArrayDescriptor, array));
  CATCH;
}
...
extern "C" hipError_t hipBindTexture(size_t* offset, const textureReference* tex,
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipBindTexture_fn(offset, tex, devPtr, desc, size));
  CATCH;
}
hipError_t hipBindTexture2D(size_t* offset, const textureReference* tex, const void* devPtr,
  ...
  rocm_trace_emit_hip_api_enter(__func__);
  TRY;
  ROCM_TRACE_RET_STATUS(hip::GetHipDispatchTable()->hipBindTexture2D_fn(offset, tex, devPtr, desc,
                                                                        width, height, pitch));
  CATCH;
}
...
hipError_t hipBindTextureToMipmappedArray(const textureReference* tex,
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipBindTextureToMipmappedArray_fn(tex, mipmappedArray, desc));
  CATCH;
}
...
extern "C" hipError_t hipConfigureCall(dim3 gridDim, dim3 blockDim, size_t sharedMem,
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipConfigureCall_fn(gridDim, blockDim, sharedMem, stream));
  CATCH;
}
hipError_t hipCreateSurfaceObject(hipSurfaceObject_t* pSurfObject,
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipCreateSurfaceObject_fn(pSurfObject, pResDesc));
  CATCH;
}
hipError_t hipCreateTextureObject(hipTextureObject_t* pTexObject, const hipResourceDesc* pResDesc,
  ...
  rocm_trace_emit_hip_api_enter(__func__);
  TRY;
  ROCM_TRACE_RET_STATUS(hip::GetHipDispatchTable()->hipCreateTextureObject_fn(
...
hipError_t hipDeviceCanAccessPeer(int* canAccessPeer, int deviceId, int peerDeviceId) {
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipDeviceCanAccessPeer_fn(canAccessPeer, deviceId, peerDeviceId));
  CATCH;
}
hipError_t hipDeviceComputeCapability(int* major, int* minor, hipDevice_t device) {
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipDeviceComputeCapability_fn(major, minor, device));
  CATCH;
}
...
hipError_t hipDeviceEnablePeerAccess(int peerDeviceId, unsigned int flags) {
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipDeviceEnablePeerAccess_fn(peerDeviceId, flags));
  CATCH;
}
...
hipError_t hipDeviceGetDefaultMemPool(hipMemPool_t* mem_pool, int device) {
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipDeviceGetDefaultMemPool_fn(mem_pool, device));
  CATCH;
}
hipError_t hipDeviceGetGraphMemAttribute(int device, hipGraphMemAttributeType attr, void* value) {
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipDeviceGetGraphMemAttribute_fn(device, attr, value));
  CATCH;
}
...
hipError_t hipDeviceGetP2PAttribute(int* value, hipDeviceP2PAttr attr, int srcDevice,
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipDeviceGetP2PAttribute_fn(value, attr, srcDevice, dstDevice));
  CATCH;
}
...
hipError_t hipDeviceGetStreamPriorityRange(int* leastPriority, int* greatestPriority) {
  rocm_trace_emit_hip_api_enter(__func__);
  TRY;
  ROCM_TRACE_RET_STATUS(hip::GetHipDispatchTable()->hipDeviceGetStreamPriorityRange_fn(
...
hipError_t hipDevicePrimaryCtxGetState(hipDevice_t dev, unsigned int* flags, int* active) {
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipDevicePrimaryCtxGetState_fn(dev, flags, active));
  CATCH;
}
...
hipError_t hipDeviceSetGraphMemAttribute(int device, hipGraphMemAttributeType attr, void* value) {
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipDeviceSetGraphMemAttribute_fn(device, attr, value));
  CATCH;
}
...
hipError_t hipDrvGraphAddMemcpyNode(hipGraphNode_t* phGraphNode, hipGraph_t hGraph,
  ...
  rocm_trace_emit_hip_api_enter(__func__);
  TRY;
  ROCM_TRACE_RET_STATUS(hip::GetHipDispatchTable()->hipDrvGraphAddMemcpyNode_fn(
...
hipError_t hipDrvPointerGetAttributes(unsigned int numAttributes, hipPointer_attribute* attributes,
  ...
  rocm_trace_emit_hip_api_enter(__func__);
  TRY;
  ROCM_TRACE_RET_STATUS(hip::GetHipDispatchTable()->hipDrvPointerGetAttributes_fn(
...
hipError_t hipExtGetLinkTypeAndHopCount(int device1, int device2, uint32_t* linktype,
  ...
  rocm_trace_emit_hip_api_enter(__func__);
  TRY;
  ROCM_TRACE_RET_STATUS(hip::GetHipDispatchTable()->hipExtGetLinkTypeAndHopCount_fn(
...
hipError_t hipExtMallocWithFlags(void** ptr, size_t sizeBytes, unsigned int flags) {
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipExtMallocWithFlags_fn(ptr, sizeBytes, flags));
  CATCH;
}
hipError_t hipExtStreamCreateWithCUMask(hipStream_t* stream, uint32_t cuMaskSize,
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipExtStreamCreateWithCUMask_fn(stream, cuMaskSize, cuMask));
  CATCH;
}
hipError_t hipExtStreamGetCUMask(hipStream_t stream, uint32_t cuMaskSize, uint32_t* cuMask) {
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipExtStreamGetCUMask_fn(stream, cuMaskSize, cuMask));
  CATCH;
}
hipError_t hipExternalMemoryGetMappedBuffer(void** devPtr, hipExternalMemory_t extMem,
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipExternalMemoryGetMappedBuffer_fn(devPtr, extMem, bufferDesc));
  CATCH;
}
...
hipError_t hipGetDriverEntryPoint(const char* symbol, void** funcPtr, unsigned long long flags,
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipGetDriverEntryPoint_fn(symbol, funcPtr, flags, status));
  CATCH;
}
hipError_t hipGetDriverEntryPoint_spt(const char* symbol, void** funcPtr, unsigned long long flags,
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipGetDriverEntryPoint_spt_fn(symbol, funcPtr, flags, status));
  CATCH;
}
...
hipError_t hipGetMipmappedArrayLevel(hipArray_t* levelArray,
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipGetMipmappedArrayLevel_fn(levelArray, mipmappedArray, level));
  CATCH;
}
hipError_t hipExternalMemoryGetMappedMipmappedArray(
  ...
  rocm_trace_emit_hip_api_enter(__func__);
  TRY;
  ROCM_TRACE_RET_STATUS(hip::GetHipDispatchTable()->hipExternalMemoryGetMappedMipmappedArray_fn(
...
hipError_t hipGetTextureAlignmentOffset(size_t* offset, const textureReference* texref) {
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipGetTextureAlignmentOffset_fn(offset, texref));
  CATCH;
}
hipError_t hipGetTextureObjectResourceDesc(hipResourceDesc* pResDesc,
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipGetTextureObjectResourceDesc_fn(pResDesc, textureObject));
  CATCH;
}
hipError_t hipGetTextureObjectResourceViewDesc(struct hipResourceViewDesc* pResViewDesc,
  ...
  rocm_trace_emit_hip_api_enter(__func__);
  TRY;
  ROCM_TRACE_RET_STATUS(hip::GetHipDispatchTable()->hipGetTextureObjectResourceViewDesc_fn(
...
hipError_t hipGetTextureObjectTextureDesc(hipTextureDesc* pTexDesc,
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipGetTextureObjectTextureDesc_fn(pTexDesc, textureObject));
  CATCH;
}
...
hipError_t hipGraphAddChildGraphNode(hipGraphNode_t* pGraphNode, hipGraph_t graph,
  ...
  rocm_trace_emit_hip_api_enter(__func__);
  TRY;
  ROCM_TRACE_RET_STATUS(hip::GetHipDispatchTable()->hipGraphAddChildGraphNode_fn(
...
hipError_t hipGraphAddEmptyNode(hipGraphNode_t* pGraphNode, hipGraph_t graph,
  ...
  rocm_trace_emit_hip_api_enter(__func__);
  TRY;
  ROCM_TRACE_RET_STATUS(hip::GetHipDispatchTable()->hipGraphAddEmptyNode_fn(
...
hipError_t hipGraphAddHostNode(hipGraphNode_t* pGraphNode, hipGraph_t graph,
  ...
  rocm_trace_emit_hip_api_enter(__func__);
  TRY;
  ROCM_TRACE_RET_STATUS(hip::GetHipDispatchTable()->hipGraphAddHostNode_fn(
...
hipError_t hipGraphAddMemAllocNode(hipGraphNode_t* pGraphNode, hipGraph_t graph,
  ...
  rocm_trace_emit_hip_api_enter(__func__);
  TRY;
  ROCM_TRACE_RET_STATUS(hip::GetHipDispatchTable()->hipGraphAddMemAllocNode_fn(
      pGraphNode, graph, pDependencies, numDependencies, pNodeParams));
  CATCH;
}
hipError_t hipGraphAddMemFreeNode(hipGraphNode_t* pGraphNode, hipGraph_t graph,
  ...
  rocm_trace_emit_hip_api_enter(__func__);
  TRY;
  ROCM_TRACE_RET_STATUS(hip::GetHipDispatchTable()->hipGraphAddMemFreeNode_fn(
...
hipError_t hipGraphAddNode(hipGraphNode_t* pGraphNode, hipGraph_t graph,
  ...
  rocm_trace_emit_hip_api_enter(__func__);
  TRY;
  ROCM_TRACE_RET_STATUS(hip::GetHipDispatchTable()->hipGraphAddNode_fn(
...
hipError_t hipGraphChildGraphNodeGetGraph(hipGraphNode_t node, hipGraph_t* pGraph) {
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipGraphChildGraphNodeGetGraph_fn(node, pGraph));
  CATCH;
}
...
hipError_t hipGraphEventRecordNodeGetEvent(hipGraphNode_t node, hipEvent_t* event_out) {
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipGraphEventRecordNodeGetEvent_fn(node, event_out));
  CATCH;
}
hipError_t hipGraphEventRecordNodeSetEvent(hipGraphNode_t node, hipEvent_t event) {
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipGraphEventRecordNodeSetEvent_fn(node, event));
  CATCH;
}
hipError_t hipGraphEventWaitNodeGetEvent(hipGraphNode_t node, hipEvent_t* event_out) {
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipGraphEventWaitNodeGetEvent_fn(node, event_out));
  CATCH;
}
...
hipError_t hipGraphExecChildGraphNodeSetParams(hipGraphExec_t hGraphExec, hipGraphNode_t node,
  ...
  rocm_trace_emit_hip_api_enter(__func__);
  TRY;
  ROCM_TRACE_RET_STATUS(hip::GetHipDispatchTable()->hipGraphExecChildGraphNodeSetParams_fn(
...
hipError_t hipGraphExecNodeSetParams(hipGraphExec_t hGraphExec, hipGraphNode_t node,
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipGraphExecNodeSetParams_fn(hGraphExec, node, nodeParams));
  CATCH;
}
...
hipError_t hipGraphExecEventRecordNodeSetEvent(hipGraphExec_t hGraphExec, hipGraphNode_t hNode,
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipGraphExecEventRecordNodeSetEvent_fn(hGraphExec, hNode, event));
  CATCH;
}
hipError_t hipGraphExecEventWaitNodeSetEvent(hipGraphExec_t hGraphExec, hipGraphNode_t hNode,
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipGraphExecEventWaitNodeSetEvent_fn(hGraphExec, hNode, event));
  CATCH;
}
hipError_t hipGraphExecHostNodeSetParams(hipGraphExec_t hGraphExec, hipGraphNode_t node,
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipGraphExecHostNodeSetParams_fn(hGraphExec, node, pNodeParams));
  CATCH;
}
...
hipError_t hipGraphExecMemcpyNodeSetParams(hipGraphExec_t hGraphExec, hipGraphNode_t node,
  ...
  rocm_trace_emit_hip_api_enter(__func__);
  TRY;
  ROCM_TRACE_RET_STATUS(hip::GetHipDispatchTable()->hipGraphExecMemcpyNodeSetParams_fn(
...
hipError_t hipGraphExecMemsetNodeSetParams(hipGraphExec_t hGraphExec, hipGraphNode_t node,
  ...
  rocm_trace_emit_hip_api_enter(__func__);
  TRY;
  ROCM_TRACE_RET_STATUS(hip::GetHipDispatchTable()->hipGraphExecMemsetNodeSetParams_fn(
      hGraphExec, node, pNodeParams));
  CATCH;
}
hipError_t hipGraphExecUpdate(hipGraphExec_t hGraphExec, hipGraph_t hGraph,
  ...
  rocm_trace_emit_hip_api_enter(__func__);
  TRY;
  ROCM_TRACE_RET_STATUS(hip::GetHipDispatchTable()->hipGraphExecUpdate_fn(
...
hipError_t hipGraphGetRootNodes(hipGraph_t graph, hipGraphNode_t* pRootNodes,
  ...
  rocm_trace_emit_hip_api_enter(__func__);
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipGraphGetRootNodes_fn(graph, pRootNodes, pNumRootNodes));
}
hipError_t hipGraphHostNodeGetParams(hipGraphNode_t node, hipHostNodeParams* pNodeParams) {
  rocm_trace_emit_hip_api_enter(__func__);
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipGraphHostNodeGetParams_fn(node, pNodeParams));
  CATCH;
}
hipError_t hipGraphHostNodeSetParams(hipGraphNode_t node, const hipHostNodeParams* pNodeParams) {
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipGraphHostNodeSetParams_fn(node, pNodeParams));
  CATCH;
}
...
hipError_t hipGraphInstantiateWithFlags(hipGraphExec_t* pGraphExec, hipGraph_t graph,
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipGraphInstantiateWithFlags_fn(pGraphExec, graph, flags));
  CATCH;
}
hipError_t hipGraphInstantiateWithParams(hipGraphExec_t* pGraphExec, hipGraph_t graph,
  ...
  rocm_trace_emit_hip_api_enter(__func__);
  TRY;
  ROCM_TRACE_RET_STATUS(hip::GetHipDispatchTable()->hipGraphInstantiateWithParams_fn(
...
hipError_t hipGraphKernelNodeCopyAttributes(hipGraphNode_t hSrc, hipGraphNode_t hDst) {
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipGraphKernelNodeCopyAttributes_fn(hSrc, hDst));
  CATCH;
}
hipError_t hipGraphKernelNodeGetAttribute(hipGraphNode_t hNode, hipKernelNodeAttrID attr,
  ...
  rocm_trace_emit_hip_api_enter(__func__);
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipGraphKernelNodeGetAttribute_fn(hNode, attr, value));
}
hipError_t hipGraphKernelNodeGetParams(hipGraphNode_t node, hipKernelNodeParams* pNodeParams) {
  rocm_trace_emit_hip_api_enter(__func__);
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipGraphKernelNodeGetParams_fn(node, pNodeParams));
  CATCH;
}
hipError_t hipGraphKernelNodeSetAttribute(hipGraphNode_t hNode, hipKernelNodeAttrID attr,
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipGraphKernelNodeSetAttribute_fn(hNode, attr, value));
  CATCH;
}
hipError_t hipGraphKernelNodeSetParams(hipGraphNode_t node,
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipGraphKernelNodeSetParams_fn(node, pNodeParams));
  CATCH;
}
...
hipError_t hipGraphMemAllocNodeGetParams(hipGraphNode_t node, hipMemAllocNodeParams* pNodeParams) {
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipGraphMemAllocNodeGetParams_fn(node, pNodeParams));
  CATCH;
}
...
hipError_t hipGraphMemcpyNodeGetParams(hipGraphNode_t node, hipMemcpy3DParms* pNodeParams) {
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipGraphMemcpyNodeGetParams_fn(node, pNodeParams));
  CATCH;
}
hipError_t hipGraphMemcpyNodeSetParams(hipGraphNode_t node, const hipMemcpy3DParms* pNodeParams) {
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipGraphMemcpyNodeSetParams_fn(node, pNodeParams));
  CATCH;
}
hipError_t hipGraphMemcpyNodeSetParams1D(hipGraphNode_t node, void* dst, const void* src,
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipGraphMemcpyNodeSetParams1D_fn(node, dst, src, count, kind));
  CATCH;
}
hipError_t hipGraphMemcpyNodeSetParamsFromSymbol(hipGraphNode_t node, void* dst, const void* symbol,
  ...
  rocm_trace_emit_hip_api_enter(__func__);
  TRY;
  ROCM_TRACE_RET_STATUS(hip::GetHipDispatchTable()->hipGraphMemcpyNodeSetParamsFromSymbol_fn(
...
hipError_t hipGraphMemcpyNodeSetParamsToSymbol(hipGraphNode_t node, const void* symbol,
  ...
  rocm_trace_emit_hip_api_enter(__func__);
  TRY;
  ROCM_TRACE_RET_STATUS(hip::GetHipDispatchTable()->hipGraphMemcpyNodeSetParamsToSymbol_fn(
...
hipError_t hipGraphMemsetNodeGetParams(hipGraphNode_t node, hipMemsetParams* pNodeParams) {
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipGraphMemsetNodeGetParams_fn(node, pNodeParams));
  CATCH;
}
hipError_t hipGraphMemsetNodeSetParams(hipGraphNode_t node, const hipMemsetParams* pNodeParams) {
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipGraphMemsetNodeSetParams_fn(node, pNodeParams));
  CATCH;
}
hipError_t hipGraphNodeFindInClone(hipGraphNode_t* pNode, hipGraphNode_t originalNode,
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipGraphNodeFindInClone_fn(pNode, originalNode, clonedGraph));
  CATCH;
}
hipError_t hipGraphNodeGetDependencies(hipGraphNode_t node, hipGraphNode_t* pDependencies,
  ...
  rocm_trace_emit_hip_api_enter(__func__);
  TRY;
  ROCM_TRACE_RET_STATUS(hip::GetHipDispatchTable()->hipGraphNodeGetDependencies_fn(
...
hipError_t hipGraphNodeGetDependentNodes(hipGraphNode_t node, hipGraphNode_t* pDependentNodes,
  ...
  rocm_trace_emit_hip_api_enter(__func__);
  TRY;
  ROCM_TRACE_RET_STATUS(hip::GetHipDispatchTable()->hipGraphNodeGetDependentNodes_fn(
...
hipError_t hipGraphNodeGetEnabled(hipGraphExec_t hGraphExec, hipGraphNode_t hNode,
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipGraphNodeGetEnabled_fn(hGraphExec, hNode, isEnabled));
  CATCH;
}
...
hipError_t hipGraphNodeSetEnabled(hipGraphExec_t hGraphExec, hipGraphNode_t hNode,
  ...
  rocm_trace_emit_hip_api_enter(__func__);
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipGraphNodeSetEnabled_fn(hGraphExec, hNode, isEnabled));
}
hipError_t hipGraphReleaseUserObject(hipGraph_t graph, hipUserObject_t object, unsigned int count) {
  rocm_trace_emit_hip_api_enter(__func__);
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipGraphReleaseUserObject_fn(graph, object, count));
  CATCH;
}
hipError_t hipGraphRemoveDependencies(hipGraph_t graph, const hipGraphNode_t* from,
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipGraphRemoveDependencies_fn(graph, from, to, numDependencies));
  CATCH;
}
hipError_t hipGraphRetainUserObject(hipGraph_t graph, hipUserObject_t object, unsigned int count,
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipGraphRetainUserObject_fn(graph, object, count, flags));
  CATCH;
}
...
hipError_t hipGraphicsGLRegisterBuffer(hipGraphicsResource** resource, GLuint buffer,
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipGraphicsGLRegisterBuffer_fn(resource, buffer, flags));
  CATCH;
}
hipError_t hipGraphicsGLRegisterImage(hipGraphicsResource** resource, GLuint image, GLenum target,
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipGraphicsGLRegisterImage_fn(resource, image, target, flags));
  CATCH;
}
hipError_t hipGraphicsMapResources(int count, hipGraphicsResource_t* resources,
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipGraphicsMapResources_fn(count, resources, stream));
  CATCH;
}
hipError_t hipGraphicsResourceGetMappedPointer(void** devPtr, size_t* size,
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipGraphicsResourceGetMappedPointer_fn(devPtr, size, resource));
  CATCH;
}
hipError_t hipGraphicsSubResourceGetMappedArray(hipArray_t* array, hipGraphicsResource_t resource,
  ...
  rocm_trace_emit_hip_api_enter(__func__);
  TRY;
  ROCM_TRACE_RET_STATUS(hip::GetHipDispatchTable()->hipGraphicsSubResourceGetMappedArray_fn(
...
hipError_t hipGraphicsUnmapResources(int count, hipGraphicsResource_t* resources,
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipGraphicsUnmapResources_fn(count, resources, stream));
  CATCH;
}
...
hipError_t hipHostGetDevicePointer(void** devPtr, void* hstPtr, unsigned int flags) {
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipHostGetDevicePointer_fn(devPtr, hstPtr, flags));
  CATCH;
}
...
hipError_t hipImportExternalMemory(hipExternalMemory_t* extMem_out,
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipImportExternalMemory_fn(extMem_out, memHandleDesc));
  CATCH;
}
hipError_t hipImportExternalSemaphore(hipExternalSemaphore_t* extSem_out,
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipImportExternalSemaphore_fn(extSem_out, semHandleDesc));
  CATCH;
}
...
extern "C" hipError_t hipMalloc3DArray(hipArray_t* array, const struct hipChannelFormatDesc* desc,
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipMalloc3DArray_fn(array, desc, extent, flags));
  CATCH;
}
extern "C" hipError_t hipMallocArray(hipArray_t* array, const hipChannelFormatDesc* desc,
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipMallocArray_fn(array, desc, width, height, flags));
  CATCH;
}
...
extern "C" hipError_t hipMallocMipmappedArray(hipMipmappedArray_t* mipmappedArray,
  ...
  rocm_trace_emit_hip_api_enter(__func__);
  TRY;
  ROCM_TRACE_RET_STATUS(hip::GetHipDispatchTable()->hipMallocMipmappedArray_fn(
...
hipError_t hipMemAdvise_v2(const void* dev_ptr, size_t count, hipMemoryAdvise advice,
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipMemAdvise_v2_fn(dev_ptr, count, advice, location));
  CATCH;
}
...
hipError_t hipMemAllocPitch(hipDeviceptr_t* dptr, size_t* pitch, size_t widthInBytes, size_t height,
  ...
  rocm_trace_emit_hip_api_enter(__func__);
  TRY;
  ROCM_TRACE_RET_STATUS(hip::GetHipDispatchTable()->hipMemAllocPitch_fn(dptr, pitch, widthInBytes,
...
hipError_t hipMemExportToShareableHandle(void* shareableHandle,
  ...
  rocm_trace_emit_hip_api_enter(__func__);
  TRY;
  ROCM_TRACE_RET_STATUS(hip::GetHipDispatchTable()->hipMemExportToShareableHandle_fn(
...
hipError_t hipMemGetAllocationGranularity(size_t* granularity, const hipMemAllocationProp* prop,
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipMemGetAllocationGranularity_fn(granularity, prop, option));
  CATCH;
}
hipError_t hipMemGetAllocationPropertiesFromHandle(hipMemAllocationProp* prop,
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipMemGetAllocationPropertiesFromHandle_fn(prop, handle));
  CATCH;
}
...
hipError_t hipMemImportFromShareableHandle(hipMemGenericAllocationHandle_t* handle, void* osHandle,
  ...
  rocm_trace_emit_hip_api_enter(__func__);
  TRY;
  ROCM_TRACE_RET_STATUS(hip::GetHipDispatchTable()->hipMemImportFromShareableHandle_fn(
...
hipError_t hipMemMapArrayAsync(hipArrayMapInfo* mapInfoList, unsigned int count,
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipMemMapArrayAsync_fn(mapInfoList, count, stream));
  CATCH;
}
...
hipError_t hipMemPoolExportPointer(hipMemPoolPtrExportData* export_data, void* dev_ptr) {
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipMemPoolExportPointer_fn(export_data, dev_ptr));
  CATCH;
}
hipError_t hipMemPoolExportToShareableHandle(void* shared_handle, hipMemPool_t mem_pool,
  ...
  rocm_trace_emit_hip_api_enter(__func__);
  TRY;
  ROCM_TRACE_RET_STATUS(hip::GetHipDispatchTable()->hipMemPoolExportToShareableHandle_fn(
...
hipError_t hipMemPoolGetAccess(hipMemAccessFlags* flags, hipMemPool_t mem_pool,
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipMemPoolGetAccess_fn(flags, mem_pool, location));
  CATCH;
}
hipError_t hipMemPoolGetAttribute(hipMemPool_t mem_pool, hipMemPoolAttr attr, void* value) {
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipMemPoolGetAttribute_fn(mem_pool, attr, value));
  CATCH;
}
hipError_t hipMemPoolImportFromShareableHandle(hipMemPool_t* mem_pool, void* shared_handle,
  ...
  rocm_trace_emit_hip_api_enter(__func__);
  TRY;
  ROCM_TRACE_RET_STATUS(hip::GetHipDispatchTable()->hipMemPoolImportFromShareableHandle_fn(
...
hipError_t hipMemPoolImportPointer(void** dev_ptr, hipMemPool_t mem_pool,
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipMemPoolImportPointer_fn(dev_ptr, mem_pool, export_data));
  CATCH;
}
hipError_t hipMemPoolSetAccess(hipMemPool_t mem_pool, const hipMemAccessDesc* desc_list,
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipMemPoolSetAccess_fn(mem_pool, desc_list, count));
  CATCH;
}
hipError_t hipMemPoolSetAttribute(hipMemPool_t mem_pool, hipMemPoolAttr attr, void* value) {
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipMemPoolSetAttribute_fn(mem_pool, attr, value));
  CATCH;
}
hipError_t hipMemPoolTrimTo(hipMemPool_t mem_pool, size_t min_bytes_to_hold) {
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipMemPoolTrimTo_fn(mem_pool, min_bytes_to_hold));
  CATCH;
}
...
hipError_t hipMemPrefetchAsync_v2(const void* dev_ptr, size_t count, hipMemLocation location,
  ...
  rocm_trace_emit_hip_api_enter(__func__);
  TRY;
  ROCM_TRACE_RET_STATUS(hip::GetHipDispatchTable()->hipMemPrefetchAsync_v2_fn(
...
hipError_t hipMemDiscardBatchAsync(void** dev_ptrs, size_t* sizes, size_t count,
  ...
  rocm_trace_emit_hip_api_enter(__func__);
  TRY;
  ROCM_TRACE_RET_STATUS(hip::GetHipDispatchTable()->hipMemDiscardBatchAsync_fn(
...
hipError_t hipDrvMemDiscardBatchAsync(hipDeviceptr_t* dptrs, size_t* sizes, size_t count,
  ...
  rocm_trace_emit_hip_api_enter(__func__);
  TRY;
  ROCM_TRACE_RET_STATUS(hip::GetHipDispatchTable()->hipDrvMemDiscardBatchAsync_fn(
...
hipError_t hipMemDiscardAndPrefetchBatchAsync(void** dptrs, size_t* sizes, size_t count,
  ...
  rocm_trace_emit_hip_api_enter(__func__);
  TRY;
  ROCM_TRACE_RET_STATUS(hip::GetHipDispatchTable()->hipMemDiscardAndPrefetchBatchAsync_fn(
...
hipError_t hipDrvMemDiscardAndPrefetchBatchAsync(hipDeviceptr_t* dptrs, size_t* sizes, size_t count,
  ...
  rocm_trace_emit_hip_api_enter(__func__);
  TRY;
  ROCM_TRACE_RET_STATUS(hip::GetHipDispatchTable()->hipDrvMemDiscardAndPrefetchBatchAsync_fn(
      dptrs, sizes, count, prefetchLocs, prefetchLocIdxs, numPrefetchLocs, flags, stream));
  CATCH;
}
...
hipError_t hipMemRangeGetAttribute(void* data, size_t data_size, hipMemRangeAttribute attribute,
  ...
  rocm_trace_emit_hip_api_enter(__func__);
  TRY;
  ROCM_TRACE_RET_STATUS(hip::GetHipDispatchTable()->hipMemRangeGetAttribute_fn(
...
hipError_t hipMemRangeGetAttributes(void** data, size_t* data_sizes,
  ...
  rocm_trace_emit_hip_api_enter(__func__);
  TRY;
  ROCM_TRACE_RET_STATUS(hip::GetHipDispatchTable()->hipMemRangeGetAttributes_fn(
...
hipError_t hipMemcpy2D(void* dst, size_t dpitch, const void* src, size_t spitch, size_t width,
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipMemcpy2D_fn(dst, dpitch, src, spitch, width, height, kind));
  CATCH;
}
...
hipError_t hipMemcpy2DFromArray(void* dst, size_t dpitch, hipArray_const_t src, size_t wOffset,
  ...
  rocm_trace_emit_hip_api_enter(__func__);
  TRY;
  ROCM_TRACE_RET_STATUS(hip::GetHipDispatchTable()->hipMemcpy2DFromArray_fn(
...
hipError_t hipMemcpy2DToArray(hipArray_t dst, size_t wOffset, size_t hOffset, const void* src,
  ...
  rocm_trace_emit_hip_api_enter(__func__);
  TRY;
  ROCM_TRACE_RET_STATUS(hip::GetHipDispatchTable()->hipMemcpy2DToArray_fn(
...
hipError_t hipMemcpy2DToArrayAsync(hipArray_t dst, size_t wOffset, size_t hOffset, const void* src,
  ...
  rocm_trace_emit_hip_api_enter(__func__);
  TRY;
  ROCM_TRACE_RET_STATUS(hip::GetHipDispatchTable()->hipMemcpy2DToArrayAsync_fn(
...
hipError_t hipMemcpyAtoH(void* dst, hipArray_t srcArray, size_t srcOffset, size_t count) {
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipMemcpyAtoH_fn(dst, srcArray, srcOffset, count));
  CATCH;
}
...
hipError_t hipMemcpyFromArray(void* dst, hipArray_const_t srcArray, size_t wOffset, size_t hOffset,
  ...
  rocm_trace_emit_hip_api_enter(__func__);
  TRY;
  ROCM_TRACE_RET_STATUS(hip::GetHipDispatchTable()->hipMemcpyFromArray_fn(dst, srcArray, wOffset,
                                                                          hOffset, count, kind));
  CATCH;
}
hipError_t hipMemcpyFromSymbol(void* dst, const void* symbol, size_t sizeBytes, size_t offset,
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipMemcpyFromSymbol_fn(dst, symbol, sizeBytes, offset, kind));
  CATCH;
}
hipError_t hipMemcpyFromSymbolAsync(void* dst, const void* symbol, size_t sizeBytes, size_t offset,
  ...
  rocm_trace_emit_hip_api_enter(__func__);
  TRY;
  ROCM_TRACE_RET_STATUS(hip::GetHipDispatchTable()->hipMemcpyFromSymbolAsync_fn(
...
hipError_t hipMemcpyHtoA(hipArray_t dstArray, size_t dstOffset, const void* srcHost, size_t count) {
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipMemcpyHtoA_fn(dstArray, dstOffset, srcHost, count));
  CATCH;
}
...
hipError_t hipMemcpyToArray(hipArray_t dst, size_t wOffset, size_t hOffset, const void* src,
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipMemcpyToArray_fn(dst, wOffset, hOffset, src, count, kind));
  CATCH;
}
hipError_t hipMemcpyToSymbol(const void* symbol, const void* src, size_t sizeBytes, size_t offset,
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipMemcpyToSymbol_fn(symbol, src, sizeBytes, offset, kind));
  CATCH;
}
hipError_t hipMemcpyToSymbolAsync(const void* symbol, const void* src, size_t sizeBytes,
  ...
  rocm_trace_emit_hip_api_enter(__func__);
  TRY;
  ROCM_TRACE_RET_STATUS(hip::GetHipDispatchTable()->hipMemcpyToSymbolAsync_fn(
...
hipError_t hipMemcpyWithStream(void* dst, const void* src, size_t sizeBytes, hipMemcpyKind kind,
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipMemcpyWithStream_fn(dst, src, sizeBytes, kind, stream));
  CATCH;
}
...
hipError_t hipMemset2D(void* dst, size_t pitch, int value, size_t width, size_t height) {
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipMemset2D_fn(dst, pitch, value, width, height));
  CATCH;
}
hipError_t hipMemset2DAsync(void* dst, size_t pitch, int value, size_t width, size_t height,
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipMemset2DAsync_fn(dst, pitch, value, width, height, stream));
  CATCH;
}
...
hipError_t hipMemset3DAsync(hipPitchedPtr pitchedDevPtr, int value, hipExtent extent,
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipMemset3DAsync_fn(pitchedDevPtr, value, extent, stream));
  CATCH;
}
...
hipError_t hipMemsetD16Async(hipDeviceptr_t dest, unsigned short value, size_t count,
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipMemsetD16Async_fn(dest, value, count, stream));
  CATCH;
}
...
hipError_t hipMemsetD32Async(hipDeviceptr_t dst, int value, size_t count, hipStream_t stream) {
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipMemsetD32Async_fn(dst, value, count, stream));
  CATCH;
}
...
hipError_t hipMemsetD8Async(hipDeviceptr_t dest, unsigned char value, size_t count,
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipMemsetD8Async_fn(dest, value, count, stream));
  CATCH;
}
hipError_t hipMipmappedArrayCreate(hipMipmappedArray_t* pHandle,
  ...
  rocm_trace_emit_hip_api_enter(__func__);
  TRY;
  ROCM_TRACE_RET_STATUS(hip::GetHipDispatchTable()->hipMipmappedArrayCreate_fn(
...
hipError_t hipMipmappedArrayGetLevel(hipArray_t* pLevelArray, hipMipmappedArray_t hMipMappedArray,
  ...
  rocm_trace_emit_hip_api_enter(__func__);
  TRY;
  ROCM_TRACE_RET_STATUS(hip::GetHipDispatchTable()->hipMipmappedArrayGetLevel_fn(
...
hipError_t hipLinkAddData(hipLinkState_t state, hipJitInputType type, void* data, size_t size,
  ...
  rocm_trace_emit_hip_api_enter(__func__);
  TRY;
  ROCM_TRACE_RET_STATUS(hip::GetHipDispatchTable()->hipLinkAddData_fn(
...
hipError_t hipLinkAddFile(hipLinkState_t state, hipJitInputType type, const char* path,
  ...
  rocm_trace_emit_hip_api_enter(__func__);
  TRY;
  ROCM_TRACE_RET_STATUS(hip::GetHipDispatchTable()->hipLinkAddFile_fn(state, type, path, numOptions,
...
hipError_t hipLinkCreate(unsigned int numOptions, hipJitOption* options, void** optionValues,
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipLinkCreate_fn(numOptions, options, optionValues, stateOut));
  CATCH;
}
...
extern "C" hipError_t hipModuleOccupancyMaxActiveBlocksPerMultiprocessor(
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipModuleOccupancyMaxActiveBlocksPerMultiprocessor_fn(
...
extern "C" hipError_t hipModuleOccupancyMaxActiveBlocksPerMultiprocessorWithFlags(
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipModuleOccupancyMaxActiveBlocksPerMultiprocessorWithFlags_fn(
...
extern "C" hipError_t hipModuleOccupancyMaxPotentialBlockSizeWithFlags(
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipModuleOccupancyMaxPotentialBlockSizeWithFlags_fn(
...
extern "C" hipError_t hipOccupancyAvailableDynamicSMemPerBlock(size_t* dynamicSmemSize,
  ...
  rocm_trace_emit_hip_api_enter(__func__);
  TRY;
  ROCM_TRACE_RET_STATUS(hip::GetHipDispatchTable()->hipOccupancyAvailableDynamicSMemPerBlock_fn(
...
extern "C" hipError_t hipOccupancyMaxActiveBlocksPerMultiprocessorWithFlags(
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipOccupancyMaxActiveBlocksPerMultiprocessorWithFlags_fn(
          numBlocks, f, blockSize, dynSharedMemPerBlk, flags));
  CATCH;
}
...
extern "C" hipError_t hipOccupancyMaxActiveClusters(int* numClusters, const void* func,
  ...
  rocm_trace_emit_hip_api_enter(__func__);
  TRY;
  ROCM_TRACE_RET_STATUS(hip::GetHipDispatchTable()->hipOccupancyMaxActiveClusters_fn(
      numClusters, func, launchConfig));
  CATCH;
}
extern "C" hipError_t hipOccupancyMaxPotentialClusterSize(int* clusterSize, const void* func,
  ...
  rocm_trace_emit_hip_api_enter(__func__);
  TRY;
  ROCM_TRACE_RET_STATUS(hip::GetHipDispatchTable()->hipOccupancyMaxPotentialClusterSize_fn(
...
hipError_t hipPointerGetAttribute(void* data, hipPointer_attribute attribute, hipDeviceptr_t ptr) {
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipPointerGetAttribute_fn(data, attribute, ptr));
  CATCH;
}
...
hipError_t hipPointerSetAttribute(const void* value, hipPointer_attribute attribute,
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipPointerSetAttribute_fn(value, attribute, ptr));
  CATCH;
}
...
hipError_t hipSignalExternalSemaphoresAsync(const hipExternalSemaphore_t* extSemArray,
  ...
  rocm_trace_emit_hip_api_enter(__func__);
  TRY;
  ROCM_TRACE_RET_STATUS(hip::GetHipDispatchTable()->hipSignalExternalSemaphoresAsync_fn(
...
hipError_t hipStreamGetCaptureInfo(hipStream_t stream, hipStreamCaptureStatus* pCaptureStatus,
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipStreamGetCaptureInfo_fn(stream, pCaptureStatus, pId));
  CATCH;
}
...
hipError_t hipStreamUpdateCaptureDependencies(hipStream_t stream, hipGraphNode_t* dependencies,
  ...
  rocm_trace_emit_hip_api_enter(__func__);
  TRY;
  ROCM_TRACE_RET_STATUS(hip::GetHipDispatchTable()->hipStreamUpdateCaptureDependencies_fn(
...
hipError_t hipStreamWaitValue32(hipStream_t stream, void* ptr, uint32_t value, unsigned int flags,
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipStreamWaitValue32_fn(stream, ptr, value, flags, mask));
  CATCH;
}
hipError_t hipStreamWaitValue64(hipStream_t stream, void* ptr, uint64_t value, unsigned int flags,
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipStreamWaitValue64_fn(stream, ptr, value, flags, mask));
  CATCH;
}
hipError_t hipStreamWriteValue32(hipStream_t stream, void* ptr, uint32_t value,
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipStreamWriteValue32_fn(stream, ptr, value, flags));
  CATCH;
}
hipError_t hipStreamWriteValue64(hipStream_t stream, void* ptr, uint64_t value,
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipStreamWriteValue64_fn(stream, ptr, value, flags));
  CATCH;
}
hipError_t hipStreamBatchMemOp(hipStream_t stream, unsigned int count,
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipStreamBatchMemOp_fn(stream, count, paramArray, flags));
  CATCH;
}
hipError_t hipTexObjectCreate(hipTextureObject_t* pTexObject, const HIP_RESOURCE_DESC* pResDesc,
  ...
  rocm_trace_emit_hip_api_enter(__func__);
  TRY;
  ROCM_TRACE_RET_STATUS(hip::GetHipDispatchTable()->hipTexObjectCreate_fn(pTexObject, pResDesc,
...
hipError_t hipTexObjectGetResourceDesc(HIP_RESOURCE_DESC* pResDesc, hipTextureObject_t texObject) {
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipTexObjectGetResourceDesc_fn(pResDesc, texObject));
  CATCH;
}
hipError_t hipTexObjectGetResourceViewDesc(HIP_RESOURCE_VIEW_DESC* pResViewDesc,
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipTexObjectGetResourceViewDesc_fn(pResViewDesc, texObject));
  CATCH;
}
hipError_t hipTexObjectGetTextureDesc(HIP_TEXTURE_DESC* pTexDesc, hipTextureObject_t texObject) {
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipTexObjectGetTextureDesc_fn(pTexDesc, texObject));
  CATCH;
}
...
hipError_t hipTexRefGetFormat(hipArray_Format* pFormat, int* pNumChannels,
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipTexRefGetFormat_fn(pFormat, pNumChannels, texRef));
  CATCH;
}
hipError_t hipTexRefGetMaxAnisotropy(int* pmaxAnsio, const textureReference* texRef) {
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipTexRefGetMaxAnisotropy_fn(pmaxAnsio, texRef));
  CATCH;
}
...
hipError_t hipTexRefGetMipmapLevelClamp(float* pminMipmapLevelClamp, float* pmaxMipmapLevelClamp,
  ...
  rocm_trace_emit_hip_api_enter(__func__);
  TRY;
  ROCM_TRACE_RET_STATUS(hip::GetHipDispatchTable()->hipTexRefGetMipmapLevelClamp_fn(
...
hipError_t hipTexRefSetAddress(size_t* ByteOffset, textureReference* texRef, hipDeviceptr_t dptr,
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipTexRefSetAddress_fn(ByteOffset, texRef, dptr, bytes));
  CATCH;
}
hipError_t hipTexRefSetAddress2D(textureReference* texRef, const HIP_ARRAY_DESCRIPTOR* desc,
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipTexRefSetAddress2D_fn(texRef, desc, dptr, Pitch));
  CATCH;
}
...
hipError_t hipTexRefSetBorderColor(textureReference* texRef, float* pBorderColor) {
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipTexRefSetBorderColor_fn(texRef, pBorderColor));
  CATCH;
}
...
hipError_t hipTexRefSetFormat(textureReference* texRef, hipArray_Format fmt,
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipTexRefSetFormat_fn(texRef, fmt, NumPackedComponents));
  CATCH;
}
...
hipError_t hipTexRefSetMipmapLevelClamp(textureReference* texRef, float minMipMapLevelClamp,
  ...
  rocm_trace_emit_hip_api_enter(__func__);
  TRY;
  ROCM_TRACE_RET_STATUS(hip::GetHipDispatchTable()->hipTexRefSetMipmapLevelClamp_fn(
...
hipError_t hipTexRefSetMipmappedArray(textureReference* texRef,
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipTexRefSetMipmappedArray_fn(texRef, mipmappedArray, Flags));
  CATCH;
}
...
hipError_t hipWaitExternalSemaphoresAsync(const hipExternalSemaphore_t* extSemArray,
  ...
  rocm_trace_emit_hip_api_enter(__func__);
  TRY;
  ROCM_TRACE_RET_STATUS(hip::GetHipDispatchTable()->hipWaitExternalSemaphoresAsync_fn(
      extSemArray, paramsArray, numExtSems, stream));
  CATCH;
}
...
hipError_t hipMemcpyToSymbol_spt(const void* symbol, const void* src, size_t sizeBytes,
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipMemcpyToSymbol_spt_fn(symbol, src, sizeBytes, offset, kind));
  CATCH;
}
hipError_t hipMemcpyFromSymbol_spt(void* dst, const void* symbol, size_t sizeBytes, size_t offset,
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipMemcpyFromSymbol_spt_fn(dst, symbol, sizeBytes, offset, kind));
  CATCH;
}
hipError_t hipMemcpy2D_spt(void* dst, size_t dpitch, const void* src, size_t spitch, size_t width,
  ...
  rocm_trace_emit_hip_api_enter(__func__);
  TRY;
  ROCM_TRACE_RET_STATUS(hip::GetHipDispatchTable()->hipMemcpy2D_spt_fn(dst, dpitch, src, spitch,
                                                                       width, height, kind));
  CATCH;
}
hipError_t hipMemcpy2DFromArray_spt(void* dst, size_t dpitch, hipArray_const_t src, size_t wOffset,
  ...
  rocm_trace_emit_hip_api_enter(__func__);
  TRY;
  ROCM_TRACE_RET_STATUS(hip::GetHipDispatchTable()->hipMemcpy2DFromArray_spt_fn(
      dst, dpitch, src, wOffset, hOffset, width, height, kind));
  CATCH;
}
...
hipError_t hipMemsetAsync_spt(void* dst, int value, size_t sizeBytes, hipStream_t stream) {
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipMemsetAsync_spt_fn(dst, value, sizeBytes, stream));
  CATCH;
}
hipError_t hipMemset2D_spt(void* dst, size_t pitch, int value, size_t width, size_t height) {
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipMemset2D_spt_fn(dst, pitch, value, width, height));
  CATCH;
}
hipError_t hipMemset2DAsync_spt(void* dst, size_t pitch, int value, size_t width, size_t height,
  ...
  rocm_trace_emit_hip_api_enter(__func__);
  TRY;
  ROCM_TRACE_RET_STATUS(hip::GetHipDispatchTable()->hipMemset2DAsync_spt_fn(dst, pitch, value,
                                                                            width, height, stream));
  CATCH;
}
hipError_t hipMemset3DAsync_spt(hipPitchedPtr pitchedDevPtr, int value, hipExtent extent,
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipMemset3DAsync_spt_fn(pitchedDevPtr, value, extent, stream));
  CATCH;
}
hipError_t hipMemset3D_spt(hipPitchedPtr pitchedDevPtr, int value, hipExtent extent) {
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipMemset3D_spt_fn(pitchedDevPtr, value, extent));
  CATCH;
}
hipError_t hipMemcpyAsync_spt(void* dst, const void* src, size_t sizeBytes, hipMemcpyKind kind,
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipMemcpyAsync_spt_fn(dst, src, sizeBytes, kind, stream));
  CATCH;
}
...
hipError_t hipMemcpy2DAsync_spt(void* dst, size_t dpitch, const void* src, size_t spitch,
  ...
  rocm_trace_emit_hip_api_enter(__func__);
  TRY;
  ROCM_TRACE_RET_STATUS(hip::GetHipDispatchTable()->hipMemcpy2DAsync_spt_fn(
      dst, dpitch, src, spitch, width, height, kind, stream));
  CATCH;
}
hipError_t hipMemcpyFromSymbolAsync_spt(void* dst, const void* symbol, size_t sizeBytes,
  ...
  rocm_trace_emit_hip_api_enter(__func__);
  TRY;
  ROCM_TRACE_RET_STATUS(hip::GetHipDispatchTable()->hipMemcpyFromSymbolAsync_spt_fn(
      dst, symbol, sizeBytes, offset, kind, stream));
  CATCH;
}
hipError_t hipMemcpyToSymbolAsync_spt(const void* symbol, const void* src, size_t sizeBytes,
  ...
  rocm_trace_emit_hip_api_enter(__func__);
  TRY;
  ROCM_TRACE_RET_STATUS(hip::GetHipDispatchTable()->hipMemcpyToSymbolAsync_spt_fn(
      symbol, src, sizeBytes, offset, kind, stream));
  CATCH;
}
hipError_t hipMemcpyFromArray_spt(void* dst, hipArray_const_t src, size_t wOffsetSrc,
  ...
  rocm_trace_emit_hip_api_enter(__func__);
  TRY;
  ROCM_TRACE_RET_STATUS(hip::GetHipDispatchTable()->hipMemcpyFromArray_spt_fn(
...
hipError_t hipMemcpy2DToArray_spt(hipArray_t dst, size_t wOffset, size_t hOffset, const void* src,
  ...
  rocm_trace_emit_hip_api_enter(__func__);
  TRY;
  ROCM_TRACE_RET_STATUS(hip::GetHipDispatchTable()->hipMemcpy2DToArray_spt_fn(
      dst, wOffset, hOffset, src, spitch, width, height, kind));
  CATCH;
}
...
hipError_t hipStreamWaitEvent_spt(hipStream_t stream, hipEvent_t event, unsigned int flags) {
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipStreamWaitEvent_spt_fn(stream, event, flags));
  CATCH;
}
...
hipError_t hipStreamAddCallback_spt(hipStream_t stream, hipStreamCallback_t callback,
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipStreamAddCallback_spt_fn(stream, callback, userData, flags));
  CATCH;
}
...
extern "C" hipError_t hipLaunchKernel_spt(const void* function_address, dim3 numBlocks,
  ...
  rocm_trace_emit_hip_api_enter(__func__);
  TRY;
  ROCM_TRACE_RET_STATUS(hip::GetHipDispatchTable()->hipLaunchKernel_spt_fn(
...
hipError_t hipStreamIsCapturing_spt(hipStream_t stream, hipStreamCaptureStatus* pCaptureStatus) {
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipStreamIsCapturing_spt_fn(stream, pCaptureStatus));
  CATCH;
}
hipError_t hipStreamGetCaptureInfo_spt(hipStream_t stream, hipStreamCaptureStatus* pCaptureStatus,
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipStreamGetCaptureInfo_spt_fn(stream, pCaptureStatus, pId));
  CATCH;
}
...
hipError_t hipTexRefGetBorderColor(float* pBorderColor, const textureReference* texRef) {
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipTexRefGetBorderColor_fn(pBorderColor, texRef));
  CATCH;
}
...
extern "C" hipError_t hipGetProcAddress(const char* symbol, void** pfn, int hipVersion,
  ...
  rocm_trace_emit_hip_api_enter(__func__);
  TRY;
  ROCM_TRACE_RET_STATUS(hip::GetHipDispatchTable()->hipGetProcAddress_fn(symbol, pfn, hipVersion,
                                                                         flags, symbolStatus));
  CATCH;
}
extern "C" hipError_t hipGetProcAddress_spt(const char* symbol, void** pfn, int hipVersion,
  ...
  rocm_trace_emit_hip_api_enter(__func__);
  TRY;
  ROCM_TRACE_RET_STATUS(hip::GetHipDispatchTable()->hipGetProcAddress_spt_fn(
      symbol, pfn, hipVersion, flags, symbolStatus));
  CATCH;
}
...
hipError_t hipDrvGraphExecMemsetNodeSetParams(hipGraphExec_t hGraphExec, hipGraphNode_t hNode,
  ...
  rocm_trace_emit_hip_api_enter(__func__);
  TRY;
  ROCM_TRACE_RET_STATUS(hip::GetHipDispatchTable()->hipDrvGraphExecMemsetNodeSetParams_fn(
...
hipError_t hipDrvGraphAddMemFreeNode(hipGraphNode_t* phGraphNode, hipGraph_t hGraph,
  ...
  rocm_trace_emit_hip_api_enter(__func__);
  TRY;
  ROCM_TRACE_RET_STATUS(hip::GetHipDispatchTable()->hipDrvGraphAddMemFreeNode_fn(
...
hipError_t hipDrvGraphExecMemcpyNodeSetParams(hipGraphExec_t hGraphExec, hipGraphNode_t hNode,
  ...
  rocm_trace_emit_hip_api_enter(__func__);
  TRY;
  ROCM_TRACE_RET_STATUS(hip::GetHipDispatchTable()->hipDrvGraphExecMemcpyNodeSetParams_fn(
...
hipError_t hipMemcpyAtoD(hipDeviceptr_t dstDevice, hipArray_t srcArray, size_t srcOffset,
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipMemcpyAtoD_fn(dstDevice, srcArray, srcOffset, ByteCount));
  CATCH;
}
hipError_t hipMemcpyDtoA(hipArray_t dstArray, size_t dstOffset, hipDeviceptr_t srcDevice,
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipMemcpyDtoA_fn(dstArray, dstOffset, srcDevice, ByteCount));
  CATCH;
}
hipError_t hipMemcpyAtoA(hipArray_t dstArray, size_t dstOffset, hipArray_t srcArray,
  ...
  rocm_trace_emit_hip_api_enter(__func__);
  TRY;
  ROCM_TRACE_RET_STATUS(hip::GetHipDispatchTable()->hipMemcpyAtoA_fn(dstArray, dstOffset, srcArray,
                                                                     srcOffset, ByteCount));
  CATCH;
}
hipError_t hipMemcpyAtoHAsync(void* dstHost, hipArray_t srcArray, size_t srcOffset,
  ...
  rocm_trace_emit_hip_api_enter(__func__);
  TRY;
  ROCM_TRACE_RET_STATUS(hip::GetHipDispatchTable()->hipMemcpyAtoHAsync_fn(
...
hipError_t hipMemcpyHtoAAsync(hipArray_t dstArray, size_t dstOffset, const void* srcHost,
  ...
  rocm_trace_emit_hip_api_enter(__func__);
  TRY;
  ROCM_TRACE_RET_STATUS(hip::GetHipDispatchTable()->hipMemcpyHtoAAsync_fn(
...
hipError_t hipDrvGraphMemcpyNodeGetParams(hipGraphNode_t hNode, HIP_MEMCPY3D* nodeParams) {
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipDrvGraphMemcpyNodeGetParams_fn(hNode, nodeParams));
  CATCH;
}
hipError_t hipDrvGraphMemcpyNodeSetParams(hipGraphNode_t hNode, const HIP_MEMCPY3D* nodeParams) {
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipDrvGraphMemcpyNodeSetParams_fn(hNode, nodeParams));
  CATCH;
}
...
hipError_t hipGraphAddBatchMemOpNode(hipGraphNode_t* pGraphNode, hipGraph_t graph,
  ...
  rocm_trace_emit_hip_api_enter(__func__);
  TRY;
  ROCM_TRACE_RET_STATUS(hip::GetHipDispatchTable()->hipGraphAddBatchMemOpNode_fn(
      pGraphNode, graph, dependencies, numDependencies, nodeParams));
  CATCH;
}
hipError_t hipGraphBatchMemOpNodeGetParams(hipGraphNode_t hNode,
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipGraphBatchMemOpNodeGetParams_fn(hNode, nodeParams_out));
  CATCH;
}
hipError_t hipGraphBatchMemOpNodeSetParams(hipGraphNode_t hNode,
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipGraphBatchMemOpNodeSetParams_fn(hNode, nodeParams));
  CATCH;
}
hipError_t hipGraphExecBatchMemOpNodeSetParams(hipGraphExec_t hGraphExec, hipGraphNode_t hNode,
  ...
  rocm_trace_emit_hip_api_enter(__func__);
  TRY;
  ROCM_TRACE_RET_STATUS(hip::GetHipDispatchTable()->hipGraphExecBatchMemOpNodeSetParams_fn(
...
hipError_t hipEventRecordWithFlags(hipEvent_t event, hipStream_t stream, unsigned int flags) {
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipEventRecordWithFlags_fn(event, stream, flags));
  CATCH;
}
...
hipError_t hipDrvLaunchKernelEx(const HIP_LAUNCH_CONFIG* config, hipFunction_t f, void** kernel,
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipDrvLaunchKernelEx_fn(config, f, kernel, extra));
  CATCH;
}
...
hipError_t hipMemGetHandleForAddressRange(void* handle, hipDeviceptr_t dptr, size_t size,
  ...
  rocm_trace_emit_hip_api_enter(__func__);
  TRY;
  ROCM_TRACE_RET_STATUS(hip::GetHipDispatchTable()->hipMemGetHandleForAddressRange_fn(
...
hipError_t hipMemsetD2D8(hipDeviceptr_t dst, size_t dstPitch, unsigned char value, size_t width,
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipMemsetD2D8_fn(dst, dstPitch, value, width, height));
  CATCH;
}
hipError_t hipMemsetD2D8Async(hipDeviceptr_t dst, size_t dstPitch, unsigned char value,
  ...
  rocm_trace_emit_hip_api_enter(__func__);
  TRY;
  ROCM_TRACE_RET_STATUS(hip::GetHipDispatchTable()->hipMemsetD2D8Async_fn(dst, dstPitch, value,
                                                                          width, height, stream));
  CATCH;
}
hipError_t hipMemsetD2D16(hipDeviceptr_t dst, size_t dstPitch, unsigned short value, size_t width,
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipMemsetD2D16_fn(dst, dstPitch, value, width, height));
  CATCH;
}
hipError_t hipMemsetD2D16Async(hipDeviceptr_t dst, size_t dstPitch, unsigned short value,
  ...
  rocm_trace_emit_hip_api_enter(__func__);
  TRY;
  ROCM_TRACE_RET_STATUS(hip::GetHipDispatchTable()->hipMemsetD2D16Async_fn(dst, dstPitch, value,
                                                                           width, height, stream));
  CATCH;
}
hipError_t hipMemsetD2D32(hipDeviceptr_t dst, size_t dstPitch, unsigned int value, size_t width,
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipMemsetD2D32_fn(dst, dstPitch, value, width, height));
  CATCH;
}
hipError_t hipMemsetD2D32Async(hipDeviceptr_t dst, size_t dstPitch, unsigned int value,
  ...
  rocm_trace_emit_hip_api_enter(__func__);
  TRY;
  ROCM_TRACE_RET_STATUS(hip::GetHipDispatchTable()->hipMemsetD2D32Async_fn(dst, dstPitch, value,
                                                                           width, height, stream));
  CATCH;
}
...
hipError_t hipMemcpyBatchAsync(void** dsts, void** srcs, size_t* sizes, size_t count,
  ...
  rocm_trace_emit_hip_api_enter(__func__);
  TRY;
  ROCM_TRACE_RET_STATUS(hip::GetHipDispatchTable()->hipMemcpyBatchAsync_fn(
...
hipError_t hipMemcpy3DBatchAsync(size_t numOps, struct hipMemcpy3DBatchOp* opList, size_t* failIdx,
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipMemcpy3DBatchAsync_fn(numOps, opList, failIdx, flags, stream));
  CATCH;
}
...
hipError_t hipDeviceGetTexture1DLinearMaxWidth(size_t* maxWidthInElements,
  ...
  rocm_trace_emit_hip_api_enter(__func__);
  TRY;
  ROCM_TRACE_RET_STATUS(hip::GetHipDispatchTable()->hipDeviceGetTexture1DLinearMaxWidth_fn(
...
hipError_t hipGraphExternalSemaphoresSignalNodeSetParams(
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipGraphExternalSemaphoresSignalNodeSetParams_fn(hNode,
                                                                                   nodeParams));
  CATCH;
}
hipError_t hipGraphExternalSemaphoresSignalNodeGetParams(
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipGraphExternalSemaphoresSignalNodeGetParams_fn(hNode,
                                                                                   params_out));
  CATCH;
}
hipError_t hipGraphExternalSemaphoresWaitNodeGetParams(
  ...
  rocm_trace_emit_hip_api_enter(__func__);
  TRY;
  ROCM_TRACE_RET_STATUS(hip::GetHipDispatchTable()->hipGraphExternalSemaphoresWaitNodeGetParams_fn(
      hNode, params_out));
  CATCH;
}
hipError_t hipGraphExternalSemaphoresWaitNodeSetParams(
  ...
  rocm_trace_emit_hip_api_enter(__func__);
  TRY;
  ROCM_TRACE_RET_STATUS(hip::GetHipDispatchTable()->hipGraphExternalSemaphoresWaitNodeSetParams_fn(
      hNode, nodeParams));
  CATCH;
}
hipError_t hipGraphExecExternalSemaphoresSignalNodeSetParams(
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipGraphExecExternalSemaphoresSignalNodeSetParams_fn(
          hGraphExec, hNode, nodeParams));
  CATCH;
}
hipError_t hipGraphExecExternalSemaphoresWaitNodeSetParams(
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipGraphExecExternalSemaphoresWaitNodeSetParams_fn(
          hGraphExec, hNode, nodeParams));
  CATCH;
}
...
hipError_t hipLibraryGetKernel(hipKernel_t* pKernel, hipLibrary_t library, const char* name) {
  rocm_trace_emit_hip_api_enter(__func__);
  TRY;
  ROCM_TRACE_RET_STATUS(hip::GetHipDispatchTable()->hipLibraryGetKernel_fn(pKernel, library, name));
  CATCH;
}
hipError_t hipLibraryGetKernelCount(unsigned int* count, hipLibrary_t library) {
  rocm_trace_emit_hip_api_enter(__func__);
  TRY;
  ROCM_TRACE_RET_STATUS(hip::GetHipDispatchTable()->hipLibraryGetKernelCount_fn(count, library));
  CATCH;
}
hipError_t hipLibraryGetGlobal(void** dptr, size_t* bytes, hipLibrary_t library, const char* name) {
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipLibraryGetGlobal_fn(dptr, bytes, library, name));
  CATCH;
}
hipError_t hipLibraryGetManaged(void** dptr, size_t* bytes, hipLibrary_t library,
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipLibraryGetManaged_fn(dptr, bytes, library, name));
  CATCH;
}
hipError_t hipKernelGetAttribute(int* pi, hipFunction_attribute attrib, hipKernel_t kernel,
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipKernelGetAttribute_fn(pi, attrib, kernel, dev));
  CATCH;
}
hipError_t hipLibraryEnumerateKernels(hipKernel_t* kernels, unsigned int numKernels,
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipLibraryEnumerateKernels_fn(kernels, numKernels, library));
  CATCH;
}
...
hipError_t hipKernelGetParamInfo(hipKernel_t kernel, size_t paramIndex, size_t* paramOffset,
  ...
  rocm_trace_emit_hip_api_enter(__func__);
  TRY;
  ROCM_TRACE_RET_STATUS(hip::GetHipDispatchTable()->hipKernelGetParamInfo_fn(
...
hipError_t hipExtSetLoggingParams(size_t log_level, size_t log_size, size_t log_mask) {
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipExtSetLoggingParams_fn(log_level, log_size, log_mask));
  CATCH;
}
...
hipError_t hipMipmappedArrayGetMemoryRequirements(hipArrayMemoryRequirements* memoryRequirements,
  ...
  rocm_trace_emit_hip_api_enter(__func__);
  TRY;
  ROCM_TRACE_RET_STATUS(hip::GetHipDispatchTable()->hipMipmappedArrayGetMemoryRequirements_fn(
...
hipError_t hipKernelSetAttribute(hipFunction_attribute attrib, int value, hipKernel_t kernel,
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipKernelSetAttribute_fn(attrib, value, kernel, dev));
  CATCH;
}
...
hipError_t hipGreenCtxCreate(hipExecutionCtx_t* ctx, hipDevResourceDesc_t desc, int device,
  ...
  rocm_trace_emit_hip_api_enter(__func__);
  TRY;
  ROCM_TRACE_RET_STATUS(hip::GetHipDispatchTable()->hipGreenCtxCreate_fn(ctx, desc, device, flags));
  CATCH;
}
hipError_t hipExecutionCtxDestroy(hipExecutionCtx_t ctx) {
  rocm_trace_emit_hip_api_enter(__func__);
  TRY;
  ROCM_TRACE_RET_STATUS(hip::GetHipDispatchTable()->hipExecutionCtxDestroy_fn(ctx));
  CATCH;
}
hipError_t hipExecutionCtxStreamCreate(hipStream_t* stream, hipExecutionCtx_t greenctx,
  ...
  rocm_trace_emit_hip_api_enter(__func__);
  TRY;
  ROCM_TRACE_RET_STATUS(hip::GetHipDispatchTable()->hipExecutionCtxStreamCreate_fn(
      stream, greenctx, flags, priority));
  CATCH;
}
hipError_t hipDeviceGetDevResource(hipDevice_t device, hipDevResource* resource,
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipDeviceGetDevResource_fn(device, resource, type));
  CATCH;
}
hipError_t hipDevSmResourceSplitByCount(hipDevResource* result, unsigned int* nbGroups,
  ...
  rocm_trace_emit_hip_api_enter(__func__);
  TRY;
  ROCM_TRACE_RET_STATUS(hip::GetHipDispatchTable()->hipDevSmResourceSplitByCount_fn(
...
hipError_t hipDevSmResourceSplit(hipDevResource* result, unsigned int nbGroups,
  ...
  rocm_trace_emit_hip_api_enter(__func__);
  TRY;
  ROCM_TRACE_RET_STATUS(hip::GetHipDispatchTable()->hipDevSmResourceSplit_fn(
...
hipError_t hipDevResourceGenerateDesc(hipDevResourceDesc_t* phDesc, hipDevResource* resources,
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipDevResourceGenerateDesc_fn(phDesc, resources, nbResources));
  CATCH;
}
hipError_t hipDeviceGetExecutionCtx(hipExecutionCtx_t* ctx, int device) {
  rocm_trace_emit_hip_api_enter(__func__);
  TRY;
  ROCM_TRACE_RET_STATUS(hip::GetHipDispatchTable()->hipDeviceGetExecutionCtx_fn(ctx, device));
  CATCH;
}
hipError_t hipExecutionCtxGetDevResource(hipExecutionCtx_t ctx, hipDevResource* resource,
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipExecutionCtxGetDevResource_fn(ctx, resource, type));
  CATCH;
}
hipError_t hipExecutionCtxGetDevice(int* device, hipExecutionCtx_t ctx) {
  rocm_trace_emit_hip_api_enter(__func__);
  TRY;
  ROCM_TRACE_RET_STATUS(hip::GetHipDispatchTable()->hipExecutionCtxGetDevice_fn(device, ctx));
  CATCH;
}
hipError_t hipExecutionCtxGetId(hipExecutionCtx_t ctx, unsigned long long* ctxId) {
  rocm_trace_emit_hip_api_enter(__func__);
  TRY;
  ROCM_TRACE_RET_STATUS(hip::GetHipDispatchTable()->hipExecutionCtxGetId_fn(ctx, ctxId));
  CATCH;
}
hipError_t hipStreamGetDevResource(hipStream_t hStream, hipDevResource* resource,
  ...
  TRY;
  ROCM_TRACE_RET_STATUS(
      hip::GetHipDispatchTable()->hipStreamGetDevResource_fn(hStream, resource, type));
  CATCH;
}
hipError_t hipExecutionCtxRecordEvent(hipExecutionCtx_t ctx, hipEvent_t event) {
  rocm_trace_emit_hip_api_enter(__func__);
  TRY;
  ROCM_TRACE_RET_STATUS(hip::GetHipDispatchTable()->hipExecutionCtxRecordEvent_fn(ctx, event));
  CATCH;
}
hipError_t hipExecutionCtxSynchronize(hipExecutionCtx_t ctx) {
  rocm_trace_emit_hip_api_enter(__func__);
  TRY;
  ROCM_TRACE_RET_STATUS(hip::GetHipDispatchTable()->hipExecutionCtxSynchronize_fn(ctx));
  CATCH;
}
hipError_t hipExecutionCtxWaitEvent(hipExecutionCtx_t ctx, hipEvent_t event) {
  rocm_trace_emit_hip_api_enter(__func__);
  TRY;
  ROCM_TRACE_RET_STATUS(hip::GetHipDispatchTable()->hipExecutionCtxWaitEvent_fn(ctx, event));
  CATCH;
}
