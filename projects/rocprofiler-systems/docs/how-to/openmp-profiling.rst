.. meta::
    ...
    :keywords: rocprof-sys, rocprofiler-systems, ROCm, tips, how to, profiler, tracking, OpenMP, OMPT, AMD, Offload
...
Below is an example of a a complete configuration file that can be used to instrument OpenMP programs:
...
.. tip::
   The steps in this section also applies to C/C++ programs.
