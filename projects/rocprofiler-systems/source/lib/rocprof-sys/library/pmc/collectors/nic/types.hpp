 ...
 *   - req_rx_impl_nak_seq_err = 9   Requester has received an ACK with PSN larger than expected
 */
...
struct metrics
{
    ...
    uint64_t req_rx_impl_nak_seq_err = 0;  // Requester has received an ACK with PSN larger than expected
};
