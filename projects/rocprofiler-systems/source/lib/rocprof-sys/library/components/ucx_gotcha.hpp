...
template <typename Policy, typename = void>
struct has_ucx_bundle : std::false_type
{};
...
template <typename Policy, typename = void>
struct has_ucx_gotcha : std::false_type
{};
...
template <typename Policy>
constexpr bool HasCommData = has_comm_data<Policy>::value;

template <typename Policy>
constexpr bool HasGotchaData = has_gotcha_data<Policy>::value;

template <typename Policy>
constexpr bool HasCategoryRegion = has_category_region<Policy>::value;

template <typename Policy>
constexpr bool HasUcxBundle = has_ucx_bundle<Policy>::value;

template <typename Policy>
constexpr bool HasUcxGotcha = has_ucx_gotcha<Policy>::value;
}  // namespace rocprofsys::component::ucx_concepts
