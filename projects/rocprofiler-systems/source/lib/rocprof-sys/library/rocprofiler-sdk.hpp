    ...
    typename Wrapper::user_data_t*            user_data, void* /*callback_data*/)
{
    ...
    if constexpr(Wrapper::compile_time_version >= 600)
    {
        ...
        {
            auto* payload_data =
                static_cast<typename Wrapper::ompt_data_t*>(record.payload);
                                           ...
                                           void*                               user_data)
{
    ...
    std::vector<typename Wrapper::external_correlation_request_kind>
        external_corr_id_request_kinds = {
    ...
    if constexpr(Wrapper::compile_time_version >= 600)
    {
        external_corr_id_request_kinds.push_back(
    ...
    std::vector<typename Wrapper::callback_tracing_kind> callback_domain_list = {
    ...
    if constexpr(Wrapper::compile_time_version >= 600)
    {
        callback_domain_list.push_back(Wrapper::CALLBACK_TRACING_OMPT);
        callback_domain_list.push_back(Wrapper::CALLBACK_TRACING_ROCDECODE_API);
    }
    if constexpr(Wrapper::compile_time_version >= 700)
    {
        callback_domain_list.push_back(Wrapper::CALLBACK_TRACING_ROCJPEG_API);
    }

    for(auto itr : callback_domain_list)
    {
    ...
    if constexpr(Wrapper::compile_time_version >= 700)
    {
           ...
           (_buffered_domain.count(Wrapper::BUFFER_TRACING_MEMORY_COPY) > 0))
        {
            rocprofiler_call<Wrapper>(Wrapper::configure_callback_tracing_service(
                                          _data->primary_ctx,
                                          Wrapper::CALLBACK_TRACING_HIP_STREAM, nullptr,
                                          0, tool_hip_stream_callback, nullptr),
                                      "Wrapper::configure_callback_tracing_service");
        }
    }
        ...
        if(_buffered_domain.count(Wrapper::BUFFER_TRACING_MEMORY_ALLOCATION) > 0)
        {
            rocprofiler_call<Wrapper>(
                Wrapper::create_buffer(_data->primary_ctx, buffer_size, watermark,
                                       ...
                                       tool_tracing_buffered, tool_data,
            ...
            rocprofiler_call<Wrapper>(Wrapper::configure_buffer_tracing_service(
                                          ...
                                          nullptr, 0, _data->memory_alloc_buffer),
                                      "Wrapper::configure_buffer_tracing_service");
        }
    }
    ...
    if constexpr(Wrapper::compile_time_version >= 10000)
    {
        ...
        if(_buffered_domain.count(Wrapper::BUFFER_TRACING_KFD_PAGE_FAULT) > 0)
        {
            ...
            rocprofiler_call<Wrapper>(Wrapper::configure_buffer_tracing_service(
                                          _data->primary_ctx,
                                          Wrapper::BUFFER_TRACING_KFD_PAGE_FAULT, nullptr,
                                          0, _data->kfd_page_fault_buffer),
                                      "Wrapper::configure_buffer_tracing_service");
        }
        if(_buffered_domain.count(Wrapper::BUFFER_TRACING_KFD_PAGE_MIGRATE) > 0)
        {
            ...
            rocprofiler_call<Wrapper>(Wrapper::configure_buffer_tracing_service(
                                          ...
                                          nullptr, 0, _data->kfd_page_migrate_buffer),
                                      "Wrapper::configure_buffer_tracing_service");
        }
        ...
        if(_buffered_domain.count(Wrapper::BUFFER_TRACING_KFD_EVENT_QUEUE) > 0)
        {
            ...
            // RESTORE_RESCHEDULED. All others are captured within paired KFD_QUEUE
            // operations
        ...
        if(_buffered_domain.count(Wrapper::BUFFER_TRACING_KFD_EVENT_UNMAP_FROM_GPU) > 0)
        {
            ...
            rocprofiler_call<Wrapper>(
                Wrapper::configure_buffer_tracing_service(
                    _data->primary_ctx, Wrapper::BUFFER_TRACING_KFD_EVENT_UNMAP_FROM_GPU,
        ...
        if(_buffered_domain.count(Wrapper::BUFFER_TRACING_KFD_EVENT_DROPPED_EVENTS) > 0)
        {
            ...
            rocprofiler_call<Wrapper>(
                Wrapper::configure_buffer_tracing_service(
                    _data->primary_ctx, Wrapper::BUFFER_TRACING_KFD_EVENT_DROPPED_EVENTS,
