...
inline constexpr auto k_amd_ext_api = callback_domain_definition<SdkBackend>{
    ...
    .on_record = tracing_callback_dispatcher<
        SdkBackend, on_tracing_api_enter<SdkBackend, Externals, amd_ext_api_category>,
        on_tracing_api_exit<SdkBackend, Externals, amd_ext_api_category>>::callback,
