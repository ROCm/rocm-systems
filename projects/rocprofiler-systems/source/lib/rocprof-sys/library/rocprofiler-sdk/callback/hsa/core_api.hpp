...
inline void
on_core_api_configure()
{}

template <policies::domain_service::backend   SdkBackend,
          policies::domain_service::externals Externals>
inline void
on_core_api_enter(typename SdkBackend::callback_tracing_record_t record,
                  typename SdkBackend::user_data_t* user_data, void* callback_data)
{
    ...
    {
        Externals::tracing_push_timemory(typename Externals::rocm_hsa_api_category{},
                                         name);
    }
}
...
template <policies::domain_service::backend   SdkBackend,
          policies::domain_service::externals Externals>
inline void
on_core_api_exit(typename SdkBackend::callback_tracing_record_t record,
                 typename SdkBackend::user_data_t* user_data, void* callback_data)
{
    (void) callback_data;
    ...
    if(Externals::get_use_timemory())
    {
        Externals::tracing_pop_timemory(typename Externals::rocm_hsa_api_category{},
                                        name);
    }
    ...
    Externals::metadata_add_string(Externals::rocm_hsa_api_category_name);
    ...
    Externals::buffer_storage_store(typename Externals::region_sample{
        ...
        Externals::rocm_hsa_api_category_name.data() });
}
...
inline constexpr auto k_core_api = callback_domain_definition<SdkBackend>{
    .meta =
        domain_descriptor{
            .name  = "hsa_core_api",
            .id    = SdkBackend::CALLBACK_TRACING_HSA_CORE_API,
            .mode  = collection_mode::callback,
            .group = domain_group{ .name = "hsa_api" },
        },
    .on_record =
        tracing_callback_dispatcher<SdkBackend, on_core_api_enter<SdkBackend, Externals>,
                                    on_core_api_exit<SdkBackend, Externals>>::callback,
    .on_configure = on_core_api_configure<Externals>
};
