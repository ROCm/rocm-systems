...
inline void
on_finalize_ext_api_enter(typename SdkBackend::callback_tracing_record_t record,
...
template <policies::domain_service::backend   SdkBackend,
          policies::domain_service::externals Externals>
inline void
on_finalize_ext_api_exit(typename SdkBackend::callback_tracing_record_t record,
...
inline constexpr auto k_finalize_ext_api = callback_domain_definition<SdkBackend>{
    ...
    .on_record = tracing_callback_dispatcher<
        SdkBackend, on_finalize_ext_api_enter<SdkBackend, Externals>,
        on_finalize_ext_api_exit<SdkBackend, Externals>>::callback,
