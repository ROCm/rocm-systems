...
struct rocjpeg_api_category
{
    using type = Externals::rocm_rocjpeg_api_category;

    static constexpr std::string_view k_name = Externals::rocm_rocjpeg_api_category_name;
};
