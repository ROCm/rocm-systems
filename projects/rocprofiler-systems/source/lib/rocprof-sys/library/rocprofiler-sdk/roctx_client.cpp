...
int
iterate_args_callback(rocprofiler_callback_tracing_kind_t, std::int32_t, std::uint32_t arg_number,
                      const void* const, std::int32_t, const char*                arg_type,
                      const char* arg_name, const char* arg_value_str, std::int32_t,
                      void* data)
{
