...
TEST(kfd_event_page_migrate_test, descriptor_reports_correct_metadata)
{
    ...
    constexpr const auto& k_domain = k_event_page_migrate<mock_sdk, externals>;
        ...
        *g_externals_mock,
        add_pmc_info(AllOf(
            ...
            Field(&pmc_info_data_t::name,
                  Eq(std::string{ externals::k_kfd_event_page_migrate_category_name })),
            Field(&pmc_info_data_t::symbol,
                  Eq(std::string{ "KFD Event Page Migration Events" })),
