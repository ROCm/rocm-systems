...
TEST_F(type_registry_test, test_get_type_sample_1)
{
    ...
    size_t        buffer_size = rocprofsys::trace_cache::serialized_size(test_value);
    std::vector<std::uint8_t> buffer(buffer_size);
    rocprofsys::trace_cache::serialize_at(buffer.data(), test_value);
...
TEST_F(type_registry_test, test_multiple_calls_same_type)
{
    ...
    size_t buffer_size1 = rocprofsys::trace_cache::serialized_size(test_value1);
    size_t buffer_size2 = rocprofsys::trace_cache::serialized_size(test_value2);

    std::vector<std::uint8_t> buffer1(buffer_size1);
    std::vector<std::uint8_t> buffer2(buffer_size2);

    rocprofsys::trace_cache::serialize_at(buffer1.data(), test_value1);
    rocprofsys::trace_cache::serialize_at(buffer2.data(), test_value2);
