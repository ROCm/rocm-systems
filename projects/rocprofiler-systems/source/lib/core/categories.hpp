...
ROCPROFSYS_DEFINE_CATEGORY(category, unified_memory_bandwidth, ROCPROFSYS_CATEGORY_UNIFIED_MEMORY_BANDWIDTH, "unified_memory_bandwidth", "Unified Memory Migration Throughput")
