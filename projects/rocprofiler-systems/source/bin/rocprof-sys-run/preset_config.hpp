...
inline const std::vector<PresetConfig> PRESETS = {
    ...
    { "trace-hpc",
      ...
      { "ROCPROFSYS_TRACE", "ROCPROFSYS_PROFILE", "ROCPROFSYS_USE_SAMPLING",
        ...
        "ROCPROFSYS_USE_KOKKOSP", "ROCPROFSYS_USE_RCCLP", "ROCPROFSYS_USE_MPIP",
      ...
      { { "ROCPROFSYS_TRACE", common_values::ON },
        ...
        { "ROCPROFSYS_USE_RCCLP", common_values::ON },
    ...
    { "workload-trace",
      ...
      { "ROCPROFSYS_TRACE", "ROCPROFSYS_PROFILE", "ROCPROFSYS_USE_SAMPLING",
        ...
        "ROCPROFSYS_SAMPLING_CPUS", "ROCPROFSYS_ROCM_DOMAINS",
        "ROCPROFSYS_AMD_SMI_METRICS", "ROCPROFSYS_SAMPLING_GPUS", "ROCPROFSYS_USE_RCCLP",
        "ROCPROFSYS_USE_ROCPD", "ROCPROFSYS_PERFETTO_BUFFER_SIZE_KB" },
      { { "ROCPROFSYS_TRACE", common_values::ON },
        { "ROCPROFSYS_PROFILE", common_values::ON },
        { "ROCPROFSYS_USE_SAMPLING", common_values::OFF },
        { "ROCPROFSYS_SAMPLING_FREQ", "50" },
    ...
    { "sys-trace",
      ...
      { "ROCPROFSYS_TRACE", "ROCPROFSYS_PROFILE", "ROCPROFSYS_ROCM_DOMAINS" },
      { { "ROCPROFSYS_TRACE", common_values::ON },
        { "ROCPROFSYS_PROFILE", common_values::ON },
    ...
    { "trace-gpu",
      ...
      { "ROCPROFSYS_TRACE", "ROCPROFSYS_PROFILE", "ROCPROFSYS_USE_AMD_SMI",
        "ROCPROFSYS_SAMPLING_CPUS", "ROCPROFSYS_ROCM_DOMAINS" },
      { { "ROCPROFSYS_TRACE", common_values::ON },
