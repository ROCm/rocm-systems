...
Validates that running sdma_test with ROCPROFSYS_AMD_SMI_METRICS=sdma_usage
...
class TestSDMA(RocprofsysTest):
    ...
    def test_sdma_usage_tracks(self, mode, sdma_env, sdma_rules):
        """Run sdma_test with sdma_usage and validate Perfetto + ROCPD for SDMA tracks/values."""
