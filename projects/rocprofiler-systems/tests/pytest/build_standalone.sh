...
a = Analysis(
    ...
    hiddenimports=[
        ...
        'rocprofsys.rocpd_rules',
        'rocprofsys.gpu',
        'rocprofsys.capabilities',
        'rocprofsys_validator',
        'rocprofsys_validator.core',
        'rocprofsys_validator.expect',
        'rocprofsys_validator.registry',
        'rocprofsys_validator.readers',
        'rocprofsys_validator.readers.perfetto',
        'rocprofsys_validator.readers.timemory_json',
        'perfetto',
        'pandas',
    ],
    hookspath=[],
...
a = Analysis(
    ...
    hiddenimports=[
        ...
        'rocprofsys.validators', 'rocprofsys.rocpd_rules',
        'rocprofsys.gpu', 'rocprofsys.capabilities',
        'rocprofsys_validator', 'rocprofsys_validator.core',
        'rocprofsys_validator.expect', 'rocprofsys_validator.registry',
        'rocprofsys_validator.readers', 'rocprofsys_validator.readers.perfetto',
        'rocprofsys_validator.readers.timemory_json',
        'perfetto', 'pandas',
    ],
    hookspath=[],
