...
add_test(
    ...
    COMMAND
        ${PROJECT_BINARY_DIR}/rocprofv2 --hip-api -d
        ${PROJECT_BINARY_DIR}/out-trace -o out
...
add_test(
    ...
    COMMAND
        ${Python3_EXECUTABLE} ${CMAKE_CURRENT_LIST_DIR}/hip_trace_validate.py
...
set_tests_properties(
    ...
    PROPERTIES
        DEPENDS hiptrace_helloworld_test
