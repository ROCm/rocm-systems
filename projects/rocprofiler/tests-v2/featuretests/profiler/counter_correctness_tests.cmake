...
add_test(
    ...
    COMMAND
        ...
        ${PROJECT_BINARY_DIR}/tests-v2/featuretests/profiler/apps/goldentraces/pmc.txt
        -d /tmp/tests-v2/pmc -o vadd
        tests-v2/featuretests/profiler/apps/pmc_vectoradd
...
add_test(
    ...
    COMMAND
        ${Python3_EXECUTABLE} ${CMAKE_CURRENT_SOURCE_DIR}/test_vectoradd.py
...
set_tests_properties(
    ...
    PROPERTIES
        DEPENDS pmc_correctnes_vadd_test
...
add_test(
    ...
    COMMAND
        ${PROJECT_BINARY_DIR}/rocprofv2 -i
        ${PROJECT_BINARY_DIR}/tests-v2/featuretests/profiler/apps/goldentraces/pmc.txt
        -d /tmp/tests-v2/pmc -o histo
        tests-v2/featuretests/profiler/apps/pmc_histogram
    WORKING_DIRECTORY "${PROJECT_BINARY_DIR}"
)
...
add_test(
    ...
    COMMAND
        ${Python3_EXECUTABLE} ${CMAKE_CURRENT_SOURCE_DIR}/test_histogram.py
...
set_tests_properties(
    ...
    PROPERTIES
        DEPENDS pmc_correctnes_histogram_test
        LABELS "v2;validation"
        PASS_REGULAR_EXPRESSION "Test Passed"
