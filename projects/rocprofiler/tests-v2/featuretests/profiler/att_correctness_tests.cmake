...
add_test(
    ...
    COMMAND
        ...
        -d /tmp/tests-v2/att/ -o /tmp/tests-v2/att/vadd --plugin att auto --mode
        csv tests-v2/featuretests/profiler/apps/att_vectoradd
...
add_test(
    ...
    COMMAND
        ${Python3_EXECUTABLE} ${CMAKE_CURRENT_SOURCE_DIR}/test_att_vectoradd.py
    WORKING_DIRECTORY "${PROJECT_BINARY_DIR}"
)
...
set_tests_properties(
    ...
    PROPERTIES
        DEPENDS att_correctness_vectoradd_run
