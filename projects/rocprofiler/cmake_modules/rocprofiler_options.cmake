if("${PROJECT_SOURCE_DIR}" STREQUAL "${PROJECT_BINARY_DIR}")
    ...
    message(
        STATUS
        "Delete CMakeCache.txt and CMakeFiles in ${PROJECT_SOURCE_DIR}"
    )
...
foreach(_PLUGIN "ATT" "CTF" "PERFETTO")
    option(
        ROCPROFILER_BUILD_PLUGIN_${_PLUGIN}
        "Enable building the ${_PLUGIN} plugin"
        ON
    )
endforeach()
...
if(CMAKE_PROJECT_NAME STREQUAL PROJECT_NAME)
    set_property(
        ...
        PROPERTY STRINGS "${ROCPROFILER_BUILD_TYPES}"
    )
endif()

set(ROCPROFILER_MEMCHECK "" CACHE STRING "Memory checker type")
...
if(ASAN)
    set(ROCPROFILER_MEMCHECK
        "AddressSanitizer"
        CACHE STRING
        "Memory checker type (forced by ASAN defined)"
        FORCE
    )
endif()

set(ROCPROFILER_MEMCHECK_TYPES
    "ThreadSanitizer"
    "AddressSanitizer"
    "LeakSanitizer"
    "MemorySanitizer"
...
if(
    ...
    AND NOT ROCPROFILER_MEMCHECK IN_LIST ROCPROFILER_MEMCHECK_TYPES
)
    message(
        FATAL_ERROR
...
set_property(
    CACHE ROCPROFILER_MEMCHECK
    PROPERTY STRINGS "${ROCPROFILER_MEMCHECK_TYPES}"
)
...
function(rocprofiler_add_memcheck_flags _TYPE)
    ...
    target_link_options(
        rocprofiler-memcheck
        INTERFACE $<BUILD_INTERFACE:-fsanitize=${_TYPE} -Wl,--no-undefined>
    )
endfunction()
