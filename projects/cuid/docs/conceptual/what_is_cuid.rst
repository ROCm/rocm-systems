...
The Component Unified Identifier (CUID or CUUID) is generated by combining the device-specific data into a 122-bit ID value. This can either be a primary CUID or a derived CUID.
...
.. list-table:: UUIDv8 style format
  ...
  * - 48:51
    - A fixed value of 8
    - The value is fixed for RFC 9562 compliance.
