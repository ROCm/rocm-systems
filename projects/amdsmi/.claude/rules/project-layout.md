...
| Python integration | `tests/python_unittest/integration_test.py` | `python3` (per-API, live device) |
| Python functional | `tests/python_unittest/functional_test.py` | `python3` (live device + root) |
