...
/**
 *  @brief Select the DKMS package matching the loaded amdgpu module version.
 *
 *  @param[in] packages Validated PACKAGE_VERSION to PACKAGE_NAME map.
 *  @param[in] loaded_version Loaded amdgpu module version.
 *  @param[out] active_version Cleared on entry and populated on an exact match.
 */
