...
`version` | Fabric info layout that was actually filled: `2` for the nested layout, or `1` if the loaded library predates it and reports the flat layout instead
