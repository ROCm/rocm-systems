...
CPU Arguments:
  ...
  --cpu-socket-sdps-limit                   Displays socket SDPS limit for the selected CPU socket (in Watts)
...
usage: amd-smi set [-h] (-g GPU [GPU ...] | -U CPU [CPU ...] | -O CORE [CORE ...]) [-f %]
                   ...
                   [--soc-floor-limit FLOOR_LIMIT] [--cpu-msr-floor-limit MSR_FLOOR_LIMIT]
                   [--core-floor-limit FLOOR_LIMIT] [--core-msr-floor-limit MSR_FLOOR_LIMIT]
                   [--cpu-dimm-sb-reg DIMM_ADDR LID REG_OFFSET REG_SPACE [WRITE_DATA]] [--cpu-socket-sdps-limit SDPS_LIMIT]
...
CPU Arguments:
  ...
  --cpu-socket-sdps-limit SDPS_LIMIT                             Set socket SDPS limit for the given socket. Input parameter is SDPS limit value in milliwatts (mW).
...
CPU Core Arguments:
  ...
  --core-msr-floor-limit MSR_FLOOR_LIMIT                         Sets the MSR floor limit for the given core. Input parameter is core MSR_FLOOR_LIMIT value in MHz
