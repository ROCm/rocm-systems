...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--list", default="", metavar="platform", help="List function in a platform"
    )
    parser.add_argument(
        "--diff",
        default=None,
        metavar="platform",
        nargs=2,
        help="Find the APIs in platform1 but not in platform2",
    )
    parser.add_argument(
        "--common",
        default=None,
        metavar="platform",
        nargs=2,
        help="Find the common APIs of two platforms",
    )
