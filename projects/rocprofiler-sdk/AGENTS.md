...
These are enforced by `.github/workflows/rocprofiler-sdk-formatting.yml`, which also rejects any
file not ending in a newline. The repository-root `.pre-commit-config.yaml` pins different tools
