...
class WorkflowSession:
    ...
    def _phase1b_quick_workload_analysis(self) -> Optional[str]:
        ...
        _print()
        _print(
            "  ── Quick Workload Analysis ─────────────────────────────────", style="cyan"
        )
        ...
        try:
            ...
            if total_ns == 0 and self._state.trace_history:
                ...
                if already_has_sync:
                    ...
                    _print(
                        "     Alternatively: rocprof-sys --trace -- <app>", style="yellow"
                    )
                _print()
        ...
        while True:
            ...
            if all_info and already_reprofiled:
                ...
                if has_real_data:
                    ...
                    _print(
                        "  Analysis result unchanged after re-profiling.", style="yellow"
                    )
                    _print(
    ...
    def _phase6_apply_direct(self, snap: _AnalysisSnapshot) -> Optional[str]:
        ...
        while True:  # retry loop — re-entered when user picks [f] Try a different fix
            ...
            _print(
                "  Type 'done' when compiled, 'revert' to undo the AI edit,", style="dim"
            )
