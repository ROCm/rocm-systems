...
namespace counters
{
// Iterates active dispatch_counter_collection contexts; appends one inst_pkt
// entry per callback that produces a packet, OR-folding each callback's
// serialize flag into is_serialized.
void
