...
Streaming Performance Monitor (SPM) sampling is a profiling method that samples hardware performance counters at regular intervals. This provides a granualar insight into behavior of kernel during its execution.
.. warning::
