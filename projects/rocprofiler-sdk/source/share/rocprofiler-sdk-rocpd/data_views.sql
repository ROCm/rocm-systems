...
SELECT
    ...
    -- Snapshot fields
    COALESCE(MAX(CASE WHEN PMC.name = 'dual_issue_valu' THEN PE.value END), '0') AS dual_issue_valu,
    COALESCE(MAX(CASE WHEN PMC.name = 'arb_state_issue_valu' THEN PE.value END), '0') AS arb_state_issue_valu,
    COALESCE(MAX(CASE WHEN PMC.name = 'arb_state_issue_matrix' THEN PE.value END), '0') AS arb_state_issue_matrix,
    COALESCE(MAX(CASE WHEN PMC.name = 'arb_state_issue_lds' THEN PE.value END), '0') AS arb_state_issue_lds,
    COALESCE(MAX(CASE WHEN PMC.name = 'arb_state_issue_lds_direct' THEN PE.value END), '0') AS arb_state_issue_lds_direct,
    COALESCE(MAX(CASE WHEN PMC.name = 'arb_state_issue_scalar' THEN PE.value END), '0') AS arb_state_issue_scalar,
    COALESCE(MAX(CASE WHEN PMC.name = 'arb_state_issue_vmem_tex' THEN PE.value END), '0') AS arb_state_issue_vmem_tex,
    COALESCE(MAX(CASE WHEN PMC.name = 'arb_state_issue_flat' THEN PE.value END), '0') AS arb_state_issue_flat,
    COALESCE(MAX(CASE WHEN PMC.name = 'arb_state_issue_exp' THEN PE.value END), '0') AS arb_state_issue_exp,
    COALESCE(MAX(CASE WHEN PMC.name = 'arb_state_issue_misc' THEN PE.value END), '0') AS arb_state_issue_misc,
    COALESCE(MAX(CASE WHEN PMC.name = 'arb_state_issue_brmsg' THEN PE.value END), '0') AS arb_state_issue_brmsg,
    COALESCE(MAX(CASE WHEN PMC.name = 'arb_state_stall_valu' THEN PE.value END), '0') AS arb_state_stall_valu,
    COALESCE(MAX(CASE WHEN PMC.name = 'arb_state_stall_matrix' THEN PE.value END), '0') AS arb_state_stall_matrix,
    COALESCE(MAX(CASE WHEN PMC.name = 'arb_state_stall_lds' THEN PE.value END), '0') AS arb_state_stall_lds,
    COALESCE(MAX(CASE WHEN PMC.name = 'arb_state_stall_lds_direct' THEN PE.value END), '0') AS arb_state_stall_lds_direct,
    COALESCE(MAX(CASE WHEN PMC.name = 'arb_state_stall_scalar' THEN PE.value END), '0') AS arb_state_stall_scalar,
    COALESCE(MAX(CASE WHEN PMC.name = 'arb_state_stall_vmem_tex' THEN PE.value END), '0') AS arb_state_stall_vmem_tex,
    COALESCE(MAX(CASE WHEN PMC.name = 'arb_state_stall_flat' THEN PE.value END), '0') AS arb_state_stall_flat,
    COALESCE(MAX(CASE WHEN PMC.name = 'arb_state_stall_exp' THEN PE.value END), '0') AS arb_state_stall_exp,
    COALESCE(MAX(CASE WHEN PMC.name = 'arb_state_stall_misc' THEN PE.value END), '0') AS arb_state_stall_misc,
    COALESCE(MAX(CASE WHEN PMC.name = 'arb_state_stall_brmsg' THEN PE.value END), '0') AS arb_state_stall_brmsg,
    -- Memory counters
