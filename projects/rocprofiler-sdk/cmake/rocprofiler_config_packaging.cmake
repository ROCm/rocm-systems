...
function(
    rocprofiler_set_package_depends
    _VARIABLE
    _VALUE
    _INFO
    _REPLACE_PARENTHESIS
)
...
set(CPACK_STRIP_FILES OFF CACHE BOOL "") # eventually this should be set to ON
set(ROCPROFILER_CPACK_SYSTEM_NAME
    "${CMAKE_SYSTEM_NAME}"
    CACHE STRING
    "System name, e.g. Linux or Ubuntu-18.04"
)
...
list(
    LENGTH
    ROCPROFILER_PACKAGING_COMPONENTS
    NUM_ROCPROFILER_PACKAGING_COMPONENTS
)

# the packages we will generate
set(ROCPROFILER_COMPONENT_GROUPS
    "core"
    "docs"
    "tests"
    "roctx"
...
set(COMPONENT_GROUP_core_COMPONENTS
    "core"
    "development"
    "samples"
    "tools"
...
set(COMPONENT_DESC_core
    "rocprofiler-sdk libraries, headers, samples, and tools"
)
...
if(ROCPROFILER_BUILD_DOCS)
    math(
        ...
        "${EXPECTED_PACKAGING_COMPONENTS} + 1"
    )
endif()
...
set(CPACK_DEBIAN_PACKAGE_SHLIBDEPS ON CACHE BOOL "") # auto-generate deps based on shared libs
...
set(CPACK_RPM_PACKAGE_AUTOREQ ON CACHE BOOL "") # auto-generate deps based on shared libs
...
if(ROCM_LLVM_OBJCOPY)
    set(CPACK_OBJCOPY_EXECUTABLE "${ROCM_LLVM_OBJCOPY}" CACHE FILEPATH "" FORCE)
endif()
if(ROCM_LLVM_OBJDUMP)
    set(CPACK_OBJDUMP_EXECUTABLE "${ROCM_LLVM_OBJDUMP}" CACHE FILEPATH "" FORCE)
endif()
if(ROCM_LLVM_READELF)
    set(CPACK_READELF_EXECUTABLE "${ROCM_LLVM_READELF}" CACHE FILEPATH "" FORCE)
endif()
