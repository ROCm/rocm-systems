...
if(NOT TIMEM_EXECUTABLE OR NOT EXISTS "${TIMEM_EXECUTABLE}")
    ...
    execute_process(
        COMMAND
            ${SHELL_EXECUTABLE} ${TIMEM_INSTALLER}
            --prefix=${PROJECT_BINARY_DIR} --exclude-subdir --skip-license
...
set_property(
    TARGET rocprofiler-sdk::timem
    PROPERTY IMPORTED_LOCATION ${TIMEM_EXECUTABLE}
)
