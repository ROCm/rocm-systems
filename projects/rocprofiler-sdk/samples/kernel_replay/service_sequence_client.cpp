...
configure_pc_sampling()
{
    ...
    // Deliberately do not start this context globally. Replay promotes only the selected
    // agent for the PC-sampling pass and restores this stopped state afterward.
    return configured;
}
