...
void pm4_builder::Gfx9CmdBuilder::BuildWriteShRegPacket(CmdBuffer* cmdBuf, uint32_t addr,
                                                        uint32_t value) {
  uint32_t packet[3] = {
...
void pm4_builder::Gfx9CmdBuilder::BuildCacheFlushPacket(CmdBuffer* cmdBuf, size_t addr,
                                                        size_t size) {
  uint32_t packet[7] = {
