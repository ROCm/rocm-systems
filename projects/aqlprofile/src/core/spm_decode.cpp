...
PUBLIC_API hsa_status_t aqlprofile_spm_decode_query(aqlprofile_spm_buffer_desc_t desc_bin,
...
PUBLIC_API hsa_status_t aqlprofile_spm_decode_stream_v1(
    aqlprofile_spm_buffer_desc_t desc_bin, aqlprofile_spm_decode_callback_v1_t decode_cb,
    void* _data, size_t _size, void* userdata) {
  SpmBufferDesc* desc = (SpmBufferDesc*)desc_bin.data;
