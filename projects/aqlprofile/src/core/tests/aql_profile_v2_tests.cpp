...
class CallbackMock {
 public:
  MOCK_METHOD(hsa_status_t, memory_alloc,
  ...
  MOCK_METHOD(hsa_status_t, memory_copy, (void* dst, const void* src, size_t size, void* userdata),
              ());
  MOCK_METHOD(hsa_status_t, pmc_data_callback,
              (aqlprofile_pmc_event_t event, uint64_t counter_id, uint64_t counter_value,
               void* userdata),
              ());
  MOCK_METHOD(hsa_status_t, att_data_callback,
  ...
  MOCK_METHOD(hsa_status_t, coordinate_callback,
...
TEST_F(AqlProfileV2Test, CallbackSignatures) {
  ...
  aqlprofile_memory_alloc_callback_t alloc_cb =
      [](void** ptr, uint64_t size, aqlprofile_buffer_desc_flags_t flags,
         void* userdata) -> hsa_status_t { return HSA_STATUS_SUCCESS; };

  aqlprofile_memory_dealloc_callback_t dealloc_cb = [](void* ptr, void* userdata) -> void {};

  aqlprofile_memory_copy_t copy_cb = [](void* dst, const void* src, size_t size,
  ...
  aqlprofile_att_data_callback_t att_cb = [](uint32_t shader, void* buffer, uint64_t size,
                                             void* callback_data) -> hsa_status_t {
    return HSA_STATUS_SUCCESS;
  };
  ...
  aqlprofile_coordinate_callback_t coord_cb = [](int position, int id, int extent, int coordinate,
                                                 const char* name, void* userdata) -> hsa_status_t {
    return HSA_STATUS_SUCCESS;
  };
...
class AqlProfileV2ApiTest : public AqlProfileV2Test {
 protected:
  ...
  static hsa_status_t coordinate_callback_mock(int position, int id, int extent, int coordinate,
  ...
  static hsa_status_t att_data_callback_mock(uint32_t shader, void* buffer, uint64_t size,
                                             void* callback_data) {
    callback_call_count_++;
    return HSA_STATUS_SUCCESS;
  }
