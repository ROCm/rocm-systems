...
if(NOT DEFINED CTEST_BUILD_NAME)
    set(CTEST_BUILD_NAME
        "aqlprofile-amd-staging-ubuntu-${RUNNER_HOSTNAME}-core"
    )
endif()
...
if(_submit_ret EQUAL 0)
    ...
    message(
        AUTHOR_WARNING
        "Dashboard submission failed with code ${_submit_ret}."
    )
endif()
