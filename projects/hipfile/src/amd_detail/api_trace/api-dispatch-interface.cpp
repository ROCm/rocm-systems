...
{
    return hipFile::GetHipFileDispatchTable()->pfn_hipfile_handle_deregister(fh);
}
extern "C" hipFileError_t
...
{
    return hipFile::GetHipFileDispatchTable()->pfn_hipfile_batch_io_destroy(batch_idp);
}
extern "C" hipFileError_t
