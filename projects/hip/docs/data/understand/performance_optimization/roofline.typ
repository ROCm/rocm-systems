...
#cetz.canvas({
  ...
  plot.plot(
    ...
    x-tick-step: none, y-tick-step: none,
    {
      ...
      plot.add(((0.0, 0.0), (18.025, 144.2)), style: (stroke: (paint: dark-green, thickness: 1.5pt)))
      
      // Memory bandwidth line - dashed continuation (dark green)
      plot.add(((18.025, 144.2), (140, 200)), style: (stroke: (paint: dark-green, thickness: 1.5pt, dash: "dashed")))
      
      // Arithmetic bandwidth line - dashed left segment (dark blue)
      plot.add(((0.0, 144.2), (18.025, 144.2)), style: (stroke: (paint: dark-blue, thickness: 1.5pt, dash: "dashed")))
      
      // Arithmetic bandwidth line - solid right segment (dark blue)
      plot.add(((18.025, 144.2), (10000, 144.2)), style: (stroke: (paint: dark-blue, thickness: 1.5pt)))
  ...
  line("roofline.intensity1", ((), "|-", (1, 0)), stroke: (paint: dark-pink, dash: "dashed"))
  content(("roofline.intensity1"), [
    #set text(fill: dark-pink)
  ...
  line("roofline.intensity2", ((), "|-", (1000, 0)), stroke: (paint: dark-pink, dash: "dashed"))
