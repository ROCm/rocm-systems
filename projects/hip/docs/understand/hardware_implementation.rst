...
Each compute unit includes a set of specialized pipelines and/or transcendental
...
Each compute unit includes a set of LSUs tightly integrated with its vector
