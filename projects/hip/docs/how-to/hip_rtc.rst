...
For a detailed example, refer to `lowered_names <https://github.com/ROCm/rocm-examples/tree/amd-staging/HIP-Doc/Programming-Guide/Programming-for-HIP-Runtime-Compiler/lowered_names/main.cpp>`__ in `rocm_examples <https://github.com/ROCm/rocm-examples>`__.
