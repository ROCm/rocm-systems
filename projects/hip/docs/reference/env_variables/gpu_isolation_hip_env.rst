...
.. list-table::
    ...
    * - | ``ROCR_VISIBLE_DEVICES``
      ...
      - :doc:`GPU isolation <rocm:reference/system-optimization/gpu-isolation>`, :doc:`Setting the number of compute units <rocm:reference/environment-variables/setting-cus>`
