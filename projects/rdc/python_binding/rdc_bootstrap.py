...
class rdc_field_t(c_int):
    ...
    def get_rdc_metric_type(cls, rdc_metric_t):
        ...
        if rdc_metric_t is not None:
            return cls._rdc_metric_type_lookup.get(
                rdc_metric_t, rdc_metric_type_t.GAUGE
            )
...
rdc.rdc_connect.argtypes = [
    c_char_p,
    POINTER(rdc_handle_t),
    c_char_p,
    c_char_p,
    c_char_p,
]
...
rdc.rdc_job_start_stats.argtypes = [
    rdc_handle_t,
    rdc_gpu_group_t,
    POINTER(c_char),
    c_uint64,
...
rdc.rdc_job_get_stats.argtypes = [
    rdc_handle_t,
    POINTER(c_char),
    POINTER(rdc_job_info_t),
]
...
rdc.rdc_device_get_attributes.argtypes = [
    rdc_handle_t,
    c_uint32,
    POINTER(rdc_device_attributes_t),
]
...
rdc.rdc_group_gpu_get_info.argtypes = [
    rdc_handle_t,
    rdc_gpu_group_t,
    POINTER(rdc_group_info_t),
]
rdc.rdc_group_get_all_ids.restype = rdc_status_t
rdc.rdc_group_get_all_ids.argtypes = [
    rdc_handle_t,
    POINTER(rdc_gpu_group_t),
    POINTER(c_uint32),
]
