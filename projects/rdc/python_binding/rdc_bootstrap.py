...
if rdc == None:
    print(
        "Unable to load the librdc_bootstrap.so. Set LD_LIBRARY_PATH to the folder containing librdc_bootstrap.so."
    )
    exit(1)
...
class rdc_field_t(c_int):
    ...
    RDC_FI_GPU_CLOCK_MIN = 102
    RDC_FI_GPU_CLOCK_MAX = 103
    RDC_FI_SOC_CLOCK = 104
    RDC_FI_VCLK0 = 105
    RDC_FI_DCLK0 = 106
    RDC_FI_MEMORY_TEMP = 200
    RDC_FI_GPU_TEMP = 201
    RDC_FI_GPU_JUNCTION_TEMP = 202
    RDC_FI_POWER_USAGE = 300
    RDC_FI_GPU_ENERGY = 301
    RDC_FI_PCIE_TX = 400
    RDC_FI_PCIE_RX = 401
    ...
    RDC_FI_PCIE_SPEED = 406
    RDC_FI_PCIE_MAX_SPEED = 407
    RDC_FI_PCIE_REPLAY_ROLLOVER = 408
    RDC_FI_PCIE_BANDWIDTH_BIDIR = 409
    RDC_FI_GPU_UTIL = 500
    ...
    RDC_FI_GFX_ACTIVITY_ACC = 509
    RDC_FI_MEM_ACTIVITY_ACC = 510
    RDC_FI_ACCUMULATION_COUNTER = 511
    RDC_FI_GPU_MEMORY_FREE = 512
    RDC_FI_GPU_VIS_VRAM_TOTAL = 513
    RDC_FI_GPU_VIS_VRAM_USED = 514
    RDC_FI_GPU_VIS_VRAM_FREE = 515
    RDC_FI_GPU_GTT_TOTAL = 516
    RDC_FI_GPU_GTT_USED = 517
    RDC_FI_GPU_GTT_FREE = 518
    RDC_FI_GPU_GFX_BUSY_INST = 519
    RDC_FI_GPU_VCN_BUSY_INST = 520
    RDC_FI_GPU_JPEG_BUSY_INST = 521
    ...
    RDC_FI_ECC_SDMA_DE = 640
    RDC_FI_ECC_GFX_DE = 641
    RDC_FI_ECC_MMHUB_DE = 642
    RDC_FI_ECC_ATHUB_DE = 643
    RDC_FI_ECC_PCIE_BIF_DE = 644
    RDC_FI_ECC_HDP_DE = 645
    RDC_FI_ECC_XGMI_WAFL_DE = 646
    RDC_FI_ECC_DF_DE = 647
    RDC_FI_ECC_SMN_DE = 648
    RDC_FI_ECC_SEM_DE = 649
    RDC_FI_ECC_MP0_DE = 650
    RDC_FI_ECC_MP1_DE = 651
    RDC_FI_ECC_FUSE_DE = 652
    RDC_FI_ECC_UMC_DE = 653
    RDC_FI_ECC_MCA_DE = 654
    RDC_FI_ECC_VCN_DE = 655
    RDC_FI_ECC_JPEG_DE = 656
    RDC_FI_ECC_IH_DE = 657
    RDC_FI_ECC_MPIO_DE = 658
    RDC_FI_ECC_DEFERRED_TOTAL = 659
    ...
    RDC_HEALTH_VIOLATION_COUNTER = 3008
    RDC_HEALTH_PROCHOT_RESIDENCY_ACC = 3009
    RDC_HEALTH_PROCHOT_RESIDENCY_PCT = 3010
    RDC_HEALTH_PPT_RESIDENCY_PCT = 3011
    RDC_HEALTH_SOCKET_THRM_ACC = 3012
    RDC_HEALTH_SOCKET_THRM_PCT = 3013
    RDC_HEALTH_VR_THRM_ACC = 3014
    RDC_HEALTH_VR_THRM_PCT = 3015
    RDC_HEALTH_HBM_THRM_ACC = 3016
    RDC_HEALTH_HBM_THRM_PCT = 3017
    RDC_HEALTH_GFX_CLK_LMT_PWR_ACC = 3018
    RDC_HEALTH_GFX_CLK_LMT_PWR_PCT = 3019
    RDC_HEALTH_GFX_CLK_LMT_THM_ACC = 3020
    RDC_HEALTH_GFX_CLK_LMT_THM_PCT = 3021
    RDC_HEALTH_LOW_UTIL_ACC = 3022
    RDC_HEALTH_LOW_UTIL_PCT = 3023
    RDC_HEALTH_GFX_CLK_LMT_TOTAL_ACC = 3024
    RDC_HEALTH_GFX_CLK_LMT_TOTAL_PCT = 3025
...
class rdc_device_attributes_t(Structure):
    _fields_ = [("device_name", c_char * 256)]


class rdc_group_info_t(Structure):
    _fields_ = [("count", c_uint32), ("group_name", c_char * 256), ("entity_ids", c_uint32 * 64)]
...
class rdc_anonymous_0(ctypes.Union):
    _fields_ = [("l_int", c_int64), ("dbl", c_double), ("str", c_char * 256)]
...
class rdc_field_group_info_t(Structure):
    _fields_ = [("count", c_uint32), ("group_name", c_char * 256), ("field_ids", rdc_field_t * 128)]
...
rdc.rdc_group_gpu_create.argtypes = [
    rdc_handle_t,
    rdc_group_type_t,
    c_char_p,
    POINTER(rdc_gpu_group_t),
]
...
rdc.rdc_group_field_create.argtypes = [
    rdc_handle_t,
    c_uint32,
    POINTER(rdc_field_t),
    c_char_p,
    POINTER(rdc_field_grp_t),
]
rdc.rdc_group_field_get_info.restype = rdc_status_t
rdc.rdc_group_field_get_info.argtypes = [
    rdc_handle_t,
    rdc_field_grp_t,
    POINTER(rdc_field_group_info_t),
]
rdc.rdc_group_field_get_all_ids.restype = rdc_status_t
rdc.rdc_group_field_get_all_ids.argtypes = [
    rdc_handle_t,
    POINTER(rdc_field_grp_t),
    POINTER(c_uint32),
]
...
rdc.rdc_field_get_latest_value.argtypes = [
    rdc_handle_t,
    c_uint32,
    rdc_field_t,
    POINTER(rdc_field_value),
]
rdc.rdc_field_get_value_since.restype = rdc_status_t
rdc.rdc_field_get_value_since.argtypes = [
    rdc_handle_t,
    c_uint32,
    rdc_field_t,
    c_uint64,
