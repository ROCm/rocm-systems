...
"""
rocm-ai-analysis -- AI-powered GPU performance analysis for AMD ROCm.

This package provides AI-powered GPU performance analysis with optional
...
- JSON, text, markdown, and webview output formats
...
def __getattr__(name):
    ...
    raise AttributeError(f"module 'rocm_ai_analysis' has no attribute {name!r}")
