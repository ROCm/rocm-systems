...
"""
Public Python API for ROCm AI analysis.
...
Example:
    from rocm_ai_analysis import analyze_database
...
try:
    ...
    _ROCPD_VERSION = _pkg_version("rocm-ai-analysis")
except Exception:
...
def analyze_database(
    ...
    *,
    ...
    try:
        from .db import AnalysisConnection as RocpdImportData
        ...
        att_analysis: dict = {}
        if att_dir:
            from .analyze_engine import analyze_thread_trace
...
def analyze_source(
    ...
    *,
    ...
    Example:
        >>> from rocm_ai_analysis import analyze_source
        >>> from pathlib import Path
        >>>
