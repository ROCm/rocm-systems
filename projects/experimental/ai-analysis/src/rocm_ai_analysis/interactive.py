...
class InteractiveSession:
    ...
    def _run_tier1_analysis(self, db_path: str):
        ...
        """
        try:
            from .api import analyze_database
...
class WorkflowSession:
    ...
    def _post_revert_llm_analysis(
        ...
        try:
            from .llm_analyzer import LLMAnalyzer  # type: ignore[import]
    ...
    def _merge_per_process_dbs(self, db_files: List[str], out_dir: str) -> Optional[str]:
        ...
        try:
            from .merge import merge_sqlite_dbs  # type: ignore[import]
    ...
    def _phase4_analyze(self, db_path: str) -> _AnalysisSnapshot:
        ...
        try:
            from .api import analyze_database  # type: ignore[import]
