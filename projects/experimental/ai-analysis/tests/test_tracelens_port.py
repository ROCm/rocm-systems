...
class TestMergeIntervals:
    def test_empty(self):
        from rocm_ai_analysis.tracelens_port import _merge_intervals
...
class TestCategorizeKernelName:
    def test_gemm(self):
        from rocm_ai_analysis.tracelens_port import categorize_kernel_name
...
class TestSubtractIntervals:
    def test_empty_a(self):
        from rocm_ai_analysis.tracelens_port import _subtract_intervals
...
class TestComputeIntervalTimeline:
    def test_overlapping_kernels(self):
        ...
        from rocm_ai_analysis.tracelens_port import compute_interval_timeline
        ...
        memcpy_rows = []
        with patch("rocm_ai_analysis.tracelens_port.execute_statement") as mock_es:
            mock_es.side_effect = [
...
class TestAnalyzeKernelsByCategory:
    def test_basic(self):
        ...
        from rocm_ai_analysis.tracelens_port import analyze_kernels_by_category
...
class TestAnalyzeShortKernels:
    def test_basic(self):
        ...
        from rocm_ai_analysis.tracelens_port import analyze_short_kernels
...
def test_integration_tracelens_with_real_db():
    ...
    from rocm_ai_analysis.db import RocpdImportData
    from rocm_ai_analysis.tracelens_port import (
