...
def _make_minimal_result():
    ...
    from rocm_ai_analysis.api import (
        AnalysisResult,
        AnalysisMetadata,
        ProfilingInfo,
        AnalysisSummary,
...
class TestOutputFormat:
    def test_has_python_object(self):
        from rocm_ai_analysis.api import OutputFormat
...
class TestExceptions:
    def test_missing_data_error_optional_list(self):
        ...
        from rocm_ai_analysis.exceptions import MissingDataError
    ...
    def test_unsupported_gpu_error_optional_str(self):
        ...
        from rocm_ai_analysis.exceptions import UnsupportedGPUError
    ...
    def test_reference_guide_exported_from_init(self):
        ...
        from rocm_ai_analysis import ReferenceGuideNotFoundError
    ...
    def test_all_exceptions_exported(self):
        ...
        for name in [
            ...
            assert hasattr(m, name), f"{name} not exported from rocm_ai_analysis"
...
class TestValidateDatabase:
    def test_raises_for_missing_file(self):
        ...
        from rocm_ai_analysis import validate_database, DatabaseNotFoundError
...
class TestConvertResultToLlmFormat:
    def test_returns_real_kernel_data(self):
        ...
        from rocm_ai_analysis.api import _convert_result_to_llm_format
