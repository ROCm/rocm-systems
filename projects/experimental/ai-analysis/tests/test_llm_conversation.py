...
from rocm_ai_analysis.llm_conversation import LLMConversation
...
class TestInteractiveIntegration(unittest.TestCase):
    ...
    def _make_session(self, mock_conv=None):
        ...
        from rocm_ai_analysis.interactive import InteractiveSession, SessionStore
        import tempfile
    ...
    def test_post_rewrite_summary_appended_to_conv(self):
        ...
        import rocm_ai_analysis.interactive as imod

        with patch(
            "rocm_ai_analysis.llm_analyzer.LLMAnalyzer", return_value=mock_analyzer
        ):
