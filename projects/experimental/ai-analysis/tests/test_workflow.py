...
from rocm_ai_analysis.interactive import WorkflowState
...
def test_checkpoint_record_defaults():
    from rocm_ai_analysis.interactive import CheckpointRecord
...
def test_checkpoint_error_is_exception():
    from rocm_ai_analysis.interactive import CheckpointError
...
def test_edit_record_has_checkpoint_id():
    from rocm_ai_analysis.interactive import _EditRecord
...
def _make_gcm(repo_root="/repo", session_id="sess1"):
    from rocm_ai_analysis.interactive import GitCheckpointManager
...
def test_session_start_sets_repo_root_when_git_available():
    from rocm_ai_analysis.interactive import WorkflowSession
...
def test_init_checkpoints_disables_on_get_head_failure():
    from rocm_ai_analysis.interactive import WorkflowSession, CheckpointError
...
def _make_workflow_session_with_gcm(mock_gcm=None):
    ...
    from rocm_ai_analysis.interactive import WorkflowSession, GitCheckpointManager
...
def test_update_checkpoint_records_run_index():
    from rocm_ai_analysis.interactive import (
        CheckpointRecord,
        _AnalysisSnapshot,
        _TraceRun,
    )
...
def test_phase5_shows_rollback_option_when_checkpoints_exist():
    ws = _make_ws_with_checkpoints()
    from rocm_ai_analysis.interactive import _AnalysisSnapshot
...
def test_phase5_does_not_crash_when_no_checkpoints():
    from rocm_ai_analysis.interactive import WorkflowSession, _AnalysisSnapshot
