...
TEST_CASE("Unit_RTC_LinkerAPI_Negative", "[rtc][link]") {
...
TEST_CASE("Unit_RTC_LinkDestroy_Negative", "[rtc][link]") {
...
TEST_CASE("Unit_RTC_LinkDestroy_Default", "[rtc][link]") {
...
TEST_CASE("Unit_RTC_LinkerAPI", "[rtc][link]") {
...
TEST_CASE("Unit_RTC_LinkAddFile_Negative", "[rtc][link]") {
...
TEST_CASE("Unit_RTC_LinkAddFile_Default", "[rtc][link]") {
