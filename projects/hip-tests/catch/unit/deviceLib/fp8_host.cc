...
HIP_TEST_CASE(Unit_fp8_ocp_bool_host) {
  // clang-format off
...
HIP_TEST_CASE(Unit_all_fp8_ocp_vector_cvt) {
...
HIP_TEMPLATE_TEST_CASE(Unit_fp8_ocp_correctness, float, double) {
  SECTION("e4m3_ocp") {
...
HIP_TEST_CASE(Unit_fp8_ocp_vector_basic_conversions) {
  float f1 = 1.0f;
  float2 f2 = {1.0f, 2.0f};
...
HIP_TEST_CASE(Unit_fp8_fnuz_bool_host) {
  // clang-format off
  std::vector<float> fvals{-10.0f, -1.0f, -0.0f,  0.0f, 1.0f, 10.0f};
  std::vector<bool> tvals   {true,  true, false, false, true,  true};
  // clang-format on
...
// test to check we are putting in data correctly in vector types
HIP_TEST_CASE(Unit_all_fp8_fnuz_vector_cvt) {
  float2 in2{1.0f, 2.0f};
  float4 in4{3.0f, 4.0f, 5.0f, 6.0f};
...
HIP_TEMPLATE_TEST_CASE(Unit_fp8_fnuz_correctness, float, double) {
  SECTION("e4m3_fnuz") {
...
// Check the orientation encoded is correct
HIP_TEST_CASE(Unit_fp8_fnuz_vector_basic_conversions) {
  float f1 = 1.0f;
  float2 f2 = {1.0f, 2.0f};
  float4 f4 = {1.0f, 2.0f, 3.0f, 4.0f};
