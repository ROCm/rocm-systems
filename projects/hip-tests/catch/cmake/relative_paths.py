...
if len(sys.argv) > 1:
    ...
    print(f"******relative_paths.py:******************catch_tests build folder: {build_folder}")
    print(f"******relative_paths.py:******************catch_tests install folder: {install_folder}")
    #exit(1)
else:
...
#Ctesttest_files = glob.glob(build_folder + "/**/"+ctesttest_pattern, recursive=True)

#print("----inccmake_files:", inccmake_files)
#print("----Ctesttest_files:",Ctesttest_files)
make_test_files_portable(inccmake_files)
#make_test_files_portable(Ctesttest_files)
