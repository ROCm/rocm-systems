...
HIP_TEST_CASE(Contract_MemAdviseV2_HipMemAdviseV2_SetReadMostly_IsAcceptedOrUnsupported) {
...
HIP_TEST_CASE(Contract_MemAdviseV2_HipMemAdviseV2_SetAndUnsetPreferredLocation_IsAcceptedOrUnsupported) {
  SkipIfManagedMemoryUnsupported();
  hip::contract::ContractCleanup cleanup;
...
HIP_TEST_CASE(Contract_MemAdviseV2_HipMemPrefetchAsyncV2_PrefetchAsync_IsAcceptedOrUnsupported) {
  SkipIfManagedMemoryUnsupported();
  hip::contract::ContractCleanup cleanup;
