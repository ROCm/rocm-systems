...
HIP_TEST_CASE(Contract_GraphNodeAttributes_HipGraphKernelNodeSetAttribute_Cooperative_RoundTrips) {
...
HIP_TEST_CASE(Contract_GraphNodeAttributes_HipGraphKernelNodeSetAttribute_Default_RejectsInvalidInputs) {
  hip::contract::ContractCleanup cleanup;
  int value = kInitialValue;
  int* device_value = nullptr;
  hipGraph_t graph = nullptr;
