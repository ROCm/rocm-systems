...
HIP_TEST_CASE(Contract_GraphGenericNode_HipGraphAddNode_AddMemsetNode_LaunchesExpectedValue) {
...
HIP_TEST_CASE(Contract_GraphGenericNode_HipGraphNodeSetParams_Default_UpdatesValueBeforeInstantiate) {
  hip::contract::ContractCleanup cleanup;
  void* device_ptr = nullptr;
  hipGraph_t graph = nullptr;
  hipGraphNode_t node = nullptr;
...
HIP_TEST_CASE(Contract_GraphGenericNode_HipGraphExecNodeSetParams_Default_UpdatesValueAfterInstantiate) {
  hip::contract::ContractCleanup cleanup;
  void* device_ptr = nullptr;
  hipGraph_t graph = nullptr;
  hipGraphNode_t node = nullptr;
