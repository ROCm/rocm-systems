...
Although individual tests can be compiled with `hipcc`, you should use `amdclang++` because `hipcc` is deprecated.
...
Note: `standalone_main.cc` was previously used but has been removed.
