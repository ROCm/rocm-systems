...
Multiplication::Multiplication() {
  ...
  hipSynchronizationPolicy syncPolicy = hipSynchronizationPolicy::hipSyncPolicySpin;
...
void Multiplication::LaunchKernelForMultiplication(float *x, float *y, float *z, int N){
  float *d_x, *d_y, *d_z;
  ...
  CHECK_HIP_ERROR(hipLibraryLoadFromFile(&library, libFile.data(), nullptr, nullptr, 0, nullptr, nullptr, 0));
...
void Multiplication::getStream(hipStream_t &strm) {
  strm = stream;
}
