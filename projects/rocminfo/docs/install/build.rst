...
2. ``target.lst``: user-supplied text file, in the same folder as ``rocm_agent_enumerator``. This is used in a container setting where ROCm stack is usually not available.
