...
struct insert_statements
{
    ...
    using category_info_statement_func_t = statement_t<integer_primary_key_t,
                                                       std::string_view,
                                                       std::string_view>;

    // NEW in v4: rocpd_info_address_range table
    using address_range_info_statement_func_t = statement_t<integer_primary_key_t,
    ...
    using source_code_info_statement_func_t = statement_t<integer_primary_key_t,
                                                          integer_foreign_key_t,          // nid
                                                          integer_foreign_key_t,          // pid
    ...
    using pc_info_statement_func_t = statement_t<integer_primary_key_t,
                                                 integer_foreign_key_t,          // nid
                                                 integer_foreign_key_t,          // pid
...
public:
    ...
    [[nodiscard]] const address_range_info_statement_func_t& address_range_info_statement() const
    {
        return m_address_range_info_statement;
    }

    [[nodiscard]] const source_code_info_statement_func_t& source_code_info_statement() const
    {
...
private:
    ...
    void initialize_track_info_statement()
    {
        ...
        auto query = query_builder.set_table_name(fmt::format("rocpd_track_{}", m_uuid))
                         .set_columns("id", "nid", "ppid", "pid", "tid",
                                      "agent_id", "queue_id", "stream_id", "name_id", "extdata")
                         .set_values('?', '?', '?', '?', '?', '?', '?', '?', '?', '?')
                         .get_query_string();
    ...
    {
        rocpdsna::queries::insert::table_insert_query query_builder;
        auto query = query_builder.set_table_name(fmt::format("rocpd_timestamp_{}", m_uuid))
    ...
    {
        rocpdsna::queries::insert::table_insert_query query_builder;
        auto query = query_builder.set_table_name(fmt::format("rocpd_info_category_{}", m_uuid))
    ...
    {
        rocpdsna::queries::insert::table_insert_query query_builder;
        auto query = query_builder.set_table_name(fmt::format("rocpd_info_address_range_{}", m_uuid))
                         .set_columns("id", "nid", "pid", "address_base", "address_low", "address_high", "extdata")
                         .set_values('?', '?', '?', '?', '?', '?', '?')
                         .get_query_string();
    ...
    {
        rocpdsna::queries::insert::table_insert_query query_builder;
        auto query = query_builder.set_table_name(fmt::format("rocpd_info_source_code_{}", m_uuid))
                         .set_columns("id", "nid", "pid", "address_id", "file", "line_number", "lines", "instructions", "extdata")
                         .set_values('?', '?', '?', '?', '?', '?', '?', '?', '?')
                         .get_query_string();
    ...
    void initialize_pc_info_statement()
    {
        ...
        auto query = query_builder.set_table_name(fmt::format("rocpd_info_pc_{}", m_uuid))
                         .set_columns("id", "nid", "pid", "function", "address_id", "file", "line", "extdata")
                         .set_values('?', '?', '?', '?', '?', '?', '?', '?')
                         .get_query_string();
    ...
    {
        rocpdsna::queries::insert::table_insert_query query_builder;
        auto query = query_builder.set_table_name(fmt::format("rocpd_call_stack_{}", m_uuid))
    ...
    {
        rocpdsna::queries::insert::table_insert_query query_builder;
        auto query = query_builder.set_table_name(fmt::format("rocpd_line_info_{}", m_uuid))
    ...
    void initialize_sample_statement()
    {
        ...
        auto                                          query =
            query_builder.set_table_name(fmt::format("rocpd_sample_{}", m_uuid))
                .set_columns("id", "track_id", "name_id", "timestamp_id", "event_id", "extdata")
                .set_values('?', '?', '?', '?', '?', '?')
                .get_query_string();
