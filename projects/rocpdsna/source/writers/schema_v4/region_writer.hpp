...
public:
                     ...
                     const writer_types::trace_environment_t& trace_env)
    {
        ...
        const auto start_id = m_common_ops->insert_timestamp(data.start_timestamp, 0, track_pk);
        const auto end_id = m_common_ops->insert_timestamp(data.end_timestamp, 1, track_pk);
