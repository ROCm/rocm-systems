# Rocpdsna Architecture

![System Layer Overview](graphs/system_layers.png)

## Chapter 1: Public API Design

The rocpdsna public API consists of three classes -- storage_t, writer_t, and reader_t -- and four type namespaces -- storage_types, writer_types, reader_types, and shared_types. Together they form the only surface that users interact with. Everything behind these headers is hidden and must remain hidden.
