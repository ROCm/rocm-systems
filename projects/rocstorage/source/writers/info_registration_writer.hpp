...
class info_registration_writer;

template <>
class info_registration_writer<data_storage::schema_v3_tag>
: public api_writer_base<info_registration_writer<data_storage::schema_v3_tag>>
{
public:
        ...
        const writer_types::code_object_info_t& code_object_info)
    {
        ...
        LOG_TRACE("Registered code object info: {}",
                  rocstorage::to_string(code_object_info));
    }
    ...
    void register_string(const char* str) { m_common_ops->register_string(str); }
