...
public:
    ...
    void register_agent_info(const data_types::agent_info_t& agent_info);
...
private:
    primary_key_t insert_event(const data_types::event_data_t& event_data);
    void          insert_sample(const data_types::sample_data_t& sample_data,
                                const primary_key_t&             event_primary_key);
    void insert_arg(const data_types::arg_data_t& arg_data, primary_key_t event_id);
