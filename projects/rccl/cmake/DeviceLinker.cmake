...
add_custom_command(
  OUTPUT  ${DIRECT_A2A_ALL_REDUCE_FAT_OBJ}
  COMMAND ${DL_CLANG}
    -x hip ${DL_OFFLOAD_ARCH_FLAGS}
    ${DL_HIP_COMPILER_FLAGS}
    -DRCCL_DEVICE_LINKER
    ...
    -std=c++17
    -fPIC
    -c -o ${DIRECT_A2A_ALL_REDUCE_FAT_OBJ}
    ${HIPIFY_DIR}/src/algorithms/direct_a2a/all_reduce/direct_a2a_all_reduce.cu.cpp
  DEPENDS ${HIPIFY_DIR}/src/algorithms/direct_a2a/all_reduce/direct_a2a_all_reduce.cu.cpp
  COMMENT "DL compile: direct_a2a_all_reduce.cu.cpp (has device kernel)"
  VERBATIM
)
