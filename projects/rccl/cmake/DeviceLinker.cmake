...
set(DDA_ALL_REDUCE_FABRIC_LL128_WARPSYNC_FAT_OBJ "${DEVICE_BUILD_DIR}/dda_all_reduce_fabric_ll128_warpsync.o")
set(DDA_ALL_REDUCE_FABRIC_SIMPLE_WARPSYNC_FAT_OBJ "${DEVICE_BUILD_DIR}/dda_all_reduce_fabric_simple_warpsync.o")
...
add_custom_command(
  OUTPUT  ${DDA_ALL_REDUCE_FABRIC_LL128_WARPSYNC_FAT_OBJ}
  COMMAND ${DL_CLANG}
    -x hip ${DL_OFFLOAD_ARCH_FLAGS}
    ${DL_HIP_COMPILER_FLAGS}
    -DRCCL_DEVICE_LINKER
    ...
    -fPIC
    -w
    -c -o ${DDA_ALL_REDUCE_FABRIC_LL128_WARPSYNC_FAT_OBJ}
    ${HIPIFY_DIR}/src/dda_all_reduce_fabric_ll128_warpsync.cu.cpp
  DEPENDS ${HIPIFY_DIR}/src/dda_all_reduce_fabric_ll128_warpsync.cu.cpp
  COMMENT "DL compile: dda_all_reduce_fabric_ll128_warpsync.cu.cpp (has device kernels)"
  VERBATIM
)

add_custom_command(
  OUTPUT  ${DDA_ALL_REDUCE_FABRIC_SIMPLE_WARPSYNC_FAT_OBJ}
  COMMAND ${DL_CLANG}
    -x hip ${DL_OFFLOAD_ARCH_FLAGS}
    ${DL_HIP_COMPILER_FLAGS}
    -DRCCL_DEVICE_LINKER
    ...
    -fPIC
    -w
    -c -o ${DDA_ALL_REDUCE_FABRIC_SIMPLE_WARPSYNC_FAT_OBJ}
    ${HIPIFY_DIR}/src/dda_all_reduce_fabric_simple_warpsync.cu.cpp
  DEPENDS ${HIPIFY_DIR}/src/dda_all_reduce_fabric_simple_warpsync.cu.cpp
  COMMENT "DL compile: dda_all_reduce_fabric_simple_warpsync.cu.cpp (has device kernels)"
  VERBATIM
)
...
add_custom_target(device_linker_build ALL
  DEPENDS ${COMMON_FAT_OBJ} ${ONERANK_FAT_OBJ} ${COLLECTIVES_FAT_OBJ} ${DDA_ALL_REDUCE_IPC_FAT_OBJ} ${DDA_REDUCE_SCATTER_IPC_FAT_OBJ} ${DDA_ALL_GATHER_IPC_FAT_OBJ} ${DDA_ALLTOALL_IPC_FAT_OBJ} ${DDA_ALL_REDUCE_FABRIC_FAT_OBJ} ${DDA_ALL_REDUCE_FABRIC_LL_FAT_OBJ} ${DDA_ALL_REDUCE_FABRIC_LL128_FAT_OBJ} ${DDA_ALL_REDUCE_FABRIC_LL128_WARPSYNC_FAT_OBJ} ${DDA_ALL_REDUCE_FABRIC_SIMPLE_WARPSYNC_FAT_OBJ} ${DDA_REDUCE_SCATTER_FABRIC_FAT_OBJ} ${DDA_ALL_GATHER_FABRIC_FAT_OBJ} ${DDA_ALL_GATHER_FABRIC_LL_FAT_OBJ} ${DDA_ALL_GATHER_FABRIC_LL128_FAT_OBJ} ${DDA_ALLTOALL_FABRIC_FAT_OBJ} ${DDA_ALLTOALL_FABRIC_LL_FAT_OBJ} ${DDA_ALLTOALL_FABRIC_LL128_FAT_OBJ} ${DDA_REDUCE_SCATTER_FABRIC_LL_FAT_OBJ} ${DDA_REDUCE_SCATTER_FABRIC_LL128_FAT_OBJ} ${CE_REDUCE_FAT_OBJ} ${SYM_FAT_OBJS}
)
...
set(DEVICE_LINKER_OBJECTS
  ...
  ${DDA_ALL_REDUCE_FABRIC_LL128_WARPSYNC_FAT_OBJ}
  ${DDA_ALL_REDUCE_FABRIC_SIMPLE_WARPSYNC_FAT_OBJ}
