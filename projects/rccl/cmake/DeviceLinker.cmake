...
# Profile section anchor (ENABLE_DEVICE_COVERAGE).
#
...
"/* Auto-generated by cmake/DeviceLinker.cmake for ENABLE_DEVICE_COVERAGE.\n"
...
set(RCCL_DEVICE_PROFILE_ANCHOR "${DL_DEVICE_PROFILE_ANCHOR}"
  CACHE INTERNAL "amdgcn profile section anchor bitcode for coverage")
...
add_custom_target(device_linker_build ALL
  DEPENDS ${COMMON_FAT_OBJ} ${ONERANK_FAT_OBJ} ${COLLECTIVES_FAT_OBJ} ${DDA_ALL_REDUCE_IPC_FAT_OBJ} ${DDA_REDUCE_SCATTER_IPC_FAT_OBJ} ${DDA_ALL_GATHER_IPC_FAT_OBJ} ${DDA_ALLTOALL_IPC_FAT_OBJ} ${DDA_ALL_REDUCE_FABRIC_FAT_OBJ} ${DDA_REDUCE_SCATTER_FABRIC_FAT_OBJ} ${DDA_ALL_GATHER_FABRIC_FAT_OBJ} ${DDA_ALLTOALL_FABRIC_FAT_OBJ} ${SYM_FAT_OBJS} ${DEVICE_ELF_SYMLINKS}
)
