...
set(DDA_FABRIC_GPU_BARRIER_FAT_OBJ "${DEVICE_BUILD_DIR}/fabric_gpu_barrier.o")
...
add_custom_command(
  OUTPUT  ${DDA_FABRIC_GPU_BARRIER_FAT_OBJ}
  COMMAND ${DL_CLANG}
    -x hip ${DL_OFFLOAD_ARCH_FLAGS}
    ${DL_HIP_COMPILER_FLAGS}
    -DRCCL_DEVICE_LINKER
    ...
    -std=c++17
    -fPIC
    -c -o ${DDA_FABRIC_GPU_BARRIER_FAT_OBJ}
    ${HIPIFY_DIR}/src/algorithms/dda/fabric/fabric_gpu_barrier.cu.cpp
  DEPENDS ${HIPIFY_DIR}/src/algorithms/dda/fabric/fabric_gpu_barrier.cu.cpp
  COMMENT "DL compile: fabric_gpu_barrier.cu.cpp (has device kernels)"
  VERBATIM
)
...
add_custom_target(device_linker_build ALL
  DEPENDS ${COMMON_FAT_OBJ} ${ONERANK_FAT_OBJ} ${COLLECTIVES_FAT_OBJ} ${DDA_ALL_REDUCE_IPC_FAT_OBJ} ${DDA_REDUCE_SCATTER_IPC_FAT_OBJ} ${DDA_ALL_GATHER_IPC_FAT_OBJ} ${DDA_ALLTOALL_IPC_FAT_OBJ} ${DDA_FABRIC_GPU_BARRIER_FAT_OBJ} ${DDA_ALL_REDUCE_FABRIC_FAT_OBJ} ${DDA_ALL_REDUCE_FABRIC_LL_FAT_OBJ} ${DDA_ALL_REDUCE_FABRIC_LL128_FAT_OBJ} ${DDA_REDUCE_SCATTER_FABRIC_FAT_OBJ} ${DDA_ALL_GATHER_FABRIC_FAT_OBJ} ${DDA_ALL_GATHER_FABRIC_LL_FAT_OBJ} ${DDA_ALL_GATHER_FABRIC_LL128_FAT_OBJ} ${DDA_ALLTOALL_FABRIC_FAT_OBJ} ${DDA_ALLTOALL_FABRIC_LL_FAT_OBJ} ${DDA_ALLTOALL_FABRIC_LL128_FAT_OBJ} ${DDA_REDUCE_SCATTER_FABRIC_LL_FAT_OBJ} ${DDA_REDUCE_SCATTER_FABRIC_LL128_FAT_OBJ} ${CE_REDUCE_FAT_OBJS} ${SYM_FAT_OBJS} ${GIN_ALLTOALL_SDMA_FAT_OBJ} ${GIN_ALLREDUCE_SDMA_FAT_OBJ}
)
...
set(DEVICE_LINKER_OBJECTS
  ...
  ${DDA_FABRIC_GPU_BARRIER_FAT_OBJ}
