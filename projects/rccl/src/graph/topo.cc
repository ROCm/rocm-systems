...
// [RCCL] Hoisted out of the #else (NVL-only) branch since ncclTopoAddC2c references it
// unconditionally further below. Body is generic XML traversal, no NVL deps.
