...
# TODO: follow-up PR to arch-guard 1/2/4 by which target actually dispatches them
# (gfx950 uses 1/2, gfx908 and gfx942 >80 CU use 2, everything else uses 4).
default_unrolls = ["1", "2", "4", "32"]
# Only gfx1250 dispatches unroll 32; the arch guard keeps the multi-arch build
# from compiling these kernels for every other target.
gfx1250_unrolls = ["32"]
