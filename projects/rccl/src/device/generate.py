...
# Unrolls generated by a multi-arch build: 8/16 are gfx1250 tuning-only, dispatched by no arch.
default_unrolls = ["1", "2", "4", "32"]
# Unrolls only gfx1250 dispatches; their kernels are arch-guarded.
gfx1250_unrolls = ["8", "16", "32"]
