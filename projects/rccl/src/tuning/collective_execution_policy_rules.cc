...
constexpr RuleSpec kCollectiveExecutionRules[] = {
  ...
  {{P2P, "gfx120", ncclFuncSend, {0, (16ULL << 20) - 1}, EQ(1), EQ(8),
    kAnyInt, IPC, ANY_BOOL},
   {AUTO, KEEP, AUTO, AUTO_PATH, AUTO_XFER}, EFFICIENCY(17.22, kGfx120xPeakBusBwGBps)},
  ...
  {{P2P, "gfx1201", GATHER, {1ULL << 20, 8ULL << 30}, EQ(1), EQ(8),
    kAnyInt, SHM, BOOL_FALSE},
   {CHANNELS(32), KEEP, AUTO, SENDRECV, AUTO_XFER}, EFFICIENCY(49.79, kGfx120xPeakBusBwGBps)},
  {{P2P, "gfx1201", GATHER, {1536ULL << 10, 8ULL << 30}, EQ(1), EQ(8),
    kAnyInt, SHM, BOOL_TRUE},
   {CHANNELS(32), KEEP, AUTO, SENDRECV, AUTO_XFER}, EFFICIENCY(49.70, kGfx120xPeakBusBwGBps)},
  ...
  {{P2P, "gfx1201", SCATTER, {64ULL << 10, (768ULL << 10) - 1}, EQ(1), EQ(8),
    kAnyInt, SHM, ANY_BOOL},
   {CHANNELS(32), KEEP, AUTO, SENDRECV, AUTO_XFER}, EFFICIENCY(15.10, kGfx120xPeakBusBwGBps)},
  {{P2P, "gfx1201", SCATTER, {24ULL << 20, 8ULL << 30}, EQ(1), EQ(8),
    kAnyInt, SHM, ANY_BOOL},
   {CHANNELS(32), KEEP, AUTO, SENDRECV, AUTO_XFER}, EFFICIENCY(56.80, kGfx120xPeakBusBwGBps)},

  {{P2P, "gfx1201", ALL_TO_ALL, {48ULL << 10, (128ULL << 10) - 1}, EQ(1), EQ(8),
    kAnyInt, SHM, BOOL_FALSE},
   {CHANNELS(32), KEEP, AUTO, SENDRECV, AUTO_XFER}, EFFICIENCY(1.08, kGfx120xPeakBusBwGBps)},
  {{P2P, "gfx1201", ALL_TO_ALL, {128ULL << 10, (768ULL << 10) - 1}, EQ(1), EQ(8),
    kAnyInt, SHM, BOOL_FALSE},
   {CHANNELS(32), KEEP, AUTO, SENDRECV, AUTO_XFER}, EFFICIENCY(8.29, kGfx120xPeakBusBwGBps)},
  {{P2P, "gfx1201", ALL_TO_ALL, {48ULL << 10, (128ULL << 10) - 1}, EQ(1), EQ(8),
    kAnyInt, SHM, BOOL_TRUE},
   {CHANNELS(32), KEEP, AUTO, SENDRECV, AUTO_XFER}, EFFICIENCY(1.09, kGfx120xPeakBusBwGBps)},
  {{P2P, "gfx1201", ALL_TO_ALL, {128ULL << 10, (768ULL << 10) - 1}, EQ(1), EQ(8),
    kAnyInt, SHM, BOOL_TRUE},
   {CHANNELS(32), KEEP, AUTO, SENDRECV, AUTO_XFER}, EFFICIENCY(8.42, kGfx120xPeakBusBwGBps)},
  {{P2P, "gfx1201", ALL_TO_ALL, {6ULL << 20, (96ULL << 20) - 1}, EQ(1), EQ(8),
    kAnyInt, SHM, BOOL_FALSE},
   {CHANNELS(32), KEEP, AUTO, SENDRECV, AUTO_XFER}, EFFICIENCY(20.15, kGfx120xPeakBusBwGBps)},
  {{P2P, "gfx1201", ALL_TO_ALL, {12ULL << 20, (96ULL << 20) - 1}, EQ(1), EQ(8),
    kAnyInt, SHM, BOOL_TRUE},
   {CHANNELS(32), KEEP, AUTO, SENDRECV, AUTO_XFER}, EFFICIENCY(20.04, kGfx120xPeakBusBwGBps)},
  {{P2P, "gfx1201", ALL_TO_ALL, {384ULL << 20, (512ULL << 20) - 1}, EQ(1), EQ(8),
    kAnyInt, SHM, BOOL_FALSE},
   {CHANNELS(32), KEEP, AUTO, SENDRECV, AUTO_XFER}, UNMEASURED},
  {{P2P, "gfx1201", ALL_TO_ALL, {512ULL << 20, 8ULL << 30}, EQ(1), EQ(8),
    kAnyInt, SHM, BOOL_FALSE},
   {CHANNELS(32), KEEP, AUTO, SENDRECV, AUTO_XFER}, EFFICIENCY(19.28, kGfx120xPeakBusBwGBps)},
  ...
  {{P2P, "gfx120", ALL_TO_ALL, {512ULL << 20, 8ULL << 30}, EQ(1), EQ(8),
   ...
   {CHANNELS(1), KEEP, AUTO, SENDRECV, WRITE}, EFFICIENCY(17.92, kGfx120xPeakBusBwGBps)},
  ...
  {{P2P, "gfx120", ALL_TO_ALL, {128ULL << 10, (768ULL << 10) - 1}, EQ(1), EQ(8),
    kAnyInt, IPC, BOOL_FALSE},
   {CHANNELS(2), KEEP, AUTO, SENDRECV, AUTO_XFER}, EFFICIENCY(5.56, kGfx120xPeakBusBwGBps)},
  ...
  {{P2P, "gfx120", ALL_TO_ALL, {128ULL << 10, (768ULL << 10) - 1}, EQ(1), EQ(8),
   ...
   {CHANNELS(2), KEEP, AUTO, SENDRECV, AUTO_XFER}, EFFICIENCY(5.69, kGfx120xPeakBusBwGBps)},
  {{P2P, "gfx120", ALL_TO_ALL, {768ULL << 10, (1ULL << 20) - 1}, EQ(1), EQ(8),
    kAnyInt, IPC, BOOL_TRUE},
   {CHANNELS(2), KEEP, AUTO, SENDRECV, AUTO_XFER}, UNMEASURED},
  {{P2P, "gfx120", SCATTER, {64ULL << 10, (768ULL << 10) - 1}, EQ(1), EQ(8),
    kAnyInt, IPC, ANY_BOOL},
   {CHANNELS(2), KEEP, AUTO, SENDRECV, AUTO_XFER}, EFFICIENCY(8.84, kGfx120xPeakBusBwGBps)},
  ...
  {{P2P, "gfx120", ALL_TO_ALL, {1ULL << 20, 4ULL << 20}, EQ(1), EQ(8),
    kAnyInt, IPC, BOOL_FALSE},
   {CHANNELS(8), KEEP, SIMPLE, SENDRECV, READ}, EFFICIENCY(16.39, kGfx120xPeakBusBwGBps)},
  {{P2P, "gfx120", ALL_TO_ALL, {1ULL << 20, 4ULL << 20}, EQ(1), EQ(8),
    kAnyInt, IPC, BOOL_TRUE},
   {CHANNELS(8), KEEP, SIMPLE, SENDRECV, READ}, EFFICIENCY(16.32, kGfx120xPeakBusBwGBps)},
  ...
  {{P2P, "gfx120", ALL_TO_ALL_V, kAnyBytes, EQ(1), EQ(8),
    kAnyInt, IPC, ANY_BOOL},
   {CHANNELS(8), KEEP, SIMPLE, SENDRECV, READ}, EFFICIENCY(16.97, kGfx120xPeakBusBwGBps)},
  {{P2P, "gfx120", SCATTER, {1ULL << 20, (24ULL << 20) - 1}, EQ(1), EQ(8),
    kAnyInt, IPC, ANY_BOOL},
   {CHANNELS(8), KEEP, SIMPLE, SENDRECV, READ}, EFFICIENCY(51.62, kGfx120xPeakBusBwGBps)},
  {{P2P, "gfx120", SCATTER, {24ULL << 20, 8ULL << 30}, EQ(1), EQ(8),
    kAnyInt, IPC, ANY_BOOL},
   {CHANNELS(8), KEEP, SIMPLE, SENDRECV, READ}, EFFICIENCY(52.41, kGfx120xPeakBusBwGBps)},
  ...
  // Arithmetic midpoints provide smooth handoffs between measured sizes. The
  // September 24 20-iteration resweep added Reduce at 16 MiB and AllReduce at
  // 32-64 MiB.
  {{COLL, "gfx1201", REDUCE, {16ULL << 20, (1536ULL << 20) - 1}, EQ(1), EQ(8),
    kAnyInt, SHM, ANY_BOOL},
   {CHANNELS(24), RING, SIMPLE, AUTO_PATH, KEEP}, EFFICIENCY(24.31, kGfx120xPeakBusBwGBps)},
  {{COLL, "gfx1201", ALL_REDUCE, {24ULL << 20, (96ULL << 20) - 1}, EQ(1), EQ(8),
    kAnyInt, SHM, ANY_BOOL},
   {CHANNELS(24), RING, SIMPLE, AUTO_PATH, KEEP}, EFFICIENCY(22.84, kGfx120xPeakBusBwGBps)},
  // AllGather and ReduceScatter have no stable SHM-winning crossover.
  // Broadcast also remains IPC below 16 MiB; these intentionally fall through
  // to their IPC profiles.
  ...
  {{COLL, "gfx120", ALL_GATHER, {128, (16ULL << 10) - 1}, EQ(1), EQ(8),
    kAnyInt, IPC, ANY_BOOL},
   {AUTO, RING, LL, AUTO_PATH, KEEP}, EFFICIENCY(0.36, kGfx120xPeakBusBwGBps)},
  {{COLL, "gfx120", ALL_GATHER, {16ULL << 10, (32ULL << 10) - 1}, EQ(1), EQ(8),
    kAnyInt, IPC, ANY_BOOL},
   {AUTO, RING, AUTO, AUTO_PATH, KEEP}, EFFICIENCY(0.69, kGfx120xPeakBusBwGBps)},
  {{COLL, "gfx120", ALL_GATHER, {32ULL << 10, (256ULL << 10) - 1}, EQ(1), EQ(8),
    kAnyInt, IPC, ANY_BOOL},
   {AUTO, RING, SIMPLE, AUTO_PATH, KEEP}, EFFICIENCY(3.39, kGfx120xPeakBusBwGBps)},
  {{COLL, "gfx120", ALL_GATHER, {256ULL << 10, (1ULL << 20) - 1}, EQ(1), EQ(8),
    kAnyInt, IPC, ANY_BOOL},
   {AUTO, RING, SIMPLE, AUTO_PATH, KEEP}, EFFICIENCY(9.24, kGfx120xPeakBusBwGBps)},
  {{COLL, "gfx120", ALL_GATHER, {1ULL << 20, (16ULL << 20) - 1}, EQ(1), EQ(8),
    kAnyInt, IPC, ANY_BOOL},
   {AUTO, RING, SIMPLE, AUTO_PATH, KEEP}, EFFICIENCY(19.67, kGfx120xPeakBusBwGBps)},
  {{COLL, "gfx120", ALL_GATHER, {16ULL << 20, 8ULL << 30}, EQ(1), EQ(8),
    kAnyInt, IPC, ANY_BOOL},
   {AUTO, RING, SIMPLE, AUTO_PATH, KEEP}, EFFICIENCY(22.37, kGfx120xPeakBusBwGBps)},

  {{COLL, "gfx120", ALL_REDUCE, {128, (64ULL << 10) - 1}, EQ(1), EQ(8),
    kAnyInt, IPC, ANY_BOOL},
   {AUTO, RING, LL, AUTO_PATH, KEEP}, EFFICIENCY(1.55, kGfx120xPeakBusBwGBps)},
  {{COLL, "gfx120", ALL_REDUCE, {64ULL << 10, (256ULL << 10) - 1}, EQ(1), EQ(8),
    kAnyInt, IPC, ANY_BOOL},
   {AUTO, RING, SIMPLE, AUTO_PATH, KEEP}, EFFICIENCY(4.29, kGfx120xPeakBusBwGBps)},
  {{COLL, "gfx120", ALL_REDUCE, {256ULL << 10, (1ULL << 20) - 1}, EQ(1), EQ(8),
    kAnyInt, IPC, ANY_BOOL},
   {AUTO, RING, SIMPLE, AUTO_PATH, KEEP}, EFFICIENCY(11.08, kGfx120xPeakBusBwGBps)},
  {{COLL, "gfx120", ALL_REDUCE, {1ULL << 20, (16ULL << 20) - 1}, EQ(1), EQ(8),
    kAnyInt, IPC, ANY_BOOL},
   {AUTO, RING, SIMPLE, AUTO_PATH, KEEP}, EFFICIENCY(19.57, kGfx120xPeakBusBwGBps)},
  {{COLL, "gfx120", ALL_REDUCE, {16ULL << 20, (24ULL << 20) - 1}, EQ(1), EQ(8),
    kAnyInt, IPC, ANY_BOOL},
   {AUTO, RING, SIMPLE, AUTO_PATH, KEEP}, EFFICIENCY(20.57, kGfx120xPeakBusBwGBps)},
  {{COLL, "gfx120", ALL_REDUCE, {24ULL << 20, (96ULL << 20) - 1}, EQ(1), EQ(8),
    kAnyInt, IPC, ANY_BOOL},
   {AUTO, RING, SIMPLE, AUTO_PATH, KEEP}, EFFICIENCY(21.76, kGfx120xPeakBusBwGBps)},
  {{COLL, "gfx120", ALL_REDUCE, {96ULL << 20, 8ULL << 30}, EQ(1), EQ(8),
    kAnyInt, IPC, ANY_BOOL},
   {AUTO, RING, SIMPLE, AUTO_PATH, KEEP}, EFFICIENCY(22.42, kGfx120xPeakBusBwGBps)},

  {{COLL, "gfx120", BROADCAST, {128, (64ULL << 10) - 1}, EQ(1), EQ(8),
    kAnyInt, IPC, ANY_BOOL},
   {AUTO, RING, SIMPLE, AUTO_PATH, KEEP}, EFFICIENCY(2.42, kGfx120xPeakBusBwGBps)},
  {{COLL, "gfx120", BROADCAST, {64ULL << 10, (256ULL << 10) - 1}, EQ(1), EQ(8),
    kAnyInt, IPC, ANY_BOOL},
   {CHANNELS(1), RING, SIMPLE, AUTO_PATH, KEEP}, EFFICIENCY(6.71, kGfx120xPeakBusBwGBps)},
  {{COLL, "gfx120", BROADCAST, {256ULL << 10, (512ULL << 10) - 1}, EQ(1), EQ(8),
    kAnyInt, IPC, ANY_BOOL},
   {CHANNELS(1), RING, SIMPLE, AUTO_PATH, KEEP}, EFFICIENCY(9.50, kGfx120xPeakBusBwGBps)},
  {{COLL, "gfx120", BROADCAST, {512ULL << 10, (1ULL << 20) - 1}, EQ(1), EQ(8),
    kAnyInt, IPC, ANY_BOOL},
   {AUTO, RING, SIMPLE, AUTO_PATH, KEEP}, EFFICIENCY(16.74, kGfx120xPeakBusBwGBps)},
  {{COLL, "gfx120", BROADCAST, {1ULL << 20, 8ULL << 30}, EQ(1), EQ(8),
    kAnyInt, IPC, ANY_BOOL},
   {AUTO, RING, SIMPLE, AUTO_PATH, KEEP}, EFFICIENCY(23.26, kGfx120xPeakBusBwGBps)},

  {{COLL, "gfx120", REDUCE, {128, (64ULL << 10) - 1}, EQ(1), EQ(8),
    kAnyInt, IPC, ANY_BOOL},
   {AUTO, RING, SIMPLE, AUTO_PATH, KEEP}, EFFICIENCY(2.41, kGfx120xPeakBusBwGBps)},
  {{COLL, "gfx120", REDUCE, {64ULL << 10, (256ULL << 10) - 1}, EQ(1), EQ(8),
    kAnyInt, IPC, ANY_BOOL},
   {CHANNELS(1), RING, SIMPLE, AUTO_PATH, KEEP}, EFFICIENCY(6.56, kGfx120xPeakBusBwGBps)},
  {{COLL, "gfx120", REDUCE, {256ULL << 10, (512ULL << 10) - 1}, EQ(1), EQ(8),
    kAnyInt, IPC, ANY_BOOL},
   {CHANNELS(1), RING, SIMPLE, AUTO_PATH, KEEP}, EFFICIENCY(8.97, kGfx120xPeakBusBwGBps)},
  {{COLL, "gfx120", REDUCE, {512ULL << 10, (1ULL << 20) - 1}, EQ(1), EQ(8),
    kAnyInt, IPC, ANY_BOOL},
   {AUTO, RING, SIMPLE, AUTO_PATH, KEEP}, EFFICIENCY(15.40, kGfx120xPeakBusBwGBps)},
  {{COLL, "gfx120", REDUCE, {1ULL << 20, (16ULL << 20) - 1}, EQ(1), EQ(8),
    kAnyInt, IPC, ANY_BOOL},
   {AUTO, RING, SIMPLE, AUTO_PATH, KEEP}, EFFICIENCY(20.98, kGfx120xPeakBusBwGBps)},
  {{COLL, "gfx120", REDUCE, {16ULL << 20, (1536ULL << 20) - 1}, EQ(1), EQ(8),
    kAnyInt, IPC, ANY_BOOL},
   {AUTO, RING, SIMPLE, AUTO_PATH, KEEP}, EFFICIENCY(22.63, kGfx120xPeakBusBwGBps)},
  {{COLL, "gfx120", REDUCE, {1536ULL << 20, 8ULL << 30}, EQ(1), EQ(8),
    kAnyInt, IPC, ANY_BOOL},
   {AUTO, RING, SIMPLE, AUTO_PATH, KEEP}, EFFICIENCY(22.34, kGfx120xPeakBusBwGBps)},

  {{COLL, "gfx120", REDUCE_SCATTER, {128, (8ULL << 10) - 1}, EQ(1), EQ(8),
    kAnyInt, IPC, ANY_BOOL},
   {AUTO, RING, LL, AUTO_PATH, KEEP}, EFFICIENCY(0.19, kGfx120xPeakBusBwGBps)},
  {{COLL, "gfx120", REDUCE_SCATTER, {8ULL << 10, (32ULL << 10) - 1}, EQ(1), EQ(8),
    kAnyInt, IPC, ANY_BOOL},
   {AUTO, RING, AUTO, AUTO_PATH, KEEP}, EFFICIENCY(0.70, kGfx120xPeakBusBwGBps)},
  {{COLL, "gfx120", REDUCE_SCATTER, {32ULL << 10, (256ULL << 10) - 1}, EQ(1), EQ(8),
    kAnyInt, IPC, ANY_BOOL},
   {AUTO, RING, SIMPLE, AUTO_PATH, KEEP}, EFFICIENCY(3.70, kGfx120xPeakBusBwGBps)},
  {{COLL, "gfx120", REDUCE_SCATTER, {256ULL << 10, (1ULL << 20) - 1}, EQ(1), EQ(8),
    kAnyInt, IPC, ANY_BOOL},
   {AUTO, RING, SIMPLE, AUTO_PATH, KEEP}, EFFICIENCY(9.54, kGfx120xPeakBusBwGBps)},
  {{COLL, "gfx120", REDUCE_SCATTER, {1ULL << 20, (16ULL << 20) - 1}, EQ(1), EQ(8),
    kAnyInt, IPC, ANY_BOOL},
   {AUTO, RING, SIMPLE, AUTO_PATH, KEEP}, EFFICIENCY(19.21, kGfx120xPeakBusBwGBps)},
  {{COLL, "gfx120", REDUCE_SCATTER, {16ULL << 20, (2ULL << 30) - 1}, EQ(1), EQ(8),
    kAnyInt, IPC, ANY_BOOL},
   {AUTO, RING, SIMPLE, AUTO_PATH, KEEP}, EFFICIENCY(22.17, kGfx120xPeakBusBwGBps)},
  {{COLL, "gfx120", REDUCE_SCATTER, {2ULL << 30, (8ULL << 30) - 1}, EQ(1), EQ(8),
    kAnyInt, IPC, ANY_BOOL},
   {CHANNELS(6), RING, SIMPLE, AUTO_PATH, KEEP}, EFFICIENCY(22.17, kGfx120xPeakBusBwGBps)},
  {{COLL, "gfx120", REDUCE_SCATTER, {8ULL << 30, 8ULL << 30}, EQ(1), EQ(8),
    kAnyInt, IPC, ANY_BOOL},
   {AUTO, RING, SIMPLE, AUTO_PATH, KEEP}, EFFICIENCY(22.33, kGfx120xPeakBusBwGBps)},

  {{P2P, "gfx120", ALL_TO_ALL, {1ULL << 20, 4ULL << 20}, EQ(1), GE(3),
    GE(3), IPC, BOOL_FALSE},
   {CHANNELS(2), KEEP, SIMPLE, SENDRECV, WRITE}, UNMEASURED},
  {{P2P, "gfx120", ALL_TO_ALL, {4194305, (6ULL << 20) - 1}, EQ(1), GE(3),
    GE(3), IPC, BOOL_FALSE},
   {CHANNELS(2), KEEP, SIMPLE, SENDRECV, WRITE}, UNMEASURED},
  {{P2P, "gfx120", ALL_TO_ALL, {6ULL << 20, (96ULL << 20) - 1}, EQ(1), GE(3),
    GE(3), IPC, BOOL_FALSE},
   {CHANNELS(2), KEEP, SIMPLE, SENDRECV, WRITE}, EFFICIENCY(19.15, kGfx120xPeakBusBwGBps)},
  ...
  {{P2P, "gfx120", ALL_TO_ALL, {4194305, (12ULL << 20) - 1}, EQ(1), GE(3),
    GE(3), IPC, BOOL_TRUE},
   {CHANNELS(2), KEEP, SIMPLE, SENDRECV, WRITE}, EFFICIENCY(17.17, kGfx120xPeakBusBwGBps)},
  {{P2P, "gfx120", ALL_TO_ALL, {12ULL << 20, (96ULL << 20) - 1}, EQ(1), GE(3),
    GE(3), IPC, BOOL_TRUE},
   {CHANNELS(2), KEEP, SIMPLE, SENDRECV, WRITE}, EFFICIENCY(18.67, kGfx120xPeakBusBwGBps)},
  {{P2P, "gfx120", ALL_TO_ALL, {96ULL << 20, SIZE_MAX}, EQ(1), GE(3),
    GE(3), IPC, BOOL_TRUE},
   {CHANNELS(2), KEEP, SIMPLE, SENDRECV, WRITE}, EFFICIENCY(20.11, kGfx120xPeakBusBwGBps)},
  {{P2P, "gfx120", ALL_GATHER, {1ULL << 20, SIZE_MAX}, EQ(1), GE(3),
    GE(3), IPC, ANY_BOOL},
   {CHANNELS(2), KEEP, SIMPLE, SENDRECV, WRITE}, EFFICIENCY(22.37, kGfx120xPeakBusBwGBps)},
  {{P2P, "gfx120", REDUCE_SCATTER, {1ULL << 20, SIZE_MAX}, EQ(1), GE(3),
    GE(3), IPC, ANY_BOOL},
   {CHANNELS(2), KEEP, SIMPLE, SENDRECV, WRITE}, EFFICIENCY(22.33, kGfx120xPeakBusBwGBps)},
  {{P2P, "gfx120", GATHER, {1ULL << 20, 8ULL << 30}, EQ(1), GE(3),
    GE(3), IPC, BOOL_FALSE},
   {CHANNELS(2), KEEP, SIMPLE, SENDRECV, WRITE}, EFFICIENCY(44.99, kGfx120xPeakBusBwGBps)},
  {{P2P, "gfx120", GATHER, {8589934593, SIZE_MAX}, EQ(1), GE(3),
    GE(3), IPC, BOOL_FALSE},
   {CHANNELS(2), KEEP, SIMPLE, SENDRECV, WRITE}, UNMEASURED},
  {{P2P, "gfx120", GATHER, {1ULL << 20, (1536ULL << 10) - 1}, EQ(1), GE(3),
    GE(3), IPC, BOOL_TRUE},
   {CHANNELS(2), KEEP, SIMPLE, SENDRECV, WRITE}, EFFICIENCY(31.06, kGfx120xPeakBusBwGBps)},
  {{P2P, "gfx120", GATHER, {1536ULL << 10, 8ULL << 30}, EQ(1), GE(3),
    GE(3), IPC, BOOL_TRUE},
   {CHANNELS(2), KEEP, SIMPLE, SENDRECV, WRITE}, EFFICIENCY(45.56, kGfx120xPeakBusBwGBps)},
  {{P2P, "gfx120", GATHER, {8589934593, SIZE_MAX}, EQ(1), GE(3),
    GE(3), IPC, BOOL_TRUE},
   {CHANNELS(2), KEEP, SIMPLE, SENDRECV, WRITE}, UNMEASURED},
  {{P2P, "gfx120", SCATTER, {1ULL << 20, (24ULL << 20) - 1}, EQ(1), GE(3),
    GE(3), IPC, ANY_BOOL},
   {CHANNELS(2), KEEP, SIMPLE, SENDRECV, WRITE}, UNMEASURED},
  {{P2P, "gfx120", SCATTER, {24ULL << 20, 8ULL << 30}, EQ(1), GE(3),
    GE(3), IPC, ANY_BOOL},
   {CHANNELS(2), KEEP, SIMPLE, SENDRECV, WRITE}, UNMEASURED},
  ...
  {{COLL, "gfx1201", ALL_REDUCE, {128, (64ULL << 10) - 1}, EQ(1), EQ(8),
    kAnyInt, SHM, ANY_BOOL},
   {CHANNELS(1), RING, SIMPLE, AUTO_PATH, KEEP}, EFFICIENCY(0.88, kGfx120xPeakBusBwGBps)},
  {{COLL, "gfx1201", ALL_REDUCE, {64ULL << 10, (256ULL << 10) - 1}, EQ(1), EQ(8),
    kAnyInt, SHM, ANY_BOOL},
   {CHANNELS(1), RING, SIMPLE, AUTO_PATH, KEEP}, EFFICIENCY(2.74, kGfx120xPeakBusBwGBps)},
  {{COLL, "gfx1201", ALL_REDUCE, {256ULL << 10, (1ULL << 20) - 1}, EQ(1), EQ(8),
    kAnyInt, SHM, ANY_BOOL},
   {CHANNELS(4), RING, SIMPLE, AUTO_PATH, KEEP}, EFFICIENCY(7.77, kGfx120xPeakBusBwGBps)},
  {{COLL, "gfx1201", ALL_REDUCE, {1ULL << 20, (16ULL << 20) - 1}, EQ(1), EQ(8),
    kAnyInt, SHM, ANY_BOOL},
   {CHANNELS(12), RING, SIMPLE, AUTO_PATH, KEEP}, EFFICIENCY(18.36, kGfx120xPeakBusBwGBps)},
  {{COLL, "gfx1201", ALL_REDUCE, {16ULL << 20, (24ULL << 20) - 1}, EQ(1), EQ(8),
    kAnyInt, SHM, ANY_BOOL},
   {CHANNELS(24), RING, SIMPLE, AUTO_PATH, KEEP}, EFFICIENCY(20.94, kGfx120xPeakBusBwGBps)},
  {{COLL, "gfx1201", ALL_REDUCE, {24ULL << 20, (96ULL << 20) - 1}, EQ(1), EQ(8),
    kAnyInt, SHM, ANY_BOOL},
   {CHANNELS(24), RING, SIMPLE, AUTO_PATH, KEEP}, UNMEASURED},
  {{COLL, "gfx1201", ALL_REDUCE, {96ULL << 20, 8ULL << 30}, EQ(1), EQ(8),
    kAnyInt, SHM, ANY_BOOL},
  ...
  {{COLL, "gfx1201", ALL_GATHER, {128, (16ULL << 10) - 1}, EQ(1), EQ(8),
    kAnyInt, SHM, ANY_BOOL},
   {CHANNELS(1), RING, SIMPLE, AUTO_PATH, KEEP}, EFFICIENCY(0.18, kGfx120xPeakBusBwGBps)},
  {{COLL, "gfx1201", ALL_GATHER, {16ULL << 10, (32ULL << 10) - 1}, EQ(1), EQ(8),
    kAnyInt, SHM, ANY_BOOL},
   {CHANNELS(1), RING, SIMPLE, AUTO_PATH, KEEP}, EFFICIENCY(0.37, kGfx120xPeakBusBwGBps)},
  {{COLL, "gfx1201", ALL_GATHER, {32ULL << 10, (256ULL << 10) - 1}, EQ(1), EQ(8),
    kAnyInt, SHM, ANY_BOOL},
   {CHANNELS(1), RING, SIMPLE, AUTO_PATH, KEEP}, EFFICIENCY(2.68, kGfx120xPeakBusBwGBps)},
  {{COLL, "gfx1201", ALL_GATHER, {256ULL << 10, (1ULL << 20) - 1}, EQ(1), EQ(8),
    kAnyInt, SHM, ANY_BOOL},
   {CHANNELS(6), RING, SIMPLE, AUTO_PATH, KEEP}, EFFICIENCY(6.09, kGfx120xPeakBusBwGBps)},
  {{COLL, "gfx1201", ALL_GATHER, {1ULL << 20, (16ULL << 20) - 1}, EQ(1), EQ(8),
    kAnyInt, SHM, ANY_BOOL},
   {CHANNELS(12), RING, SIMPLE, AUTO_PATH, KEEP}, EFFICIENCY(17.51, kGfx120xPeakBusBwGBps)},
  {{COLL, "gfx1201", ALL_GATHER, {16ULL << 20, 8ULL << 30}, EQ(1), EQ(8),
    kAnyInt, SHM, ANY_BOOL},
   {CHANNELS(28), RING, SIMPLE, AUTO_PATH, KEEP}, EFFICIENCY(21.59, kGfx120xPeakBusBwGBps)},

  {{COLL, "gfx1201", REDUCE_SCATTER, {128, (8ULL << 10) - 1}, EQ(1), EQ(8),
    kAnyInt, SHM, ANY_BOOL},
   {CHANNELS(1), RING, SIMPLE, AUTO_PATH, KEEP}, EFFICIENCY(0.10, kGfx120xPeakBusBwGBps)},
  {{COLL, "gfx1201", REDUCE_SCATTER, {8ULL << 10, (32ULL << 10) - 1}, EQ(1), EQ(8),
    kAnyInt, SHM, ANY_BOOL},
   {CHANNELS(1), RING, SIMPLE, AUTO_PATH, KEEP}, EFFICIENCY(0.39, kGfx120xPeakBusBwGBps)},
  {{COLL, "gfx1201", REDUCE_SCATTER, {32ULL << 10, (256ULL << 10) - 1}, EQ(1), EQ(8),
    kAnyInt, SHM, ANY_BOOL},
   {CHANNELS(1), RING, SIMPLE, AUTO_PATH, KEEP}, EFFICIENCY(2.84, kGfx120xPeakBusBwGBps)},
  {{COLL, "gfx1201", REDUCE_SCATTER, {256ULL << 10, (1ULL << 20) - 1}, EQ(1), EQ(8),
    kAnyInt, SHM, ANY_BOOL},
   {CHANNELS(2), RING, SIMPLE, AUTO_PATH, KEEP}, EFFICIENCY(6.11, kGfx120xPeakBusBwGBps)},
  {{COLL, "gfx1201", REDUCE_SCATTER, {1ULL << 20, (16ULL << 20) - 1}, EQ(1), EQ(8),
    kAnyInt, SHM, ANY_BOOL},
   {CHANNELS(12), RING, SIMPLE, AUTO_PATH, KEEP}, EFFICIENCY(16.68, kGfx120xPeakBusBwGBps)},
  {{COLL, "gfx1201", REDUCE_SCATTER, {16ULL << 20, (2ULL << 30) - 1}, EQ(1), EQ(8),
    kAnyInt, SHM, ANY_BOOL},
   {CHANNELS(28), RING, SIMPLE, AUTO_PATH, KEEP}, EFFICIENCY(21.81, kGfx120xPeakBusBwGBps)},
  {{COLL, "gfx1201", REDUCE_SCATTER, {2ULL << 30, (8ULL << 30) - 1}, EQ(1), EQ(8),
    kAnyInt, SHM, ANY_BOOL},
   {CHANNELS(28), RING, SIMPLE, AUTO_PATH, KEEP}, EFFICIENCY(21.37, kGfx120xPeakBusBwGBps)},
  ...
  {{COLL, "gfx1201", REDUCE, {128, (64ULL << 10) - 1}, EQ(1), EQ(8),
    kAnyInt, SHM, ANY_BOOL},
   {CHANNELS(1), RING, SIMPLE, AUTO_PATH, KEEP}, EFFICIENCY(2.05, kGfx120xPeakBusBwGBps)},
  {{COLL, "gfx1201", REDUCE, {64ULL << 10, (256ULL << 10) - 1}, EQ(1), EQ(8),
    kAnyInt, SHM, ANY_BOOL},
   {CHANNELS(1), RING, SIMPLE, AUTO_PATH, KEEP}, EFFICIENCY(4.89, kGfx120xPeakBusBwGBps)},
  {{COLL, "gfx1201", REDUCE, {256ULL << 10, (512ULL << 10) - 1}, EQ(1), EQ(8),
    kAnyInt, SHM, ANY_BOOL},
   {CHANNELS(2), RING, SIMPLE, AUTO_PATH, KEEP}, EFFICIENCY(8.13, kGfx120xPeakBusBwGBps)},
  {{COLL, "gfx1201", REDUCE, {512ULL << 10, (1ULL << 20) - 1}, EQ(1), EQ(8),
    kAnyInt, SHM, ANY_BOOL},
   {CHANNELS(2), RING, SIMPLE, AUTO_PATH, KEEP}, EFFICIENCY(9.56, kGfx120xPeakBusBwGBps)},
  {{COLL, "gfx1201", REDUCE, {1ULL << 20, (16ULL << 20) - 1}, EQ(1), EQ(8),
    kAnyInt, SHM, ANY_BOOL},
   {CHANNELS(8), RING, SIMPLE, AUTO_PATH, KEEP}, EFFICIENCY(17.37, kGfx120xPeakBusBwGBps)},
  {{COLL, "gfx1201", REDUCE, {16ULL << 20, (1536ULL << 20) - 1}, EQ(1), EQ(8),
    kAnyInt, SHM, ANY_BOOL},
   {CHANNELS(24), RING, SIMPLE, AUTO_PATH, KEEP}, UNMEASURED},
  {{COLL, "gfx1201", REDUCE, {1536ULL << 20, 8ULL << 30}, EQ(1), EQ(8),
    kAnyInt, SHM, ANY_BOOL},
   {CHANNELS(24), RING, SIMPLE, AUTO_PATH, KEEP}, EFFICIENCY(22.14, kGfx120xPeakBusBwGBps)},
  ...
  {{COLL, "gfx1201", BROADCAST, {128, (64ULL << 10) - 1}, EQ(1), EQ(8),
    kAnyInt, SHM, ANY_BOOL},
   {KEEP, RING, SIMPLE, AUTO_PATH, KEEP}, EFFICIENCY(2.13, kGfx120xPeakBusBwGBps)},
  {{COLL, "gfx1201", BROADCAST, {64ULL << 10, (256ULL << 10) - 1}, EQ(1), EQ(8),
    kAnyInt, SHM, ANY_BOOL},
   {CHANNELS(1), RING, SIMPLE, AUTO_PATH, KEEP}, EFFICIENCY(4.93, kGfx120xPeakBusBwGBps)},
  {{COLL, "gfx1201", BROADCAST, {256ULL << 10, (512ULL << 10) - 1}, EQ(1), EQ(8),
    kAnyInt, SHM, ANY_BOOL},
   {CHANNELS(2), RING, SIMPLE, AUTO_PATH, KEEP}, EFFICIENCY(8.43, kGfx120xPeakBusBwGBps)},
  {{COLL, "gfx1201", BROADCAST, {512ULL << 10, (1ULL << 20) - 1}, EQ(1), EQ(8),
    kAnyInt, SHM, ANY_BOOL},
   {CHANNELS(2), RING, SIMPLE, AUTO_PATH, KEEP}, EFFICIENCY(10.39, kGfx120xPeakBusBwGBps)},
  {{COLL, "gfx1201", BROADCAST, {1ULL << 20, 8ULL << 30}, EQ(1), EQ(8),
    kAnyInt, SHM, ANY_BOOL},
   {CHANNELS(8), RING, SIMPLE, AUTO_PATH, KEEP}, EFFICIENCY(22.63, kGfx120xPeakBusBwGBps)},
