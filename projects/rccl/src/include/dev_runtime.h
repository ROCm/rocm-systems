...
// Bytes from userPtr that fit in this window and in every LSA peer allocation.
// lsaMinSize starts at the allocation base, so a window at memOffset only owns
// the tail of that minimum.
