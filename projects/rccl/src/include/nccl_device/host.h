...
static_assert(offsetof(ncclCommProperties_t, devCommRuntimeVersionSize) == 136,
              ...
              "cynccl.pxd and bindings/nccl4py/tests/test_comm_properties_abi.py to match");
static_assert(offsetof(ncclCommProperties_t, cftSupport) == 144,
              "ncclCommProperties_t.cftSupport offset changed; update nccl4py's cynccl.pxd "
              "and bindings/nccl4py/tests/test_comm_properties_abi.py to match");
static_assert(offsetof(ncclCommProperties_t, cftCountedSupport) == 146,
              "ncclCommProperties_t.cftCountedSupport offset changed; update nccl4py's cynccl.pxd "
              "and bindings/nccl4py/tests/test_comm_properties_abi.py to match");
static_assert(sizeof(ncclCommProperties_t) == 152, "ncclCommProperties_t size changed; update nccl4py's cynccl.pxd and "
