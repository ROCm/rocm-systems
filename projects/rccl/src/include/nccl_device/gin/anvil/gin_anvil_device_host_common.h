...
// - signalsBase[peer] is this GPU's IPC-mapped base for peer P's signal array (remote SDMA).
// - signals is this rank's flat indexed signal array (readSignal / waitSignal on local cells).
