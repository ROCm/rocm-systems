...
#include "checks.h"
#include "argcheck.h"
// [RCCL] cudawrap.h drives CUDA via dynamically loaded driver pfn_*; on HIP
// we use the rocmwrap.h shim which calls hip APIs directly. The two define
// the same CUCHECK*/CUCALL macros so we just include the HIP version.
#include "rocmwrap.h"
#include "debug.h"
#include "bootstrap.h"
#include "proxy.h"
