...
.. code:: shell
  ...
  NCCL_IB_QPS_PER_CONNECTION - This controls the number of QPs per connection. The default value is 1. However, on
                               ...
                               can improve path diversity on the network and increase throughput. With the IB
                               network transport, GIN connections stay at one QP per device when this value is
                               raised.
