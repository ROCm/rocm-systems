...
// Regression tests for PR #1864: ncclInitKernelsForDevice must drain the sticky
// HIP error left by a failing hipFuncGetAttributes so it never leaks into the
// caller's subsequent kernel launches.
