...
// LaunchOrderImplicit is declared inside init.cc (NCCL_PARAM at init.cc:139) and generated by param_redirect.h in init-test.cc.
...
int64_t ncclParamEnqueueRearchEnable() { return g_loadParam("ENQUEUE_REARCH_ENABLE", 0); }   // enqueue.cc:93
int64_t ncclParamRasDiagnostics() { return g_loadParam("RUN_RAS_DIAGNOSTICS", 0); }           // ras/ras.cc:89
int64_t ncclParamDiagnostics() { return g_loadParam("RUN_DIAGNOSTICS", 0); }                  // diagnostics.cc:30
