...
const std::vector<ExpectedKernelCase>& ValidCases() {
  static const std::vector<ExpectedKernelCase> kCases = {
      {"AllGather_LL", ncclSymkKernelId_AllGather_LL, ncclDevSum, ncclFloat32,
       (void*)ncclSymkDevKernel_AllGather_LL},
      {"AllGather_ST", ncclSymkKernelId_AllGather_ST, ncclDevSum, ncclFloat32,
