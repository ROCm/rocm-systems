...
// fakes/wrap_fakes.cc.
//
// Covers 17 low-dependency helpers: ten that take no ncclComm* at all, plus
// seven that take one, of which four need a real one-GPU comm+topology
// (MakeCommWithArch below), while still avoiding RCCL_PARAM/getenv/DDA/CE/
// symmetric-kernel machinery beyond a cached fast-return path.
