...
# and cudaEvent_t are treated as opaque void* (HIP's hipStream_t and
# hipEvent_t are also pointers); we never dereference them, only pass them
# through to RCCL functions resolved by dlsym.
