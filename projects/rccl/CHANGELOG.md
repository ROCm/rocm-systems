...
### Fixed
* Skip InfiniBand RMA proxy verbs init (`ibv_get_device_list`) when `NCCL_GIN_TYPE` is Anvil-SDMA (`6`) or unset (`-1`). A second verbs enumeration after NET/IB-CAST can SIGSEGV on some MI455 rdma-core stacks; GDAKI still initializes IB.
