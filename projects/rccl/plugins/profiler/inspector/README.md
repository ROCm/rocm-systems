...
export NCCL_PROFILER_PLUGIN=/path/to/nccl/plugins/profiler/inspector/librccl-profiler-inspector.so
...
- `NCCL_PROFILER_PLUGIN=/path/to/nccl/plugins/profiler/inspector/librccl-profiler-inspector.so`
