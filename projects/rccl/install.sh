...
function display_help()
{
    ...
    echo "       --all-unrolls           Build all unroll factors (1 2 4 8 16 32); default is arch-specific"
...
# Build all unroll factors
if [[ "${build_all_unrolls}" == true ]]; then
    cmake_common_options="${cmake_common_options} -DRCCL_BUILD_ALL_UNROLLS=ON"
fi
