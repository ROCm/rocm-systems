 ...
 */
template <typename T>
void PrintArray(string header, const T* data, const int width, const int height);
...
// hsa_status_t find_symbol_offset(hsa_ext_brig_module_t* brig_module, char* symbol_name,
