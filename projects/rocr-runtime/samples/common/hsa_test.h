...
class HsaTest {
 ...
 protected:
  ...
  virtual void GetGpuPeer(hsa_agent_t master, std::vector<hsa_agent_t>& gpu_peers);
  ...
  virtual void LaunchPacket(hsa_queue_t& queue, hsa_packet_type_t type, void* packet);
