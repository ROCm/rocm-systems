...
if(UNIX)
    ...
    if(${BUILD_SHARED_LIBS})
        ...
        add_subdirectory(
            "${ROCR_LIBELF_INCLUDE_DIR}"
            ${CMAKE_CURRENT_BINARY_DIR}/libelf
        )
    endif()
    set(USE_AMD_LIBELF "yes" CACHE FORCE "")
    set(AMD_ELFTOOLCHAIN_DIR
        ${ROCR_LIBELF_INCLUDE_DIR}/../..;${ROCR_LIBELF_INCLUDE_DIR}/../common/win32;${ROCR_LIBELF_INCLUDE_DIR}/../common
    )
    set(ROCR_LIBELF_INCLUDE_DIR
        ${ROCR_LIBELF_INCLUDE_DIR};${AMD_ELFTOOLCHAIN_DIR}
    )
