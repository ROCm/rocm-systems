...
Coordinate::Coordinate(enum Dim dim, INT_32 n) { set(dim, n); }
...
enum Dim Coordinate::getdim() { return dim; }

INT_8 Coordinate::getord() { return ord; }

BOOL_32 Coordinate::operator==(const Coordinate& b) { return (dim == b.dim) && (ord == b.ord); }
...
BOOL_32 Coordinate::operator<=(const Coordinate& b) { return (*this < b) || (*this == b); }

BOOL_32 Coordinate::operator>=(const Coordinate& b) { return !(*this < b); }
...
CoordTerm::CoordTerm() { num_coords = 0; }

VOID CoordTerm::Clear() { num_coords = 0; }
...
UINT_32 CoordTerm::getsize() { return num_coords; }
...
Coordinate& CoordTerm::operator[](UINT_32 i) { return m_coord[i]; }
...
BOOL_32 CoordTerm::operator!=(const CoordTerm& b) { return !(*this == b); }
...
UINT_32 CoordEq::getsize() { return m_numBits; }
...
VOID CoordEq::solveAddr(UINT_64 addr, UINT_32 sliceInM, UINT_32* coords) const {
...
CoordTerm& CoordEq::operator[](UINT_32 i) { return m_eq[i]; }
...
BOOL_32 CoordEq::operator!=(const CoordEq& b) { return !(*this == b); }
