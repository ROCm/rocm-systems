...
typedef union _ADDR_CHANNEL_SETTING {
  struct {
    ...
    UINT_8 channel : 2;  ///< 0 for x channel, 1 for y channel, 2 for z channel, 3 for MSAA sample
                         ///< index
...
****************************************************************************************************
*/
typedef VOID*(ADDR_API* ADDR_ALLOCSYSMEM)(const ADDR_ALLOCSYSMEM_INPUT* pInput);
...
****************************************************************************************************
*/
typedef ADDR_E_RETURNCODE(ADDR_API* ADDR_FREESYSMEM)(const ADDR_FREESYSMEM_INPUT* pInput);
...
****************************************************************************************************
*/
typedef ADDR_E_RETURNCODE(ADDR_API* ADDR_DEBUGPRINT)(const ADDR_DEBUGPRINT_INPUT* pInput);
...
****************************************************************************************************
*/
ADDR_E_RETURNCODE ADDR_API AddrCreate(const ADDR_CREATE_INPUT* pAddrCreateIn,
...
****************************************************************************************************
*/
ADDR_E_RETURNCODE ADDR_API AddrDestroy(ADDR_HANDLE hLib);
...
****************************************************************************************************
*/
ADDR_E_RETURNCODE ADDR_API AddrComputeSurfaceInfo(ADDR_HANDLE hLib,
...
ADDR_E_RETURNCODE ADDR_API AddrComputeSurfaceAddrFromCoord(
    ADDR_HANDLE hLib, const ADDR_COMPUTE_SURFACE_ADDRFROMCOORD_INPUT* pIn,
...
ADDR_E_RETURNCODE ADDR_API AddrComputeSurfaceCoordFromAddr(
    ADDR_HANDLE hLib, const ADDR_COMPUTE_SURFACE_COORDFROMADDR_INPUT* pIn,
...
****************************************************************************************************
*/
ADDR_E_RETURNCODE ADDR_API AddrComputeHtileInfo(ADDR_HANDLE hLib,
...
AddrComputeHtileAddrFromCoord(ADDR_HANDLE hLib, const ADDR_COMPUTE_HTILE_ADDRFROMCOORD_INPUT* pIn,
...
*/
ADDR_E_RETURNCODE ADDR_API
AddrComputeHtileCoordFromAddr(ADDR_HANDLE hLib, const ADDR_COMPUTE_HTILE_COORDFROMADDR_INPUT* pIn,
...
****************************************************************************************************
*/
ADDR_E_RETURNCODE ADDR_API AddrComputeCmaskInfo(ADDR_HANDLE hLib,
...
*/
ADDR_E_RETURNCODE ADDR_API
AddrComputeCmaskAddrFromCoord(ADDR_HANDLE hLib, const ADDR_COMPUTE_CMASK_ADDRFROMCOORD_INPUT* pIn,
...
*/
ADDR_E_RETURNCODE ADDR_API
AddrComputeCmaskCoordFromAddr(ADDR_HANDLE hLib, const ADDR_COMPUTE_CMASK_COORDFROMADDR_INPUT* pIn,
...
****************************************************************************************************
*/
ADDR_E_RETURNCODE ADDR_API AddrComputeFmaskInfo(ADDR_HANDLE hLib,
...
*/
ADDR_E_RETURNCODE ADDR_API
AddrComputeFmaskAddrFromCoord(ADDR_HANDLE hLib, const ADDR_COMPUTE_FMASK_ADDRFROMCOORD_INPUT* pIn,
...
*/
ADDR_E_RETURNCODE ADDR_API
AddrComputeFmaskCoordFromAddr(ADDR_HANDLE hLib, const ADDR_COMPUTE_FMASK_COORDFROMADDR_INPUT* pIn,
...
*/
ADDR_E_RETURNCODE ADDR_API
AddrExtractBankPipeSwizzle(ADDR_HANDLE hLib, const ADDR_EXTRACT_BANKPIPE_SWIZZLE_INPUT* pIn,
...
****************************************************************************************************
*/
BOOL_32 ADDR_API ElemGetExportNorm(ADDR_HANDLE hLib, const ELEM_GETEXPORTNORM_INPUT* pIn);
...
****************************************************************************************************
*/
ADDR_E_RETURNCODE ADDR_API ElemFlt32ToDepthPixel(ADDR_HANDLE hLib,
...
****************************************************************************************************
*/
ADDR_E_RETURNCODE ADDR_API ElemFlt32ToColorPixel(ADDR_HANDLE hLib,
...
****************************************************************************************************
*/
ADDR_E_RETURNCODE ADDR_API AddrConvertTileInfoToHW(ADDR_HANDLE hLib,
...
****************************************************************************************************
*/
ADDR_E_RETURNCODE ADDR_API AddrConvertTileIndex(ADDR_HANDLE hLib,
...
****************************************************************************************************
*/
ADDR_E_RETURNCODE ADDR_API AddrGetMacroModeIndex(ADDR_HANDLE hLib,
...
****************************************************************************************************
*/
ADDR_E_RETURNCODE ADDR_API AddrConvertTileIndex1(ADDR_HANDLE hLib,
...
****************************************************************************************************
*/
ADDR_E_RETURNCODE ADDR_API AddrComputeDccInfo(ADDR_HANDLE hLib,
...
****************************************************************************************************
*/
ADDR_E_RETURNCODE ADDR_API AddrGetMaxAlignments(ADDR_HANDLE hLib,
...
****************************************************************************************************
*/
ADDR_E_RETURNCODE ADDR_API AddrGetMaxMetaAlignments(ADDR_HANDLE hLib,
                                                    ADDR_GET_MAX_ALIGNMENTS_OUTPUT* pOut);
...
****************************************************************************************************
*/
ADDR_E_RETURNCODE ADDR_API Addr2ComputeSurfaceInfo(ADDR_HANDLE hLib,
...
ADDR_E_RETURNCODE ADDR_API Addr2ComputeSurfaceAddrFromCoord(
    ADDR_HANDLE hLib, const ADDR2_COMPUTE_SURFACE_ADDRFROMCOORD_INPUT* pIn,
...
ADDR_E_RETURNCODE ADDR_API Addr2ComputeSurfaceCoordFromAddr(
    ADDR_HANDLE hLib, const ADDR2_COMPUTE_SURFACE_COORDFROMADDR_INPUT* pIn,
...
****************************************************************************************************
*/
ADDR_E_RETURNCODE ADDR_API Addr2ComputeHtileInfo(ADDR_HANDLE hLib,
...
*/
ADDR_E_RETURNCODE ADDR_API
Addr2ComputeHtileAddrFromCoord(ADDR_HANDLE hLib, const ADDR2_COMPUTE_HTILE_ADDRFROMCOORD_INPUT* pIn,
...
*/
ADDR_E_RETURNCODE ADDR_API
Addr2ComputeHtileCoordFromAddr(ADDR_HANDLE hLib, const ADDR2_COMPUTE_HTILE_COORDFROMADDR_INPUT* pIn,
...
****************************************************************************************************
*/
ADDR_E_RETURNCODE ADDR_API Addr2ComputeCmaskInfo(ADDR_HANDLE hLib,
...
*/
ADDR_E_RETURNCODE ADDR_API
Addr2ComputeCmaskAddrFromCoord(ADDR_HANDLE hLib, const ADDR2_COMPUTE_CMASK_ADDRFROMCOORD_INPUT* pIn,
...
*/
ADDR_E_RETURNCODE ADDR_API
Addr2ComputeCmaskCoordFromAddr(ADDR_HANDLE hLib, const ADDR2_COMPUTE_CMASK_COORDFROMADDR_INPUT* pIn,
...
****************************************************************************************************
*/
ADDR_E_RETURNCODE ADDR_API Addr2ComputeFmaskInfo(ADDR_HANDLE hLib,
...
*/
ADDR_E_RETURNCODE ADDR_API
Addr2ComputeFmaskAddrFromCoord(ADDR_HANDLE hLib, const ADDR2_COMPUTE_FMASK_ADDRFROMCOORD_INPUT* pIn,
...
*/
ADDR_E_RETURNCODE ADDR_API
Addr2ComputeFmaskCoordFromAddr(ADDR_HANDLE hLib, const ADDR2_COMPUTE_FMASK_COORDFROMADDR_INPUT* pIn,
...
****************************************************************************************************
*/
ADDR_E_RETURNCODE ADDR_API Addr2ComputeDccInfo(ADDR_HANDLE hLib,
...
*/
ADDR_E_RETURNCODE ADDR_API
Addr2ComputeDccAddrFromCoord(ADDR_HANDLE hLib, const ADDR2_COMPUTE_DCC_ADDRFROMCOORD_INPUT* pIn,
...
****************************************************************************************************
*/
ADDR_E_RETURNCODE ADDR_API Addr2ComputePipeBankXor(ADDR_HANDLE hLib,
...
*/
ADDR_E_RETURNCODE ADDR_API
Addr2ComputeSlicePipeBankXor(ADDR_HANDLE hLib, const ADDR2_COMPUTE_SLICE_PIPEBANKXOR_INPUT* pIn,
...
ADDR_E_RETURNCODE ADDR_API Addr2ComputeSubResourceOffsetForSwizzlePattern(
    ADDR_HANDLE hLib, const ADDR2_COMPUTE_SUBRESOURCE_OFFSET_FORSWIZZLEPATTERN_INPUT* pIn,
...
ADDR_E_RETURNCODE ADDR_API Addr2ComputeNonBlockCompressedView(
    ADDR_HANDLE hLib, const ADDR2_COMPUTE_NONBLOCKCOMPRESSEDVIEW_INPUT* pIn,
...
*/
ADDR_E_RETURNCODE ADDR_API
Addr2GetPreferredSurfaceSetting(ADDR_HANDLE hLib, const ADDR2_GET_PREFERRED_SURF_SETTING_INPUT* pIn,
...
*/
ADDR_E_RETURNCODE ADDR_API
Addr2GetPossibleSwizzleModes(ADDR_HANDLE hLib, const ADDR2_GET_PREFERRED_SURF_SETTING_INPUT* pIn,
                             ADDR2_GET_PREFERRED_SURF_SETTING_OUTPUT* pOut);
...
****************************************************************************************************
*/
ADDR_E_RETURNCODE ADDR_API Addr2GetAllowedBlockSet(ADDR_HANDLE hLib,
...
****************************************************************************************************
*/
ADDR_E_RETURNCODE ADDR_API Addr2GetAllowedSwSet(ADDR_HANDLE hLib, ADDR2_SWMODE_SET allowedSwModeSet,
...
BOOL_32 Addr2BlockTypeWithinMemoryBudget(UINT_64 minSize, UINT_64 newBlockTypeSize,
                                         UINT_32 ratioLow, UINT_32 ratioHi,
#if defined(__cplusplus)
                                         DOUBLE memoryBudget = 0.0f,
                                         BOOL_32 newBlockTypeBigger = TRUE);
#else
                                         DOUBLE memoryBudget, BOOL_32 newBlockTypeBigger);
#endif
...
****************************************************************************************************
*/
ADDR_E_RETURNCODE ADDR_API Addr3ComputeSurfaceInfo(ADDR_HANDLE hLib,
...
*/
ADDR_E_RETURNCODE ADDR_API
Addr3GetPossibleSwizzleModes(ADDR_HANDLE hLib, const ADDR3_GET_POSSIBLE_SWIZZLE_MODE_INPUT* pIn,
...
ADDR_E_RETURNCODE ADDR_API Addr3ComputeSurfaceAddrFromCoord(
    ADDR_HANDLE hLib, const ADDR3_COMPUTE_SURFACE_ADDRFROMCOORD_INPUT* pIn,
...
****************************************************************************************************
*/
ADDR_E_RETURNCODE ADDR_API Addr3ComputePipeBankXor(ADDR_HANDLE hLib,
...
ADDR_E_RETURNCODE ADDR_API Addr3ComputeNonBlockCompressedView(
    ADDR_HANDLE hLib, const ADDR3_COMPUTE_NONBLOCKCOMPRESSEDVIEW_INPUT* pIn,
...
VOID ADDR_API Addr3ComputeSubResourceOffsetForSwizzlePattern(
    ADDR_HANDLE hLib, const ADDR3_COMPUTE_SUBRESOURCE_OFFSET_FORSWIZZLEPATTERN_INPUT* pIn,
...
*/
ADDR_E_RETURNCODE ADDR_API
Addr3ComputeSlicePipeBankXor(ADDR_HANDLE hLib, const ADDR3_COMPUTE_SLICE_PIPEBANKXOR_INPUT* pIn,
