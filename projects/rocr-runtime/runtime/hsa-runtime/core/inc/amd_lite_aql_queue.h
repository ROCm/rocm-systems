...
#ifndef HSA_RUNTIME_CORE_INC_AMD_LITE_AQL_QUEUE_H_
#define HSA_RUNTIME_CORE_INC_AMD_LITE_AQL_QUEUE_H_

#if !defined(__linux__)
#error "amd_lite_aql_queue.h is Linux amdgpu_lite-only"
#endif
...
class LiteAqlQueue : public core::Queue,
 ...
 public:
  ...
  LiteAqlQueue(core::SharedQueue* shared_queue, LiteGpuAgent* agent, size_t req_size_pkts,
              uint64_t flags, core::HsaEventCallback callback, void* err_data);
  ~LiteAqlQueue() override;
 ...
 private:
  ...
  LinuxAmdgpuLiteDriver::DirectComputeQueue direct_queue_{};
...
#endif  // HSA_RUNTIME_CORE_INC_AMD_LITE_AQL_QUEUE_H_
