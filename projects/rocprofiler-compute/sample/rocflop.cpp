...
// SMFMAC requires CDNA3+ (gfx940 and later). Clang over-reports the builtin on
// gfx908/gfx90a, so hybrid-guard those until upstream gating catches up. As
// with MFMA, the empty body on unsupported targets is never launched.
