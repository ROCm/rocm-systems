...
"""ROCPD data interface for profile and analysis artifacts."""
...
def _write_query_rows(
    ...
    try:
        ...
        console_error(f"Database error while extracting {file_path}: {e}")
    except Exception as e:
        console_error(f"Unexpected error while extracting {file_path}: {e}")
