...
void mock_code_object_translator_t::add_file_code_object(const char* filepath,
                                                         size_t      id,
                                                         uint64_t    load_addr,
                                                         uint64_t    load_size)
{
...
void mock_code_object_translator_t::add_memory_code_object(uint64_t memory_base,
                                                           size_t   memory_size,
                                                           size_t   id,
                                                           uint64_t load_base,
                                                           uint64_t load_size)
