...
class Bench_gfx9(benchmark_base.Bench_base):
    def __init__(self, device_id: int, cache_sizes: dict) -> None:
        ...
        self.matrix_kernel_selector = {
            ...
            "MXFP8": "mfma_f8f6f4<FP8_E4M3>",
            "MXBF8": "mfma_f8f6f4<BF8_E5M2>",
            "F8": "mfma_f8",
            "F16": "mfma_f16",
            "BF16": "mfma_bf16",
            "F32": "mfma_f32",
        ...
        self.tests = {
            ...
            "MFMA-MXFP8": super().matrix_mxf8_bench,
            "MFMA-MXBF8": super().matrix_mxbf8_bench,
        ...
        self.csv_cols_map = {
            ...
            "MFMA-MXFP8": "MFMAMXFP8Flops",
            "MFMA-MXBF8": "MFMAMXBF8Flops",
            "MFMA-F8": "MFMAF8Flops",
