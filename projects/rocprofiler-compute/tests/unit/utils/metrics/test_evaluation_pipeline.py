...
class TestEvaluationPipeline:
    ...
    def test_eval_metric_rejects_zero_gui_active_counter(self, gui_active_counter):
        ...
        raw_pmc_df = raw_pmc_df.drop(columns=["GRBM_GUI_ACTIVE"])
        ...
        with patch(
            ...
            mock_error.side_effect = RuntimeError("halted")
    ...
    def test_calc_builtin_vars_uses_gfx1250_gui_active_sum(self):
        ...
        with patch(
            "utils.metrics.evaluation_pipeline.mi_gpu_specs.get_gpu_series",
