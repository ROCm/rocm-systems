...
class TestCreateDfKernelTopStats:
    """Tests for utils.file_io.create_df_kernel_top_stats."""

    @pytest.fixture
    def raw_pmc(self) -> pd.DataFrame:
    ...
    def test_returns_valid_dataframes(self, raw_pmc: pd.DataFrame) -> None:
    ...
    def test_grouping_and_aggregation(self, raw_pmc: pd.DataFrame) -> None:
    ...
    def test_filters(self, raw_pmc: pd.DataFrame) -> None:
