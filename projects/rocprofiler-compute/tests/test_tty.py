...
class TestTimeUnitConversion:
    """Tests for utils.tty.has_time_data and convert_time_columns."""

    def test_has_time_data_detection(self, sample_time_data: pd.DataFrame) -> None:
    ...
    def test_default_unit_is_nanoseconds(self, sample_time_data: pd.DataFrame) -> None:
    ...
    def test_conversion_to_seconds(
        self, sample_time_data: pd.DataFrame, original_ns_values: dict[str, float]
    ) -> None:
    ...
    def test_conversion_to_milliseconds(
        self, sample_time_data: pd.DataFrame, original_ns_values: dict[str, float]
    ) -> None:
    ...
    def test_conversion_to_microseconds(
        self, sample_time_data: pd.DataFrame, original_ns_values: dict[str, float]
    ) -> None:
    ...
    def test_conversion_to_nanoseconds(
        self, sample_time_data: pd.DataFrame, original_ns_values: dict[str, float]
    ) -> None:
    ...
    def test_non_time_rows_unchanged(self, sample_time_data: pd.DataFrame) -> None:
    ...
    def test_invalid_time_unit_is_noop(self, sample_time_data: pd.DataFrame) -> None:
    ...
    def test_missing_unit_column_is_noop(self) -> None:
    ...
    def test_conversion_with_missing_columns(
        self, sample_time_data: pd.DataFrame, original_ns_values: dict[str, float]
    ) -> None:
    ...
    def test_mathematical_correctness_all_units(
        self, sample_time_data: pd.DataFrame, original_ns_values: dict[str, float]
    ) -> None:
    ...
    def test_integration_conversion_flow(self) -> None:
    ...
    def test_show_all_with_time_unit_conversion(self) -> None:
