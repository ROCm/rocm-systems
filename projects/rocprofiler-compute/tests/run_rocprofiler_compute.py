...
the CTest suite generated by that project. It is intended to be called directly
from CI or by developers with an installed ROCm tree.
"""
...
Use --ctest-dir for a non-default CTest payload location, and --rocm-path when
the ROCm install prefix cannot be inferred from the runner or payload path.
"""
