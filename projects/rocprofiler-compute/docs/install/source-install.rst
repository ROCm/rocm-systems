...
.. tip::
   ...
   ``TORCH_TRACE_PYTHON`` selects the Python interpreter that the ``roctx_recordfn``
   extension is built against. The extension is built whenever PyTorch is importable
