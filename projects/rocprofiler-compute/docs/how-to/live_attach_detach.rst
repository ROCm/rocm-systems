...
.. note::
  ...
  * Dynamic process attachment feature is currently in BETA version. To enable Dynamic process attachment, you need to have the correct supported version of :doc:`ROCprofiler-SDK <rocprofiler-sdk:index>` and ``rocprofiler-register``.
