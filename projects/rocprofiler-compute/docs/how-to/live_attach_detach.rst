...
.. note::
  ...
  * Dynamic process attachment feature is currently in BETA version. To enable Dynamic process attachment, you need to have the correct supported proper version of ROCprofiler-SDK and rocprofiler-register.
