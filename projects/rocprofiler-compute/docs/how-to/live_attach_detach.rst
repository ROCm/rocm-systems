...
.. note::
  ...
  * To make the Live Attach/Detach feature work, you must restrict the number of counter input files (which determine number of application runs) to one. This can be acheived with options such as: "--block", "--set", "--iteration-multiplexing".
