...
* **Navigation:** Drag to pan and scroll to zoom. Use the *Reset zoom* button in the toolbar at the top of the page to reframe on the kernels currently shown; double-clicking the chart does the same.
