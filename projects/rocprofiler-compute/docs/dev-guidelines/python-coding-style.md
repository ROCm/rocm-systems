...
- [Python Coding Style Guidelines](#python-coding-style-guidelines)
  ...
  - [Naming Conventions](#naming-conventions)
    - [Rules](#rules-1)
    - [Example 1: Concise Helper Functions](#example-1-concise-helper-functions)
    - [Example 2: Breaking Down Complex Operations](#example-2-breaking-down-complex-operations)
  ...
  - [When to Use Helper Functions](#when-to-use-helper-functions)
    - [Rules](#rules-6)
    - [1. Repeated Code Patterns](#1-repeated-code-patterns)
    - [2. Complex Expressions That Need Clarification](#2-complex-expressions-that-need-clarification)
    - [3. Improving Testability](#3-improving-testability)
  - [When NOT to Extract Helper Functions](#when-not-to-extract-helper-functions)
    - [Rules](#rules-7)
    - [Example](#example-5)
  - [Single Responsibility Principle](#single-responsibility-principle)
    - [Rules](#rules-8)
    - [Example 1: Clear Single Purpose](#example-1-clear-single-purpose)
    - [Example 2: Focused Data Processing](#example-2-focused-data-processing)
  - [Levels of Abstraction](#levels-of-abstraction)
    - [Rules](#rules-9)
    - [Example 1: Consistent Abstraction Level](#example-1-consistent-abstraction-level)
    - [Example 2: Delegation to Appropriate Level](#example-2-delegation-to-appropriate-level)
  - [Avoiding Deep Nesting](#avoiding-deep-nesting)
    - [Rules](#rules-10)
    - [Example 1: Early Returns](#example-1-early-returns)
    - [Example 2: Extract Nested Logic](#example-2-extract-nested-logic)
