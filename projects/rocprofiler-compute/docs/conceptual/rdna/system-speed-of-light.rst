.. meta::
    ...
    :keywords: ROCm Compute Profiler, RDNA, gfx11.5, system speed of light
...
This page documents System Speed-of-Light metrics for RDNA3.5 (gfx11.5) with the
shipped gfx11.5 analysis configuration.
...
.. Note::
  ...
  Other gfx11.5 metric tables follow the RDNA3 hierarchy in :doc:`rdna-performance-model`
