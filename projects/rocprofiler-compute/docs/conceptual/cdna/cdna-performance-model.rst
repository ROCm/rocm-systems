...
including CDNA™ architecture based GPUs like the AMD Instinct MI100, CDNA2 architecture based GPUs such as the AMD Instinct MI250X, MI250,
...
.. table::
  ...
  |                 |           |into single package.             |chiplets, configurable with partition|Multi-Die chiplet        |
  |                 |           |                                 |modes.                               |                         |
  +-----------------+-----------+---------------------------------+-------------------------------------+-------------------------+
  |Supported series |MI100      |MI200                            |MI300A                               |MI350X                   |
  |                 +-----------+---------------------------------+-------------------------------------+-------------------------+
  |                 |MI210      |MI250X                           |MI300X                               |MI355X                   |
  |                 |           |                                 +-------------------------------------+-------------------------+
  |                 |           |                                 |MI325X                               |                         |
  +-----------------+-----------+---------------------------------+-------------------------------------+-------------------------+
