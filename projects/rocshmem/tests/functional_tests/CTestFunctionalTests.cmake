...
function(add_coll_tests)
    ...
    begin_test_group(CATEGORY "COLLECTIVE;WAVE" TIER full BACKENDS "ipc;gda" GPUS "all")
        ...
        add_rocshmem_functional_test(NAME teamreducescatterwave RANKS 2 WORKGROUPS 1 MAX_MSG_SIZE 32768 NUM_WF 1)
        add_rocshmem_functional_test(NAME teamreducescatterwave RANKS 4 WORKGROUPS 1 MAX_MSG_SIZE 32768 NUM_WF 1)
        add_rocshmem_functional_test(NAME teamreducescatterwave RANKS 8 WORKGROUPS 1 MAX_MSG_SIZE 32768 NUM_WF 1)
    end_test_group()
endfunction()
