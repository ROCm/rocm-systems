...
function(add_tile_tests)
    ...
    begin_test_group(CATEGORY "TILE;RMA;PUT" TIER comprehensive BACKENDS "ipc;gda" GPUS "all")
        ...
        add_rocshmem_functional_test(NAME tile_put_wave_rowmajor RANKS 2 WORKGROUPS 1 NUM_WF 1)
        add_rocshmem_functional_test(NAME tile_put_wave_rowmajor RANKS 2 WORKGROUPS 1 NUM_WF 1 MAX_MSG_SIZE 1048576)
        add_rocshmem_functional_test(NAME tile_put_wave_colmajor RANKS 2 WORKGROUPS 1 NUM_WF 1)
        ...
        add_rocshmem_functional_test(NAME tile_put_wg_rowmajor RANKS 2 WORKGROUPS 1 NUM_WF 16)
        add_rocshmem_functional_test(NAME tile_put_wg_rowmajor RANKS 2 WORKGROUPS 1 NUM_WF 16 MAX_MSG_SIZE 1048576)
        add_rocshmem_functional_test(NAME tile_put_wg_colmajor RANKS 2 WORKGROUPS 1 NUM_WF 16)
    ...
    begin_test_group(CATEGORY "TILE;RMA;GET" TIER comprehensive BACKENDS "ipc;gda" GPUS "all")
        ...
        add_rocshmem_functional_test(NAME tile_get_wave_rowmajor RANKS 2 WORKGROUPS 1 NUM_WF 1)
        add_rocshmem_functional_test(NAME tile_get_wave_rowmajor RANKS 2 WORKGROUPS 1 NUM_WF 1 MAX_MSG_SIZE 1048576)
        add_rocshmem_functional_test(NAME tile_get_wave_colmajor RANKS 2 WORKGROUPS 1 NUM_WF 1)
        ...
        add_rocshmem_functional_test(NAME tile_get_wg_rowmajor RANKS 2 WORKGROUPS 1 NUM_WF 16)
        add_rocshmem_functional_test(NAME tile_get_wg_rowmajor RANKS 2 WORKGROUPS 1 NUM_WF 16 MAX_MSG_SIZE 1048576)
        add_rocshmem_functional_test(NAME tile_get_wg_colmajor RANKS 2 WORKGROUPS 1 NUM_WF 16)
