...
function(ROCPROFILER_REGISTER_TARGET_COMPILE_OPTIONS _TARG_TARGET)
    ...
    function(
        rocprofiler_register_target_compile_option_patch_name
        _P_LANG
        _P_IN
        _P_OUT
    )
    ...
    if(
        NOT DEFINED rocprofiler_register_c_error
        AND NOT DEFINED rocprofiler_register_cxx_error
    )
...
function(ROCPROFILER_REGISTER_TARGET_COMPILE_DEFINITIONS _TARG _VIS)
    foreach(_DEF ${ARGN})
        if(
            ...
            AND "${_DEF}" MATCHES "^ROCPROFILER_REGISTER_"
        )
            set(_DEF "${_DEF}=1")
        endif()
