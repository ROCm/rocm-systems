...
set(ROCPROFILER_REGISTER_CPACK_SYSTEM_NAME
    "${CMAKE_SYSTEM_NAME}"
    CACHE STRING
    "System name, e.g. Linux or <OS>-<VERSION>"
)
set(ROCPROFILER_REGISTER_CPACK_PACKAGE_SUFFIX "" CACHE STRING "Package suffix")
...
list(
    REMOVE_ITEM
    ROCPROFILER_REGISTER_PACKAGING_COMPONENTS
    "Development"
    "Unspecified"
    "external"
    "fmt-core"
...
foreach(COMPONENT_GROUP ${ROCPROFILER_REGISTER_COMPONENT_GROUPS})
    ...
    set(CPACK_DEBIAN_${UCOMPONENT}_PACKAGE_NAME
        "${PROJECT_NAME}${_SEP}${_NAME}"
    )
...
if(rocm_version_FOUND)
    set(_ROCPROFILER_REGISTER_SUFFIX
        " (>= 1.0.0.${rocm_version_NUMERIC_VERSION})"
    )
