...
set(ROCM_DEP_ROCMCORE
    OFF
    CACHE BOOL
    "DEB and RPM packages depend on rocm-core package"
)
...
if(
    (ROCM_DEP_ROCMCORE AND NOT ROCPROFILER_REGISTER_DEP_ROCMCORE)
...
set(ROCPROFILER_REGISTER_BUILD_TYPES
    "Release"
    "RelWithDebInfo"
    "Debug"
    "MinSizeRel"
...
if(CMAKE_PROJECT_NAME STREQUAL PROJECT_NAME)
    set_property(
        ...
        PROPERTY STRINGS "${ROCPROFILER_REGISTER_BUILD_TYPES}"
    )
endif()
