...
if(
    NOT ROCPROFILER_REGISTER_CLANG_FORMAT_EXE
    AND EXISTS $ENV{HOME}/.local/bin/clang-format
)
    execute_process(
...
if(
    ...
    if(
        ROCPROFILER_REGISTER_CLANG_FORMAT_EXE
        AND (rocp_source_files OR rocp_header_files)
    )
        add_custom_target(
            format-rocprofiler-register-source
