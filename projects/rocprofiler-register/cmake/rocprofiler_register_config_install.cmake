...
# build tree
#
set(${PROJECT_NAME}_BUILD_TREE ON CACHE BOOL "" FORCE)

file(
    RELATIVE_PATH
    rocp_reg_bin2src_rel_path
    ${PROJECT_BINARY_DIR}
    ${PROJECT_SOURCE_DIR}
)
string(
    ...
    "//"
    "/"
    rocp_reg_inc_rel_path
    "${rocp_reg_bin2src_rel_path}/source/include"
)

execute_process(
    COMMAND
        ${CMAKE_COMMAND} -E create_symlink ${rocp_reg_inc_rel_path}
...
if(
    NOT EXISTS "${_BUILDTREE_EXPORT_DIR}/rocprofiler-register-library-targets.cmake"
)
    file(
        TOUCH
        "${_BUILDTREE_EXPORT_DIR}/rocprofiler-register-library-targets.cmake"
    )
endif()
