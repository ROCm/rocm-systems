...
find_package(
    Threads
    ${rocprofiler_register_FIND_QUIETLY}
    ${rocprofiler_register_FIND_REQUIREMENT}
)
if(Threads_FOUND)
    target_link_libraries(
        rocprofiler-register-threading
...
foreach(_LIB dl rt)
    ...
    find_package_handle_standard_args(
        ${_LIB}-library
        REQUIRED_VARS ${_LIB}_LIBRARY
    )
    if(${_LIB}_LIBRARY)
        target_link_libraries(
            rocprofiler-register-${_LIB}
            INTERFACE
                $<BUILD_INTERFACE:${${_LIB}_LIBRARY}>
...
find_package_handle_standard_args(
    stdcxxfs-library
    REQUIRED_VARS stdcxxfs_LIBRARY
)

if(stdcxxfs_LIBRARY)
    target_link_libraries(
        rocprofiler-register-stdcxxfs
