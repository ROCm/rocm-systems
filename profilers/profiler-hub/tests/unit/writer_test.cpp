...
// track registered with no events is not surfaced (returns 0), unlike the
// removed get_all_tracks(), which returned raw registered rocpd_track rows
// regardless of events. This is a semantic gap, not just a name change;
