...
if(NOT PROFILER_HUB_FETCH_DEPENDENCIES)
    ...
    if(NOT spdlog_FOUND)
        message(
            FATAL_ERROR
            "profiler-hub requires spdlog ${SPDLOG_VERSION} or newer on CMAKE_PREFIX_PATH. Drop -DPROFILER_HUB_FETCH_DEPENDENCIES=OFF to download it instead."
        )
    endif()
...
if(NOT _spdlog_iface_defs MATCHES "SPDLOG_FMT_EXTERNAL")
    message(
        FATAL_ERROR
        "profiler-hub requires an spdlog built with SPDLOG_FMT_EXTERNAL. The one provided is built against its bundled fmt, which would put two fmt copies in one binary. Provide a suitable spdlog on CMAKE_PREFIX_PATH, or leave fetching enabled and configure with -DCMAKE_DISABLE_FIND_PACKAGE_spdlog=ON to bypass it and download one."
    )
endif()
