...
typedef void (*HashFunction)(const uint8_t *key, uint64_t len, uint32_t seed,
                             uint8_t *hash);
...
static const char *test_key_63 =
    "012345678901234567890123456789012345678901234567890123456789012";

// The hash assumes a little-endian architecture. Treating the hash results
// as an array of uint64_t should enable conversion for big-endian
// implementations.
const TestVectorData TestVector[] = {
    ...
    {metrohash128crc_1, 128, test_key_63, 0,
     "B329ED67831604D3DFAC4E4876D8262F"},
    {metrohash128crc_2, 128, test_key_63, 0,
     "0502A67E257BBD77206BBCA6BBEF2653"},
    ...
    {metrohash128crc_1, 128, test_key_63, 1,
     "E8FAB51AF19F18A7B10D0A57D4276DF2"},
    {metrohash128crc_2, 128, test_key_63, 1,
     "2D54F87181A0CF64B02C50D95692BC19"},
};
