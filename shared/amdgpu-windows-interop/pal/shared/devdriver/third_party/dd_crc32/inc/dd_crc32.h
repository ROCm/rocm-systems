...
// CRC32
//
// Calculate a 32bit crc using a the Sarwate look up table method. The original
// algorithm was created by Dilip V. Sarwate, and is based off of Stephan
// Brumme's implementation. See also:
...
// * liable for any damages arising from the use of this software. Permission is
// granted to anyone to use this
// * software for any purpose, including commercial applications, and to alter
// it and redistribute it freely,
...
#include <stdint.h>
static inline uint32_t CRC32(const void *pData, size_t length,
                             uint32_t lastCRC = 0) {
